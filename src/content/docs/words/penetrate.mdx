...
title: Penetrate
description: >-
  Penetrate是一个动词。它有两个主要的含义：一是打破，穿透或渗透进物体或者说是一个区域，通常是指物质上的穿透。二是充分理解，领会或勘察未知事物或未知区域，例如击穿市场的难题，充分理解困扰的问题等。
sidebar:
  hidden: true
...
“Penetrate”来自于拉丁语"penetrare"，这个词是由"penitus" 衍生出来的，意为"内部"，"深入"，再加上"trare"这个动词后缀，基本含义就是"进入"，"深入"。这个词在 14 世纪进入英语，一度用来表达“进入、深入”的物理意义，后来在 18 世纪被赋予了“洞察、理解”的抽象意义。

### 单词变形

"Penetrate"对应的名词有 penetration，对应的形容词有 penetrative 和 penetrable，对应的副词是 penetratively。
