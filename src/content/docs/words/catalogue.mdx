---
title: Catalogue
description: Catalogue 是一个名词，意思是 '目录' 或者 '分类列表'。常常被用于描述一个可供参照的物品、服务或者信息的列表。
sidebar:
  hidden: true
...
<Pronunciation word="Catalogue" uk="/ˈkætəlɑɡ/" us="/ˈkætəlɔɡ/" client:only />
...
"Catalogue" 大约在 15 世纪的英语中出现。这个词更多的是关于组织和分类信息，没有特定的文化内涵。
...
<WordRelations synonyms={["list"]} client:only />
