---
title: Anode
description: Anode是一个专业术语，主要用于电子学中。这是一个在电池或二极管电源中的阳极，电流流入的地方。这是被氧化的电极，即它会损失电子。
sidebar:
  hidden: true
...
<Pronunciation word="Anode" uk="/ˈæn.əʊd/" us="/ˈæn.oʊd/" client:only />
...
"Anode"这个词在 19 世纪英国发明了电池以后开始使用，并且现在是科学和工程中非常常见的一个术语。
