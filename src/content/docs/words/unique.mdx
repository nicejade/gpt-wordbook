...
title: Unique
description: >-
  Unique 是一个形容词，它的基本含义是“独特的，独一无二的”。如果某人或某件东西是
  unique，那意味着它与其他任何人或事物都不相同，没有其他可以与之匹配的。
sidebar:
  hidden: true
...
<Pronunciation word="Unique" uk="/juːˈniːk/" us="/juːˈniːk/" client:only />
...
"Unique"这个词在 16 世纪从法语进入英语，起初用于描述稀有的或独特的事物，后来扩大到更广义的"无与伦比"的含义。
...
<WordRelations synonyms={["singular"]} client:only />
