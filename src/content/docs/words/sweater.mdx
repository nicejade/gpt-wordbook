---
title: Sweater
description: Sweater 是英文中的一个名词，汉语中的意思是“毛衣”。
sidebar:
  hidden: true
...
<Pronunciation word="Sweater" uk="/ˈswetə/" us="/-ɾɚ/" client:only />
...
"Sweater" 这个词来源于 19 世纪，当时的意思是令人出汗的运动衣物。
...
<WordRelations
  synonyms={["sweatshirt","cardigan","jersey","jumper","pullover","wooly"]}
  client:only
/>
