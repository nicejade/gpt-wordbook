...
title: French
description: >-
  French是一个英语单词，通常用作形容词或者名词。作为形容词时，'French'
  是法国的，也表示法国文化、语言或者其他事物的；作为名词时，它指的是法国的语言。
sidebar:
  hidden: true
...
<Pronunciation word="French" uk="/fɹɛnt͡ʃ/" us="/fɹɛnt͡ʃ/" client:only />
...
<WordRelations synonyms={["French"]} client:only />
