...
title: Baby
description: >-
  Baby 在英文中一般愉快承载两种主要的含义。首先，最直接常见的含义就是指'婴儿'或'新生儿'。其次，'baby'
  也经常用作爱人、另一半的昵称或者悦耳的称呼。
sidebar:
  hidden: true
...
<Pronunciation word="Baby" uk="/ˈbeɪbi/" us="/ˈbeɪbi/" client:only />
...
"Baby" 是指新出生到学步之间的小孩。这个单词在 14 世纪中期进入英语，可能源于早期类似"babe"的音译形式，或者像 "baba" 这样的小孩学语声音。
...
<WordRelations
  synonyms={["love","babbie","babby","babe","infant","little"]}
  client:only
/>
