---
title: Agony
description: Agony 是一个名词，表示'极大的痛苦'或'折磨'，可以用来形容强烈的身体上的痛苦，也可以用来形容深重的精神上的痛苦。
sidebar:
  hidden: true
...
<Pronunciation word="Agony" uk="/ˈæ.ɡə.niː/" us="/ˈæ.ɡə.niː/" client:only />
...
"Agony" 在早期希腊语中有"斗争"或"竞争"的意思。到了 16 世纪，它在英语中被用来描述“身体上的极度痛苦”，后来又演变出“精神上的痛苦”“折磨的感觉”的含义。
...
<WordRelations
  synonyms={["anguish", "distress", "pang", "suffering", "throe", "torment"]}
  antonyms={["ecstasy"]}
  client:only
/>
