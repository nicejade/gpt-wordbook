---
title: Kidney
description: Kidney的中文意思是“肾脏”，它是人体的主要排泄器官之一。
sidebar:
  hidden: true
...
<Pronunciation word="Kidney" uk="/ˈkɪdni/" us="/ˈkɪdni/" client:only />
...
<WordRelations synonyms={["nephros", "rein", "ren"]} client:only />
