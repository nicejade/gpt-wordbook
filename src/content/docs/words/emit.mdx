...
description: >-
  Emit
  是一个动词，它主要有两个含义。第一个是“放出、发出、射出”，通常与光、声音、热量、气味等无形的东西连用。第二个含义是“发布、公布、颁布”，多用于法律、规则、声明等的语境中。
sidebar:
  hidden: true
...
<Pronunciation word="Emit" uk="/iˈmɪt/" us="/iˈmɪt/" client:only />
...
<WordRelations synonyms={["output", "outsend"]} client:only />
