...
title: summit
description: >-
  'Summit' 是一个名词, 主要有两个意思, 其一是顶点或最高点, 通常用来指 mountains、 hills或一个上升的表面的最高点.
  其二是峰会或高级会议, 指的是一种由各国的领导人或高级官员参加的会议. 列举例句: 1. Climbing to the summit of the
  mountain is a feat in itself. 登上山顶本身就是一项壮举。
sidebar:
  hidden: true
