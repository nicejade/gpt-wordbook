---
title: Canvas
description: Canvas是一个英语单词，基本含义是'帆布'，常用于指代用于绘画的布料。在更广泛的语境中，也可以表示任何基础层或背景。
sidebar:
  hidden: true
...
<Pronunciation word="Canvas" uk="/ˈkæn.vəs/" us="/ˈkæn.vəs/" client:only />
...
"Canvas"的词根来自 12 世纪的中英语单词"Canvaz"，原意为粗麻布。随着时间的推移和用途的转变，"Canvas"逐渐发展成为我们今天所知道的意思。
