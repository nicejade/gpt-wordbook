---
title: Continuous
description: Continuous 是一个形容词，意为 “连续不断的”， “无中断的”。
sidebar:
  hidden: true
...
<Pronunciation word="Continuous" uk="/kənˈtɪn.juː.əs/" us="/kənˈtɪn.juː.əs/" client:only />
...
"Continuous" 源自于拉丁语 "continuare"，在 16 世纪被收入英语词汇。在欧美文化中，这个单词通常用于描述连续和持续的行为或状态。
...
<WordRelations
  synonyms={["connected","continued","extended","protracted","unbroken","constant","continual","continuous","incessant","nonstop","ongoing","relentless","unceasing","unending","uninterrupted","unremitting","perpetual"]}
  antonyms={["broken","disconnected","disjoint","unbroken","discontinuous","discrete","intermittent","interrupted","stepwise"]}
  client:only
/>
