...
<WordRelations
  synonyms={["connected","extended","protracted","unbroken","constant","continual","continuous","incessant","nonstop","ongoing","relentless","unceasing","unending","uninterrupted","unremitting","perpetual"]}
  antonyms={["broken","unbroken","discrete","intermittent","interrupted","stepwise"]}
  client:only
/>
