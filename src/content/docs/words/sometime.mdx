...
description: >-
  Sometime
  是一个副词，表示在未来的某个不确定的时间点或在过去的某个不确定的时间点。这个词可以用于描述你不确定具体时间，但确信某事肯定会发生，或者已经发生过的情况。
sidebar:
  hidden: true
...
<Pronunciation word="Sometime" uk="/ˈsʌmˌtaɪm/" us="/ˈsʌmˌtaɪm/" client:only />

### 列举例句

1.  We should catch up for a coffee sometime.（我们应该找个时间喝杯咖啡。）
2.  She moved to New York sometime in the 1980s.（她在 80 年代的某个时间搬到了纽约。）
...
<WordRelations
  synonyms={["earlier","erstwhile","previous","somewhen"]}
  client:only
/>
