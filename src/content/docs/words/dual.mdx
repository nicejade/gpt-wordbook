---
title: Dual
description: 单词'dual'一般被用作形容词。它的中文释义为' 双重的，双向的，双元的 '，是形容一件事物具有两个方面，两个部分或两个元素的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Dual" uk="/ˈdjuː.əl/" us="/ˈdjuː.əl/" client:only />
...
<WordRelations
  synonyms={["opposite", "double", "duplicate", "twin"]}
  client:only
/>
