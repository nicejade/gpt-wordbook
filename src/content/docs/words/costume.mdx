...
title: Costume
description: >-
  Costume 是一个名词，一般用来表示服装，特别是在特殊场合或活动（如戏剧、电影、派对）中使用的特定服装。此外，'costume'
  还可以指特定国家、时代或职业的典型服装。
sidebar:
  hidden: true
...
<Pronunciation word="Costume" uk="/ˈkɒs.tjuːm/" us="/ˈkɒs.tjuːm/" client:only />
...
2.  The film's costume designer did a great job recreating the 1920's fashion.
    这部电影的服装设计师在重现 1920 年代的服饰方面做得非常好。
...
"Costume" 这个词在英语中最早出现是在 18 世纪，当时主要用来指代一个人穿着的衣服的风格和特点。进入 19 世纪，随着剧院和电影的流行，"costume" 逐渐得到了现今的意义，特指各类表演中的角色扮演服装。
...
<WordRelations synonyms={["outfit"]} client:only />
