---
title: Illuminate
description: '- ''Illuminate''是一个动词，主要有三层含义：1）点亮，照亮，通过光线使某处变亮；2）阐明，解释，使明了；3）装饰，使辉煌。'
sidebar:
  hidden: true
...
<Pronunciation word="Illuminate" uk="/ɪlˈl(j)uməneɪt/" us="/ɪlˈl(j)uməneɪt/" client:only />
...
<WordRelations
  synonyms={["illustrate","quill","clarify","elucidate","explicitize","belight","enlighten","illumine","gleam","shine"]}
  client:only
/>
