...
description: >-
  - 'Lap'
  这个单词在英语中有两个主要意思。第一个意思是作为一个名词时，它通常指的是人坐着时，大腿部分上部的区域，特别是当另一物体或者某人正在这个空间中的情况下（例如，一本放在你的腿上的书）。另一个主要意思是作为动词时，它指的是一种涉及舌头运动的动作，特别是当动物，如猫或狗，快速而反复地用舌头舔食液体。
sidebar:
  hidden: true
...
<Pronunciation word="Lap" uk="/læp/" us="/læp/" client:only />
