---
title: Aluminium
description: Aluminium 是一种轻质但坚韧的金属元素，化学符号为 Al。它是地壳中含量第三大的元素，广泛应用于飞机、建筑、电线等多个行业。
sidebar:
  hidden: true
...
<Pronunciation word="Aluminium" uk="/ˌæl.(j)ʊˈmɪn.i.əm/" us="/ˌæl(j)uˈmɪn.j.əm/" client:only />
