---
title: Woe
description: woe是一个名词，表示大痛苦、痛心疾首、灾难或困扰。它可以描述对物质或情绪的强烈的不快或痛苦。
sidebar:
  hidden: true
...
<Pronunciation word="Woe" uk="/wəʊ/" us="/woʊ/" client:only />
...
<WordRelations synonyms={["grief", "misery", "sorrow"]} client:only />
