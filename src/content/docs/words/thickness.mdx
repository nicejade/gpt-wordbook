---
title: Thickness
description: Thickness 是一个名词，主要是指物体的厚度，广泛用于描述物体的一维度尺寸，同时也可以用来形象地描述声音、气味等的浓度。
sidebar:
  hidden: true
...
<Pronunciation word="Thickness" uk="/ˈθɪknəs/" us="/ˈθɪknəs/" client:only />
...
<WordRelations
  synonyms={["density","viscosity","layer","stratum","depth","denseness","slowness","stupidity","thickheadedness","fatness"]}
  antonyms={["fluidity","liquidity","runniness","thinness","wateriness","acuity","agility","sharpness"]}
  client:only
/>
