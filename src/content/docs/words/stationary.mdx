---
title: Stationary
description: Stationary 是一种形容词，主要意思是 '不动的'，'静止的'。也可以用来描述某个事物或者人一直处在一个不变的位置或状态，不发生改变。
sidebar:
  hidden: true
...
<Pronunciation word="Stationary" uk="/ˈsteɪʃ(ə)n(ə)ɹi/" us="/ˈsteɪʃ(ə)n(ə)ɹi/" client:only />
...
这个词来源于拉丁语 stationarius，而它又是由 statio+arius 组成的，意思是 "保持一个状态的人"。在 14 世纪初，它被用来形容一个随军行动的商人，也就是“驻军商人”。19 世纪时，它开始被用来指代“驻军商人”销售的商品，如纸，笔等办公用品，于是有了 'stationary' (文具)的意思。
...
<WordRelations
  synonyms={["immobile","unmoveable","fixed","motionless","still","unmoving","changeless","constant","immutable","unchanging"]}
  antonyms={["mobile","moveable","moving","changing","mutable","variable"]}
  client:only
/>
