---
title: Mean
description: Mean 是一个英文单词，主要有两个词义：
sidebar:
  hidden: true
...
<Pronunciation word="Mean" uk="/miːn/" us="/miːn/" client:only />
...
3.  "The mean of 2, 3, 4 is 3." - 2，3，4 的平均数是 3。
...
<WordRelations
  synonyms={["cause","convey","indicate","signify","imply","intend","serious"]}
  client:only
/>
