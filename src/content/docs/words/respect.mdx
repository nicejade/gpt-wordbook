---
title: Respect
description: "英文单词 'respect' 主要有两个基本含义:"
sidebar:
  hidden: true
...
<Pronunciation word="Respect" uk="/ɹɪˈspɛkt/" us="/ɹɪˈspɛkt/" client:only />
...
<WordRelations
  synonyms={["admiration","esteem","honor","recognition","regard","reverence","veneration","aspect","dimension","face","facet","side","consideration","deference","value"]}
  antonyms={["contempt","disdain","disrespect","irreverence","neglect","scorn","slight","despise","ignore"]}
  client:only
/>
