---
title: Sadness
description: Sadness 是一个名词，指的是一种情感状态，表达深度的不快乐或不满。通常用来形容哀痛、沮丧、悲伤或失望等负面情绪。
sidebar:
  hidden: true
...
<Pronunciation word="Sadness" uk="/ˈsædnəs/" us="/ˈsædnəs/" client:only />
...
<WordRelations
  synonyms={["forlornness", "melancholy", "misfortune", "woe"]}
  client:only
/>
