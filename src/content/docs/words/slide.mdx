...
title: Slide
description: >-
  Slide 作为动词时，主要意思是“滑动，滑落”，例如我们常说的 'slide down a
  hill'（从山坡上滑下）。作为名词时，意味着“滑梯，幻灯片，滑动”，例如 'children's slide'（儿童滑梯），'presentation
  slide'（演示文稿里的幻灯片）。
sidebar:
  hidden: true
...
<Pronunciation word="Slide" uk="/slaɪd/" us="/slaɪd/" client:only />
...
- "Slide" 一词于大约在 1300 年左右由早期英语进化而来，原来指的是滑动或滑落的意思，后来逐渐发展出更多的含义，例如在音乐领域，有滑音(slide note)的说法。
...
<WordRelations synonyms={["chute", "runner"]} client:only />
