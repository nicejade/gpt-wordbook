...
description: >-
  Paradox
  是一个英文名词，中文翻译为'悖论'或'似非而是的说法'，这指的是在逻辑或常识看起来荒谬或自相矛盾的陈述，但在深入调查后，可能包含一些隐藏的真理或观点。
sidebar:
  hidden: true
...
<Pronunciation word="Paradox" uk="/ˈpaɹədɒks/" us="/ˈpæɹədɑks/" client:only />
...
<WordRelations
  synonyms={["shocker","contradiction","juxtaposition","enigma","koan","puzzle","quandary","riddle"]}
  client:only
/>
