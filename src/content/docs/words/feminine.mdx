---
title: Feminine
description: Feminine是一个形容词，主要用于描绘或描述与女性有关或被认为具有传统“女性气质”的行为、性格、风格或事物。
sidebar:
  hidden: true
...
<Pronunciation word="Feminine" uk="/ˈfɛmənɪn/" us="/ˈfɛmənɪn/" client:only />
...
<WordRelations
  synonyms={["caring", "ladylike", "nurturing", "female", "womanly"]}
  antonyms={["butch", "masculine", "male", "manly", "neuter"]}
  client:only
/>
