...
title: Require
description: >-
  Require 是个动词，表示“需要”或者“要求”。如果你说你 'require' 一样东西，意味着你需要它。如果一项任务 'requires'
  你去做一些事情意味着那是你必须去完成的。
sidebar:
  hidden: true
...
<Pronunciation word="Require" uk="/ɹɪˈkwaɪə/" us="/ɹɪˈkwaɪɹ/" client:only />

### 列举例句

1.  The recipe requires 200g of flour.（这个食谱需要 200 克面粉）
