...
description: "Administration主要用作名词，有两个主要含义:"
sidebar:
  hidden: true
...
此词包含前缀“ad-”表示“行动”;词根“ministrate”表示“管理";后缀“-ion”表示状态或行为。与之形态相近的单词有：Destination, Consideration 等。

### 文化背景

"Administration"一词来源于古法语"administracioun"，最早出现在 14 世纪，是拉丁词“administratio”的借词。该词经常在政府和组织背景下使用，表示管理和运营活动。
...
<WordRelations
  synonyms={["conduct","management","organization","regulation","supervision"]}
  client:only
/>
