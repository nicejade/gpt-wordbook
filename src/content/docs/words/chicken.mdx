---
title: Chicken
description: Chicken指的是鸡，特别是家禽。也可以指鸡肉，作为食物消费。此外，'chicken'在口语中也有怕事或胆小的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Chicken" uk="/ˈt͡ʃɪkɪn/" us="/ˈt͡ʃɪkɪn/" client:only />
...
"Chicken"是一个古老的英语单词，起源于公元前 7 世纪的英国，当时的意思是小鸟，后来逐渐指代家禽——鸡。在欧美文化中，"Chickens"也常常被用作象征胆小和怯懦的象征。
...
<WordRelations synonyms={["biddy", "chook", "twink"]} client:only />
