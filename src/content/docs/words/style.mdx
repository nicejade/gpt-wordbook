...
title: style
description: >-
  Style是一个英语单词，它主要的含义有： 1. 一种独特的或典型的方式进行表达、设计、或执行某事。 2. 时尚，一个人的穿衣方式或者说时髦的东西。 例如：
  * The way he plays the piano is his own unique style.（他弹钢琴的方式是他自己独特的风格。） * She
  has a great sense of style.（她有很高的时尚品位。）
sidebar:
  hidden: true
