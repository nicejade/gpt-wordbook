...
description: >-
  Media 是英文单词 'medium'
  的复数形式，经常被用来描述各种不同的传播信息、数据或知识的方式或工具，包括电视、广播、报纸、杂志、电影等。在另一方面，'media'
  也可以表示平均或中间，这是数学和科学中常用的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Media" uk="/ˈmiːdɪə/" us="/ˈmiːdɪə/" client:only />
...
"Media" 这个词在 20 世纪 50 年代开始用来指代广播、电视和报纸这样的集体通信媒介，这个词的使用随着互联网和数字技术的发展变得更加广泛。
...
<WordRelations synonyms={["M"]} antonyms={["tenuis"]} client:only />
