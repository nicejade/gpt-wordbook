---
title: "disorderly"
description: "Disorderly 是一个形容词，主要表示“混乱的，无秩序的”。用来形容不整齐的情况、混乱的行为或无秩序的状态。"
---
...
词缀包括前缀 dis-，这时表示否定的意思，基词 order 表示秩序，后缀 -ly 表形容词。
以 dis- 为前缀的其他单词：disagree（不同意），discomfort（不舒服）。

### 发展历史和文化背景

Disorderly 来源于中古英语的'dis-'和'orderly'，首次出现于 15 世纪，主要用来描述对秩序或规则的不顺从或驳斥。
