...
description: >-
  Zone
  是一个英语名词，主要用于表示区域、地带、区。在地理、生物和人类社会中，“zone”经常被用来表示某种特定功能或特性的区域。在体育比赛中，'zone'也指代片区或区域。
sidebar:
  hidden: true
...
<Pronunciation word="Zone" uk="/zəʊn/" us="/zoʊn/" client:only />
...
"Zone"这个词在英语中的应用早在 16 世纪就开始了。最初，它是用来表达“带状地带”或“腰带”之意。然后，"zone"的意义在不同的专业领域中逐渐扩展。例如，在地理学中，“zone”用来表示从北极到南极贯穿地球的带状区域。在 19 世纪中期，"zone"的用法进一步扩展到一般意义的地理区域和社会功能区域。
...
<WordRelations
  synonyms={["area","belt","district","region","section","sector","sphere","territory","crease"]}
  client:only
/>
