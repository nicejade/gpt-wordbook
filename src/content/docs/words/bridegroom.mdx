---
title: Bridegroom
description: "Bridegroom, 常被缩短为 'groom', 是指新婚男子或即将结婚的男子。"
sidebar:
  hidden: true
...
"Bridegroom"源于古英语 "brydguma"，在 14 世纪时候把后面的"guma"，原始的意思为"man"，替换成"groom"。但是"groom"原本并没有特指新婚男子的意思，用于此处可能是因为 rime (押韵）的原因。
...
<WordRelations synonyms={["groom"]} client:only />
