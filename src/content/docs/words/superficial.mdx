---
title: Superficial
description: Superficial是一个英语形容词，它的主要含义是“表面的，浮躁的，缺乏深度的”。当用来描述人时，它通常含有贬义的色彩，表示该人做事肤浅、不求甚解。
sidebar:
  hidden: true
...
<Pronunciation word="Superficial" uk="/ˌs(j)uːpəˈfɪʃəl/" us="/ˌsupɚˈfɪʃəl/" client:only />
...
"Superficial"最初出现在 14 世纪的英语中，源自拉丁语。
...
Bob 被 Alice 的美貌所吸引，但他们的交谈内容总是很空泛，没有深度。

<WordRelations
  synonyms={["surficial"]}
  antonyms={["substantive","thorough"]}
  client:only
/>
