...
title: Wash
description: >-
  Wash 是一个用途广泛的英语单词，主要用作动词，指的是清洗、洗涤的意思，例如洗脸、洗手、洗车。同时，“wash”也可以用作名词，指的是洗涤的行为或结果，如
  “give the car a good wash”（给车子好好洗一洗）。
sidebar:
  hidden: true
...
<Pronunciation word="Wash" uk="/wɒʃ/" us="/wɑʃ/" client:only />
