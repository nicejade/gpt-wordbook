---
title: Never
description: Never 是一个英文副词，意为“从不，永不，决不”，用来表示一项行为或事件在过去、现在以及未来都不会发生。
sidebar:
  hidden: true
...
<Pronunciation word="Never" uk="/ˈnɛv.ə(ɹ)/" us="/ˈnɛ.vɚ/" client:only />
...
<WordRelations
  antonyms={["always","consistently","constantly","continually","continuously","ever"]}
  client:only
/>
