---
title: Cease
description: 英文动词 'cease' 的意思是停止，结束。这个词常用于比较正式的语境中，比如法律文本或新闻报道。
sidebar:
  hidden: true
...
<Pronunciation word="Cease" uk="/siːs/" us="/siːs/" client:only />
...
"cease" 的词源可追溯到 14 世纪的法语，然后由于诺曼人的入侵而传入英语。
...
<WordRelations
  synonyms={["desert", "lack", "discontinue", "hold", "terminate", "arrest"]}
  client:only
/>
