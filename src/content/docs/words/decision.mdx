...
title: Decision
description: >-
  Decision这个单词来自于拉丁文的'decidere'，表示'决定'。在英语中，它主要有两个意思。第一是'一个由某人选择的行动计划或者行为'，第二是指'对某事做出的决议或结论'。
sidebar:
  hidden: true
...
<Pronunciation word="Decision" uk="/dɪˈsɪʒən/" us="/dɪˈsɪʒən/" client:only />
...
"Decision"这个词在 14 世纪的老法语中首次出现，它来自于拉丁语的"decidere"，原意为"决定，断定"。后来，随着英语的演变，"Decision"的含义也变得更为广泛，除了表示一个人的选择或决定，也可以表示对某一议题的决议或结论。
