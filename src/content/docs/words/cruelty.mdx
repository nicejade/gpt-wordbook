---
title: Cruelty
description: Cruelty 是一个名词，它指的是对其他人或动物粗鲁无情的行为或态度。它可以参考身体损害，精神虐待，贬低或者恶意的行为。
sidebar:
  hidden: true
...
"Cruelty" 一词最早在英语中出现在 14 世纪，它源于法语词根 "cruel"，原本指的是人或行为的无情或暴行。作为一个反社会行为，严重的残忍行为在多数社会中是被严惩的。
...
<WordRelations
  synonyms={["barbarism", "mercilessness", "ruthlessness"]}
  antonyms={["mercy"]}
  client:only
/>
