...
title: Regularity
description: >-
  Regularity是一个名词，它表示的是事物符合某种规则、顺序或者模式的性质。它可以用于描述时间、空间或者行为的连贯性和一致性。例如，经常使用来说明一个人做事有序，时间处理得好。
sidebar:
  hidden: true
...
"Regularity"一词最早在英语中于 14 世纪被应用，它源自拉丁语的 regulare，常常用于形容事物的顺序性、连贯性。
...
汤姆非常喜欢规律的生活。每天早晨，他都会在 6:30 准时起床，在 7:00 之前吃完早餐，然后开启他的工作。他的朋友们都羡慕他生活的规律性，认为这是他成功的秘诀之一。

<WordRelations antonyms={["irregularity"]} client:only />
