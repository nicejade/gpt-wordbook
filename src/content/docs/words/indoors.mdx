---
title: Indoors
description: Indoors是副词，用于描述一个动作或状态发生在建筑物内部或在房间里，相当于中文的 '在室内'。
sidebar:
  hidden: true
...
<Pronunciation word="Indoors" uk="/ɪnˈdɔːz/" us="/ɪnˈdɔːz/" client:only />
...
"Indoors"由"in" 和"doors"组成。In 是介词或者副词，表示在里面，在内部。Doors 源自“door”，即门，表示建筑物的入口。
...
<WordRelations antonyms={["outdoors"]} client:only />
