...
description: >-
  Liquid
  是一个英语单词，用作名词时，通常表示'液体'，意思是一种可以流动的物质，介于固态和气态之间。作为形容词，也可用于描述像水一样流动的东西或情况，例如'liquid
  assets'就表示'流动资产'。
sidebar:
  hidden: true
...
<Pronunciation word="Liquid" uk="/ˈlɪkwɪd/" us="/ˈlɪkwɪd/" client:only />
...
"Liquid"这个词源自于拉丁文 liquidus，意为流动的。在金融领域，“liquid”被用来形容可以迅速转化为现金的资产。
...
<WordRelations
  synonyms={["flowy", "fluxive"]}
  antonyms={["illiquid", "gaseous", "solid"]}
  client:only
/>
