...
title: Zip
description: >-
  "Zip" 是一个多义词，可以根据不同的起源和使用场景有不同的含义。 1. 作为名词，表示"拉链"。如 "The zip on my jacket is
  broken" （我的夹克的拉链坏了）。 2. 作为动词，表示 "以高速移动"，含义接近 "zoom" 或 "fly"。例如 "She zipped
  through her homework"（她快速完成了作业）。 3. 在计算机科学当中，"zip" 作为动词，表示"压缩文件"。例如 "Please
  zip the files before you send them" （在你发送文件之前请先将它们压缩）。
sidebar:
  hidden: true
...
"zip" 这个词源自 20 世纪初，首先作为 "拉链" 的意思在美国使用，这和当时拉链在美国的发明有关。在日常对话及口语中，"zip" 也经常用来形容快速的移动。
