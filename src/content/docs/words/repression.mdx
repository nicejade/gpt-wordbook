---
title: Repression
description: '"Repression" 是一个名词，指的是对某人或某事进行镇压、抑制或控制的行为或过程。'
sidebar:
  hidden: true
...
"Repression" 的最早使用可以追溯到 14 世纪，但在 20 世纪初，由于弗洛伊德的精神分析理论的流行，其更深入的心理含义得到了广泛的接受和理解。在弗洛伊德的理论中，"repression" 是指在不自主情况下将痛苦和困扰的记忆推向潜意识。
