...
description: >-
  英文单词 'restore'
  的主要含义是“恢复”，它包括恢复到原来的状态或者回复到某个之前的位置或者状态。这个词多被用在物体的修复、健康状况的改善、权力或者职位的回复等几种场景中。
sidebar:
  hidden: true
...
<Pronunciation word="Restore" uk="/ɹɪˈstɔː/" us="/ɹɪˈstɔɹ/" client:only />
...
"Restore" 这个词在 14 世纪进入英语，与"repair", "renew", "renovate" 等词相似，都带有"使复原"的含义，不过"restore" 更强调把某事物恢复至其原始或正常状态。
