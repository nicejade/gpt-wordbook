...
description: >-
  Tolerate
  是一个动词，主要有两个意义：一是指忍受、容忍，通常用来表示接受那些不舒服、痛苦或者我们不喜欢的事情；二是指容忍、宽恕，多用于描述对别人的行为或观点的接受。
sidebar:
  hidden: true
...
<Pronunciation word="Tolerate" uk="/ˈtɒl.ə.ɹeɪt/" us="/ˈtɑl.ə.ɹeɪt/" client:only />
...
词形变化主要有：过去式和过去分词形式是 tolerated，现在进行时是 tolerating。固定搭配有 "tolerate someone doing something" （忍受某人做某事）。
...
Tom was a perfectionist who couldn’t tolerate flaws. However, when he met his girlfriend, a free spirit who lived in chaos, he learned to tolerate the mess and fell in love with her quirky charm. (Tom 是个完美主义者，无法忍受瑕疵。然而，当他遇到了他的女朋友，一个在混乱中生活的自由精神时，他学会了忍受混乱，并爱上了她的怪异魅力。)

<WordRelations
  synonyms={["accept","bear","brook","endure"]}
  client:only
/>
