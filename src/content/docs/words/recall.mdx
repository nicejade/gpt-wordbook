---
title: Recall
description: Recall是一个英语的动词，其含义主要是'回忆起；召回；取消'。例如，在一次考试中，你可能需要'recall'（回忆起）你曾经学过的知识。
sidebar:
  hidden: true
...
"Recall"是一个自 14 世纪中叶就开始在英语中使用的单词，最初用以表示"召回"或"取消"。 在美国， "recall"在政治语境中特别常见，作为一种召回任政府职务的公民权利。
...
<WordRelations synonyms={["withcall"]} client:only />
