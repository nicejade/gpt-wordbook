---
title: Ignorant
description: Ignorant 直译成中文为“无知的”，一般指一个人对某个特定主题或事情没有足够的知识或理解。
sidebar:
  hidden: true
...
<Pronunciation word="Ignorant" uk="/ˈɪɡnəɹənt/" us="/ˈɪɡnəɹənt/" client:only />
...
Ignorant 的词根为 Latin 词汇 "ignorare"，表示 "不知道"。
