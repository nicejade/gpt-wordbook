...
description: >-
  Tree
  是英语中非常常用的一个词，它是指那些大型的、主干直立的植物。这个词是一个集合性的词汇，包括了各种各样的树，例如苹果树、松树、橡树等等。此外，'tree'这个词在计算机科学中还有一个特殊的含义，那就是树形结构，用于表示一种类似于家族关系的层次结构。
sidebar:
  hidden: true
...
<Pronunciation word="Tree" uk="/tɹiː/" us="/tɹi/" client:only />
...
自古以来，"tree"这个词就在每个文化中代表生命力和力量的象征。例如，在圣经中，生命之树是伊甸园最神秘的元素之一。在北欧神话中，世界之树 Yggdrasil 连接了九个宇宙，象征着宇宙的中心和连续性。
