---
title: Behavious
description: '"Behavior" 是一个名词，表示“行为”或者“举止”。它可以用来描述一种习性，一个过程，或者一个体现特定理论或模型的个体或系统的反应。'
sidebar:
  hidden: true
...
"Behavior"这个单词初次出现在 15 世纪，来源于旧法语的"behave"，表示行为或举止。现在它被广泛使用在心理学，社会学和其他的社会科学领域中。
