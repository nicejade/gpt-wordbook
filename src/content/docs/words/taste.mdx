---
title: Taste
description: taste 是一个多义词，主要含有以下几种意思：
sidebar:
  hidden: true
...
<Pronunciation word="Taste" uk="/teɪst/" us="/teɪst/" client:only />
...
"taste"起源于 12 世纪的英语，由于大家都会用到品尝、味道的概念，这个词渐渐被大家所接受并普及。
...
<WordRelations
  synonyms={["culture","discernment","refinement","style","impression","sample","trial","hint"]}
  client:only
/>
