---
title: External
description: External 是一个英语形容词，意思是'外部的，外面的'，用于描述不在某事情或某人体内的事物。以下是几个例子：
sidebar:
  hidden: true
...
<Pronunciation word="External" uk="/əksˈtɜːnəl/" us="/əksˈtɝnəl/" client:only />
...
<WordRelations antonyms={["internal"]} client:only />
