---
title: Commodity
description: Commodity是一个名词，意为商品或者物品，尤指在贸易中被买卖的产品或者原材料。在经济学中，'commodity'常常指的是一种可交换、可替代的商品。
sidebar:
  hidden: true
...
<Pronunciation word="Commodity" uk="/kəˈmɒdəti/" us="/kəˈmɒdəti/" client:only />
