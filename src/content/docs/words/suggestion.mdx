---
title: Suggestion
description: Suggestion 是一个名词，主要有两种含义：
sidebar:
  hidden: true
...
由此词根衍生出来的其他单词有：suggest, suggestive, suggestion 等。

### 词缀分析

"Suggestion" 是由 "sug-" （表示"下面"）、 "-gest-" （意为"带来"）和 "-ion"（表示过程或结果）组成的。

相同词缀的其他单词包括：direction, operation, creation 等。

### 文化背景

"Suggestion" 是在 14 世纪从拉丁语 derivatives 引入英语的。在欧美文化中，它更侧重于表达一种较为委婉和礼貌的提议方式。
...
<WordRelations synonyms={["hint", "incitement", "proposal"]} client:only />
