---
title: Dessert
description: Dessert 是一个英文名词，主要用来指的是一餐的最后部分，也就是甜点。这个词一般用于形容糖果、饼干、冰淇淋，甚至是水果等各类甜食。
sidebar:
  hidden: true
...
<Pronunciation word="Dessert" uk="/dɪˈzɜːt/" us="/dɪˈzɝt/" client:only />
...
"Dessert" 这个词在 14 世纪时期，源于法语 "desservir"，原意各地都是 "clear the table"。逐渐发展为英文中表示 "the final course" 或 "sweet course" 的意思，被普遍接受和使用。
...
<WordRelations synonyms={["afters", "pudding", "sweet"]} client:only />
