---
title: Taxi
description: Taxi 是一个英文名词，主要指的是约车服务供应者或为乘客提供交通服务的车辆。在美国和加拿大等地，'taxi' 和 'cab' 可以互换使用。
sidebar:
  hidden: true
...
Taxi 是一个英文名词，主要指的是约车服务供应者或为乘客提供交通服务的车辆。在美国和加拿大等地，"taxi" 和 "cab" 可以互换使用。

<Pronunciation word="Taxi" uk="/ˈtæk.si/" us="/ˈtæk.si/" client:only />
...
"Taxi" 这个词的历史可以追溯到 19 世纪末的法国，最初被用于描述配备计价器的出租马车。在今天的英美热门电视剧影片中，出租车司机的形象常常被写入其中，如电影《出租车司机》。
...
<WordRelations synonyms={["cab", "taxicab"]} client:only />
