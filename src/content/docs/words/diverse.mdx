---
title: Diverse
description: Diverse是一个形容词，表示多样的，各种各样的，不同的，变化多的。它用来概述一组或一类事物有许多不同点。
sidebar:
  hidden: true
...
<Pronunciation word="Diverse" uk="/daɪˈvɜːs/" us="/daɪ.ˈvɝs/" client:only />
...
<WordRelations synonyms={["manifold"]} antonyms={["homogeneous"]} client:only />
