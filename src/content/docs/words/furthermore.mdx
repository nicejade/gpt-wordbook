---
title: Furthermore
description: Furthermore 是一个副词，用于增加额外的信息或引出相关的事实，其意思类似于“此外”，“而且”。
sidebar:
  hidden: true
...
<Pronunciation word="Furthermore" uk="/ˈfɜː(ɹ).ðə(ɹ).mɔː(ɹ)/" us="/ˈfɜː(ɹ).ðə(ɹ).mɔː(ɹ)/" client:only />
...
"Tom was tired. Furthermore, he still had five more miles to run." (Tom 很累，而且他还有五英里要跑。) 这是一个简短的故事，可以帮你记住"furthermore"的意思及其使用场景。

<WordRelations
  synonyms={["additionally","also","moreover"]}
  client:only
/>
