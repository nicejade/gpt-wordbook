...
title: Embody
description: >-
  Embody 是一个动词，它的核心意思是“体现”或“包含”。当一个人或事物被说成是 'embody'
  了某种特质或概念时，意味着他们代表或者显现出了这个特质或概念。
sidebar:
  hidden: true
...
<Pronunciation word="Embody" uk="/ɪmˈbɒdi/" us="/ɪmˈbɒdi/" client:only />
...
"Embody"的词源可追溯到 15 世纪的英格兰，最初的含义是“使成为实体”或“赋予形体”，之后逐渐泛化了表达“体现”或“代表”的含义。
...
<WordRelations
  synonyms={["embrace","materialize","realize","fuse","integrate","merge"]}
  client:only
/>
