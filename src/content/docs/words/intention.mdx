---
title: Intention
description: Intention是一个名词，表示有意，意图，目的，或计划。这个词常用于描述有决定做某事或达到某个目标的决心。
sidebar:
  hidden: true
...
<Pronunciation word="Intention" uk="/ɪnˈtɛnʃən/" us="/ɪnˈtɛnʃən/" client:only />
...
"Intention" 在 14 世纪的时候从法语进入英语，它的使用在法律和哲学中非常广泛，如"无意识犯罪"或"有意识的行为"。
