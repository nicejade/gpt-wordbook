---
title: Stove
description: Stove 是一个名词，指的是做饭用的炉灶或者供暖用的炉子。
sidebar:
  hidden: true
...
<Pronunciation word="Stove" uk="/stəʊv/" us="/stoʊv/" client:only />
...
Stove 本身是一个完整的单词，没有添加词缀。

### 文化背景

"Stove" 一词的使用可以追溯到 14 世纪的英格兰，最初指的是加热的房间或围禽的笼子。18 世纪中叶，随着工业革命的到来，"stove" 开始被用来指煤或木材燃烧的加热设备。

### 单词变形

做为名词，stove 没有变化形式。其复数形式为 stoves（炉子们）。
