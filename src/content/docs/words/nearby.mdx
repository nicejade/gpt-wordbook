---
title: Nearby
description: "- 'Nearby' 是一个形容词或副词，表示距离上的接近，常用于表达在附近或与某物贴近的意思。比如：A nearby restaurant（附近的餐馆）。"
sidebar:
  hidden: true
...
- "Nearby" 出现于 15 世纪的英格兰，起初仅作为副词使用，到了 19 世纪末期，它开始承担形容词的角色。
...
<WordRelations synonyms={["close"]} client:only />
