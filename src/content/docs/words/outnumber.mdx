---
title: Outnumber
description: '"Outnumber"是一个动词，意思是"在数量上超过"或"多于"，通常用来指在数量比较上显示出优势或者优越性。'
sidebar:
  hidden: true
...
Outnumber 的词根是“-number”，来自于拉丁语 "numerus"，意为“数量”或“数目”。"Out-"在此是一个前缀，表示“超过”或“超越”。
...
"Outnumber" 这个词源自 17 世纪，由 "out-" 和 "number" 组成，用来描述一方的数量超过另一方。
