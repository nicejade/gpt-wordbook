...
title: Literacy
description: >-
  literacy是一个名词，主要意思是读写能力、文化水平或者素养。在不同的上下文中它的含义可以稍有不同。基础的意思是指个体能够阅读、理解并写作本国语言的能力。扩展的含义可以是指熟悉或了解某一特定领域的知识或技能。
sidebar:
  hidden: true
...
1.  The literacy rate in that country is almost 90%. 那个国家的识字率几乎达到了 90%.
...
'Literacy' 这个词最早出现在英语中是在 1883 年，最初指的是能够阅读并理解书面文字的能力。到了 20 世纪，随着科技的发展和社会的变革，'literacy' 的含义也开始拓展，如今它还可以指一系列的专业技能和素养，包括计算机素养、媒体素养和金融素养等。
...
John 尽管年纪小，但已经展现出令人印象深刻的读写能力。他会利用空闲时间阅读各种各样的书籍，然后写书评。他的父母对他对学习的热爱感到非常高兴。

<WordRelations antonyms={["illiteracy"]} client:only />
