...
title: Mould
description: >-
  "Mould" 是一个英语单词，在美式英语中通常被写作 "mold"。它有几个不同的含义： 1. 作为一个名词，"mould"
  可以指模具，用于制造特定形状的容器。例如，冰模就是我们常说的 "ice mould"。 2. "Mould"
  也可以指霉菌，就像在湿气重的情况下食物上会生长的那种。 3. 另外，"mould" 还有形塑、塑造的意思，通常用在比喻语境中。比如，“be moulded
  by experience”（被经验塑造）。
sidebar:
  hidden: true
