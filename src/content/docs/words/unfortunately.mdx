---
title: Unfortunately
description: Unfortunately 是一个含有不幸或者未按预期正常发展的褒贬中立词。常见使用场景为表达一些事情的不良结果或者期望外的结果。
sidebar:
  hidden: true
...
<Pronunciation word="Unfortunately" uk="/ʌnˈfɔːtjʊnətli/" us="/ʌnˈfɔɹt͡ʃənɪtli/" client:only />
...
"Unfortunately" 这个词源于 14 世纪的英格兰，它的出现反映了那个时代的选择权問題以及对命运的态度。
...
<WordRelations
  synonyms={["alas","regrettably","sadly","unluckily"]}
