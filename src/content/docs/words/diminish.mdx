---
title: Diminish
description: Diminish 是一个动词，意思是“减少”，“降低”，或者“变小”。它表示的是事物的数量、大小、质量、程度或重要性在逐渐或显着地减小。
sidebar:
  hidden: true
...
<Pronunciation word="Diminish" uk="/dɪˈmɪnɪʃ/" us="/dɪˈmɪnɪʃ/" client:only />
...
"Diminish"一词最早在 14 世纪的英语中出现，最初使用的地方主要是音乐领域，用于描述音量的减小。后来才开始在各种场合表达物体，影响等的减小。
...
<WordRelations antonyms={["improve", "renovate", "repair"]} client:only />
