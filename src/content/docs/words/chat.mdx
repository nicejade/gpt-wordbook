...
title: Chat
description: >-
  Chat 这个单词在英语中是一个非常常见的词，主要有两种用法。一是作为名词，表示“闲聊，聊天”。二是作为动词，表示“闲谈，聊天”。例如，“Let's
  have a chat' (让我们来聊天)；或者 'They are chatting in the living room' (他们在客厅聊天).
sidebar:
  hidden: true
...
<Pronunciation word="Chat" uk="/tʃæt/" us="/tʃæt/" client:only />
