---
title: Loosely
description: Loosely 是个副词，用来描述事情做得不紧、不严，并无规矩或预谋，比如结构宽松，无纪律，随意等等。
sidebar:
  hidden: true
...
<Pronunciation word="Loosely" uk="/ˈluːsli/" us="/ˈluːsli/" client:only />
...
<WordRelations antonyms={["tightly"]} client:only />
