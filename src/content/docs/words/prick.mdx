...
title: Prick
description: >-
  "Prick" 是个多义词，它可以作为一个名词和动词使用。 1. 作为动词使用 它主要的含义是以尖锐物件刺、戳。例如，用针刺破气球 (prick a
  balloon with a needle)。 2. 作为名词使用 它指的是一小口刺伤或者刺痛感，例如，感到一阵刺痛 (feel a prick of
  pain)。
sidebar:
  hidden: true
...
In the park, a little girl called Emma was walking barefoot and suddenly a prick of pain made her scream. She stepped on a rose thorn. (在公园里，一个叫 Emma 的小女孩赤脚走路，突然感到一阵刺痛让她大喊起来。她踩到了玫瑰刺上）。
