...
title: Weak
description: >-
  Weak 是形容词，意为 '弱的'， '软的'， '不够强的'。它既可以用于描述物理的弱小 (例如肌肉弱)，也可以用于描述精神、信念等方面的脆弱
  (例如意志薄弱)。
sidebar:
  hidden: true
...
<Pronunciation word="Weak" uk="/wiːk/" us="/wiːk/" client:only />
...
Weak 来源于古英语的 wēak，本身就是词根, 没有进一步的词根分析。
...
<WordRelations
  synonyms={["feeble","frail","powerless","vincible","vulnerable","dilute","watery"]}
  antonyms={["strong", "healthy", "invincible", "powerful", "robust", "potent"]}
  client:only
/>
