---
title: Mercury
description: Mercury 是一个英文单词，它有两个主要的含义。在天文学上，它指的是离太阳最近的一颗行星。在化学上，它指的是化学元素汞（也叫做水银）
sidebar:
  hidden: true
...
<Pronunciation word="Mercury" uk="/ˈməː.kjʊ.ɹi/" us="/ˈmɝkjəɹi/" client:only />
...
"Mercury" 这个词在英语中有很多深层次的文化和历史含义。在罗马神话中，Mercury 是通商和益智的神，他以快速和灵敏而知名。水星（Mercury）是在太阳系中最小且公转速度最快的行星，因此得名。
