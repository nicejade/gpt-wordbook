---
title: Long
description: Long是一个英文单词，最常见的意思是“长的、长度大的”，用来描述物理距离或时间的长度。它还有'渴望、期待'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Long" uk="/ˈlɔːŋ/" us="/ˈlɔːŋ/" client:only />
...
"Long"一词在早期的英语中即有“长的”之意。在古英语中，它的形式为"lang"或"long",来源于 Proto-Germanic 词根 "langaz"。
...
<WordRelations
  synonyms={["extended", "lengthy", "prolonged", "deep", "high", "tall"]}
  antonyms={["short", "brief", "low", "shallow"]}
  client:only
/>
