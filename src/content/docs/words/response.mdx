---
title: Response
description: response 这个单词在英语中通常被用作名词，主要有以下几种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Response" uk="/ɹɪˈspɒns/" us="/ɹɪˈspɒns/" client:only />
...
<WordRelations synonyms={["reaction"]} client:only />
