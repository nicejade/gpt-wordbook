---
title: Scramble
description: Scramble 是一个英文单词，可以作为动词，也可以作为名词使用。作为动词时，它包含多种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Scramble" uk="/ˈskɹæmbl̩/" us="/ˈskɹæmbl̩/" client:only />
...
<WordRelations antonyms={["sortie"]} client:only />
