---
title: Saucer
description: Saucer 是一种扁平的，宽浅的碟子，通常用于放置杯子或者喝茶时防止茶洒出，也可以装装点心，比如曲奇或巧克力等。
sidebar:
  hidden: true
...
<Pronunciation word="Saucer" uk="/ˈsɔː.sə/" us="/ˈsɔː.sə/" client:only />
...
**历史和文化背景**
"Saucer" 这个词在 14 世纪英格兰首次出现，原先指的是盛放调味汁的容器，其用法及含义在后续的几个世纪中有所变化，人们开始使用它来放置杯子，防止茶水洒出。
