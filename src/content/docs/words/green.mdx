...
description: >-
  Green
  是一个英语单词，用作形容词时，常指的是“绿色的”。它可以用来描述大自然、植物或任何具有绿色的物品。此外，“green”还有“环保的”、“新手的”。用作名词时，则是指绿色或草地。
sidebar:
  hidden: true
...
<Pronunciation word="Green" uk="/ɡɹiːn/" us="/ɡɹin/" client:only />
...
Jake lives in a green house with green walls, surrounded by a wide stretch of green fields.（Jake 住在一所绿色的房子里，墙壁是绿色的，周围是一大片广阔的绿地。）

<WordRelations
  synonyms={["verdant","raw","tart"]}
  antonyms={["processed","smoked","ripe","sweet"]}
  client:only
/>
