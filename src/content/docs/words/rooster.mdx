---
title: Rooster
description: Rooster是英文中对'公鸡'的称呼。这个词常常用在农场和乡村环境中，描述公鸡的行为或特点。
sidebar:
  hidden: true
...
<Pronunciation word="Rooster" uk="/ˈɹuːstə/" us="/ˈɹustəɹ/" client:only />
...
<WordRelations synonyms={["cock", "brawler"]} client:only />
