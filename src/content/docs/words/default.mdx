---
title: Default
description: default 作为名词，通常意味着“故障”，“违约”或者“未做的事情”。作为动词，它指的是未能履行某项义务或者责任。
sidebar:
  hidden: true
...
<Pronunciation word="Default" uk="/dɪˈfɔːlt/" us="/dɪˈfɔːlt/" client:only />
...
"default" 这个单词的使用最早可以追溯到 14 世纪的法语，"defaillir"，意思是失败，背离，不足。该词在中世纪进入英语，主要用于法律语境中表示未能出席法庭、未能履行义务或者未能按期付款。
...
default 可以被分为 "de-"（向下）和 "fault"（故障）。所以你可以记忆为向下的错误，当你没办法满足义务时，你就会犯下一个错误，这就是 default 的含义。
