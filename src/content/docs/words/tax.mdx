---
title: Tax
description: Tax 是一个名词，意为'税，税款'。也可作为一个动词，意思是'对...征税'或'使负重担，使压力增大'。
sidebar:
  hidden: true
...
<Pronunciation word="Tax" uk="/tæks/" us="/tæks/" client:only />
...
词汇 "tax" 最初来自拉丁语 "taxare"，后在早期的法国中发展成了 "taxer"，并在 14 世纪时成为英语常用词。
...
<WordRelations
  synonyms={["assessment","contribution","custom","demand","duty","levy","rate","toll","tribute"]}
  antonyms={["subsidy"]}
  client:only
/>
