---
title: Equation
description: Equation 的主要含义是'等式'，它通常用来表达在量和数量之间的相等关系。在物理学和化学中，它的意思也被广泛使用，例如化学反应方程式和物理方程式。
sidebar:
  hidden: true
...
<Pronunciation word="Equation" uk="/ɪˈkweɪʃən/" us="/ɪˈkweɪʃən/" client:only />
...
"Equation" 源自拉丁词根 "aequus"，意为 "equal"，后来进入早期法国语言，并在 14 世纪被引入英语。
