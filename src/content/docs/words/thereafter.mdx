---
title: Thereafter
description: thereafter 是副词，用于描述某事接着在特定事件或时间之后发生。它的含义是'在那之后'或'从那时起'。
sidebar:
  hidden: true
...
1.  "He graduated in 1980, and thereafter started his own business."（他在 1980 年毕业，此后开始了他自己的生意。)
...
"thereafter" 这个单词来自早期的英语，最早出现在公元 1000 年左右。它源自说英语的人对 "then" 和 "after" 两个词组合的需要，用于更精确地描述事件的顺序。
