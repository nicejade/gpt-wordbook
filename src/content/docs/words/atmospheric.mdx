...
title: Atmospheric
description: >-
  - 'Atmospheric' 是一个形容词，主要指与大气或大气层有关的。另外，也经常被用来形容一个环境、音乐或艺术作品有一种特殊的感觉或情绪，常见的搭配有
  'atmospheric music' 或 'atmospheric lighting'。
sidebar:
  hidden: true
...
- "Atmospheric" 是个相对较新的词，大约在 17 世纪后期由 "atmosphere" 衍生出来。
...
<WordRelations synonyms={["atmospherical"]} client:only />
