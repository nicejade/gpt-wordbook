---
title: Hearty
description: Hearty 是一个形容词，它的基本意思是充满热情和真诚的，或者表达热烈、强烈的特征。
sidebar:
  hidden: true
...
<Pronunciation word="Hearty" uk="/ˈhɑːti/" us="/ˈhɑɹti/" client:only />
...
<WordRelations synonyms={["sincere"]} client:only />
