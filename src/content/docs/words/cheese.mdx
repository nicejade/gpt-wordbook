...
title: Cheese
description: >-
  Cheese 是一个英语单词，主要用于指一种由牛奶（或羊奶、山羊奶等）通过发酵等手段制作的乳制品。在很多西方国家，比如法国和意大利，cheese
  是非常重要的食品。
sidebar:
  hidden: true
...
<Pronunciation word="Cheese" uk="/t͡ʃiz/" us="/t͡ʃiz/" client:only />
...
<WordRelations antonyms={["fill"]} client:only />
