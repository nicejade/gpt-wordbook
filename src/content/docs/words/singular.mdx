---
title: Singular
description: Singular 一般指“单数的，单一的，特殊的，非凡的”，在不同的上下文中有不同的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Singular" uk="/ˈsɪŋɡjʊlə/" us="/ˈsɪŋɡjəlɚ/" client:only />
...
"Singular" 最初出现于 14 世纪，源自法语 "snguler" 和拉丁语 "singularis"。早期的使用主要指"单一的、特殊的"，后来在语言学中用于描述单数形态。
...
<WordRelations
  synonyms={["curious","eccentric","funny","odd","peculiar","rum","rummy","strange","unusual","exceptional","extraordinary","remarkable","individual","unique"]}
  antonyms={["plural","general","invertible"]}
  client:only
/>
