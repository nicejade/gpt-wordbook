---
title: Live
description: Live 是一个十分常用的英语单词，有生活、居住以及活着的意思。它可以作为动词、形容词或者副词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Live" uk="/lɪv/" us="/lɪv/" client:only />
...
<WordRelations synonyms={["dwell", "last", "remain"]} client:only />
