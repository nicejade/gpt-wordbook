---
title: Unfortunate
description: Unfortunate是一个形容词，用于描述倒霉的、不幸的情况或事件。多用于形容人遭遇不好的事件或者事情不按照期望去发生。
sidebar:
  hidden: true
...
"Unfortunate"一词在 14 世纪就已经出现，源自法语"unfortunate"，在欧美文化中, 制高点往往表示运气、命运，因此"unfortunate"多用在描述不好的运气和命运。
