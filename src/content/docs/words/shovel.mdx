...
description: >-
  Shovel
  是一个名词，也可以作为动词使用。作为名词，它指的是一种工具，一端有一个宽而平的金属片，另一端有一个长柄，常被用来挖掘或移动材料比如雪、煤或土壤。当
  'shovel' 作为动词时，意思是使用铲子挖掘或移动材料。
sidebar:
  hidden: true
...
<Pronunciation word="Shovel" uk="/ˈʃʌvəl/" us="/ˈʃʌvəl/" client:only />
