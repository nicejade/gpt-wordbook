...
title: Mix
description: >-
  Mix这个单词作为动词时，表示'混合'或者'搅拌'，用来描述把两种或者更多的事物放在一起，使其形成一个整体或者结合在一起。作为名词时，它表示'混合物'或者'混搭'。
sidebar:
  hidden: true
...
<Pronunciation word="Mix" uk="/ˈmɪks/" us="/ˈmɪks/" client:only />
...
<WordRelations
  synonyms={["muddle", "blend", "combine", "intermix", "mingle"]}
  client:only
/>
