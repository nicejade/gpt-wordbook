---
title: Fry
description: "- 'Fry' 主要有两个意思。其一，做动词时，表示在油炸或油煎，如 'Fry the chicken'. 其二，做名词时，表示 '年轻或小的鱼苗'。"
sidebar:
  hidden: true
...
<Pronunciation word="Fry" uk="/fɹaɪ/" us="/fɹaɪ/" client:only />
...
<WordRelations synonyms={["chip"]} client:only />
