...
title: Endow
description: >-
  Endow 是一个动词，意为“捐赠”，“赋予”，通常用于表示赋予某人某种品质、特性或资源。常见的表达为'endow somebody with
  something'，即用某种东西赋予某人。
sidebar:
  hidden: true
...
<Pronunciation word="Endow" uk="/ɛn-/" us="/ɛn-/" client:only />
...
<WordRelations synonyms={["begift", "bless", "gift"]} client:only />
