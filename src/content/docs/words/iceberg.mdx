---
title: Iceberg
description: "- 'Iceberg' 是大块从冰川断裂而成的浮冰。'Iceberg' 这个词的形象含义通常用于描述大部分内容或信息仍然隐藏或未知的情况。"
sidebar:
  hidden: true
...
<Pronunciation word="Iceberg" uk="/ˈaɪsbɜːɡ/" us="/ˈaɪsbɜːɡ/" client:only />
...
- "Iceberg" 这个词是在 18 世纪由在北大西洋行驶的船只中使用的海员引进英语的。它的观念对于“冰山一角”的比喻深入人心。
