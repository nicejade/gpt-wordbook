---
title: Ruler
description: Ruler在英文中有两个主要含义，一是尺子，用于测量长度；另一种用法则常常是指统治者或者领导者。
sidebar:
  hidden: true
...
<Pronunciation word="Ruler" uk="/ˈɹuːlə(ɹ)/" us="/ˈɹulɚ/" client:only />
...
"Ruler"源自古英语"rice"，意为统治，其后又发展为"rule"，也有统治之意。此外，尺子的英文单词也是 ruler，可能因为尺子控制了尺寸与长度。
...
<WordRelations synonyms={["rule"]} client:only />
