---
title: Throughout
description: Throughout 是一个副词，也可作为介词使用。作为副词时，它表示“在整个过程中”，“自始至终”。作为介词，它表示“遍及”，“贯穿”。
sidebar:
  hidden: true
...
<Pronunciation word="Throughout" uk="/θɹuˈʌʊt/" us="[θɹuːˈʷaʊt]" client:only />
...
Throughout 在中古英语中被用作介词和副词，主要表示“在...各处”。在现代英语中的用法是从 16 世纪开始的。
...
<WordRelations synonyms={["across", "amidst", "during"]} client:only />
