---
title: Inquire
description: Inquire 这个单词的意思是“询问”，“查寻”。在英语中，它通常用于正式的场合，或者是当我们要追求更深入，更具体的信息时。
sidebar:
  hidden: true
...
<Pronunciation word="Inquire" uk="/ɪnˈkwaɪə/" us="/ɪnˈkwaɪɹ/" client:only />
...
<WordRelations synonyms={["frain"]} client:only />
