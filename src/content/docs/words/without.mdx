...
title: Without
description: >-
  Without 是一个英文单词，用作介词或副词。当它作为介词时，意思是“没有，不包括，缺乏”，例如 'live without
  food'（没有食物生活）；当它作为副词时，意思是“在外部，向外”，例如 'go without'（外出）。
sidebar:
  hidden: true
...
<Pronunciation word="Without" uk="/wɪθˈʌʊt/" us="/wɪðˈaʊt/" client:only />
...
<WordRelations
  synonyms={["lacking", "outwith", "sans", "w/o"]}
  antonyms={["characteristic", "endowed", "having", "with", "within"]}
  client:only
/>
