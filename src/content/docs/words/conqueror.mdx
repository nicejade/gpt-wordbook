---
title: Conqueror
description: Conqueror 是一个名词，意思是'征服者'或'胜利者'，通常用于描述在某方面取得突出成功或胜利的人，尤其是在战争或竞赛中取得胜利的人。
sidebar:
  hidden: true
...
<Pronunciation word="Conqueror" uk="/ˈkɒŋkəɹə/" us="/ˈkɒŋkəɹə/" client:only />
...
<WordRelations synonyms={["subjugator", "vanquisher", "victor"]} client:only />
