...
description: >-
  Loan
  是一个名词，常被用来指代一笔借款或贷款，即将某物暂时借给他人，但期望其在未来原样归还或偿还其等值的事物。此外，'loan'还可以作为一个动词，意味着把某物暂时借给他人。
sidebar:
  hidden: true
...
<Pronunciation word="Loan" uk="/ləʊn/" us="/loʊn/" client:only />
...
<WordRelations synonyms={["lending", "loaning", "principal"]} client:only />
