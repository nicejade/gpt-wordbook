---
title: Bone
description: Bone 是一个名词，中文意思是“骨头”或“骨骼”。在某些场合下，它也可作形容词或动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Bone" uk="/bəʉn/" us="/ˈboʊn/" client:only />

### 列举例句

1.  My dog loves to gnaw on a bone. (我的狗喜欢啃骨头。)
2.  The x-ray showed a fracture in the bone. (X 光片显示骨头有个裂缝。)
...
"Bone" 这个词的语源可以追溯到古英语的 "ban"。在中世纪，bonework 即骨制工艺，被广泛用于制作各种工具和装饰品。
...
<WordRelations
  synonyms={["rib","stay","debone","unbone","bonk","fuck","screw","shag"]}
  client:only
/>
