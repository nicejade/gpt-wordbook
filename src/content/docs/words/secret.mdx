---
title: Secret
description: Secret 是一个英语单词，意为秘密，涵盖的概念可以是隐藏的信息，亦或是个人或组织不希望公开的事情。
sidebar:
  hidden: true
...
<Pronunciation word="Secret" uk="/ˈsiːkɹət/" us="/ˈsiːkɹət/" client:only />
...
<WordRelations synonyms={["dern"]} antonyms={["overt"]} client:only />
