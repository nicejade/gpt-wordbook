...
description: >-
  Linear
  是一个英语形容词，意思是'直线的'，'线性的'或'长度的'，通常用来描述与直线相关的事物或者关系。例如，线性代数就是研究直线空间和线性变化的一个数学分支。
sidebar:
  hidden: true
...
<Pronunciation word="Linear" uk="/ˈlɪn.i.ə/" us="/ˈlɪn.i.ɚ/" client:only />
...
<WordRelations antonyms={["nonlinear"]} client:only />
