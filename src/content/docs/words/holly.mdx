...
description: >-
  Holly
  是一个英文单词，通常用来指代一种名为冬青的常绿灌木，也是常见的女性名字。它在英语中的主要含义是指代这种植物，这种植物在圣诞节期间经常被作为节日装饰。
sidebar:
  hidden: true
...
<Pronunciation word="Holly" uk="/ˈhɒli/" us="/ˈhɑli/" client:only />
...
"Holly" 这个单词在英语中使用的历史可以追溯到公元前 7 世纪。在欧美经常以冬青（Holly）来装饰圣诞树，因此在西方国家，holly 往往与圣诞节联系在一起。
