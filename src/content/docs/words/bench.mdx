...
title: Bench
description: >-
  Bench 是一个英语单词，作为名词时通常指的是'长凳'。例如公园里给人们休息的长椅。此外，在法律语境下，'bench'
  可以指法官或法官团队；在体育中，'bench' 可以指替补席。
sidebar:
  hidden: true
...
<Pronunciation word="Bench" uk="/bɛntʃ/" us="/bɛntʃ/" client:only />
...
<WordRelations synonyms={["sideline"]} client:only />
