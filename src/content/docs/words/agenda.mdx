...
title: Agenda
description: >-
  Agenda 是一个名词，意为“议程”或“待办事项”。它通常用来列出会议、活动或个人需要完成的事项的顺序。该词源自拉丁语
  'agenda'，字面意思是“应该做的事”。
sidebar:
  hidden: true
...
<Pronunciation word="Agenda" uk="/əˈdʒɛn.də/" us="/əˈdʒɛn.də/" client:only />
...
<WordRelations synonyms={["docket", "schedule", "worklist"]} client:only />
