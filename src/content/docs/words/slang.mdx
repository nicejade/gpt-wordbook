---
title: Slang
description: Slang 是一个英语单词，通常指的是在某个社区、集团、地区或特殊行业中使用的非正式的、非标准的词汇或词组。
sidebar:
  hidden: true
...
<Pronunciation word="Slang" uk="/sleɪŋ/" us="/sleɪŋ/" client:only />
...
"Slang" 这个单词的确切起源并不清楚，发现的最早记录是在 1756 年，但可能比这个日期还要早一些。它可能源于那些特定的社会群体，比如贼和流浪者，他们创建自己的语言以在警察面前保密。
...
<WordRelations
  synonyms={["dialect","jargon","lingo","vernacular"]}
  client:only
/>
