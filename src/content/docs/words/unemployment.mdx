---
title: Unemployment
description: Unemployment 是英语中的一个名词，用来指一个人当前没有工作，也就是他或她失业的状态。
sidebar:
  hidden: true
...
"Unemployment" 的前缀是 "un-"，它表示否定。词根是 "employ"，后缀 "-ment" 是把 verb 转成名词,再先后加上前缀 'un-' 和后缀 '-ed' 分别表示否定和状态。

### 文化背景

"Unemployment" 这个词在 1880 年左右开始在英语中广泛使用，主要是在工业革命后，当工厂的大规模生产开始取代传统职业时，失业成为一个普遍存在的社会问题。
...
<WordRelations
  synonyms={["joblessness", "unwork", "worklessness"]}
  antonyms={["employment"]}
  client:only
/>
