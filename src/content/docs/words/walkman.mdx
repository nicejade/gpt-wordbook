...
title: Walkman
description: >-
  Walkman 在大部分情况下是指索尼的一款便携式音乐播放器，它因具有便捷的携带功能和出色的音质，曾经颠覆了 20 世纪 80
  年代的音乐播放方式。有时候，人们会用 'walkman' 来表示所有的便携式音乐播放器。
sidebar:
  hidden: true
...
"Walkman" 在大部分情况下是指索尼的一款便携式音乐播放器，它因具有便捷的携带功能和出色的音质，曾经颠覆了 20 世纪 80 年代的音乐播放方式。有时候，人们会用 "walkman" 来表示所有的便携式音乐播放器。
