---
title: Degree
description: Degree 是一个名词，有多种含义，可以表示“学位”、“程度”、“度数”。
sidebar:
  hidden: true
...
<Pronunciation word="Degree" uk="/dɪˈɡɹiː/" us="/dɪˈɡɹiː/" client:only />
...
3.  The temperature today is twenty degrees. (今天的温度是 20 度。)
...
"Degree" 大约于 13 世纪中叶从法语借入英语。最初有 "step" (步骤) 的含义，随后发展出了现在的多种含义。
...
<WordRelations synonyms={["arcdegree", "°"]} client:only />
