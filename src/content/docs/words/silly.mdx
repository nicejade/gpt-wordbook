---
title: Silly
description: Silly 是一种描述粗心大意，做事冲动，或者是幼稚，不理智的形容词。
sidebar:
  hidden: true
...
<Pronunciation word="Silly" uk="/ˈsɪli/" us="/ˈsɪli/" client:only />
...
<WordRelations synonyms={["charming"]} antonyms={["pious"]} client:only />
