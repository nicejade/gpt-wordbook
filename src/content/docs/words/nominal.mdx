...
title: nominal
description: >-
  Nominal是一个英语形容词，主要有三个含义： 1. 名义上的，有名无实的：这个意思是说它存在，但实际上并没有什么重要的影响或值得重大注意的地方。例如:
  They charge a nominal fee for the service.（他们对这项服务收取象征性的费用。） 2.
  名词的：在语法中，如果说一样东西是nominal，意思是它像名词或者与名词有关。例如: A nominal clause in a sentence
