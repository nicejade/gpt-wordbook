...
title: Nominal
description: >-
  "Nominal"是一个英语形容词，主要有三个含义： 1.
  名义上的，有名无实的：这个意思是说它存在，但实际上并没有什么重要的影响或值得重大注意的地方。例如: "They charge a nominal fee
  for the service."（他们对这项服务收取象征性的费用。） 2.
  名词的：在语法中，如果说一样东西是"nominal"，意思是它像名词或者与名词有关。例如: "A nominal clause in a sentence"
  (一个句子中的名词子句) 3. (货币或经济)面额的，标明的：关于金钱和价格的正式含义，较少使用。例如: "The nominal value of the
  shares" (股票的面值)
sidebar:
  hidden: true
