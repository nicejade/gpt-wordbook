---
title: "nominal"
description: "Nominal是一个英语形容词，主要有三个含义： 1. 名义上的，有名无实的：这个意思是说它存在，但实际上并没有什么重要的影响或值得重大注意的地方。例如: They charge a nominal fee for the service.（他们对这项服务收取象征性的费用。） 2. 名词的：在语法中，如果说一样东西是nominal，意思是它像名词或者与名词有关。例如: A nominal clause in a sentence (一个句子中的名词子句) 3. (货币或经济)面额的，标明的：关于金钱和价格的正式含义，较少使用。例如: The nominal value of the shares (股票的面值)"
---
...
单词"Nominal"来源于拉丁词"nominālis"，意为"名字的、属于名字的"。15 世纪晚期开始在英文中使用，最初指的是名词或现在分词的形式或用法，后来逐渐形成我们现在所熟知的意义。

### 单词变形

Nominal 主要以形容词的形态存在，无明显的其他变形，如动词、副词形式等。
