...
<Pronunciation word="Partition" uk="/pɑɹˈtɪʃən/" us="/pɑɹˈtɪʃən/" client:only />
...
"Partition" 这个单词来源于 14 世纪的中古英语，最初用来描述按照比例分割或分发的行为。现在，我们用它来描述从政治到科技在内的各种不同的分隔或分割。
...
<WordRelations synonyms={["dismemberment", "dismember"]} client:only />
