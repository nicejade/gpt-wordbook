---
title: Drunk
description: Drunk 是一个形容词和过去分词，它的主要意义是'喝过量的酒而不能思考和行为正常'。它也可以用作名词，表示一个喝醉酒的人。
sidebar:
  hidden: true
...
<Pronunciation word="Drunk" uk="/dɹʌŋk/" us="/dɹʌŋk/" client:only />
...
<WordRelations
  synonyms={["gulp","imbibe","quaff","sip","alcohol","alcoholic","drunkard","pisshead","sot","boozy","sottish"]}
  client:only
/>
