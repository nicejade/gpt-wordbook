---
title: Prompt
description: Prompt是一个英语单词，作为动词时意思是'马上做'，或者说'促使'；作为名词时可以理解为'提示'或者'指示'。
sidebar:
  hidden: true
...
<Pronunciation word="Prompt" uk="/pɹɒmpt/" us="/pɹɒmpt/" client:only />
...
<WordRelations synonyms={["hasty", "timely", "yare"]} client:only />
