---
title: Kid
description: "- 单词 'kid' 通常被用作名词，主要表示“小孩，孩子”。同时，'kid'也可以作为动词，表示“开玩笑，戏弄”。"
sidebar:
  hidden: true
...
<Pronunciation word="Kid" uk="/kɪd/" us="/kɪd/" client:only />
...
<WordRelations synonyms={["cabrito"]} client:only />
