---
title: Descent
description: Descent 是一个名词，主要指的是“下降”或“下落”，也可以用来形容某一种物品或特性由一个源头或上一代传递给下一代的过程，即“血统”或“遗传”。
sidebar:
  hidden: true
...
<Pronunciation word="Descent" uk="/dɪˈsɛnt/" us="/dɪˈsɛnt/" client:only />
...
"Descent" 这个单词最早出现在 14 世纪的英格兰，它源自拉丁语词 "descendere"，该词在英语中的使用普遍指代两个方向，一是空间的下降，二是家族、种族或国籍的血统、遗传。
...
<WordRelations antonyms={["ascent"]} client:only />
