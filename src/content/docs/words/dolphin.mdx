---
title: Dolphin
description: Dolphin是英文中的一种名词，它的中文含义是“海豚”，通常指的是正常生活在海洋中的智慧生物。
sidebar:
  hidden: true
...
<Pronunciation word="Dolphin" uk="/ˈdɒlfɪn/" us="/ˈdɑlfɪn/" client:only />
...
<WordRelations synonyms={["mereswine"]} client:only />
