...
title: Therein
description: >-
  Therein 是一个附属副词（adverb），基本意思是 '在那种情况下' 或者
  '在那个位置'，类似于中文里的“在其中”，“在那里”。常用于正式的写作领域。
sidebar:
  hidden: true
...
<Pronunciation word="Therein" uk="/ˈðeəɹˈɪn/" us="/ˈðeəɹˈɪn/" client:only />
