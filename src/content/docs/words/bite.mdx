---
title: Bite
description: Bite 是一个英语动词，基本的中文翻译是'咬'。此外，它还可以表示'刺痛'或'刺激'。
sidebar:
  hidden: true
...
<Pronunciation word="Bite" uk="/bʌɪt/" us="/baɪt/" client:only />
...
<WordRelations synonyms={["mouthful", "snack", "sting"]} client:only />
