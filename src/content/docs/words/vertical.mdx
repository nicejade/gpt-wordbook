---
title: Vertical
description: "Vertical 是一个形容词，具有垂直，竖直的意思。用于描述两个点之间的距离的直线(或符合这种性质的平面或立体), 与水平线呈 90 度角。"
sidebar:
  hidden: true
...
"Vertical" 是一个形容词，具有垂直，竖直的意思。用于描述两个点之间的距离的直线(或符合这种性质的平面或立体), 与水平线呈 90 度角。

<Pronunciation word="Vertical" uk="/ˈvɜːtɪkəl/" us="/ˈvɝtɪkəl/" client:only />
...
<WordRelations synonyms={["harmonic"]} antonyms={["horizontal"]} client:only />
