---
title: Tiny
description: Tiny 这个单词是形容词，在英语中表示“非常小”的意思。这个词用来描述尺寸、规模、程度等方面小到了非常度的物体或者现象。
sidebar:
  hidden: true
...
<Pronunciation word="Tiny" uk="/ˈtaɪni/" us="/ˈtaɪni/" client:only />
...
<WordRelations antonyms={["great", "huge"]} client:only />
