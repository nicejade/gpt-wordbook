...
title: Selection
description: >-
  Selection 是名词，有选择、挑选、选集、精选货品等意义。常与其他词搭配使用，如'selection process'
  (挑选过程)、'selection criteria' (选择标准)。
sidebar:
  hidden: true
...
<Pronunciation word="Selection" uk="/səˈlɛkʃən/" us="/səˈlɛkʃən/" client:only />
...
“Selection”本身为名词，一般不发生变形。对应的动词是 select，其变形有 selects、selected、selecting，中文翻译为选择。对应的形容词是 selective，中文翻译为有选择性的。
...
<WordRelations
  synonyms={["number","piece","option","subset","choice"]}
  client:only
/>
