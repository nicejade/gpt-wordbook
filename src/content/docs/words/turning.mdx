---
title: Turning
description: '- ''Turning'' 主要有两个含义。第一是作为动名词，指的是''转向''或''转变''的行为；第二是作为名词，指的是车床上的切削过程，即''车削''。'
sidebar:
  hidden: true
...
<Pronunciation word="Turning" uk="[ˈtɜː.nɪŋ]" us="[ˈtɝ.nɪŋ]" client:only />
...
<WordRelations
  synonyms={["become","get","go","rotate","complete","sour","spoil","spin","twirl","rebel","revolt","lathe","steer","swerve","tack","swarf"]}
  client:only
/>
