---
title: Tighten
description: tighten是一个动词，主要的含义是“使紧，收紧”。通常用于某种物体或着肌肉的紧绷。
sidebar:
  hidden: true
...
<Pronunciation word="Tighten" uk="/ˈtaɪ.tən/" us="/ˈtaɪ.tən/" client:only />
...
<WordRelations antonyms={["loosen"]} client:only />
