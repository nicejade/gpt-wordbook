---
title: Worthless
description: Worthless是一个形容词，用来形容一件事物之没有价值、无用或者无价值的。
sidebar:
  hidden: true
...
<Pronunciation word="Worthless" uk="/ˈwɜːθləs/" us="/ˈwɝθləs/" client:only />
...
在 "worthless" 中, "-less" 是词缀，表示否定, 如同 Chinese-"没有"。
用这个词缀的其他单词：heartless(无情的)；endless(无尽的)。

### 文化背景

"Worthless"这个词源于英语，最早被使用于大约 14 世纪。原意为"无价值的，无用的"，在经济和道德等多个层面都有应用。
...
<WordRelations
  synonyms={["inconsequential", "valueless", "miserable", "useless"]}
  antonyms={["precious","useful","valuable","worthy"]}
  client:only
/>
