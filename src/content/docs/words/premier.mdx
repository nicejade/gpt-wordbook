---
title: Premier
description: Premier是一个形容词，也可以作为名词使用。作为形容词时，意思是'首要的'，'一流的'。作为名词时，通常指的是'首相'或'总理'。
sidebar:
  hidden: true
...
<Pronunciation word="Premier" uk="/ˈpɹemjə/" us="/ˈpɹemjə/" client:only />
...
"Premier" 这个单词在 14 世纪时从法语引入英语，原意指的是"最初的"或"第一的"。随着时间推移，在政治场合，"premier"开始被用来指代某个国家的政府首脑，像是首相或总理。
