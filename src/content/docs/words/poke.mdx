---
title: Poke
description: Poke 是一个动词，意味着用指头或尖端轻轻地戳或刺。除此之外，它也有嘲弄，激怒的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Poke" uk="/pəʊk/" us="/pəʊk/" client:only />
...
"Poke" 这个词可能源于 14 世纪的中英语，当时这个词被用来表达"刺入，插入或刺穿"的动作。
...
<WordRelations
  synonyms={["drill","nail","pound","root"]}
  client:only
/>
