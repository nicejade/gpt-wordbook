---
title: qualitative
description: Qualitative，这个单词在英语中是形容词，主要是用来描述事物的质量或性质的，而不是量。
sidebar:
  hidden: true
...
Qualitative 一词来源于法国词"qualitatif"。在中世纪晚期，它被用来形容天主教神学中神的本质和属性。
...
中文：在他的科学课上，John 必须进行质性和量性的研究。他需要识别出细菌的类型(质性)，然后再数一数他们的数量(量性)。
