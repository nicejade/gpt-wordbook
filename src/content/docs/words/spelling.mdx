---
title: Spelling
description: "- 'Spelling'是一个名词，它的意思是拼写，是指字母按特定顺序排列组成单词的方式。"
sidebar:
  hidden: true
...
<Pronunciation word="Spelling" uk="/ˈspɛlɪŋ/" us="/ˈspɛlɪŋ/" client:only />
...
<WordRelations
  synonyms={["comprise","mean","signify","relieve","orthography"]}
  client:only
/>
