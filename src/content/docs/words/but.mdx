---
title: But
description: but是一个非常常见的英语连词。在不同的情境下，其释义有所不同。
sidebar:
  hidden: true
...
<Pronunciation word="But" uk="/bʊt/" us="/bʊt/" client:only />
...
<WordRelations
  synonyms={["nevertheless","notwithstanding","yet","barring","bar","excepting","excluding","unless","without","ac","although"]}
  client:only
/>
