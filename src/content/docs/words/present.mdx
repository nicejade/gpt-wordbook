...
title: Present
description: >-
  Present这个单词既可以做名词，也可以用作动词，也可以做形容词。作为名词时，它的意思是'礼物'；作为动词时，它意味着'展示'或'提供'；作为形容词时，它表示'现在的'或'在场的'。
sidebar:
  hidden: true
...
<Pronunciation word="Present" uk="/pɹəˈzɛnt/" us="/ˈpɹɛzənt/" client:only />
...
(从前，有一个名叫 Leo 的男孩。母亲节那天，他想给妈妈一个特别的礼物。所以，他自己动手做了一张美丽的卡片，妈妈看到时非常高兴。)

<WordRelations
  synonyms={["now","audient","heedful","reckful","presentaneous","close","nearby","instantaneous","current"]}
  antonyms={["distracted","inattentive","absent","delayed","future","past"]}
  client:only
/>
