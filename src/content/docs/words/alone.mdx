---
title: Alone
description: Alone是一个英语单词，作为形容词时，意思是'单独的'或'孤独的'；作为副词用时，它表示'只有'或'仅仅'。
sidebar:
  hidden: true
...
<Pronunciation word="Alone" uk="/əˈləʊn/" us="/əˈloʊn/" client:only />
...
Mike is alone in the mountains, finding peace in solitude. He sees a world only he knows.（Mike 独自一人在山上，从孤独中找到平静。他看到的是只有他知道的世界。）

<WordRelations
  synonyms={["singlehanded","singlehandedly","lonelily","singlely","solitarily","solo","entirely","solely"]}
  client:only
/>
