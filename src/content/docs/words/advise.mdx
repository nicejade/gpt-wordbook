---
title: Advise
description: Advise是一个动词，表示“给予建议”或“通知”，一般用于描述有专业知识的人向他人给出的建议。
sidebar:
  hidden: true
...
<Pronunciation word="Advise" uk="/ədˈvaɪz/" us="/ədˈvaɪz/" client:only />
...
<WordRelations synonyms={["inform", "notify", "counsel", "warn"]} client:only />
