---
title: Tenant
description: Tenant 是一个英文名词，主要指在租赁协议下使用和占据房地产、土地或者其他类型财产的人。在房地产业中，tenant 常常指的是租户。
sidebar:
  hidden: true
...
<Pronunciation word="Tenant" uk="/ˈtɛ.nənt/" us="/ˈtɛ.nənt/" client:only />
...
"Tenant" 这个词在英文中的使用可以追溯到 14 世纪的法语中的 "tenant"（"者"）的一个用法，那时候它表示的是“持有者”。随着时间的推移，它发展出了“租户”的含义。
...
<WordRelations
  synonyms={["dweller", "occupant", "lessee", "rentee", "renter"]}
  client:only
/>
