---
title: Inherent
description: Inherent 是一个形容词，表示的是一个内在的、固有的特质。如果我们说某种特性是固有于某个内容或人中的，那么这个特性就是本质的，无法分离的。
sidebar:
  hidden: true
...
<Pronunciation word="Inherent" uk="/ɪnˈhɛɹənt/" us="/ɪnˈhɛɹənt/" client:only />
...
<WordRelations
  synonyms={["inbuilt", "ingrained", "intrinsic"]}
  antonyms={["extrinsic"]}
  client:only
/>
