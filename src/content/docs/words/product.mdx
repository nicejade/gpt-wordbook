---
title: Product
description: Product 是一个名词，主要有两大意义：1) 明确指代被生产出来的货物或者服务，例如一台手机或者一次理发服务等。 2) 指示数学中的乘法运算结果。
sidebar:
  hidden: true
...
<Pronunciation word="Product" uk="/ˈpɹɒd.əkt/" us="/ˈpɹɒd.əkt/" client:only />
...
"Product" 这个单词源于 14 世纪的中古法语 "produit"，这个词取自拉丁词"productus"，原意是"扩展"或"延伸"。在随后的发展中，"product" 逐渐获得了 "生产出来的结果" 的意义。
...
<WordRelations synonyms={["goods", "merchandise", "wares"]} client:only />
