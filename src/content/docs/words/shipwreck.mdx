---
title: Shipwreck
description: "- `Shipwreck` 是一个名词，指的是船只在海洋中遭到事故损坏或沉没的事件。这个词也可以用做动词，表示船只遭到破坏或者沉没。"
sidebar:
  hidden: true
...
<Pronunciation word="Shipwreck" uk="/ˈʃɪpɹɛk/" us="/ˈʃɪpɹɛk/" client:only />
...
- `Shipwreck` 这个词的发展历史可以追溯到公元前 8 世纪的古希腊。在那时，航海是一项非常重要的活动，因此有很多关于船只沉没的记录。这个词在文学作品中常被用作比喻，表示失去希望和绝望。
...
<WordRelations synonyms={["shipbreach"]} client:only />
