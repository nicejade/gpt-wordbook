...
title: Constituent
description: >-
  "Constituent" 是一个英文单词，通常用作名词，它的含义主要包含： 1. 组成部分，成分，例如：Water has two basic
  constituents: hydrogen and oxygen (水有两个基本成分：氢和氧). 2. 选民，例如：He met with his
  constituents to discuss the new policy (他与选民会面讨论新的政策).
sidebar:
  hidden: true
