---
title: Distant
description: Distant 是一个英语形容词，意为'遥远的，远离的，远处的'，也有'疏远的，冷淡的，不亲近的'的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Distant" uk="/ˈdɪstənt/" us="/ˈdɪstənt/" client:only />
...
"Distant"来源于 14 世纪的法语 "distant"（远的、差距大的），原先从拉丁语 "distantem", 来源于 "distare" ("从...中站起","离开", "与...不同")。
...
<WordRelations synonyms={["aloof", "cold", "faraway"]} client:only />
