---
title: Couple
description: couple一词源于拉丁语的'copula'，在英语中常作名词使用，有'一对'、'一双'、'几个'的意思。偶尔也会作为动词使用，意思是'连接'、'结合'。
sidebar:
  hidden: true
...
<Pronunciation word="Couple" uk="/ˈkʌpəl/" us="/ˈkʌpəl/" client:only />
...
"Couple"一词源于 14 世纪的法语，此后又进入英语，并开始用来表示"两个成对的东西"。这个词在英语的发展过程中，其含义已经从严格的"两个"扩展到了"几个"或者"一些"的含义。
...
<WordRelations
  synonyms={["few","handful","brace","pair","bewed","espouse","affix","attach"]}
  client:only
/>
