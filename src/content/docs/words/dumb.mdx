---
title: Dumb
description: Dumb是一个形容词，最常见的含义为“愚蠢的”或“无法表达的”，还常用于描述人或物无法发声或语言表达的状态，例如'deaf and dumb'（聋哑）。
sidebar:
  hidden: true
...
<Pronunciation word="Dumb" uk="/dʌm/" us="/dʌm/" client:only />
...
<WordRelations
  synonyms={["banal","brainless","dopey","ridiculous","silly","stupid","vulgar","dumbstruck","mute","speechless","wordless","idiotic","moronic"]}
  client:only
/>
