---
title: Repertoire
description: Repertoire 是一个名词，表示一个表演者或者团体可以准备并表演的一系列剧目或者作品。它也可以被用来引义，表示某人技能、信息或者知识的总和。
sidebar:
  hidden: true
...
这个单词出现在 19 世纪，最初是用来描述歌剧或者戏剧中被准备好的和能够被表演的一组作品。现在则更广泛地用来描述任何可以被表演的一组作品，或者一个人的技能集。
