---
title: Mammal
description: mammal是英文中的名词，译为中文是“哺乳动物”。
sidebar:
  hidden: true
...
<Pronunciation word="Mammal" uk="/ˈmæməl/" us="/ˈmæməl/" client:only />
...
"Mammal"这个单词首次出现在 19 世纪。这个词源于"mamma"，在许多语言中都表示"母亲"或"乳房"。哺乳动物是指有乳腺并可以哺乳的动物。
