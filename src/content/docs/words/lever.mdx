---
title: Lever
description: Lever 主要表示'杠杆'。它大多数时候是名词，描述一种工具或装置，经过恰当的应用，可以用来对物体施加力，从而简化或执行任务。
sidebar:
  hidden: true
...
<Pronunciation word="Lever" uk="/ˈliː.və/" us="/ˈlɛ.vɚ/" client:only />
...
"Lever" 的词根来自中古英语 "levere"，意为"挂钩"，最早出现在 14 世纪，用来指代"机械杠杆"。
