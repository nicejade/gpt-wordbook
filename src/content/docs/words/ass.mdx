---
title: Ass
description: Ass 在英语中有两个主要含义：一是作为俚语，指“屁股”；二是作为现代标准英语词汇，指一种生活在山区的驴。
sidebar:
  hidden: true
...
<Pronunciation word="Ass" uk="/æs/" us="/æs/" client:only />
...
<WordRelations synonyms={["donkey", "fool", "idiot"]} client:only />
