---
title: Squalor
description: Squalor 是个英文名词，用来描述一个地方或者情况极度的肮脏和破败，在中文中，我们通常译为'肮脏'、'悲惨'或'庸俗'。
sidebar:
  hidden: true
...
<Pronunciation word="Squalor" uk="/ˈskwɒlə(ɹ)/" us="/ˈskwɒlə(ɹ)/" client:only />
...
"Squalor" 这个词来自于拉丁语，它的意思是污秽，到了 17 世纪初，这个词开始在英语中使用，用来形容环境或生活条件的肮脏和破败。
...
<WordRelations
  synonyms={["filthiness", "foulness", "squalidity", "squalidness"]}
  client:only
/>
