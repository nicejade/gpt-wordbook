---
title: Pulley
description: Pulley 是一个名词，意思是“滑轮”，是一种机械装置，通过绳索或者链条与其上的轮子配合，可以使力量方向改变，或者通过机械优势进行物品的搬运。
sidebar:
  hidden: true
...
<Pronunciation word="Pulley" uk="/ˈpʊli/" us="/ˈpʊli/" client:only />
...
从前，有个聪明的男孩名叫 John，他用滑轮帮助他的爷爷在他们的商店里搬运重物。
