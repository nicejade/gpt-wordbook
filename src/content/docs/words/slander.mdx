...
title: Slander
description: >-
  Slander 是一个名词，也可以作为一个动词使用。作为名词时，'slander' 指的是口头诽谤、诬蔑。当它作为动词时，'slander'
  的意思是诽谤，刻薄地对他人进行贬低或诬蔑。
sidebar:
  hidden: true
...
<Pronunciation word="Slander" uk="/ˈslændɚ/" us="/ˈslændɚ/" client:only />
...
<WordRelations
  ...
  antonyms={["glorification", "glorify"]}
  client:only
/>
