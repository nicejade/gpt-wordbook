---
title: Heal
description: Heal 是个英文动词，意指“康复，治愈”。可以用于描述因疾病、受伤或情绪困扰等因素导致的疾病或伤口的康复，也可以用于形容内心创伤或精神困扰的恢复。
sidebar:
  hidden: true
...
<Pronunciation word="Heal" uk="/hiːl/" us="/hiːl/" client:only />
...
<WordRelations synonyms={["recover", "cure"]} client:only />
