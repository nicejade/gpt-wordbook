...
<Pronunciation word="Puzzle" uk="/ˈpʌzəl/" us="/ˈpʌzəl/" client:only />
...
- "Puzzle"的词根并不明确，可能来自于 16 世纪的英语动词 "pose"，原意是"使困惑"。
...
<WordRelations
  synonyms={["conundrum","enigma","mystery","crossword","poser","jigsaw","riddle"]}
  client:only
/>
