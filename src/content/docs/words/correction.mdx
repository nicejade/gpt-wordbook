---
title: Correction
description: Correction 是一个名词，主要含义是修正，纠正，它也可以引申为改正的内容或结果。
sidebar:
  hidden: true
...
在 "correction" 这个单词里，-rect- 是词根，来源于拉丁语，意思是 "right" 或 "straight"，和直或者正确有关。其他有同样词根的单词有：direct, rectangle, rectify 等。
