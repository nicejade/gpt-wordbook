---
title: Awfully
description: Awfully是一个英语副词，有'非常'或'极度'的意思。通常、它被用来强调描述词或其他副词的程度。
sidebar:
  hidden: true
...
<Pronunciation word="Awfully" uk="/ˈɔːfli/" us="/ˈɔːfli/" client:only />
...
<WordRelations synonyms={["extremely", "terribly", "very"]} client:only />
