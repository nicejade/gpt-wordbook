---
title: Pear
description: Pear 在英文里直接指的就是梨子，和我们生活中的水果一样。在形容词的用法中，'pear-shaped' 可以用来形容某事变糟，出现意料之外的问题。
sidebar:
  hidden: true
...
"Pear" 这个单词的历史可以追溯到 10 世纪的英语中，并从拉丁文中得到借鉴，其最初形态可以追根溯源到古希腊语的 ‘pera’。
...
（James 刚才手上这个梨子就是他见过的最好的一个。他举起梨子，一口咬下去，果汁顺着下巴流了下来，他笑了。在温暖的夕阳下，这份简单的变乐趣却如此美好。）
