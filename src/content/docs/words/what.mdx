...
title: What
description: >-
  What在英语中是一个广泛使用的疑问词，常用于询问或解释事物。它可以询问人，地点，原因，目标，时间，方式等。例如，“What is your name?”
  （你叫什么名字？） 或“What do you want? ” （你想要什么?）。
sidebar:
  hidden: true
...
<Pronunciation word="What" uk="/wɒt/" us="/wɒt/" client:only />
...
<WordRelations synonyms={["such", "wot", "pardon"]} client:only />
