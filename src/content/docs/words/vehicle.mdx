---
title: Vehicle
description: Vehicle 是一个名词，源自拉丁语 'vehiculum'，意味着'用于运输的工具'。它通常用于描述任何形式的运输工具，如汽车，飞机，船只等。
sidebar:
  hidden: true
...
<Pronunciation word="Vehicle" uk="/ˈvɪː(ə).kəl/" us="/ˈvi.ə.kəl/" client:only />
...
<WordRelations synonyms={["vahan"]} client:only />
