---
title: Stranger
description: Stranger是一个名词，主要用来指代一个我们不熟悉或未曾见过的人。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["new", "unfamiliar", "unknown", "newbie", "newcomer"]}
  antonyms={["everyday","normal","regular","standard","unsurprising","usual","familiar","known","citizen","fellow","national","resident","acquaintance","friend"]}
  client:only
/>
