---
title: Office
description: Office 是一个英文名词，主要有两种意思：
sidebar:
  hidden: true
...
<Pronunciation word="Office" uk="/ˈɑfɪs/" us="/ˈɔfɪs/" client:only />
...
<WordRelations
  synonyms={["breviary","surgery","bureau","department","ministry","liturgy","service"]}
  client:only
/>
