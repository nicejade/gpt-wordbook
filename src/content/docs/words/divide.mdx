...
description: >-
  - 'Divide'
  是一个英文动词，主要含义有“分割”，“划分”或“除法”。例如，我们可以将一块饼干“divide”（分割）成几部分，或者将一个数字“divide”（除）以另一个数字。
sidebar:
  hidden: true
...
<Pronunciation word="Divide" uk="/dɪˈvaɪd/" us="/dɪˈvaɪd/" client:only />
...
3.  Divide sixteen by four and you get four. (16 除以 4 等于 4。)

### 词根分析

- Divide 来自拉丁词根- "divid"，意为分开。

几个与此词根相关的单词：dividend（红利），divisible（可分割的），individual（个人的）

### 词缀分析

- Divide 主要由词根 - "divid" 构成，没有明显的前后缀。但与其有关的单词里就包含了词缀，比如"dividend"的后缀“-end”表明了它是名词。
...
<WordRelations
  synonyms={["separate","shear","split","share","disunite","partition"]}
  antonyms={["multiply","combine","merge","unify","unite"]}
  client:only
/>
