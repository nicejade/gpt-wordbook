...
description: >-
  Childish这个词衍生自
  'child'，在英语中用作形容词，它指的是像小孩子那样的行为、态度或思考方式，通常具有贬义，形容一个成年人的行为不成熟，幼稚。
sidebar:
  hidden: true
...
<Pronunciation word="Childish" uk="/ˈtʃaɪldɪʃ/" us="/ˈtʃaɪldɪʃ/" client:only />
...
<WordRelations
  synonyms={["immature","infantile","juvenile","puerile","silly","unbecoming"]}
