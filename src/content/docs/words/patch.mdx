---
title: Patch
description: 英文单词'patch'有多个含义，最主要的几个是：一小片、修补、补丁。
sidebar:
  hidden: true
...
<Pronunciation word="Patch" uk="/pætʃ/" us="/pætʃ/" client:only />
...
<WordRelations
  synonyms={["tract","area","blotch","period","section","spell","spot","stretch"]}
  client:only
/>
