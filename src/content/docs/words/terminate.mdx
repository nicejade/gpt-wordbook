---
title: Terminate
description: Terminate 是一个动词，意思是 “结束” 或者 “终止”，它通常用来表示某种行动、状态或存在的最后一刻或终结。
sidebar:
  hidden: true
...
<Pronunciation word="Terminate" uk="/ˈtɜːmɪneɪt/" us="/ˈtɜːmɪneɪt/" client:only />
...
<WordRelations
  synonyms={["discontinue","stop","axe","fire","sack"]}
  antonyms={["continue"]}
  client:only
/>
