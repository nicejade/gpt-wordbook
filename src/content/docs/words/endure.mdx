---
title: Endure
description: Endure 是一个动词，意思是 '忍耐' 或 '忍受'，表示在困境或不适的环境中保持存在或者保持坚持不屈。
sidebar:
  hidden: true
...
<Pronunciation word="Endure" uk="/ɪnˈdjɔː(ɹ)/" us="/ɪnˈd(j)ʊɹ/" client:only />
...
这个词"endure" 是来自于中古英语的"enduren"，进一步溯源来自法语“endurer”，它在英语中的使用可以追溯到 14 世纪。
...
<WordRelations
  synonyms={["persist","resist","survive","withstand","accept","thole","bear","take"]}
  client:only
/>
