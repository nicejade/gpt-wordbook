---
title: Powder
description: Powder是一个名词，意思是'粉'或者'粉末'。通常用来描述一种连续的片段或颗粒，细小到让它们可以自由流动。
sidebar:
  hidden: true
...
<Pronunciation word="Powder" uk="/ˈpaʊ.də(ɹ)/" us="/ˈpaʊ.də(ɹ)/" client:only />
...
Powder 源自拉丁语 "pulvis"，意思是 "dust"或者 "powder"。 这个词没有明确的词根。

### 词缀分析

"Powder"没有特定的词缀，但是它的复数形式是在词尾加上-s 或-es，形成"powders"。
