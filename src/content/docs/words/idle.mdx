...
description: >-
  idle
  是一个英语词汇，主要有两个基本含义。第一个是不忙碌的、闲置的，通常用来描述人或者物件没有正在进行活动或工作。第二个含义是无效的、无用的，用来描述无结果或无价值的
  action。
sidebar:
  hidden: true
...
"idle" 是一个英语词汇，主要有两个基本含义。第一个是不忙碌的、闲置的，通常用来描述人或者物件没有正在进行活动或工作。第二个含义是无效的、无用的，用来描述无结果或无价值的 action。

<Pronunciation word="Idle" uk="/ˈaɪd(ə)l/" us="/ˈaɪd(ə)l/" client:only />
...
<WordRelations synonyms={["pointless"]} client:only />
