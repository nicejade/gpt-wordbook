---
title: Verbal
description: Verbal是一个形容词，主要涉及到通过言语或者口头的形式来表达的意愿。它也可以作为一个名词使用，表示口语部分的考试或者评价。
sidebar:
  hidden: true
...
<Pronunciation word="Verbal" uk="/ˈvɜː.bəl/" us="/ˈvɝ.bəl/" client:only />
...
单词 "verbal" 来自拉丁语 "verbum"，意为 "词"。在大约 16 世纪时被引入英语，用于描述通过言语部分或口头表达的内容。
...
<WordRelations
  synonyms={["lectic", "literal", "verbatim", "rhematic", "wordish"]}
  antonyms={["implied", "unsaid", "substantive", "preverbal"]}
  client:only
/>
