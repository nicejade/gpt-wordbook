---
title: Weird
description: Weird 是一个形容词，主要意思是 '奇怪的'，'不寻常的'。它用来形容那些看起来、听起来或感觉起来与正常或预期的不同的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Weird" uk="/ˈwiːəd/" us="/ˈwiɚd/" client:only />
...
<WordRelations
  synonyms={["Norns","kismet","lot","orlay","wyrd","fortune","luck","foretale","foretelling","prognostication","cantrip","enchantment","incantation","bizarre","fremd","odd","strange","eerie","spooky"]}
  client:only
/>
