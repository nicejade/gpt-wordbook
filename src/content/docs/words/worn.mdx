---
title: Worn
description: worn 是 'wear' 的过去分词，然而，它一般用作形容词。 'worn' 意味着已经或者因为经过使用或年龄而变得破旧、损坏或者日常使用的痕迹。
sidebar:
  hidden: true
...
<Pronunciation word="Worn" uk="/wɔːn/" us="/wɔɹn/" client:only />
...
<WordRelations synonyms={["gybe"]} client:only />
