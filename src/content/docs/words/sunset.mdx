---
title: Sunset
description: Sunset 是一个英文单词，标示一天最后的那个时段，也就是太阳落山的过程，或者这个时间到了黑暗开始的一段时间。
sidebar:
  hidden: true
...
<Pronunciation word="Sunset" uk="/ˈsʌnˌsɛt/" us="/ˈsʌnˌsɛt/" client:only />
...
<WordRelations
  synonyms={["last","terminal","twilight","end","swansong","dusk","nightfall","sundown"]}
  antonyms={["sunrise"]}
  client:only
/>
