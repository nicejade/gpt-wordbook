---
title: Early
description: Early 是一个形容词，意思是“早的”或“早期的”。它也可以作为副词使用，表示“早”或“提前”。
sidebar:
  hidden: true
...
<Pronunciation word="Early" uk="/ˈɜː.li/" us="/ˈɝli/" client:only />
...
“Early” 这个单词来自于古英语 ǽr，其源自原始德语词语 airiz，意为“早”。这个词的使用频繁，已经成为英语常用词汇。
...
<WordRelations
  synonyms={["first", "premature", "prematurely"]}
  antonyms={["late", "terminal", "tardily"]}
  client:only
/>
