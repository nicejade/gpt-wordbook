---
title: North
description: North 可以用作名词，形容词和副词，它代表了方向概念中的'向北'或'北方'。
sidebar:
  hidden: true
...
<Pronunciation word="North" uk="/nɔːθ/" us="/noɹθ/" client:only />
...
<WordRelations synonyms={["boreal"]} antonyms={["south"]} client:only />
