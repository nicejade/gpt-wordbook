...
title: Dominant
description: >-
  dominant 是一个形容词，源于拉丁词
  'dominant-'，意为具有统治地位的，占优势的。它表示某个个体或事物在某个领域或群体中具有明显的优势或统治地位。
sidebar:
  hidden: true
...
<Pronunciation word="Dominant" uk="/ˈdɒmɪnənt/" us="/ˈdɒmɪnənt/" client:only />
...
"dominant" 最初来源于拉丁语 "dominans"，此单词在 14 世纪晚期首次出现在英语中，最初用于音乐领域，指代和弦进行中的主音。
...
<WordRelations
  synonyms={["dominator", "prevalent", "imposing"]}
  antonyms={["defiant", "obedient", "rebellious", "submissive"]}
  client:only
/>
