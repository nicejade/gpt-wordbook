...
title: Heritage
description: >-
  Heritage 是英语中的一个名词，它来源于法语的
  'héritage'，意思是'遗产'。它通常用来表示从前辈那里继承下来的物质财富或非物质传统，如我们的文化遗产、历史遗产等。
sidebar:
  hidden: true
...
<Pronunciation word="Heritage" uk="/ˈhɛɹɪtɪd͡ʒ/" us="/ˈhɛɹɪtɪd͡ʒ/" client:only />
