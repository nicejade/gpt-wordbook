---
title: Alter
description: Alter 是一个动词，意味着改变、变更或者调整。尽管“alter”通常与物理的改变有关，但它也可以指更抽象的概念，如计划或行为模式的调整。
sidebar:
  hidden: true
...
<Pronunciation word="Alter" uk="/ˈɑl.tɚ/" us="/ˈɔl.tɚ/" client:only />
...
由于 alter 的发音与“all+tear”相近，可以通过联想“所有泪水的改变”帮助记忆。
