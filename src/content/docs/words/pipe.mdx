---
title: Pipe
description: Pipe是一个常用的英语单词，其主要的含义是“管子”或者“烟斗”。也可以作为动词，表示“用管子输送”或者“鸣奏（疏通管道）”。
sidebar:
  hidden: true
...
<Pronunciation word="Pipe" uk="/paɪp/" us="/paɪp/" client:only />
...
<WordRelations synonyms={["pan", "bar", "virgule"]} client:only />
