...
description: >-
  Lazy
  是一个形容词，表示的是“懒散的，懒惰的'。用以形容那些不愿意工作或者不积极完成应做的事情的人。此外，'lazy'也可以用来形容行为或者做事的方式，若说“a
  lazy afternoon”，意思就是表示一个有悠闲、不紧张的气氛的下午。
sidebar:
  hidden: true
...
<Pronunciation word="Lazy" uk="/ˈleɪzi/" us="/ˈleɪzi/" client:only />
...
<WordRelations synonyms={["idle", "indolent", "slothful"]} client:only />
