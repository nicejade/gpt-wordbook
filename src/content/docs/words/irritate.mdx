---
title: Irritate
description: Irritate是一个动词，意味着'激怒'或'使烦躁'。它可以用来指任何让人失去耐心或感到困扰的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Irritate" uk="/ˈɪɹɪteɪt/" us="/ˈɪɹɪteɪt/" client:only />
...
"Irritate"这个词自 16 世纪开始使用，其基本含义自那时起就没有太大变化。
