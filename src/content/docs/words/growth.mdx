...
title: Growth
description: >-
  Growth是一个名词，主要有两大意义。其一是增长或发展，例如“经济增长”(economic growth)，或者“个人成长”(personal
  growth)。其二是生物体的生长，如“植物的生长”(the growth of the plant)。
sidebar:
  hidden: true
...
<Pronunciation word="Growth" uk="/ɡɹəʊθ/" us="/ɡɹoʊθ/" client:only />
...
<WordRelations
  synonyms={["development","maturation","enlargement","expansion","increase","increment","cancer","mass","vegetation"]}
