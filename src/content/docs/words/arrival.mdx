---
title: Arrival
description: Arrival是名词，表示到达或者抵达某个地方。
sidebar:
  hidden: true
...
<Pronunciation word="Arrival" uk="/əˈɹaɪ.vəl/" us="/əˈɹaɪ.vəl/" client:only />
...
<WordRelations antonyms={["departure", "nonarrival"]} client:only />
