---
title: Relevant
description: Relevant 是一个形容词，表示与当前情况或主题密切相关的。就好像说一个事物或信息与讨论的问题或决定具有重要的或直接的连接。
sidebar:
  hidden: true
...
<Pronunciation word="Relevant" uk="/ˈɹɛləvənt/" us="/ˈɹɛləvənt/" client:only />
...
"Relevant" 最早在 14 世纪的法律文献中出现，当时被用来表示"适当的，恰当的"。今天我们在日常对话和正式写作中广泛使用该词。
...
<WordRelations
  synonyms={["applicable","germane","pertinent","salient","current","prevailing","prevalent","rife"]}
  antonyms={["irrelevant"]}
  client:only
/>
