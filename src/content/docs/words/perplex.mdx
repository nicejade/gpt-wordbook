---
title: Perplex
description: Perplex 是个动词，意为“使困惑”或“使困窘”。当你被一些难题、棘手的问题或者难以理解的事物弄得困惑时，你就可以说你被'perplex'了。
sidebar:
  hidden: true
...
<Pronunciation word="Perplex" uk="/pəˈplɛks/" us="/pɚˈplɛks/" client:only />
...
"Perplex"的使用可以追溯到 15 世纪，当时意为"使..变得困惑"。它的词源来自拉丁语"per-" 和 "plexus"，其中 "plexus" 的意味着 "编织"，因此 "perplex" 初始的含义是 "使..变得复杂"，这也符合"使..困惑"的含义。
