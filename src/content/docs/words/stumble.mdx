---
title: Stumble
description: Stumble 是一个动词，直译为“跌倒”或“绊倒”，在广义上也指失误、错误，或者无意中发现。
sidebar:
  hidden: true
...
<Pronunciation word="Stumble" uk="/ˈstʌmbəl/" us="/ˈstʌmbəl/" client:only />
...
<WordRelations
  synonyms={["blooper","blunder","defect","error","fault","fluff","gaffe","lapse","mistake","slip","thinko"]}
  client:only
/>
