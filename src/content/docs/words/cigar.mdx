---
title: Cigar
description: Cigar(雪茄)指的是一个气密封装且可以点燃的烟草制品，通常比一般的香烟更大，可以慢慢抽吮，也被视为某些人的社交装饰。
sidebar:
  hidden: true
...
<Pronunciation word="Cigar" uk="/sɪˈɡɑː(ɹ)/" us="/sɪˈɡɑɹ/" client:only />
...
雪茄开始流行于 16 世纪，当时的探险者将它带回欧洲。雪茄在西班牙和意大利文化中尤其流行，被视为一种展示社会地位和品味的方式。

### 单词变形

cigar 作为名词，无复数形式，无其他变形。
...
<WordRelations synonyms={["stogie"]} client:only />
