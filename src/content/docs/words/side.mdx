---
title: Side
description: 英文单词 'side' 在中文里的意思通常是“侧面”，“旁边”或“一方”。它既可以作为名词，也可以作为动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Side" uk="/saɪd/" us="/saɪd/" client:only />
...
<WordRelations
  synonyms={["edge","face","half","team","page","channel","station"]}
  client:only
/>
