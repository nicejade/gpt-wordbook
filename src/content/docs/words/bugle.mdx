---
title: Bugle
description: "- 'Bugle' 是一个名词，通常指武器，我们通常称其为小号或军号，用于发出简单的音乐信号。"
sidebar:
  hidden: true
...
<Pronunciation word="Bugle" uk="/ˈbjuːɡəl/" us="/ˈbjuːɡəl/" client:only />
...
<WordRelations
  synonyms={["cone", "funnel", "bugleweed", "trumpet"]}
  client:only
/>
