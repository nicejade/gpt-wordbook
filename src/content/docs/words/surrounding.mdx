---
title: Surrounding
description: 单词 'surrounding' 通常作为形容词使用，用来描述周围的，附近的。也可作为名词使用，指周围环境或情况。
sidebar:
  hidden: true
...
Surrounding 作为形容词和名词，没有单复数、词性、时态变形。但其基本形式“surround”作为动词有不同时态，如："surrounds"(第三人称单数)，"surrounded"(过去式和过去分词)，"surrounding"(现在分词)。
...
<WordRelations
  synonyms={["bebay", "beleaguer", "beset", "periphery"]}
  client:only
/>
