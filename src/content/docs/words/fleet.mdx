...
title: Fleet
description: >-
  Fleet 是一个英文单词，既可以作为名词，亦可作为动词使用。作为名词时，常常被用来描述一组船只、飞机或车辆，例如：舰队（a fleet of
  ships）或者机队（a fleet of planes）。当它作为动词时，它的意思是“快速流动”，“飞逝”，正如我们常说的“时光飞逝”。
sidebar:
  hidden: true
...
<Pronunciation word="Fleet" uk="/fliːt/" us="/flit/" client:only />
