...
title: Gradually
description: >-
  Gradually是一个副词，意思是缓慢地，逐渐地，一点一点地。当你需要描述一些事情不是立刻发生，而是慢慢地、一点点地发生时，就可以使用'gradually'。
sidebar:
  hidden: true
...
<Pronunciation word="Gradually" uk="/ˈɡɹædʒuəli/" us="/ˈɡɹædʒuəli/" client:only />
...
<WordRelations
  synonyms={["incrementally","ponderously","sluggishly"]}
  client:only
/>
