---
title: Chef
description: Chef 是一名厨师，特别是在餐馆或酒店工作的专业厨师。
sidebar:
  hidden: true
...
<Pronunciation word="Chef" uk="/ʃɛf/" us="/ʃɛf/" client:only />
...
"Chef" 这个词在 19 世纪中叶引入英语。面对法国菏宴的影响，这个词用来指代副职：厨房的主管。
...
<WordRelations synonyms={["magirist", "magirologist"]} client:only />
