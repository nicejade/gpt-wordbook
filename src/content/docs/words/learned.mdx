...
description: >-
  ...
  也是一个形容词，描述一个人有深广的知识或经验。 **例句示例** 作为动词： 1. I learned English at
  school.（我在学校学习英语。） 2. She just learned that her husband got a
  promotion.（她刚刚得知她的丈夫得到了晋升。） 作为形容词： 3\. He is a learned scholar in the field of
  history.（他是历史领域的一位博学的学者。）
sidebar:
  hidden: true
