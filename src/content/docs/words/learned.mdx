...
title: Learned
description: >-
  Learned 是 'learn' 的过去式和过去分词，表示'学习'或'得知'的意思。另外，'learned'
  也是一个形容词，描述一个人有深广的知识或经验。
sidebar:
  hidden: true
...
作为形容词： 3. He is a learned scholar in the field of history.（他是历史领域的一位博学的学者。）

<Pronunciation word="Learned" uk="/ˈlɜːnɪd/" us="/ˈlɜːnɪd/" client:only />
...
<WordRelations
  synonyms={["brainy", "educated", "erudite", "knowledgeable", "scholarly"]}
