...
description: >-
  Newspaper
  是一个英文名词，中文简单翻译为“报纸”，意味着被印刷出来，定期发行（通常是每天或每周），并包含新闻，特稿，评论以及其他主题的文章的出版物。
sidebar:
  hidden: true
...
"Newspaper" 这个词在 16 世纪首次出现在英文中，最初用于描述市场的定期新闻摘要。英式英语中，"newspaper" 特指每日或每周出版的报纸，而美式英语里则包括所有常规新闻出版物。
...
<WordRelations synonyms={["daily", "paper", "rag", "newsprint"]} client:only />
