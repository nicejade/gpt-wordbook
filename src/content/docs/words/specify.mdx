---
title: Specify
description: Specify是一个动词，意思是“详细说明”、“明确指出”或“详细列举”。
sidebar:
  hidden: true
...
<Pronunciation word="Specify" uk="/ˈspɛsɪfaɪ/" us="/ˈspɛsɪfaɪ/" client:only />
...
<WordRelations synonyms={["disambiguate", "explicitize"]} client:only />
