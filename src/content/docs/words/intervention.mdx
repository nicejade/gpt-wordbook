---
title: Intervention
description: '"Intervention"是一个英语单词，直译为“干预，介入”。这是名词，主要表示对疾病、问题的不正常情况或在发生事情时进行的行动，以改变结果或过程。'
sidebar:
  hidden: true
...
"Intervention"首次出现在大约在 15 世纪的英语文献中，来自于法语"intervention"，又来自于拉丁语"interventionem"。
