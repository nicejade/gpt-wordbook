---
title: Toe
description: Toe是英语中的一个名词，指的是'脚趾'。它也可以作动词使用，意为'轻轻地踢'或者'用脚趾触碰'。
sidebar:
  hidden: true
...
<Pronunciation word="Toe" uk="/təʊ/" us="/toʊ/" client:only />
...
<WordRelations synonyms={["hoof"]} antonyms={["heel", "tail"]} client:only />
