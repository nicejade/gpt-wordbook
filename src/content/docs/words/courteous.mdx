---
title: Courteous
description: Courteous 是一个形容词，表示的是在态度和行为上都充满礼貌的人。这个词通常被用来形容有敬意的举动和礼貌待人的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Courteous" uk="/ˈkɜːti.əs/" us="/ˈkɝti.əs/" client:only />
...
<WordRelations antonyms={["discourteous", "uncourteous"]} client:only />
