...
description: >-
  Modest
  是一个形容词，意思是谦虚的、适度的、不夸张的。这也可以用来形容一个人的行为品格，即不喜欢夸夸其谈，避免过度显示自己的才能或成就。同样，它也可以描述一个数量、价格或规模在适中范围内。
sidebar:
  hidden: true
...
<Pronunciation word="Modest" uk="/ˈmɑdəst/" us="/ˈmɑdəst/" client:only />
...
Modest 是一个单一形式的单词，没有前缀和后缀。

### 文化背景

这个词在 16 世纪时从法语引入英语，主要是用来形容人的品行修养和精神性质。在近代，它的使用更广泛，也用来描述物量的适当或适中。
...
<WordRelations antonyms={["immodest"]} client:only />
