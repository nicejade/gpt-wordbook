---
title: Home
description: Home是英语中最常见的单词之一，表示家，也可以指人生活、生存的地方。它既可以用作名词，也可以用作形容词或副词。
sidebar:
  hidden: true
...
<Pronunciation word="Home" uk="/(h)əʊm/" us="/hoʊm/" client:only />
...
<WordRelations
  synonyms={["abode","domicile","dwelling","house","residence","tenement","homeward"]}
