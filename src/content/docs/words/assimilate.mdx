...
title: Assimilate
description: >-
  Assimilate这个词具有多层含义，主要涵盖以下几个方面：1.吸收并理解信息或知识；
  2.将吸收的事物彻底地或是成功地融入、整合到系统或体系中；3.在生物学上，指生物体吸收并化用营养物质。
sidebar:
  hidden: true
...
"Assimilate"这个词源自拉丁语“assimilare”，在 15 世纪中期进入英语，且开始用于生物学和社会科学领域。
...
<WordRelations synonyms={["integrate", "process"]} client:only />
