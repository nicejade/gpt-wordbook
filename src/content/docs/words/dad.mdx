---
title: Dad
description: Dad是英语中表示父亲的一个非正式词汇，类似于中文中的“爸爸”。
sidebar:
  hidden: true
...
<Pronunciation word="Dad" uk="/dæd/" us="/dæd/" client:only />
...
"Dad"源自 14 世纪的古英语，许多语言中都存有类似的名词，用来表示亲密和熟悉的父亲。在美国文化中，"Dad"和"Daddy"通常用于儿童和年轻人跟父亲互动时。
...
<WordRelations
  synonyms={["Pa","Pop","daddy","pa","paw","pop"]}
  client:only
/>
