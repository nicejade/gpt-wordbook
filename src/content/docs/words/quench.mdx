...
title: Quench
description: >-
  Quench 是一个动词，基本意思是“熄灭”或“扑灭”，就像扑灭火焰或汽车刹车片过热后冷却下来一样。其次，'quench'
  还可以表示“解渴”，就像喝水解渴。
sidebar:
  hidden: true
...
<Pronunciation word="Quench" uk="/kwɛnt͡ʃ/" us="/kwɛnt͡ʃ/" client:only />
...
"Quench" 是一种很早就在英语中使用的词，自 10 世纪开始使用。其词源楚顿语 quenken，意为 '熄灭'，并将其延伸到 '熄灭人的欲望或需求'。
...
<WordRelations synonyms={["appease", "slake"]} client:only />
