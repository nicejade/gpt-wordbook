...
description: >-
  Orthodox
  是一个英语形容词。它有两个主要的含义，第一个是指传统的，遵循传统或者惯例的；第二个是指正统的，在宗教领域中，经常用来表达信仰或者观念是正统的，被普遍认可的。
sidebar:
  hidden: true
...
<Pronunciation word="Orthodox" uk="/ˈɔːθədɒks/" us="/ˈɔːɹθədɑks/" client:only />
...
Orthodox 一词在英语中，最早在公元 1635 年左右使用，最初主要在宗教语境中使用，用来表示接受并维持正统教义的。由于其在宗教领域的重要性，'orthodox' 往往带有权威和传统的色彩。
...
<WordRelations
  ...
  antonyms={["heretical","heterodox","unorthodox","liberal","outlandish"]}
  client:only
/>
