---
title: Deficit
description: Deficit 可以用于形容个人，团体或者国家的财富缺口或收入不足。
sidebar:
  hidden: true
...
<Pronunciation word="Deficit" uk="/ˈdɛfɪsɪt/" us="/ˈdɛfɪsɪt/" client:only />
...
"Deficit" 一词在 17 世纪中叶开始在法文中使用，由拉丁词 "deficere" 演变而来。原始的意思是缺乏或不足，现在它主要用来表示经济领域的资金短缺。
...
<WordRelations synonyms={["shortfall"]} antonyms={["superavit"]} client:only />
