...
description: >-
  "Melancholy"
  是一个形容词，也可以作为名词使用。作为名词，它用来描述一种深深的、持久的、无明显原因的伤感或忧郁的情绪状态。作为形容词，它则用来形容情绪低落、忧郁的人或事物。
  例如： - He felt a strange sense of melancholy. (他感到一种奇怪的忧郁。) - The music has a
  melancholy feel to it. (这首音乐给人一种忧郁的感觉。)
sidebar:
  hidden: true
