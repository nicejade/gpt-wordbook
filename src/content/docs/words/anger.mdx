---
title: Anger
description: Anger是名词，指的是怒火，愤怒的情绪。
sidebar:
  hidden: true
...
<Pronunciation word="Anger" uk="/ˈæŋɡə(ɹ)/" us="/ˈæŋɡɚ/" client:only />
...
想象一个情景，你的电脑突然死机了，你的工作没能保存，你可能会感到 Anger，这就是"愤怒"的感觉。
...
<WordRelations
  synonyms={["angry","get","aggravate","annoy","displease","grill","irritate"]}
  client:only
/>
