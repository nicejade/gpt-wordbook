---
title: Member
description: Member 这个单词主要用于表示'成员'或者'会员'的含义，指的是某个团体、组织、俱乐部等中的一份子。
sidebar:
  hidden: true
...
<Pronunciation word="Member" uk="/ˈmɛmbə/" us="/ˈmɛmbɚ/" client:only />
...
(自小，John 就是当地图书馆的一名忠实会员。他每个星期六都会去图书馆借一本书，沉浸在各种各样的世界中。)

<WordRelations
  synonyms={["element","limb","premise"]}
  client:only
/>
