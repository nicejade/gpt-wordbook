...
title: CBA
description: >-
  CBA 通常用作一个缩写，它有多种可能的解释。 在体育领域，它最常用于指 "Chinese Basketball
  Association"，即“中国篮球协会”。然而也可以表示 "Collective Bargaining Agreement"，意为"集体协商协议"
  ，这是在工会和企业之间达成的工资和工作条件等的一种协议。 由于 CBA 可以有许多含义，理解它的含义通常需要上下文的帮助。
sidebar:
  hidden: true
