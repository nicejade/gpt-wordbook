...
title: Band
description: >-
  "Band" 是一个英语单词，它可以有以下几种基本含义： 1. 乐团，一组演奏音乐的人，例如："The Beatles" 是一个很有名的乐团。 2.
  带子，一条装饰或用途的狭长片材，例如："She tied a band in her hair." （她在头发上扎了个发带。） 3.
  波段，特定频率范围的一系列无线电波，例如："The radio station operates on a different band."
  （该电台在不同的频段上运行。）
sidebar:
  hidden: true
...
"Band" 这个词最早在 14 世纪的作品中，用以指带状的东西。19 世纪时期，乐团的概念开始诞生，并成为 "band" 的另一种主要含义。
