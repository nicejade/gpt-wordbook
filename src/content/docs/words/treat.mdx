---
title: Treat
description: Treat 是一个常用的英语单词，它可以用作动词和名词，有不少不同的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Treat" uk="/tɹiːt/" us="/tɹiːt/" client:only />
...
<WordRelations synonyms={["leech", "behandle"]} client:only />
