...
title: Haughty
description: >-
  Haughty 是一个形容词，用来形容那些表现出傲慢或自大态度的人。如果一个人的行为、言语或体态表现出他自认为比别人好或更优秀，就可以用 'haughty'
  来形容他。
sidebar:
  hidden: true
...
<Pronunciation word="Haughty" uk="/ˈhɑti/" us="/ˈhɑti/" client:only />
...
"Haughty" 的使用可以追溯到 14 世纪的中古英语。这个词通常用来形容有高傲、自大的行为或性格的人。
