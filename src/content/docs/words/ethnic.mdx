---
title: Ethnic
description: Ethnic 是英语中的一个形容词，其主要意义是“种族的”，“民族的”或“具有共同族群特征的”。
sidebar:
  hidden: true
...
<Pronunciation word="Ethnic" uk="/ˈɛθ.nɪk/" us="/ˈɛθ.nɪk/" client:only />
...
"Ethnic" 这个词源自于 15 世纪的希腊语，被用来描述从一个固定的地理区域来的人群或继承了一定的文化传统的人群。在现今的社会和文化环境中，"ethnic "常常被用来强调我们身份的一部分，这部分与我们的文化遗产，祖先，或者社区的特性紧密相连。
...
<WordRelations synonyms={["exotic", "gentile", "pagan"]} client:only />
