...
title: Cut
description: >-
  Cut 是一个非常常用的英文单词，根据环境和上下文，它有不同的意义。在最直接的理解上，'cut' 作为动词使用，意思是“剪”，“切割”，“削减”。如： 'I
  cut an apple.' (我切了一个苹果)。同时 'cut' 也可以作为名词，表示 '切口'，'削减'，'截断'，以及 '切块'等等。
sidebar:
  hidden: true
...
<Pronunciation word="Cut" uk="/kʌt/" us="/kʌt/" client:only />
