---
title: Alien
description: Alien 在英文中主要有两个含义：一是作为形容词，表示 '外来的，外国的，异乎寻常的'；二是作为名词，表示 '外星人，非法移民'。往往根据上下文进行理解。
sidebar:
  hidden: true
...
<Pronunciation word="Alien" uk="/ˈeɪ.li.ən/" us="/ˈeɪ.li.ən/" client:only />
...
（从前，一个叫 Bob 的外星人降落在地球上。这里的一切对他来说都很陌生，树木，建筑物，语言。但驱使着他的是好奇心，Bob 开始探索这个陌生的世界。）

<WordRelations
  synonyms={["guest","stranger"]}
  client:only
/>
