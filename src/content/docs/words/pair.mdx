...
title: Pair
description: >-
  - 'Pair' 是英文中的一个常用词，主要用来表示一对或者是配对的概念，通常用于描述两个相似或相配的人或物。例如，我们经常会说 'a pair of
  shoes'（一双鞋），'a pair of glasses'（一副眼镜），或者 'a pair of people'（一对人）。
sidebar:
  hidden: true
...
<Pronunciation word="Pair" uk="/pɛə(ɹ)/" us="/pɛɹ/" client:only />
...
- "Pair" 源于中古英语的词汇 "pare"，并于 14 世纪从法语借用过来。在这个过程中，这个词一直坚持着 "两者" 的含义，这就是为什么我们现在用它来描述一对或者是配对的物品。
...
<WordRelations synonyms={["spectacles"]} client:only />
