...
title: Bulk
description: >-
  bulk 作为名词，代表了重量、大量或者大块，在英语中它具有大部分、主体的意义，正如在'the bulk of the work'
  中，它就表示'大部分的工作'。作为动词，'bulk' 意味着变得更大、增长，常见于词组 'bulk up'，表示'增加体重、壮大身形'。
sidebar:
  hidden: true
...
<Pronunciation word="Bulk" uk="/bʌlk/" us="/bʌlk/" client:only />
