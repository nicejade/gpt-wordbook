...
title: Convert
description: >-
  Convert 是一个动词，源自拉丁语词根 'converto'，意为“改变，转换”。在英语中，'convert'
  的意思相当广泛，可以用来描述任何类型的改变或转换。常见的用来表示从一种形式、类型、单位、系统、方法或信仰等转换为另一种的过程。
sidebar:
  hidden: true
...
<Pronunciation word="Convert" uk="/ˈkɒn.vəːt/" us="/ˈkɑn.vəɹt/" client:only />
...
<WordRelations antonyms={["deconvert"]} client:only />
