---
title: Fairness
description: Fairness是名词，代表公平、公正、公平待遇的概念。这个词可以用来描述任何被认为是公正、平等的情况或决定。
sidebar:
  hidden: true
...
“Fair”一词最早见于公元前 8 世纪的英格兰。那时候它主要是用来描述美丽和光明。到了中世纪，它开始被用作形容词，形容公平和正直。现代英语中的"fairness "一词延续了此义。
...
<WordRelations synonyms={["beauty", "fairhood"]} client:only />
