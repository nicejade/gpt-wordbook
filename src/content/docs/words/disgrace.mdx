---
title: Disgrace
description: Disgrace 是一个英文词汇，代表'丢脸'或'耻辱'，可以作为名词或动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Disgrace" uk="/dɪsˈɡɹeɪs/" us="/dɪsˈɡɹeɪs/" client:only />
...
"Disgrace"这个词在 15 世纪法语引入英语后逐渐流行起来，本身没有太多的文化背景，但在欧美社会中，人们极其看重名誉和面子，所以经常使用。
...
<WordRelations synonyms={["dishonor", "ignominy", "misgrace"]} client:only />
