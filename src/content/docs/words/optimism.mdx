...
description: >-
  Optimism
  是一个英文名词，它的中文翻译一般为“乐观”。“Optimism”是指一个人或一种态度对未来充满希望和信心，期待结果会是积极的、好的。例如，你可以说：“Her
  optimism inspires everyone around her.”（她的乐观鼓舞了身边的每一个人。）
sidebar:
  hidden: true
...
<WordRelations antonyms={["pessimism"]} client:only />
