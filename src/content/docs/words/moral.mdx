...
title: Moral
description: >-
  Moral 是一个形容词，表示与道德或者伦理有关的。比如，moral principles
  意思是“道德原则”。它也可作名词，表示教训或一种教诲，经常用在故事或经验的结尾。
sidebar:
  hidden: true
...
<Pronunciation word="Moral" uk="/ˈmɒɹəl/" us="/ˈmɑɹəl/" client:only />
...
"Moral" 来自拉丁语 "mōrālis"，它最初是含义更广泛，涵盖 "manners", "customs"， "character"或 "proper behavior"等。然而，由于宗教等因素的影响，19 世纪以后，"moral"的含义逐渐窄化，主要用来指与 "ethics" 或者 "virtues" 有关的概念。
...
<WordRelations
  synonyms={["ethics","mores","ethical","incorruptible","noble","righteous","virtuous","virtual"]}
  antonyms={["amoral","corrupt","immoral","unethical","unmoral","unscrupulous"]}
  client:only
/>
