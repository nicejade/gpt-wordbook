---
title: Listen
description: Listen 是一个动词，其核心词义是“听”。在具体使用中它可以表示平常我们说的“听音乐、听报告、听小时候的故事”等等。
sidebar:
  hidden: true
...
<Pronunciation word="Listen" uk="/ˈlɪs.ən/" us="/ˈlɪs.ən/" client:only />
...
<WordRelations
  synonyms={["play","agree","assent","hearken","mind","obey","anticipate","await","expect","hear","heed","attend","behear","hark","list","note"]}
