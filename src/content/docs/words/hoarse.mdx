...
description: >-
  hoarse
  这个单词是形容词，用来描述由于喉咙疼痛或者过度使用导致的声音嘶哑或者沙哑。这个词通常用于描述人的声音，但也可以用来形容动物，如“嘶哑的狗吠声”。
sidebar:
  hidden: true
...
<Pronunciation word="Hoarse" uk="/hɔːs/" us="/hoɹs/" client:only />
...
"Hoarse" 这个词在英语中使用的历史可以追溯到公元前 413 年，最初源自古英语 "hās"，与荷兰语 "hees" 和德语 "heiser" 同源，意为 "嘶哑"。
