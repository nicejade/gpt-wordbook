---
title: Headache
description: Headache是一个英语名词，表示'头痛'。它常常用于描述由于各种原因（如压力、疾病或者紧张）造成的头部的疼痛。
sidebar:
  hidden: true
...
<Pronunciation word="Headache" uk="/ˈhɛdeɪk/" us="/ˈhɛdeɪk/" client:only />
...
"Headache"的使用可以追溯到公元前 1200 年的古希腊，其在欧美文化中，除了直接表示头部的疼痛，也常用于形容一些比较讨厌或者麻烦的事情。
...
<WordRelations synonyms={["bother", "cephalalgia"]} client:only />
