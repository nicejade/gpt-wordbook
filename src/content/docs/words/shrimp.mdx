---
title: Shrimp
description: Shrimp 通常用来指鱼虾类中的一种小型虾，我们经常在烹饪或食品中看到。此外，'shrimp'还可以作为贬义词，指的是身材瘦小、力量微弱的人。
sidebar:
  hidden: true
...
<Pronunciation word="Shrimp" uk="/ʃɹɪmp/" us="/ʃɹɪmp/" client:only />
...
<WordRelations synonyms={["prawn"]} client:only />
