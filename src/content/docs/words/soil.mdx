---
title: Soil
description: Soil 是一个名词，意思是'土壤'。它是固体表面的上层，通常充满有机物质和无机物质，植物根部的主要生长环境。
sidebar:
  hidden: true
...
<Pronunciation word="Soil" uk="/sɔɪl/" us="/sɔɪl/" client:only />
...
"Soil" 这个词在英语中大约于 14 世纪开始使用，源自拉丁文的"soles"，意思是"地面"，它的使用反映了人们对环境和农业的重视。
...
<WordRelations synonyms={["dirt", "earth"]} client:only />
