---
title: Pride
description: pride 在英语中通常用作名词，意为“自豪”或“骄傲”，表示对自身的一种自满和夸耀。当代表一群雄狮时，也使用'pride'一词。
sidebar:
  hidden: true
...
<Pronunciation word="Pride" uk="/pɹaɪd/" us="/pɹaɪd/" client:only />
...
<WordRelations
  synonyms={["dignity","sandpiper","conceit","disdain"]}
  client:only
/>
