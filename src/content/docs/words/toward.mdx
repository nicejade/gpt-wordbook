---
title: Toward
description: Toward是一个英语的介词，主要表示方向、目标或者趋势，另外，也可表示关于某事或某人的态度和感觉。
sidebar:
  hidden: true
...
<Pronunciation word="Toward" uk="/tɘ.ˈwoːd/" us="/tʊ.ˈwɔɹd/" client:only />
...
<WordRelations
  synonyms={["imminent","proximate","coming","towards"]}
  antonyms={["fromward","froward"]}
  client:only
/>
