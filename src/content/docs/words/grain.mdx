---
title: "grain"
description: "Grain 是一个非常常用的英文单词，它主要有两种含义： 1. 指粮食或谷物，如 wheat grain (小麦粒)； 2. 指事物的纹理或结构，如 wood grain (木头的纹理)。"
---
...
"Grain" 这个词汇在中世纪英语中就已经开始使用，用于形容谷物。而 "grain" 表示纹路或质地的含义，则是在 16 世纪开始出现的。
