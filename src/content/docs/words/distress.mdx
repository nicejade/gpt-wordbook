...
title: Distress
description: >-
  Distress 是一个名词，通常意味着极度的痛苦、痛心或忧虑。例如，身体的 distress 可能会指身体疾病或伤害，精神的 distress
  可能会指精神痛苦或压力。
sidebar:
  hidden: true
...
<Pronunciation word="Distress" uk="/dɪˈstɹɛs/" us="/dɪˈstɹɛs/" client:only />
...
"Distress" 最早的用法可以追溯到 14 世纪的英语，用于描述因贫困、疾病、痛苦等原因导致的不幸或灾难。
...
<WordRelations
  synonyms={["age","antique","anguish","martyr","tantalize","torment","trouble"]}
  antonyms={[]}
  client:only
/>
