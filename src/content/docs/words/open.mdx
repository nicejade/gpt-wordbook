---
title: Open
description: Open 是一种常见的英语单词，可以用作多种词性，包括名词、动词、形容词和副词。
sidebar:
  hidden: true
...
<Pronunciation word="Open" uk="/ˈəʊ.pən/" us="/ˈoʊ.pən/" client:only />

### 列举例句

1.  Could you please open the window? (你能打开窗户吗？)
2.  The shop is open from 9 am to 5 pm. (店铺从早上 9 点营业到下午 5 点。)
...
来自古英语的"openian"，意思是"打开、揭示"，在很多英语国家和地区，人们会用 open 来表示公正、透明和无障碍，体现了这些地方倡导开放和自由的文化价值。
...
<WordRelations
  synonyms={["free", "accessible", "unimpeded"]}
  antonyms={["closed", "shut", "checked", "proprietary"]}
  client:only
/>
