---
title: Triangle
description: Triangle 是一个英文名词，它的意思是 '三角形'。它通常用来描述具有三个角和三个边的几何形状。
sidebar:
  hidden: true
...
<Pronunciation word="Triangle" uk="/ˈtɹaɪəŋɡəl/" us="/ˈtɹaɪˌæŋɡəl/" client:only />
...
<WordRelations
  synonyms={["threeside","trigon","bluebottle","wye"]}
  client:only
/>
