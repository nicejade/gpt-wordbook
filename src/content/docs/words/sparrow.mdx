---
title: Sparrow
description: Sparrow 是英文的'麻雀'的意思。在北美和亚洲把许多小型鸟类称为'Sparrow'，但它们并不一定都是我们常说的麻雀。
sidebar:
  hidden: true
...
<Pronunciation word="Sparrow" uk="/ˈspæɹəʊ/" us="/ˈspæɹoʊ/" client:only />
...
Sparrow 没有词缀，它是一个单独的词。

### 文化背景

Sparrow 这个词源自古英语的"spearwa"，意为麻雀。在欧美文化中，sparrow 常被用作谦卑，普通或无关紧要的象征。

### 单词变形

Sparrow 的复数形式是 sparrows，中文翻译是“麻雀们”。
...
<WordRelations
  synonyms={["spadger", "sparra", "spoggy", "spuggy"]}
  client:only
/>
