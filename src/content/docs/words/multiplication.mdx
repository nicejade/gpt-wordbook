...
description: '"Multiplication"是一个英文单词，它的基本含义是"乘法"。它可以描述数学中的一种运算操作，也可以指代增加或扩大。'
sidebar:
  hidden: true
...
Multiplication 一词来自于拉丁词根 "multi-", 指的是 "多"，而"-plic-"指的是 "折叠"。由这些词根派生出来的其他单词有例如:
...
"Multiplication"的词缀包括前缀 "multi-"标志着"多"的意思, "-plic-" 是词根，意为"折叠"或"翻倍"，而"-ation" 是后缀，表示动作或过程。如 Addition (加法) 和 Inspection (检查) 等词就使用了相同的后缀 "-ation"。
