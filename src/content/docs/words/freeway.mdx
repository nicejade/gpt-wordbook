...
title: Freeway
description: >-
  Freeway是一个英语单词，来源于美式英语，指的是高速公路，一种设计用于高速行驶的特殊公路，实行车辆分流，通常设有多个车道，并且没有红绿灯或路口，通行效率高。
sidebar:
  hidden: true
...
<Pronunciation word="Freeway" uk="/ˈfɹiː.wei/" us="/ˈfɹiː.wei/" client:only />
...
在美国，高速公路被命名为"freeway"，这个词诞生于 20 世纪 30 年代的汽车繁荣时期。"Freeway"这个词汇反映了美国汽车文化的注重速度和效率的特性。
...
<WordRelations synonyms={["fwy"]} client:only />
