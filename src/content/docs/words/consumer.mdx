---
title: Consumer
description: Consumer 在英文中主要指的是“消费者”，就是购买商品或服务并为其付款的个人或团体。
sidebar:
  hidden: true
...
Consumer 这个词在 14 世纪的法语中就出现过，原意是"吞食者"。到了 16 世纪，这个词在英语中被广泛用于描述"花费者"，也就是我们现在所说的"消费者"。
...
<WordRelations antonyms={["producer"]} client:only />
