...
title: Organiser
description: >-
  Organiser是英语中的一个名词，其主要含义是'组织者'或'策划者'，指在活动或事件中负责计划和协调的人。它也可以指代一个用来管理日程的设备，比如日程表或文件夹。
sidebar:
  hidden: true
...
"John, the organiser of our community event, did a fantastic job ensuring everything went smoothly."（我们社区活动的组织者 John 做得非常好，确保一切顺利进行。）
中文翻译: "我们社区活动的组织者约翰做得非常好，确保一切顺利进行。"

<WordRelations
  synonyms={["chief","comptroller","controller","foreman","head","overseer","superintendent","supervisor"]}
  client:only
/>
