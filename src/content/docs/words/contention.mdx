...
title: Contention
description: >-
  Contention是个名词，来自拉丁词根'contendere'，意思是争斗或斗争。在英语里，它被常常用于讨论中，表示一个人所持有的观点，尤其是在辩论或者讨论中，代表了一方的立场或观点，也指争论或争端。
sidebar:
  hidden: true
...
这个词在 14 世纪时引入英文，并保持了其在拉丁语中的争斗含义。对抗或争论被视为推动社会进步的重要方式，因此"contention"是政治和学术讨论中常用的词。
...
<WordRelations
  synonyms={["gainstrife", "gainstriving", "wrangling"]}
  client:only
/>
