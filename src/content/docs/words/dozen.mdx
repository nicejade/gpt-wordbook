---
title: Dozen
description: Dozen 是一个数量词，意为“一打”，即数目为 12 的一组。它常用来表示大致的数量，而非一个确切的数字。
sidebar:
  hidden: true
...
"Dozen" 是一个数量词，意为“一打”，即数目为 12 的一组。它常用来表示大致的数量，而非一个确切的数字。

<Pronunciation word="Dozen" uk="/ˈdʌzən/" us="/ˈdʌzən/" client:only />
...
"Dozen" 一词源自 13 世纪的英语，表示“十二个”。它来自于老法语 "douzaine"，意思也是“一组十二”。在欧美文化中，"dozen" 这个词常常用来表示一组或大约的数量。
...
你可以将 "dozen" 和 "12" 这个数字联系起来，这样你就可以轻松记住这个单词。毕竟 "dozen" 的含义就是 12。
...
<WordRelations
  synonyms={["heaps","hundreds","loads","lots","many","millions","scads","scores","thousands"]}
  antonyms={["few"]}
  client:only
/>
