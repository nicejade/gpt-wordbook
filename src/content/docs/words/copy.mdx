...
<Pronunciation word="Copy" uk="/ˈkɒpi/" us="/ˈkɑpi/" client:only />
...
<WordRelations
  synonyms={["duplicate","facsimile","fake","forgery","image","likeness","phony","replica","replication","reproduction","sham","simulacrum"]}
  antonyms={["original"]}
  client:only
/>
