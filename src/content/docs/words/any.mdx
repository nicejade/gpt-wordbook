...
description: >-
  Any
  是一个常用的英语单词，主要在询问和否定句中使用。它可以表示'任何的'或者'无论哪个'，也可用在一些特定情况下表示'无所谓的、随便的'。其中，'any'
  作为限定词，可以修饰可数名词单数和复数形式，也可以修饰不可数名词。
sidebar:
  hidden: true
...
<Pronunciation word="Any" uk="/ˈæni/" us="/ˈɛni/" client:only />
