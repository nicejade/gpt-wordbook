...
title: Prayer
description: >-
  Prayer是一个名词，这个词的基本含义是“祈祷”，是一个人对神或者其他神圣的存在发出的宗教性的请求，感谢或者赞美。此外，“prayer”也可以引申为对愿望的强烈希望或者请求。
sidebar:
  hidden: true
...
<Pronunciation word="Prayer" uk="/pɹɛə(ɹ)/" us="/pɹɛɚ/" client:only />
...
<WordRelations synonyms={["bead", "orison", "precation"]} client:only />
