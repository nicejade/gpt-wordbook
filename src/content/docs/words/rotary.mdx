---
title: Rotary
description: Rotary是一个形容词，其主要含义是'旋转的'、'轮转的'或者是'环形的'。这个词也可以用作名词，通常指'旋转机械'或'旋转交通岛'。
sidebar:
  hidden: true
...
<Pronunciation word="Rotary" uk="/ˈɹoʊtəɹi/" us="/ˈɹoʊtəɹi/" client:only />
...
"Rotary"这个单词在英语中一直被广泛使用，特别是在描述各种机械设备的旋转动作时。在 19 世纪，随着工业革命的推进，涌现出了许多新型的旋转设备，这让"rotary"这个词的使用频率大大增加。
