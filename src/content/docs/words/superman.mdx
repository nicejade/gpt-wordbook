...
title: Superman
description: >-
  Superman 是由 'super-' 和 'man' 两个部分组成的组合词。'super-' 是前缀，来源于拉丁语，表示“超越，超过常人”，'man'
  就是我们通用的 '男人'。所以，'superman' 的直接翻译是'超人'。
sidebar:
  hidden: true
...
"Superman"最早可以追溯到尼采的哲学作品，被用来描述人类对超越者的理想。但如今，"superman"一词在西方文化中更多的是被用来指代 DC 超级英雄一般的角色。
...
<WordRelations antonyms={["netherman"]} client:only />
