...
description: >-
  Lift
  这个单词在英语中有很多不同的含义和用法。首先，作为名词，它常被用来指代电梯，此外也可以表示举起、提升或抬高的行动。而作为动词，它则常被用来描述抬起或举起某物的动作。此外，'lift'
  还可以表示提升某人的精神状态，或是使情感、气氛得到提高。
sidebar:
  hidden: true
...
<Pronunciation word="Lift" uk="/lɪft/" us="/lɪft/" client:only />
...
<WordRelations synonyms={["elevator", "ride", "uplift"]} client:only />
