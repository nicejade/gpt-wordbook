...
description: >-
  Afternoon
  是一个时间相关的英文单词，指的是从正午（midday）过后到黄昏（dusk）之前的一段时间。在日常英文中，它主要用来表示一天中的下午时间。
sidebar:
  hidden: true
...
"Afternoon" 的词源来源于早期的英语“æfternōn”在 16 世纪时，由"after"和"noon"两个词组合起来，指的是午餐以后的时段。
...
<WordRelations synonyms={["aft", "arvo", "undern"]} client:only />
