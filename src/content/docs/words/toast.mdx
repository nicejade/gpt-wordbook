---
title: Toast
description: Toast一词在英语中有两种主要含义：1）一个被烤过或烘烤过的面包片；2）在庆祝时举杯赞美或祝愿的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Toast" uk="/təʊst/" us="/toʊst/" client:only />
...
"Toast"一词最早可以追溯到 14 世纪，初衷是对食物的烹饪方式的描述。而到了 17 世纪，人们在庆祝时开始民间宴会上，人们喜欢在酒中放入烤面包，从后来发展为在饮酒时用来表示赞美或祝愿的手势。

### 单词变形

Toast 没有多种变形，但可以改变构词法来制成不同的词，例如：Toast + er = Toaster (烤面包机).
