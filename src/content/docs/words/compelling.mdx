---
title: Compelling
description: Compelling是一个英语形容词，意为'引人注目的'、'令人信服的'、'不可抵抗的'。通常用于描述某事物或论点力量极强，足以吸引人的注意力，或使人信服。
sidebar:
  hidden: true
...
Compelling 源于拉丁词根 "pellere"，意为"推"、"驱动"。其他由这个词根衍生出来的单词还有 expel（驱逐）、repellent（驱虫剂、令人反感的事物）等。

### 词缀分析

Compelling 由前缀"com-"和词根 "-pell-"以及后缀"-ing"组成。 "com-" 是拉丁词前缀，表示 "共同"或者"加强"；词根 "-pell-" 意为"推"、"驱动"；后缀 "-ing"常用于形成现在分词。

例如： 同样以"com-"为前缀的单词还有如：community, communication，common 等。
...
Compelling 的本质是一个形容词。

它的名词形式为 Compulsion（强迫、冲动），动词形式为 Compel（迫使，强迫）。
