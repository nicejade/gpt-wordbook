...
title: Moon
description: >-
  Moon 是英语中一个非常常用的单词，表示“月亮”，即地球的唯一自然卫星。例如：'I can see the moon in the sky.'
  (我可以看见天空中的月亮。)
sidebar:
  hidden: true
...
<Pronunciation word="Moon" uk="/muːn/" us="/muːn/" client:only />
...
<WordRelations synonyms={["Luna", "Moon", "month", "satellite"]} client:only />
