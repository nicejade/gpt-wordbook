---
title: Coffin
description: Coffin 是英语的一个名词，中文意思是“棺材”，用于装载死者的木箱或类似容器。
sidebar:
  hidden: true
...
<Pronunciation word="Coffin" uk="/ˈkɑfɪn/" us="/ˈkɔfɪn/" client:only />
...
<WordRelations synonyms={["casket", "encoffin"]} client:only />
