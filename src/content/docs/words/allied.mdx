---
title: Allied
description: '例如：allied forces (联合军队), allied industries (相关联的产业）。'
sidebar:
  hidden: true
...
<Pronunciation word="Allied" uk="/əˈlaɪd/" us="/əˈlaɪd/" client:only />
...
(在二战期间，同盟国军队发起了声名狼藉的“D 日”的行动，标志着战争的重大转折。这个联盟被颂扬为一群共同对抗邪恶的力量。)
