---
title: Beginner
description: Beginner 是一个名词，意思是“初学者”或者“新手”，指的是在某个领域或技能中的新加入者或刚开始学习的人。
sidebar:
  hidden: true
...
<Pronunciation word="Beginner" uk="/bɪˈɡɪnə/" us="/bɪˈɡɪnə/" client:only />
...
"Beginner" 这个词在 18 世纪开始广泛使用，用来形容对某事或某项技能了解甚少或兴趣刚刚开始的人。
...
<WordRelations synonyms={["amateur", "newbie"]} client:only />
