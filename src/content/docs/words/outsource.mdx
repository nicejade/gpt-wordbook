---
title: Outsource
description: Outsource是一个动词，主要意思是将一个组织的某些职能、任务或服务外包给外部供应商完成， 通常进行外包是为了降低成本，提高效率或者专注于核心业务。
sidebar:
  hidden: true
...
<Pronunciation word="Outsource" uk="/ˈaʊtˌsɔɹs/" us="/ˈaʊtˌsɔɹs/" client:only />
...
<WordRelations synonyms={["subcontract"]} client:only />
