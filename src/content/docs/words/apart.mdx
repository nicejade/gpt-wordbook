---
title: Apart
description: apart是个副词，意为'分隔开'，用来描述两个或多个人或物被空隔或分隔开。当与'from'一起使用时，它变为介词短语，意为'除了……之外'。
sidebar:
  hidden: true
...
<Pronunciation word="Apart" uk="/əˈpɑː(ɹ)t/" us="/əˈpɑɹt/" client:only />
...
"apart"没有特定的词根，但它可以分为两部分：a-和-part，其中 a-是一个古英语的前缀，表示"off, from"；part 是一个来自拉丁语的词根，意为"部分"。

### 词缀分析

"apart"由前缀 a-和词根-part 构成，没有后缀。

### 文化背景

该单词起源于 12 世纪的中古英语，源于早期前缀 a（表示从......出来）和 part（部分）的组合，用于描述两者的分离状态。
...
<WordRelations
  synonyms={["independently","separately","asunder"]}
  antonyms={["together"]}
  client:only
/>
