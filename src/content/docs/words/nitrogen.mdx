...
title: Nitrogen
description: >-
  - **Nitrogen** 是一种化学元素，符号为 N，原子序数为 7。在常温常压下是一种无色、无味、无毒的气体,占大气体积的
  78%以上，对生物生存非常重要。
sidebar:
  hidden: true
...
- **Nitrogen** 是一种化学元素，符号为 N，原子序数为 7。在常温常压下是一种无色、无味、无毒的气体,占大气体积的 78%以上，对生物生存非常重要。

<Pronunciation word="Nitrogen" uk="/ˈnaɪ.tɹə.dʒən/" us="/ˈnaɪ.tɹə.dʒən/" client:only />
...
- **Nitrogen**这个名字由法国化学家安托万·拉瓦锡在 1785 年提出，因此单词的词源是希腊语“nitron”和"genes"的组合，意思分别是“硝石的”和“产生者”。
...
<WordRelations
  synonyms={["E941","propellant","azote"]}
  client:only
/>
