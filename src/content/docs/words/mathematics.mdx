---
title: Mathematics
description: Mathematics，中文翻译为“数学”，是一种以数量，结构，空间和变化等为研究对象的科学。
sidebar:
  hidden: true
...
Mathematics 一词源自古希腊语，原意是学习、学问、科学，也特别强调数学的研究成果。
...
想象到的每一个数学公式或者问题，都可以联想到"mathematics"这个单词。此外，你可以建立外部关联，比如科比的球衣号码"24"，是 8 的 3 倍，然后想象科比正在解这个数学问题。
...
<WordRelations synonyms={["numeracy", "math", "maths"]} client:only />
