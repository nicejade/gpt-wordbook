---
title: Traveler
description: Traveler，是一个名词，意为“旅行者、游客”。一般用来指参与各种各样旅行或者旅游活动的人。
sidebar:
  hidden: true
...
<Pronunciation word="Traveler" uk="/ˈtɹæv.l̩.ɚ/" us="/ˈtɹæv.l̩.ɚ/" client:only />
...
- "Travel" 这个词根在中世纪英语中表示"工作、努力、痛苦或者说艰难的努力"，它来自法语 "travailler"。后来逐渐引申为"长时间的、艰苦的旅行"。
- 而"-er"这个词尾，它经常用于把动词变成名词，表示“做...的人”。

### 词缀分析

- "Travel"，这个词没有词缀，它本身就是一个词根.
- "-er" 是后缀，表示“做某事的人”。
...
- 不规则变形：travelers（复数形式，指多个旅行者）。
- 相关单词： travel（动词，旅行）； traveling（现在分词，正在旅行）； traveled/travelled（过去式和过去分词，旅行过）。
...
<WordRelations
  synonyms={["Gypsy","Traveler","Traveller"]}
  client:only
/>
