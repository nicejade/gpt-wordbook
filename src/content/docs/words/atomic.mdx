...
description: >-
  Atomic来自于希腊语
  atmos，意思是'不可分割的'。在科学领域，'atomic'常用来解释和描述与原子有关的事物或现象。此外，它也可以用来描述一种非常小或微乎其微的事物。
sidebar:
  hidden: true
...
"Atomic"来自于希腊语 atmos，意思是"不可分割的"。在科学领域，"atomic"常用来解释和描述与原子有关的事物或现象。此外，它也可以用来描述一种非常小或微乎其微的事物。

<Pronunciation word="Atomic" uk="/əˈtɔm.ɪk/" us="/əˈtɑː.mɪk/" client:only />
...
Atomic 来自于希腊语词根"atomos"，表示"不可分割的"。与"atomos"有关的其他单词还有"atom"（原子）、"atomize"（使成为原子）、"atomizer"（喷雾器）等。
...
<WordRelations antonyms={["molecular"]} client:only />
