---
title: Abortion
description: Abortion在医学上的意思是流产。它指的是妊娠早期的胚胎或者胎儿自然或人为地从母体中排出，导致妊娠终止。
sidebar:
  hidden: true
...
<Pronunciation word="Abortion" uk="/əˈbɔɹ.ʃn̩/" us="/əˈbɔɹ.ʃn̩/" client:only />
...
"Abortion"这个词出现在 14 世纪，以表示早期的胎儿的早期死亡或流产。在各种文化和国家中，对于堕胎的看法各不相同，有些地方将其视为合理的医疗操作，而有些地方则将其视为犯罪。
...
<WordRelations
  synonyms={["pregnancy","termination","miscarriage"]}
  client:only
/>
