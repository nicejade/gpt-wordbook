---
title: Then
description: Then 是一个英语连词，用作副词、形容词或名词，主要有以下几种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Then" uk="/ðen/" us="/ðɛn/" client:only />
...
<WordRelations
  synonyms={["concurrently","therewhile","accordingly","so","subsequently"]}
  client:only
/>
