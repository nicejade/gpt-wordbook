---
title: Historical
description: historical 是形容词，中文意思是“历史的，有关历史的”。它通常用来形容与历史相关的人、事件、物件等。
sidebar:
  hidden: true
...
<Pronunciation word="Historical" uk="/hɪˈstɒɹɪkəl/" us="/hɪˈstɔːɹɪkəl/" client:only />
...
<WordRelations
  synonyms={["ancient","bygone","former","old","past","historial","historic"]}
  antonyms={["ahistorical","anachronistic","expected","future","projected","contemporary","modern","present"]}
  client:only
/>
