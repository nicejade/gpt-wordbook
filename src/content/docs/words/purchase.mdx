---
title: Purchase
description: Purchase是一个英文单词，作为动词时，意思是“购买”，作为名词时，意思是“购买的物品”。
sidebar:
  hidden: true
...
<Pronunciation word="Purchase" uk="/ˈpɜːtʃəs/" us="/ˈpɝtʃəs/" client:only />
...
<WordRelations
  synonyms={["contact", "grip", "hold", "foothold", "support", "procure"]}
  client:only
/>
