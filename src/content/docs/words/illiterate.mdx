---
title: Illiterate
description: Illiterate 是形容词，指的是一个人不识字，无法阅读或写作，或者对某个主题知识贫乏。这个词也常用来形容一个人对某一特定领域的无知。
sidebar:
  hidden: true
...
"Illiterate" 这个词最初出现在 16 世纪，源自拉丁语 "illes 'litteratus"，与现在的含义 "不懂文字的，无法阅读和写作的"一致。这个词在欧美文化中，通常用来讨论教育水平和文盲率问题。
...
<WordRelations
  synonyms={["analphabet", "analphabetic", "ignorant", "unlettered"]}
  antonyms={["literate"]}
  client:only
/>
