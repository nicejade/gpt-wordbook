---
title: Obviously
description: Obviously 是一个副词，其常用含义是 '显然地'，'明显地'，用来表示某事物非常清晰地，可以通过直接的观察或理解得知。
sidebar:
  hidden: true
...
Obviously 一词源自拉丁语"obvius"，最早出现在 15 世纪中叶的欧洲文本中，当前的使用情况在各种语境中都十分广泛。
...
<WordRelations
  synonyms={["apparently", "clearly", "evidently", "manifestly", "obvi"]}
  client:only
/>
