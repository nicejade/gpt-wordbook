---
title: Accord
description: Accord 作为动词意味着'同意'，'给予'；作为名词时，它意味着'一致'，'和谐'，或'协议'。
sidebar:
  hidden: true
...
<Pronunciation word="Accord" uk="/əˈkɔːd/" us="/ə.ˈkɔɹd/" client:only />
...
Accord 可分为 'Ac-' 和 '-cord'. '-cord' 来于拉丁语 'cor, cordis'，意思是 "heart" （心），在很多词中用来表示 "feel" 或者 "emotion" (感觉 或者 情绪)。如 "discord", "cordial", "cordially".
...
<WordRelations synonyms={["assent", "consent", "treaty"]} client:only />
