---
title: Elect
description: Elect是一个动词，主要含义是选择或选举。该词常用在政治语境中，表达选民通过投票来选出合适的代表或候选人。
sidebar:
  hidden: true
...
<Pronunciation word="Elect" uk="/iːˈlɛkt/" us="/iːˈlɛkt/" client:only />
...
<WordRelations antonyms={["reprobate"]} client:only />
