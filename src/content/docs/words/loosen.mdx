---
title: Loosen
description: Loosen 是一个动词，表示“使松弛或变得不太紧”。它也可以指使某件事情或规定的限制变得宽松。
sidebar:
  hidden: true
...
<Pronunciation word="Loosen" uk="/ˈluːsn̩/" us="/ˈluːsn̩/" client:only />
...
“松松你的鞋子，Peter。你的脚已经长大了，” 妈妈对 Peter 说，并给了他一双新鞋子。

<WordRelations
  synonyms={["ease","relax","untighten","liberate","release","undo","unfasten"]}
  antonyms={["tighten"]}
  client:only
/>
