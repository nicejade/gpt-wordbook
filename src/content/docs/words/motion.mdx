...
title: Motion
description: >-
  Motion是一个英文名词，指的是移动或行动的过程。它通常指的是从一个地方到另一个地方的移动。它也可以用于形容物体的物理运动，如 'the motion
  of the planets'（行星的运动）。
sidebar:
  hidden: true
...
<Pronunciation word="Motion" uk="/ˈməʊʃən/" us="/ˈmoʊʃən/" client:only />
...
汤姆发现了灌木丛中的动静。他过去一看，发现一只小猫被困住了。救出她后，他给她起名叫 Motion，以此纪念他们的特殊邂逅。
