---
title: Scarcely
description: Scarcely 是一个副词，原意为'仅仅，只是'，常用于形容事情发生的可能性很小，或者说某件事几乎没有或未曾发生。它还有“刚刚，勉强”的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Scarcely" uk="/ˈskɛəsli/" us="/ˈskɛɹsli/" client:only />
...
<WordRelations synonyms={["barely", "hardly", "just"]} client:only />
