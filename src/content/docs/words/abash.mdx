---
title: Abash
description: Abash 是一个动词，表示使某人感到困窘或尴尬。常见的中文翻译有：使...局促不安、使困窘、使...羞愧。
sidebar:
  hidden: true
...
<Pronunciation word="Abash" uk="/əˈbæʃ/" us="/əˈbæʃ/" client:only />
...
<WordRelations
  synonyms={["bewilder","confuse","embarrass","humble","rattle","shake","shame","snub"]}
  antonyms={["buoy","cheer","countenance","encourage","rally","reassure","uphold"]}
  client:only
/>
