...
description: >-
  Shade
  是一个英文单词，通常被用作名词和动词。作为名词，它指的是阳光被物体遮挡后形成的较冷暗的地方。同时，它也用于形容某一颜色或情绪的微妙差异。作为动词，'shade'
  的意思是给某物提供遮蔽，以防止阳光的直射。
sidebar:
  hidden: true
...
<Pronunciation word="Shade" uk="/ʃeɪd/" us="/ʃeɪd/" client:only />
