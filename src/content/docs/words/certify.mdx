---
title: "certify"
description: "“Certify” 是一个动词，表示“证明”或“确认”。它常用于表示某人或某机构确认或确保某事的正确性、真实性或合法性。例如，我们可以说某个机构“certify a product”（认证一个产品）或者一个教育机构“certify a student's graduation”（确认一个学生的毕业）。"
---
