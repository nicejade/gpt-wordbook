...
title: President
description: >-
  President 是一个英文名词，用来称呼一种高级领导角色，常见于公司和国家政府中。在国家领导人中，'President'
  通常指的是总统。在企业或机构中，'President' 通常指的是董事长或总裁。
sidebar:
  hidden: true
...
"President" 这个词在英语中的使用始于 14 世纪，最初用于指称掌管法庭的人。到了美国独立后，被用于指称国家元首，即我们通常意义上的"总统"。
...
<WordRelations
  synonyms={["POTUS", "provost", "prepositus", "prexy", "prez"]}
  client:only
/>
