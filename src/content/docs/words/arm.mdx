...
title: Arm
description: >-
  Arm 是英文中的一个单词，它主要有两个基本含义。作为名词，它一般指的是身体的部分，从肩膀到手的部分，我们称之为 'arm' (手臂)。然而，'arm'
  在许多情况下也可以表示'武器'，像是在说'arm oneself with' (用……武装自己)这样的短语中。
sidebar:
  hidden: true
...
<Pronunciation word="Arm" uk="/ɑːm/" us="/ɑɹm/" client:only />
