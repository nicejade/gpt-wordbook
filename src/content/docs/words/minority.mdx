---
title: Minority
description: '"Minority" 是一个名词，主要有以下两种含义： 1. 数量上的少数，例如人口、种族、党派等； 2. 法定年龄以下的人。'
sidebar:
  hidden: true
...
3.  "She's still a minority because she's only 17." ——她还未成年，因为她只有 17 岁。
...
Minority 为名词。单复数形式相同，都为 minority。
