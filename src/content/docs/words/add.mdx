---
title: Add
description: Add 是一个动词，主要意思是'加，增加'。在数学中，'add'是求和的意思；在日常生活里也经常用到，如增加配料，增加人数等。
sidebar:
  hidden: true
...
<Pronunciation word="Add" uk="/æd/" us="/æd/" client:only />
...
"Add"起源于古英语的许多变体，比如 "ādihtian"，在 12 世纪时已经有了现在的形式及意思。
...
<WordRelations
  synonyms={["coalesce","join","unite","bestow","give","annex","augment","increase","sum","mention","note"]}
