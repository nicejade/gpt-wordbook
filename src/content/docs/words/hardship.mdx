---
title: Hardship
description: Hardship 是一个名词，表示生活中的困难或苦难，特指有剧烈、痛苦、需要克服的困难。
sidebar:
  hidden: true
...
Hardship 是一个名词，表示生活中的困难或苦难，特指有剧烈、痛苦、需要克服的困难。

<Pronunciation word="Hardship" uk="/ˈhɑːdˌʃɪp/" us="/ˈhɑːdˌʃɪp/" client:only />
...
<WordRelations antonyms={["softship"]} client:only />
