...
title: Find
description: >-
  Find 是一个动词，它的基本含义是“发现”、“找到”。当你在寻找某样东西并最终找到它时，你就可以说 'I find it.' 。另外，'find'
  也可以用来表达认为或者感觉，比如，“I find it interesting.” (我发现它很有趣)。
sidebar:
  hidden: true
...
<Pronunciation word="Find" uk="/faɪnd/" us="/faɪnd/" client:only />
