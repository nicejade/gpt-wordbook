...
title: Contradictory
description: >-
  Contradictory 是个形容词，表示“相互矛盾的、对立的”。例如，有两个观点或事实如果是 contradictory
  的话，那么它们就不能同时为真，因为它们互相冲突。
sidebar:
  hidden: true
...
Contradictory 的来源是 16 世纪后期的拉丁词 "contradictorius"，意为 "含有对立的意见"。
...
<WordRelations synonyms={["incompatible", "opposite"]} client:only />
