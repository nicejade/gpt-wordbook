...
description: >-
  英语单词 'dig'
  在中文中常被翻译为“挖掘”，它多用于描述人或机器挖开地面或物体的内部，以获取分离出其内部内容的行为。此外，这个单词还有其他含义，例如，可以表示'深入研究'或者'欣赏'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Dig" uk="/dɪɡ/" us="/dɪɡ/" client:only />
...
“Dig”这个词自古英语时期起就一直在使用，其在 20 世纪 60 年代的美国被用作俚语，表示某人“喜欢或欣赏某事物”。
...
<WordRelations synonyms={["excavation", "jab", "jibe"]} client:only />
