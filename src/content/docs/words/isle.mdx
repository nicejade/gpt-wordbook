---
title: Isle
description: Isle 是英语中的名词，它的意思是“岛屿”。这个词通常用来描述一个较小且通常较为草木茂盛的岛。
sidebar:
  hidden: true
...
<Pronunciation word="Isle" uk="/aɪ̯l/" us="/aɪ̯l/" client:only />
...
"Isle" 一词中英文表现形式源自法语，最早的记载是在 14 世纪，当时以 "ile" 或 "ille" 的形式出现。此后演变成了我们现在所用的 "isle" 形式。
...
<WordRelations synonyms={["isle"]} antonyms={["window"]} client:only />
