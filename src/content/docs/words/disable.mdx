---
title: Disable
description: Disable 是一个动词，主要含义为使失效、使无法工作，或者使某人或某物失去正常的功能或活动能力。
sidebar:
  hidden: true
...
<Pronunciation word="Disable" uk="[dɪsˈeɪbəɫ]" us="[dɪsˈeɪbəɫ]" client:only />
