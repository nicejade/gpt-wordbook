---
title: Celebration
description: Celebration 这个单词来自英文，它的基本含义是庆祝或者庆典，用来描述对特定事件或日子的欢喜、尊重或者欣赏。
sidebar:
  hidden: true
...
1.  The town held a grand celebration for its 200th anniversary. (这个城镇为它的 200 周年纪念举行了盛大的庆祝活动。)
