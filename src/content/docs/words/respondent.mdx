...
title: Respondent
description: >-
  Respondent 是一个英语名词，通常有两个主要的含义： 1.
  在一项调查或研究中提供信息或者回答问题的人。例如，如果你参加了一项调查并回答了问题，那么你就是这项调查的 respondent。 2.
  在法律语境中，Respondent 通常指在上诉案件中的被告，即原审判决赞成方。 中文翻译为“回答者”，“答复者”或“被告”。
sidebar:
  hidden: true
