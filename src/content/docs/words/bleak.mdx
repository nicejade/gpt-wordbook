...
description: >-
  Bleak
  是个形容词，本义是'荒凉的'或'阴冷的'，用来描述一个地方或者天气等。另外，它也有“未来无望的”或者“令人沮丧的”的意思，用来描述人的情绪或者某种状况。
sidebar:
  hidden: true
...
<Pronunciation word="Bleak" uk="/bliːk/" us="/bliːk/" client:only />
...
Bleak 这个词源自古英语"bleac"，直译就是“没有色彩”。在欧美文化中，这个词常常用来形容一个阴郁沮丧，或者前景黯淡的情况。
