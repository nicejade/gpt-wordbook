---
title: Commence
description: Commence是一个来自于法语的词，意为开始、着手、启动。
sidebar:
  hidden: true
...
<Pronunciation word="Commence" uk="/kəˈmɛns/" us="/kəˈmɛns/" client:only />
...
这个词源自于 14 世纪的法语 "comencier"，意为开始、着手。它再追溯就是来自于拉丁文的 "cominitiare"，同样以此意。
...
<WordRelations antonyms={["cease", "stop"]} client:only />
