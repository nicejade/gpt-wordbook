---
title: Gold
description: "Gold是一个名词，意思是金, 一个贵重的、黄色的贵金属，也用它来描述金黄色。它也常用来描述高质量的物品或事件。"
sidebar:
  hidden: true
...
<Pronunciation word="Gold" uk="/ɡɒʊld/" us="/ɡoʊld/" client:only />
...
"Gold"的词根是"gold"，由这个词根衍生出的其他单词有 golden(金色的)，goldsmith(金匠)，goldfish(金鱼)。
...
Gold 没有动词或形容词的变形。它的形容词形式是"golden"，意思是"金色的"。
...
<WordRelations synonyms={["E175", "golden"]} client:only />
