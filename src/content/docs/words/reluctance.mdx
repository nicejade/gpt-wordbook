---
title: Reluctance
description: '"Reluctance"是一个名词，表示"不情愿"，"抗拒"或"反对"。这是一个表达心理状态的词汇，指一个人不想做某事，或者对做某事感到犹豫不决。'
sidebar:
  hidden: true
...
Reluctance 来自拉丁语词根"luct"，该词根意为"斗争"。其它一些词根的单词有："reluctant"（不情愿的）和 "reluct"（to struggle against, to resist）。
