...
description: >-
  Architecture
  是一个名词，主要有两个含义。其一是建筑学或建筑艺术，指设计和建造建筑物的艺术和科学。其二是描述建筑物设计风格或特点的术语。在计算机科学中，'architecture'也用来描述计算机系统或软件设计的高级组织结构。
sidebar:
  hidden: true
...
"Architecture"来源于 16 世纪的法语，原意为建筑艺术。由于文艺复兴时期，人们对古罗马和希腊建筑的研究和模仿，使得“architecture”这个词在欧洲文化中占据了重要地位。
