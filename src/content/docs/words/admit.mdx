...
title: Admit
description: >-
  Admit是一个英语动词，主要有两层含义。首先，它可以指'接受（有某种事实或真实情况）'，例如，'I have to admit that I felt
  jealous.'（我必须承认我感到嫉妒）。其次，它也可以指'允许进入'，例如，'The ticket admits two
  people.'（票可以让两个人进入）。
sidebar:
  hidden: true
...
<Pronunciation word="Admit" uk="/ədˈmɪt/" us="/ədˈmɪt/" client:only />
...
"Admit" 这个词最初来源于拉丁语"admittere"，于 14 世纪开始流行使用在英语中，主要表示 "允许进入"。但时至今日，这个单词已经发展出了更广泛的含义，比如"承认"、"容许"等。
...
<WordRelations
  synonyms={["inlet", "acknowledge", "own", "confess"]}
  client:only
/>
