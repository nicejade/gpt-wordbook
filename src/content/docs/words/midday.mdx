---
title: Midday
description: Midday 是一个英语单词，表示一天中的正午或中午时分，普遍用于描述太阳位于天空最高点的时候，或者是一天中的 12 点左右。
sidebar:
  hidden: true
...
"Midday" 是一个英语单词，表示一天中的正午或中午时分，普遍用于描述太阳位于天空最高点的时候，或者是一天中的 12 点左右。

<Pronunciation word="Midday" uk="/mɪdˈdeɪ/" us="/mɪdˈdeɪ/" client:only />
...
"Midday" 这个单词源自古英语的 "middæg"，最早在 10 世纪的文献中出现。在许多欧美文化中，正午经常是休息和就餐的时间。
