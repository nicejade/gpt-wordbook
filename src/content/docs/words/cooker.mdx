...
description: >-
  Cooker
  是一个名词，意为“炊具”、“炉具”，通常指的是用于烹饪的设备，如电饭煲，慢炖锅等。这个词可以指一件具体的烹饪器具，也可以泛指任何可以用于烹饪的施热设备。
sidebar:
  hidden: true
...
<Pronunciation word="Cooker" uk="/ˈkʊkə/" us="/ˈkʊkə/" client:only />
...
<WordRelations synonyms={["stove"]} client:only />
