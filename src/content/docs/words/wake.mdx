...
description: >-
  wake
  主要有两种基础词义，一是作为动词，表示“醒来”，二是作为名词，表示“守夜，尤指守丧”。此外，此词也用于描述留下的痕迹或影响，例如在船只通过时水面上的波纹。
sidebar:
  hidden: true
...
<Pronunciation word="Wake" uk="/ˈweɪk/" us="/ˈweɪk/" client:only />

### 列举例句

1.  I usually wake up at 6 a.m. (我通常在上午 6 点醒来。)
