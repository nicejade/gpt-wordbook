---
title: Education
description: '"Education"是一个英文名词，代表了知识、技能、价值、信仰和习俗的一种系统性传承方式。它大致可以译为"教育"。'
sidebar:
  hidden: true
...
"Education"的词根是 Latin "educare"，意为"导出"或"训练"。由此派生的单词比如，"educate"（教育）、"educational"（教育的）、"educator"（教育者）等。
