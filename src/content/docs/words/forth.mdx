---
title: "forth"
description: "Forth是一个副词，它通常具有以下含义： 1. 向前或向外，例如：He set forth to travel around the world.（他启程去环游世界。） 2. 从特定的起点开始的，例如：And so we start forth from this point.（于是我们从这个点开始前进。）"
---
...
"Forth"最早可以追溯到公元前 1150 年左右的古英语。它经历了在中英语，然后进入到现代英语的过程。在许多成语中都会使用到 "forth"，比如"bring forth"（带来）,"set forth"（勃发，启程）等。
