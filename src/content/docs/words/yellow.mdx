---
title: Yellow
description: Yellow 是一个表示颜色的英语单词，指的是黄色。Yellow 也常用来表示胆怯的，产生这个意思是人们常认为黄色代表胆小，害怕，因此有了这层含义。
sidebar:
  hidden: true
...
<Pronunciation word="Yellow" uk="/ˈjɛl.əʊ/" us="/ˈjɛl.oʊ/" client:only />
...
Yellow 这个词在英语中的使用可以追溯到公元前 725 年。在西方文化中，黄色通常被视为快乐和活泼的象征。
...
<WordRelations
  synonyms={["amber", "cowardly"]}
  antonyms={["green", "red", "nonyellow", "unyellow"]}
  client:only
/>
