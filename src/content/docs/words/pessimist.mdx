---
title: Pessimist
description: Pessimist 是英文中的一个名词，形容一个总是预期最坏结果或者看到事物最坏一面的人。中文翻译为“悲观主义者”。
sidebar:
  hidden: true
...
<Pronunciation word="Pessimist" uk="/ˈpɛsɪmɪst/" us="/ˈpɛsɪmɪst/" client:only />
...
<WordRelations antonyms={["optimist"]} client:only />
