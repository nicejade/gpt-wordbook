---
title: Arch
description: Arch有多个含义，它可以作为名词，表示两边较低而中间较高的弧形结构；也可作为形容词，表示恶作剧的、狡诈的。当其作为动词时，意指形成弧形或者形成类似的形状。
sidebar:
  hidden: true
...
<Pronunciation word="Arch" uk="/ɑːt͡ʃ/" us="/ɑɹt͡ʃ/" client:only />
...
"Arch"没有特殊的词缀，但在其前缀形态中(如 arch-enemy)，"arch-"表示首要、主要或最重要的。
