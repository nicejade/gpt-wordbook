...
description: >-
  notwithstanding 可用做副词、介词或连词。在语义上，它通常被翻译成“尽管”、“虽然”或“不管”。'Notwithstanding'
  通常用来引导让步状语从句，表示“尽管有某情况，但是仍然……”，强调主句的内容。
sidebar:
  hidden: true
...
<Pronunciation word="Notwithstanding" uk="/ˌnɒtwɪðˈstændɪŋ/" us="/ˌnɑtwɪθˈstændɪŋ/" client:only />
...
"notwithstanding" 这个单词源自 14 世纪的英语，最早是两个单词 "not" 和 "withstanding "的组合，后来逐渐发展为一个词。
...
<WordRelations
  synonyms={["anyway","nevertheless","nonetheless","regardless","still","yet","maugre"]}
  client:only
/>
