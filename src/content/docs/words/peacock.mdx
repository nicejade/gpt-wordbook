---
title: Peacock
description: Peacock 通常指的是孔雀，这是一种用其美丽和多彩的羽毛而闻名的大型鸟类。 这个词也可以用作形容词或动词，更广泛地描述像孔雀一样展示自己的人或行为。
sidebar:
  hidden: true
...
<Pronunciation word="Peacock" uk="/ˈpiːkɒk/" us="/ˈpikɑk/" client:only />
...
<WordRelations synonyms={["peafowl"]} client:only />
