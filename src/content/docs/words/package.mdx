---
title: Package
description: Package是一个名词，意为“包裹”或“一套”。它也可以用作动词，表示“打包”或“包装”。
sidebar:
  hidden: true
...
<Pronunciation word="Package" uk="/ˈpækɪdʒ/" us="/ˈpækɪdʒ/" client:only />
...
在 14 世纪的法国，最早的"paquet"被用来形容一捆或一包小东西，此后，英语逐渐引入这个词，发展为两种主要的用法——一个封闭的物体和一套物事。
