...
title: generally
description: >-
  Sure, let's go into the analysis of the word generally. Analysis of Meaning:
  Generally is an adverb, and it means usually or in most situations. It's often
  used to describe something that is commonly found or recognized as a norm or
  standard. Examples: 1. Schools generally teach students basic
  skills.（学校通常教给学生基本技能。
sidebar:
  hidden: true
