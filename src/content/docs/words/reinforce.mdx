---
title: Reinforce
description: Reinforce 是一个英文动词，直接翻译成中文，意思是“加强”，“强化”。在使用中，它常常用来描述加强某种能力，强化某个观点或者支持某种观念。
sidebar:
  hidden: true
...
衍生词有 reinforceable、reinforcement 等。

### 词缀分析

在单词 "reinforce" 中，"re-" 是前缀，表示“再次”，"enforce" 是词根。

相同前缀的单词还有 recall（召回）, redo（重做） 等。
...
<WordRelations
  synonyms={["emphasize","repeat","review","encourage","instruct","learn","reward","teach","line","strengthen"]}
  client:only
/>
