...
title: Sulphur
description: >-
  sulphur是英式英语中的硫磺的拼写，美式英语中通常拼写为'sulfur'。硫磺是一种化学元素，其原子序数为 16
  的非金属元素。硫磺可以表现出各种颜色，但自然硫通常呈亮黄色。它在许多应用中都有重要作用，包括肥料和火药的生产。
sidebar:
  hidden: true
...
"sulphur"是英式英语中的硫磺的拼写，美式英语中通常拼写为"sulfur"。硫磺是一种化学元素，其原子序数为 16 的非金属元素。硫磺可以表现出各种颜色，但自然硫通常呈亮黄色。它在许多应用中都有重要作用，包括肥料和火药的生产。
...
<WordRelations synonyms={["brimstone"]} client:only />
