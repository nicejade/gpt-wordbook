---
title: "course"
description: "course 是一个多义词，它可以作为名词和动词，有几个主要的含义 1. 课程：例如 university course (大学课程) 2. 道路或路径：例如 water course (水道) 3. 一道(菜)：例如 main course (主菜) 4. （做某事的）方式或方法：例如 of course (当然)"
---
