...
description: >-
  Discrimination 是一个名词，意思是"歧视"，具体指因人的种族、性别、年龄、宗教或残疾等因素，对他们进行不公平的待遇。 比如："Racial
  discrimination is against the law."（种族歧视是违法的。）
sidebar:
  hidden: true
...
Discrimination 这个词在英语中的使用可以追溯到 17 世纪，但它的现代含义——基于种族、性别、年龄等特征的不公平对待，是在 20 世纪中叶的民权运动期间形成的。
