...
title: Decency
description: >-
  Decency是一个名词，用于描述符合公认标准或行为准则的行为。在大多数情况下，这个词用于描述人或行为的得体、适当或有礼貌。例如，'他行为得体，总是彬彬有礼'中的'得体'就可以使用'decency'来表示。
sidebar:
  hidden: true
...
<Pronunciation word="Decency" uk="/ˈdiːsənsi/" us="/ˈdiːsənsi/" client:only />
