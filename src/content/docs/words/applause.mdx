---
title: Applause
description: Applause 是一个名词，指的是为示赞许和欣赏，观众鼓掌的行为。这个词经常用于表演艺术，诸如音乐会，戏剧，电影等场合。
sidebar:
  hidden: true
...
<Pronunciation word="Applause" uk="/əˈplɔːz/" us="/əˈplɔz/" client:only />
...
<WordRelations
  synonyms={["acclamation","approbation","approval","plaudit"]}
  client:only
/>
