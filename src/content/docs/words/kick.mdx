---
title: Kick
description: Kick 是一个英语动词，主要含义是'用力用脚踢'，也可以用作名词，意思是“踢”。
sidebar:
  hidden: true
...
<Pronunciation word="Kick" uk="/kɪk/" us="/kɪk/" client:only />
...
<WordRelations
  synonyms={["kick", "kickback", "motor", "preface", "prologue", "kicker"]}
  client:only
/>
