...
description: >-
  Compression
  这个单词的意思是压缩，减少，或者是压制。在生活中我们经常用这个词，比如电脑的文件压缩，音乐的压缩版本，从而使得文件或者音乐占用的存储空间变小。在医学上也使用这个词，比如压迫绷带等等。
sidebar:
  hidden: true
...
<WordRelations antonyms={["decompression", "rarefaction"]} client:only />
