---
title: Innumerable
description: "Innumerable这个单词来源于拉丁语 'innumerabilis', 它的字面意思是数不清的或者无数的。"
sidebar:
  hidden: true
...
"Innumerable"这一单词的使用可以追溯到 14 世纪的英文。它源自于拉丁文的 "innumerabilis"，表示"无法计算的"或"过多以至于无法计算的"。在欧美文化中，"innumerable"常常用来强调数量之大，例如用来描述星星的数量，或者形容大量的想法和观点。
...
<WordRelations
  synonyms={["countless", "numberless", "unnumbered", "untold"]}
  client:only
/>
