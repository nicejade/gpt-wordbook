---
title: Toothbrush
description: Toothbrush 是一个英语名词，主要意思是“牙刷”，指的是清洁牙齿的一个工具。
sidebar:
  hidden: true
...
"Toothbrush" 的用法在英语中相当直接，第一次记录为人类使用牙刷的证据可以追溯到公元前 3500 - 3000 年的埃及和巴比伦。然而，“toothbrush”这个词在英文中的出现是在 17 世纪。人们以寓教于乐的方式强调口腔卫生，在此过程中，“牙刷”成为推广口腔卫生的重要工具。
