...
这是一个一切都没有颜色的世界。有一天，一个叫做 Colour 的女孩带来了一支魔法画笔。她开始绘画，她触摸到的一切都充满了颜色。

<WordRelations
  synonyms={["DgammaDtime","colour","blee","complexion","ethnicity","race","affect","influence","blush","call","dye","paint","shade","stain","tinge","tint"]}
  antonyms={["decolor"]}
  client:only
/>
