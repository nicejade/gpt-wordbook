---
title: Quantitative
description: Quantitative 是一个形容词，意思是"定量的"或"数量的"，通常用来描述能够以数字或数量来测量或比较的事物。
sidebar:
  hidden: true
...
"Quantitative" 的使用始于 19 世纪，它来源于拉丁词根"quantus"，意思是"多少"。随着科学技术的发展，特别是统计学的发展，人们开始使用这个单词来描述那些可以用数字或数量衡量的事物。
