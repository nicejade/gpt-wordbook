...
title: hot
description: >-
  Hot 这个英语单词， 1. 主要用作形容词，其基本含义为热的，高温的，比如 It's hot today(今天很热)； 2.
  另外，Hot也可以表示辣的，例如：This is a hot pepper (这是一个辣椒)。 3.
  Hot还可以形象地用来描述受欢迎，热门的事物或人，例如：This band is hot right now (这个乐队现在很火)。
sidebar:
  hidden: true
