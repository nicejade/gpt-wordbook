...
<WordRelations
  synonyms={["heat","live","temperature","heated","bad","rubber","sultry","sweltering","radioactive","attractive","beautiful","cute","fit","foxy"]}
  antonyms={["dead","neutral","freezing","chilly","cold","frigid","glacial","icy","lifeless","bland","mild"]}
  client:only
/>
