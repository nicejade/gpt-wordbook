...
title: Hot
description: >-
  "Hot" 这个英语单词， 1. 主要用作形容词，其基本含义为"热的，高温的"，比如 "It's hot today"(今天很热)； 2.
  另外，"Hot"也可以表示"辣的"，例如："This is a hot pepper" (这是一个辣椒)。 3.
  "Hot"还可以形象地用来描述"受欢迎，热门"的事物或人，例如："This band is hot right now" (这个乐队现在很火)。
sidebar:
  hidden: true
