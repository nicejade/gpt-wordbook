...
<Pronunciation word="Hot" uk="/hɒt/" us="/hɑt/" client:only />
...
3.  "The new iPhone model is a hot item in the market." (新的 iPhone 型号在市场上很热门。)
...
<WordRelations
  synonyms={["heat","live","baking","boiling","feverish","temperature","heated","bad","rubber","sultry","sweltering","radioactive","attractive","beautiful","cute","fit","foxy"]}
  antonyms={["dead","neutral","freezing","chilled","chilly","cold","frigid","glacial","icy","lifeless","bland","mild"]}
  client:only
/>
