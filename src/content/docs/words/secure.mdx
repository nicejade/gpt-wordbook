...
title: Secure
description: >-
  "Secure" 是一个英语单词，可以作为形容词或动词使用。 作为形容词，"secure" 的意思是“安全的，无危险的”。例如：It's a secure
  system. 译为："这是一个安全的系统。" 作为动词，"secure" 的意思是“保护，确保”， 或者“获取、获得”。例如：Secure your
  seat belt. 译为："系好你的安全带。"
sidebar:
  hidden: true
