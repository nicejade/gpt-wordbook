---
title: Faction
description: Faction（n.）意为集团，派系，通常用来指政党、组织、公司或任何大团体中的一个争取特定目标的小群体。
sidebar:
  hidden: true
...
<Pronunciation word="Faction" uk="/ˈfæk.ʃn̩/" us="/ˈfæk.ʃn̩/" client:only />
...
Faction 一词来源于 Latin 词根 "facere"，意为 "做" 或 "制作"。从这个词根派生出的单词有：factory(工厂), fact(事实), and manufacture(制造)，等等。
...
Faction 一词源于 Latin 中的 "factionem"，意为组织、聚会、作为一群人的行为。在 16 世纪的时候，这个词开始被用来指代一个争权夺利的小集团。
