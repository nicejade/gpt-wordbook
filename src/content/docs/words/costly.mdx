---
title: Costly
description: Costly 是一个形容词，常常用来描述价格高昂、代价大的事物或行为。同时，'costly'也可以形容精神上的消耗，比如时间和精力的投入。
sidebar:
  hidden: true
...
<Pronunciation word="Costly" uk="/ˈkɒst.li/" us="/ˈkɒst.li/" client:only />
...
"Costly"的词缀主要包括了词根"cost"和后缀"-ly"。像"costly"这样的词，有许多同样以 "-ly" 结尾的形容词，如：quickly, willingly, easily 等。
...
<WordRelations antonyms={["costlessly"]} client:only />
