...
title: Mistress
description: >-
  Mistress是一个多义词，主要有两个含义。一是指'女主人'或'女主持人'，通常用于指代管理家务的女性或主持某事项的女性。二是作为'情妇'或'秘密情人'来理解，指一个与已婚男子有情感或性关系的女性。
sidebar:
  hidden: true
...
<Pronunciation word="Mistress" uk="/ˈmɪstɹɪs/" us="/ˈmɪstɹɪs/" client:only />
...
<WordRelations
  synonyms={["comaré", "goomah", "boss", "head", "leader", "schoolmarm"]}
  antonyms={["cicisbeo"]}
  client:only
/>
