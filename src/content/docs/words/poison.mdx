...
title: Poison
description: >-
  Poison这个单词在英语中是 '毒药'或者'毒害'的意思。它可以用来指代任何有害的物质，具有物理或心理危害。例如：“The snake’s venom
  is a potent poison.” （蛇的毒液是一种很强的毒药。）
sidebar:
  hidden: true
...
<Pronunciation word="Poison" uk="/ˈpɔɪz(ə)n/" us="/ˈpɔɪz(ə)n/" client:only />
...
<WordRelations
  synonyms={["bane","pollutant","toxin","venom","corrupt","taint","contaminate","pollute"]}
  client:only
/>
