---
title: Quiet
description: Quiet 这个单词在英语中常用作形容词或副词，主要表示“安静的”、“平静的”。
sidebar:
  hidden: true
...
<Pronunciation word="Quiet" uk="/ˈkwaɪ.ət/" us="/ˈkwaɪ.ət/" client:only />
...
"Quiet" 这个词源于 14 世纪的中英语"quiete", 其本身源于拉丁语"quietus"，意指"静止的"、"安静的"。
...
<WordRelations
  synonyms={["quieten", "slow", "unbusy", "modest", "plain", "simple"]}
