...
description: >-
  Identification 是名词，意为 '认证' 或
  '身份证明'。这通常涉及到简单地确认某人的身份，或者包含更深层次的识别，比如确定某物的性质或某人的动机。
sidebar:
  hidden: true
...
<Pronunciation
  word="Identification"
  uk="/aɪˌdɛntɪfɪˈkeɪʃən/"
  us="/aɪˌdɛntɪfɪˈkeɪʃən/"
  client:only
/>
...
Identification 是名词，对应的动词形式为 "identify"（识别），形容词形式为 "identifiable"（可识别的），副词形式为 "identifiably"（可辨认地）。相应的固定搭配有 "identification card"（身份证）、"identification number"（身份证号码）等。
