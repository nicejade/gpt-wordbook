---
title: New
description: New是一个形容词，表达的意思是最近或最新的，或者再一次，有新颖，新鲜之意。例如，new book（新书），new idea（新想法）等。
sidebar:
  hidden: true
...
<Pronunciation word="New" uk="/njuː/" us="/n(j)u/" client:only />
...
<WordRelations
  synonyms={["recent","current","mint","pristine","spanking","green","newborn","young","fresh","novel","singular","reformed","refreshed","reinvigorated","revived","strange","unfamiliar","new"]}
  antonyms={["dated","old","former","used","worn","accustomed","experienced","expert","original","previous","established","ancient","familiar"]}
  client:only
/>
