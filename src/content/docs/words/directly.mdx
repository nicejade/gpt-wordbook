...
<Pronunciation word="Directly" uk="/daɪˈɹɛk(t)li/" us="/daɪˈɹɛk(t)li/" client:only />
...
<WordRelations
  synonyms={["accurately","precisely","forthwith","now","straightwise","undeviatingly","betimes","presently","shortly","frankly","truthfully","bluntly","clearly","downrightly","unambiguously"]}
  antonyms={["indirectly"]}
  client:only
/>
