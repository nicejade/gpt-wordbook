---
title: Prolonged
description: Prolonged是一个形容词，它的中文意思为'长久的'或'延长的'。例如：prolonged illness，表示长期的病病。
sidebar:
  hidden: true
...
<Pronunciation word="Prolonged" uk="/pɹoʊˈlɑŋd/" us="/pɹoʊˈlɑŋd/" client:only />
...
"Prolonged"这个词源自于 14 世纪的米德尔英语词汇"prolongen"，最初的意思是"使延长"。通过时间的演变，现在通常用来描述某种状况或行为持续存在或延续的时间很长。
