---
title: Naked
description: Naked 是一个形容词，最直接的意思是'赤裸的'或'裸体的'。它也有引申含义，比如'无遮掩的'、'坦诚的'，还等。
sidebar:
  hidden: true
...
<Pronunciation word="Naked" uk="/ˈnɛkɪd/" us="/ˈnɛkɪd/" client:only />
...
"Naked" 这个词语源于古英语单词 "nacod"，意为"裸露的"，自从 12 世纪以来一直使用至今。在欧美文化中，"naked" 除了描述肉体裸露，还被引申为心灵的裸露，表示无所遮掩和坦诚自白。
...
<WordRelations
  synonyms={["bare","bareskin","nude","skyclad","starkers","unclad","unclothed","uncovered"]}
  client:only
/>
