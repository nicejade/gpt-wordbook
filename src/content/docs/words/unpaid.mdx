---
title: Unpaid
description: Unpaid 是一个英语形容词，其基本含义是'未支付的'，'未获报酬的'，通常用于描述尚未支付的账单、欠款，或者是未获报酬的工作。
sidebar:
  hidden: true
...
<Pronunciation word="Unpaid" uk="/ʌnˈpeɪd/" us="/ʌnˈpeɪd/" client:only />
...
"Unpaid"源自了古英语中的 "un-"（表示否定）和 "paid"（由 "pay" 发展而来，指支付）。早在 14 世纪时，就有了 "unpaid" 这个词，用来描述未支付的款项。
