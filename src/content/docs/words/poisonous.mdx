---
title: Poisonous
description: Poisonous 是一个英语形容词，用来形容有害的或含有毒性的事物，可以用来描述各种例如蛇，植物，物质等具有危害生物健康或生命的特性。
sidebar:
  hidden: true
...
<Pronunciation word="Poisonous" uk="/ˈpɔɪznəs/" us="/ˈpɔɪznəs/" client:only />
...
"Poison"这个词在 14 世纪从旧法语的"poison"进入英语，原本指的是毒药。16 世纪之后，这个词逐渐发展为形容有毒，能够造成伤害或死亡的事物。
...
<WordRelations
  synonyms={["attery", "poisoned", "toxic", "venomous"]}
