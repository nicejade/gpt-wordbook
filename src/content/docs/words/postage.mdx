---
title: Postage
description: Postage 是一个名词，意思是“邮费”，指的是将物品（特别是信件或包裹）通过邮局或快递服务发送的费用。
sidebar:
  hidden: true
...
<Pronunciation word="Postage" uk="/ˈpəʊstɪdʒ/" us="/ˈpəʊstɪdʒ/" client:only />
...
"Postage"这个概念随着人类文明与交流的需要而发展。19 世纪中叶，英国开始发行邮票，这也标志着现代邮政系统的建立，"postage"自此成为了全球通用的术语。
