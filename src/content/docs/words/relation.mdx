...
title: Relation
description: >-
  Relation是一个英语单词，在中文中，我们一般译为“关系”或者“联系”。它可以指两个或更多元素间的相互影响或关联，既可以指人和人之间的关系（比如家庭关系、友情关系），也可以指事物和事物之间的联系（比如因果关系）。
sidebar:
  hidden: true
...
<Pronunciation word="Relation" uk="/ɹɪˈleɪʃən/" us="/ɹɪˈleɪʃən/" client:only />
...
"Relation"这个单词来源于 14 世纪的中古法语，原本用来描述法律词汇中的报告或陈述。到了 16 世纪，它逐渐发展出了“人与人之间的相互关系”的含义。
