---
title: Eliminate
description: Eliminate （清除、消除）是一个动词，指的是消除或彻底去掉。它可能涉及去掉物体、解决问题，或者在比赛或比赛中击败某人或某个团队。
sidebar:
  hidden: true
...
该单词最初在 16 世纪的拉丁文中出现，含义为"离开自己的门槛" 或 "送出门"，其有关扔掉或排出的含义从此开始发展。在更现代的使用中，它用于描述去除或移除事物，无论是实际的还是抽象的。
...
<WordRelations synonyms={["abolish", "abrogate"]} client:only />
