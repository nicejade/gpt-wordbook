---
title: Election
description: "- 'Election'是一个名词，意思是“选举”，指的是人们通过投票选择代表或者决定某个问题的过程。"
sidebar:
  hidden: true
...
1.  The presidential election will be held in November. (总统选举将于 11 月举行。)
...
- "Election"一词在 14 世纪从法语词汇"elecion"进入英语，其根源在拉丁词“eligere”，意为选择。选举在西方文化中具有重要地位，作为民主制度的基本组成部分，以此来确保公民能够参与并影响政府决策。
...
<WordRelations synonyms={["chosenness"]} client:only />
