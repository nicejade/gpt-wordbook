...
description: >-
  Soccer
  是一种团队运动，在大多数国家，这个词通常被称为'football'。在美国和加拿大，他们用'football'来指美式足球，所以用'soccer'来表示大家熟知的足球运动。
sidebar:
  hidden: true
...
<Pronunciation word="Soccer" uk="/ˈsɒk.ə/" us="/ˈsɒk.ə/" client:only />
...
Soccer 在全球范围内都十分流行，很多国家会有自己的国家队，而且还有一些大型的足球赛事如世界杯，欧洲杯等。这个词在北美被广泛使用，以区别于美式足球。
...
<WordRelations synonyms={["football"]} client:only />
