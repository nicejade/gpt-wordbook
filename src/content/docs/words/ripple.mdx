---
title: Ripple
description: Ripple在英语中主要有两种词性，名词和动词。作为名词，它的主要含义是（液体表面的）涟漪，轻微的波动；作为动词，它有使...起涟漪，使...波动的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Ripple" uk="/ˈɹɪp(ə)l/" us="/ˈɹɪp(ə)l/" client:only />
...
"Ripple"这个词可以追溯到 14 世纪中叶的英语，最初是用来形容水面上的微波。到了 17 世纪，这个词的含义进行了拓展，以形容任何形式的连续或扩散的波动效果。

### 单词变形

Ripple 作为动词，他的过去式和过去分词为"rippled"，现在进行时为"rippling"。
