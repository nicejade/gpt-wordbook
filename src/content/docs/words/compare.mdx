---
title: Compare
description: Compare 是一个动词，它意味着 '将两个或更多的事物进行对比以发现相似性或差异'。这可以包括人、事物、概念等等。
sidebar:
  hidden: true
...
<Pronunciation word="Compare" uk="/kəmˈpɛə/" us="/kəmˈpɛɚ/" client:only />
...
"Compare" 这个词来自于拉丁语 "comparare"，意思为 "匹敌，相比"。它进入英语是在 14 世纪，最初用于 "将 ... 与 ... 相比" 的语境中。
