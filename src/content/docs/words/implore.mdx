---
title: Implore
description: Implore这个单词来自于英文，它的意思是'恳求'或'乞求'，通常用在比较正式的场合或者文学作品中，表示某人非常渴望得到他人的帮助或同情。
sidebar:
  hidden: true
...
<Pronunciation word="Implore" uk="/ɪmˈplɔː/" us="/ɪmˈplɔː/" client:only />
...
“Implore”这个单词在 14 世纪由法语带入英语，来源于拉丁语单词 “implorare”，一般常见于文学作品或者宗教语境中。根据 OED 的记录，“implore”最初的用法是对神的哀求或乞求，在现代英语中，它已经发展成一个比较正式的词，通常用来表示非常恳求或乞求。
...
<WordRelations synonyms={["entreat"]} client:only />
