---
title: Delay
description: Delay这个单词在英文中主要有两种含义，第一种是作为动词，指的是推迟或者延误某件事；第二种是作为名词，指的是等待的时间、延误或暂停。
sidebar:
  hidden: true
...
<Pronunciation word="Delay" uk="/dɪˈleɪ/" us="/dɪˈleɪ/" client:only />
...
<WordRelations
  synonyms={["calm","moderate","quell","cunctation","adjourn","defer","forslow","penelopize","postpone","suspend","impede"]}
  client:only
/>
