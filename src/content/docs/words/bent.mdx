...
title: Bent
description: >-
  Bent 有两个主要含义，作为形容词时，它通常用来描述某物已被弯曲或已经不再直。此外，'bent'
  也常用于非正式英语中，表示一个人对某件事情有特别的爱好或倾向。
sidebar:
  hidden: true
...
<Pronunciation word="Bent" uk="/bɛnt/" us="/bɛnt/" client:only />
...
"Bent" 这个词可以追溯到公元前 8 世纪的古英语，原意为 “转弯”。
