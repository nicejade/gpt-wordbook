---
title: Shrink
description: Shrink 在英语中主要有两个基本含义：1.变小或者减小，经常用来描述物体的尺寸、数量或者价值缩小。2.精神科医生，这在日常口语中使用较多。
sidebar:
  hidden: true
...
<Pronunciation word="Shrink" uk="/ˈʃɹɪŋk/" us="/ˈʃɹɪŋk/" client:only />
...
"Shrink"这个单词在英美文化中，除了涵盖物品或事物减小或收缩的含义之外，现代口语中也常用它来指称精神科医生，这从 20 世纪 60 年代起就开始流行。
...
<WordRelations
  synonyms={["funk", "shirk", "retreat"]}
  antonyms={["enlarge", "expand", "grow", "stretch"]}
  client:only
/>
