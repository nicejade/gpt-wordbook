---
title: Workplace
description: Workplace 是一个英文名词，它指的是某人进行工作的地点或者环境。一般来说，它可以指办公室，工厂，或者任何专门的工作区域。
sidebar:
  hidden: true
...
"Workplace"这个词在 20 世纪初开始广泛使用，随着工业革命和城市化进程的加快，越来越多的人离开农田，进入工厂或办公室工作，“Workplace” 这个词也应运而生，以区分工作和家庭的不同空间。
...
<WordRelations synonyms={["workstead"]} client:only />
