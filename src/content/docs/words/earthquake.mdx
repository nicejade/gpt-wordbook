---
title: Earthquake
description: Earthquake 是一个英文名词，表现地壳因为地质力量变动而突然释放出来的能量，引起的地震现象。
sidebar:
  hidden: true
...
<Pronunciation word="Earthquake" uk="/ˈɜːθkweɪk/" us="/ˈɝθkweɪk/" client:only />
...
"Earthquake" 这个单词在 14 世纪时开始使用，来自于旧英语的 "eorþræs"，意思为"地震"。
...
<WordRelations
  synonyms={["quake","temblor","tremblor","tremor"]}
  client:only
/>
