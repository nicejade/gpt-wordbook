---
title: Easy
description: Easy 是一个形容词，用来形容事物不复杂或不困难，容易理解或做。例如：easy task (容易的任务)。
sidebar:
  hidden: true
...
<Pronunciation word="Easy" uk="/ˈiːzi/" us="/ˈizi/" client:only />
...
"Easy"这个单词起源于 12 世纪的英国，由古英语的词根"eath"发展而来。在欧美文化中，这个词体现了他们追求轻松，自在的生活态度。
...
<WordRelations
  synonyms={["relaxed", "relaxing", "fast", "eath", "light", "soft", "trivial"]}
  antonyms={["anxious", "uneasy", "challenging", "difficult", "hard", "uneath"]}
  client:only
/>
