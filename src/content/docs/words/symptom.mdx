---
title: Symptom
description: Symptom是一个名词，指的是表示疾病、疾患或不健康的状态的任何特征或迹象。'Symptom'通常用于医学领域，同时也可以指一个问题或事物存在的迹象。
sidebar:
  hidden: true
...
<Pronunciation word="Symptom" uk="/ˈsɪm(p)təm/" us="/ˈsɪm(p)təm/" client:only />
...
<WordRelations
  synonyms={["indication", "manifestation", "sign", "signal"]}
  antonyms={["cause"]}
  client:only
/>
