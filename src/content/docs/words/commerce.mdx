...
title: Commerce
description: >-
  英文单词 'Commerce' 是名词，定义是 'the activity of buying and selling, especially on a
  large scale.', 中文意思是指买卖，尤其是大规模的交易，通常是指贸易或商业活动。
sidebar:
  hidden: true
...
<Pronunciation word="Commerce" uk="/kɒˈmɜːs/" us="/ˈkɑm.ɚs/" client:only />
...
"Commerce" 是 14 世纪从法语引入到英语中，表示交易或贸易。
...
<WordRelations
  synonyms={["communication","dealings","interchange","intercourse","trade","traffic"]}
  client:only
/>
