...
title: Strain
description: >-
  "Strain" 是一个英语单词，它的意思包括但不限于以下几种： 1. 拉紧，伸张。例如，这些动作可能对你的肌肉产生压力。 2.
  种类，类型。它常常用于指微生物或病毒的特定变种。 3. 心力交瘁，压力。指身心受到的压力或担忧。
sidebar:
  hidden: true
...
Strain 来源于拉丁语"strictus"，表示"紧张"或"伸展"。我们可以看到很多同样源自这个词根的单词，比如"strict"（严格的）和"district"（地区，地段）。
...
Strain 作为一个单词，早在 14 世纪就开始使用，最早来自中古英语"streinen"，意指"收紧"或"平衡"，随后逐渐发展出了现今我们使用的多种含义。
