---
title: Recommend
description: Recommend是一个动词，原意是“推荐”，“建议”。可以用于建议某个人、地点、产品或事件，也可以用于建议某种行为、活动或方案。
sidebar:
  hidden: true
...
<Pronunciation word="Recommend" uk="/ɹɛkəˈmɛnd/" us="/ɹɛkəˈmɛnd/" client:only />
...
Recommend 的三单形式是 recommends, 过去式和过去分词形式则为 recommended。
...
<WordRelations
  antonyms={["deprecate", "disapprove", "discourage", "disrecommend", "oppose"]}
  client:only
/>
