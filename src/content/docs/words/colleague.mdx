...
title: Colleague
description: >-
  Colleague 是英语中的一种名词，具有 '同事'
  的意思。这个单词经常用于工作环境中，描述和自己在同一工作场所工作，共同完成任务的人。这个单词与同行或对等的合作伙伴最为相关，而不仅仅是指工作的伙伴。
sidebar:
  hidden: true
...
<Pronunciation word="Colleague" uk="/ˈkɒliːɡ/" us="/ˈkɑliɡ/" client:only />
...
<WordRelations synonyms={["coworker", "workmate"]} client:only />
