...
title: Rapidity
description: >-
  「Rapidity」是一个名词，意思是'速度快，迅速'。它通常用来描述一种速度或行动的快速进行。例如：the rapidity of his
  speech（他讲话的速度）。
sidebar:
  hidden: true
...
<Pronunciation word="Rapidity" uk="/ɹəˈpɪdɪti/" us="/ɹəˈpɪdɪti/" client:only />
...
"Rapidity"这个词在 16 世纪时流行，最早是从法语的"Rapidité"中借来的，主要是用于描述一种速度或者行动的快速进行。
