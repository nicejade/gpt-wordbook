---
title: Set
description: set 一词在英语中拥有多重含义，最常见的是作为动词用于指“设置、安排”之意，同样也可以作为名词，表示“一套、一组”。
sidebar:
  hidden: true
...
<Pronunciation word="Set" uk="/sɛt/" us="/sɛt/" client:only />
...
"Every morning, Tom sets his alarm clock for 7 am. It's his set routine."（汤姆每天早晨都设定闹钟 7 点响。这是他的固定习惯。）
每天早晨，汤姆都会把闹钟设定在早上 7 点。这是他的日常习惯。

<WordRelations
  synonyms={["lay","put","light"]}
