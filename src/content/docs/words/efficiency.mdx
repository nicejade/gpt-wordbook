---
title: Efficiency
description: Efficiency是一个名词，用于描述做某件事的效率，即以最小的资源投入获得最大的成果。这个词也经常用于形容人或机器在执行任务时的效能或者性能。
sidebar:
  hidden: true
...
<Pronunciation word="Efficiency" uk="/ɪˈfɪʃn̩si/" us="/ɪˈfɪʃn̩si/" client:only />
...
这个单词可以通过"效"和"能"两个字来联想，其中"效"就像 efficient 的 effic 部分，"能"就像 ency 部分发音。
...
Tom 总是最后一个完成工作的人。有一天，他开始提前规划并专注于一件事情。他的工作效率显著提高。
