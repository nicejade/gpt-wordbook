...
title: Thereof
description: >-
  Thereof 是一种特殊形式的代词，被称为书面式的正式英语，用来代替“that（那个）”。“Thereof”的含义是“of that”或“of
  it”。这个单词在一些法律、庄重或者比较正式的文本中比较常见。
sidebar:
  hidden: true
...
<Pronunciation word="Thereof" uk="/ðɛəˈɹɒv/" us="/ðɛˈɹʌv/" client:only />
...
"Thereof"是古英语词汇，可以追溯到 14 世纪，由于其语言特性和表达清晰，被广泛用于法律、宗教和正式文件中。
