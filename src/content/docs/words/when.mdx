---
title: When
description: When 是一个连词，一般用于询问或者描述某一事件发生的时间，类似于中文里的 “何时” 或者 “当……时候”。
sidebar:
  hidden: true
...
<Pronunciation word="When" uk="/wɛn/" us="/wɛn/" client:only />
...
"When" 是一个古老的英语词，可以追溯到公元前 450 年的古英语 "hwanne"，在欧美文化中通常用来询问与时间相关的事情。
...
<WordRelations
  synonyms={["immediately","once","whenever","while","whilst","but","where","whereas"]}
  client:only
/>
