---
title: Obedient
description: Obedient 是一个形容词，主要表示“服从的”或“听话的”。这个词通常用于描述愿意遵守规则或顺从指示的人或动物。
sidebar:
  hidden: true
...
"Obedient" 这个词来源于拉丁语 "oboedientem"，意为“听从的”。英文词汇 "obedient" 于 14 世纪末期开始进入英语中，一直延续至今，并广泛应用于各种语境中。
...
<WordRelations
  synonyms={["dutiful", "hearsome"]}
  antonyms={["disobedient", "dominant"]}
  client:only
/>
