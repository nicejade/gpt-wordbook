...
title: Save
description: >-
  "Save"是一个英语动词，主要含有两个基本词义。 1. 保存，存储：这个意思一般用在我们想保留一些东西时，比如数据、食物等。 例如：Save your
  work before you leave. (在你离开之前保存你的工作。) 2. 救援，拯救：这个意思一般用在我们想帮助处于困境中的人或情况时。 例如：I
  was saved from the burning building by a firefighter. (我被一个消防员从燃烧的建筑中救出。)
sidebar:
  hidden: true
...
可以将 save 和 safe 联想在一起，当你记住 safe（安全）的时候，就会自然而然地想到 save（保存，使安全）
