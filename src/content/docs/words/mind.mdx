...
title: Mind
description: >-
  Mind 是一个非常普遍的英语词汇，它有多种含义，最常见的是作为名词，表示'思维'，'智力'或者'头脑'。此外，它还可以用作动词, 例如 '注意' 或
  '遵守'。另外，'Mind' 也常在俚语和短语中出现, 例如 'mind you', 'never mind'等。
sidebar:
  hidden: true
...
<Pronunciation word="Mind" uk="/maɪnd/" us="/maɪnd/" client:only />
...
<WordRelations
  synonyms={["brain","head","intellect","intelligence","psyche","reason","wit","awareness","consciousness","sentience","attention","concentration","focus","memory","recollection","desire","disposition","idea","inclination"]}
  client:only
/>
