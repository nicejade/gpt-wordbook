---
title: Permission
description: Permission 是一个名词，意思是允许或许可。它既可以指形式的批准，也可以指对某个行动或事情的默许。
sidebar:
  hidden: true
...
<Pronunciation word="Permission" uk="/pəˈmɪʃən/" us="/pɚˈmɪʃən/" client:only />
...
Permission 的词根来自于拉丁文 "permittere"，意思是 "let pass, allow"。"Per-" 意为 through，"mittere"意为 send。
...
<WordRelations antonyms={["prohibition"]} client:only />
