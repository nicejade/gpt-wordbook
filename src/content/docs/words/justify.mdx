...
title: Justify
description: >-
  Justify 是一个英语动词，基本解释为“证明... 正确或合理”或“为...
  辩护”。它可以用在很多场景中，来描述一种推理或证明某事物的正确性，以此来支持或维护某些行为、决定或观点。
sidebar:
  hidden: true
...
<Pronunciation word="Justify" uk="/ˈdʒʌstɪfaɪ/" us="/ˈdʒʌstɪfaɪ/" client:only />
...
"Justify"这个词最早源于法国，并于 14 世纪时被引入英语，在那之后一直沿用至今。它的原意是“行为符合道德或法律”，后来发展为“使合理化，证明为正当”。
