---
title: Versus
description: Versus 是一个常用的拉丁词，常缩写为 'vs' 或 'v'，在英语中意为“对”，常用于区分互相竞争或对立的两方。
sidebar:
  hidden: true
...
<Pronunciation word="Versus" uk="/ˈvɜːsəs/" us="/ˈvɜːsəs/" client:only />
...
<WordRelations synonyms={["v", "v.", "vs", "vs."]} client:only />
