...
title: Footstep
description: >-
  Footstep 是一个名词，它表示步行的声音，或者是一步，比如我们说 'follow in someone's footsteps'
  就是指按照某人的方式行事。
sidebar:
  hidden: true
...
<Pronunciation word="Footstep" uk="/ˈfʊtstɛp/" us="/ˈfʊtstɛp/" client:only />
...
英文中的 "footstep" 最初在中文乎 14 世纪的早期文献中出现，用来指代一个人或物体在地面上移动所产生的声音或印记。
...
<WordRelations
  synonyms={["plod","step","tread","footprint","track","pace","stride","path","point","trail","riser"]}
  client:only
/>
