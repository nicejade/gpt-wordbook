---
title: Detach
description: Detach是一个动词，它的基本含意是使物体或人与另一个物体或人分开，成为单独的或者独立的。在中文里我们通常翻译为“分离”或“脱离”。
sidebar:
  hidden: true
...
<Pronunciation word="Detach" uk="/dəˈtætʃ/" us="/dɪˈtætʃ/" client:only />
...
"Mike was hurt and had to detach himself from the past to move on. He resigned from his old job and started traveling." （Mike 受伤了，他必须要和过去断开联系才能继续前进。他辞掉了他的旧职位，开始了旅行。）

<WordRelations
  synonyms={["allocate", "earmark", "disengage", "unfasten"]}
  antonyms={["attach"]}
  client:only
/>
