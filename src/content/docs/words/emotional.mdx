---
title: Emotional
description: Emotional 是一个形容词，源自名词 'emotion'，意为充满情感的，富有感情的。它可以用来描述人、事物或者场合等。
sidebar:
  hidden: true
...
<Pronunciation word="Emotional" uk="/ɪˈməʊʃnəl/" us="/ɪˈməʊʃnəl/" client:only />
...
"Emotional"一词源于 17 世纪的英国，来自于拉丁词 “emotio”，意为"移动，推动" 后逐渐引申为情感的波动和刺激。
...
<WordRelations
  synonyms={["effusive","sentimental","temperamental"]}
  client:only
/>
