...
description: >-
  Cognitive
  这个单词来源于拉丁语“cognitivus”，其含义与知道、理解和思考等概念有关。在现代英语中，'cognitive'主要被用于描述与思考、理解或记忆等大脑认知函数相关的东西。
sidebar:
  hidden: true
...
<Pronunciation word="Cognitive" uk="/ˈkɒɡnɪtɪv/" us="/ˈkɒɡnɪtɪv/" client:only />
...
"Cognitive"这个词的使用在 20 世纪 50 年代开始增加，由于当时认知心理学的兴起，这个词开始在学术和日常语言中广泛使用。它仍然是科学，特别是心理学和教育学中的一个重要概念。
