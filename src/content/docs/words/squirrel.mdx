---
title: Squirrel
description: Squirrel是一种生活在树上的小型或中型哺乳动物。 在森林或公园中很常见，有着灵活的四肢和一种像扇子一样可以打开的尾巴。
sidebar:
  hidden: true
...
<Pronunciation word="Squirrel" uk="/ˈskwɪɹl̩/" us="/ˈskwɪɹl̩/" client:only />
...
<WordRelations synonyms={["scug"]} client:only />
