...
title: Gifted
description: >-
  Gifted 一词具有两层含义。首先，它用作形容词，描述一个拥有特殊天赋或才能的人，尤其在学术或艺术领域。其次，'gifted' 可以被理解为 “gift”
  的过去式和过去分词形式，表示赠送或送礼的动作。
sidebar:
  hidden: true
...
<Pronunciation word="Gifted" uk="/ˈɡɪftɪd/" us="/ˈɡɪftɪd/" client:only />
...
<WordRelations
  synonyms={["contribute", "donate", "give", "talented"]}
  client:only
/>
