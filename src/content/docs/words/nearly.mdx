---
title: Nearly
description: Nearly 是一个副词，表示接近或几乎。当我们想要说明一件事或一个数量之差不多或几乎就是时，我们就可以使用这个词。
sidebar:
  hidden: true
...
<Pronunciation word="Nearly" uk="/ˈniːɹli/" us="/ˈnɪɹli/" client:only />
...
<WordRelations
  synonyms={["almost","near","nigh","practically","virtually"]}
  client:only
/>
