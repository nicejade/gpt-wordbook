---
title: Chamber
description: Chamber 是一个复用性广泛的英文单词，通常它表示封闭的空间或者房间，可以引申为室、间、厅等。另外在立法机构里，它通常指代议院。
sidebar:
  hidden: true
...
<Pronunciation word="Chamber" uk="/ˈtʃeɪmbə(ɹ)/" us="/ˈtʃeɪmbɚ/" client:only />
...
此外，Chamber 的变形还有 "chambers"，表示多个房间或特别的空间。
...
<WordRelations synonyms={["blissom", "lust"]} client:only />
