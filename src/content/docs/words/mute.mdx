...
title: Mute
description: >-
  Mute在英语中有两个主要的含义：作为形容词，表示'沉静的，寡言的，不发声的'，例如'mute
  person'可以指哑巴，或者是不善言辞的人；作为动词，它表示'消音，使安静'。
sidebar:
  hidden: true
...
<Pronunciation word="Mute" uk="/mjuːt/" us="/mjuːt/" client:only />
...
"Mute"起源于古法国语"meut"，最初的意思是"静默的，哑的"。这个词在英语中的使用可以追溯到 14 世纪。
...
<WordRelations synonyms={["occlusive", "plosive", "stop"]} client:only />
