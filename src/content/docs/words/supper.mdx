...
description: >-
  Supper
  是一个英文字，主要用作名词，表示“晚餐”或“晚餐所吃的食物”。在美国和英国之间，关于“supper”的具体意义有所不同。在美国，“supper”通常指的是较早的晚餐，而在英国，“supper”通常指的是在晚上或夜晚之后的一个小餐。
sidebar:
  hidden: true
...
<Pronunciation word="Supper" uk="/ˈsʌpə/" us="/ˈsʌpɚ/" client:only />
...
'Supper' 这个词在 17 世纪有记录，初始是描述在主餐 - 即晚餐之后的夜宵。这在当时的英国社会中很常见，人们会在晚上较晚的时间再吃一些食物。然后经过时间的推移，这个词的含义开始变化，现在在不同的地方和文化里，晚餐有不同的意义。
...
<WordRelations synonyms={["dinner"]} client:only />
