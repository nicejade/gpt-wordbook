...
description: >-
  Air
  是个名词，一般指我们呼吸的气体，也就是包含了氮、氧等元素的大气。同时，'air'也可以作为动词使用，例如表示'让风吹过以使新鲜'或者'在电视上，广播中播放'。
sidebar:
  hidden: true
...
<Pronunciation word="Air" uk="/ˈɛə/" us="/ˈɛəɹ/" client:only />
...
Air 作名词时,复数形式为 airs，用于表示"摆架子，装腔作势"的意思。作动词时，变形包括 airs, airing, aired。
...
Jay 打开窗户，深深吸了一口凉爽的晚风。他喜欢这种新鲜的味道。知道他最爱的节目将要播出，他感到非常兴奋和满足。

<WordRelations
  synonyms={["atmosphere", "aura", "gas", "lift", "nimbus"]}
  client:only
/>
