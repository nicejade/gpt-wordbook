...
description: >-
  Attend
  这个单词在英语中主要有两个含义。首先，最常见的含义是'参加'或者'出席'，通常用于某个活动或者事件。另外，'attend'也可以表示'关注'，'照顾'，或者'服务'。
sidebar:
  hidden: true
...
<Pronunciation word="Attend" uk="/əˈtɛnd/" us="/əˈtɛnd/" client:only />
...
"Attend"这个单词源于 14 世纪的中古英语，原意是"留意，注意"。后来，随着社会和文化的变迁，词义发生了扩展，从"留意"拓展到了"看护"、"参与"。
...
<WordRelations
  synonyms={["notice","behear","heed","mark","bestand","serve"]}
  client:only
/>
