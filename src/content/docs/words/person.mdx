---
title: Person
description: Person 是一个名词，主要指一个人或者一个直接参与某种活动或事件的单位。一般可以表示所有的人类，也可指某一个特定的人。
sidebar:
  hidden: true
...
<Pronunciation word="Person" uk="/ˈpɜːsən/" us="/ˈpɝsən/" client:only />
...
Person 的复数形式为"People"或"Persons"，表现的是数量的变化，例如 "three persons" or "three people".（这里翻译为：三个人）。
