...
description: >-
  Freezing
  是形容词，也可以作为动词，本身涵盖两种基本意义。一作为形容词，一般用来描述非常冷的天气或温度。二作为动词，它可以表示改变物体的状态至固态，例如水变为冰，或者把食物放在冷冻室中以防腐
  。
sidebar:
  hidden: true
...
<Pronunciation word="Freezing" uk="/ˈfɹiːz.ɪŋ/" us="/ˈfɹiːz.ɪŋ/" client:only />
...
<WordRelations
  synonyms={["solidify","halt","immobilize","hang","seize","frost","frigorific","frosty","icy"]}
