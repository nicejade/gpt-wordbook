---
title: Snob
description: Snob 是一个名词，通常用来形容一个总是瞧不起人，只看重地位、财富，或者精英社会的人。
sidebar:
  hidden: true
...
<Pronunciation word="Snob" uk="/snɒb/" us="/snɒb/" client:only />
...
"Snob" 一词在 18 世纪首次出现，当时是剑桥大学的一个俚语，用来指代没有贵族血统的普通学生。19 世纪初，它的义项扩大，开始用来形容那些过分热衷于模仿、追求上流社会生活方式，并看不起下层阶级的人。
...
<WordRelations synonyms={["cad"]} client:only />
