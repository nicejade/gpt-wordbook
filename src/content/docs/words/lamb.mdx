---
title: Lamb
description: Lamb 是一个名词，既可以指一只羊羔，也可以指一只年轻的羊。在一些语境中，人们会用 'lamb' 来比喻因无辜或纯真而受苦的人。
sidebar:
  hidden: true
...
<Pronunciation word="Lamb" uk="/læm/" us="/læm/" client:only />
...
<WordRelations synonyms={["sheepling"]} client:only />
