...
title: Muscle
description: >-
  Muscle（肌肉）指的是身体的一种组织，由纤维性生物组织构成，其主要功能是通过收缩产生运动。词语“muscle”
  可以用在描述人体的肌肉组织，也可以用在描述力量和力气的过程中。
sidebar:
  hidden: true
...
<Pronunciation word="Muscle" uk="/ˈmʌs.əl/" us="/ˈmʌs.əl/" client:only />
...
Muscle 这个词在拉丁语中的原义是“小老鼠”，因为古人观察到当肌肉在皮肤下面活动的时候，看起来就像老鼠在皮肤下面游走，于是称之为“musculus”，也就是“小老鼠”。这个词经由法语传入英语，逐渐演变为现在的“muscle”。

### 单词变形

Muscle 作为名词，其复数形式为 muscles；作为动词，一般现在时第三人称单数为 muscles，过去式和过去分词为 muscled。
...
<WordRelations synonyms={["thew"]} client:only />
