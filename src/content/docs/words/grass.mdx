---
title: Grass
description: Grass 是一个英文词汇，通常指的是一种建筑或者装饰物，特别是公园、花园或者田野上的草地。在广义上，'Grass' 也可以引申为所有的草本植物。
sidebar:
  hidden: true
...
<Pronunciation word="Grass" uk="[ɡɹ̠ɑːs]" us="[ɡɹ̠eəs]" client:only />
...
<WordRelations
  synonyms={["breakup","spring","springtime","ephemera","flatten","floor"]}
  client:only
/>
