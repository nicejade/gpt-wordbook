---
title: Offset
description: Offset 是一个英文单词，它在中文中主要有以下含义：
sidebar:
  hidden: true
...
<Pronunciation word="Offset" uk="/ɒfˈsɛt/" us="/ɒfˈsɛt/" client:only />
...
"Offset"这个词源自 14 世纪的中英语，原意为从一边设置或放置位置。当用于财务术语时，是指用一种收益来平衡另一种成本或亏损。
...
"There was a change in the menu at Tom's Café, but the price cut offset the customers' disappointment. Not only did business not decline, but it also improved." （Tom 的咖啡厅菜单有所改变，但是价格的降低抵消了顾客的失望。生意不仅没有下滑，反而有所改善。）
