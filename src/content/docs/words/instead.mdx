---
title: Instead
description: Instead是一个英文副词，常用于表示“作为替代”，或者“而不是”。
sidebar:
  hidden: true
...
<Pronunciation word="Instead" uk="/ɪnˈstɛd/" us="/ɪnˈstɛd/" client:only />
...
"Instead"来源于古英语中的 "on stede"，原意为“在...位置”，在 13 世纪时，词语的用法转向了“作为替换”。
...
(彼得有一个选择要做：按计划去公园，还是呆在家里完成他的项目？他选择了后者并努力工作。所以，彼得拿到了他的项目的 A。)
