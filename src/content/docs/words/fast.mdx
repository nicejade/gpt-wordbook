...
<WordRelations
  synonyms={["express","quick","rapid","speedy","swift","easy","ahead","deep","sound","firm","immobile","secure","stable","tight","fortified","impenetrable"]}
  antonyms={["local","stopper","slow","behind","light","loose","penetrable","weak","lightly","loosely"]}
  client:only
/>
