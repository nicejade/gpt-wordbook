---
title: Fast
description: Fast主要有两大意思：一个是形容词，表示'快速的'；另一个是动词或名词，表示'禁食'。
sidebar:
  hidden: true
...
<Pronunciation word="Fast" uk="/fæst/" us="/fæst/" client:only />
...
<WordRelations
  synonyms={["express","quick","rapid","speedy","swift","easy","slutty","ahead","deep","sound","firm","immobile","secure","stable","stuck","tight","fortified","impenetrable"]}
  antonyms={["local","stopper","slow","behind","light","loose","penetrable","weak","lightly","loosely","slowly"]}
  client:only
/>
