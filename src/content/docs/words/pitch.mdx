---
title: Pitch
description: Pitch是英文中的一个多义词，可根据上下文的不同有多种意思。主要有以下三个意思：
sidebar:
  hidden: true
...
<Pronunciation word="Pitch" uk="/pɪtʃ/" us="/pɪtʃ/" client:only />
...
Pitch 源于古英语 "piccan" ，原意是“用尖物刺”，有“投掷”之意。

### 词缀分析

Pitch 是一个单词本身，没有前缀和后缀。但它可以与其他词语组合形成复合词，例如：pitch-black (漆黑的)，pitch in（鼓足干劲；出一份力）。

### 文化背景

Pitch 的概念在各种语言文化中都有贯穿，尤其在运动（例如：棒球）和音乐中的应用最为常见。
