---
title: Significant
description: Significant是一个英文形容词，主要用于形容某事物或者事件有重大的、重要的或者显著的含义。也可以用于描述数量或数量上有显著差异的情况。
sidebar:
  hidden: true
...
"Significant"的词缀结构是：-ic 为形容词后缀，表示"...的"，-ant 也是形容词后缀，表示"...的"。相同词缀的其他单词有：electric（电的）、romantic（浪漫的）等。

### 文化背景

"Significant"这个词源自 14 世纪的拉丁语中的“significans”，原意是“象徵的”，后在欧美文化中逐渐发展为“重要的”、“显著的”的含义。

### 单词变形

"Significant"的名词形式为 significance，意为“重要性”；而它的副词形式为 significantly，意为“显著地”。
...
<WordRelations
  synonyms={["important"]}
  antonyms={["ignorable", "insignificant", "negligible", "slight"]}
  client:only
/>
