---
title: Steamer
description: Steamer主要有两个含义，一个是指蒸汽机，尤指用蒸汽驱动的船或火车；另一个是指蒸锅，也就是我们用来蒸食物的具有封盖的容器。
sidebar:
  hidden: true
...
<Pronunciation word="Steamer" uk="/ˈstiːmə(ɹ)/" us="/ˈstiːmə(ɹ)/" client:only />
...
<WordRelations
  synonyms={["bender","binge","carouse","packer","steamer"]}
  client:only
/>
