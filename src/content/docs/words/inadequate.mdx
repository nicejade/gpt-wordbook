---
title: Inadequate
description: Inadequate是一个形容词，主要意思是“不充分的，不足的，不适当的”。一般用来形容某件事情、物品或者人不足以满足一定的要求。
sidebar:
  hidden: true
...
"Inadequate" 源自于拉丁词根 "adæquātus"，在英语中，它首次出现在 17 世纪，用来描述某物不足以达到一定标准或要求。
...
<WordRelations synonyms={["deficient", "insufficient"]} client:only />
