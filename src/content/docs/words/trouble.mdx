---
title: Trouble
description: 「Trouble」一词，通常作为名词使用，指的是问题、困扰、麻烦，也可以作为动词，表示‘困扰’、‘烦扰’。
sidebar:
  hidden: true
...
<Pronunciation word="Trouble" uk="/ˈtɹʌb(ə)l/" us="/ˈtɹə-/" client:only />
...
Trouble 的词根是"turb", 源于拉丁语，原意是'扰乱'。
...
Trouble 这个词在 12 世纪从法语引入英文，在法语中它来自于拉丁语的'turbo'，原意是混乱，烦恼。
