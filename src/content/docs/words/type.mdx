---
title: Type
description: Type 一词源自中世纪拉丁语的 'typus'，在现代英语中有多个词义，它可以被用作名词和动词。
sidebar:
  hidden: true
...
<Pronunciation word="Type" uk="/taɪp/" us="/taɪp/" client:only />
...
<WordRelations
  synonyms={["category","class","genre","group","kind","nature","sort","stripe","tribe"]}
  client:only
/>
