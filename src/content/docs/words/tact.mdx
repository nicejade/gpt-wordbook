...
Tact 是一个英文名词，用于描述某人在处理敏感、流利或困难的问题时显示的敏锐感觉或理解。它也可以用来表示有技巧地处理人际关系的能力，以取得良好的结果且不会冒犯或触怒其他人。

<Pronunciation word="Tact" uk="/tækt/" us="/tækt/" client:only />
...
"Tact"源于 17 世纪，直译的意思是“感觉”，或者“感知”。它的使用之初主要涉及到文字理解或者物理接触。然后，18 世纪开始，它的使用逐渐扩展到了对人际交往的敏感和技巧性的理解。
...
将"Tact" 和"Touch" 进行联想，帮助记忆；当你触摸东西的时候需要使用恰当的力度，同样，tact 的含义也是要我们在处理敏感或困难的事物的时候小心翼翼，恰到好处。
...
<WordRelations
  synonyms={["consideration","diplomacy","sensitivity","tactfulness","maneuver","plan","scheme","stratagem"]}
  client:only
/>
