---
title: Pasture
description: Pasture 是一个英语单词，主要指的是供动物觅食的草地或者牧场。它也可以作为动词，意为把（牛，羊等）放牧。
sidebar:
  hidden: true
...
<Pronunciation word="Pasture" uk="/ˈpɑːstjə/" us="/ˈpæstʃɚ/" client:only />
...
<WordRelations synonyms={["leasow"]} client:only />
