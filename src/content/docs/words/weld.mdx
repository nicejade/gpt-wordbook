---
title: Weld
description: 英语单词 "weld" 常常用作动词，指的是通过热量，特别是高温的熔化来把金属或者其他材料的两端连接在一起。 当 "weld" 用作名词时，它指的是这个连接点，或者是这过程本身。 像在制造业中说：“He used a torch to weld the pieces together” 他用焊枪把这些部分焊接在一起。
sidebar:
  hidden: true
...
"weld"最早作为一个名词使用，指的是种植物的名字，然后在 16 世纪的时候，与金属的加工工艺联系在一起，意为 "to join pieces of metal by heat"。 从那以后，这个词就广泛地被应用在各种制造业之中。
