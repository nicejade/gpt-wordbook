---
title: "saturation"
description: "Saturation 是一个名词，表示“饱和”。在不同的环境中，它有不同的含义。在物理或化学中，它描述了物质或溶液达到其最大容量的状态——没有更多的物质可以被吸收或溶解。在颜色理论中，它用来描述颜色的纯度或强度。"
---
...
Saturation 这个词在 14 世纪首次出现在英语中，用来描述负荷或容量的极限状态。在科学和技术领域，这个词用来描述物质或系统的充满状态。在艺术和设计中，饱和度用来描述颜色的强度或纯度。
