---
title: Ordinarily
description: Ordinarily 是一个副词，主要用于描述某种情况是常态，平常的情况或通常情况下的事情。它的意思是'通常'，'一般'。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["conventionally","customarily","traditionally","ordinarily","routinely","commonly"]}
  client:only
/>
