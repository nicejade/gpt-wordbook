...
title: Father
description: >-
  Father 是一个英语名词，它最基本的含义是指一个孩子的父亲。此外，'Father' 也常被用以形容创始人或者领导者等，比如 'the father of
  modern science'。
sidebar:
  hidden: true
...
<Pronunciation word="Father" uk="/ˈfɑːðə(ɹ)/" us="/ˈfɑðɚ/" client:only />
...
"Father" 一词在英语中已有数百年的历史，可追溯到早期的英格兰人，它的词源可以追溯到更早的印欧语系。同时在欧美文化中，"Father"被尊为家庭的顶梁柱和 Protector。
...
<WordRelations
  synonyms={["granddaddy", "mother"]}
  antonyms={["child", "daughter", "son", "mother"]}
  client:only
/>
