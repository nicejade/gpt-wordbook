---
title: Perpetual
description: Perpetual 是一个形容词，源自拉丁文 'perpetus'，意为“持续的，永恒的”，在英文中通常用来描述一种永无止境的状态或持续不断的情况。
sidebar:
  hidden: true
...
“Perpetual”一词源自中世纪拉丁语“perpetualis”，而这个词则来自原始拉丁语“perpetuus”，表示“持续的，连续的”。它在英国在 14 世纪开始使用，用于描述无穷无尽的事物。
...
<WordRelations
  synonyms={["continuant", "persistent", "continuous", "nonstop"]}
  client:only
/>
