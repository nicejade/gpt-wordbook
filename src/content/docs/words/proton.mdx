---
title: Proton
description: Proton 是一个英文名词，意味着“质子”。它是原子核的基本组成部分，带有一个正电荷。
sidebar:
  hidden: true
...
<Pronunciation word="Proton" uk="/ˈpɹəʊ.tɒn/" us="/ˈpɹoʊ.tɑn/" client:only />

### 列举例句

1.  A proton is about 1,800 times heavier than an electron.
    一个质子的质量大约是电子的 1800 倍。
...
“Proton”这个词源自希腊语的 'πρώτον'，意思是"first"，因为当物理学家在研究原子时，他们认识到质子是所有原子的共同组成部分。这个术语自 19 世纪末开始在物理学中使用。
...
<WordRelations synonyms={["p"]} client:only />
