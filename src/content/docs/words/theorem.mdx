---
title: Theorem
description: Theorem 这个词在英语中是名词，意思为“定理”，通常用在数学或物理等科学领域，指一个已被证明为真的陈述或公式。
sidebar:
  hidden: true
...
<Pronunciation word="Theorem" uk="/ˈθiː.ə.ɹəm/" us="/ˈθiː.ə.ɹəm/" client:only />
...
<WordRelations
  synonyms={["lemma", "proposition", "statement", "conjecture"]}
  client:only
/>
