...
title: Logically
description: >-
  Logically 是一个副词，来源于形容词
  'logical'，表示“逻辑地，按逻辑推理的方式”，用于描述一个人的思维过程、争论、推理等是按照逻辑规则进行的。
sidebar:
  hidden: true
...
"Logically" 这个词来源于 16 世纪的拉丁语 "logica" ，当时用于哲学和逻辑学。这个词在欧美文化中被广泛使用，表示一种理性的思考和抽象推理的方式。
...
<WordRelations antonyms={["illogically"]} client:only />
