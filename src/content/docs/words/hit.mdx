...
title: Hit
description: >-
  Hit可以作为动词也可以作为名词，它的核心意思可以表示'打击'，'碰撞'或者'成功而受欢迎的事'。当然在口语表达中'hit'的意义会更丰富如'hit the
  road'意为起程或者动身。
sidebar:
  hidden: true
...
<Pronunciation word="Hit" uk="/hɪt/" us="/hɪt/" client:only />
...
过去式和过去分词形式为：hit，现在分词形式为：hitting。构成的短语有 hit the books (开始认真学习)、hit in the pocket (经济上受到打击)等。
...
Tom is always late for class. One day, he hit the alarm clock in anger when it rang. Unexpectedly, the alarm clock didn't ring the next day, and Tom was late again.(Tom 总是迟到。一天，闹钟响起时他气愤地打了一下。没想到，第二天闹钟没响，Tom 又迟到了。)

<WordRelations
  synonyms={["beat","pelt","thump","beset","bang","ram","smash","whack","toke"]}
  antonyms={["miss","flop","turkey","cut","kill"]}
  client:only
/>
