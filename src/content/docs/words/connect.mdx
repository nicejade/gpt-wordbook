...
title: connect
description: >-
  Connect 是一个动词，意思是链接，联接或连接。可以用于描述一系列的连续动作，使事物相互关联或联系在一起。 比如： * Connect the
  computer to the internet. (把电脑连接到互联网。) * I couldn't connect the facts
  together. (我无法将这些事实联系在一起。)
sidebar:
  hidden: true
