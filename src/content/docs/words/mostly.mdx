---
title: Mostly
description: "- 'Mostly'是一个副词，主要用来描述某物的主要特性或人们的主要行动。它表达的意思是“主要地，大部分”。"
sidebar:
  hidden: true
...
<Pronunciation word="Mostly" uk="/ˈməʊstli/" us="/ˈmoʊstli/" client:only />
...
- "Mostly"这个单词来源于英语，其形态沿袭了许多古英语和中古英语的规律。这个单词在英美文化中，lot 被广泛的用在各种语境和环境中，表示多数或者大部分的意思。
...
<WordRelations
  synonyms={["largely", "predominantly", "principally"]}
  client:only
/>
