---
title: Uranium
description: Uranium，中文名称为铀，它是一种银白色的放射性金属元素，化学符号为 U，是原子序数为 92 的元素。
sidebar:
  hidden: true
...
Uranium，中文名称为铀，它是一种银白色的放射性金属元素，化学符号为 U，是原子序数为 92 的元素。

<Pronunciation word="Uranium" uk="/jʊˈɹeɪniəm/" us="/jʊˈɹeɪniəm/" client:only />
...
词根词缀分析：
Uranium 这个词并没有特别明显的词根或者词缀。它来自于拉丁词“Uranus”，意为战神，或者天王星。

### 文化背景

Uranium 的发现要追溯到 1789 年，那时的德国化学家 Martin Klaproth 将其命名为 Uranium，以纪念刚刚被发现的太阳系新星天王星(Uranus)。
...
Uranium 的发音与“you rain”相似，你可以设想下雨的画面使得你的记忆更加深刻。
