---
title: Zero
description: Zero 是一个英文单词，主要意思是'零'，在数学和科学中被广泛使用。它还有其它含义，例如表示'无'，'没有'，或者形容某人或某事为'无足轻重的'。
sidebar:
  hidden: true
...
Zero 是一个英文单词，主要意思是"零"，在数学和科学中被广泛使用。它还有其它含义，例如表示"无"，"没有"，或者形容某人或某事为"无足轻重的"。

<Pronunciation word="Zero" uk="/ˈzɪəɹəʊ/" us="/ˈzi(ˌ)ɹoʊ/" client:only />
...
Zero 源自于拉丁语的"zephyrus"，意为西风。因为阿拉伯人在记书写数字时以西风代表零，而后演化成我们现在的单词"zero"。

### 词缀分析

Zero 本身并没包含词缀，是一个无缀词。
...
<WordRelations
  synonyms={["nadir","nada","naught","nil","nothing","nought","nowt","null","zilch","zip","cipher","nobody","nonentity"]}
  antonyms={["pole"]}
  client:only
/>
