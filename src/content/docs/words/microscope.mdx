...
title: Microscope
description: >-
  Microscope 是一个名词，来源于希腊语“micros”（小的）和“skopein”（看）。所以，Microscope
  即为用来看小东西的工具，也就是“显微镜”。
sidebar:
  hidden: true
...
"Microscope" 这个单词是在大约 1650 年左右形成的，在那个时候它是用来描述一个可以放大小物体方便观看的新型设备。
...
<WordRelations synonyms={["microscopize"]} client:only />
