...
title: Human
description: >-
  Human 是一个英语单词，代表'人'或'人类'。通常用于描述与人类有关的事物，例如人类行为(human behavior)、人类学(human
  studies)，等等。
sidebar:
  hidden: true
...
<Pronunciation word="Human" uk="/ˈhjuː.mən/" us="/ˈ(h)ju.mən/" client:only />
...
<WordRelations synonyms={["man", "mannish", "mennish"]} client:only />
