---
title: Within
description: 英语单词 'within' 是一个介词，表示在...之内，或者在...范围之内。也可以表达在某个时间段内、在某种能力范围内等等。
sidebar:
  hidden: true
...
<Pronunciation word="Within" uk="/wɪˈθɪn/" us="/wɪðˈɪn/" client:only />
...
"Within"源自老英语的"withinnan"，将"with" （表示在...里面）和"innan"（来自 inside / inside 的旧式形式)结合在一起。
...
<WordRelations antonyms={["outside", "outwith", "without"]} client:only />
