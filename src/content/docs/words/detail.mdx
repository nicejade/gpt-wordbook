---
title: Detail
description: Detail 在英文中主要有两个含义，作为名词，它指的是细节或者详尽的描述；作为动词，它表示详述或者派遣。
sidebar:
  hidden: true
...
<Pronunciation word="Detail" uk="/ˈdiːteɪl/" us="/dɪˈteɪl/" client:only />
...
Detail 这个词起源于 14 世纪的法文，原意是"切下、割下"，后逐渐发展并引申为"细节、详情"的意思。
...
<WordRelations
  synonyms={["detachment","portion","section","particular","minutia","technicality","trifle","triviality","detach","specify"]}
  client:only
/>
