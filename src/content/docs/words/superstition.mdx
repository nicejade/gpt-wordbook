---
title: Superstition
description: Superstition是名词，表示“迷信”。这是对某个人或群体对某些事物的无理解的，非科学或非逻辑的信仰。
sidebar:
  hidden: true
...
<Pronunciation
  word="Superstition"
  uk="/ˌs(j)u.pə(ɹ)ˈstɪ.ʃn̩/"
  us="/ˌs(j)u.pɚˈstɪ.ʃn̩/"
  client:only
/>
...
"Superstition"的词根是 latin 词根 "super-"和 "stare"。 "super-" 意为"超过"，"stare" 意为 "站立"。"super-" 衍生出很多单词如 superior（优越的）, superman（超人）等。"stare" 衍生出很多单词如 stature（身高）, status（状态）等。

### 词缀分析

"Superstition"无前缀和后缀，但"super-"在这里可以看作虚缀，没有实际独立的意义。与"super-"相关的单词有：superpose, supernormal 等。

### 文化背景

"Superstition"源自 late Middle English，根据 oxford 英语词典，此词取自法语的“superstitio”。该词具有宗教和文化多样性的痕迹，代表了人类对未知的恐惧和尊重。
