...
description: >-
  Humble
  是一个形容词，主要用来形容那些不自大、谦逊的人或者物品的特性。它表达了对他人尊重和谦逊的态度。例如，我们说一个人非常'humble'，就是说他/她非常低调、不自我炫耀。
sidebar:
  hidden: true
...
<Pronunciation word="Humble" uk="/ˈhʌmbəl/" us="/ˈhʌmbəl/" client:only />
...
<WordRelations
  synonyms={["abase","degrade","depress","disgrace","lower","modest","unassuming"]}
  antonyms={["arrogant", "presumptuous", "smug", "snobby"]}
  client:only
/>
