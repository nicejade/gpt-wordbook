---
title: Honey
description: "Honey 是英语中的一个名词，通常用来表示一种甜的, 浓稠的黄色食物，由蜜蜂收集花蜜制成。在比喻语中，'honey'还可以用来称呼心爱的人或者美貌的人。"
sidebar:
  hidden: true
...
<Pronunciation word="Honey" uk="/ˈhʌni/" us="/ˈhʌni/" client:only />
...
<WordRelations synonyms={["mel", "darling", "sweetie"]} client:only />
