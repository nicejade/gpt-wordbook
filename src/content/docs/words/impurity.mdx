---
title: Impurity
description: Impurity 是一个英文单词，指的是“不纯，杂质”。它的形容词形式为'impure'，通常用来形容物质内部含有杂质，或者抽象地用来形容思想、行为不纯洁。
sidebar:
  hidden: true
...
Impurity 一词源于中世纪的拉丁词 impuritas，原意是“不纯净的”，后来用于形容物理和道德的不纯。在欧美文化中，"purity" 泛指道德的纯洁，而 "impurity" 则表示失去这种纯洁性。
...
<WordRelations synonyms={["impureness"]} antonyms={["purity"]} client:only />
