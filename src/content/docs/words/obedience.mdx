...
title: Obedience
description: >-
  Obedience 是一个名词，意思是 '服从'，也就是不反抗权威或指导，而是完全按照指示行事。绝对的、没有任何质疑或抵抗的服从，我们称之为 '绝对服从'
  或 '盲目服从'。所以在某种程度上，obedience 有着积极的含义，对于规章制度、法律法规，我们应该要有的身心服从。
sidebar:
  hidden: true
...
(在一个小镇上，有一只因其显著的服从性而闻名的狗。这只名叫 Leo 的狗，遵守主人的每一条指令，这种情景总是让每个人感到惊讶。)

<WordRelations
  synonyms={["submission"]}
  antonyms={["control","dominance","defiance","rebellion","violation"]}
  client:only
/>
