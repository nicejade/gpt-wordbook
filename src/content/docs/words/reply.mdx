---
title: Reply
description: Reply 是一个英语单词，作为动词，它的意思是回答，比如回答一个问题或者回应一个表达。作为名词，它表示对于一个问题或者表达的答复或回应。
sidebar:
  hidden: true
...
<Pronunciation word="Reply" uk="/ɹɪˈplaɪ/" us="/ɹɪˈplaɪ/" client:only />
...
"Reply" 一词最早出现在 14 世纪的英语中，来源于拉丁语 "replicare"，它在现代英语中广泛使用，而且不仅在口语中，在书面语言中也非常常见。
...
<WordRelations
  synonyms={["account","answer","comeback","reaction","rejoinder","response","retort","return","riposte","counter","react","rejoin","respond","revert"]}
  client:only
/>
