---
title: Introduction
description: Introduction 英 /ˌɪntrə'dʌkʃən/，是名词，意为 '介绍'，'引言'，'导论'。
sidebar:
  hidden: true
...
<Pronunciation word="Introduction" uk="/ˌɪntɹəˈdʌkʃən/" us="/ˌɪntɹəˈdʌkʃən/" client:only />
...
Introduction 这个单词源于拉丁语的 "introductio"，意为引进，导入。一开始在 14 世纪被引入英语中使用，主要用于指向话题的引介，或者引领人进入某个位置或者现象。
...
<WordRelations
  synonyms={["isagoge","lead","lede","preface"]}
  client:only
/>
