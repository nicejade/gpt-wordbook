---
title: Comma
description: Comma 是一个英语单词，也是我们编写或阅读文本时常见的一个符号。其主要用途是在句子中创建一个自然的停顿，或者用于列出或区分项目。
sidebar:
  hidden: true
...
<Pronunciation word="Comma" uk="/ˈkɒm.ə/" us="/ˈkɑm.ə/" client:only />
...
"Comma" 这个词源于公元前 3 世纪的希腊，该用词由阿历山大的语言学家首次使用，主要用于割开不同的句子和短语，使读者能够在阅读时更有节奏感。
...
<WordRelations synonyms={["come", "virgula", "virgule"]} client:only />
