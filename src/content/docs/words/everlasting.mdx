---
title: Everlasting
description: Everlasting 是一个形容词，表示'永恒的，永久的'。 这个词常常用来描述持续不断的或者看起来无休止的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Everlasting" uk="/ˌɛvəˈlɑːstɪŋ/" us="/ˌɛvɚˈlæstɪŋ/" client:only />
...
<WordRelations
  synonyms={["continual","endless","eternal","immortal","incessant","infinite","interminable","unceasing","unintermitted","uninterrupted","unlimited","sempiternal"]}
  antonyms={["finite","limited","mortal","ephemeral"]}
  client:only
/>
