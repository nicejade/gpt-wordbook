...
title: Peg
description: >-
  Peg作为一个名词，通常指一个小而尖的物体，用于固定或挂起物体，比如钉子或者挂钩。作为一个动词，它有好几种含义：可以表示固定某物的价格或者比率；也可以表示准确地识别或者分类。
sidebar:
  hidden: true
...
<Pronunciation word="Peg" uk="/pɛɡ/" us="/pɛɡ/" client:only />
...
"Peg"这个单词来自老挪威语的"peggr"，原意为钉子或棍子。它在英语中的使用可以追溯到 14 世纪。
...
<WordRelations synonyms={["shot"]} client:only />
