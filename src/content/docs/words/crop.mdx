---
title: Crop
description: crop 作为名词时，主要有两个含义，一个是“作物，庄稼”，另一个是“一次的产量”。作为动词时则表示“剪短，修剪，收割”。
sidebar:
  hidden: true
...
<Pronunciation word="Crop" uk="/kɹɒp/" us="/kɹɑp/" client:only />
...
<WordRelations
  synonyms={["craw","harvest","yield","bat","whip"]}
  client:only
/>
