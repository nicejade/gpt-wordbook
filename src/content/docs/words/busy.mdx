...
description: >-
  Busy
  是一个形容词，表示“忙碌的”或“占用的”。这个词可以用来描述一个人在工作、学业或其他活动中积极投入，没有闲暇时间的状态。也可用来描绘一个地方或事物，比如交通路线，咖啡馆等，一直有很多活动或嘈杂声的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Busy" uk="/ˈbɪzi/" us="/ˈbɪzi/" client:only />
...
<WordRelations synonyms={["swamped"]} client:only />
