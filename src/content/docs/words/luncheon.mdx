---
title: Luncheon
description: Luncheon 是一个英语名词，指的是正午或中午稍晚一些时候的一顿正式的或正规的午餐。
sidebar:
  hidden: true
...
<Pronunciation word="Luncheon" uk="/ˈlʌntʃ.ən/" us="/ˈlʌntʃ.ən/" client:only />
...
在 17 世纪的英格兰，"luncheon" 单词被用于描述一顿小的午餐，该午餐通常在正餐之间服用。随着时间的推移，"luncheon" 在现代英语中通常定义为一顿稍大的午餐，通常在某种事件或会议中进行。
