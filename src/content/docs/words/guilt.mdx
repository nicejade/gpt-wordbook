---
title: Guilt
description: Guilt 是一个名词，主要用于表达“犯罪”或“过错”后造成的内心愧疚和罪恶感。它还可以指在法律上，一个人对犯罪行为的责任。
sidebar:
  hidden: true
...
<Pronunciation word="Guilt" uk="/ɡɪlt/" us="/ɡɪlt/" client:only />
...
<WordRelations synonyms={["remorse"]} antonyms={["innocence"]} client:only />
