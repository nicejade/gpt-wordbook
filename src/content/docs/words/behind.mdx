...
title: Behind
description: >-
  Behind是一个英语介词，其基本含义为'在...的后面'，可以描述物理空间中的位置关系。此外，该单词也可以作为副词使用，表示“留在原地”。当作为形容词时，'behind'可以表示'落后的'或'晚于的'。
sidebar:
  hidden: true
...
<Pronunciation word="Behind" uk="/bəˈhaɪnd/" us="/bəˈhaɪnd/" client:only />
