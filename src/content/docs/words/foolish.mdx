---
title: Foolish
description: Foolish是英语中的一个形容词，用来描述某人或某事缺乏普通的理解力或判断力，即傻的、愚蠢的。
sidebar:
  hidden: true
...
<Pronunciation word="Foolish" uk="/ˈfuː.lɪʃ/" us="/ˈfuː.lɪʃ/" client:only />
...
"Foolish" 这个单词的最初出现是在 14 世纪，由古英语的 "fōl" （愚蠢的）和 "-isc"（有……性质的）两个词组合而成。
...
<WordRelations
  synonyms={["absurd", "idiotic", "ridiculous", "silly", "unwise"]}
  antonyms={["wise"]}
  client:only
/>
