---
title: Concert
description: concert 是名词，主要意思是音乐会或演唱会。
sidebar:
  hidden: true
...
<Pronunciation word="Concert" uk="/ˈkɒnsət/" us="/ˈkɒnsət/" client:only />
...
"concert" 这个词在 16 世纪时导入英语，最初意思表示各种元素的协调或互相关联。它在 17 世纪开始用于音乐，表示为音乐表演的场所或表演活动。
...
<WordRelations synonyms={["gig"]} client:only />
