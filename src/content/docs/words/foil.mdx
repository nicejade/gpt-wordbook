...
title: Foil
description: >-
  "Foil" 可以有很多意思，具体取决于上下文环境： 1. "Foil" 是一个名词，主要意思是“锡纸”。例如：We wrapped the chicken
  in foil before grilling it.（我们在烤这只鸡前用锡纸包了起来。） 2. "Foil" 作为动词意思是阻止，挫败。例如： Her
  plans were foiled by the rain.（她的计划被雨打乱了。）
sidebar:
  hidden: true
