---
title: Ridicule
description: Ridicule 是一个英语单词，它的意思是嘲笑或者奚落。这是一个贬义词，指的是用尖刻或者侮辱的语言来指责或者嘲笑他人。
sidebar:
  hidden: true
...
"Ridicule" 是一个来源于拉丁语词汇 "ridiculus" 的词，意为 laughable，最初在 16 世纪后半叶由法国引入英语，一直沿用至今。
...
<WordRelations synonyms={["outlaugh"]} client:only />
