...
title: Brightness
description: >-
  "Brightness"是一个名词，描述的是光的亮度或颜色的鲜艳度。在自然科学，特别是在光学中，它被用来指代一个光源发出的可见光的强度。在每日对话中,
  它也可以形象地用来形容事物或人的显眼程度或者出色程度。
sidebar:
  hidden: true
...
"Brightness"是一个源自中古英语的单词，最初来自词汇 "beorht"，意为 "光亮的"，而 "-ness" 后缀则在 12 世纪时附加上去，形成了今天我们所熟知的单词 "brightness"。
