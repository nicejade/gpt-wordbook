...
title: Sacrifice
description: >-
  Sacrifice作为名词，是指一种为了达到某种目标或者获得某种利益，而主动放弃某些东西或者承受一些痛苦的行为；作为动词，是指为了实现某种目的，牺牲或者放弃（某人或某物）。
sidebar:
  hidden: true
...
<Pronunciation word="Sacrifice" uk="/ˈsækɹɪfaɪs/" us="/ˈsækɹɪfaɪs/" client:only />
...
"Sacrifice"源于拉丁词 sacrificium，意为 "perform priestly functions, offer sacrifices". 这个词由 sacri- ("of a god") 和 -ficium ("to do, make") 组成。
