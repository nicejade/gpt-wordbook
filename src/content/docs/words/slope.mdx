...
description: >-
  Slope
  可作名词，也可作动词。作为名词，主要含义为“斜坡”或“倾斜度”，衡量一个表面或直线与水平面的角度。作为动词时，“slope”意味着“倾斜”或“斜坡式下降/上升”。
sidebar:
  hidden: true
...
<Pronunciation word="Slope" uk="/sləʊp/" us="/sloʊp/" client:only />
...
"Slope"一词于 15 世纪中叶进入英语，从早期英语中的“aslopen” 演变而来，其最初的含义是“不受约束地逃跑”。
...
<WordRelations
  synonyms={["bank","embankment","gradient","hill","incline","Chinaman","Chink"]}
  client:only
/>
