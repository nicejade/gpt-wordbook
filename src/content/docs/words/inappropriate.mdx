---
title: Inappropriate
description: Inappropriate是一个形容词，用于描述不适合的，不恰当的或者不合时宜的事物或行为。
sidebar:
  hidden: true
...
<Pronunciation word="Inappropriate" uk="/ˌɪnəˈpɹəʊpɹi.ət/" us="/ˌɪnəˈpɹəʊpɹi.ət/" client:only />
...
Inappropriate 最早源于 16 世纪的拉丁语，“in-”表示否定，“appropriatus”表示适当的，因此“inappropriate”的直接翻译就是“不适当的”。
...
<WordRelations
  synonyms={["improper","unfit","unsuitable"]}
  client:only
/>
