...
description: >-
  Whirl
  这个词可以作为动词和名词使用。作为动词，它主要有两个含义：一是指快速旋转或者使某物快速旋转。二是泛指一种快速、繁忙的活动。作为名词，'whirl'
  可以指一个快速的旋转动作，也可以用来形容经历的一系列快速、混乱的事件，但通常带有积极的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Whirl" uk="/ʍɪɾ(ə̯)l/" us="/wɝl/" client:only />
