---
title: Deal
description: Deal 主要有三个基本含义：1.做交易或者协商；2.处理，应对；3.分配。它同样可以作为名词使用，意味着一次交易或者协议。
sidebar:
  hidden: true
...
<Pronunciation word="Deal" uk="/diːl/" us="/diːl/" client:only />
...
<WordRelations
  synonyms={["allotment","apportionment","distribution","sharing","batch","flock","hatful","heap","load","lot","mass","mess","mickle","mint","muckle","peck","pile"]}
  client:only
/>
