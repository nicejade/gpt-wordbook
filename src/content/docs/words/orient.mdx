...
title: Orient
description: >-
  Orient这个单词在英语中主要有两大含义。首先，它可以作为动词，表示“使朝向”、“使适应”、“定位”。其次，它也可作为名词，表示“东方”。通常对在新环境中寻找方向或适应新环境的行为做描述时可以使用'orient'。
sidebar:
  hidden: true
...
<Pronunciation word="Orient" uk="/ˈɔː.ɹɪ.ənt/" us="/ˈɔː.ɹɪ.ənt/" client:only />
...
<WordRelations
  synonyms={["orientate"]}
  antonyms={["Occident","disorient","disorientate","occidental"]}
  client:only
/>
