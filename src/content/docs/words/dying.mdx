---
title: Dying
description: Dying 是一个英语动词的进行时，它来自于动词 'die'，主要表示“正在死亡”或“濒临死亡”的状态或过程。
sidebar:
  hidden: true
...
<Pronunciation word="Dying" uk="/ˈdaɪ.ɪŋ/" us="/ˈdaɪ.ɪŋ/" client:only />
...
"Die" 这个词于公元前 4 世纪从古英语中产生，最初的意思指的是"过去"或"离开"，表示生命的结束。
