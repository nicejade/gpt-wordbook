---
title: Stairs
description: Stairs 是一个常用的英语名词，意为“楼梯”。这个词经常用来描述从一个楼层到另一个楼层的步行通道。
sidebar:
  hidden: true
...
<Pronunciation word="Stairs" uk="/ˈstɛəz/" us="/ˈstɛɹz/" client:only />
...
<WordRelations synonyms={["staircase", "stairway"]} client:only />
