...
title: Exclaim
description: >-
  Exclaim 是一个动词，意思是大声说出或强烈表达感情，通常用于表达惊讶、愤怒、激动或恐惧等强烈感情。如：He exclaimed in
  delight.（他高兴得叫了起来。）
sidebar:
  hidden: true
...
<Pronunciation word="Exclaim" uk="/ɛkˈskleɪm/" us="/ɛkˈskleɪm/" client:only />
...
你可以通过下面的口诀来记忆它：“EX 出口，CLAIM 要求，惊叫一声要求出口”。
