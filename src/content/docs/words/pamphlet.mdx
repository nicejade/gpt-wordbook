---
title: Pamphlet
description: Pamphlet 是一个英语名词，指的是一种小册子，通常用于提供信息或争论某个观点。一般来说，它包括很少的页数，并且可供广发或免费发放。
sidebar:
  hidden: true
...
<Pronunciation word="Pamphlet" uk="/ˈpæmf.lɪt/" us="/ˈpæmf.lɪt/" client:only />
...
"Pamphlet" 是一个没有词缀的单词。其中，"phlet" 是后缀，用于生成名词。相同后缀的单词还有 booklet， leaflet 等。

### 文化背景

该词源于 14 世纪的法语，原是指一本中世纪的畅销喜剧。它在历史上经常被用于传播政治或宗教理念，尤其在欧洲的启蒙时期。
