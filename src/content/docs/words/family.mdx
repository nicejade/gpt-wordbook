...
description: >-
  Family
  这个单词在英语里的基本含义，它指的是由爷爷、奶奶、父亲、母亲、兄弟姐妹或儿女等关系亲密的人组成的群体。在一个更广义的语境中，“family”也可以用来泛指所有有共同祖先的人，或者共同的兴趣和目标的社交团体。
sidebar:
  hidden: true
...
<Pronunciation word="Family" uk="/ˈfæm(ɪ)li/" us="/ˈfæm(ə)li/" client:only />
...
<WordRelations synonyms={["kin", "kinfolk", "family", "member"]} client:only />
