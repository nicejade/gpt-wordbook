...
title: Concentrate
description: >-
  Concentrate 是一个英语单词，用作动词时意思是“集中，聚集”，如：我正在集中精力学习（I'm concentrating on my
  studies）。它还可以表示“使...更浓，使...精炼”，如：从矿石中提取出纯金（Concentrate the gold from the ore）。
sidebar:
  hidden: true
...
"Concentrate"由 lat 的词根 "centr" 衍生出来， “centr”在拉丁语中表示“中心”。其他由这个词根衍生的单词有：centric（中心的），decent （有道德的，适中的）等。
...
<WordRelations antonyms={["dilute"]} client:only />
