---
title: Convict
description: Convict 是一个英文词，主要有两种用法，可以作为动词或名词。
sidebar:
  hidden: true
...
<Pronunciation word="Convict" uk="/ˈkɒnvɪkt/" us="/ˈkɒnvɪkt/" client:only />
...
<WordRelations synonyms={["con", "disapprove", "sentence"]} client:only />
