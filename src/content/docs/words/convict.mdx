...
title: convict
description: >-
  Convict 是一个英文词，主要有两种用法，可以作为动词或名词。 * 作为动词时，convict 主要意味着
  判某人有罪，它通常用在司法环境和法律语境中，例如 He was convicted of theft.(他被判入狱因盗窃)。 * 作为名词时，convict
  主要指的是 已经被判有罪的人 或者 囚犯。例如 He is a convict. (他是一个罪犯)
sidebar:
  hidden: true
