---
title: Wallet
description: Wallet 是一个名词，用来表示一个小的、平的包，通常用来携带所有的现金、信用卡、身份证等个人事物。
sidebar:
  hidden: true
...
<Pronunciation word="Wallet" uk="/ˈwɒlɪt/" us="/ˈwɒlɪt/" client:only />
...
"Wallet" 在英语中最早的記錄是在 14 世紀后期，起初的含义是旅行者用来携带他们的食物相关物品，后来开始转变，被人们用来携带钱币，以及个人事物，这就是我们现在所知道的 "wallet"。
...
<WordRelations synonyms={["billfold", "pocketbook"]} client:only />
