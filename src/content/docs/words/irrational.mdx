---
title: Irrational
description: irrational 是一个形容词，意思是'不合理的'或'无逻辑的'。它用来描述不符合逻辑或常理的事物或行为。
sidebar:
  hidden: true
...
"irrational" 最初来自于拉丁词 "rationalis"，意为"理性的"，前缀 ir- 是一种表示否定的前缀，所以“irrational”意指"非理性的"。这个单词在公元前 4 世纪的希腊被激进的哲学流派所使用，试图推翻整个柏拉图的哲学体系。
...
<WordRelations antonyms={["rational"]} client:only />
