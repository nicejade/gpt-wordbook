---
title: Fragile
description: "- 'Fragile' 是一个英文形容词，表示某物质地非常脆弱，很容易损坏或者破裂。也常用于比喻感情、健康等虚无的东西非常娇弱，易受伤。"
sidebar:
  hidden: true
...
<Pronunciation word="Fragile" uk="/ˈfɹædʒaɪl/" us="/ˈfɹædʒəl/" client:only />
...
- "Fragile" 这个单词首次在英语中出现在 15 世纪，它的来源是拉丁语 "fragilis"，意为容易碎裂。这个词语的发展过程中，最初用于形容物质的脆弱，后来逐渐开始被用于形容非物质的脆弱，如健康、情感等。
...
<WordRelations
  synonyms={["breakable", "breakly", "destroyable", "destructible", "friable"]}
  antonyms={["durable", "indestructible", "unbreakable", "undestroyable"]}
  client:only
/>
