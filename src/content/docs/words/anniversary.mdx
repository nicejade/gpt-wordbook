---
title: Anniversary
description: Anniversary是一种英文单词，用于指示特定事件或情况在某年的同一日期的重现，通常用于庆祝或纪念重要的历史或个人事件。
sidebar:
  hidden: true
...
这个单词起源于 12 世纪的拉丁文 "anniversarium"，意为"年度庆祝"。在现代英语中，"anniversary"常用来纪念特定事件的年度回归，如婚姻、组织成立、国家事件等。
...
<WordRelations synonyms={["yearday", "yeartide"]} client:only />
