...
description: >-
  Agreement
  是个名词，用来表示“达成一致”，通常用于指合同或与他人达成的安排。同时，'agreement'也可表示语言学上的一致的概念，比如动词和主语在数或者性上的一致。
sidebar:
  hidden: true
...
<Pronunciation word="Agreement" uk="/əˈɡɹiːmənt/" us="/əˈɡɹiːmənt/" client:only />
...
"Agreement" 源自 14 世纪的老法语 "a gre", 含义为“心满意足的”或“合意的”。在西方文化中，它通常代表双方或多方对某件事的共识或契约。
...
<WordRelations
  synonyms={["settlement","accord","concurrence","congeniality","harmony","amenity","niceness","pleasantness","concord","convention","covenant","pact","treaty","concordance"]}
  client:only
/>
