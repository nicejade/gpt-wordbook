...
description: >-
  Address
  这个单词在英语里有两个主要的用途。作为名词的时候，它通常指的是“地址”。可以是电子邮件地址，也可以是物理邮件的传递位置。爲动词时，“address”指的是向某个人或者专题发表言论或者提出问题。
sidebar:
  hidden: true
...
<Pronunciation word="Address" uk="/əˈdɹɛs/" us="/æˈdɹɛs/" client:only />
...
“Address”这个单词在 14 世纪从法语引入英语，最初指的是“发言”，“对・・・讲话”。
...
<WordRelations
  synonyms={["adroitness","discourse","harangue","ingenuity","lecture","oration","petition","readiness","speech","tact","beclothe","dight","romance"]}
  client:only
/>
