---
title: Await
description: await 是一个动词，主要意思是等待。它通常用来表示期待或等待某事的发生。
sidebar:
  hidden: true
...
<Pronunciation word="Await" uk="/əˈwɛɪt/" us="/əˈwɛɪt/" client:only />
...
<WordRelations synonyms={["service", "anticipate", "listen"]} client:only />
