---
title: Ashamed
description: Ashamed是英文的形容词，意思是“感到羞愧的”，也可译为“觉得惭愧、内疚”。
sidebar:
  hidden: true
...
<Pronunciation word="Ashamed" uk="/əˈʃeɪmd/" us="/əˈʃeɪmd/" client:only />
...
<WordRelations synonyms={["embarrassed"]} antonyms={["proud"]} client:only />
