---
title: Unhappy
description: "- 'Unhappy' 是一个形容词，表示不快乐，心情沮丧，或者感到不满意，不适。"
sidebar:
  hidden: true
...
<Pronunciation word="Unhappy" uk="/ʌnˈhæpi/" us="/ʌnˈhæpi/" client:only />
...
<WordRelations
  antonyms={["delighted", "exuberant", "glad", "happy", "joyful", "joyous"]}
  client:only
/>
