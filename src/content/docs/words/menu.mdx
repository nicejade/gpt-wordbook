---
title: Menu
description: Menu 是英语中的一个名词，主要指在餐馆、咖啡馆等餐饮场所提供的食物和饮料的列表，或在电脑等电子设备上表示各种功能选项的列表。
sidebar:
  hidden: true
...
<Pronunciation word="Menu" uk="/ˈmɛnju/" us="/ˈmɛnju/" client:only />
...
“Menu”一词起源于法语，早在 19 世纪初就已被英语接纳使用，原本用于描述详细列表或清单，在 19 世纪后期逐渐约定俗成，专指餐饮场所的食品和饮料列表。随着电子科技的发展，菜单的概念也扩大到了电脑软件及应用程序中的各种功能列表。
