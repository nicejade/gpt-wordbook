---
title: Fluctuate
description: Fluctuate 这个词是一个动词，意思是“正负波动，起伏不定”。在现实生活中，常常被用来指人心情、股票价格，或者温度等不稳定、有变动的事物。
sidebar:
  hidden: true
...
"Fluctuate" 源于 17 世纪的拉丁语，但在现代英语中，它主要被用来描述不稳定或不定的状态，这在科学、金融和心理学等领域很常见。

### 单词变形

无名词形式，无复数形式。其形容词形式为 fluctuating（波动的、变动的），对应中文翻译的形容词形式为“波动的、变动的”。
例如：
