...
title: Pinch
description: >-
  Pinch是一个英语词汇，作为动词，其主要意思是“捏，掐”， 例如，你可以说 'She pinched me on the arm'.
  (她在我胳膊上掐了我一下。) 另外 'pinch' 还可以表示 '借用', '偷窃', 例如，'He pinched my pen when I
  wasn't looking.' (我不注意的时候，他偷了我的笔。)
sidebar:
  hidden: true
...
<Pronunciation word="Pinch" uk="/pɪntʃ/" us="/pɪntʃ/" client:only />
...
Pinch 的词根是来自于「Pinc」，这是拉丁语，表示"获得",在英文中则发展为了捏、掐的意思。例如：Pincer, 表示一个用于抓取东西的工具，与捏、掐有相同的本质含义。
