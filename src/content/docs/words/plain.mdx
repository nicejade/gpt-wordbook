---
title: Plain
description: Plain 是一个英文词汇，既可以作为形容词，也可以作为名词。
sidebar:
  hidden: true
...
<Pronunciation word="Plain" uk="/pleɪn/" us="/pleɪn/" client:only />
...
1.  She bought a plain white t-shirt. (她买了一件素白的 T 恤。)
...
Plain 这个单词在中古英语时期，即在公元 1100 年到 1500 年间也以 plaine 的形式存在, 具有"普通的，简单的"的含义。
...
<WordRelations
  synonyms={["frank","sincere","consarn","darned","stinking","simple","unadorned","unseasoned","normal","ordinary","blatant","ostensible","monochrome"]}
