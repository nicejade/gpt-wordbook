...
title: Internal
description: >-
  Internal是一个形容词，主要用来描述事物的内部的或者内在的。比如我们常说的“内部问题(internal issue)”，“内部审计(internal
  audit)”等。
sidebar:
  hidden: true
...
<Pronunciation word="Internal" uk="/ɪnˈtɝnəl/" us="/ɪnˈtɝnəl/" client:only />
...
<WordRelations
  synonyms={["inly", "inner", "interior", "intern", "interne"]}
  antonyms={["exterior", "external"]}
  client:only
/>
