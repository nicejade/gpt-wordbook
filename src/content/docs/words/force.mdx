---
title: Force
description: Force作为名词时，主要含义是力，用于表达物理上的力，或者强制，压制。作为动词时，含义是迫使，强迫。
sidebar:
  hidden: true
...
<Pronunciation word="Force" uk="/fɔːs/" us="/fɔɹs/" client:only />
...
"Force"这个词在 13 世纪从 Old French 的"force"词汇中引入英语。
...
<WordRelations synonyms={["police"]} client:only />
