---
title: Limited
description: limited 是一种形容词，表示“有限的”、“受限的”，或“有限公司”。其基本含义是某事物在数量、范围、能力等方面受到一定的限制。
sidebar:
  hidden: true
...
<Pronunciation word="Limited" uk="/ˈlɪmɪtɪd/" us="/ˈlɪmɪtɪd/" client:only />

### 列举例句

1.  Our resources are very limited. 我们的资源非常有限。
2.  His knowledge of geography is rather limited. 他的地理知识相当有限。
3.  ABC Limited is a well-known company. ABC 有限公司是一家知名的公司。
...
"limited" 这个词汇，早在 14 世纪时期的拉丁文中就有使用，当时表示 “boundary, borderline, shore, bank” 等含义，后来在英语中发展出了“限制”的意思。
