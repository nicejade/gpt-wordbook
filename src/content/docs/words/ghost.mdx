...
description: >-
  Ghost
  是名词，中文翻译为“鬼”，“灵魂”，或者“鬼魂”。在更广阔的语境中，“ghost”可能指一个人的影子或副本，即某人过去的自我版本。在技术领域，'ghost'
  也可以用于描述电脑屏幕上持续出现的淡影。
sidebar:
  hidden: true
...
<Pronunciation word="Ghost" uk="/ɡəʊst/" us="/ɡoʊst/" client:only />
...
<WordRelations
  synonyms={["spook","spy","glimmer","glimmering","glimpse","hint","inkling","phantom","spark","suggestion","echo","ghostwriter","shadow","backup","essence","soul","spirit","apparition"]}
  client:only
/>
