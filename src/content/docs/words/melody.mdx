---
title: Melody
description: Melody是一个名词，通常表示乐曲的主旋律，或者指歌曲中的主唱部分。它也可以更广义地表示某种和谐、美好的声音或调子。
sidebar:
  hidden: true
...
<Pronunciation word="Melody" uk="/ˈmel.ə.di/" us="/ˈmɛl.ə.di/" client:only />
...
"Melody"最早在 14 世纪从法语融入英语，源自拉丁语“melodia”，并最终追溯到上述的古希腊语。在欧洲文化中，这个词常用来形容和谐、优美的音乐和声音。
...
<WordRelations synonyms={["tune"]} client:only />
