---
title: Suspension
description: Suspension 是一个名词，具有多重的含义，常见的有两个方向：
sidebar:
  hidden: true
...
<Pronunciation word="Suspension" uk="/səˈspɛnʃən/" us="/səˈspɛnʃən/" client:only />
...
<WordRelations
  synonyms={["syncope","halt","intermission","interruption","stop"]}
  client:only
/>
