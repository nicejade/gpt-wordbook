...
title: Row
description: >-
  "Row"是一个英语单词，有两个主要的发音和意思。 第一种发音是 \[rou\]，像 "cow"
  的发音，主要意思是"排"，"行"，经常用于形容可数的物品或者人按照一定的方式排列起来，如：row of houses（一排房子）。 第二种发音是
  \[rəʊ\]，和 "go" 的发音很像，主要意思是"划船"或"大吵一架"。在英式英语中， "have a row with someone"
  可以理解为和某人争吵起来。
sidebar:
  hidden: true
