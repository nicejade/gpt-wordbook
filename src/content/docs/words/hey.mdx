---
title: Hey
description: Hey是一个英语的招呼语，也可以用来引起他人的注意。在口语中使用非常广泛，语气比较轻松，相当于中文中的'嘿' 或 '喂'。
sidebar:
  hidden: true
...
<Pronunciation word="Hey" uk="/heɪ/" us="/heɪ/" client:only />
...
"Hey"是一个非常古老的英语词汇，可以追溯到 14 世纪，在这段时间它与“hi”的用法很相似，都用来引起别人的注意。
...
<WordRelations
  synonyms={["oi","yo","blimey","yowzah","eh","huh","hi","howdy","wotcher"]}
  client:only
/>
