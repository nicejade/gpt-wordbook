---
title: Duty
description: Duty是一个名词，它在英语中有几种主要的含义：1）是一种职责、义务或责任，指必须做的事情；2）也可以指一种税或费用，如关税。
sidebar:
  hidden: true
...
<Pronunciation word="Duty" uk="/ˈdjuːti/" us="/duːti/" client:only />
...
<WordRelations synonyms={["obligation"]} antonyms={["right"]} client:only />
