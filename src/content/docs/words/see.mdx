---
title: See
description: See 主要用作动词，有以下几个主要含义：
sidebar:
  hidden: true
...
<Pronunciation word="See" uk="/siː/" us="/siː/" client:only />
...
<WordRelations
  synonyms={["behold","descry","espy","observe","view","follow","get","understand","look","so","well"]}
  client:only
/>
