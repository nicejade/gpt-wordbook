---
title: Particularly
description: Particularly是一个副词，用来强调某种程度，相当于 'especially' 或 'specifically'。意为尤其，特别是。
sidebar:
  hidden: true
...
<Pronunciation word="Particularly" uk="/pəˈtɪkjəli/" us="/pəˈtɪkjəli/" client:only />
...
"Particularly"一词来自拉丁词"particularis"（特定的），后来通过法语发展进入英语，并最初代表“详情“。然而，到了 16 世纪，它逐渐获得了现在的意思。
...
<WordRelations
  synonyms={["primarily","exacting","fastidiously","pedantically","pickily","detailly","thoroughly","exceedingly","greatly"]}
  client:only
/>
