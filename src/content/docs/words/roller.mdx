---
title: Roller
description: Roller 主要有两个基本含义：一是指滚轴或滚筒，常用于各种工程设备中，起到支持、压实，运输等作用；二是指滚轴刷或滚筒券，常用于画画或粉刷墙壁。
sidebar:
  hidden: true
...
<Pronunciation word="Roller" uk="/ˈɹəʊlə/" us="/ˈɹəʊlə/" client:only />
...
"Roller" 是 15 世纪中期出现的单词，起初主要用于形容海浪的滚动和沸腾。后来随着工业革命和科技的进步，该词在工程设备，画画工具，以及滑旱冰等诸多领域被广泛应用。
