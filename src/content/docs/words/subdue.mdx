---
title: Subdue
description: 单词 'subdue' 主要意思为“使顺从；制服；抑制”。最常见的用法是表示用力量或权威克服，并使之处于控制之下，也可以表示抑制或降低强度。
sidebar:
  hidden: true
...
<Pronunciation word="Subdue" uk="/səbˈdjuː/" us="/səbˈdjuː/" client:only />
...
“subdue”始于 14 世纪，意为“征服，战胜，抑制”，源自“sub-”（下方）+“due”（应得的），字面意思为“引向下方”。后来演变为目前的意思，指控制、压制或抑制某人或某物。
...
<WordRelations synonyms={["underbring"]} client:only />
