---
title: Mining
description: Mining 是一个名词，被广泛地用来描述从地下开采矿石或者其他有价值的材料的过程。也可以作为一个动词，表示开采的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Mining" uk="/ˈmaɪnɪŋ/" us="/ˈmaɪnɪŋ/" client:only />
