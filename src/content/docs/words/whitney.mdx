---
title: Whitney
description: '"Whitney"是一个英文名字，广泛用作女性名字，但也有部分男性使用。Whitney 的原意指“白色的岛屿”。'
sidebar:
  hidden: true
...
"Whitney"是一个英文名字，广泛用作女性名字，但也有部分男性使用。Whitney 的原意指“白色的岛屿”。
...
一个有效的记忆方法是把 Whitney 和某个著名人物联系起来，比如歌手惠特尼·休斯顿。
