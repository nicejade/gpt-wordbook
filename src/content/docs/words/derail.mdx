---
title: Derail
description: Derail 是一个动词，主要有两种常见含义：
sidebar:
  hidden: true
...
<Pronunciation word="Derail" uk="/dəˈɹeɪl/" us="/dəˈɹeɪl/" client:only />

### 列举例句

**例句 1**：The train derailed due to a malfunction.
**中文翻译**：火车因故障出轨。

**例句 2**：His indifference could derail the project.
**中文翻译**：他的冷漠可能会使项目偏离轨道。

**例句 3**：The negotiation was derailed by their unreasonable demands.
...
<WordRelations synonyms={["unrail"]} client:only />
