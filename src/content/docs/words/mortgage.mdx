...
title: Mortgage
description: >-
  Mortgage是一个名词，也可用作动词。作为名词，它是指一种贷款类型，通常用于购买房产或其他大型资产，且该资产作为贷款的担保，若贷款人不能偿还贷款，贷款机构有权占有并出售该资产。作为动词时，郁
  er 指将一个资产作为贷款的担保。
sidebar:
  hidden: true
...
"Mortgage"是一个名词，也可用作动词。作为名词，它是指一种贷款类型，通常用于购买房产或其他大型资产，且该资产作为贷款的担保，若贷款人不能偿还贷款，贷款机构有权占有并出售该资产。作为动词时，郁 er 指将一个资产作为贷款的担保。

<Pronunciation word="Mortgage" uk="/ˈmɔː.ɡɪdʒ/" us="/ˈmɔɹ.ɡɪdʒ/" client:only />
