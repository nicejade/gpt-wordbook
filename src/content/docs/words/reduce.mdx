---
title: Reduce
description: "英语单词 'reduce' 的基本含义为 '减少' 或 '缩小', 它用于表示在数量、规模、价值等方面的减小或减轻。"
sidebar:
  hidden: true
...
<Pronunciation word="Reduce" uk="/ɹɪˈdjuːs/" us="/ɹɪˈduːs/" client:only />
...
"reduce" 这个词源自于 14 世纪的拉丁语 "reducere", 含义是 "bring back" 或 "restore"，经过时间的演变，现在的 "reduce" 可以表示 "减少"， "缩小" 或 "降低"。
...
<WordRelations
  synonyms={["inspissate", "cut", "decrease", "lower"]}
  antonyms={["increase"]}
  client:only
/>
