---
title: User
description: User 是英语中的一个常用词，它的基本含义是“用户”，“使用者”或是“消费者”。它是一个名词，指的是一个使用某种产品、服务或系统的人。
sidebar:
  hidden: true
...
<Pronunciation word="User" uk="/ˈjuːzə/" us="/ˈjuzɚ/" client:only />
...
"User"这个词在中世纪英语中的意思为"一种使用"，这个词的使用日期可以追溯到 14 世纪。 随着现代科技和商业的发展，"user"的含义更多地转变为指使用特定产品或服务的人。
...
<WordRelations synonyms={["parasite"]} antonyms={["nonuser"]} client:only />
