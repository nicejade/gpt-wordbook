...
title: Mutual
description: >-
  Mutual 是一个形容词，意味着两者或更多者之间的共享、相互的或共同的。当你可能说某事物是
  “mutual”，意味着它影响了所有提到的人或事物，不仅只是一个。
sidebar:
  hidden: true
...
<Pronunciation word="Mutual" uk="/ˈmjuːt͡ʃuəl/" us="/ˈmjuːt͡ʃuəl/" client:only />
...
Mutual 这个词来源于早期的法语 "mutuel", 这个词本身源自拉丁词 "mutuus", 意思是互相的，交换的。
...
"Mutual" 这个词在 14 世纪初首次出现在英文中，来自早期法语 "mutuel" 和拉丁词 "mutuus"。"Mutual" 在现代英语中广泛使用，特别是在描述需要合作或者相互依赖的场景中。
...
一种记忆方法是将 "mutual" 与 "mutual friends" 这个短语联系起来，这个短语在社交媒体中常常被使用，例如在 Facebook，当两个人有共同的朋友时，他们就是 "mutual friends"。
...
<WordRelations synonyms={["mutual", "shared", "reciprocative"]} client:only />
