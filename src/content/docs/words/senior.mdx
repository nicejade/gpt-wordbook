...
description: >-
  Senior
  是一个形容词，用于描述一个人在年龄、经验、或者地位上比别人大或者高。它也可以用作名词，表示“年长者”或“高级的人”。例如，在学校，'seniors'通常指的是最后一年的学生。
sidebar:
  hidden: true
...
<Pronunciation word="Senior" uk="/ˈsiːnjə(r)/" us="/ˈsinjɚ/" client:only />
...
<WordRelations synonyms={["geriatric"]} antonyms={["junior"]} client:only />
