...
title: Steady
description: >-
  Steady是一个形容词，意味着“固定的，稳定的，坚定的”。可以描述物理稳定（例如：稳定的桌子），也可以描述情绪的稳定（如：他保持镇定）。它还可以作为一个动词，表示“使稳定”。
sidebar:
  hidden: true
...
<Pronunciation word="Steady" uk="/ˈstɛdi/" us="/ˈstɛdi/" client:only />
...
<WordRelations
  synonyms={["dogged","staunch","unyielding","robust","solid","constant","uniform","unvarying","glacial","ponderous","stately","fluid"]}
  antonyms={["unsteady"]}
  client:only
/>
