...
title: Fore
description: >-
  Fore 是一个英文前缀，指的是'在前'或'在前面'。作为一个独立的单词，它常用在航海和高尔夫球语境中。在高尔夫球中，'Fore!'
  是一个警告词，意思是'当心！'，用来提醒人们有飞行的高尔夫球。
sidebar:
  hidden: true
...
<Pronunciation word="Fore" uk="/fɔː/" us="/fɔɹ/" client:only />
...
<WordRelations antonyms={["aft", "latter"]} client:only />
