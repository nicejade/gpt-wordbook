---
title: Clerk
description: Clerk 是一个名词，主要的意思是“职员”，'文书'或者'店员'。它常常被用来描述工作在办公室或者商店里并进行一些日常任务的人。
sidebar:
  hidden: true
...
<Pronunciation word="Clerk" uk="/klɐːk/" us="/klɝk/" client:only />
...
你可以将 "clerk"和 work 联想在一起，因为职员(clerk)经常在工作(work)。
