...
title: Lathe
description: >-
  Lathe是一个名词，《牛津高阶英汉双解词典》定义为'车床',
  是一种机械设备，主要用于切割、棱形、打磨或者整形固体材料。通过对工件的旋转和切剪，可以制造出具有轴对称或者平面对称的工件。
sidebar:
  hidden: true
...
<Pronunciation word="Lathe" uk="/leɪð/" us="/leɪð/" client:only />
...
"Lathe"在词根分析上信息不多，它現已常見的形式，來自于 1381 年的 late。
