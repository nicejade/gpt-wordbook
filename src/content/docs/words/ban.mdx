...
description: >-
  Ban
  是个英文动词，主要有两个基本含义。其一是禁止、禁用，对某些活动或行为实行禁令。其二是官方或正式地禁止某人做某事或进入某地。常用于法律、政策或规定的语境中。
sidebar:
  hidden: true
...
<Pronunciation word="Ban" uk="/bæn/" us="/bæn/" client:only />
...
"Ban" 这个词在中古英语中意为 "宣告；公开谴责”，随着时间的推移，“ban”的含义有所发展，更多地指向“禁止”或“禁用”的意思。在现代的欧美文化中，ban 经常用于描述在某个特定领域或情境中明确禁止的行为或物品。
...
<WordRelations synonyms={["disallow", "forbid", "prohibit"]} client:only />
