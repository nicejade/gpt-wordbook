---
title: Humidity
description: humidity 是一个名词，中文翻译为“湿度”。指空气中含有的水分或湿气的量。它实际上是对空气中水蒸气含量的一种测量，对我们的日常生活和健康有直接影响。
sidebar:
  hidden: true
...
"Humidity" 这个单词最早出现在 14 世纪，当时主要用于描述湿气或湿润的物体。现在它被广泛用于描述天气情况，特别是与人类舒适度和健康有关的湿度。
