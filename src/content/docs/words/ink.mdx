---
title: Ink
description: ink 是名词，指的是用于写作或印刷的黑色或其他深色液体。
sidebar:
  hidden: true
...
<Pronunciation word="Ink" uk="/ɪŋk/" us="/iŋk/" client:only />
...
"ink" 在英语中首次出现在 15 世纪，其由拉丁语 "encaustum" 经过古英语的演变成为我们现在所知的 "ink"。
...
Once upon a time, Tom found a mysterious bottle of ink. With it, what he drew became reality.（有一次，Tom 发现了一瓶神秘的墨水。有了它，他所画的都能变成现实。）

<WordRelations
  synonyms={["hoopla","hype","plug","spotlight","paint","initial","subscribe"]}
  client:only
/>
