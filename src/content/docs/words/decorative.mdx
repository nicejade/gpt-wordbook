---
title: Decorative
description: Decorative 是一个形容词，用于描述那些装饰性的或具有艺术效果的东西。它可以形容人工制品、自然元素，甚至可以用于形容文字和语言。
sidebar:
  hidden: true
...
“Decorative”源自 14 世纪的法语"decoratif"，其由拉丁词根"decor-"（装饰）派生而来。它在欧美文化中通常与艺术、设计和建筑相关，让物体不仅仅具有实用性，还有艺术性和美感。
