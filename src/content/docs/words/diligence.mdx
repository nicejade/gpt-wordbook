---
title: Diligence
description: Diligence 是苦勤，尽职的意思，通常用于形容一个人认真勤奋的工作态度。
sidebar:
  hidden: true
...
"Diligence"一词源于 13 世纪的法语，原意是"尽职，勤奋"。英语文化中，这个词通常用于赞扬人的勤奋和专注。
...
<WordRelations synonyms={["worksomeness"]} client:only />
