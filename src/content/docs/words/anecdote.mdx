---
title: Anecdote
description: Anecdote 是个名词，代表“轶事”或者“逸闻”，通常指一个短小有趣或者揭示性的真实故事。
sidebar:
  hidden: true
...
Anecdote 是个名词，代表“轶事”或者“逸闻”，通常指一个短小有趣或者揭示性的真实故事。
...
单词的词根 anecdot-来自于古希腊语的' "anekdota"，意思是“未发布的事情”。

### 词缀分析

Anecdote 是一个简单的单词，没有前缀或后缀。 但是，它有变体，如 "anecdotal"，其中 "al" 是后缀，表示相关性。

### 文化背景

Anecdote 起源于 17 世纪的法国，最初是用来描述那些未公开发表的轶事和故事。 它很快就广为人知，并在英语中得到了广泛的传播。
