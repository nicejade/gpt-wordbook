---
title: Bag
description: bag主要有两种含义，一种是'袋子'，通常指一个可以装东西的容器，另一种解释是在口语中表示'捕获'或'赢得'。
sidebar:
  hidden: true
...
<Pronunciation word="Bag" uk="/ˈbæːɡ/" us="/ˈbeɪɡ/" client:only />
...
“Bag”源自北欧诸语言的相似词汇，均表示容器、袋子之意。到中世纪英语中，包袱的含义开始普及。18 世纪，"bag"作为“获得，掌握”之意在口语中使用。
...
<WordRelations
  synonyms={["thing","dog","hag","handbag","purse","multiset","poke","sack","tote"]}
  client:only
/>
