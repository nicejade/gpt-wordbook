---
title: Shift
description: Shift可以作为名词或动词，有多种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Shift" uk="/ʃɪft/" us="/ʃɪft/" client:only />
...
<WordRelations
  synonyms={["reposition","interchange","swap","remove","fondle","grope","hasten","rush","relocate","transfer","move"]}
  antonyms={["unshift"]}
  client:only
/>
