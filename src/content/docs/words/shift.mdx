...
title: Shift
description: >-
  "Shift"可以作为名词或动词，有多种含义： 1）名词：“改变，转变”或者“轮班”。例如："There has been a dramatic shift
  in public opinion."（公共意见发生了剧变）。 2）动词：表示"移动"或者"改变"。例如："She shifted
  uncomfortably in her chair."（她在椅子上不安地移动着）
sidebar:
  hidden: true
