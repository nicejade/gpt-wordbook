---
title: Outfit
description: Outfit是一个英语单词，主要用作名词，有“全套衣物、配件、设备、装备”等意思。此外，'outfit'也可以作为动词使用，意为“装备、配备”。
sidebar:
  hidden: true
...
<Pronunciation word="Outfit" uk="/ˈaʊtfɪt/" us="/ˈaʊtfɪt/" client:only />
...
<WordRelations
  synonyms={["getup", "kit", "rig", "turnout", "equip", "fit"]}
  antonyms={[]}
  client:only
/>
