...
title: Angry
description: >-
  Angry是一个形容词，经常用于表达不满、不悦或疾恨的情绪。具体用法也可能因情景的不同，以及所表示的强度差异而有所变化。例如，我们可以用这个单词来描述一个人的情绪状态，或者用来形容天气暴躁、动乱。
sidebar:
  hidden: true
...
<Pronunciation word="Angry" uk="/ˈæŋ.ɡɹi/" us="/ˈæŋ.ɡɹi/" client:only />
...
<WordRelations
  synonyms={["annoyed","apoplectic","enraged","furious","irritated","mad","vexed","wrathful"]}
  client:only
/>
