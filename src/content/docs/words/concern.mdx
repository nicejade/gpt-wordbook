---
title: Concern
description: Concern 是一个形式多样的词汇，它既可以作为动词，也可以作为名词。
sidebar:
  hidden: true
...
<Pronunciation word="Concern" uk="/kənˈsɜːn/" us="/kənˈsɝn/" client:only />
...
<WordRelations synonyms={["interest"]} client:only />
