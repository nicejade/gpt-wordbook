---
title: Disobey
description: Disobey 是一个动词，表示 “不服从，违抗”，通常指对命令、要求、规则或指示的违反。
sidebar:
  hidden: true
...
<Pronunciation word="Disobey" uk="/dɪs.əˈbeɪ/" us="/dɪs.əˈbeɪ/" client:only />
...
"Disobey" 这个词源于中古英语的 "disobeien"，首次出现在 14 世纪，原意是 "拒绝服从"。
...
<WordRelations antonyms={["obey"]} client:only />
