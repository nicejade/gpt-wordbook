---
title: Jump
description: Jump 是一个动词，表示“跳跃”或者“跳过”。它也可以作为名词使用，表示一次跳跃或跳跃的距离。
sidebar:
  hidden: true
...
<Pronunciation word="Jump" uk="/dʒʌmp/" us="/dʒʌmp/" client:only />
...
<WordRelations
  synonyms={["leap","flinch","jerk","twitch","ambush","assail","skydive","hump","rabbit","skip","spring","accurately","just"]}
  client:only
/>
