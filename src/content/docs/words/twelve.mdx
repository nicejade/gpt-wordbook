---
title: Twelve
description: Twelve 是一个基本的计数词，代表数字'12'。它在很多不同的语境中使用。
sidebar:
  hidden: true
...
<Pronunciation word="Twelve" uk="/twɛlv/" us="/twɛlv/" client:only />
...
"Twelve" 在欧美文化中也有特别的意义。比如存在 12 个月、一天分为 12 个小时、耶稣十二使徒等，表现了十二的重要性。
...
<WordRelations synonyms={["twelveteen"]} client:only />
