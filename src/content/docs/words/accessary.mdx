...
title: Accessary
description: >-
  Accessary是英国英语中的一个词，主要意思为'附件'或'配件'。在美国英语中则常见为'Accessory'，主要是指那些附加上的东西，用来完成或美化主要物品。也可以用来指帮助他人犯罪的人。
sidebar:
  hidden: true
...
"Accessary" 这个词在 15th-17th 世纪时，用于法律术语，用来指帮凶。直到 19 世纪，它的意思才延伸到了附件或配件的意思。
