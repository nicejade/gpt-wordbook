...
title: Obscene
description: >-
  Obscene 是一个英语形容词，常用来形容当某个行为、事物、情况、或者言论过于猥亵，淫秽，或者道德上不能接受，让人感到厌恶的时候。例如，'obscene
  language'（淫秽语言）和 'obscene behaviour'（淫秽行为）。
sidebar:
  hidden: true
...
<Pronunciation word="Obscene" uk="/əbˈsiːn/" us="/əbˈsin/" client:only />
...
Obscene 是源于拉丁语 obscēnus，原意是“不适合公开表演的”或者是“邪恶的”。在 16 世纪的时候被英语采用后，开始用来形容猥亵或淫秽的言论和行为，也有广泛的用在批评社会现象和个人贪婪、粗俗的行为。
...
<WordRelations
  antonyms={["chaste", "nonobscene", "pure", "decent", "moral"]}
  client:only
/>
