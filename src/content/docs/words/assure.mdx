---
title: Assure
description: Assure是一个动词，意思是使某人确信，向某人保证或告知确信某事将会（或已经）发生。也可以指给予（某人）信心；使放心。
sidebar:
  hidden: true
...
<Pronunciation word="Assure" uk="/əˈʃɔː/" us="/əˈʃɝ/" client:only />
...
Assure 来自拉丁词"securus"，意为安全的。其中，"ad-"是前缀，表示"向"，"securus"是词根，表示"安全"。

### 词缀分析

Assure 的词缀主要包括前缀 "as-" 和动词词根 "-sure"。并无后缀。
其他带有 "-sure" 的单词包括: "ensure，insure，pressure"等。

### 文化背景

Assure 来自中古法语 assurer，意为“安全、保护”。英语中的使用最早出现在 14 世纪。
