...
title: Housing
description: >-
  Housing 是一个名词，主要指住房，居住区域或者具有保护或遮护作用的结构。例如，公寓，别墅，单元房都属于
  housing。此外，它也可以作为一个动词，意思是提供住宿。
sidebar:
  hidden: true
...
"Housing" 是一个名词，主要指住房，居住区域或者具有保护或遮护作用的结构。例如，公寓，别墅，单元房都属于 housing。此外，它也可以作为一个动词，意思是提供住宿。

<Pronunciation word="Housing" uk="/ˈhaʊzɪŋ/" us="/ˈhaʊzɪŋ/" client:only />
...
"Housing" 的源头可以追溯到古英语的"hus"，意为"shelter，dwelling, house"。房子作为一个最基本的生活需求，其在欧美文化中的地位是不可忽视的。很多政策也是围绕 housing 来制定，用以解决一些社会问题。
...
<WordRelations
  synonyms={["accommodate", "harbor", "harbour", "host", "enclose", "store"]}
  client:only
/>
