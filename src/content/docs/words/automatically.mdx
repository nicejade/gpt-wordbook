...
title: Automatically
description: >-
  Automatically 是一个副词，来源于形容词
  'automatic'，表示'自动的'，'无需人工干预的'。当它放在动词之后，表示这个动作或过程是自动进行的，不需要额外的努力或者控制。
sidebar:
  hidden: true
...
“Automatically”这个词在 19 世纪中叶因工业革命的发展开始广泛使用，最初用于描述无需人工操作即可运行的机器。随着科技的发展，它的含义也相应拓展，用来描述任何无需人工干预即可进行的过程。
