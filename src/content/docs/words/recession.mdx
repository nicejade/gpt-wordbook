---
title: Recession
description: Recession是一个名词，主要用于经济上，表示“经济衰退”。也可用于形容一种倾向，或一种事情的退步、后退。
sidebar:
  hidden: true
...
<Pronunciation word="Recession" uk="/ɹɪˈsɛʃn̩/" us="/ɹɪˈsɛʃn̩/" client:only />
...
“Recession”这个单词最早在 17 世纪从法语中引入英语，开始用于描述人们从公共生活中抽身的行为。到了 19 世纪，该词开始被用于经济领域，描述经济活动的下降。
...
<WordRelations
  synonyms={["procession", "return", "withdrawal"]}
  antonyms={["boom"]}
  client:only
/>
