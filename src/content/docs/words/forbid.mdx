---
title: Forbid
description: Forbid 是一个动词，它的意思是不允许或者是禁止。它具有强烈的权威性和严肃性，通常用于严格的禁令。
sidebar:
  hidden: true
...
<Pronunciation word="Forbid" uk="/fəˈbɪd/" us="/fɚˈbɪd/" client:only />
...
<WordRelations synonyms={["ban", "disallow", "prohibit", "veto"]} client:only />
