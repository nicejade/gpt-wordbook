---
title: Around
description: Around 是一个常用英文单词，主要有两种用法：一个是作为方位词，表示'四处'，'在……周围'，另一个是作为副词，表示'大约'或'左右”。
sidebar:
  hidden: true
...
<Pronunciation word="Around" uk="/əˈɹaʊnd/" us="/əˈɹaʊnd/" client:only />
...
He travelled around the world in 80 days. (他用 80 天环游了世界。)
翻译：他用 80 天环游了世界。
