...
title: Improvement
description: >-
  Improvement是一个名词，意味着'改进'，'提高'或'改善'的行为或过程。 这个词源于 14
  世纪的英语，那时被用作“利益增加”的意思，现在它的主要用途是表达'在质量，数量或强度等上的增强'。
sidebar:
  hidden: true
...
“Improvement”是一个名词，意味着"改进"，"提高"或"改善"的行为或过程。 这个词源于 14 世纪的英语，那时被用作“利益增加”的意思，现在它的主要用途是表达"在质量，数量或强度等上的增强"。
...
Improvement 的词根是"prove"，来自拉丁词"probare"，意为"测试"或"证明"。当添加前缀"im-"（提高，增加）和后缀"-ment"（形成名词的后缀）时，它变成了“改善”的意思。
...
Improvement 这个词在 14 世纪的英语中就已经出现，最早表达的含义是“利益的增加”。到 16 世纪时，它扩展为包括“建造或修理房屋或地产，从而提高其价值”。17 世纪，它开始用来指“教育或道德的提升”。到现在，它的含义已经包括了各种形式的“提高”，包括个人能力，生活质量，产品或服务的质量等。
...
<WordRelations
  synonyms={["amelioration", "improval"]}
  antonyms={["deterioration", "disimprovement", "worsening"]}
  client:only
/>
