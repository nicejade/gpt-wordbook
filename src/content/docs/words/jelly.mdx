...
title: Jelly
description: >-
  Jelly是英语中的单词，一般来说它有两个常见的含义。第一种含义是一种食品，我们通常称之为果冻，它是由糖、果汁和一种叫做明胶的东西制作的。第二种含义是某一种厚厚的、通常有些透明的、半固态的液体。
sidebar:
  hidden: true
...
<Pronunciation word="Jelly" uk="/ˈd͡ʒɛl.i/" us="/ˈd͡ʒɛl.i/" client:only />
...
“Jelly”没有特别的词缀，它完整的形式就是 jelly。

### 文化背景

"Jelly"这个词的使用可以追溯到 14 世纪的英格兰，当时的“jelly”是指一种制作精细，必须冷冻才能固化的甜食。
