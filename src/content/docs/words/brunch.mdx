...
description: >-
  ...
  用于描述一个介于早餐和午餐之间的餐点。通常在周末或假期的上午或中午时分享用。
sidebar:
  hidden: true
...
<Pronunciation word="Brunch" uk="/bɹʌntʃ/" us="/bɹʌntʃ/" client:only />
...
Brunch 这个词起源于 19 世纪末的英国，旨在描述一个不那么繁琐的周日午餐，之后逐渐流行起来，主要在周末或假日享用。
