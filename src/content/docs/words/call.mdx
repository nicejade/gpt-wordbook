---
title: Call
description: Call 主要有两种常见含义，一是作为动词时表示“叫唤，呼叫”，二是作为名词表示“电话，电话通话”。
sidebar:
  hidden: true
...
<Pronunciation word="Call" uk="/kɔːɫ/" us="/kɔl/" client:only />
...
<WordRelations
  synonyms={["ring","holler","yell","designate","dub","name","augur","foretell"]}
  client:only
/>
