...
title: Dan
description: >-
  Dan 在英文中可能有多个含义。它可能是一个常见的男子名字，像 'Dan Smith' 或 'Dan Jones'。在某些语境下，'Dan'
  也可能是衔级或等级的意思，特别是在某些武术（尤其是和日本有关的）中，例如：'He is a fifth dan in karate'（他是空手道五段）。
sidebar:
  hidden: true
...
<Pronunciation word="Dan" uk="/dæn/" us="/dæn/" client:only />
