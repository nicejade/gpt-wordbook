---
title: Furnish
description: Furnish 是一个动词，主要有两个含义。其一是提供或供应，常用来指提供某种服务、商品、信息等。其二是装饰、布置，特别是指用家具装饰或布置房屋。
sidebar:
  hidden: true
...
<Pronunciation word="Furnish" uk="/ˈfɜːnɪʃ/" us="/ˈfɝnɪʃ/" client:only />
...
你可以把"furnish"和“furniture" (furniture 就是家具的意思)关联起来，用家具来装饰或布置房间就是"furnish"。
