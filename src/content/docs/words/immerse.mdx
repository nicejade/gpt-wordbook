---
title: Immerse
description: Immerse是一个动词，源于拉丁文'immergere'，主要意思是把某物完全放入液体中，比喻意思则是使某人全身心投入到某件事物中，侧重于深度和专注度。
sidebar:
  hidden: true
...
<Pronunciation word="Immerse" uk="/ɪˈmɜː(ɹ)s/" us="/ɪˈmɜː(ɹ)s/" client:only />
...
<WordRelations synonyms={["submerge"]} client:only />
