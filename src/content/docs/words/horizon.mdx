...
description: >-
  Horizon
  是一个英文单词，意为'地平线'。它描述的是我们站在地面上所能看到的天空和地面相接触的虚拟线。同时，它也有着比喻的含义，被用来表示“视野”或“界限”等。
sidebar:
  hidden: true
...
<Pronunciation word="Horizon" uk="/həˈɹaɪzən/" us="/həˈɹaɪzən/" client:only />
...
(Tom 爬上了山顶。他望出去，看到太阳正好碰到地平线，这是完美的一天的完美结束。)

<WordRelations synonyms={["skyline", "skysill"]} client:only />
