...
title: Flexible
description: >-
  "Flexible"是一个形容词，它的基本意思是"能够轻易弯曲而不破裂，韧性好；可以变通的，易于调整的；能够适应新环境、应变于不同情况的"。 如： 1.
  This cable is flexible. (这条电缆很柔韧) 2. He is flexible in his attitude.
  (他在态度上能做到灵活变通。) 3. Flexible hours make life easier for employees.
  (弹性工作时间使员工的生活更轻松。)
sidebar:
  hidden: true
