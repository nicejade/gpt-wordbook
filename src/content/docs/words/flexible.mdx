---
title: Flexible
description: Flexible是一个形容词，它的基本意思是'能够轻易弯曲而不破裂，韧性好；可以变通的，易于调整的；能够适应新环境、应变于不同情况的'。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["manageable","tractable","inconstant","malleable","plastic","obsequious","pliable","pliant","supple","wavering"]}
  antonyms={["brittle", "inflexible", "stiff"]}
  client:only
/>
