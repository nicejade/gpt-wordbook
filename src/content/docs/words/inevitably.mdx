---
title: Inevitably
description: Inevitably 是一个副词，意为 '无可避免地'，它表明某种情况或结果强制性和必然性。
sidebar:
  hidden: true
...
同样基于 “evit-” 词根衍生的单词还有：evitable，eviternal 之类的。
...
<WordRelations
  ...
  antonyms={["unexpectedly","unusually","impossibly","incidentally"]}
  client:only
/>
