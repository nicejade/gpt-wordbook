---
title: Ratio
description: "Ratio是一个名词，表示两个数量之间的关系或比例。例如，如果我们有 10 个苹果和 20 个香蕉，那么苹果和香蕉的比例就是 1:2。"
sidebar:
  hidden: true
...
"Ratio"是一个名词，表示两个数量之间的关系或比例。例如，如果我们有 10 个苹果和 20 个香蕉，那么苹果和香蕉的比例就是 1:2。

<Pronunciation word="Ratio" uk="/ˈɹeɪ.ʃi.əʊ/" us="/ˈɹeɪ.ʃiˌoʊ/" client:only />

### 列举例句

1.  The ratio of men to women in the company is 2:3. （公司中男女的比例是 2:3）
...
该词源于 16 世纪的拉丁语，最初用于描述计算或思考。在现代英语中，“ratio”被广泛用来表示任何种类的数值比例，比如财经、科学和烹饪等领域。
...
汤姆查看了他的银行账户，并计算了他的储蓄和支出的比例。是 1:2。他意识到他需要存更多的钱。
