---
title: One
description: one 最常见的含义是表示数字'1'，同时它也被用作代词，指代某一已提到或已知的人或物。当'one'用作代词时，它指的是一般的、抽象的人，而不是特指某个人。
sidebar:
  hidden: true
...
<Pronunciation word="One" uk="/wan/" us="/wʌn/" client:only />
...
"one" 的词源相当古老，它来源于古英语 an，意为"一个"，进一步追溯，它源自原始日耳曼语 ainaz。
...
<WordRelations
  synonyms={["single", "unity", "1", "eleven", "they", "you"]}
  client:only
/>
