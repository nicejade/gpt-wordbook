---
title: Ruin
description: Ruin 是一个既可以作为动词又可以作为名词的单词。作为动词，它主要用来描述使某物毁坏，使某人堕落；作为名词，它形容的是毁灭的情况或状态，或者毁坏的遗迹。
sidebar:
  hidden: true
...
<Pronunciation word="Ruin" uk="/ˈɹuː.ɪn/" us="/ˈɹuː.ɪn/" client:only />
...
"Ruin" 这个单词最早出现在 14 世纪的英国，主要指建筑物的倒塌，后来在语境中扩大化，用来描述一般的毁灭或破产。
