...
title: Verse
description: >-
  "Verse" 这个单词有两个主要含义，它可以既表示“诗歌”，也可以指歌词的“段落”。例如："He recited a verse from his
  favorite poem"（他背诵了他最喜欢的诗的一段）；"The second verse of the song really speaks to
  me"（这首歌的第二段歌词真是深得我心）。 **例句展示：** 1. "The child wrote a beautiful verse for his
  mother."（孩子为他妈妈写了一段美丽的诗歌） 2. "The chorus is followed by another
  verse."（副歌后是另一个段落） 3. "This verse from the Bible is quite
  inspirational."（圣经里的这一节很有启发性）
sidebar:
  hidden: true
...
Verse 来源于拉丁语 "versus"，意为“转，旋转”，基本意思是“以特定的韵律和节奏旋转”。由此词根派生的单词比如： "reverse"(反转), "rehearse"(反复练习，来自拉丁语的 "re-" + "versus") 等。
