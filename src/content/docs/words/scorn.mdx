...
description: >-
  Scorn
  是一个英语单词，它主要在两种情境中使用：名词和动词。作为名词，它通常意味着“轻蔑”或“鄙视”。可以指代对他人的不尊重或轻视，甚至含有嘲笑的意味。作为动词，它可以表示“不屑”或“鄙视”某事或某人。
sidebar:
  hidden: true
...
<Pronunciation word="Scorn" uk="/skɔːn/" us="/skɔɹn/" client:only />
...
该词词源可追溯到 12 世纪的古法语，然后发展为中世纪英语的 "scarn"，后来经过演变最终变为了现在的 "scorn"。
...
<WordRelations
  synonyms={["mock","ridicule","scoff","sneer"]}
  client:only
/>
