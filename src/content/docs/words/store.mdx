...
title: Store
description: >-
  "Store"这个单词有很多意思，但主要的两个意思是： - 作为名词， "Store"通常指的是一个商店或一个存储地点。例如， "grocery
  store" 通常指的是售卖食品的商店。 - 作为动词时，"Store" 指的是保存或储备物品，例如"store water in a
  tank"意思是在水箱里储存水。
sidebar:
  hidden: true
...
"Store"这个单词在 14 世纪时由法语引入英语，原意是供应品，后来发展成储存和供应物品的场所的意思，即我们现在的商店。
