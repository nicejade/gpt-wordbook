---
title: Park
description: Park是一个英文单词，可以作为动词或名词使用。动词的含义是'停放，停住'，例如停车。名词的含义是'公园，停车场'等。
sidebar:
  hidden: true
...
<Pronunciation word="Park" uk="[paːk]" us="[paːk]" client:only />
...
"Park"一词从 14 世纪开始有记录，最初用于指代一块用于狩猎的地方，围栏内放有野兽。到 18 世纪，随着园林艺术的发展，它开始被用来形容精心设计和维护的户外区域，例如公园。
