---
title: Painful
description: Painful是一个形容词，用于描述感觉到的疼痛，也可以形容令人不愉快或困扰的事情。
sidebar:
  hidden: true
...
<Pronunciation word="Painful" uk="/ˈpeɪn.fəl/" us="/ˈpeɪn.fəl/" client:only />
...
"Painful"源自老英语的"paine"，意为"疾病"、"疼痛"，后缀"ful"出现于 1300 年左右，起初用于表示"充满…"的意思。
...
<WordRelations
  synonyms={["doleful","irksome","sorrowful","laborious"]}
  antonyms={["painless"]}
  client:only
/>
