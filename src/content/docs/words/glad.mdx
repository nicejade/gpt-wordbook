...
title: Glad
description: >-
  Glad 是一个英文形容词，它表示快乐、高兴或者愉快的情绪。通常描述在某件事情发生后感到的满足和喜悦。例如, 'I'm glad to hear that
  you're doing well.'（听到你过得很好，我很高兴。）
sidebar:
  hidden: true
...
<Pronunciation word="Glad" uk="/ɡlæd/" us="/ɡlæd/" client:only />
...
<WordRelations
  synonyms={["exhilarate","gladden"]}
  antonyms={["cranky","depressed","downcast","heavy","peevish","sad","sorrowful"]}
  client:only
/>
