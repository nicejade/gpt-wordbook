---
title: Enterprise
description: Enterprise 是个英文字，意指“企业”或“事业”，不仅指代商业组织，也可以指任何大型的、有组织的尝试和事业。
sidebar:
  hidden: true
...
"Enterprise" 最早在 15 世纪末解作行动或尝试，16 世纪中叶开始引申为冒险活动，16 世纪晚期又被用来表示艰难的任务。到了 19 世纪，"Enterprise" 又被用来指代商业公司，这是我们现在最常见的用法。
...
<WordRelations synonyms={["initiative"]} client:only />
