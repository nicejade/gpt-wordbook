---
title: Various
description: Various这个词是个形容词，主要用来表示“各种各样的”，或者说是“不同类型的”。
sidebar:
  hidden: true
...
<Pronunciation word="Various" uk="/ˈvɛə.ɹi.əs/" us="/ˈvæɹ.i.əs/" client:only />
...
"Various"这个词源于拉丁语"varius"，在大约 14 世纪时开始在英语中使用，一开始主要是用来形容各种各样的颜色。
