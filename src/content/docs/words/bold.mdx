...
title: Bold
description: >-
  Bold主要有两个含义，第一个是'勇敢的'，用来形容质量及个性，如一个勇敢的人或者一个勇敢的举动。第二个是'粗的'或'醒目的'，常用于形容字体、线条、色彩等。
sidebar:
  hidden: true
...
<Pronunciation word="Bold" uk="/bəʊld/" us="/boʊld/" client:only />
