---
title: Management
description: Management 是一个名词，一般指管理或者经营。这个词在商业和组织结构中非常常见，通常指领导或者监督团队以达到一定的目标或者期望。
sidebar:
  hidden: true
...
Management 这个单词最早出现在 16 世纪，表示“驾驭技巧”，其后随工业革命的到来，逐渐泛化并引申为日常事务和人的管理。
...
<WordRelations
  synonyms={["Mgmt.", "mgmt", "mgmt.", "mgt", "mng't"]}
  client:only
/>
