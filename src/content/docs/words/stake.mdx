---
title: Stake
description: Stake 是一个英文单词，它有多个含义：作为名词，可以指'维持物，标柱'，也可以指'赌注；利害关系'。作为动词，它的含义是'打赌；资助；以柱支撑'。
sidebar:
  hidden: true
...
<Pronunciation word="Stake" uk="/steɪk/" us="/steɪk/" client:only />
...
<WordRelations synonyms={["peg", "bet", "hazard", "wager"]} client:only />
