---
title: Vicious
description: Vicious 这个单词的含义是“邪恶的、残忍的、凶恶的”。
sidebar:
  hidden: true
...
<Pronunciation word="Vicious" uk="/ˈvɪʃəs/" us="/ˈvɪʃəs/" client:only />
...
"Vicious" 词根源于拉丁语 "vitiosus"。首次在 14 世纪的英国使用，原指行为缺点和过失，后发展为更广泛的含义，主要用来形容人或行为的邪恶或凶恶。
...
<WordRelations synonyms={["scathy"]} client:only />
