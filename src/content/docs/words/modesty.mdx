---
title: Modesty
description: Modesty 是一个名词，意思是谦虚、谦逊，它也可以引用表示端庄、保守或者避免过于展示自我。
sidebar:
  hidden: true
...
<Pronunciation word="Modesty" uk="/ˈmɒd.ə.sti/" us="/ˈmɒd.ə.sti/" client:only />
...
Modesty 源自于拉丁词根 "modus"，这个词根的意思是“度量，尺度，方式，方式”。其中 -esty 是名词后缀。
...
Modern English 词汇 "modesty" 来源于中世纪拉丁词 "modestia" ，在欧美文化中，modesty 被高度赞扬和期待，尤其在社交、职业场所，和伦理道德方面。
...
在一个小镇上，一个名叫 Bob 的谦逊的人因他的谦逊而出名。尽管他享有名声和财富，他过着简单的生活，总是穿着朴素的衣服，尊重每个人。他的谦虚赢得了每个人的爱。

<WordRelations
  antonyms={["extravagance", "immodesty", "impudence"]}
  client:only
/>
