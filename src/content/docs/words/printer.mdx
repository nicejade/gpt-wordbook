---
title: Printer
description: Printer指的是一种用来打印文档或者图片的电脑设备。它可以将电脑中的电子文档转化为硬拷贝。
sidebar:
  hidden: true
...
<Pronunciation word="Printer" uk="/ˈpɹɪntə(ɹ)/" us="/ˈpɹɪntə(ɹ)/" client:only />
...
"Printer"这个词出现在大约 14 世纪，来自中古英语词汇 “prente”，最初用以指称印刷工人。随着技术的发展，特别是电脑打印技术的诞生，"printer"的含义逐步扩展。
