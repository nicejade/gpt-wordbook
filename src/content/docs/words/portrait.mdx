...
description: >-
  Portrait
  是一个英文名词，最基本的意思是“肖像，画像”。它通常用于指一种艺术形式，即通过绘画、摄影或其他媒介来捕捉个人或群体的肖像。同时，'portrait'也可以用来描述一种形象生动、详细的描述或展示。
sidebar:
  hidden: true
...
<Pronunciation word="Portrait" uk="/ˈpɔːtɹeɪt/" us="/ˈpɔɹtɹeɪt/" client:only />
...
"Portrait"的词源可以追溯到 16 世纪的法语，来自于“portraire”，意为“描绘”。肖像画在欧洲文化中非常重要，因为它能保存个人的形象，并作为权力和身份的象征。
...
<WordRelations antonyms={["landscape", "profile"]} client:only />
