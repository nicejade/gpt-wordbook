---
title: Dim
description: Dim 是个形容词，基本的意思是'不光明的”，'暗淡的'，也可以表示'模糊的'，'难以理解的'。一般用于描述光线不足或者视力模糊的情况。
sidebar:
  hidden: true
...
<Pronunciation word="Dim" uk="/dɪm/" us="/dɪm/" client:only />
...
<WordRelations antonyms={["augmented"]} client:only />
