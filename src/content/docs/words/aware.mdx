---
title: Aware
description: aware是形容词，意思是“意识到的，知道的”，指知道或意识到正在发生的事情。
sidebar:
  hidden: true
...
<Pronunciation word="Aware" uk="/əˈweːɹ/" us="/əˈwɛɚ/" client:only />
...
<WordRelations
  synonyms={["cognizant","conscious","informed","mindful","alert","attentive","observant","sensitive","wary","watchful"]}
  antonyms={["unaware"]}
  client:only
/>
