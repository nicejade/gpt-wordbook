---
title: Toothache
description: Toothache 是一个英文单词，意思是“牙痛”。这个单词是由 'tooth'（牙齿）和 'ache' （疼痛）两个单词组合而成的。
sidebar:
  hidden: true
...
<Pronunciation word="Toothache" uk="/ˈtuθˌeɪk/" us="/ˈtuθˌeɪk/" client:only />
...
<WordRelations synonyms={["dentalgia", "odontalgia"]} client:only />
