---
title: Echo
description: Echo一词在英语里主要有两个含义，一是名词，指声音的反射，即回声。二是动词，指像回声一样重复或反射声音。
sidebar:
  hidden: true
...
<Pronunciation word="Echo" uk="/ˈɛkəʊ/" us="/ˈɛkoʊ/" client:only />
...
Echo 没有特别的变形，其复数形式为 echos 或 echoes。
