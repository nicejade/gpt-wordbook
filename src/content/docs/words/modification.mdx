---
title: "modification"
description: "Modification 是一个名词，它主要用来指的是改变、修改或调整的过程。这个词经常被用于描述对计划、设备、文档等的改动。"
---
...
"Modification" 这个单词在 14 世纪左右开始在英语中使用。它主要用于表示一种意图改变或调整某物的行动，这种变化可以是物理的或抽象的。
...
"Modification" 的固定搭配有: make a modification, under modification，modification to sth 等。
...
Tom sat at his desk, squinting at the blueprint. He realized a modification was necessary to improve the efficiency of the machine. Adjusting a few connections could drastically cut down operation time. (Tom 坐在他的办公桌前，眯着眼睛看着蓝图。他意识到需要对机器进行一些修改以提高效率。调整一些连接可以大大减少操作时间)。
