---
title: Contrary
description: Contrary 是以形容词的形态最为常见，表示“相反的，矛盾的”。作为名词时，意思是“相反的事物或情况”。
sidebar:
  hidden: true
...
<Pronunciation word="Contrary" uk="/ˈkɒntɹəɹi/" us="/ˈkɑntɹɛɹi/" client:only />
...
<WordRelations synonyms={["witherward"]} client:only />
