...
title: Client
description: >-
  Client 是一个名词，意思是客户，指在商业交易中，购买商品或服务的个人或组织。另外在计算机科学中，'client'
  还可以指的是客户端，像一个电脑或手机这样的设备，用于接收服务器提供的服务。
sidebar:
  hidden: true
...
<Pronunciation word="Client" uk="/ˈklʌɪənt/" us="/ˈklaɪ.ənt/" client:only />
...
<WordRelations
  synonyms={["buyer", "customer", "punter"]}
  antonyms={["server"]}
  client:only
/>
