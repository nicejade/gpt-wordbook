...
description: >-
  Affirmation
  这个词主要用于描述一种表达强烈肯定或支持的行为或陈述。它可以用于指代个人的情绪宣泄，也可以用于正式的情境，比如在法律中表达确认或证实的动作。
sidebar:
  hidden: true
...
"Affirmation"是由拉丁词根"firm"演变而来，"firm"意为“稳固的”，前缀"ad-"（在英语中常常变为"af-"）表示“向”，结合起来愿意是"向稳固的”。 衍生词有 affirm, confirm 等。
...
"Affirmation"这个词起源于 14 世纪法国的法语"affirmacion"，意思是"确认，肯定"。之后从法语传入英语的过程中逐渐演变为现在的形态和用法。
...
<WordRelations synonyms={["assertion"]} client:only />
