...
description: >-
  Partly
  是一个副词，用来表示某件事情或某种情况的一部分，通常用于因果关系的叙述中，表示某结果是由几个原因共同造成的其中之一。相当于汉语中的“部分地”或“在某种程度上”。
sidebar:
  hidden: true
...
<Pronunciation word="Partly" uk="/ˈpɑːtli/" us="/ˈpɑɹtli/" client:only />
...
"Partly" 源于中世纪英语，大约在 14 世纪开始出现，其在英语当中的使用十分广泛，并没有特殊的文化内涵。
