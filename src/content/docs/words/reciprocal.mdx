---
title: Reciprocal
description: reciprocal 主要被用作形容词，其意义在不同的上下文中可以有所不同，但主要项以下几个方向：
sidebar:
  hidden: true
...
<Pronunciation word="Reciprocal" uk="/ɹɪˈsɪpɹək(ə)l/" us="/ɹɪˈsɪpɹək(ə)l/" client:only />
...
<WordRelations
  synonyms={["reflexive","contrary","converse","cross","inverse","inverted","opposite","mutual"]}
  client:only
/>
