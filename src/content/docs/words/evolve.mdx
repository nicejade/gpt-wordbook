---
title: Evolve
description: "Evolve 是一个动词，主要有两个含义:"
sidebar:
  hidden: true
...
<Pronunciation word="Evolve" uk="/ɪˈvɒlv/" us="/ɪˈvɒlv/" client:only />
...
这个词首次出现在英文中是在 17 世纪，最早的含义是"展开、打开"。到了 18 世纪，这个词的意思转为"进行、进行中"。直到 19 世纪，"evolve" 才得到了现在"进化、发展"的意思。
