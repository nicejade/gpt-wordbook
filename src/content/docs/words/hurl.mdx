---
title: Hurl
description: Hurl是一个动词，它的基本含义是猛力投掷或抛出。在口语中，它也可以用来形容沉重的打击或咆哮声。此外，'hurl'也可以指猛烈的甩出或猛烈的吐出。
sidebar:
  hidden: true
...
<Pronunciation word="Hurl" uk="/hɝl/" us="/hɝl/" client:only />
...
"Hurl"的历史可以追溯到 14 世纪，最初来源于中古英语中的"hurlen"，意为"投掷"。在欧美文化中，"hurl"常用于描述强烈的、猛烈的动作。
