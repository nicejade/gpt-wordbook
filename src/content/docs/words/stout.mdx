...
title: Stout
description: >-
  Stout 是个形容词，主要有两种含义：一是形容人或物体肥胖、结实、健壮，如'stout man'
  (壮实的男人)。二是形容物质结构坚实、耐用，如'stout shoes' (坚固的鞋子)。
sidebar:
  hidden: true
...
<Pronunciation word="Stout" uk="/stʌʊt/" us="/staʊt/" client:only />
...
"Stout"最早源于古英语的"stut"，大约发展形成我们现在使用的 "Stout" 是在 14 世纪，主要用于形容人们的体态健壮。
...
<WordRelations
  synonyms={["thickset","fat","arrogant","hard","haughty","lusty","muscular","robust","sinewy","vigorous"]}
  client:only
/>
