---
title: Attractive
description: attractive 是一个形容词，意思是吸引人的、有魅力的。在常规的用法中，它最常用来描述看上去很好的人或物体。
sidebar:
  hidden: true
...
'attractive' 一词的最早出现在 16 世纪。早期的意义更多地关联到物理特性，如磁铁吸引铁钉。
...
<WordRelations
  synonyms={["magnetic"]}
  antonyms={["repulsive", "ugly", "unattractive"]}
  client:only
/>
