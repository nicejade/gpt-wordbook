---
title: King
description: King 是一个英语单词，表示'国王'，这个单词主要在讨论封建制度，国家领导人，或者象棋的王等场合使用。
sidebar:
  hidden: true
...
<Pronunciation word="King" uk="/kɪŋ/" us="/kiŋ/" client:only />
...
这个单词没有前缀或后缀，它是一个基本词。但是我们可以增加后缀-forming words，比如 "kingdom" (后缀 -dom 表示领地，地方，像 freedom, wisdom 等)。
