...
description: >-
  Confer
  是一个动词，有两个主要的含义。首先，它可以表示“讨论”，指的是一组人聚在一起交换观点或者寻求共识。第二，它也可以表示“授予”，在这种情况下，它通常指的是授予荣誉、权力、地位等。
sidebar:
  hidden: true
...
<Pronunciation word="Confer" uk="/kənˈfɜː/" us="/kənˈfɜː/" client:only />
...
<WordRelations synonyms={["afford"]} client:only />
