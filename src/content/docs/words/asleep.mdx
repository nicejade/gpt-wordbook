---
title: Asleep
description: asleep是一个形容词，主要描述一种处于睡眠状态的情况。这个词常用于表述一个人或动物的睡眠状态，例如，“He's asleep”（他正在睡觉）。
sidebar:
  hidden: true
...
<Pronunciation word="Asleep" uk="/əˈsliːp/" us="/əˈsliːp/" client:only />
...
<WordRelations synonyms={["dormant"]} antonyms={["awake"]} client:only />
