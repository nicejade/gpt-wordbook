---
title: Victor
description: Victor 是一个英语名字，源自拉丁语，顾名思义，它的意思是“胜利者”或“赢家”。
sidebar:
  hidden: true
...
<Pronunciation word="Victor" uk="/ˈvɪk.tə(ɹ)/" us="/ˈvɪk.tə(ɹ)/" client:only />
...
<WordRelations synonyms={["conqueror", "winner"]} client:only />
