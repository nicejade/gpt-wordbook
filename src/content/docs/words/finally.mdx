---
title: Finally
description: Finally是一个副词，常用来表示最后，终于，最终的意思。当要表达某事情在一段时间后或者经过很多麻烦后才发生时，我们会使用'finally'。
sidebar:
  hidden: true
...
<Pronunciation word="Finally" uk="/ˈfaɪ.nəl.i/" us="/ˈfaɪ.nl̩.i/" client:only />
...
"Finally" 的词源历史可以追溯到 14 世纪的英格兰，在欧美文化中，它用于强调事情最后的结果或最终实现的情况。
...
<WordRelations
  synonyms={["completely","thoroughly","totally","endly","eventually"]}
  antonyms={["initially"]}
  client:only
/>
