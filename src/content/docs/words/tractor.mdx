---
title: Tractor
description: Tractor 是一个名词，它主要用来表示“拖拉机”，一种农业或工程用途的重型机械载具。
sidebar:
  hidden: true
...
<Pronunciation word="Tractor" uk="/ˈtɹæktə/" us="/ˈtɹæktɚ/" client:only />
...
"Tractor" 这个词在英文中首次出现是在 19 世纪的美国，用来表示一种可以拖拽其他的重型机械设备，特别是在农业和建筑工程中。
