...
title: Facial
description: >-
  Facial是一个英语词，它是一个形容词和名词。作为形容词，它通常用来描述与面部或脸有关的东西，例如 facial hair（面部毛发）或 facial
  expression（面部表情）。作为名词，它通常指的是针对面部皮肤的各种美容护理措施。
sidebar:
  hidden: true
...
<Pronunciation word="Facial" uk="/ˈfeɪʃəl/" us="/ˈfeɪʃəl/" client:only />
...
"Facial" 的词缀是 -ial，它是一个常见的形容词后缀。其他同样带有-ial 后缀的单词包括 "personal"（个人的），"official"（官方的）等。

### 文化背景

19 世纪，面部护肤作为一种形式的美容疗法在美国和欧洲逐渐流行起来，由此词汇 "facial" 进入了英语词汇。此外，由于人类社会十分注重外貌，尤其是脸部的外貌，因此"facial"在英语中使用频率也很高。
