---
title: Ant
description: Ant 是英语中的一个单词，表示“蚂蚁”。
sidebar:
  hidden: true
...
<Pronunciation word="Ant" uk="/ɛnt/" us="/ænt/" client:only />

### 列举例句

1.  The ant is the smallest creature, yet it is diligent. (蚂蚁是最小的生物，然而它却勤奋。)
2.  An ant can carry 50 times its own body weight. (一只蚂蚁能抬起自身体重的 50 倍。)
...
<WordRelations synonyms={["emmet", "pismire"]} client:only />
