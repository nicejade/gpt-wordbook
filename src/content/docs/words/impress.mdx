---
title: Impress
description: Impress这个单词是动词，主要含义是'给人以深刻的影响'或'使印象深刻'。
sidebar:
  hidden: true
...
<Pronunciation word="Impress" uk="/ˈɪmpɹɛs/" us="/ˈɪmpɹɛs/" client:only />
...
"Impress"一词起源于 14 世纪的法语，意思为"有影响"或"留下痕迹"，后来发展成英语中"给人深刻印象"的含义。
...
可以联想到"在 press(压)力下，通常会留下深刻影响"来记住此单词。
...
<WordRelations
  synonyms={["pressgang","imprint","print","stamp","confiscate","impound","seize","sequester"]}
  client:only
/>
