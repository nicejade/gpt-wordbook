---
title: Personality
description: Personality 是个英语名词，意为“性格”，“个性”，专指一个人的字符、品质、行为和情绪的总和，是每个人独特的思考、感受、行为模式。
sidebar:
  hidden: true
...
<Pronunciation word="Personality" uk="/-i/" us="/-i/" client:only />
...
"Personality"的词根来自于拉丁语"persona"，意为“人”。"Personality"可以经由"person"与后缀-ality 演变而来，表示特性。
...
"Personality"这个词在 14 世纪被首次用在英语中，原先主要指法律上的身份或角色。到了 19 世纪，它开始拥有描述一个人性格特点和个性特征的意思，由此广泛用于心理学研究。
...
<WordRelations synonyms={["selfness"]} client:only />
