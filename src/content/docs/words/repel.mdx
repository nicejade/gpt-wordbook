---
title: Repel
description: Repel是一个动词，主要有两个含义：一是“排斥，使厌恶”，二是“抵挡，抵抗”（比如敌人或攻击）。
sidebar:
  hidden: true
...
<Pronunciation word="Repel" uk="/ɹɪˈpɛl/" us="/ɹɪˈpɛl/" client:only />
...
"Repel"这个词来源于 14 世纪的“排斥、击退”，具有在物理和道德层面上“拒绝接受”的含义。
...
<WordRelations synonyms={["withdrive"]} antonyms={["attract"]} client:only />
