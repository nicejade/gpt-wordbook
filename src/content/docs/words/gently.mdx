---
title: Gently
description: Gently 是一个副词，表示以轻轻的或柔和的方式。可以形象地理解为 '轻轻地' 或 '温柔地'。
sidebar:
  hidden: true
...
<Pronunciation word="Gently" uk="/ˈdʒɛntli/" us="/ˈdʒɛntli/" client:only />
...
<WordRelations antonyms={["roughly"]} client:only />
