---
title: Important
description: Important是英语中的形容词，常被用来表示'重要的，严肃的，有影响的'。
sidebar:
  hidden: true
...
"Important"这个词在 14 世纪从法语进入英语，最初的意思是"显著的，大量的"，在 16 世纪时才逐渐发展出现今天“重要”的含义。
...
<WordRelations
  synonyms={["significant", "weighty"]}
  antonyms={["ignorable", "negligible", "petty", "slight", "unimportant"]}
  client:only
/>
