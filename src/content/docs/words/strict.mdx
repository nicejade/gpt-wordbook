---
title: Strict
description: Strict 是一个形容词，意指严格的、严厉的，也有严谨的含义。当表示对规章、法律或纪律的遵守时，strict 强调必须严格恪守，没有任何例外。
sidebar:
  hidden: true
...
Strict 是一个形容词，意指严格的、严厉的，也有严谨的含义。当表示对规章、法律或纪律的遵守时，strict 强调必须严格恪守，没有任何例外。

<Pronunciation word="Strict" uk="/stɹɪkt/" us="/stɹɪkt/" client:only />
...
Strict 源自拉丁语“strictus”，意为“绷紧的”，随时间发展，引申出严格、严厉的含义。类似的单词有 restrict（限制）、constrict（压缩）、district（区域）等。

### 词缀分析

Strict 是一个基础词，并没有包含任何词缀。

### 文化背景

Strict 源于 14 世纪的法国，其最早的含义为"紧密、紧张"，源自拉丁语词根"strictus"的过去分词，其含义为"拉紧"，后来比喻为对规则等的严格遵守。
...
<WordRelations antonyms={["lax", "lenient", "permissive"]} client:only />
