...
title: Radio
description: >-
  Radio一词主要有两种用法。一是作为名词，表示无线电广播、无线电接收机，这个词常常被用来形容与通讯和音乐广播有关的事物。另一种是作为动词，表示通过无线电发送信息或信号。
sidebar:
  hidden: true
...
<Pronunciation word="Radio" uk="/ˈɹeɪdiˌəʊ/" us="/ˈɹeɪdiˌoʊ/" client:only />
...
"Radio"一词最早出现在 19 世纪 90 年代的英语中，最初被用来描述最早的无线电通信设备。随着 20 世纪的到来，无线电广播开始普及，并成为信息和娱乐的重要来源。
...
<WordRelations synonyms={["receiver", "tuner", "wireless"]} client:only />
