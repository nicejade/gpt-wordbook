...
title: Dental
description: >-
  Dental 是一个英文形容词，主要关联于牙齿或牙科的事务。它常常在描述与牙齿相关的科学、治疗、疾病或设备时使用。也可以作为前缀，比如 dental
  floss (牙线)。
sidebar:
  hidden: true
...
<Pronunciation word="Dental" uk="/ˈdɛntl̩/" us="/ˈdɛntl̩/" client:only />
...
<WordRelations synonyms={["prophy", "teethly", "toothly"]} client:only />
