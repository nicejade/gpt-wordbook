---
title: Battery
description: Battery 是一个英语名词，意思是“电池”。“Battery”也有一个不常用的意思，可以指一系列相同的事物。除此之外，还可以指代“炮丛”。
sidebar:
  hidden: true
...
<Pronunciation word="Battery" uk="/ˈbætəɹi/" us="/ˈbætəɹi/" client:only />

### 列举例句

1.  I need to change the battery in my watch. (我需要更换手表的电池。)
2.  This device requires two AA batteries. (这个设备需要两节 AA 电池。)
...
Battery 这个词最初的意思是“打击”，在 17 世纪被用来形容一系列火炮的联合攻击。到了 19 世纪，随着科学技术的发展，电池被发明出来，由于电池内部的化学反应可以看作是一种物质内部的“攻击”，因此这个词被用来指代电池。
