...
description: >-
  ...
  作为连词，"while"用来表示两个同时发生的动作，例如： 1. While I was reading, my brother was watching
  TV.（我在阅读的时候，我的兄弟在看电视。） 2. He listened to music while he was
  studying.（他在学习的时候听音乐。） 作为名词，"while"表示一段时间，例如：Stay for a while.（待一会儿。）
  "while"也可以用来强调对比或相反的情况，例如： 1. While I understand your concerns, I believe this
  is the best approach.（我理解你的担忧，但我相信这是最好的方法。） 2. He enjoys reading, while his
  brother prefers playing video games.（他喜欢阅读，而他的兄弟更喜欢玩电子游戏。）
sidebar:
  hidden: true
...
"while" 是古英语的词，它来自 Proto-Germanic 语言的 "hwilo"，原始印欧语族的 "kweilo-"，其中 "kwi-" 是一个时间概念。
