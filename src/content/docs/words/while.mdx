---
title: While
description: while 在英语中，是一个非常常见的词，它可以作为广义的时间概念，也可以表现出对对比和相反情况的强调。
sidebar:
  hidden: true
...
<Pronunciation word="While" uk="/waɪl/" us="/waɪl/" client:only />
...
<WordRelations
  synonyms={["spell","linger","idle","laze","lounge","providing","whilst","till"]}
  client:only
/>
