...
title: Biochemistry
description: >-
  Biochemistry是由'Bio-'和'chemistry'组成的合成词，是一个英语专业名词，直译为'生物化学'。它是一门研究生命现象的化学基础的学科，主要探索生物体的化学组成和代谢过程。
sidebar:
  hidden: true
...
生物化学是一个相对年轻的领域，19 世纪末到 20 世纪初开始进入科学领域。在现代，生物化学对医学、基因工程、农业、环保等多领域的研究起到基础性作用。
