---
title: Portion
description: Portion 是英文的一个名词，通常意义为一部分或是一份。它可以用来描述分配或被分配的东西的一部分。
sidebar:
  hidden: true
...
<Pronunciation word="Portion" uk="/ˈpoəɹʃən/" us="/ˈpɔɹʃən/" client:only />
...
<WordRelations
  synonyms={["part","piece","apportion","divide","divvy"]}
  client:only
/>
