---
title: Punctuate
description: Punctuate 这个单词对应汉语的意思为 '标点、强调、打断'，常见用法为'标注符号'，尤其指在写作中加入标点符号。
sidebar:
  hidden: true
...
As Sarah read the letter aloud, the sound of the rain punctuated her words, adding an eerie rhythm to the room. (当 Sarah 大声读信的时候，雨声打断了她的话语，给房间增添了一种怪诞的节奏。)
