---
title: Consider
description: "- 'Consider'作为动词，主要的含义是'考虑'或'认为'。它可以被用于许多情况，例如在撰写计划、发表观点或者评估选择时。"
sidebar:
  hidden: true
...
<Pronunciation word="Consider" uk="/kənˈsɪdə/" us="/kənˈsɪdɚ/" client:only />
...
- "Consider" 在 14 世纪从法语引入英语，原意是"用星星观察、记住"，后演变为"思考，考虑"的意思。
...
- 以"Consider all the case" 为例，记忆该单词。假设 c 代表 case（情况），o 代表 option（选项），然后把所有的情况作为选项，进行记忆。
...
<WordRelations
  synonyms={["bethink", "deliberate", "reflect", "deem", "regard", "observe"]}
  client:only
/>
