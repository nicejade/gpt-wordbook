---
title: Harmless
description: Harmless是一个形容词，意为'无害的、无伤害的'，用来描述不会造成伤害或危害的人或事物。
sidebar:
  hidden: true
...
<Pronunciation word="Harmless" uk="/ˈhɑːmləs/" us="/ˈhɑɹmləs/" client:only />
...
<WordRelations
  synonyms={["benign", "innocent", "innocuous", "undamaging"]}
  antonyms={["harmful"]}
  client:only
/>
