---
title: Ago
description: ago 是一个英语副词，用来表示 '...之前' 的意思。常比较常用在表示过去的时间概念中。
sidebar:
  hidden: true
...
<Pronunciation word="Ago" uk="/əˈɡəʊ/" us="/əˈɡoʊ/" client:only />
...
"ago"这个单词可以追溯到 14 世纪早期的英语，它最初的形式为"agon"，源自古英语"agān"，意为“去，离开”。
