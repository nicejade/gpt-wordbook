...
description: >-
  Discipline
  是一个可以作为名词和动词使用的英文单词。作为名词，它表示一种遵从规定或者规则的状态，或者一个具体的学术领域。作为动词，它表示对某人进行惩罚或者规定行为。
sidebar:
  hidden: true
...
- 名词：He has the discipline to get up at 5 AM every day. 我每天都有纪律性地早上 5 点起床。
...
<WordRelations
  synonyms={["field", "sphere", "penalty", "sanction", "drill"]}
