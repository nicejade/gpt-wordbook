---
title: Requirement
description: Requirement 是个名词，主要意思是“要求”、“需求”。
sidebar:
  hidden: true
...
"Requirement" 这个词语源于 14 世纪的法国，原意是“请求”，这与现在的含义“需要”、“要求”相符。在欧美文化中，"requirement" 常常用于规定标准或条件。
...
<WordRelations
  synonyms={["condition", "necessity", "prerequisite"]}
  client:only
/>
