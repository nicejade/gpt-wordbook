---
title: Immigrant
description: Immigrant 是英语中的一个常用名词，表示 '移民'，即选择离开自己的祖国，移居他国的人。
sidebar:
  hidden: true
...
<Pronunciation word="Immigrant" uk="/ˈɪmɪɡɹənt/" us="/ˈɪmɪɡɹənt/" client:only />
...
“Immigrant”一词在 18 世纪开始正式用来表示从一个国家移动到另一个国家的人。有大量的标志性文献和历史事件与移民有关，例如美国的"Ellis Island"是进入美国的主要移民门户。
...
<WordRelations antonyms={["emigrant"]} client:only />
