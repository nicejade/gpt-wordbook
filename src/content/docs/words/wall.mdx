...
description: >-
  Wall
  是一个英语单词，通常被翻译为“墙”，它通常指的是建筑物的一面，一般为垂直且实心的，将室内和室外或将两个区域分开。它也可以在比喻中使用，代表一种难以超越或穿越的障碍。
sidebar:
  hidden: true
...
<Pronunciation word="Wall" uk="/wɔːl/" us="/wɔl/" client:only />
...
<WordRelations
  synonyms={["chandelier", "profile", "rampart"]}
  antonyms={["sieve"]}
  client:only
/>
