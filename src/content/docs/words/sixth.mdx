...
title: Sixth
description: >-
  Sixth 是一个序数词，表示顺序中的“第六”。它来自基数词 'six' (六)，后接序数词后缀 '-th'。例如，如果你是在队伍中的第六个人，你可以说
  'I am the sixth person in line.'（我是队伍中的第六个人。）
sidebar:
  hidden: true
...
<Pronunciation word="Sixth" uk="/sɪk(s)θ/" us="/sɪk(s)θ/" client:only />
...
"Sixth" 由词根 "six" 和后缀 "-th" 构成。"Six" 是一个基数词，表示数字 6， "-th" 是用来将基数词变为序数词的后缀。
...
<WordRelations synonyms={["⅙", "6th", "VI", "VIth"]} client:only />
