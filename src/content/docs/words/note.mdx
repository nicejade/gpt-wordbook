---
title: Note
description: Note是一个常见并且多义的英语单词，其主要意义包括'笔记，记号'(名词）以及'注意'（动词）。参见以下例句和中文翻译。
sidebar:
  hidden: true
...
<Pronunciation word="Note" uk="/nəʊt/" us="/noʊt/" client:only />
...
"Note" 最早被记录在 13 世纪的英语中，最初来源于拉丁文的 "nota"。
