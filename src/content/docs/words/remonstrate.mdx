...
title: Remonstrate
description: >-
  "Remonstrate" 是一个动词，表示"反对"或"抗议"。在一般语境中，这个单词常用来形容对某一行为或决定的强烈抗议或反对。 列举使用例句： 1.
  "The citizens remonstrated against the new law." (市民们抗议新法律。) 2. "She
  remonstrated with him about his unhealthy lifestyle." (她对他的不健康生活方式表示反对。) 3.
  "The manager remonstrated that the reduction in staff would lead to lower
  productivity." (经理反对裁员会导致生产力下降。)
sidebar:
  hidden: true
...
单词 "remonstrate" 在 16 世纪从拉丁语词 "remonstrare" 中演变而来，意思是 “反复指出”。至今在英语中，它仍然保持了抗议或反对的含义，并常用于形式上的抗议。
