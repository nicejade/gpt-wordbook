---
title: Rod
description: Rod 是一个名词，主要有两个常见的含义：1) 圆棒或者长棒；2) 竿（比如钓鱼竿或者拐杖）。
sidebar:
  hidden: true
...
<Pronunciation word="Rod" uk="/ɹɒd/" us="/ɹɑd/" client:only />
...
"Rod" 来自于古英语的 "rodd"，该词在 12 世纪的英格兰就被用来形容长棒状的东西。
...
<WordRelations synonyms={["skyfish"]} client:only />
