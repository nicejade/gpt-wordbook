---
title: Gleam
description: Gleam 这个词在英语中是名词和动词两种格式，既可以作为一种明亮或光辉，也可以形容闪烁或反射光线。
sidebar:
  hidden: true
...
<Pronunciation word="Gleam" uk="/ɡliːm/" us="/ɡliːm/" client:only />
...
<WordRelations
  synonyms={["dazzle","lambency","shine","glimmer","trace","beam","ray","flare","flash","kindle","glint","sparkle","glow"]}
  client:only
/>
