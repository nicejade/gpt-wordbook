---
title: Afraid
description: Afraid 是一个形容词，用来描述某人因为担心某事可能发生而感到不安或害怕的情况。它的中文翻译为“害怕的，恐惧的”。
sidebar:
  hidden: true
...
<Pronunciation word="Afraid" uk="/əˈfɹeɪd/" us="/əˈfɹeɪd/" client:only />
...
<WordRelations
  synonyms={["anxious","apprehensive","fearful","timid","timorous","sorry"]}
  client:only
/>
