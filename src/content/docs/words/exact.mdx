...
description: >-
  Exact 这个单词来自于拉丁语的
  'exactus'，意思是精细的、精确的、准确无误的。它既可以作为形容词，也可作为动词。当它袁为形容词时，表示'精确的'或'准确无误的'；当它作为动词时，意思是'强制要求'、'索取'。
sidebar:
  hidden: true
...
<Pronunciation word="Exact" uk="/ɪɡˈzækt/" us="/ɪɡˈzækt/" client:only />
...
<WordRelations
  synonyms={["correct","perfect","precise","true","strict","accurately","just","precisely"]}
