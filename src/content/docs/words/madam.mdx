...
title: Madam
description: >-
  Madam 是对妇女的尊称，相当于先生（Mister）的女性形式，经常用于商务场所或正式场合。在邮件、信件等正式形式中，如果对方的姓名未知，你可以使用
  'madam' 开头。另外，在酒店、餐厅或其他服务行业，员工经常称呼女性客户为 'madam'。
sidebar:
  hidden: true
...
<Pronunciation word="Madam" uk="/ˈmæd.əm/" us="/ˈmæd.əm/" client:only />
...
"Madam" 的使用始于 14 世纪，来源于法语 "ma dame"，意为 "我的女士"。在欧美社会中，这是一种对女士的尊重称呼，类似于 "千金"。在服务行业里，"madam" 用于称呼女士也是很有礼貌的。
...
<WordRelations
  synonyms={["dame","lady","matron","mistress","woman","abbess","bawd","whoremistress"]}
  client:only
/>
