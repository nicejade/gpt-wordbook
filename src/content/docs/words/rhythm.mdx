---
title: Rhythm
description: Rhythm 这个单词的意思是“节奏、韵律”，主要用来描述音乐、生活或自然中重复的模式。
sidebar:
  hidden: true
...
<Pronunciation word="Rhythm" uk="/ˈɹɪ.ð(ə)m/" us="/ˈɹɪ.ð(ə)m/" client:only />
...
<WordRelations synonyms={["meter", "metre", "prosody"]} client:only />
