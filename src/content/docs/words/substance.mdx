...
description: >-
  Substance
  是一个名词，基本含义是“物质”，指所有能够触摸和看到的物体。还可以指“实质”或“核心”，表示事物的主要或重要部分。此外，'substance'
  也可以表示“财产”或“财富”。
sidebar:
  hidden: true
...
<Pronunciation word="Substance" uk="/ˈsʌbstəns/" us="/ˈsʌbstəns/" client:only />
...
<WordRelations
  synonyms={["crux","gist","gear","matter","stuff"]}
  client:only
/>
