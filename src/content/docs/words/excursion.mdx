---
title: Excursion
description: Excursion是一个英文单词，它是名词，意思是“短途旅行”或“远足”。
sidebar:
  hidden: true
...
"Excursion"这个词来源于拉丁语，最早被英语文字记录是在 16 世纪，最初的使用是描述军队的出击。这个词语的使用随着社会文化的发展和变化，现在的使用场景更多的与旅游和娱乐活动相关。
...
<WordRelations
  synonyms={["journey", "trip", "digression", "excursus"]}
  client:only
/>
