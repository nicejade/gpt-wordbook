---
title: Retard
description: Retard这个词通常在英语中被用作动词，意思是“延迟”或“使减速”。它也可以作为名词，指“阻止者”，“妨碍者”。
sidebar:
  hidden: true
...
"Retard"从 15 世纪起在英语中被用作动词，起初的意思是“使延迟或减慢”。此单词的使用在语境中是中性的，以指示物理或概念的减速。
...
<WordRelations
  synonyms={["idiot","imbecile","moron","retarded","tard","delay","retardation","decelerate","slow","hinder","postpone","reluctant"]}
  antonyms={["accelerate","speed"]}
  client:only
/>
