---
title: Ascertain
description: Ascertain 是英语中的一个动词，意为 '确定'、'查明'、'弄清'，通常用于表达对信息、事实等的确定或验证。
sidebar:
  hidden: true
...
<Pronunciation word="Ascertain" uk="/ˌæsəˈteɪn/" us="/ˌæsɚˈteɪn/" client:only />
...
"Ascertain" 的词源可以追溯到中古法语的 "acertener"，意为"确定"，早在 14 世纪就开始在英文中使用，用于表达确定或确认信息、事实等。
...
<WordRelations
  synonyms={["determine", "discover", "establish", "learn"]}
  client:only
/>
