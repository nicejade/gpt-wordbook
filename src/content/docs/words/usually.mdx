---
title: Usually
description: Usually 是一个副词，它的意思是“通常，一般”，用来表示某种动作或状态在一般情况下或通常情况下的发生。
sidebar:
  hidden: true
...
<Pronunciation word="Usually" uk="/ˈjuːʒju(ə)li/" us="/ˈjuːʒ(ʊə)li/" client:only />
...
<WordRelations
  synonyms={["commonly","generally","mainly","mostly","ordinarily","regularly","wontedly","customarily","habitually","normally","routinely","wontly"]}
  client:only
/>
