---
title: Pill
description: Pill 是一个英文名词，通常被翻译为中文的“药片”或“药丸”。它指的是将药物或其他药剂凝固和压缩成小块，以便于口服。
sidebar:
  hidden: true
...
<Pronunciation word="Pill" uk="/pɪl/" us="/pɪl/" client:only />
...
<WordRelations synonyms={["cap", "tablet"]} client:only />
