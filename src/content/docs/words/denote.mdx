---
title: Denote
description: 英语单词 'denote' 是一个动词，它的意思是表示，标示，意味着。比如当我们说“这个标志 denotes 速度限制”，就是指这个标志表示了速度的限制。
sidebar:
  hidden: true
...
<Pronunciation word="Denote" uk="/dɪˈnəʊt/" us="/dɪˈnoʊt/" client:only />
...
"Denote"在 14 世纪从法语派生出来，最初它的意思是“表示”。在现代英语中，这个词主要用来说明一些事物的含义或可能性。
