---
title: Sand
description: 英文单词 'sand' 的意思是“沙子”或者“沙滩”。这个词在使用中可以是名词，也可以是动词。当它被用作动词时，它表示“用沙纸打磨”。
sidebar:
  hidden: true
...
<Pronunciation word="Sand" uk="/sænd/" us="/sænd/" client:only />
...
"sand" 这个词在英语中有很长的历史，最早可以追溯到公元前 4500 年的原始日耳曼语。
