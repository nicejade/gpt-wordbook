---
title: Tone
description: 英文单词 'tone' 的主要含义有两种。首先，它可以指一种声音的质量、音调或者说调子（如：音乐的音调）。其次，它还可以表示一种特殊的态度或表达方式。
sidebar:
  hidden: true
...
<Pronunciation word="Tone" uk="/təʊn/" us="/toʊn/" client:only />
...
<WordRelations
  synonyms={["color","colour","dye","paint","tint","harmonise","harmonize","firm"]}
  client:only
/>
