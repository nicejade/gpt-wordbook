...
title: "Off"
description: >-
  Off 是一个英文单词，它同时可以作为副词、介词、形容词和动词使用。其主要的意义包括：从一个位置或表面移开（例如，“take it
  off”/“把它拿开”）；停止工作或运行（例如，“the lights are off”/“灯熄了”）；离开某地（例如，“he's off to
  work”/“他去上班了”）；表示质量或状态的降低（例如，“I'm a little off today”/“我今天有点不对劲”）等。
sidebar:
  hidden: true
...
<Pronunciation word="Off" uk="/ɔːf/" us="/ɔf/" client:only />
...
<WordRelations antonyms={["fresh", "leg", "on", "near"]} client:only />
