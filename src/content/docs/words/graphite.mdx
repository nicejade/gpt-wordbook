---
title: Graphite
description: Graphite是一种天然碳矿物，也是碳在标准状态下的稳定形式之一。它通常以层状或片状单元出现，经常用于制造铅笔、电池和各种工业零件。
sidebar:
  hidden: true
...
<Pronunciation word="Graphite" uk="/ˈɡɹæfaɪt/" us="/ˈɡɹæfaɪt/" client:only />
...
"Graphite"这个词最早在 1789 年由德国矿物学家 Abraham Gottlob Werner 引入，用于描述铅黑色的自然碳矿。由于其写字使用的特性，从希腊语'graphein'派生出来。
...
<WordRelations
  synonyms={["plumbago","CFRP","CRP","composite","plastic","polymer","reinforced"]}
  client:only
/>
