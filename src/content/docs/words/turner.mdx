---
title: Turner
description: Turner 在英文中的意思取决于其上下文。
sidebar:
  hidden: true
...
<Pronunciation word="Turner" uk="/ˈtɜːnə(ɹ)/" us="/ˈtɜːnə(ɹ)/" client:only />
...
"Turner" 记录的最早的人名是在 12 世纪的英格兰。原意是"车工"或"制陶人"的意思，但它后来成为一个普遍的姓氏。
...
<WordRelations synonyms={["spatula"]} client:only />
