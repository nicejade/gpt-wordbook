...
description: >-
  Company
  是一个英语单词，既可以作为名词，也可以作为动词。最常见的解析是它作为名词，意为“公司”或者“商会”。另外，它还有“陪伴”，“伙伴”的意思。作为动词时，也有'陪伴'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Company" uk="/ˈkʌmp(ə)ni/" us="/ˈkʌmpəni/" client:only />
...
"Company"这个词最早可以追溯到 13 世纪的老法语，用于表示朋友或者同伴，经过长时间的演变，被引申和扩大到今天我们所熟知的商业实体——公司。
...
<WordRelations
  synonyms={["fellowship","friendship","mateship","association","companionship","organization","society","corporation","attend","escort","fornicate"]}
  client:only
/>
