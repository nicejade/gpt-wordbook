---
title: Son
description: Son的主要含义是男性的子孙或后代，常常用来指一个人的男孩。在一些特定情况下，还可能表达亲密、和谐的关系。
sidebar:
  hidden: true
...
<Pronunciation word="Son" uk="/sɒn/" us="/sɒn/" client:only />
...
<WordRelations
  antonyms={["daughter", "father", "mother", "parent"]}
  client:only
/>
