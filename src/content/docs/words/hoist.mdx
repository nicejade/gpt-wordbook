---
title: Hoist
description: hoist是一个英语单词，通常用作动词，意为抬高，举起，吊起。也可以作为名词，指的是用来吊起或提升重物的装置。
sidebar:
  hidden: true
...
<Pronunciation word="Hoist" uk="/hɔɪst/" us="/hɔɪst/" client:only />
...
"hoist"这个词最早出现在 16 世纪，起源于低地德语中的"hijsen"，意为"拉高，升高"。除了物理上的提升外，该词也可以用来描述在精神或社会层面上的提升。
