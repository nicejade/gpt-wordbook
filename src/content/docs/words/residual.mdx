---
title: Residual
description: Residual是一個英文形容詞，意為'剩餘的'或'殘留的'。这个词常用在各种情境中，如在科学、统计、工商管理等领域，可以表示剩余的分量、数量、力量等。
sidebar:
  hidden: true
...
<Pronunciation word="Residual" uk="/ɹɪˈzɪdjəl/" us="/ɹɪˈzɪdjəl/" client:only />
...
<WordRelations synonyms={["residuary"]} client:only />
