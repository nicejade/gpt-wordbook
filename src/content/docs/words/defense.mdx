...
description: >-
  Defense
  是一个名词，通常用于指一种防止伤害、攻击、损失或难题的行为。此外，它也可用于指法律术语中的辩护过程，或者表示体育运动中阻止对方得分的动作或策略。
sidebar:
  hidden: true
...
<Pronunciation word="Defense" uk="/dɪˈfɛns/" us="/dɪˈfɛns/" client:only />
...
"Defense" 这个词源于 14 世纪的法语 "defens" 或 "defense"，这两个词又源于拉丁语 "defensus"，是 "defendere" 的过去形式，意为"防卫"。
...
<WordRelations antonyms={["offense"]} client:only />
