...
title: Fluid
description: >-
  Fluid是一个形容词和名词。作为名词，它是液体的普遍术语，可以引用任何液态物质，如水或油。作为形容词，“fluid”描述的是易变的，不固定的，或流动的事物。它也可能描绘一种语言、动作或行为的流畅性。
sidebar:
  hidden: true
...
<Pronunciation word="Fluid" uk="/ˈfluːɪd/" us="/ˈfluːɪd/" client:only />
...
<WordRelations
  synonyms={["fluent","liquid","unstable","variable"]}
  client:only
/>
