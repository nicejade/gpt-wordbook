---
title: Grid
description: Grid 是一个名词，主要有两种基本含义：1）网格，指的是类似于棋盘的方格子；2）电网，特指供电系统。
sidebar:
  hidden: true
...
<Pronunciation word="Grid" uk="/ɡɹɪd/" us="/ɡɹɪd/" client:only />
...
"Grid"这个词首次出现在美国，大约在 19 世纪 20 年代，最早用于表示金属的篱笆后来演变为描述网格形状的指代。在电力系统中，"grid"常常被用来指代电网。
