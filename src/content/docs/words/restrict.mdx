---
title: Restrict
description: Restrict是一个动词，通常来说，它的意思是'限制'或'约束'。这个单词是在某种范围内、在某种限度内做事，或将某事限定在一定的条件、规定或区域内。
sidebar:
  hidden: true
...
<Pronunciation word="Restrict" uk="/ɹɪˈstɹɪkt/" us="/ɹɪˈstɹɪkt/" client:only />
...
<WordRelations
  synonyms={["bound","curb","limit","restrain"]}
  client:only
/>
