---
title: Preliminary
description: Preliminary 是一个形容词，意为'预备的，初步的，起初的'，用于描述一些初步的、为了之后更复杂的活动所做的准备活动。
sidebar:
  hidden: true
...
"Preliminary" 这个单词在 16 世纪从法语引入英语，用以表达“初步的，准备的”的概念。在语言发展历程中，这个词一直用于描述一些先行，为后续工作做准备的步骤。
