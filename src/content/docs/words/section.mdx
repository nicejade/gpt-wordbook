...
title: Section
description: >-
  Section 是英语中的一个常见词，其主要意思是“部分，部门，区域，区段，章节”。例如，在军事术语中，“section”
  可以用来指一小群士兵，同时在书籍文章中也经常用“section”来形容章节或部分。
sidebar:
  hidden: true
...
<Pronunciation word="Section" uk="/ˈsɛkʃən/" us="/ˈsɛkʃən/" client:only />
...
单词 "section"起源于 14 世纪，借自拉丁词"sectio"。此词在历史上的用法及含义已经基本未曾发生改变。
...
<WordRelations
  synonyms={["slice","snippet","division","part","piece","volume"]}
  antonyms={["whole"]}
  client:only
/>
