...
description: >-
  Corrosion
  是一个名词，主要用来描述一种自然现象，指的是材料，特别是金属在环境影响下逐渐磨损、损坏的过程。通常与化学反应或电化学反应有关，比如铁在湿气中会生锈就是一种腐蚀。
sidebar:
  hidden: true
...
<Pronunciation word="Corrosion" uk="/kəˈɹəʊʒən/" us="/kəˈɹəʊʒən/" client:only />
...
"Corrosion" 一词源自 14 世纪中期的英语，主要用于描述化学或电化学反应引起的材料磨损过程。
