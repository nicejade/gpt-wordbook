---
title: Rotation
description: Rotation这个单词来自于动词'rotate'，意思是旋转。当它用作名词时，它通常用来表示一个事物围绕某点旋转或回转的过程。
sidebar:
  hidden: true
...
<Pronunciation word="Rotation" uk="/ɹoʊˈteɪʃən/" us="/ɹoʊˈteɪʃən/" client:only />
...
3.  She made a 360-degree rotation with the ballet. (她做了一个 360 度的芭蕾旋转。)
...
“Rotation"这个词在 14 世纪从老法语进入到英语中，最初是用来描述物体围绕中心的旋转。现在，这个词具有很广泛的用途，包括数学，物理，生物等各个领域。
...
<WordRelations
  synonyms={["cycling","roster","rota","schedule","turn","revolution","turning"]}
  client:only
/>
