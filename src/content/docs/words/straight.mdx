---
title: Straight
description: Straight 在英语中主要有三个含义：
sidebar:
  hidden: true
...
<Pronunciation word="Straight" uk="/stɹeɪt/" us="/stɹeɪt/" client:only />
...
<WordRelations
  synonyms={["breeder", "hetero", "straightedge"]}
  antonyms={["bent", "crooked", "curved"]}
  client:only
/>
