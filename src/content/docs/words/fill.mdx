---
title: Fill
description: Fill 是一个英语动词，中文意思可以理解为“填满”，“充满”，“填补”，等等。在日常用语中，我们可以根据语境选择最合适的解释。
sidebar:
  hidden: true
...
<Pronunciation word="Fill" uk="/fɪl/" us="/fɪl/" client:only />
...
<WordRelations
  synonyms={["dick", "knob", "swive", "pervade"]}
  antonyms={["empty"]}
  client:only
/>
