---
title: Future
description: Future 是一个英语单词，作为名词，意思是'未来'、'前程'，作为形容词，意思是'将来的'、'未来的'。
sidebar:
  hidden: true
...
<Pronunciation word="Future" uk="/ˈfjuːt͡ʃə/" us="/ˈfjuːt͡ʃɚ/" client:only />
...
<WordRelations synonyms={["toward", "unborn"]} client:only />
