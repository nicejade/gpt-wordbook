---
title: Disk
description: Disk 是名词，主要有两个基本含义：一是圆盘或圆形物体；二是指计算机硬盘或光盘。
sidebar:
  hidden: true
...
<Pronunciation word="Disk" uk="/dɪsk/" us="/dɪsk/" client:only />
...
<WordRelations synonyms={["disk", "diskette", "floppy"]} client:only />
