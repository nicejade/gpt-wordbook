---
title: Centigrade
description: Centigrade 是一个形容词，它表示的是“摄氏的”，被用来描述热量或气候，并简称为 C。例如，“Centigrade scale”表示“摄氏温度计”。
sidebar:
  hidden: true
...
"Centigrade" 是一个形容词，它表示的是“摄氏的”，被用来描述热量或气候，并简称为 C。例如，“Centigrade scale”表示“摄氏温度计”。
...
摄氏温度 (Centigrade temperature) 于 1742 年由瑞典天文学家、物理学家安德斯·塞尔修斯 (Anders Celsius) 提出，以公开的，容易复制的海平面冰点和沸点为标准，被全世界广泛的应用。

### 单词变形

Centigrade 没有名词、动词、不同时态、形容词、副词等的变形。單數和复數形式都是 centigrade。相关的固定搭配有“摄氏度温标”(centigrade scale)。
