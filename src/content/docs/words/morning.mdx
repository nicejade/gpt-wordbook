---
title: Morning
description: Morning 是一个英文名词，意为'早晨'或'上午'。此词指的是从日出或开始工作的一天的早上部分。
sidebar:
  hidden: true
...
<Pronunciation word="Morning" uk="/ˈmɔːnɪŋ/" us="/ˈmɔɹnɪŋ/" client:only />
...
<WordRelations synonyms={["forenoon", "yeender", "a.m."]} client:only />
