...
title: Champion
description: >-
  Champion主要有两个意思。一，指在竞赛中获胜的人，即冠军，例如 'He was the champion in the tennis
  match'（他是网球比赛的冠军）。二，可以形容一个极力支持或捍卫某事物的人，例如 'She is a champion of human
  rights'（她是人权的拥护者）。
sidebar:
  hidden: true
...
<Pronunciation word="Champion" uk="/ˈtʃæmpiən/" us="/ˈtʃæmpiən/" client:only />
...
"Champion"最早来源于 12 世纪的法语，原意是"战斗的骑士"，后来扩展为"冠军"或"捍卫者"的含义。在西方文化中，"champion"经常用来形容在某项运动或任务中表现优秀的人。
...
<WordRelations synonyms={["paladin"]} client:only />
