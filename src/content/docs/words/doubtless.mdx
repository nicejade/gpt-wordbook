...
title: Doubtless
description: >-
  Doubtless 是一个英文副词，表示“无疑地，肯定地”。例如，'Doubtless, he will arrive on time.'
  (毫无疑问，他会准时到达。)
sidebar:
  hidden: true
...
<Pronunciation word="Doubtless" uk="/ˈdʌʊ̯tləs/" us="/ˈdaʊ̯tləs/" client:only />
...
该词源自 Old English，其中 "doubt" 的词源是拉丁语的 "dubitare"，意为“疑虑，不确定”，后缀 "-less" 表示“没有...的”。
...
<WordRelations
  synonyms={["indisputably", "indubitably", "undoubtedly", "unquestionably"]}
  client:only
/>
