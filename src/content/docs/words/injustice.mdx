---
title: Injustice
description: Injustice是一个名词，意指公正或公平的缺失，通常被用来描述一个不公平或者不公正的行为、情况或事件。
sidebar:
  hidden: true
...
这个词语最早出现于 1300 年左右的中世纪英语，最初指的是犯法行为或者罪行。随着时间的推移，它的含义逐渐演变成今日我们所理解的“不公正”。
...
<WordRelations
  synonyms={["justicelessness", "unjustice", "wrength", "wrong"]}
  client:only
/>
