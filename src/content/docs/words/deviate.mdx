---
title: Deviate
description: Deviate是一个动词，主要含义是偏离正道，脱离或偏离某个预定的路径或方向。在数学和统计学中，它也常被用来描述从平均值或预期结果中的差异。
sidebar:
  hidden: true
...
<Pronunciation word="Deviate" uk="/ˈdiːvi.ət/" us="/ˈdiːvi.ət/" client:only />
...
"Deviate"这个词起源于 16 世纪的拉丁语，原意是"出路"，后来演变成了"偏离正道"的意思。在英语中，从一个预先确定的路径或标准偏离的行为常常被看作是贬低的或负面的，这也反映在单词“deviate”的含义和使用上。
...
想象一个场景：“偏离(de-via-te)了既定的 via 路线”。
...
<WordRelations
  synonyms={["degenerate","deviant","stray","wander"]}
  client:only
/>
