---
title: Trick
description: Trick 是一个英语单词，表示欺骗，诡计，或者技巧的意思。它可以用作名词和动词。
sidebar:
  hidden: true
...
<Pronunciation word="Trick" uk="/tɹɪk/" us="/tɹɪk/" client:only />
...
<WordRelations
  synonyms={["john","shift","illusion","artifice","con","gambit","ploy","dupe","fool","gull","have","hoodwink","mod"]}
  client:only
/>
