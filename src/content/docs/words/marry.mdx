...
title: Marry
description: >-
  Marry是一个动词，主要含义是“结婚”或“嫁”，用来表示两个人由于爱情以及在法律上的确立关系。这个词也可以作为一个宣言或祝福，比如神父在婚礼上会说'我宣布你们成为夫妻'。
sidebar:
  hidden: true
...
<Pronunciation word="Marry" uk="/ˈmæɹɪ/" us="/ˈmeɹi/" client:only />
...
<WordRelations antonyms={["divorce"]} client:only />
