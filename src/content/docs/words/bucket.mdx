---
title: Bucket
description: Bucket 是一个名词，表示'桶'，它通常用来存放或搬运液体、固体物质，比如水和沙子等。
sidebar:
  hidden: true
...
<Pronunciation word="Bucket" uk="/ˈbʌkɪt/" us="/ˈbʌkɪt/" client:only />
...
"Bucket" 这个单词的来源并不清晰，它可能来自 Old English 的 "buc"（表示 "pitcher, bulging vessel"）, 或者来自 Proto-Germanic root *buk- （表示 "to swell, to bulge"）。
...
Bucket 本身是个名词。在英语中，也可以用作动词用法，例如：bucketing down，表示"倾盆大雨"。
...
<WordRelations
  synonyms={["pail","banger","jalopy","rustbucket","blade","scoop","vane","hurtle","rocket","shoot","speed","whizz"]}
  client:only
/>
