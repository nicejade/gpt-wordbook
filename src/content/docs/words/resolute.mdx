---
title: Resolute
description: Resolute 是一个形容词，意思是坚定的、果断的，用来描述一个人在决定或行动上的坚定不移。
sidebar:
  hidden: true
...
"Resolute" 最早在 14 世纪的中古英语中出现，取自拉丁语的过去分词 "resolūtus"，意思是决心、决断的，也可以是解开的、宽松的。
...
<WordRelations antonyms={["irresolute"]} client:only />
