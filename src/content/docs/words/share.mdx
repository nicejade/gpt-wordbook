...
title: Share
description: >-
  Share主要有两种涵义：一种是作为名词，表示'一部分'或'份额'，比如在股票市场中，用来描述某个投资者手中的股份数。另一种是作为动词，表示'分享'或'分配'。
sidebar:
  hidden: true
...
<Pronunciation word="Share" uk="/ʃɛə/" us="/ʃɛəɹ/" client:only />
...
- Share 的过去式和过去分词为 shared。
- 在某些情况下，"share"可以表示"参与"，如"share in the joy"表示"参与快乐"。
- Share 的复数形式为 shares，常用于指股票市场上的股份。
