---
title: Disconnect
description: Disconnect 是一个英语动词，其基本含义是“断开，切断”，如电力、网络连接、电话线等的断开。它也广泛地用于形容人与人、人与事物之间关系的断裂。
sidebar:
  hidden: true
...
"Disconnect" 这个单词来源于拉丁语 "dis-" 和 "connectere"，在英语中首次出现在 14 世纪，随着电力和通讯技术的发展，这个单词的使用也变得越来越广泛。
...
<WordRelations synonyms={["disconnector"]} antonyms={["connect"]} client:only />
