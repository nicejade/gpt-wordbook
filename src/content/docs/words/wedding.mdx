...
title: Wedding
description: >-
  Wedding 是一个名词，用来指一个结婚仪式，以及和结婚仪式有关的各种活动。该词源自古英语的
  'wedding'，意为'资助'或'誓言'，表示新郎对新娘的承诺。
sidebar:
  hidden: true
...
<Pronunciation word="Wedding" uk="/ˈwɛdɪŋ/" us="/ˈwɛdɪŋ/" client:only />
...
<WordRelations synonyms={["marry"]} client:only />
