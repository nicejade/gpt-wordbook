...
description: >-
  Identity
  是一个英语名词，用来表示个体或团体的本质特征或特性，这些特性让他们有别于其他个体或团体。这可以是一个人的人格特点，种族或文化特性，或是一个组织的宗旨。
sidebar:
  hidden: true
...
<Pronunciation word="Identity" uk="/aɪˈdɛntəti/" us="/aɪˈdɛntəti/" client:only />
...
"Identity"这个词在 16 世纪时首次出现在英语中，最初只有数学和法律的意义，用于指示完全同一的事物。而身份概念的现代意义，作为个体或团体的特性或特征，是从 20 世纪中期开始的。
...
在一个完美克隆的世界里，Bob 因为他对艺术的热爱而能保持他的身份（identity）。

<WordRelations
  synonyms={["individuality","selfhood","celebrity","personality"]}
  client:only
/>
