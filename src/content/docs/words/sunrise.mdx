---
title: Sunrise
description: Sunrise 是一个英语单词，表示“日出”或“黎明”，是 sun（太阳）和 rise（上升）两个单词的组合，直译就是太阳上升。
sidebar:
  hidden: true
...
"Sunrise" 是一个英语单词，表示“日出”或“黎明”，是 sun（太阳）和 rise（上升）两个单词的组合，直译就是太阳上升。

<Pronunciation word="Sunrise" uk="/ˈsʌnɹaɪz/" us="/ˈsʌnɹaɪz/" client:only />
...
<WordRelations synonyms={["dawn", "sunup"]} antonyms={["sunset"]} client:only />
