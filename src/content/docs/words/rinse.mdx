---
title: Rinse
description: Rinse是一个英文动词，意为“清洗”，“冲洗”。常用于指在清洗面部、头发、衣物或者餐具等物品后，用水将清洁剂冲掉的动作。
sidebar:
  hidden: true
...
<Pronunciation word="Rinse" uk="/ɹɛns/" us="/ɹɛns/" client:only />
...
<WordRelations synonyms={["lavatory", "wash"]} client:only />
