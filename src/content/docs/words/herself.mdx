---
title: Herself
description: Herself 是一个反身代词，通常用来强调主语，或者表示某一动作的主体与接受者为同一人。
sidebar:
  hidden: true
...
Herself 是一个反身代词，通常用来强调主语，或者表示某一动作的主体与接受者为同一人。

<Pronunciation word="Herself" uk="/hɜːˈsɛlf/" us="/hɝˈsɛlf/" client:only />
