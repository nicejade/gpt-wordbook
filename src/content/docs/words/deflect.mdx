...
description: >-
  Deflect
  是一个英语动词，它的基本含义是“偏离正道，转向”。当某事物被物理力量（例如击打或者推动）使其偏离其初始的或者预定的路径时，就可以使用这个词。此外，它也可以指使某事物（通常是需要面对的问题或者批评）偏离其目标或者焦点。
  比如： 1. The bullet was deflected by his helmet. "他的头盔抵挡住了子弹的直线飞行。" 2. She
  deflected the criticism by changing the subject. "她通过改变话题来使批评偏离焦点。"
sidebar:
  hidden: true
...
此单词源于拉丁语'deflectere'，最早在 15 世纪时开始在英语中使用。随着时间的推移，它的使用越来越广泛，不仅用于描述物理对象的路径改变，也用于形象地描述注意力、观点或责任的转移。
