---
title: Discourage
description: "- 'Discourage' 是一个动词，表示'使沮丧'，'使失去信心或兴趣'。"
sidebar:
  hidden: true
...
- "Discourage"的历史源于 14 世纪，最早在法语中出现，它是由"des-"（表示否定）和"corage"（表示"勇气、决心"）两词结合而来。
...
<WordRelations
  synonyms={["cowardliness", "becourage", "deter", "dissuade"]}
  antonyms={["encourage"]}
  client:only
/>
