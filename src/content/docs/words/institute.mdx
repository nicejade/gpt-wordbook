...
title: Institute
description: >-
  Institute 主要有两个基本含义。第一个意思是 '创建，设立' 比如设立一个新的法规。第二个常见的意思是
  '机构或组织'，尤其是一些进行特定工作的组织，比如研究所或者教育机构。
sidebar:
  hidden: true
...
"Institute" 这个词在 14 世纪开始使用，连续几个世纪它一直代表着"组织结构" 和 "宪章" 的含义。然后在 18 世纪，它开始被广泛用于指代建立或设立某个机构，如学术机构或教育机构。
