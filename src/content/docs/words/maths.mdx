---
title: Maths
description: Maths是英式英语中'Mathematics'的简称，我们常常用它来指代'数学'。它包括了代数，几何，概率，统计等多个分支学科。
sidebar:
  hidden: true
...
<Pronunciation word="Maths" uk="/mæθs/" us="/mæθs/" client:only />
...
1.  将单词 maths 与学校里的数学课程联系起来，将数学想象成一种语言，而这种语言的名字就是 maths。
