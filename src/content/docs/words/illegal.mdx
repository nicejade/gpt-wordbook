...
title: Illegal
description: >-
  illegal是一个形容词，它指的是违反法律、规定或者规则的行为或者事物。在法律术语中，'illegal'通常指违反刑法的行为。相较于'unlawful'（违法的），'illegal'的犯罪指向更强烈一些。
sidebar:
  hidden: true
...
<Pronunciation word="Illegal" uk="/ɪˈliːɡəl/" us="/ɪˈliːɡəl/" client:only />
...
"illegal"这个词在英文中首次出现是在 16 世纪，最初的用途是形容不符合教会规定的行为。随着时间的演变，它的涵义逐渐扩展到现在我们常说的违反国家法律的行为。
...
<WordRelations
  synonyms={["criminal","felonious","illicit","irregular","unlawful","bogus"]}
