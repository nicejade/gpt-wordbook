---
title: Selfish
description: Selfish 是一个形容词，主要的含义是“自私的”，用于形容那些过于在意自己的利益而忽视他人的人。
sidebar:
  hidden: true
...
<Pronunciation word="Selfish" uk="/ˈsɛlfɪʃ/" us="/ˈsɛlfɪʃ/" client:only />
...
Selfish 这个单词的词根是 Self，起源于老英语的 sēoƒ 这个单词，意为独自的，个体的。像 Selfless（无私的），Self-esteem（自尊）等词也是这个词根衍生。
...
<WordRelations
  synonyms={["egoistic","egotistic","egotistical","greedy"]}
  antonyms={["altruistic","philanthropic","selfless","unselfish"]}
  client:only
/>
