---
title: Labour
description: Labour是英式英语中的一个词，美式英语中等同的词是'labor'，通常有以下几种意思：
sidebar:
  hidden: true
...
<Pronunciation word="Labour" uk="/ˈleɪ.bə/" us="/ˈleɪ.bɚ/" client:only />

### 列举例句

1.  The fishermen were saved after labouring for hours in the stormy sea.（渔民们在暴风雨的海中艰难地挣扎了几个小时后被救出。）
2.  Labour and materials amount to 50% of the total cost.（劳动力和材料总共占总成本的 50%。）
...
此词始于 13 世纪的法语 "labour"，在那时代，意指"付出艰辛的努力"。到了 14 世纪，它又赋予了 "艰难的孕产" 的意思。
...
<WordRelations synonyms={["swink", "toil", "work"]} client:only />
