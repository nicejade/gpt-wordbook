---
title: Glory
description: Glory 通常被翻译为'荣耀'，它常常指人或群体因特别的、优秀的原因而受人提起或庆祝。
sidebar:
  hidden: true
...
<Pronunciation word="Glory" uk="/ˈɡlo(ː)ɹi/" us="/ˈɡlo(ː)ɹi/" client:only />
...
<WordRelations
  synonyms={["halo","fame","honor","honour","praise","worship"]}
  client:only
/>
