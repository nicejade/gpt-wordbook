...
title: Fluorescent
description: >-
  Fluorescent 是形容词，来源于名词
  'fluorescence'，指的是发出荧光的，具有荧光特性的。它主要用来描述一个物体或材料能够发出一种特殊的光，可以在黑暗或特殊照射之下可见。
sidebar:
  hidden: true
...
"Fluorescence" 一词最初在 1852 年由英国科学家 George Gabriel Stokes 提出，他在研究某种矿石时发现它能发出非常特别的光，并将这种现象命名为 “fluorescence”。
