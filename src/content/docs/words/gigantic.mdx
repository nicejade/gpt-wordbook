...
title: Gigantic
description: >-
  Gigantic 这个单词是形容词，表示极大的, 巨大的。例如，我们可以说一座' gigantic mountain' (巨大的山脉), 或者 a
  'gigantic elephant' (庞大的大象)。
sidebar:
  hidden: true
...
"Gigantic" 这个单词是形容词，表示极大的, 巨大的。例如，我们可以说一座" gigantic mountain" (巨大的山脉), 或者 a "gigantic elephant" (庞大的大象)。
...
<WordRelations synonyms={["gigantesque"]} client:only />
