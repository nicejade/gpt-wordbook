...
description: >-
  Runner 是一个英语单词，意为
  '跑步者'，通常是指参与各种跑步活动（比如马拉松）的人。此外，它也有其他不同的含义，例如在体育比赛中传递信息或物品的人，或者在餐馆中作为服务员，为顾客端餐的人。
sidebar:
  hidden: true
...
<Pronunciation word="Runner" uk="/ˈɹʌnə/" us="/ˈɹʌnə/" client:only />
...
<WordRelations
  synonyms={["execute","start","tread","ladder","extender","sneaker","trainer"]}
  antonyms={["rise","riser"]}
  client:only
/>
