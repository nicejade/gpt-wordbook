---
title: Prominent
description: Prominent 是形容词，主要有两个主要的含义：
sidebar:
  hidden: true
...
<Pronunciation word="Prominent" uk="/ˈpɹɒmɪnənt/" us="/ˈpɹɑmɪnənt/" client:only />
...
"Prominent"来自于拉丁语"promineo"，即“突出”。该词从 16 世纪后开始逐渐普及。
...
<WordRelations
  synonyms={["flashy","eminent","forestanding","noteworthy","extuberant","outstanding"]}
  client:only
/>
