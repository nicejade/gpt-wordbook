---
title: Logical
description: Logical 是一个形容词，中文意思是“符合逻辑的”，用来描述事物或思维过程按照逻辑规则进行的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Logical" uk="/ˈlɒdʒɪkəɫ/" us="/ˈlɑdʒɪkəɫ/" client:only />
...
<WordRelations antonyms={["illogical"]} client:only />
