---
title: Comprehensive
description: Comprehensive是一个形容词，源自拉丁语，意思是“包括所有的，全面的，详尽无遗的”。这个词可以用来形容一些广泛覆盖许多方面或者详情的事情。
sidebar:
  hidden: true
...
<Pronunciation word="Comprehensive" uk="/ˌkɒm.pɹɪˈhɛn.sɪv/" us="/ˌkɑːm.pɹəˈhɛn.sɪv/" client:only />
...
从 16 世纪开始，这个词语作为英语的一部分从法语借用，最初的含义是“理解”，后来逐渐发展出“广泛的，包括许多方面的”的含义。
