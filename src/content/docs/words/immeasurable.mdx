---
title: Immeasurable
description: Immeasurable 是一个形容词，被用来描述不可测量的，无法估量的，或深远无边的事物。它无法通过普通的估计方式比如数量、规模或个数来测量。
sidebar:
  hidden: true
...
Immeasurable 的前缀是“im-”，表示否定， “measur-” 是词根，“-able” 是后缀，表示“能...的”。
...
<WordRelations
  synonyms={["immensurable", "unmeasurable"]}
  antonyms={["measurable"]}
  client:only
/>
