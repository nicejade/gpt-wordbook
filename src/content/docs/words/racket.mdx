---
title: Racket
description: Racket在英语中有两个主要含义：一种体育器材，即我们常说的球拍，如网球拍、羽毛球拍等；另外一个含义则是指吵闹声、喧哗声。
sidebar:
  hidden: true
...
<Pronunciation word="Racket" uk="/ˈɹækɪt/" us="/ˈɹækɪt/" client:only />
...
<WordRelations synonyms={["bat", "paddle", "racquet"]} client:only />
