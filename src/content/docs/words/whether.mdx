...
title: Whether
description: >-
  Whether 是一个连词，常常用于引导宾语从句或状语从句，表示“是否”。它常常引导的句子表述选择或者选项。例如，“I don't know whether
  he will come or not.” 我不知道他是否会来。
sidebar:
  hidden: true
...
<Pronunciation word="Whether" uk="/ˈwɛðə(ɹ)/" us="/ˈwɛðə(ɹ)/" client:only />
...
"Whether" 源自古英语的 "hwæther"，用于提问和无关的选择。古英语的 "hwæther" 和 "hwer" (现代英语的 where)有相同的起源，都源自古日耳曼语的相应词汇。
