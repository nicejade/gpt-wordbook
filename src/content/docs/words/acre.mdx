---
title: Acre
description: Acre 是一个表示面积的单位，常用在英美国家，尤其用于测量土地。1 英亩约等于 4046.86 平方米。
sidebar:
  hidden: true
...
"Acre" 是一个表示面积的单位，常用在英美国家，尤其用于测量土地。1 英亩约等于 4046.86 平方米。

<Pronunciation word="Acre" uk="/ˈeɪ.kə/" us="/ˈeɪ.kɚ/" client:only />

### 列举例句

1.  My dream is to own an acre of land in the countryside. （我梦想在乡下拥有一英亩的土地。）
2.  The park covers an area of 300 acres.（这个公园占地 300 英亩。）
3.  He bought a two-hundred-acre farm.（他买了一个 200 英亩的农场。）
...
<WordRelations
  synonyms={["morgen","feddan","arpen","arpent","pose","bigha","cawney","cawny","collop","juger","jugerum","acair","cover","cyfair"]}
  client:only
/>
