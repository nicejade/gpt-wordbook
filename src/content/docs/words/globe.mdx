---
title: Globe
description: Globe是一个英语名词，常指地球仪，也可以指世界、地球。
sidebar:
  hidden: true
...
<Pronunciation word="Globe" uk="/ɡloːb/" us="/ɡloːb/" client:only />
...
"Globe"一词的使用可以追溯到 14 世纪，最早来自拉丁文的"globo"，意为球状的物体。
...
<WordRelations synonyms={["Earth", "Terra", "world"]} client:only />
