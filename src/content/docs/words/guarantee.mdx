---
title: Guarantee
description: Guarantee 是一个英语单词，作为名词时作'保证，保障' 解，作为动词时是'保证，担保'的意思。
sidebar:
  hidden: true
...
"Guarantee" 源于 12 世纪的法语“garantir”，意为保护、保证。然后通过中古英语文化，演化成为 "guarantee"。
...
<WordRelations synonyms={["assure", "warrant"]} client:only />
