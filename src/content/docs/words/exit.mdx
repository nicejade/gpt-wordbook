---
title: Exit
description: Exit 是一个名词和动词。作为名词，它表示出口或者离开的地方。作为动词，它表示离开或者退出。
sidebar:
  hidden: true
...
<Pronunciation word="Exit" uk="/ˈɛksɪt/" us="/ˈɛksət/" client:only />

### 列举例句

1.  The exit is at the end of the hallway. (出口在走廊的尽头。)
2.  Her abrupt exit left us in surprise. (她突然离开让我们很惊讶。)
3.  Please exit the building before 6 pm. (请在 6 点前离开大楼。)
...
"Exit" 的词源可以追溯到 14 世纪的拉丁语，主要在欧美文化中用于表示场所的出口或者人的离去。
...
<WordRelations
  synonyms={["outgoing"]}
  antonyms={["entrance","entry","arrive","come","enter"]}
  client:only
/>
