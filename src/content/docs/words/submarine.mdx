---
title: Submarine
description: Submarine 是一个英语名词，意为 '潜艇'。它还有一个比较口语的含义，指一个类型的长形三明治，因其形状像潜艇。
sidebar:
  hidden: true
...
<Pronunciation word="Submarine" uk="/sʌb.məˈɹiːn/" us="/sʌb.məˈɹiːn/" client:only />
...
'Submarine' 这个词最早在 18 世纪开始使用，用来指代 '在水下的'。随着科技的发展，'submarine' 这个词被用来形容那些可以在水下行动的船只，即我们现在所说的潜艇。
...
<WordRelations
  synonyms={["sub","grinder","hero","hoagie","hoagy","torpedo","wedge"]}
  client:only
/>
