---
title: catastrophe
description: Catastrophe 是一个名词，指的是一种重大的灾难或者意外事故，特别是那些导致很多人受伤、或者大量财产损失的事件。
sidebar:
  hidden: true
...
Catastrophe 的词根是来自于古希腊语 "katastrophe"， "kata-", 表示"向下"的意思， "strophe" 表示"转动"的意思。也就是类似"翻转"或者"彻底更改"的含义，指代某种重大的、负面的变化。
