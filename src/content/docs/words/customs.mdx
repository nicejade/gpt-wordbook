---
title: Customs
description: Customs 通常有两种基本意思。一是表示海关，这个场所对进出国家的商品和行李进行检查。另一种意思是习俗，指的是特定社团或社会总体上的传统行为或习惯。
sidebar:
  hidden: true
...
<Pronunciation word="Customs" uk="/ˈkʌstəmz/" us="/ˈkʌstəmz/" client:only />
...
"Customs" 的词根来自拉丁语"consuetudo",意思是"habit or usage",这个词源于"consuescere"，表示"accustomed to".由此衍生出来的单词有：accustom、customary、customization 等。
...
"Customs" 对应的"习俗"意义在中世纪拉丁语中逐渐发展出来，当时用来指的是长期存在的习俗或规矩；海关的含义则在英语中于 15 世纪形成。
