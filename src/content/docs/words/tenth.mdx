---
title: Tenth
description: tenth是一个基础的英语单词，用于表示序数的“第十”。这是一个形容词，但在某些情况下，也可以作为名词使用，例如在表示“十分之一”的情况下。
sidebar:
  hidden: true
...
<Pronunciation word="Tenth" uk="/tɛnθ/" us="/tɛnθ/" client:only />
...
你可以通过记住数字 10 及其基本格式“ten”，然后加上后缀"-th"来帮助记忆这个单词。
