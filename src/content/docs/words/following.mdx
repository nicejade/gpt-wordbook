...
description: >-
  Following'
  是英语里的单词，可以用作形容词、名词或者副词，用作形容词时表示'下一个的、接下来的'；用作名词表示'流行、追随者'，指那些对某人或某事物有热情的人；用作副词时表示'将来、以后
sidebar:
  hidden: true
...
<Pronunciation word="Following" uk="/ˈfɒləʊɪŋ/" us="/ˈfɑloʊɪŋ/" client:only />
...
<WordRelations
  synonyms={["ensue","pursue","tail","trail","succeed","succeeding"]}
  antonyms={["guide","lead","precede","preceding"]}
  client:only
/>
