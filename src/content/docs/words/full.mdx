...
title: Full
description: >-
  Full 是一个形容词，用于描述某物是完全的或充满的。它表示没有更多的空间或容量。例如，当你说 'The bottle is full of
  water'，你表示瓶子里没有更多的空间可以容纳更多的水。
sidebar:
  hidden: true
...
<Pronunciation word="Full" uk="/fʊl/" us="/fʊl/" client:only />
...
<WordRelations
  synonyms={["complete","thorough","abounding","brimful","bursting","jammed","laden","loaded","overflowing","packed","rammed","stuffed","baggy","big","large"]}
  antonyms={["incomplete","empty","small","tight","hungry","starving","partial"]}
  client:only
/>
