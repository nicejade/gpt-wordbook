---
title: Independent
description: Independent 是一个英语单词，用作形容词，指的是自由自在，不受别人控制，有能力自己思考，做事和做出决定的意思。例如：“他以独立的思考方式而著名”。
sidebar:
  hidden: true
...
词源自 16 世纪的拉丁语 independent（不取决于），它经常被用作赞扬人独立思考，有自己的主见，并能自由自在的生活。
...
<WordRelations
  synonyms={["autonomous", "free", "selfstanding"]}
  antonyms={["contingent", "dependent"]}
  client:only
/>
