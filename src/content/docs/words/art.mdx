...
title: Art
description: >-
  Art 是表达创造性或想象力的应用的通用术语，通常用于创造像绘画、雕塑、音乐、舞蹈等可视或听觉形式的作品。'Art' 也可以表示熟练或熟知 (an art
  of doing something)。
sidebar:
  hidden: true
...
<Pronunciation word="Art" uk="/ɑːt/" us="/ɑɹt/" client:only />
...
<WordRelations
  synonyms={["craft"]}
  antonyms={["mundacity", "nature", "subsistence"]}
  client:only
/>
