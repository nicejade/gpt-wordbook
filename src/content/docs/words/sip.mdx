---
title: Sip
description: "Sip 是一个常见的英语动词, 它的意思是“小口喝”或者“抿”。这个词通常用于描述当我们慢慢地、享受地、或者小口地喝东西的时候。"
sidebar:
  hidden: true
...
<Pronunciation word="Sip" uk="/sɪp/" us="/sɪp/" client:only />
...
<WordRelations synonyms={["leak", "nurse"]} client:only />
