---
title: End
description: End 是一个英文单词，既可以做动词也可以做名词。作为名词，它的基本意思是 '结束' 或者 '终点'。作为动词，它表示 '结束' 或者 '使…结束'。
sidebar:
  hidden: true
...
<Pronunciation word="End" uk="/ɛnd/" us="/ɛnd/" client:only />
...
翻译：这个男孩走到了街道的尽头，发现了一只流浪狗。他决定把它带回家，并给它起名叫 Endy。

<WordRelations
  synonyms={["conclusion", "limit", "termination", "terminus"]}
