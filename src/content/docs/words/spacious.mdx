...
description: >-
  Spacious
  是形容词，用于描述一个地方面积大，空间广阔或开阔的。你也可以用它来描述非实物的东西，比如时间或机会都可以被形容为'spacious'，表示宽裕或丰富。
sidebar:
  hidden: true
...
<Pronunciation word="Spacious" uk="/ˈspeɪʃəs/" us="/ˈspeɪʃəs/" client:only />
...
"Spacious" 这个词来自于 14 世纪的英语，首先被用来描述一个地方宽阔或大的。随着时间的推移，它的使用逐渐扩展到了描述间隔，距离等抽象概念。
