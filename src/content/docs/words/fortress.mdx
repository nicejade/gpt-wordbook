...
description: >-
  Fortress
  这个单词来自于拉丁语，意思是“坚固的保护”，在英文中，它常常指代一个具有防守之用的军事建筑，像城堡，要塞之类的。一般来说，这个单词暗示了强大、坚固和安全。
sidebar:
  hidden: true
...
<Pronunciation word="Fortress" uk="/ˈfɔː.tɹəs/" us="/ˈfɔɹ.tɹəs/" client:only />
...
该单词源于 13 世纪的法语 "forteresse"，直接翻译为“具有防守能力的建筑”。这个词再追溯到拉丁语中的 “fortis” (强壮的)和 “arcere” （保护）。
...
<WordRelations synonyms={["bastion", "bulwark", "stronghold"]} client:only />
