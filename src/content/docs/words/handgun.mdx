---
title: Handgun
description: Handgun是一个英文名词，意思是“手枪”。它是一种轻便的，可以用一只手操作的火器，通常用于自卫或狩狌。
sidebar:
  hidden: true
...
单词 "handgun" 最早在 14 世纪的英文中出现，当时主要指的是可由单手使用的火器。其发展与火器的演变有关，特别是自第二次工业革命以来，随着科技的发展，手枪的形态和性能有了很大的改变。
...
曾经，在荒野的西部，有一个叫 Johnny 的牛仔，他从来不会在没有他信任的手枪的情况下离开家门。他说，这并不是要制造麻烦，而只是为了保护自己免受危险。

<WordRelations synonyms={["pistol"]} client:only />
