---
title: Vary
description: Vary 是一个动词，有两个主要含义：
sidebar:
  hidden: true
...
<Pronunciation word="Vary" uk="/ˈvɛəɹi/" us="/ˈvæɹi/" client:only />
...
Vary 一词源自 14 世纪的"varien"，进一步追溯可到达拉丁文的变形词“variare”，意为变化，使有所不同，以及差异。
...
<WordRelations
  synonyms={["dissent", "alter", "change", "fluctuate"]}
  client:only
/>
