---
title: Cheat
description: Cheat是一个动词，意思是欺骗，作弊，它也可以用作名词，指的是欺骗行为本身或行骗的人。
sidebar:
  hidden: true
...
<Pronunciation word="Cheat" uk="/tʃiːt/" us="/tʃiːt/" client:only />
...
"Cheat"没有涉及到显而易见的词缀。它是一个以-eat 结尾的动词，类似的单词有 treat（处理，对待）
...
<WordRelations synonyms={["belirt", "blench", "lirt"]} client:only />
