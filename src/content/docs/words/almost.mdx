---
title: Almost
description: Almost 是一个副词，表示'几乎'，'差不多' 或 '接近' 的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Almost" uk="/ɔːl.ˈməʊst/" us="/ˈɑl.moʊst/" client:only />
...
<WordRelations
  synonyms={["near", "nearly", "nigh", "not", "practically", "virtually"]}
  client:only
/>
