...
title: Leaflet
description: >-
  Leaflet 实际上有两种不同的意思：第一种是 '一张（通常为宣传或广告的）小叶状印刷品'，它类似于一张小的海报或宣传册，通常用于广告或信息传播。第二种是
  '（尤指植物的）小叶'，它用来描述植物或类似物体的小部分。
sidebar:
  hidden: true
...
<Pronunciation word="Leaflet" uk="/ˈliːflɪt/" us="/ˈliːflɪt/" client:only />
...
"Leaflet" 这个词起源于 16 世纪的英格兰，最初是用来描述小叶或片状的东西。至 19 世纪，它开始用来描述小册子或广告传单，因为这些物品的形状和小叶或小片相似。
...
<WordRelations
  synonyms={["flier", "flyer", "folder", "handbill", "pamphlet", "leafling"]}
  client:only
/>
