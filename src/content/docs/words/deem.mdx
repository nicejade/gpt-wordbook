...
title: Deem
description: >-
  Deem 是一个动词，意思是'认为，视为'。这个单词通常在正式场合或书面语中使用，用于表示作者或说话人对某件事情的看法、判断或考虑。'Deem'
  是一个过去式和过去分词同形的动词。
sidebar:
  hidden: true
...
<Pronunciation word="Deem" uk="/diːm/" us="/diːm/" client:only />
...
<WordRelations synonyms={["consider", "judge"]} client:only />
