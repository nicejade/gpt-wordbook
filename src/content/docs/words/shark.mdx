---
title: Shark
description: Shark 是英语中的一类鱼类的名称，一般指的是鲨鱼。在一些情境中，'shark'也可用来形容狡猾或贪婪的人。
sidebar:
  hidden: true
...
Shark 是英语中的一类鱼类的名称，一般指的是鲨鱼。在一些情境中，"shark"也可用来形容狡猾或贪婪的人。

<Pronunciation word="Shark" uk="/ʃɑːk/" us="/ʃɑɹk/" client:only />
...
Shark 的词根来自于德语词汇“schurke”，意为恶棍、坏蛋，以形容鲨鱼的凶猛。
...
"shark"这个词在英语中最早出现在 1569 年。它早期的意思被认为是狡猾、贪婪的人，后来用来表示一种海洋生物。

### 单词变形

Shark generally 作为名词使用，没有特别的变形。多个 shark 则用复数形式 sharks 表示。
