...
title: Pedestrian
description: >-
  Pedestrian这个单词在英文里主要有两个常见含义。首先，它是名词，表示步行的人、行人。其次，'pedestrian'也可以用作形容词，形象地描述一些平凡、普通、乏味无趣的事物。
sidebar:
  hidden: true
...
在 18 世纪末，“pedestrian”只代表步行者的意思。然而，到了 19 世纪 60 年代，这个词的形容词意思——“乏味的、平凡的”逐渐流行起来。
...
<WordRelations
  synonyms={["footer", "footfarer", "footgoer", "footman"]}
  client:only
/>
