...
title: Bunch
description: >-
  bunch 是一个英文名词，最常见的含义是“一束，一堆，一群”，通常用在许多事物聚在一起的场景。比如说，我们可以说 'a bunch of
  flowers'（一束花），'a bunch of people'（一群人）。
sidebar:
  hidden: true
...
<Pronunciation word="Bunch" uk="/ˈbʌntʃ/" us="/ˈbʌntʃ/" client:only />
...
"bunch" 的确切来源未知，但最早在 14 世纪的英格兰文献中出现，用于描述捆绑或捆扎在一起的事物。
...
<WordRelations
  synonyms={["cluster","group","circle","gang","pack","kidney","nest","pocket"]}
  client:only
/>
