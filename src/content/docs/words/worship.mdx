---
title: Worship
description: Worship 是一个动词，表示对神或者神圣事物的尊重和崇拜。例如在一个教堂，或者寺庙中礼拜，或者崇拜一个人。它也可以作为名词使用，表示崇拜或者敬仰的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Worship" uk="/ˈwɜːʃɪp/" us="/ˈwɝʃɪp/" client:only />
...
<WordRelations synonyms={["adoration", "idolatry", "reverence"]} client:only />
