---
title: Revive
description: Revive是一个动词，源自拉丁语“revivere”，意即'活过来，苏醒'。它具有多种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Revive" uk="/ɹɪˈvaɪv/" us="/ɹɪˈvaɪv/" client:only />
...
拉丁语“revivere”在 14 世纪进入英语，并在文艺复兴时期成为标准词汇，用来描述艺术和文化的复兴。
...
<WordRelations synonyms={["rediscover", "renew", "resurrect"]} client:only />
