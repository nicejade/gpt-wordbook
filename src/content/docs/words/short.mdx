...
title: Short
description: >-
  Short是一个形容词，主要有两个含义：1) 相对于长度来说比较短小的，如 'short hair'（短发）；2) 时间或距离上比较短暂的，如 'short
  break'（短暂休息）。
sidebar:
  hidden: true
...
<Pronunciation word="Short" uk="/ʃɔːt/" us="/ʃɔɹt/" client:only />
...
<WordRelations
  synonyms={["abbreviation","low","narrow","shallow","slim","brief","concise","little","petite","titchy","lacking","on","short"]}
  antonyms={["long","broad","deep","high","tall","wide"]}
  client:only
/>
