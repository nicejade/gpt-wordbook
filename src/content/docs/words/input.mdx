...
description: >-
  Input 是一个英语单词，主要意思是
  '输入'。当它作为名词时，主要指的是提供给某个系统（比如电脑系统）以进行处理或操作的数据或信息。当它作为动词时，主要表示将数据或信息输入某个系统。
sidebar:
  hidden: true
...
<Pronunciation word="Input" uk="/ˈɪnpʊt/" us="/ˈɪnpʊt/" client:only />
...
"Input" 这个词是在计算机科学开始发展的 20 世纪才广泛使用起来的。随着计算机和其他科技产品的普及，这个词也在全世界范围内被广泛理解和接受。
