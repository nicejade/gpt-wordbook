...
title: Collision
description: >-
  Collision是一个名词，主要用来描述两个或更多物体之间突然且剧烈的接触。这种接触通常是非中策划的，结果可能会导致损坏或破坏。在物理学中，'collision'是两个物体相互作用的过程。
sidebar:
  hidden: true
...
<Pronunciation word="Collision" uk="/kəˈlɪʒən/" us="/kəˈlɪʒən/" client:only />
