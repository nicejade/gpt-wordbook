...
description: >-
  ...
  "exposed"。 2. 此外，"bare" 也可以形容一个表面，没有覆盖物，例如，a bare wall (一面光板的墙)。它的含义近似于
  "uncovered" 或 "empty"。 3. 最后，"bare" 也被用以形容只含有最基本或必要的元素，例如 bare facts
  (基本事实)。在这种情况下，它的含义近似于 "basic" 或 "minimum"。
sidebar:
  hidden: true
