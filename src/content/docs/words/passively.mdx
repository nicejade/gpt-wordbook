...
title: Passively
description: >-
  Passively 是副词，其基础词是动词 'passive'，表示一种状态或行为方式，意思是“被动地，消极地。”例如，在句子 'He was
  passively accepting the decision.' 中（他被动地接受了决定），'passively'
  描述了主语对决定接受的方式是消极的，未表明抵抗状况。
sidebar:
  hidden: true
...
将 Passively 与相似的副词如 actively 进行比较，可以帮助记忆。

### 助记故事

"John passively sat in his office, unaware of the chaos outside."(约翰被动地坐在办公室里，不知道外面的混乱。)

"John 在他的办公室里消极地坐着，对外面正在发生的混乱一无所知。"

<WordRelations
  synonyms={["automatically", "mindlessly", "resignedly", "submissively"]}
  client:only
/>
