...
title: Multitude
description: >-
  Multitude这个英文单词是一个名词，表示大量、众多或大群。它通常用于表示数量从几十到数百，甚至数千的人或物。例如：A multitude of
...
<Pronunciation word="Multitude" uk="/ˈmʌltɪtjuːd/" us="/ˈməl-/" client:only />
...
Multitude 这个词源自拉丁语的"multitudinem"，其词根"multi-"表示"多的"。
...
Multitude 这个单词起源于 14 世纪的法语 multitude，它含有“显著数量”的含义。它最早的来源是拉丁语 multitudo，其涵义包括“巨大的数量”和“众多”。在西方文化中，multitude 常常用于描述在公共场合聚集的大量人群。

### 单词变形

因为 multitude 是名词，此外它在使用上没有特别的变形。
...
<WordRelations synonyms={["crowd"]} client:only />
