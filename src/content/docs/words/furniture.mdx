---
title: Furniture
description: Furniture是一个名词，指的是居家或办公室的装饰物品，如桌子，椅子，床，沙发等。
sidebar:
  hidden: true
...
<Pronunciation word="Furniture" uk="/ˈfɜːnɪtʃə/" us="/ˈfɝnɪtʃɚ/" client:only />
...
在英语中，"furniture"一词的早期含义指的是必需的设备或供应。现在，我们通常用它来指代家具，这个词最早于 15 世纪在英国开始使用。
