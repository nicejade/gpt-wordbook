...
title: Optical
description: >-
  Optical 是一个形容词，直接翻译为“光的，视觉的”，主要用于描述与光或视觉有关的事物。例如：optical
  illusions（视觉错觉），optical fibers（光纤）。或者， 'optical' 也可以用在矫正视力的上下文中，比如 'optical
  lenses'（眼镜镜片）。
sidebar:
  hidden: true
...
<Pronunciation word="Optical" uk="/ˈɒptɪkəl/" us="/ˈɒptɪkəl/" client:only />
...
"Optical"一词源自 17 世纪的拉丁文"opticus"和希腊文"optikos"。在欧美文化中，这个词通常用于与光学和视觉相关的科研领域。
