---
title: Reveal
description: "- 'Reveal' 是一个动词，意为揭示，揭露，展示。比如，reveal a secret（揭露一个秘密），reveal the truth（揭示真相）。"
sidebar:
  hidden: true
...
<Pronunciation word="Reveal" uk="/ɹəˈviːl/" us="/ɹəˈviːl/" client:only />
...
- 词根 veil 来自拉丁语"velum", 意为面纱, 帷幕. 取其隐蔽的意义.
...
<WordRelations
  synonyms={["jamb","revel","disclose","uncover","unfold"]}
  client:only
/>
