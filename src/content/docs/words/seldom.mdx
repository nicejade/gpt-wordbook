---
title: Seldom
description: Seldom是一个副词，表示“很少”，“不常”，用于描述一件事情发生的频率非常低。
sidebar:
  hidden: true
...
<Pronunciation word="Seldom" uk="/ˈsɛldəm/" us="/ˈsɛldəm/" client:only />
...
<WordRelations
  synonyms={["uncommon","barely","hardly","infrequently","rarely","scarcely"]}
