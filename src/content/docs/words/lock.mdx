---
title: Lock
description: Lock 在英语中主要有两种含义。第一种是锁，一种装置通常用来保护某些物体、空间或容器。第二种是动词意义，表示将某事物封锁或固定。
sidebar:
  hidden: true
...
<Pronunciation word="Lock" uk="/lɒk/" us="/lɑk/" client:only />
...
<WordRelations antonyms={["unlock"]} client:only />
