---
title: Cripple
description: Cripple 是一个名词和动词。作为名词，它表示身体有严重残疾，活动严重受限的人。作为动词，它意味着使某人或某物功能严重受损或者损坏。
sidebar:
  hidden: true
...
<Pronunciation word="Cripple" uk="/ˈkɹɪpl/" us="/ˈkɹɪpl/" client:only />
...
<WordRelations synonyms={["disabled", "limit", "restrict"]} client:only />
