---
title: Duration
description: Duration 是一个名词，表示 '持续的时间' 或 '期限'。
sidebar:
  hidden: true
...
<Pronunciation word="Duration" uk="/djʊˈɹeɪʃn̩/" us="/djəˈɹeɪʃn̩/" client:only />
...
"Duration" 这个词在 14 世纪时从拉丁文引入英文，来源于 "durare"，意为 "持续、坚持、耐久"。
