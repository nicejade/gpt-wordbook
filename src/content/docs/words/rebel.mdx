---
title: Rebel
description: Rebel 可以作为动词或名词使用。作为名词，'rebel' 指的是反叛者，对抗权威或传统的人。作为动词，则表示反叛，反对。
sidebar:
  hidden: true
...
<Pronunciation word="Rebel" uk="/ˈɹɛbəl/" us="/ˈɹɛbəl/" client:only />
...
"Rebel"没有词缀，但是涉及到反义词的情况下，我们会使用“-non”前缀，例如非反叛者`nonrebel`。

### 文化背景

"Rebel"这个词在 14 世纪通过法语进入英语，并始终保持其对抗性和冲突性的含义。
