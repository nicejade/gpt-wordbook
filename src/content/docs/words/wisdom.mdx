...
title: Wisdom
description: >-
  Wisdom 是一个英语名词，意思是 '智慧'，或者
  '明智'。它可以指的是生活的层面、如实际的问题解决能力，也可以指的是更深的层面，如对生活、世界有深刻理解的能力。
sidebar:
  hidden: true
...
<Pronunciation word="Wisdom" uk="/ˈwɪzdəm/" us="/ˈwɪzdəm/" client:only />
...
<WordRelations antonyms={["folly", "foolishness"]} client:only />
