...
description: >-
  Motherland
  这个词汇通常用来指一个人的出生地或祖先的原籍地，常常是出于对这个地方的深深热爱和敬仰，会引起强烈的情感共鸣。英文中，它具有和“祖国”相似的情感。
sidebar:
  hidden: true
...
Motherland 是由 Mother+land 组成的合成词，表示祖国，源自对土地的尊崇和对母亲情感的寄托。在英美文化中，Motherland 通常用于表示民族或国家的情感。
...
<WordRelations synonyms={["fatherland", "homeland"]} client:only />
