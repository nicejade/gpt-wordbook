...
title: Line
description: >-
  "Line" 在英语中是个多义词，在不同的语境中有着不同的意义。它常见的意思包括： 1. "一行"，指文字或数字等的水平排列，如一行诗、一行代码。 For
  example: "Please read the next line in the book."（请读书中的下一行。） 2.
  "线条，线"，鉴指一段起点和终点连成的线条。 For example: "The artist drew several lines in his
  sketchbook."（那位艺术家在他的素描本上画了几条线。） 3. "路线，途径，方法"，比如公交线路、推进事情的路线。 For example:
  "We have established a new shipping line for this
  product."（我们为这个产品建立了一条新的运输线。）
sidebar:
  hidden: true
...
这是一群鸟儿排成一线站在电线上。它们在欢快地鸣叫，享受着阳光明媚的清晨。Maggie 看到了这个美丽的画面并在她的素描本上画下了这一幕。
