---
title: Cattle
description: 单词 'cattle' 指的是牛的集体，它是一个不可数名词。通常，我们说的 '牛' 多指家养的用于生产肉类、牛奶或作为劳力使用的牛。
sidebar:
  hidden: true
...
<Pronunciation word="Cattle" uk="/ˈkæt(ə)l/" us="/ˈkæt(ə)l/" client:only />
...
<WordRelations
  synonyms={["Bos", "cattlebeast", "cattlehead", "neat"]}
  client:only
/>
