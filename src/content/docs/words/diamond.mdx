---
title: Diamond
description: Diamond 是一个英语单词，其主要含义是“钻石”。这是一种非常硬的闪亮的透明宝石，由碳原子在极高温度和压力下形成的。
sidebar:
  hidden: true
...
<Pronunciation word="Diamond" uk="/ˈdaɪ(ə)mənd/" us="/ˈdaɪ(ə)mənd/" client:only />
...
<WordRelations
  synonyms={["infield","sparkler","lozenge","rhomb","rhombus","adamant"]}
  antonyms={["outfield"]}
  client:only
/>
