...
title: Rebuke
description: >-
  Rebuke 是一个动词，主要指责备、斥责或强烈反对。在使用中，常常用于形容对不恰当行为的指责或批评。例如：'She rebuked him for his
  insensitivity.' (她因他的冷漠而责备他。)
sidebar:
  hidden: true
...
<Pronunciation word="Rebuke" uk="/ɹiˈbjuːk/" us="/ɹiˈbjuːk/" client:only />
...
"Rebuke"起源于 13 世纪中的法语，主要用于展示不满并对其进行指责、责备，有着一种严厉反对的含义。
...
<WordRelations
  synonyms={["admonition","reprehension","reprimand","reproach","reproof","admonish","scold"]}
  client:only
/>
