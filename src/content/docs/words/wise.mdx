...
title: Wise
description: >-
  Wise 是一个形容词，用来形容一个人具有经验和知识，并且能做出明智的决定。类似的词包括聪明的 (smart) ，聪颖的 (clever) 和有洞察力的
  (insightful)。
sidebar:
  hidden: true
...
<Pronunciation word="Wise" uk="/waɪz/" us="/waɪz/" client:only />
...
<WordRelations antonyms={["foolish", "unwise"]} client:only />
