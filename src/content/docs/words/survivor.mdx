---
title: Survivor
description: Survivor 是一个名词，主要指那些在困难、灾难、危机或其他生存挑战中存活下来的人们。
sidebar:
  hidden: true
...
<Pronunciation word="Survivor" uk="/sɚˈvaɪvɚ/" us="/sɚˈvaɪvɚ/" client:only />
...
<WordRelations synonyms={["trooper"]} client:only />
