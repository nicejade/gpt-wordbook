...
description: >-
  Decree
  是一个名词，通常指的是由官方颁布的正式指令或宣布。这个词可以用在许多法律和政府语境中，表示某位权威（如国王、总统或法官）颁布的决定或规定。它也可以做动词用，意为'颁布'或'命令'.
sidebar:
  hidden: true
...
<Pronunciation word="Decree" uk="/dɪˈkɹiː/" us="/dɪˈkɹiː/" client:only />
...
Decree 本身没有词缀，是一个完整的词。

### 文化背景

Decree 这个词语源自拉丁语，后来经由法语传入英语，在欧美法律和政府语境中常常使用，以表示官方的决定或规定。

### 单词变形

Decree 在作为动词的情况下，一般只变化时态。如：
