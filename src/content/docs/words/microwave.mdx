...
title: Microwave
description: >-
  Microwave 是微波的意思，通常指的是一種電磁波，其波長在射頻波與紅外線之間，频率在 3 00 MHz (0.3 兆赫)和 300 GHz
  (300,000 兆赫）之间。另外，microwave 也常常在日常生活中用来指我们烹饪食物的微波炉。
sidebar:
  hidden: true
...
Microwave 是微波的意思，通常指的是一種電磁波，其波長在射頻波與紅外線之間，频率在 3 00 MHz (0.3 兆赫)和 300 GHz (300,000 兆赫）之间。另外，microwave 也常常在日常生活中用来指我们烹饪食物的微波炉。
...
这个单词最初源于电磁谱的一部分，被定义为波长在 1 毫米到 1 米之间的电磁波。由于微波被广泛用于传输信息，烹饪和医学应用，因此这个单词在日常使用中也变得非常常见。
...
<WordRelations synonyms={["SHF", "nuke", "microwave"]} client:only />
