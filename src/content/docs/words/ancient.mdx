---
title: Ancient
description: Ancient 是个形容词，也可以用作名词。这个单词主要有两个含义：
sidebar:
  hidden: true
...
<Pronunciation word="Ancient" uk="/ˈeɪn.ʃənt/" us="/ˈeɪn.ʃənt/" client:only />

1.  把“ancient”用作形容词，描述非常老的、历史悠久的东西。例如我们可以说 ancient civilization（古老的文明）。
...
<WordRelations
  synonyms={["geriatric","oldster","antique","antecessor","forerunner","aged","eldern","hoary"]}
  client:only
/>
