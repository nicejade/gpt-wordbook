---
title: Summary
description: Summary 是英语中的一个名词，意为“摘要”，“总结”，或者“概述”。它主要用来指的是一个更大的作品或想法的精简版本，通常会突出其中的主要点和要点。
sidebar:
  hidden: true
...
<Pronunciation word="Summary" uk="/ˈsʌməɹi/" us="/ˈsʌməɹi/" client:only />
...
"Summary" 这个词在 14 世纪的时候，从经由法语由拉丁原词“summa”衍生而来，原词中包含了“总和”又或者是“全部”的意思。后来在英语中发展为表示一个更为简明扼要的概念，用于指代对一件事情，一个主题的核心要点的提炼。
...
<WordRelations synonyms={["upshot"]} client:only />
