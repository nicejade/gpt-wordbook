---
title: Refer
description: Refer是一个动词，主要有三种基本含义：(1) 提到，参照；(2) 参考，查阅；(3) 转交，委托。
sidebar:
  hidden: true
...
<Pronunciation word="Refer" uk="/ɹɪˈfɜː/" us="/ɹɪˈfɝ/" client:only />
...
<WordRelations synonyms={["delegate", "direct"]} client:only />
