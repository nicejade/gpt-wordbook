---
title: "PC"
description: "分析词义 英文单词 PC 有两层常用的含义，第一层含义是 Personal Computer，中文意思是 个人电脑，通常指的是个人使用的台式机或便捷式电脑；第二层含义是 Politically Correct，中文意思是 政治正确，常用来表示一个人的言论或行为是否符合大众认可的社会正义或公众道德。"
---
