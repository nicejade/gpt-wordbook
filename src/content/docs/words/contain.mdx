---
title: Contain
description: "Contain 是一个动词, 它的意思主要包括："
sidebar:
  hidden: true
...
<Pronunciation word="Contain" uk="/kənˈteɪn/" us="/kənˈteɪn/" client:only />
...
"Contain"的词根为 Latin "tene", 意为"hold".其他由此词根衍生出来的单词有：maintain（维持），retain（保留），abstain（戒除）等。
...
"Contain"源自拉丁语 "contineo"，意为“hold together”，在 14 世纪的时候进入了英语语境，并持续到现在。
...
<WordRelations
  synonyms={["enclose","comprise","embody","incorporate","control","curb","restrain","restrict"]}
  antonyms={["exclude", "omit", "release", "vent"]}
  client:only
/>
