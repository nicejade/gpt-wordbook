---
title: Arrive
description: Arrive 是一个（多数情况下）不及物动词，意为“到达”。它也可以表示在某种情况或状况中“到达”或“成为”。
sidebar:
  hidden: true
...
<Pronunciation word="Arrive" uk="/əˈɹaɪv/" us="/əˈɹaɪv/" client:only />
...
"Arrive" 这个单词在 14 世纪由法语借入英语，原本的意思是“到达海岸”，源自拉丁语的"_arripare_", 由"_ad_" 到 +"_ripar_" 银行 创造而成。
...
<WordRelations antonyms={["depart"]} client:only />
