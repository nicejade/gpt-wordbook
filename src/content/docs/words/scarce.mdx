---
title: Scarce
description: Scarce 是一个形容词，表示不足的、缺乏的、稀少的。
sidebar:
  hidden: true
...
<Pronunciation word="Scarce" uk="/ˈskɛəs/" us="/ˈskɛɚs/" client:only />
...
<WordRelations synonyms={["geason", "infrequent", "raresome"]} client:only />
