---
title: Student
description: Student是一个名词，指的是在学校、学院或大学学习的人。在更广泛的意义上，'student'也可以指任何愿意学习、热衷于获取新知识的人。
sidebar:
  hidden: true
...
<Pronunciation word="Student" uk="/ˈstjuː.dənt/" us="/ˈstu.dn̩t/" client:only />
...
"student"这个词最早出现在 14 世纪中叶的英格兰。这个词的义项适用于所有年龄段的人，表示正在接受教育或指在深造的成年人。
...
<WordRelations
  synonyms={["devotee","disciple","scholar"]}
  antonyms={["teacher"]}
  client:only
/>
