...
title: Vine
description: >-
  Vine是英文中一个常用的单词，主要指的是“葡萄藤”或者更广义的“藤本植物”。它也可以作为动词，表示“爬藤”。此外， 'Vine'
  还是一个已经终止运营的短视频分享社交类应用的名字。
sidebar:
  hidden: true
...
<Pronunciation word="Vine" uk="/vaɪn/" us="/vaɪn/" client:only />
...
<WordRelations synonyms={["climber", "grapevine"]} client:only />
