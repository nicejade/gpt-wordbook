---
title: Adoptive
description: '"Adoptive"是形容词，意为"收养的"或"领养的"，通常用于描述收养关系，例如"adoptive parents" （领养的父母）。'
sidebar:
  hidden: true
...
"Adoptive"的记忆方法可以和它的反义词"biological"（生物的，生物学的）一起记忆，如 biological parents （亲生父母）和 adoptive parents （领养父母）。
