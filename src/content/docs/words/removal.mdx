---
title: Removal
description: Removal 是一个名词，意指“移除，搬迁，去除”，它可以用于描述把某人或某物从某地取走，或者从一个位置移到另一个位置的过程。
sidebar:
  hidden: true
...
<Pronunciation word="Removal" uk="/ɹəˈmuːvəl/" us="/ɹəˈmuːvəl/" client:only />
...
"Removal"一词源于 16 世纪的英语，最初用来描述将某物从某处移开的行为。及至 19 世纪，该词义扩大，开始被用来形容“术后的恢复”或“移民”。
...
<WordRelations synonyms={["move", "relocation"]} client:only />
