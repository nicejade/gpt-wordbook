---
title: Supersonic
description: '"Supersonic"是一个形容词，主要用来描述速度超过或相当于声速的现象。这个词汇通常在描述飞行，尤其是飞机或其他航天器的速度时使用。'
sidebar:
  hidden: true
...
由此词根衍生的其他单词包括：supernatural (超自然的)、superior (超越的)，以及 sonar (声纳)、resonate (共振)等等。
...
"Supersonic"这个词在 20 世纪中叶兴起，当时正是超音速飞行技术的发展期。在欧美科技和航空领域，这个词被广泛使用。
