---
title: Kernel
description: Kernel 是一个名词，由多个含义。
sidebar:
  hidden: true
...
<Pronunciation word="Kernel" uk="/ˈkɜːnəl/" us="/ˈkɜːnəl/" client:only />
...
你可以把 kernel 和 corn（玉米）联系在一起，因为玉米的每一个颗粒都可以被称为 kernel。这样可以帮助你记住它的一个含义。“Kernel” 在计算机语境下的含义也可以用这种方式类比，因为 kernel 是操作系统的“心脏”或“核心”，正如玉米的每个颗粒都是整个玉米的组成部分。
