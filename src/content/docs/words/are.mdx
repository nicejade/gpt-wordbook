...
title: Are
description: >-
  Are' 是一个动词，用作第二人称单数和所有人称的复数形式的 'be' 动词的现在时态。'be' 动词具有许多不同的用途，包括指示存在，发生或成为。例如,
  'You are my friend.', 'We are team.
sidebar:
  hidden: true
...
<Pronunciation word="Are" uk="/ɛə/" us="/ɛə/" client:only />
...
<WordRelations synonyms={["decametre"]} client:only />
