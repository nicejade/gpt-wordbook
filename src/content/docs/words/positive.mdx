...
description: >-
  ...
  可以被理解为乐观、积极，全力以赴的。当用在科学或者技术领域（例如电荷、磁性）时，它表示正或者阳。
sidebar:
  hidden: true
...
<Pronunciation word="Positive" uk="/ˈpɒzɪ̈tɪv/" us="/ˈpɑzɪ̈tɪv/" client:only />
...
<WordRelations
  ...
  antonyms={["uncertain","unsure","negative","bad","evil"]}
  client:only
/>
