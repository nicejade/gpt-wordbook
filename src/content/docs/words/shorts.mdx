---
title: Shorts
description: Shorts 是一个常用的英文名词，指的是短裤。一般用于指夏天或热天之间穿的短裤。
sidebar:
  hidden: true
...
<Pronunciation word="Shorts" uk="/ʃɔː(ɹ)ts/" us="/ʃɔː(ɹ)ts/" client:only />
...
"Shorts"这个单词在英语中早在 14 世纪就开始使用了，最初的含义是短的或者更短的东西。以后逐渐演变为描述短裤这一种服装。
