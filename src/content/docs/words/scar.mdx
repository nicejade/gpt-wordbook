---
title: Scar
description: Scar作为名词，为伤疤、创伤痕迹的意思。作为动词时意为留下疤痕或痕迹。
sidebar:
  hidden: true
...
<Pronunciation word="Scar" uk="/skɑː(ɹ)/" us="/skɑː(ɹ)/" client:only />
...
<WordRelations synonyms={["cicatrice", "cicatrix"]} client:only />
