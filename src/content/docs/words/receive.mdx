---
title: Receive
description: Receive是一个动词，表示“接收，得到，收到”。也可以表示接受一种服务或治疗，例如：“receive medical treatment”。
sidebar:
  hidden: true
...
<Pronunciation word="Receive" uk="/ɹɪˈsiːv/" us="/ɹɪˈsiːv/" client:only />
...
"Receive"源自老英语，早在 14 世纪就开始使用，首次出现在宗教文献中，指的是接收神的礼物或祝福。
