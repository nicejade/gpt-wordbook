---
title: Calm
description: Calm 具有多种含义，主要的意思有以下几种：
sidebar:
  hidden: true
...
<Pronunciation word="Calm" uk="/kam/" us="/kɑlm/" client:only />
...
您可以将 calm 与图片关联起来记忆，例如，一个安静的湖泊或一个在野外冥想的人。
...
<WordRelations
  synonyms={["allay","appease","ease","pacify","quieten","soothe","subdue"]}
  antonyms={["agitate","excite","anxious","nervous","stressed","disturbed","stormy","windy"]}
  client:only
/>
