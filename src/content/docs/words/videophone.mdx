---
title: Videophone
description: Videophone 是一种具有可视通话功能的电话设备。这个词由 'video'（视频）和 'phone'（电话）组成，直译为'视频电话'。
sidebar:
  hidden: true
...
"Videophone" 的词源可以追溯到 20 世纪 50 年代，开始用于描述能进行音视频通话的设备。随着科技的快速发展，特别是互联网技术的出现，视频电话在 21 世纪逐渐普及，人们甚至可以通过手机进行视频通话。
...
<WordRelations synonyms={["vidphone", "viewphone"]} client:only />
