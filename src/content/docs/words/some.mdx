---
title: Some
description: some 是一个常用的英文单词，它可以用作形容词、代词或者副词，基本含义是“一些”。它的详细解释是：
sidebar:
  hidden: true
...
<Pronunciation word="Some" uk="/sɐm/" us="/sʌm/" client:only />
...
<WordRelations antonyms={["many", "much", "none"]} client:only />
