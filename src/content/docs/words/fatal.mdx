---
title: Fatal
description: 英文单词 'fatal' 在中文里的意思通常被译为“致命的”。它一般用于描述一个后果、事件或者伤害等情况用于表示极度严重，生命不能保的程度。
sidebar:
  hidden: true
...
<Pronunciation word="Fatal" uk="[ˈfeɪ.ɾɫ̩]" us="[ˈfeɪ.ɾɫ̩]" client:only />
...
<WordRelations
  synonyms={["deadly","destructive","mortal","terminal","inevitable","necessary"]}
  client:only
/>
