---
title: Curtain
description: 单词 'curtain' 是一个名词，主要指的是'窗帘'或是用来遮蔽或隐藏的'帘子'。有时候它也做动词使用，意思是'设上帘子'。
sidebar:
  hidden: true
...
<Pronunciation word="Curtain" uk="/ˈkɜːtn̩/" us="/ˈkɝtn̩/" client:only />
...
<WordRelations synonyms={["becurtain"]} client:only />
