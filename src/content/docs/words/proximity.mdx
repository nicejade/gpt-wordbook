---
title: Proximity
description: Proximity 是一个名词，表示'靠近'，'接近'或'邻近'的意思。它经常用在描述两个事物在空间或关系上的近度。
sidebar:
  hidden: true
...
单词 "Proximity" 源于 14 世纪的拉丁文 "proximitas"，表示"紧邻"。用于表示地理位置、人际关系、时间距离等的接近或紧邻关系。
...
<WordRelations synonyms={["closeness", "nearness"]} client:only />
