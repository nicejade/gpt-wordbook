---
title: Deliver
description: Deliver 是一个英文动词，有'交付'，'递送'，'发表'，或者'实现'的含义。例如，递送一份包裹；发表演讲；交付责任；实现承诺等。
sidebar:
  hidden: true
...
<Pronunciation word="Deliver" uk="/dɪˈlɪvə(ɹ)/" us="/dɪˈlɪvɚ/" client:only />
...
其他以此词根衍生的单词包括： deliverance，delivery 等等。
...
"Deliver"源于 Old French 的 "delivrer"，指的是"放下，释放，到达" ，最初被用作军事术语。在 13 世纪末，这个词开始在日常生活中用作"来带"和"带走"的意思。
...
<WordRelations
  synonyms={["outbring","utter","free","loose","rid","liberate","release"]}
  client:only
/>
