...
title: Ministry
description: >-
  Ministry 是一个名词，主要有两个含义。第一，它可以指的是一个国家政府的部门，如 'Ministry of
  Education'（教育部）。第二，它也可以用来具体指某种宗教的服务或活动，如'ministry of the church'（教堂的事务）。
sidebar:
  hidden: true
...
<Pronunciation word="Ministry" uk="/ˈmɪnɪstɹi/" us="/ˈmɪnɪstɹi/" client:only />
