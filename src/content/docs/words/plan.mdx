...
title: Plan
description: >-
  Plan 是个双性词，既可以作为名词，也可以作为动词。作为名词，'plan' 的意思是'计划'，'方案'；作为动词，'plan'
  的意思是'计划'或'策划'。
sidebar:
  hidden: true
...
<Pronunciation word="Plan" uk="/plæn/" us="/plæn/" client:only />
...
"Plan" 这个单词最早在 1678 年出现，推测起源于建筑师、工程师、城市规划者等的专业语言，代表"制定蓝图"。它后来逐渐发展成代表"策划"或"预见"的意思。
