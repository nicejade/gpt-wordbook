...
description: >-
  Manual
  在英语中有两种主要的含义。第一种是作为形容词时，表示“手工的，体力的”，通常指需要用手进行的工作或活动。第二种是作为名词，指“手册，指南”。这种含义通常用于描述一本提供特定信息、指示或程序的书籍或册子。
sidebar:
  hidden: true
...
"Manual"一词来源于 14 世纪拉丁文“manualis”意为“便于携带的，“来自”manus”的，意为“手”，反映了早期的文化，当时大多数工作都是手工完成的。
...
<WordRelations synonyms={["enchiridion", "handbook"]} client:only />
