...
title: Marginal
description: >-
  "Marginal"是一个形容词，它在英语中常见的含义是"微小的"或"不重要的"。例如， "marginal
  differences"意味着很小的差异。此外，"marginal"也用来描述那些位于边缘或者界限的人，物或情况，如"marginal
  land"可以解释为地理位置处于边缘的土地。
sidebar:
  hidden: true
...
词根"margo"最早出现在中世纪晚期的拉丁文中。到了 16 世纪时，"margo"进化为"margin"，并开始在英语中使用。直到 19 世纪末，"marginal"这个形容词才开始广泛使用。
