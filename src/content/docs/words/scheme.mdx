---
title: Scheme
description: scheme 是一个英文名词，主要有以下两大含义：
sidebar:
  hidden: true
...
<Pronunciation word="Scheme" uk="/skiːm/" us="/skiːm/" client:only />
...
"scheme" 这个词首次在 1540 年代出现，来源于拉丁文'schema'，最初用于医学领域，描述解剖学的结构图。再往前追溯，'schema'来源于希腊文，本意为'形状'或'计划'。
...
<WordRelations synonyms={["blueprint"]} client:only />
