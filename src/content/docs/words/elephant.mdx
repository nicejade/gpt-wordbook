---
title: Elephant
description: Elephant 是一个名词，指的是大象，一种大型哺乳动物，以其长鼻、长牙和大耳朵而知名。
sidebar:
  hidden: true
...
<Pronunciation word="Elephant" uk="/ˈɛləfənt/" us="/ˈɛləfənt/" client:only />
...
<WordRelations
  synonyms={["Elephas", "Loxodonta", "africana", "maximus"]}
  client:only
/>
