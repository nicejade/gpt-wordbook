---
title: Difficult
description: Difficult是一个形容词，表示'不易做到的，困难的'。
sidebar:
  hidden: true
...
<Pronunciation word="Difficult" uk="/ˈdɪfɪkəlt/" us="/ˈdɪfɪkəlt/" client:only />
...
"Difficult" 这个单词最早出现在 14 世纪，并来自法语 "difficile"，用于表示"不易理解的，错综复杂的"等。
...
<WordRelations synonyms={["burdensome", "cumbersome", "hard"]} client:only />
