---
title: Flash
description: Flash 是一个常用英语单词，主要有两种含义：一是表示 '闪光'，一是表示 '瞬间'。
sidebar:
  hidden: true
...
<Pronunciation word="Flash" uk="/flæʃ/" us="/flæʃ/" client:only />
...
"Flash" 是一个没有词缀的词。在搭配中，可添加后缀-form 成为 "flash-forming" 表示 "半导体闪光形成"。
