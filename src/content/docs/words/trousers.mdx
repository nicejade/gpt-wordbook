---
title: Trousers
description: Trousers 是一个英语名词，通常用来指代一种服装，即我们通常所说的裤子。这个词常用于英国英语，而在美国英语中，相同的物品通常被称为 'pants'。
sidebar:
  hidden: true
...
<Pronunciation word="Trousers" uk="/ˈtɹaʊzəz/" us="/ˈtɹaʊzɚz/" client:only />
...
Trousers 这个单词并没有明确的词根来源。

### 词缀分析

Trousers 这个单词并没有明确的词缀，它是个完整的单词。

### 文化背景

Trousers 在英国使用比较中，美国人则习惯用 pants 来表示同样的意思。Trousers 这个单词在 13 世纪的英语中首次出现，来源于老法语的"trousses"，表示“一对”。
...
<WordRelations
  synonyms={["breeches", "britches", "kecks", "pants", "strides"]}
  client:only
/>
