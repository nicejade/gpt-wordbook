---
title: Weekend
description: weekend 是一个名词，指的是一个星期的最后两天，通常是星期六和星期日。在大多数文化中，周末被视为休息和娱乐的时间。
sidebar:
  hidden: true
...
<Pronunciation word="Weekend" uk="/wiːˈkɛnd/" us="/ˈwiˌkɛnd/" client:only />
...
- weekend: 是一个复合词，由 "week"（星期，一周）和 "end"（结束）组成，意为一周的结束。

### 词缀分析

- weekend: 无前后缀，是由两个词"week"和"end"组合而成的。
