---
title: Totally
description: Totally是一个副词，可以翻译为'完全地'或'彻底地'。它被用来强调某个行为或状态的全面性，即无例外，无保留的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Totally" uk="/ˈtoʊt.əl.i/" us="/ˈtoʊt.əl.i/" client:only />
...
"Total"的词源来自拉丁语，并在 14 世纪引入英语。副词形式"totally"则在近代英语中形成，用以强调事物的全面，彻底性。
