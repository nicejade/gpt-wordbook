---
title: Cocktail
description: Cocktail是一个名词，最常见的意思是“鸡尾酒”，是指通过调和蒸馏酒、果汁、糖、苦味等多种材料制成的饮料。
sidebar:
  hidden: true
...
<Pronunciation word="Cocktail" uk="/ˈkɒkteɪl/" us="/ˈkɒkteɪl/" client:only />
...
虽然“cocktail”这个词的确切由来仍然是个谜，但普遍认为它起源于 18 世纪的美国。早期的鸡尾酒通常是一种简单的饮品，由烈性酒、糖、水和苦味酒调配而成。
...
<WordRelations synonyms={["ckt"]} client:only />
