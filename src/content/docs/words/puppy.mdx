---
title: Puppy
description: Puppy 是英文中的一个单词，中文的意思是 '小狗' 或 '幼犬'，通常指刚出生到一岁左右的年轻狗。
sidebar:
  hidden: true
...
<Pronunciation word="Puppy" uk="/ˈpʌpi/" us="/ˈpʌpi/" client:only />
...
<WordRelations synonyms={["dogling", "pup", "whelp"]} client:only />
