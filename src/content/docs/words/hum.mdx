---
title: Hum
description: Hum 是一个动词和名词，作动词时主要有两个意思：1）模仿嗡嗡声，2）低声不清地唱。作名词时主要指的是嗡嗡声或者低声唱的声音。
sidebar:
  hidden: true
...
<Pronunciation word="Hum" uk="/ˈhʌm/" us="/ˈhʌm/" client:only />
...
Hum 来源于古英语的 word "hūmian"，意思是发出低沉的声音，这个词在许多音译语言中都有类似的含义。
...
每天早晨，Tom 都会被闹钟的嗡嗡声唤醒。这个声音标志着新的一天的开始。

<WordRelations
  synonyms={["hnn", "bumble", "bustle", "buzz", "croon", "hustle", "whir"]}
  client:only
/>
