---
title: Hello
description: Hello 是英语的一个常用词，本意是用于问候，表示“你好”。它也可以用于表示惊讶或者获取他人注意。“Hello”也常用在接电话时的打招呼。
sidebar:
  hidden: true
...
<Pronunciation word="Hello" uk="/həˈləʊ/" us="/həˈləʊ/" client:only />
...
Hello 的词根没有明确来源，可能源于 16 世纪的英格兰方言，“holla”意为"stop, cease"。
