---
title: Demand
description: Demand 是个英文单词，它一般作为名词或动词使用，主要涵盖了以下几种意思：
sidebar:
  hidden: true
...
<Pronunciation word="Demand" uk="/dɪˈmɑːnd/" us="/dəˈmænd/" client:only />
...
<WordRelations synonyms={["imposition", "frain", "insist"]} client:only />
