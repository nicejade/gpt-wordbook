...
title: Arrangement
description: >-
  Arrangement'是一个英语名词，其基本含义为'安排，安排的方法'。然而，这个词在不同的上下文中也有其他的含义，例如'布置，排列（如花的排列）'或'协议，安排（
  如与某人的约定）
sidebar:
  hidden: true
...
"Arrangement"这个词出现在 14 世纪的英格兰，最初从法语的"arranger"演变而来。随着时间的发展，它的含义也逐渐扩展，包括对物体的排列，到时间和活动的组织，再到人与人之间的约定。
...
<WordRelations synonyms={["configuration", "constitution"]} client:only />
