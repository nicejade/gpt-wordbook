---
title: Markedly
description: Markedly 是一个形容词，意思是'明显地'或'显著地'，常用于强调某个变化或差异显得非常明显。
sidebar:
  hidden: true
...
<Pronunciation word="Markedly" uk="/ˈmɑːkɪdli/" us="/ˈmɑːkɪdli/" client:only />
...
"Markedly"的词缀是后缀-ed 和 -ly。-ed 是过去分词后缀，用于形成形容词，表明"有...标志的"或"有...特征的"；-ly 是形容词变副词的后缀，表明"以...方式"。
