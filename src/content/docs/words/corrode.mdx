---
title: Corrode
description: Corrode 是一个动词，意思是'侵蚀'或'腐蚀'，为有害物质、化学反应等导致材料的物理性质变化。它也可以比喻为：减少、降低、损害。
sidebar:
  hidden: true
...
<Pronunciation word="Corrode" uk="/kəˈɹəʊd/" us="/kəˈɹəʊd/" client:only />
...
<WordRelations
  synonyms={["canker", "gnaw", "rust", "waste", "wear"]}
  client:only
/>
