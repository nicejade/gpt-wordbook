...
description: >-
  bounce
  是一个英语单词，最常见的含义是“反弹，跳起”。它可能用作动词，表示物体撞击平面后返回原点，如：球撞到墙再弹回来。也能用作名词，用来描述弹性和生命力的属性。
sidebar:
  hidden: true
...
<Pronunciation word="Bounce" uk="/baʊns/" us="/baʊns/" client:only />
...
<WordRelations
  synonyms={["rebound","bob","bobbing","bouncing","ups","bang"]}
  client:only
/>
