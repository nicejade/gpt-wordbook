---
title: Hateful
description: Hateful 是一个形容词，含义是 '引发仇恨的'或'可恶的'。
sidebar:
  hidden: true
...
<Pronunciation word="Hateful" uk="/ˈheɪtfəl/" us="/ˈheɪtfəl/" client:only />
...
其中，-ful 是一个常见的后缀，例如：beautiful ,careful 等。

### 文化背景

"Hateful" 这个词源自古英语的 "hatefullic"，大约在 14 世纪开始普遍使用。
...
<WordRelations antonyms={["loveful"]} client:only />
