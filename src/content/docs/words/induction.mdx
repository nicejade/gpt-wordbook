---
title: induction
description: Induction 这个单词最初的意思是“引入”，常用于描述一种理论方法，即从具体事实中推出一般性原理或法则的过程，我们称之为“归纳法”或“诱导法”。
sidebar:
  hidden: true
...
发展历史和文化背景：Induction 一词最早应用于 14 世纪的法国，意为“形式接纳或就职”，后在 16 世纪引入到“逻辑推理”的领域。在科学领域，特别是物理学中，此词表示通过改变一个物体的性质来影响另一个物体的性质。
