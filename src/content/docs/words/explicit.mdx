...
title: explicit
description: >-
  Explicit 是一个形容词，它是来自拉丁文的 explicitus，意思是 解放的，清楚的”。在英语中，它主要的含义是
  清楚的、明确的，描述一个信息，无论是指示、描述、声明或者指令，都是明确无误，不含糊，没有隐藏的意思。 例如： * She gave me explicit
  instructions.（她给我明确的指示。） * His intentions were made explicit.（他的意图已经明确表示了。）
sidebar:
  hidden: true
