---
title: Plough
description: Plough（美式英语中为'plow'）是机械农耕工具的名称，它用于松动土壤，犁沟以方便种植作物。除此之外，这个词也有动词的意思，表示“犁耕土地”。
sidebar:
  hidden: true
...
<Pronunciation word="Plough" uk="/plaʊ/" us="/plaʊ/" client:only />
...
"Plough"原为古英语词汇 "plōg"，在中世纪西欧语言中，proto-germanic 词根 "*plōg-" 被广泛使用，意为"耕犁"。
...
<WordRelations
  synonyms={["carrucate","carve","hide","plough","ploughgate","ploughland","plow","plowgate","plowland","sull","zowl","carucate","flunk","pound","chamfer","groove","rut"]}
  client:only
/>
