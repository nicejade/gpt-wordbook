---
title: Improper
description: Improper 是一个英语形容词，表示“不适合的、不正确的、不适宜的”。在中文中，我们可以把它翻译为“不妥当的”，“不适当的”。
sidebar:
  hidden: true
...
<Pronunciation word="Improper" uk="/ɪmˈpɹɒp.ə/" us="/ɪmˈpɹɔp.ə/" client:only />
...
"Improper" 这个单词来源于 14 世纪的法语，意为"不适当的，不合适的"。在 20 世纪，这个词开始常用于描述不适合某个社会礼仪或不贞的行为。
