...
title: Wield
description: >-
  wield' 这个单词在英语中是一个动词，通常用来描述手持或者使用（武器、工具或者权力）。例如：'wield a
  sword'，在中文中的翻译可以是“挥舞一把剑。
sidebar:
  hidden: true
...
<Pronunciation word="Wield" uk="/wiːld/" us="/wiːld/" client:only />
...
"wield"来源于古英语的单词 wealdan，意思是控制或统治。
