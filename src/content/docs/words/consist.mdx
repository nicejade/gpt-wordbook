...
title: Consist
description: >-
  Consist是英文中的一个动词，意思是“由...组成”，用来说明某物的构成元素或组成部分。例如，我们可以说一件事由许多小事情组成，或者一种食物由多种食材组成。
sidebar:
  hidden: true
...
<Pronunciation word="Consist" uk="/kənˈsɪst/" us="/kənˈsɪst/" client:only />
...
这个词在 16 世纪从拉丁语引入到英语中，并保持了其原始的意思，即由各个部分共同组成一个完整的整体。
...
<WordRelations synonyms={["comprise"]} client:only />
