---
title: Quantifiable
description: '"Quantifiable"这个单词来自于"quantify"，是一个形容词。它的意思是“可以测量的”或者“可以量化的”。'
sidebar:
  hidden: true
...
Quantifiable 首次出现在 19 世纪 60 年代，这个词语是由拉丁词根-"quantus"（多大),以及英语后缀"ify"和"able"组合而来。在英美文化和科学研究中，"Quantifiable"这个概念显得格外重要，因为它体现出的是一种实证主义理念，即所有可以被量化、测量和计算的事物都是客观存在的。
