---
title: Maybe
description: Maybe 是个副词，用于表示可能性或不确定性，相当于“可能”、“也许”、“或许”。
sidebar:
  hidden: true
...
<Pronunciation word="Maybe" uk="/ˈmeɪbi/" us="/ˈmeɪbi/" client:only />
...
"Maybe" 这个词出现在词典中的最早记录是在 15 世纪，起源于中世纪英语，是 "it may be" 的简单表达方式。
...
<WordRelations
  synonyms={["perhaps", "mayhaps", "possible", "possibly", "peradventure"]}
  client:only
/>
