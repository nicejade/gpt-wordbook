---
title: Tickle
description: Tickle，作为动词，指的是轻轻地触摸或抓挠某人以使其感到痒。此外，'tickle'还可以意味着使人忍俊不禁或感到愉悦。
sidebar:
  hidden: true
...
<Pronunciation word="Tickle" uk="/ˈtɪkl̩/" us="/ˈtɪkl̩/" client:only />
...
"Tickle" 不容易追溯其词根，不过我们可以看到，它在大约 14 世纪的英语中被用来指代“挠痒痒”。
...
可以记忆这个短语'tickle one's funny bone'，意思是让人忍俊不禁，这样就可以记住 ticklish 这个词。
...
<WordRelations synonyms={["kittle"]} client:only />
