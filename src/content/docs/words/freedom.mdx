...
description: >-
  Freedom
  是一个名词，表示“自由、释放”。在广义上，它通常指一个人或者群体在行动、思考、表达等方面的无限制状态。在狭义上，如在法律语境中，它可以指没有身体的限制，如不受监禁。
sidebar:
  hidden: true
...
<Pronunciation word="Freedom" uk="/ˈfɹiːdəm/" us="/ˈfɹidəm/" client:only />
...
<WordRelations
  synonyms={["exemption", "liberty", "license"]}
  antonyms={["bondage", "constraint", "imprisonment", "slavery"]}
  client:only
/>
