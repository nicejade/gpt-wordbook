---
title: Expenditure
description: Expenditure 这个词在英语中用于表示支出或者开支，大多数情况下用于描述金钱的使用或消耗。我们也可以将其理解为在物资、能源、时间等方面的消耗。
sidebar:
  hidden: true
...
这个词起源于 16 世纪的拉丁语 "expenditus"，指的是"支付"或"花费”。在现代英语中，"expenditure" 通常指的是个人或组织的花费或消耗。
...
<WordRelations
  synonyms={["charge", "cost", "disbursement", "expense", "outlay", "payment"]}
  client:only
/>
