---
title: Blunder
description: Blunder 是一个英语单词，可以用作名词和动词，主要有两层含义。
sidebar:
  hidden: true
...
<Pronunciation word="Blunder" uk="/ˈblʌn.də(ɹ)/" us="/ˈblʌn.dɚ/" client:only />
...
"Blunder" 一词源自于 14 世纪的中英语，其表示的是突然到来的恐怖或恐慌，或是由于惊吓或无知而导致的混乱或错误。
...
<WordRelations
  synonyms={["blooper","error","flub","fluff","fumble","gaffe","goof","lapse","mistake","slip","stumble","thinko"]}
  client:only
/>
