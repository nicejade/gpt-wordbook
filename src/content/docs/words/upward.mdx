---
title: Upward
description: Upward 是一个英文副词，也可以当做形容词使用。作为副词时，表示 '向上地' 或者是 '上升地'; 作为形容词时则是 '向上的' 或 '底朝上的'。
sidebar:
  hidden: true
...
<Pronunciation word="Upward" uk="/ˈʌpwəd/" us="/ˈʌpwɜː(ɹ)d/" client:only />
