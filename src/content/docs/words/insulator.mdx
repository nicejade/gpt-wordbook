---
title: Insulator
description: Insulator 这个单词在物理学上的意思是“绝缘体”，也就是一种不导电、不导热的物质。在日常生活中，绝缘体可以防止电、热等的传递。
sidebar:
  hidden: true
...
**文化背景和历史**：
"Insulator" 这个词源自 19 世纪，当时由于大规模的电力系统的发展，需要一种物质来防止电的泄漏，所以这个词就应运而生了。
...
你可以通过联想法进行记忆，例如“Insu”和“Island（岛）”发音相近，你就可以把它联想为一个岛，这个岛把电（在 word"lator"里的"la"和"电"的发音相近）隔绝了，这样就能轻松记住“insulator”的含义。
