...
title: Bracket
description: >-
  Bracket 是一个英语名词，主要有两种基本含义：1. 支架，架子。例如安在墙上用于放置书本、装饰品等的小架子。2.
  方括号，指在文本中为了强调，将某些信息括起来的标点符号，即 [ 和 ]。
sidebar:
  hidden: true
...
<Pronunciation word="Bracket" uk="/ˈbɹækɪt/" us="/ˈbɹækɪt/" client:only />
...
"Bracket"这个词进入英语是在 19 世纪，当时的建筑师从法国引入了这个词来形容一种特殊的支柱设计。现在我们使用这个词来代表很多其他概念，例如数学中的括号，或体育赛事的淘汰赛形状。
...
<WordRelations synonyms={["parens", "parentheses", "benchmark"]} client:only />
