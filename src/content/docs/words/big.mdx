---
title: Big
description: Big 是一个形容词，主要用来描述大小、重要性或程度，比如大型的、巨大的、重要的、主要的。用于肯定句，它通常表示积极或重要的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Big" uk="/bɪɡ/" us="/bɪɡ/" client:only />
...
<WordRelations
  synonyms={["adult","ample","huge","jumbo","large","massive","sizeable","stoor","busty","macromastic","stacked","chubby","rotund"]}
  antonyms={["little","miniature","minuscule","minute","small","tiny","young"]}
  client:only
/>
