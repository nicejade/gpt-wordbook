...
description: >-
  Dumpling是一个英语名词,
  它通常指的是一小块面团，有时候可能会包含填充物（如肉或蔬菜）。这个词在不同的文化中可以有不同的含义，但最常见的就是中国的饺子。
sidebar:
  hidden: true
...
<Pronunciation word="Dumpling" uk="/ˈdʌmplɪŋ/" us="/ˈdʌmplɪŋ/" client:only />
...
"Dumpling"这个词在英语中已经有很长的历史，最早的书面记录可以追溯到 1600 年的英格兰。而饺子在中国的历史甚至更为悠久。虽然不同的文化中"dumpling"的样式和食材可能会有所不同，但它们都共享着把食物包裹在面团里的共性。
