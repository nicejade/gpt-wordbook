---
title: Appoint
description: Appoint是一个英语动词，意为“任命”或“指定”。它常用于表达命令某人填补某个职位，或者设定或决定特定的时间或地点。
sidebar:
  hidden: true
...
<Pronunciation word="Appoint" uk="/əˈpɔɪnt/" us="/əˈpɔɪnt/" client:only />
...
"Appoint"最早出现在 14 世纪，来自古法语单词"apointer"，本意是“安排、协定”。
