---
title: Dispute
description: Dispute 作为名词，常常表示'争论'或'争执'，作为动词时，则表示'争论'或'质疑'。
sidebar:
  hidden: true
...
<Pronunciation word="Dispute" uk="/ˈdɪs.pjuːt/" us="/dɪsˈpjuːt/" client:only />
...
"Dispute" 这个词在 13 世纪由法语引入英语，原意指的是讨论或争论某个话题。
