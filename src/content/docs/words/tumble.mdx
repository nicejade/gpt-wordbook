...
title: Tumble
description: >-
  tumble主要有两个基本含义：一是作为一个动词，意指“摔倒”、“翻滚”，如'The child tumbled down the
  stairs.'（孩子从楼梯上摔下来。）；二是作为一个名词，意指“跌倒”或者“混乱”，比如说 'His life has been a constant
  tumble of jobs and relationships.'（他的生活一直是工作和感情的不断混乱。）。
sidebar:
  hidden: true
...
<Pronunciation word="Tumble" uk="/ˈtʌmbl̩/" us="/ˈtʌmbl̩/" client:only />
...
<WordRelations synonyms={["touse"]} client:only />
