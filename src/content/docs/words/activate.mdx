---
title: Activate
description: Activate 是一个动词，中文意思主要是“激活”，“启动” 或者 “使生效”。 它常常用于描述使某种事物开始工作或运行。
sidebar:
  hidden: true
...
<Pronunciation word="Activate" uk="/ˈæktɪˌveɪt/" us="/ˈæktɪˌveɪt/" client:only />
...
"Activate" 的起源源于 1620 年，这是一个比较年轻的词。在欧美文化中，这个词常常与科技产品、信用卡或者政策生效等场景联系在一起。
...
<WordRelations
  synonyms={["actuate","enable","spur","start","stimulate","trigger"]}
  antonyms={["deactivate","inactivate"]}
  client:only
/>
