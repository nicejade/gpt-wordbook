...
title: Argument
description: >-
  Argument在英语中通常用作名词，其主要含义是争论、辩论或论点。当两个或多个人对某些事物的观点存在不合时，他们之间可能会发生“argument”（争论）。也可以指一个人支持或反对某事物的论据或理由。
sidebar:
  hidden: true
...
<Pronunciation word="Argument" uk="/ˈɑːɡjʊmənt/" us="/ˈɑɹɡjumənt/" client:only />
