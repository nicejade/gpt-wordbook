...
title: Jolly
description: >-
  Jolly是一个形容词，意思是'快乐的'，'愉快的'。也可以用作副词，表示'非常'或“相当”，用以加强语气。此外，'jolly'还可以作为动词用，意味着'劝诱'，'哄骗'。
sidebar:
  hidden: true
...
<Pronunciation word="Jolly" uk="/ˈdʒɒli/" us="/ˈdʒɒli/" client:only />
...
<WordRelations synonyms={["joey"]} client:only />
