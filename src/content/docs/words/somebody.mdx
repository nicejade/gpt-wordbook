---
title: Somebody
description: Somebody是个不定代词，意思是'某人'或'有人'，通常指未特指的或者不知名的人。
sidebar:
  hidden: true
...
<Pronunciation word="Somebody" uk="/ˈsʌmbədɪ/" us="/ˈsʌmbɑdi/" client:only />
...
<WordRelations synonyms={["someone"]} client:only />
