...
title: Project
description: >-
  Project是个非常有用的单词，同时具有动词和名词的用途。作为名词时，它通常指的是计划、方案或者任务，特别是需要计划和组织的工作。作为动词时，它有两个主要的含义：一是计划、设计或者提议某事，二是投射、发射或者投掷。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["cast","throw","extend","jut","protrude","forecast","foresee","foretell"]}
  client:only
/>
