...
title: Apology
description: >-
  Apology 是一个名词，主要有两个含义：1. 对错事行为的悔过或者表示歉意的言语或行为，例如：“I owe you an
  apology.”(我应该向你道歉。) 2. 辩解，辩护，例如：'This book is an apology for
  capitalism.'(这本书是对资本主义的辩护)。
sidebar:
  hidden: true
...
<WordRelations synonyms={["apologia"]} client:only />
