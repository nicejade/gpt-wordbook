---
title: Above
description: above主要有两层含义：1. 在位置上，表示 "在......上面"。比如 "The birds are flying above the trees"（鸟儿在树上飞翔）。2. 在数字或符号上，表示 "超过" 或 "以上"。如，“above 100”（超过 100）。
sidebar:
  hidden: true
...
2.  在数字或符号上，表示 "超过" 或 "以上"。如，“above 100”（超过 100）。

<Pronunciation word="Above" uk="/əˈbʌv/" us="/əˈbʌv/" client:only />
...
<WordRelations antonyms={["below", "beneath"]} client:only />
