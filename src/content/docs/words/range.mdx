...
title: Range
description: >-
  Range这个单词在英语中应用十分广泛，有两个主要的语义领域。一方面，'range'可以表示“范围”，“界限”，例如: the price range
...
<Pronunciation word="Range" uk="/ɹeɪndʒ/" us="/ɹeɪndʒ/" client:only />
...
<WordRelations
  synonyms={["base","compass","distance","radius"]}
  antonyms={["domain"]}
  client:only
/>
