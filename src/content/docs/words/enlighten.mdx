...
title: Enlighten
description: >-
  Enlighten 是一个动词，意思是'使明白'或者'启发'，它是关于传达知识或者洞察力的。当你向他人展示某种新的思考方式或者技能时，你就是在
  'enlighten' 他们。
sidebar:
  hidden: true
...
<Pronunciation word="Enlighten" uk="/ənˈlaɪtn̩/" us="/ənˈlaɪtn̩/" client:only />
...
<WordRelations
  synonyms={["apprise", "inform", "notify", "illuminate", "illumine"]}
  antonyms={["endarken"]}
  client:only
/>
