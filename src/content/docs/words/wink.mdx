...
title: Wink
description: >-
  Wink是一个英语动词，表示快速眨眼的动作，特别是一只眼睛。这通常被用来表示某种秘密信息或令人同情的信息。作为一个名词，'wink'指的是快速眨眼的动作或瞬间。
sidebar:
  hidden: true
...
<Pronunciation word="Wink" uk="/ˈwɪŋk/" us="/ˈwɪŋk/" client:only />
...
"Wink" 这个单词有点像"Win"+"K"，想象你一眨眼你就"赢了(K 为了发音)"，可能会帮助你记住它。
...
<WordRelations synonyms={["connive", "nictitate"]} client:only />
