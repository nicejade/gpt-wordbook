---
title: Absurd
description: Absurd（英）/əbˈsɜːd/（音标）
sidebar:
  hidden: true
...
<Pronunciation word="Absurd" uk="/æbˈzɝd/" us="/æbˈsɝd/" client:only />
...
Absurd 的拉丁语词根是'surdus'，意思是'聋的，不听话的'。据推测，这个词初始化可能是用来形容那些不听从建议或警告，行为看起来愚蠢或不符合逻辑的人。
...
Absurd 这个词出自拉丁词“absurdus”，意思是“不和谐的”，后来在法语和英语中发展为“讲话或行为愚蠢、荒谬的”含义。
