---
title: Expend
description: Expend 是一个动词，意思是'花费'或'用尽'。它有两种基本含义。一种是花费金钱，另一种是用尽或消耗某种无形的资源，如时间或精力。
sidebar:
  hidden: true
...
<Pronunciation word="Expend" uk="/ɛkˈspɛnd/" us="/ɛkˈspɛnd/" client:only />
...
"Expend" 这个词在 15 世纪从拉丁语引入英语，最初的用法跟现在相似，主要指的是花费资源或精力。
