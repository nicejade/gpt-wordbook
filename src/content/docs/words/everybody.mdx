...
title: Everybody
description: >-
  - 'Everybody' 是一个指代性的词，常被用来指代一组相关的所有人。等同于英语中的 'all people' 或 'all
  persons'。中文的翻译一般为 '每一个人' 或 '大家'。
sidebar:
  hidden: true
...
<Pronunciation word="Everybody" uk="/ˈɛvɹibɒdi/" us="/ˈɛvɹibɑdi/" client:only />
