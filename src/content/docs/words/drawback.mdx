---
title: Drawback
description: Drawback 是一个名词，表示缺点或不利条件。它用于描述事物的负面特征或对特定目标的妨碍。
sidebar:
  hidden: true
...
<Pronunciation word="Drawback" uk="/ˈdɹɔːˌbæk/" us="/ˈdɹɔːˌbæk/" client:only />
...
"Drawback" 最初出现在 16 世纪，当时用来指代退税。到了 19 世纪，人们开始将它用在更广泛的语境中，用来描述各种阻碍或障碍。
