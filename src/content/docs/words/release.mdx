---
title: Release
description: Release主要有两大类含义：一是动词，表示“释放”、“发行”或“解放”。另一种是名词，表示“释放”、“发行”或“解放的行为”。
sidebar:
  hidden: true
...
<Pronunciation word="Release" uk="/ɹɪˈliːs/" us="/ɹɪˈliːs/" client:only />
...
"Release"源自古法语"relaisser"，原意为"让债务无偿"或"取消质押约束"。它在 14 世纪初使用在法律语境中，用于描述财产转让的概念。此外，"Release"还广泛用于描述动物或者人的释放行为。
...
<WordRelations antonyms={["hold"]} client:only />
