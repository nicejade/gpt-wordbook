---
title: Void
description: Void是一个英语单词，既可以用作名词，也可以用作形容词。作为名词，它的意思是'空白'、'真空'或'无效';作为形容词，它的意思是'空的'、'无效的'。
sidebar:
  hidden: true
...
<Pronunciation word="Void" uk="/vɔɪd/" us="/vɔɪd/" client:only />
...
"Void"的使用可以追溯到 14 世纪，其主要的含义和使用在 19 世纪得到确立。
...
<WordRelations
  synonyms={["pore", "bubble", "evacuate", "annul", "cancel"]}
  client:only
/>
