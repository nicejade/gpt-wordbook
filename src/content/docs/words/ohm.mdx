---
title: Ohm
description: Ohm 是电阻的单位，符号为 Ω。它是基于真空中的一段长为 1 米、截面积为每平方米 1 座的直导体在端到端的电势差为 1 伏特时所产生的电阻。
sidebar:
  hidden: true
...
<Pronunciation word="Ohm" uk="/əʊm/" us="/əʊm/" client:only />

### 列举例句

1.  This wire is 100 ohms per meter. (这根导线每米有 100 欧姆的电阻。)
2.  The resistance of this circuit is 15 ohms. (这个电路的电阻为 15 欧姆。)
3.  This lamp needs an 8-ohm resistor. (这盏灯需要一个 8 欧姆的电阻。)

### 词根分析

"Ohm" 来自于著名物理学家 Georg Simon Ohm 的名字，他在 19 世纪发表了奠基性的电磁学研究。没其它单词是由此词根衍生出来的。
...
(有一个小女孩热爱科学实验。一天，她决定制作一个简单的电路。她需要的就是一个灯泡，一些导线，和一个 8 欧姆的电阻。)
