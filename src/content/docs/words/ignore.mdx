---
title: Ignore
description: ignore 是一个动词，意思是“忽视”，“不理睬”。它表示对某事或某人的不关注、无视或者刻意避开。
sidebar:
  hidden: true
...
<Pronunciation word="Ignore" uk="/ɪɡˈnɔː/" us="/ɪɡˈnɔɹ/" client:only />
...
<WordRelations
  synonyms={["connive","dissimulate","overlook","misheed","neglect","unheed","unmind"]}
  antonyms={["know","notice","observe","recognize","watch"]}
  client:only
/>
