---
title: "draw"
description: "Draw是一个非常常用的英语单词，它有多种含义： 1. 提取或取出某物，如 draw water from a well（从井里提水）。 2. 制作草图或图画，如 draw a picture（画一幅画）。 3. 使某物物移向某处，如 draw the curtains（拉开窗帘）。 4. 制定或阐述（如计划或协议），例如 draw up a list（编制清单）。"
---
