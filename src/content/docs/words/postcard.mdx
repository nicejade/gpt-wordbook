---
title: Postcard
description: Postcard 是名词，意为 '明信片'。它是指通常印刷有风景图片的一张小卡片，在未封闭的一面上可以写上文字后通过邮寄。
sidebar:
  hidden: true
...
“Postcard”这个单词源于 19 世纪的邮政系统，这个系统为众多人提供了便利，让他们能够和远方的人保持联系。这也是明信片在欧美文化中的内涵：热衷于旅行和交流的象征。
