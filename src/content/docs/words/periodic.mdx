---
title: Periodic
description: 英文单词 periodic 意味着“周期性的，定期的”，用于形容那些按一定时间间隔反复发生或出现的事物。
sidebar:
  hidden: true
...
英文单词 periodic 意味着“周期性的，定期的”，用于形容那些按一定时间间隔反复发生或出现的事物。

<Pronunciation word="Periodic" uk="/ˌpɪə-/" us="/ˌpɪɹiˈɑdɪk/" client:only />
...
Periodic 来自拉丁词根"peri-"，表示“周围、重复”，与周期、周围有关的词汇大多源自此词根。
...
单词"periodic"来自于 17 世纪的英语，原始含义与时间、循环和常规的反复出现有关，因此在英美文化中，此单词常被用于描述规律性的事务和事件。
...
<WordRelations synonyms={["cyclic"]} antonyms={["aperiodic"]} client:only />
