...
title: Cave
description: >-
  Cave 作为名词指的是自然形成的空洞或空腔，通常位于地下或正在某些类型的岩石中。这个词也常用来形容人为挖掘的地下空间。作为动词，'cave'
  又有另外的含义，如'to give in or yield under pressure'（在压力下放弃或让步）。
sidebar:
  hidden: true
...
<Pronunciation word="Cave" uk="/keɪv/" us="/keɪv/" client:only />
...
<WordRelations synonyms={["earthhole", "spelunk"]} client:only />
