---
title: Broom
description: Broom是一个英语单词，主要的意思是'扫帚'，它是家庭清洁工具的一种，通常由硬毛或草束等固定到一个长柄上，用来清扫地面的杂物。
sidebar:
  hidden: true
...
<Pronunciation word="Broom" uk="/bɹuːm/" us="/bɹuːm/" client:only />
...
<WordRelations synonyms={["besom"]} client:only />
