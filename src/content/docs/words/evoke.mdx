---
title: Evoke
description: Evoke 是一个动词，它的含义是激起，引起，或者唤起。这个单词常常用于描述不同类型的感觉或反应，如激起情绪，唤起记忆，引发讨论等。
sidebar:
  hidden: true
...
<Pronunciation word="Evoke" uk="/ɪˈvəʊk/" us="/ɪˈvoʊk/" client:only />
...
Evoke 的词根是拉丁词“vocare”，意为“召唤”或“呼唤”，这也是单词"voice"(声音)和"vocal"(发声的)的词根。
...
Evoke 这个词在 17 世纪开始在英文中使用，最初被用在法律语境中，意为“召唤”或“呼唤”。随后其意义逐渐拓展，如今用以指任何形式的"召唤"或"唤起"。
