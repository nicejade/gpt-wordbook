---
title: Daily
description: Daily 是一个形容词，表示“每日的，日常的”，也可作副词，表示“每日，日常地”。还可作名词，用于表示“日报”。
sidebar:
  hidden: true
...
<Pronunciation word="Daily" uk="/ˈdeɪli/" us="/ˈdeɪli/" client:only />
...
<WordRelations synonyms={["help", "maid", "quotidian"]} client:only />
