---
title: Bath
description: Bath 主要有两种解释，一种是作为名词，指的是 '浴室' 或者 '洗澡'。另一种是作为动词，以一种清洁的方式使用水是身体或其他物体，例如'给宠物洗澡”。
sidebar:
  hidden: true
...
<Pronunciation word="Bath" uk="/bɐːθ/" us="[bæθ⁓bɛəθ⁓beəθ]" client:only />
...
"Bath" 一词在英语中的使用可以追溯到公元前 1000 年，受到诸如罗马和希腊等文化的影响，它们高度重视公共洗浴设施的使用。
