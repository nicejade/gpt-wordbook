---
title: Violate
description: Violate 是一个动词，意思是“违反”。被广泛用于指违反规则、法律、习俗、道德等。
sidebar:
  hidden: true
...
<Pronunciation word="Violate" uk="/ˈvaɪəˌleɪt/" us="/ˈvaɪəˌleɪt/" client:only />
...
<WordRelations antonyms={["comply", "obey"]} client:only />
