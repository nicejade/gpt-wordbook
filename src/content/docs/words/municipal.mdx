...
title: Municipal
description: >-
  Municipal 是个形容词，通常用于描述归城市或市政府所有，管理或控制的事物。例如，'municipal
  government'（市政府）、'municipal library'（市立图书馆）或 'municipal workers'（市政工人）。
sidebar:
  hidden: true
...
<WordRelations synonyms={["civic"]} client:only />
