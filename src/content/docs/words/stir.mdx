...
title: Stir
description: >-
  Stir是一个常见的英语单词，具有多种含义，总的来说，它主要有两个核心含义。一是“搅拌”，如搅拌食物或液体；二是“激发、激起”，如激发人们的情感或者引起公众关注等。
sidebar:
  hidden: true
...
<Pronunciation word="Stir" uk="/stɜː/" us="/stɝ/" client:only />
...
“Stir”这个词在 14 世纪时产生，它最早的意思是 "设置运动" ，后来逐渐引申出多种含义。
...
<WordRelations
  synonyms={["arise","rouse","arouse","excite","instigate","prompt"]}
  client:only
/>
