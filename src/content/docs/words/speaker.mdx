---
title: Speaker
description: Speaker 在英语中有两种主要含义：一是指演讲者、讲话者，即正在发言或演讲的人。二是指扬声器或喇叭，常用于音响设备。
sidebar:
  hidden: true
...
<Pronunciation word="Speaker" uk="/ˈspiːkə/" us="/ˈspikɚ/" client:only />
...
<WordRelations synonyms={["talker"]} client:only />
