---
title: Entrance
description: "Entrance 是一个英语词，作为名词时它主要有两个含义：1.入口, 入场的地方；2.进入，开始。而作为动词时，它的意思是'使入迷，使着迷'。"
sidebar:
  hidden: true
...
<Pronunciation word="Entrance" uk="/ˈɛn.tɹəns/" us="/ˈɛn.tɹəns/" client:only />
...
<WordRelations synonyms={["ingang"]} antonyms={["exit"]} client:only />
