...
title: Collect
description: >-
  Collect作为动词，主要有“收集、聚集、搜集”等意思，常被用于指收集物品、信息、钱款等等。同时也可以表示“接（人）”如： collect the
...
<Pronunciation word="Collect" uk="/kəˈlɛkt/" us="/kəˈlɛkt/" client:only />

### 列举例句

1.  "She collects stamps as a hobby." 她的爱好是收集邮票。
2.  "I'll collect you at the train station at 6 pm." 我会在下午 6 点在火车站接你。
...
"Collect"中的"co-"是共同的意思，"-lect-"是收集的意思，所以 collect 是共同收集的意思。

### 文化背景

"Collect"一词源于拉丁语 collectus，意为"gather together"，这个词的动词形式从 14 世纪开始在英语中以"to gather, assemble"的意思使用，后来扩展到"to gather into one body or place, assemble"，现今它有着广泛的使用，比如收集物品、信息、或指接人等。
...
<WordRelations
  synonyms={["amound","gather","group","mass","merge","aggregate","receive","secure","assume","construe"]}
  client:only
/>
