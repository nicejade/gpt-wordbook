...
title: Grey
description: >-
  Grey是英式英语里的一个形容词，它在美式英语中通常被拼写成'gray'。这个单词用来描述类似于铅或烟尘的颜色，即介于黑色和白色之间的中性色。更广义的意义上，它也常被用于比喻或形容阴天、暗淡无光、模糊的情况。
sidebar:
  hidden: true
...
<Pronunciation word="Grey" uk="/ɡɹeɪ/" us="/ɡɹeɪ/" client:only />
