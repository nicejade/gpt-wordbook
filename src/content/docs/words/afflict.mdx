---
title: Afflict
description: Afflict 是动词，表示使某人受病痛或痛苦折磨，或给某人带来伤害、困扰。
sidebar:
  hidden: true
...
<Pronunciation word="Afflict" uk="/əˈflɪkt/" us="/əˈflɪkt/" client:only />
...
Afflict 的词根是`-flict-`，来自拉丁语词根`-flict-`，意为“战斗”。
...
可以想象 flict 这一部分代表了 fight（战斗），所以 afflict 就是一个人被病痛战斗或者折磨。
