...
title: Vast
description: >-
  Vast是一个形容词，意思是“广阔的”，“无边无际的”，“巨大的”，“大量的”，通常用于描述空间、数量或程度的大小。例如：“vast areas of
  forest”（广阔的森林地带）。
sidebar:
  hidden: true
...
<Pronunciation word="Vast" uk="/vɑːst/" us="/væst/" client:only />
...
"Vast"这个词从 17 世纪开始出现在英语中，表示“广阔的”或“无限的”意义，最初指物理的或空间的大，后来也被用来形容数量或程度。
