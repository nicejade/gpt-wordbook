...
description: >-
  Autonomy
  是个名词，指的是自主，独立，或者自我决定的权利。常用于形容个体或组织能自行决定和负责其行为的能力。对于人，这可能意味着独立思考和决策的能力；对于国家和政策，可能是指自治状态。
sidebar:
  hidden: true
...
<Pronunciation word="Autonomy" uk="/ɑˈtɑnəmi/" us="/ɔˈtɑnəmi/" client:only />
...
<WordRelations
  ...
  antonyms={["incapacity","dependency"]}
  client:only
/>
