...
title: Thorough
description: >-
  Thorough是一个形容词，它的主要意思为彻底的，完全的。当你坚决做好某件事，且尽己以尽，非常的复杂，仔仔细细，并检查所有细节，就可以用'thorough'来形容。它也可以形容一个人对于工作非常彻底，非常的啰嗦，一丝不苟。
sidebar:
  hidden: true
...
<Pronunciation word="Thorough" uk="/ˈθʌɹə/" us="/ˈθɜɹoʊ/" client:only />
...
"Thorough"的一种早期拼写形式是“thuruh”，这是在中世纪早期英语中使用的。它来自古英语的 "thurh"，意思是"从...穿过"。这个词在英语中始终保持了"完成"的含义。在 16 世纪和 17 世纪，"thorough"的本义被强化，常用于描述严谨的行为和态度。
