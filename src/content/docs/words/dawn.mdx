...
title: Dawn
description: >-
  Dawn 是一个英文名词，最直观的意思是 ‘黎明’ 或
  ‘拂晓’，这种词指的是日出的时间，白天刚开始的那一刻。它也可以作为动词使用，指的是开始理解或意识到某件事。
sidebar:
  hidden: true
...
<Pronunciation word="Dawn" uk="/doːn/" us="/dɔn/" client:only />
...
<WordRelations
  synonyms={["beginning","onset","start","daybreak","dayspring","sunrise","sunup"]}
  antonyms={["dusk"]}
  client:only
/>
