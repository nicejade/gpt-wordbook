...
title: Gradient
description: >-
  Gradient在英语中主要有两个含义。它可以表示物理学中的'渐变，梯度'，用来描述某一物理量（如温度，压力等）在空间中的变化速率。此外，它也可用于几何学和计算机图形学中，表示“颜色渐变”。
sidebar:
  hidden: true
...
"Gradient"一词在 18 世纪由拉丁词“gradus”演变而来，最初应用于数学和物理学领域，后来也被引入到计算机图形学中，表示颜色的逐渐变化。
...
<WordRelations
  synonyms={["angular", "coefficient", "slope", "hill", "incline", "ramp"]}
  client:only
/>
