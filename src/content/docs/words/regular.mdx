...
<WordRelations
  synonyms={["patron","absolute","thorough","basic","common","unremarkable","tidy","tumultuous","frequent","decent","seemly"]}
  antonyms={["irregular","degenerate","goofy","outlandish","weird","strong"]}
  client:only
/>
