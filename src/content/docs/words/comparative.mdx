---
title: Comparative
description: Comparative 是一个形容词，它的核心含义是“比较的，相较的”。用于描绘两者之间进行对比或具有相互比较性质的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Comparative" uk="/kəmˈpæɹ.ə.tɪv/" us="/kəmˈpɛɹ.ə.tɪv/" client:only />
...
"Comparative"这个词最早源于 14 世纪的法语，其词根是 "comparatif"，进而发展成为我们今天所使用的英语单词 "comparative"。
