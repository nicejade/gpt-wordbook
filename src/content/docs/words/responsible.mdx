---
title: Responsible
description: Responsible是一个形容词，原意是“负责的，负有责任的”，常用于描述一个人对他的任务、工作、决定、行为等负有责任。
sidebar:
  hidden: true
...
"Responsible"一词从 16 世纪中叶开始在英语中使用，原意“答复”，后来的含义是“有责任”。在我们的文化中，被视为“负责任”的人通常被高度赞扬和尊重。
...
<WordRelations antonyms={["irresponsible"]} client:only />
