---
title: Reputation
description: Reputation 是一个名词，指的是一个人或一个组织在别人眼中的印象或评价，类似中文中的“名声”，“声誉”。
sidebar:
  hidden: true
...
“Reputation”一词在 14 世纪中叶首次出现在英文中，最初的含义更偏向“认为”，与拉丁语的原词义相同。后来的意义渐渐变为“名声”或“声誉”。
...
<WordRelations synonyms={["name"]} client:only />
