---
title: Face
description: Face这个单词大家都知道，它有很常见的词义，最基本的含义是指一个人的脸，但实际应用中，这个单词却有很多不同的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Face" uk="/feɪs/" us="/feɪs/" client:only />
...
<WordRelations
  synonyms={["countenance","expression","look","visage","facet","surface","phiz","phizog","image","reputation","cakehole","gob","mush","piehole","trap","hero","foreside"]}
  antonyms={["heel"]}
  client:only
/>
