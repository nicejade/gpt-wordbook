...
title: Harsh
description: >-
  Harsh 是一个形容词，主要有三个含义：（1）刺激感强烈的，如：harsh light 是指刺眼的光。 （2）严酷的，不公平的，如: harsh
  punishment 则是指严酷的惩罚。 （3）（声音）刺耳的，难听的，如: harsh voice 是指嘶哑的、刺耳的声音。
sidebar:
  hidden: true
...
<Pronunciation word="Harsh" uk="/hɑːʃ/" us="/hɑːʃ/" client:only />
...
<WordRelations synonyms={["rough"]} antonyms={["genteel"]} client:only />
