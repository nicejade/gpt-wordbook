---
title: crossroads
description: Crossroads 有两个主要含义。一是字面意思指“十字路口”或者“交叉路口”，两条或者多条路交汇的地方。二是象征意义，表示抉择的重要时刻或转折点。
sidebar:
  hidden: true
...
- Cross-作为一个词缀，表达“相交，交叉”的意思，我们能够在单词像 crossbar（横杆）、crosswalk（斑马线）中看到它的应用。
- \-roads 在这里并不是作为词缀使用，而是作为单词的一部分。但在某些词语中，-road/-rd 有相应的道路、途径的含义，例如 railroad（铁路）、broad（宽的，广阔的）。
