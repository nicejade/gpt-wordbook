---
title: Four
description: "- 'Four' 是英文中的基数词，表示数量为 4。例如在倒数，'four, three, two, one, zero'（四、三、二、一、零）。"
sidebar:
  hidden: true
...
- "Four" 是英文中的基数词，表示数量为 4。例如在倒数，"four, three, two, one, zero"（四、三、二、一、零）。

<Pronunciation word="Four" uk="/foː/" us="/fɔɹ/" client:only />
