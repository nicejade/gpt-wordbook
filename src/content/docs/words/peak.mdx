---
title: Peak
description: Peak 一般指的是山峰、巅峰，是一处物体的边缘或表面形成的最高点，也长用来描绘某个过程或者状态的最高点。
sidebar:
  hidden: true
...
<Pronunciation word="Peak" uk="/piːk/" us="/piːk/" client:only />
...
"Peak" 最早在 14 世纪被记录用来表示“山顶”或“尖端”，源自古英语，有着表示“锥形尖顶”之意。
...
<WordRelations
  synonyms={["apex", "pinnacle", "summit", "top", "culminate", "hench"]}
  client:only
/>
