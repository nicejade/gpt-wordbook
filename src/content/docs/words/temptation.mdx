...
title: Temptation
description: >-
  Temptation是一个名词，翻译为中文就是“诱惑”、“引诱”。这个单词的含义是指引发某人进行某种行为或感到想要做某事的事物或影响。通常，这种行为或想法可能对人不利，或者和一般的社会道德标准相反。
sidebar:
  hidden: true
...
"Temptation"的词根是 Latin 词根"tempt-"，此词根的意思是“试图，测试”。其他同词根衍生的单词还有：tempt（诱惑）、attempt（尝试）等。
...
这个单词最早出现在 14 世纪，来自于拉丁词"temptationem"，含义是“试验、尝试”。在文化中，它通常与道德冲突和精神挣扎有关，出现在许多宗教故事中。
...
<WordRelations synonyms={["fitna"]} client:only />
