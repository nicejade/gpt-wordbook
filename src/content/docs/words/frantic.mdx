...
title: Frantic
description: >-
  英文单词 "frantic" 用作形容词，通常用来描述过度焦虑、过于激动乃至接近疯狂的状态，或者活动和行为的狂野、疯狂。 **举例句子**： 1. He
  made frantic efforts to keep us warm. (他疯狂地尽力让我们保暖。) 2. She was in a frantic
  rush to get ready. (她匆忙得几乎疯狂地准备着。) 3. The city was frantic with joy.
  (全城因喜悦而欢腾。)
sidebar:
  hidden: true
...
单词 "frantic" 的使用自 14 世纪起就固定为 "疯狂的" 或 "狂热的"。在历史文献中，"frantic" 主要用于描述极度的情绪激动或执念。现如今，它也用来描述繁忙和紧张的情况。
