---
title: Frantic
description: 英文单词 'frantic' 用作形容词，通常用来描述过度焦虑、过于激动乃至接近疯狂的状态，或者活动和行为的狂野、疯狂。
sidebar:
  hidden: true
...
<Pronunciation word="Frantic" uk="/ˈfɹæntɪk/" us="/ˈfɹæntɪk/" client:only />
...
<WordRelations synonyms={["frenetic", "frenzied"]} client:only />
