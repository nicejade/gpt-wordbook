---
title: Unethical
description: "- 'Unethical' 是一个形容词，它通常用来描述违反道德原则的行为或局面。"
sidebar:
  hidden: true
...
这个单词在公元 14 世纪于英格兰开始流行，被用来描述违反社区道德规范的行为。而现在，这个词常被用在描述商业，科学，或者其他某种专业领域中的不道德行为。
...
<WordRelations antonyms={["ethical"]} client:only />
