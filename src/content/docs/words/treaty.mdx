---
title: Treaty
description: Treaty 是一个名词，主要指的是两个或更多的国家间正式的、有法律效应的协定或合约。词汇的含义彰示了国际法的核心元素，它们用来规定国与国之间的权利和义务。
sidebar:
  hidden: true
...
<Pronunciation word="Treaty" uk="/ˈtɹiːti/" us="/ˈtɹiːti/" client:only />
...
"Treaty" 一词源自中古法语，指的是协议或合约。自 17 世纪以来，这个词在英语中主要用来指代国家之间为了解决具体问题而达成的正式协议。
...
<WordRelations synonyms={["convention", "covenant", "protocol"]} client:only />
