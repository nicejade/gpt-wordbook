...
title: Disabled
description: >-
  Disabled是一个形容词，来源于动词'disable'，表示“残疾的”，“有生理或者心理缺陷的”。也可以用于描述物体或者系统，“无法正常工作的”，“被禁用的”。
sidebar:
  hidden: true
...
<Pronunciation word="Disabled" uk="[dɪsˈeɪbəɫd]" us="[dɪsˈeɪbəɫd]" client:only />
...
<WordRelations
  synonyms={["deactivate","unable","incapacitated","indisposed","invalid"]}
  antonyms={["enable","enabled"]}
  client:only
/>
