...
description: >-
  Perch
  是个英语词语，它有两个主要的意义。一种是作为名词，指的是一种甜水或盐水鳍鱼，称为鲈鱼。它也可以用来形容一个高出地面的地方或者位置，比如鸟在树枝上的位置。另一种是作为动词，表示坐在或站在某个位置，特别是高出或突出的位置。
sidebar:
  hidden: true
...
<Pronunciation word="Perch" uk="/pɜːtʃ/" us="/pɝtʃ/" client:only />
...
'Perch' 这个词最初于 12 世纪进入英语，源自拉丁文，其中它被用来指代鱼类。
