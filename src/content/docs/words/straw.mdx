...
title: Straw
description: >-
  Straw是一个英语单词，主要有两种意思。首先，它可以表示'稻草'，也就是粮食作物经过收获和脱粒后剩下的植物秸秆。另一个常见的意思是'吸管'，它是一种薄而通常是塑料制成的管子，人们可以通过它从容器中吸饮料。
sidebar:
  hidden: true
...
<Pronunciation word="Straw" uk="/stɹɔː/" us="/stɹɔ/" client:only />
...
"Straw"一词追溯到公元 1000 年左右的古英语，由"streaw"一词演变而来。在欧美文化中，"straw"被广泛应用于各个领域，如农业、艺术、环保等。
...
<WordRelations synonyms={["strawen"]} client:only />
