---
title: Gruel
description: Gruel是一个英语名词，意为稀粥。在英语中，这个词常常用来引用一种很薄弱、没有营养的稀粥食品。
sidebar:
  hidden: true
...
<Pronunciation word="Gruel" uk="/ɡɹuː(ə)l/" us="/ɡɹuː(ə)l/" client:only />
...
"Gruel"源自 12 世纪的法语单词"gruau"，在英语中，这个词常常用于描述一种薄而缺乏营养的饭菜。
