---
title: Paw
description: paw在英语中常常被指作动物的脚爪，特别是哺乳动物。该词亦可作为动词，描绘动物用爪子触摸或挠的动作。
sidebar:
  hidden: true
...
<Pronunciation word="Paw" uk="/pɔː/" us="/pɔ/" client:only />
...
“paw”这个单词源自 14 世纪的古英语，随着时间的推移，它的发音和拼写都有一些变化。
...
<WordRelations synonyms={["foot", "hand"]} client:only />
