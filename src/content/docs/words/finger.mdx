---
title: Finger
description: 'Finger一词是英语中的一个常见称呼，通常用来指代人类或动物的手指或者脚趾。此外，它也可用作动词，表示“用手指触摸, 揉搓, 抚摸等”。'
sidebar:
  hidden: true
...
<Pronunciation word="Finger" uk="/ˈfɪŋəɹ/" us="/ˈfɪŋɡɚ/" client:only />
...
"Finger"这个单词没有明显的词根和词缀，可以看成$is 一个整体，来自于古英语的"finger"。
...
<WordRelations
  synonyms={["bloke","boy","guv","lad","digit","tendril","fingering","technique","touch","claw","talon","toe","fingerbang","fingerfuck","inform","snitch"]}
  client:only
/>
