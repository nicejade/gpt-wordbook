...
description: >-
  Bump
  在英语中有多个含义，其基本意思是“碰撞”或“崎岖”。当它作为动词时表示“碰撞”，例如，你可能会走进一个桌子或墙壁并“碰撞”一下。作为名词时，它通常指一个小型上升或突出点，例如路上的“颠簸”。
sidebar:
  hidden: true
...
<Pronunciation word="Bump" uk="/bʌmp/" us="/bʌmp/" client:only />
...
"Bump" 这个词首次出现在英语中是在 16 世纪，它的语源可能源于北欧语言中表示“撞击”或“颠簸”的词汇。
