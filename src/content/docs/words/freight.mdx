...
title: Freight
description: >-
  Freight是一个名词，表示货物，尤其是大宗货物或批发货物。它也可以用作动词，表示运送货物，关于运费的形容词和名词用法也经常使用。在英美社会中，这个词被广泛用于物流和运输业。
sidebar:
  hidden: true
...
<Pronunciation word="Freight" uk="/fɹeɪt/" us="/fɹeɪt/" client:only />
...
"Freight"的使用可以追溯到 14 世纪，最初在中古英语中表示货运，或者指一个船只的货物。
...
- 动词：Freight（运送货物）
- 形容词：Freight（货运的）
- 与之相关的词：Freightage, Freightliner, Freight train 等。
...
<WordRelations synonyms={["cargo", "luggage"]} client:only />
