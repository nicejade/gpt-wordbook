...
description: >-
  Shout
  是一个动词，它的基本意思是'大声呼喊'或'尖叫'。这个词也可以表示'大声说出'或者'公开表明'。为了表达强烈的情绪，如愤怒、痛苦或快乐，人们经常会大声喊叫。同时，'shout'
  也可能会用作名词，表示'喊叫声'或者'呼喊'。
sidebar:
  hidden: true
...
<Pronunciation word="Shout" uk="/ʃaʊt/" us="/ʃaʊt/" client:only />
