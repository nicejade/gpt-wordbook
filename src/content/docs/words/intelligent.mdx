---
title: Intelligent
description: Intelligent 是一个形容词，主要用来描述有较高智商的人或能进行复杂操作和理解复杂概念的机器。也经常用来表示具备良好理解力、领悟能力和判断力的品质。
sidebar:
  hidden: true
...
"Intelligent" 在 14 世纪从拉丁语被引入英语，原意是“理解”的能力。它在古罗马文化中，被用来形容那些有思考、理解和判断能力的公民。
...
<WordRelations antonyms={["stupid"]} client:only />
