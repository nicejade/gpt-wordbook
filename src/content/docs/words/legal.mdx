...
description: >-
  Legal
  是一个形容词，表示与法律有关的或者按照法律的。例如，如果一件事情是'legal'，它是按照法律的，是合法的。如果人或事物是'legal'，它们与法律有关。
sidebar:
  hidden: true
...
<Pronunciation word="Legal" uk="/ˈliː.ɡəl/" us="/ˈliɡəl/" client:only />

### 列举例句

1.  Smoking is not legal for people under 18 years old. （18 岁以下的人抽烟是不合法的。）
...
"Legal"来自于 13 世纪的拉丁语"legalis"，在英语中，它经常用于与法律有关的情境，代表满足法律要求的标准。
...
<WordRelations
  antonyms={["illegal","undocumented","banned","contraband","disallowed","forbidden","outlawed","unlawful","underage"]}
  client:only
/>
