---
title: Preface
description: Preface 是一个名词，通常指书籍前面的部分，也就是序言。序言通常是作为书籍的开端，由作者或编辑用来介绍和解释书籍内容或书写背景的部分。
sidebar:
  hidden: true
...
<Pronunciation word="Preface" uk="/ˈpɹɛfəs/" us="/ˈpɹɛfəs/" client:only />
...
"Preface" 这个单词源于拉丁语 "præfacere"，意思是 "say beforehand"，在 14 世纪的英语中，意思是 "to say or write before", 最终演变为我们现在的 包含写作和演讲的开场白，序言的意思。
...
<WordRelations
  synonyms={["foreword","introduction","prologue","prelude"]}
  client:only
/>
