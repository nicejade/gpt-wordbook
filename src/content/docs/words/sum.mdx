---
title: Sum
description: Sum一词在英语中有着多种含义。基本的意思是“总数”，通常用于一组数或概念的总和。此外，它还可以指代数学问题或方程的问题总结。
sidebar:
  hidden: true
...
<Pronunciation word="Sum" uk="/sʌm/" us="/sʌm/" client:only />
...
"Sum"一词起源于 14 世纪的英格兰，最初被用来描述财富的总量。之后，这个概念逐渐扩展，包括任何可以被添加或组合在一起的物品或概念。
...
<WordRelations
  synonyms={["calculation","computation","center","centre","core","essence","gist","heart","inwardness","kernel","marrow","meat","nub","pith","substance","quarter","amount"]}
  client:only
/>
