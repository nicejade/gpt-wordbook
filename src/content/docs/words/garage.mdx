---
title: Garage
description: Garage 是名词，意思是 '车库'，即一个用于停放和维护汽车的建筑。也可以作为动词，意思是 '开到车库' 或者 '修理车辆'。
sidebar:
  hidden: true
...
<Pronunciation word="Garage" uk="/ˈɡæɹɑː(d)ʒ/" us="/ɡəˈɹɑː(d)ʒ/" client:only />
...
Garage 的词根来源于法语的"garer"，这个词的含义是"shelter"（庇护）。
...
Garage 这个词汇源于法国语言，于 1902 年首次在英语中使用，最初是描述一个建筑或地点，用于储存，维护，或修理机动车辆。
...
你可以把 garage 联想成 garden（花园）,因为它们都是房子的重要部分。
