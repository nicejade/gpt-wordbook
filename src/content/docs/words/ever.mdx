...
title: Ever
description: >-
  Ever是一个广泛使用的副词，通常用来强调在任何时间或情况下的情况。它的基本含义可以理解为'在任何时候'或'从前'。例如，'Have you ever
  been to Paris?'（你曾经去过巴黎吗？）。
sidebar:
  hidden: true
...
<Pronunciation word="Ever" uk="/ˈɛvə/" us="/ˈɛvɚ/" client:only />
...
“Ever”起源于早期英语 æfre，意为“永远”或“始终”，在古英语中，它还可能与"每，每一个"有关。这个词在英语中的用法非常广泛，成为了很多短语的一部分。
