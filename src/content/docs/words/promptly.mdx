---
title: Promptly
description: Promptly 是一个副词，意思是“迅速地，立即”，用于描述某个动作发生的速度。
sidebar:
  hidden: true
...
<Pronunciation word="Promptly" uk="/ˈpɹɒmptli/" us="/ˈpɹɑmptli/" client:only />
...
Promptly 的词根是"prompt"，"prompt"来源于拉丁单词"promptus"，意思是“立即可用的，准备好的”。所以，一些从"prompt"衍生出的其他单词，如 unprompted（未经提示的）、prompter（提示者）等，也和“即时，迅速以及准备好的”这个概念有关。
...
可以将 promptly 一词与 prompt (立即的)关联，再将 ly 后缀理解为“以...的方式”，所以 promptly 就是“以立即的方式”，即“立即地，迅速地”。
