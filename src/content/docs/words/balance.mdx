...
<WordRelations
  synonyms={["equilibrium","account","scales","disinterest","fairness","impartiality","neutrality"]}
  antonyms={["imbalance","bias","favor","favour","partiality","partisanship","prejudice","unfairness"]}
  client:only
/>
