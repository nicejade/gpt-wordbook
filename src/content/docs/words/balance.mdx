...
description: >-
  Balance
  通常有两个主要含义。第一，作为名词时，表示'平衡'或'均衡'，用来形容两种或更多不同的元素处于和谐或等同的状态。第二，作为动词时，表示'使平衡'或'使均衡'，用来形容使事物处于平稳或相等的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Balance" uk="/ˈbæləns/" us="/ˈbæləns/" client:only />
...
<WordRelations
  synonyms={["equilibrium","account","scales","weighbridge","disinterest","fairness","impartiality","neutrality","nonpartisanship"]}
  antonyms={["imbalance","nonequilibrium","unbalance","bias","favor","favour","partiality","partisanship","prejudice","unfairness"]}
  client:only
/>
