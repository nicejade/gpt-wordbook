---
title: Chemical
description: Chemical在英文中有两大释义，作为名词时意为'化学品'，作为形容词时意为'化学的'，常常用于描述与化学反应或化学素质有关的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Chemical" uk="/ˈkɛmɪkəl/" us="/ˈkɛmɪkəl/" client:only />
...
作为名词：单数为 chemical，复数为 chemicals。
作为形容词：无变形。
