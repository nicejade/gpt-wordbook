---
title: Really
description: Really 是个副词，常用于强调事实并表示程度。它有以下的主要意思：
sidebar:
  hidden: true
...
<Pronunciation word="Really" uk="/ˈɹɪəli/" us="/ˈɹi.əli/" client:only />
...
<WordRelations synonyms={["actually", "indeed", "truly", "so"]} client:only />
