...
title: Cylinder
description: >-
  Cylinder是英语中的一个名词，它在中国通常被翻译为“圆柱”。“Cylinder”可以指化学实验室用的“试管”、工程方面的“缸筒”或者数学中的“圆柱形”等。
sidebar:
  hidden: true
...
<Pronunciation word="Cylinder" uk="/ˈsɪlɪndə(ɹ)/" us="/ˈsɪləndɚ/" client:only />
...
3.  The cylinder has a height of 2 meters and a diameter of 1 meter. (这个圆柱的高度是 2 米，直径是 1 米。)
...
"Cylinder"这个词出现在 14 世纪的英语中，直接从拉丁文"cylinder"借用过来的，最早是被应用在园艺和数学领域。
