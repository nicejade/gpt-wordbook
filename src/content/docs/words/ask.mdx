---
title: Ask
description: Ask 是一个英文单词，作为动词，它的基本意思是 '请求'，'询问' 或 '邀请'。它通常用于要求信息或请求一些事物的情况下。
sidebar:
  hidden: true
...
<Pronunciation word="Ask" uk="/ˈask/" us="/eəsk/" client:only />
...
"Ask" 起源于古英语的 "ascian"，一词在公元 8 世纪的一些早期英文文本中有记录。在老挪威语中也有类似的 "eiskā"，老高德语 "eiscōn" 等形式。
...
<WordRelations synonyms={["request"]} client:only />
