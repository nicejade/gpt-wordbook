---
title: Gross
description: Gross是英语里一个非常常用的形容词，可以表示多种含义，其中常见的有：
sidebar:
  hidden: true
...
<Pronunciation word="Gross" uk="/ɡɹəʊs/" us="/ɡɹoʊs/" client:only />

### 列举例句

1.  His gross income is over 100,000 dollars a year. (他的总收入一年超过 10 万美元。)
...
<WordRelations
  synonyms={["aggregate","entire","overall","total","whole","egregious","flagrant","serious","shameful","bulky","fat","great","large","obese","clear","obvious","coarse","impure","obscene"]}
