...
description: >-
  Much
  是一个英语词汇，它通常用作副词或形容词，通常用来描述数量的概念。当用作副词时，它用于修饰动词，表示“很多，大量”的意思。当作为形容词时，它通常与单数不可数名词连用，来表示“许多”或“大量”的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Much" uk="/mʌt͡ʃ/" us="/mʌt͡ʃ/" client:only />
...
<WordRelations
  synonyms={["greatly","highly","loads","plenty","very"]}
  antonyms={["few","less","little"]}
  client:only
/>
