...
title: Deception
description: >-
  Deception 是一个名词，意思是 '欺骗' 或
  '诈骗'。它指的是有意的行为，包括向他人提供错误的信息，或者有计划地隐瞒信息，以让他们相信不真实的事情。
sidebar:
  hidden: true
...
<Pronunciation word="Deception" uk="/dɪˈsɛpʃən/" us="/dɪˈsɛpʃən/" client:only />
...
"Deception" 这个单词在中世纪拉丁文中被广泛使用，早在 14 世纪就流行使用，用于描述一种欺诈行为。
