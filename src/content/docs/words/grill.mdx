---
title: Grill
description: Grill 是一个英语单词，常用作名词，指'烧烤炉'或'烤肉'，也可用作动词，意思是'烧烤'或'严厉盘问'。
sidebar:
  hidden: true
...
<Pronunciation word="Grill" uk="/ɡɹɪl/" us="/ɡɹɪl/" client:only />
...
"Grill" 一词首次出现在 14 世纪，源自法语的 "gril"。在许多西方文化中，烧烤(grilling)被视为一种社交活动，人们在夏天的晴朗天气里一起聚在户外烧烤食物。
...
<WordRelations synonyms={["fronts", "golds"]} client:only />
