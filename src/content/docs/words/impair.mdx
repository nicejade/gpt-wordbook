---
title: Impair
description: Impair 是一个动词，表示“损害”或“削弱”。有时我们形容某事物被减弱或者质量下降，就会使用这个词。
sidebar:
  hidden: true
...
<Pronunciation word="Impair" uk="/ɪmˈpɛə/" us="/ɪmˈpɛə/" client:only />
...
<WordRelations
  synonyms={["blunt","diminish","hurt","lessen","reduce","weaken","worsen"]}
  client:only
/>
