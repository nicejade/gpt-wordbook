...
title: Domestic
description: >-
  Domestic是一个英文形容词，它主要有两个含义。首先，它可以用来形容跟家庭或在家相关的事物，例如家务（domestic
  chores）、家庭暴力（domestic violence）等。其次，它还可以用来形容在一个国家内部的事物，例如国内的（domestic
  affairs）、国内航班（domestic flights）等。
sidebar:
  hidden: true
...
<Pronunciation word="Domestic" uk="/dəˈmɛstɪk/" us="/dəˈmɛstɪk/" client:only />
...
Domestic 这个词的词根是来自拉丁词“domus”，意为“家”。
...
Domestic 这个单词在中古英语时期就已经开始被使用，最早是用来描绘家庭生活的场景。到了现代英语，它的含义扩展了，也可以用来描述与一个国家内部有关的事情。
