---
title: Flat
description: Flat 是一个形容词，常见的意思有'平的'，'扁平的'，也可用于形容无生气，单调的。除此之外，'flat'在英语中也有其他含义，如'公寓'。
sidebar:
  hidden: true
...
<Pronunciation word="Flat" uk="/flæt/" us="/flæt/" client:only />
...
<WordRelations
  synonyms={["deflate","punctured","even","planar","plane","smooth","uniform","still","unfizzy","flabby","boring","dull","uninteresting","monotone","bluntly","curtly","absolutely","completely","utterly","tops"]}
  antonyms={["sharp","bumpy","cratered","hilly","rough","wrinkled","round"]}
  client:only
/>
