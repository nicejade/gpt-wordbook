...
<WordRelations
  synonyms={["punctured","even","planar","plane","smooth","uniform","still","flabby","boring","dull","uninteresting","monotone","bluntly","absolutely","completely","utterly"]}
  antonyms={["sharp","bumpy","hilly","rough","wrinkled","round"]}
  client:only
/>
