---
title: East
description: East 是一个英语单词，表示方向或地理位置，意为“东方”。
sidebar:
  hidden: true
...
<Pronunciation word="East" uk="/iːst/" us="/iːst/" client:only />
...
<WordRelations
  synonyms={["oriental", "easterly", "eastern", "eastward", "eastwards"]}
  antonyms={["westerly", "western", "westward", "west", "westwards"]}
  client:only
/>
