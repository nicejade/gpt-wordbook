...
title: Friction
description: >-
  Friction是英语单词，主要用作名词。它的基本含义是“摩擦”，描述两个物体在接触和相对运动时造成的阻力。此外，“friction”也可用于比喻矛盾或冲突，比如两个人之间产生的不良关系或者观点之间的冲突。
sidebar:
  hidden: true
...
<Pronunciation word="Friction" uk="/ˈfɹɪkʃən̩/" us="/ˈfɹɪkʃən̩/" client:only />
...
Friction 源自拉丁词汇 "frictionem"，其含义是“擦，磨”。同样源于此词根的单词有:
...
"Friction"一词在 16 世纪左右从拉丁语翻译成英语，最初的含义是“磨擦”。随着科学的发展，这个词的含义也迅速扩展，用于表达物理学中的摩擦力概念。在近现代，这个词也常常被用来比喻矛盾和冲突。
