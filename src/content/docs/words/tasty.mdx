---
title: Tasty
description: "- 'Tasty'是一个形容词，通常用来形容食物或饮料的口感美味，它有“好吃的，美味的”的含义。"
sidebar:
  hidden: true
...
<Pronunciation word="Tasty" uk="/ˈteɪsti/" us="/ˈteɪsti/" client:only />
...
- "Tasty"这个词出现于 13 世纪的英语，由"taste"这个词演变而来。然而，直到 16 世纪，"tasty"才开始被用来形容食物的口感。
