---
title: Trigger
description: Trigger 是一个英语词汇，作名词时，常常可以翻译为“触发器”，“引发的因素”或者“扳机”。作动词时，经常被翻译为“引发”，“激发”。
sidebar:
  hidden: true
...
<Pronunciation word="Trigger" uk="/ˈtɹɪɡə/" us="/ˈtɹɪɡə/" client:only />
...
<WordRelations
  synonyms={["activate", "detonate", "fire", "initiate"]}
  client:only
/>
