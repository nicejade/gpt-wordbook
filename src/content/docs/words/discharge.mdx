...
title: Discharge
description: >-
  Discharge 是一个英语单词，主要有以下两个含义： 1.（名词）从一个地方或系统中释放出，如：释放病人，排放液体或气体。
  2.（动词）释放、排放或解雇。
sidebar:
  hidden: true
...
"Discharge" 是一个英语单词，主要有以下两个含义： 1.（名词）从一个地方或系统中释放出，如：释放病人，排放液体或气体。 2.（动词）释放、排放或解雇。

<Pronunciation word="Discharge" uk="/ˈdɪstʃɑːdʒ/" us="/ˈdɪstʃɑːdʒ/" client:only />
...
<WordRelations
  synonyms={["firing","fire","terminate"]}
  client:only
/>
