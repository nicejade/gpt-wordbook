---
title: Crown
description: 单词 'Crown' 通常指代为王或女王制作的，象征权力和领导地位的金属头冠。此外，它还用于表示顶部或最高点。例如，山顶被称为山冠。
sidebar:
  hidden: true
...
<Pronunciation word="Crown" uk="/kɹaʊn/" us="/kɹaʊn/" client:only />
...
单词 "Crown" 可追溯到早在公元前 8 世纪的古典拉丁文，用于参考皇家象征和权威的标记。 随着时间的推移，它的用途扩展到表示最高点或顶部。
...
<WordRelations
  synonyms={["award","garland","honor","prize","wreath","bull","caroon","cartwheel","caser","coachwheel","tosh","tosheroon","tush","tusheroon","completion","culmination","finish","splendor","corona"]}
  client:only
/>
