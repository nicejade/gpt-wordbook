---
title: Nine
description: Nine是一个序数，代表了数字 9，用于计数和排列。
sidebar:
  hidden: true
...
"Nine"是一个序数，代表了数字 9，用于计数和排列。

<Pronunciation word="Nine" uk="/naɪn/" us="/naɪn/" client:only />
...
"Nine" 的词根来自于古英语 "nigon" 和古高地德语 "nin"，都表示数字 9。
...
<WordRelations synonyms={["IX"]} client:only />
