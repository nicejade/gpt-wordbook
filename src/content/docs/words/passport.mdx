---
title: Passport
description: Passport 是一个名词，意为'护照'。它是一种由一个国家政府发出的旅行文件，其中包括个人信息如姓名、照片、出生日期和国籍等，用于证明个人身份和国籍。
sidebar:
  hidden: true
...
<Pronunciation word="Passport" uk="/ˈpɑːspɔːt/" us="/ˈpæspɔɹt/" client:only />
...
"Passport"出现在英语中起源于 18 世纪中期，直到现在，它仍然用来指代一个证明一个人身份和国籍的文件。
