---
title: Define
description: Define 是一个动词，有以下主要含义：
sidebar:
  hidden: true
...
<Pronunciation word="Define" uk="/dɪˈfaɪn/" us="/dɪˈfaɪn/" client:only />
...
Define 的词根是"fin"，来源于拉丁语 "finis"，意为"最后的"或"边界"。其他由此词根衍生出来的单词有：final（最后的）、finite（有限的）、finish（结束）等。
...
Define 来自拉丁词 "definire"，原意为把边界画清楚，后来转义为定义、限定。这个单词在欧美文化中被广泛使用，尤其在学术、科学、法律等领域。
...
这个单词可以联系到电脑编程，提醒自己在编程中我们定义变量就是给变量赋值，这样就可以联想到 define 的意思是定义。
