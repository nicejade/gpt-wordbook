---
title: Smelly
description: Smelly 是形容词，用以描述某件事物有强烈或者令人不悦的气味。具有贬义色彩。
sidebar:
  hidden: true
...
<Pronunciation word="Smelly" uk="/ˈsmɛli/" us="/ˈsmɛli/" client:only />
...
Smelly 由词根"smell"(闻，嗅，气味)+ -y（后缀，表示具有...特性）构成。
...
<WordRelations
  synonyms={["dodgy","doubtful","dubious","suspect","suspicious","fetid","malodorous","rank","stinky","whiffy"]}
  antonyms={["clean","aromatic","fragrant"]}
  client:only
/>
