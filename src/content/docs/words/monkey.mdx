---
title: Monkey
description: Monkey 是名词，意为'猴子'，在一些 colloquial（口语） 中也可以表示 '胡闹' 或 '淘气'。
sidebar:
  hidden: true
...
<Pronunciation word="Monkey" uk="/ˈmʌŋki/" us="/ˈmʌŋki/" client:only />
...
<WordRelations synonyms={["fiddle", "interfere"]} client:only />
