...
description: >-
  Advantage
  是名词，用来形容一种有利条件或者是优势。例如，你在一场比赛中拥有优势，也就是你比对手更有可能赢得比赛。此外，该词还可以作为动词使用，表示利用或得到优势。
sidebar:
  hidden: true
...
你可以记住这样一个小技巧：advantage 是由 ad（加）+ vantage（一步）组成，表示你比别人“多了一步”。
...
<WordRelations
  synonyms={["benefit","edge","value","vantage","favor"]}
