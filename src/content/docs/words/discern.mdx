---
title: Discern
description: Discern 是一个动词，意味着“辨别，看出，识别”，尤其是在难以看清或理解的情况下。
sidebar:
  hidden: true
...
"Discern" 自 14 世纪起在英语中出现，源自拉丁词 "discernere"，其中 "dis-" 表示"分开"， "cernere" 表示"看"。
...
<WordRelations
  synonyms={["discriminate", "distinguish", "ken", "spy"]}
  client:only
/>
