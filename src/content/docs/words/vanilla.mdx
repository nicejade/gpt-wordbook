...
<Pronunciation word="Vanilla" uk="/vəˈnɛlə/" us="/vəˈnɛlə/" client:only />
...
2.  This is just vanilla HTML without any special features. (这只是没有任何特殊功能的普通 HTML。)
...
- “Vanilla”一词首先出现在 17 世纪，源自于马达加斯加的香草豆荚，它后来在美国南部变得非常流行。然后，“vanilla”也开始被用来形容最普通或者最基础的事物，就像使用最原始的、未加工的香草一样。
...
<WordRelations synonyms={["normophilic", "vanillar"]} client:only />
