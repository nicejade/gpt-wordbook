---
title: Compress
description: Compress 是一个英语动词，表示“压缩，压紧”，也可以作为名词使用，作名词时一般用于医疗领域，可译为“敷料”。
sidebar:
  hidden: true
...
<Pronunciation word="Compress" uk="/kəmˈpɹɛs/" us="/kəmˈpɹɛs/" client:only />
...
"Compress" 这个词来源于 14 世纪的拉丁语 "compressare "，表示“按、压”。
...
Tom 想把一个大文件发送给他的朋友，但遇到了一个问题——文件太大了。最后，他决定压缩文件，使其小到可以通过电子邮件发送。

<WordRelations
  synonyms={["contract","condense","shorten","compact","pack","press","squash","squeeze"]}
