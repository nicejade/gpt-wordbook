---
title: Peace
description: Peace 是名词，指的是没有战争、冲突或对立的状态。也可以表示内心的平静和宁静。
sidebar:
  hidden: true
...
<Pronunciation word="Peace" uk="/piːs/" us="/piːs/" client:only />
...
这个单词起源于 12 世纪，从老法语 "peis" 演变而来。原意为“和平,宁静,和睦”。在西方文化中，"peace" 是被广泛张扬和追求的理念，特别是在宗教和政治领域。
...
<WordRelations
  synonyms={[]}
  antonyms={["disruption", "violence", "war"]}
  client:only
/>
