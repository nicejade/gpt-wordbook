---
title: Peel
description: Peel这个单词主要有两种意思。第一种是动词，用于描述从表面剥去或删除某物，特别是果皮或蔬菜皮。第二种是名词，指被剥去的皮。
sidebar:
  hidden: true
...
<Pronunciation word="Peel" uk="/piːl/" us="/piːl/" client:only />
...
<WordRelations
  synonyms={["rind", "zest", "disrobe", "strip", "skin"]}
  client:only
/>
