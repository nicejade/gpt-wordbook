...
description: >-
  Satisfactorily是一个副词，它的基本意思是“令人满意地”或“在可接受的或尤其是所希望达到的标准范围之内”，然后包含着质量，性能或知识的充分或足够。
sidebar:
  hidden: true
...
衍生的其他单词包括 satisfy（满足）, satisfaction（满意）等。
...
<WordRelations antonyms={["unsatisfactorily"]} client:only />
