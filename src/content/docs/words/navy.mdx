---
title: Navy
description: Navy 是一个名词，它主要指的是一个国家的海军。这个词也可以表示一种颜色—深蓝色。
sidebar:
  hidden: true
...
<Pronunciation word="Navy" uk="/ˈneɪvi/" us="/ˈneɪvi/" client:only />
...
"Navy"这个词源于拉丁语 "navis"，然后变为法语的 "navie"，最后在 14 世纪的时候成为了英语的 "navy"。在早期的语境中，"navy"被用来指代一群船队，但现在我们更常将它用来指代一个国家的海军。

"Navy blue" 这个颜色的名称来源于 19 世纪英国皇家海军的制服颜色，即深蓝色。
