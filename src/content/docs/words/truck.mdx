...
title: Truck
description: >-
  Truck 是一个英语名词，主要指 '卡车'，在美英语中也可用于表达 '运输、搬运' 的动作。在一些特定的场景下，'truck'也可指 '手推车' 或者
  '小轮车'。
sidebar:
  hidden: true
...
<Pronunciation word="Truck" uk="/tɹʌk/" us="/tɹʌk/" client:only />
...
"Truck" 的早期含义(16 世纪)是 "小轮子" 或 "轮子装置"，这是由法语词 "trouque" 演变而来的。"trouque" 原意是 "一种有轮子的桶"。19 世纪中叶，"truck" 的义项扩展为 "重型车辆" 首次出现在报纸上。你可以理解为随着时代进步，人们的需求也在变化，所以这个词的含义也发生了变化。
...
<WordRelations synonyms={["hauler", "lorry", "rig"]} client:only />
