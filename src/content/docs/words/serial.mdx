...
<Pronunciation word="Serial" uk="/ˈsɪəɹiːəɫ/" us="/ˈsɪəɹiːəɫ/" client:only />
...
- "Serial"这个词最初在英语中被用来形容事件，事情等有固定顺序、连续发生的事物。从 19 世纪起，人们以"serial”的形式发布连载小说，从而使这个词汇的名词含义开始流行。
...
<WordRelations synonyms={["sequential"]} client:only />
