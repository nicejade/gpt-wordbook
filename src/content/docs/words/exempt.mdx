---
title: Exempt
description: Exempt 是一个形容词，也可以作为动词使用。主要有两种含义：一是“被免除的、豁免的”，此时通常使用为形容词；二是“使免除、豁免”，此时为动词。
sidebar:
  hidden: true
...
<Pronunciation word="Exempt" uk="/ɛɡˈzɛm(p)t/" us="/ɛɡˈzɛm(p)t/" client:only />

### 列举例句

1.  Some items are exempt from sales tax. (某些物品不收销售税。)
2.  Children under 16 are exempt from these charges. (16 岁以下的儿童不需要支付这些费用。)
