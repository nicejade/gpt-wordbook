---
title: Temple
description: Temple 有两个常见的含义，分别为：
sidebar:
  hidden: true
...
<Pronunciation word="Temple" uk="/ˈtɛmp(ə)l/" us="/ˈtɛmp(ə)l/" client:only />
...
从历史和文化背景来看，"temple" 作为一个英文单词，首先在 13 世纪的英格兰出现，指代 "神圣空地"，引申到 "庙宇" 或 "神殿" 的含义。
...
(Jenny 访问了尼泊尔的古庙。她摸了摸冷冷的石墙，感到一种深深的平静。)
