...
description: >-
  Romance
  是一个具有丰富含义的单词。它通常作为名词使用，可以表示爱情故事或冒险故事，或指一种引人入胜的质地，例如在诗歌或音乐中。另外，它还可以作为动词使用，表示寻求、诱惑或吸引某人以开始或维持一段浪漫的关系。
sidebar:
  hidden: true
...
<Pronunciation word="Romance" uk="/ɹəˈmæns/" us="/ɹoʊˈmæns/" client:only />
...
<WordRelations synonyms={["solicit"]} antonyms={["platonic"]} client:only />
