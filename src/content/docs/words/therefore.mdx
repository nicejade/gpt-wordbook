---
title: Therefore
description: Therefore 是一个副词，常用来引出因果关系中的结果、结论。相当于汉语中的“因此”，“所以”。
sidebar:
  hidden: true
...
<Pronunciation word="Therefore" uk="/ˈðɛəfɔː/" us="/ˈðɛəɹfɔɹ/" client:only />
...
<WordRelations
  synonyms={["accordingly", "hence", "then", "thereby", "thus", "∴", "so"]}
  client:only
/>
