---
title: Addicted
description: Addicted 是形容词，意思是对某事物极度依赖或痴迷，常常用于形容对于某些物质或行为的不能自拔的欲望，例如嗜烟、嗜酒、嗜药等。
sidebar:
  hidden: true
...
<Pronunciation word="Addicted" uk="/əˈdɪktɪd/" us="/əˈdɪktɪd/" client:only />
...
<WordRelations
  synonyms={["adapt", "fit", "hooked", "consecrate", "dedicate", "devote"]}
  client:only
/>
