---
title: Economic
description: Economic 是一个形容词，主要的词义是“经济的”，也可以表示“有经济效益的，划算的”。
sidebar:
  hidden: true
...
"economic"这个词在 18 世纪开始使用，最早来自于经济学家们对于资源分配问题的讨论和研究。在现代英语中，这个词除了在经济学领域广泛使用外，还常用来描述有关成本效益，投资回报，利润等经济概念。
