---
title: Bookshelf
description: Bookshelf是一个英语名词，直译为'书架'，就是我们用来放置和整理书籍的架子。
sidebar:
  hidden: true
...
<Pronunciation word="Bookshelf" uk="/ˈbʊkˌʃɛlf/" us="/ˈbʊkˌʃɛlf/" client:only />
...
Bookshelf 没有特殊变形，复数形式为"bookshelves"（书架）。
...
曾经有一段时间，热衷于阅读的 Tim 决定为他所有的书籍建造一个书架。他花了整整一天时间，最后，新的、结实的书架骄傲地立在他的房间里。
