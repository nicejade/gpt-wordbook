---
title: Physical
description: Physical是一个形容词，主要应用在两个大的领域中：描述具有物质形态的事物，例如“物理的，物质的”，以及有关身体或生理的情况，例如“身体的，生理的”。
sidebar:
  hidden: true
...
<Pronunciation word="Physical" uk="/ˈfɪzɪkəl/" us="/ˈfɪzɪkəl/" client:only />
...
"Physical"这个词在 14 世纪从古希腊语的"physis"发展而来，原意是"自然"，后来随着科学的发展，这个词的含义扩展了，开始用于描述关于物理的或身体的事情。
