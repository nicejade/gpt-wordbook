---
title: Requisite
description: Requisite 是一个形容词，表示'必需的'或'必备的'。例如，'requisite skills'意思是'必要的技能'。
sidebar:
  hidden: true
...
<Pronunciation word="Requisite" uk="/ɹɪˈkwɪzɪt/" us="/ˈɹɛkwɪzɪt/" client:only />
...
**开发历史和文化背景**
"Requisite"这个单词源于 16 世纪的拉丁语 "requisitus"，表示"looked for, needed, required"，在英语中通常用来强调某物或某人的重要性或必要性。
...
<WordRelations synonyms={["necessary"]} client:only />
