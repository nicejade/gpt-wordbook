...
description: >-
  Reservation
  是一个英语单词，主要有两个义项。其一是'预订'，例如你会预订一间酒店房间或餐厅座位。其二是'保留意见'或'疑虑'，表达你对某事仍有未解决的问题或顾虑。
sidebar:
  hidden: true
...
<Pronunciation word="Reservation" uk="/ˌɹɛzəˈveɪʃən/" us="/ˌɹɛzəˈveɪʃən/" client:only />
...
<WordRelations
  synonyms={["res","reserve","rez","booking","median"]}
  client:only
/>
