...
title: Enroll
description: >-
  - 英文单词'enroll'来源于法语'enroler'，
  其中'en-'是一个动词前缀，表示'使得'的意思，'roler'则源于'role'，这个词在法语中表示名单。所以，'enroll'的字面意思是'设人名下'，我们今天通常使用它来表示
  在学校、课程、活动等注册，或加入一项计划或组织。
sidebar:
  hidden: true
...
<Pronunciation word="Enroll" uk="/ɪnˈɹəʊl/" us="/ɪnˈɹəʊl/" client:only />
...
- "enroll" 一词在 14 世纪时从法语中引入英语，原意指的是"写入册子"，后来发展为我们常用的"注册"的意思。
...
<WordRelations
  synonyms={["enlist","join","subscribe","list","note","record","register","add"]}
  client:only
/>
