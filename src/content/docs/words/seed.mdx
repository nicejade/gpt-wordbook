...
description: >-
  Seed 这个单词在英语里的默认义项是
  '种子'，但其实在日常生活中，我们可以根据上下文理解为许多不同的意思。举个例子，它也可以用来描述创始要素、起源，或者指象征新生事物的人。
sidebar:
  hidden: true
...
<Pronunciation word="Seed" uk="/siːd/" us="/siːd/" client:only />
...
<WordRelations synonyms={["germ"]} client:only />
