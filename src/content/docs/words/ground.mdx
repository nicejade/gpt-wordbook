---
title: Ground
description: Ground 是一个常见的英语单词，像地面、土地这样的实体概念，也用于更抽象的语境中，如'基础'或'原因”。
sidebar:
  hidden: true
...
<Pronunciation word="Ground" uk="/ɡɹaʊnd/" us="/ɡɹaʊnd/" client:only />
...
Ground 的意义历史源远流长，它的文字根源可以追溯到公元 800 年左右的 Old English。
...
<WordRelations synonyms={["earth", "gate"]} client:only />
