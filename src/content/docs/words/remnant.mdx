---
title: Remnant
description: Remnant 是一个英文名词，意思是“残余部分”或“遗迹”。它通常指一些在过去存在、现在却只剩下一小部分或片段的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Remnant" uk="/ˈɹɛmnənt/" us="/ˈɹɛmnənt/" client:only />
...
<WordRelations
  synonyms={["lave", "relic", "remainder", "residue", "remains"]}
  client:only
/>
