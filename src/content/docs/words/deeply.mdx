---
title: Deeply
description: Deeply 是一个副词，通常用来描述某事或某物的程度达到了深入的、强烈的、内心的、或非常微妙的。例如，“深深地感动”。
sidebar:
  hidden: true
...
<Pronunciation word="Deeply" uk="/ˈdiːpli/" us="/ˈdiːpli/" client:only />
...
<WordRelations synonyms={["deep"]} client:only />
