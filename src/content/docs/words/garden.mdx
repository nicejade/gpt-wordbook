...
title: Garden
description: >-
  Garden 是一个英文单词，作为名词时，它的基本意思是 '园子'，特指一片用于种植花卉、蔬菜或果树的土地。同时也可以作为动词，意思是
  '进行园艺活动'，既指绿化栽培装饰这一行为。
sidebar:
  hidden: true
...
<Pronunciation word="Garden" uk="/ˈɡɑːdn̩/" us="/-n̩/" client:only />
...
<WordRelations synonyms={["park", "yard", "farm"]} client:only />
