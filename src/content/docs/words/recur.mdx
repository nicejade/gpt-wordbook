...
title: Recur
description: >-
  Recur是一个动词，意为“再次发生”或“重复出现”。通常用于形容像疾病复发或问题不断重出这样的概念。如：The symptoms of the
  disease recurred after a period of remission(疾病症状在一段缓解期之后再次发生)。
sidebar:
  hidden: true
...
<Pronunciation word="Recur" uk="/ɹɪˈkɜː(ɹ)/" us="/ɹɪˈkɜː(ɹ)/" client:only />
...
John continually thinks of a recurring scene: He stands on a hill, the sun shines warmly, and his childhood friends play around. This nostalgia seems never-ending. (John 不断想起一个反复出现的场景：他站在小山上，阳光温暖，他的童年朋友们在四周玩耍。这种乡愁似乎永无止境。)

<WordRelations synonyms={["repeat"]} client:only />
