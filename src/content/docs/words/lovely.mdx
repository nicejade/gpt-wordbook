---
title: Lovely
description: lovely 是一个形容词，主要用来形容人或物体非常可爱、漂亮或者吸引人。还可以用来表示适合人群的目光，给人以美好印象。
sidebar:
  hidden: true
...
<Pronunciation word="Lovely" uk="/ˈlʌvli/" us="/ˈlʌvli/" client:only />
...
"lovely" 一词最早出现在 13 世纪的英语中。它在日常生活中相当常见，并被广泛应用于诗歌和文学中，以描绘美好、宜人的场景或人物。
...
<WordRelations
  synonyms={["darling","pretty","beautiful","charming","lovable","loving"]}
  client:only
/>
