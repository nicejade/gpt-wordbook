...
title: Up
description: >-
  up 是一个复杂的英语单词，它有许多不同的用法。在最基本的层面上，'up'
  是一个描述方向的副词和介词，表明某物往更高的位置移动或到达更高的位置。此外，'up' 还常常用在短语中，以表达多种抽象的概念。
sidebar:
  hidden: true
...
<Pronunciation word="Up" uk="/ap/" us="/ʌp/" client:only />
...
<WordRelations antonyms={["down"]} client:only />
