---
title: Abbess
description: Abbess 是英语中的一个名词，它的中文解释是“女修道院院长”。它通常用于对罗马天主教、东正教、安格利教及其他一些基督教教派中女子修道院的负责人的称呼。
sidebar:
  hidden: true
...
<Pronunciation word="Abbess" uk="/ˈæb.ɛs/" us="/ˈæb.ɛs/" client:only />
...
<WordRelations synonyms={["bawd", "madam"]} client:only />
