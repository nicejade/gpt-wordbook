...
title: Hop
description: >-
  Hop在英语中主要有两种意义。作为动词，最常见的意思是“跳跃”，尤其是用一只脚跳跃或者轻快地、连续地跳跃。作为名词，它可以指跳跃的动作。此外，“hop”还可以在口语中表示“短途旅行”。
sidebar:
  hidden: true
...
<Pronunciation word="Hop" uk="/hɒp/" us="/hɑp/" client:only />
...
"hop"的词源历史有些不清楚，但许多词典将它归源于 Old English（古英语）的 "hoppian"，意思也是跳跃。
...
<WordRelations synonyms={["jump", "leap"]} client:only />
