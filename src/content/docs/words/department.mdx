---
title: Department
description: Department是一个常用的英文单词，主要表示'部门'或'系'(如学校的部门)，也可以用来指代某个特定的领域或主题。
sidebar:
  hidden: true
...
"Department" 这个单词来源于 14 世纪的法语"departement"，原意是“分开、分配。”由"de-"和 "partir"组成，"de-"在此有除去的意思，"partir"是分开的意思。在英语中，"department"主要表示机构的子部门。
...
<WordRelations synonyms={["province", "specialty", "ministry"]} client:only />
