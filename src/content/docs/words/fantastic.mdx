---
title: Fantastic
description: Fantastic 是形容词，用于描述事物或经历极好，出色。
sidebar:
  hidden: true
...
<Pronunciation word="Fantastic" uk="/fænˈtæstɪk/" us="/fænˈtæstɪk/" client:only />
...
<WordRelations
  synonyms={["fabulous","fantastical","foolish","unrealistic","wild","brilliant","splendid","super","wonderful"]}
  antonyms={["sucktastic"]}
  client:only
/>
