...
description: >-
  Lighter
  是一种用于产生火焰的小型设备，常用于点燃烟草产品如香烟，也用于点燃蜡烛等。此外，“lighter”也有一个不太常见的用法，可以指通航河流、湖泊的平底驳船。
sidebar:
  hidden: true
...
<Pronunciation word="Lighter" uk="/ˈlaɪtə/" us="/ˈlaɪtɚ/" client:only />
...
关于打火机，最早的设计可以追溯到 16 世纪，但真正的便携式打火机直到 19 世纪才开始出现。在欧美文化中，打火机在许多场合中都有其存在，从社交场合的烟火文化到户外生存技巧。
...
<WordRelations
  synonyms={["bright","lightful","pale","cream","milk","white","delicate","gentle","soft","inconsequential","trivial","unimportant","lightweight","lite"]}
  antonyms={["forceful","heavy","strong","crucial","important","weighty","cumbersome","heavyweight","massive","calorific","fatty","burdensome"]}
  client:only
/>
