...
<WordRelations
  synonyms={["bright","pale","cream","milk","white","delicate","gentle","soft","inconsequential","trivial","unimportant","lightweight"]}
  antonyms={["forceful","heavy","strong","crucial","important","weighty","cumbersome","heavyweight","massive","fatty","burdensome"]}
  client:only
/>
