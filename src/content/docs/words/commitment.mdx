---
title: Commitment
description: Commitment 是一个名词，主要有以下含义：
sidebar:
  hidden: true
...
Commitment 这个词在 15 世纪初期出现，起初主要用于描述将物品交付给他人保管的行为。随着时间的推移，它的含义逐渐扩大，包括承诺、负责任、义务或决定等。
...
<WordRelations
  synonyms={["allegiance","charge","dedication","duty","engagement","guarantee","liability","loyalty","must","need","oath","obligation","ought","pledge","promise","responsibility","undertaking"]}
  client:only
/>
