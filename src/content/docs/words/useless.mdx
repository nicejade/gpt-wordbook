---
title: Useless
description: Useless是一个形容词，意为“无用的”，“没有价值的”。当我们说某个事物是“useless”的时候，我们是在表达这个事物没有用处，或者不起作用。
sidebar:
  hidden: true
...
<Pronunciation word="Useless" uk="/ˈjuːs.ləs/" us="/ˈjuːs.ləs/" client:only />
...
“Useless”一词源自中古英语，最初的形式为"usles", 在 14 世纪被用来表示“无效的，没有价值的”。
