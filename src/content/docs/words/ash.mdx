---
title: Ash
description: Ash 在英文中作为名词有两个主要意思：一是指'灰烬'，即由燃烧物质后剩余的固体产品；二是指'梣树'，一种常绿大型乔木。
sidebar:
  hidden: true
...
<Pronunciation word="Ash" uk="/æʃ/" us="/æʃ/" client:only />
...
<WordRelations synonyms={["cremains"]} client:only />
