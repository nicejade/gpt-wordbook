...
title: Thrill
description: >-
  Thrill 是一个英语单词，用作名词时，它的意思是「刺激」或「兴奋」，表达一种强烈的快乐感或兴奋感。作为动词，'thrill'
  的意思是「使激动」或「使兴奋」，即给予某人强烈的愉快或兴奋的感觉。
sidebar:
  hidden: true
...
<Pronunciation word="Thrill" uk="[t̪ɾ̪̊ɪl]" us="[θɾ̪̊ɪɫ]" client:only />
