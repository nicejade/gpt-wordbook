---
title: Peril
description: "Peril是一个名词, 意思是'严重的危险或风险'。当你处在'peril'中时，你正面临一个可能危及你生命、安全或者幸福的情况。"
sidebar:
  hidden: true
...
<Pronunciation word="Peril" uk="/ˈpɛɹəl/" us="/ˈpɛɹəl/" client:only />
...
"Peril" 基于中古法语（circa 1300 年）的"peril"（危险，风险）一词， 该词源于拉丁语"peril(l)um"，意为"试一试"，即冒险的含义。
...
<WordRelations
  synonyms={["danger","hazard","jeopardy","risk","threat"]}
  client:only
/>
