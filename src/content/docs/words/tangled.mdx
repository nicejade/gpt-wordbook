...
description: >-
  Tangled 是形容词，来自于动词
  “tangle”的过去分词，用来描述一种混乱、错综复杂或纠结的状态。我们通常用它来形容线、头发或者一些物体纠结在一起。此外，这个词也可以形容情况或问题非常复杂和难以理解。
sidebar:
  hidden: true
...
<Pronunciation word="Tangled" uk="/ˈtæŋ.ɡəld/" us="/ˈtæŋ.ɡəld/" client:only />
...
"Tangled"这个词在英语中有很长的历史，最早由 Anglo-Saxon 中的"tangle"诞生。这个词逐渐演变成现今的含义，形容一种混乱、复杂或纠结的状态。
...
<WordRelations
  synonyms={["argue","conflict","dispute","fight","knot","mat","snarl"]}
  antonyms={[]}
  client:only
/>
