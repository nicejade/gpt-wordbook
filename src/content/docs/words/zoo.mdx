---
title: Zoo
description: Zoo 是一个名词，指的是动物园，一个人们可以看到各种各样的野生动物的地方。
sidebar:
  hidden: true
...
<Pronunciation word="Zoo" uk="/zuː/" us="/zuː/" client:only />
...
"Zoo" 是 "zoological garden" 的简写，最早在 19 世纪英语中使用。动物园是人们观察和学习动物行为的重要场所。
