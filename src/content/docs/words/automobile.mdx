---
title: Automobile
description: Automobile 是一个名词，它意为'汽车'。它描述的是一种自由移动的机动车辆，主要用于运输人员或货物。
sidebar:
  hidden: true
...
这个词在英语中出现是在 19 世纪末期，当时汽车刚开始出现和被使用。它的词源来自法语"automobile"，法国是汽车行业最早发展的国家之一。
...
<WordRelations synonyms={["auto", "car", "motor", "motorcar"]} client:only />
