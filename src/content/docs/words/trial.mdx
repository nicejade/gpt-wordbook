...
title: Trial
description: >-
  Trial的主要含义是'尝试'或'试验'，用于描述测试新想法、产品或方法的过程。此外，'trial'也有'审判'的含义，常指在法庭上，决定某人是否有罪的过程。
sidebar:
  hidden: true
...
<Pronunciation word="Trial" uk="/ˈtɹaɪəl/" us="/ˈtɹaɪəl/" client:only />
...
"Trial"起源于 14 世纪，最早用于表示"尝试"或"试验"，然后扩展到"审判"的含义。
