---
title: Footpath
description: Footpath是一个名词，通常用来指边缘的或穿过公园的小路，专供步行者使用，又称人行道或步道。
sidebar:
  hidden: true
...
<Pronunciation word="Footpath" uk="/ˈfʊtˌpæθ/" us="/ˈfʊtˌpæθ/" client:only />
...
<WordRelations
  synonyms={["footway", "pavement", "platform", "sidewalk", "walkway"]}
  client:only
/>
