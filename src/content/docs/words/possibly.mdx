---
title: Possibly
description: possibly是一个副词，意为“也许”或“可能”。
sidebar:
  hidden: true
...
<Pronunciation word="Possibly" uk="/ˈpɒsɪbli/" us="/ˈpɑsəbli/" client:only />
...
"possibly" 这个词在 14 世纪时发展成了 副词形式 "possibly"，一直沿用至今。
...
<WordRelations
  synonyms={["conceivably", "maybe", "perhaps", "potentially"]}
  antonyms={["certainly", "impossibly", "inevitably"]}
  client:only
/>
