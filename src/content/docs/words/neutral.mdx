---
title: Neutral
description: Neutral 是一个形容词，最主要的含义是“中立的”，“不偏不倚的”。用在不同的语境中，它可以描述人、态度、颜色甚至一些科学概念。
sidebar:
  hidden: true
...
<Pronunciation word="Neutral" uk="/ˈnjuːtɹəl/" us="/ˈnuːtɹəl/" client:only />
...
"Neutral"的最早使用可以追溯到 15 世纪的法国，之后传入英语语境中，可以用来形容在冲突或争议问题中保持中立的人或情况。
...
<WordRelations synonyms={["innocuous"]} client:only />
