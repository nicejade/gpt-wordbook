...
title: Itself
description: >-
  Itself是一个反身代词，通常用于指事物本身或强调某一行动是由被提及的事物主动发生的。如：The cat cleaned itself
  （猫自己梳理了自己）
sidebar:
  hidden: true
...
<Pronunciation word="Itself" uk="/ɪtˈsɛlf/" us="/ɪtˈsɛlf/" client:only />
...
Itself 并无明显的词根，但它由"it"和"self"两部分构成，"it"是第三人称单数代词，"self"在此起强调作用。

### 词缀分析

Itself 没有词缀，它是由两个单词合成而来的。
...
Itself 没有变形，记住它可以用作强调或者表示主语自己进行动作就很好了。

### 记忆辅助

由于 Itself 是由"it"和"self"两部分组成的，很好理解和记忆。你可以将它看做是“它自己”。
...
<WordRelations synonyms={["itsself"]} client:only />
