...
title: bearing
description: >-
  Bearing这个单词的含义非常丰富。最基础的意义是关系，意义，例如在句中Have something bearing on
  sth.中，表示某事与其有关。此外，它还可以表示方向，态度或举止，比如I hope he's bearing up under the
  strain.中，表示的是承受住压力的意思。
sidebar:
  hidden: true
