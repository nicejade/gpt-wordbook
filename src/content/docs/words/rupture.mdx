...
title: Rupture
description: >-
  Rupture是一个名词和动词，主要意思是撕裂，突然破裂或断裂。如果是名词，多指物理对象的破裂，或者关系、合约等的终止。如果是动词，常常描述引起上述情况的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Rupture" uk="/ˈɹʌptʃə/" us="/ˈɹʌptʃə/" client:only />
...
"Rupture"赏是从 12 世纪的法语借来的，原意是破裂或打破。现在英美文化中，它可以用来描述物理、情感和社会关系的破裂。
