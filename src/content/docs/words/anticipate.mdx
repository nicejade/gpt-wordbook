---
title: Anticipate
description: Anticipate 是一个动词，意为“预期；期待；预料到”。它描述了主体对于未来事物有预期或预感的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Anticipate" uk="/ænˈtɪs.ɪ.peɪt/" us="/ænˈtɪs.ə.peɪt/" client:only />
...
"Anticipate"这个词首次出现在大约 1550 年，源自中古拉丁语 "anticipare"，意为 "预期、期待或者是预料"。此后，这个词语在英语中逐渐演变，被广泛地应用于多种语境中。
...
<WordRelations
  synonyms={["expect","foresee","foretaste","preclude"]}
  client:only
/>
