...
title: Equilibrium
description: >-
  Equilibrium是一个英文单词，主要用于科学、经济学等场景中，通常指平衡状态。例如：物理学中'力的平衡'或者化学中的'化学平衡'、经济学中的'市场平衡'。
sidebar:
  hidden: true
...
<Pronunciation word="Equilibrium" uk="/iːkwɪˈlɪbɹɪəm/" us="/iːkwɪˈlɪbɹɪəm/" client:only />
...
<WordRelations
  synonyms={["balance","stability","sanity"]}
  antonyms={["disequilibrium","imbalance","instability","insanity","madness"]}
  client:only
/>
