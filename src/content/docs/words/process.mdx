---
title: Process
description: Process 是一个英语单词，它既可以作为名词，也可以作为动词。作为名词，它的含义是“过程”或“步骤”，而作为动词时，它的含义是“处理”。
sidebar:
  hidden: true
...
<Pronunciation word="Process" uk="/ˈpɹəʊsɛs/" us="/ˈpɹɑsɛs/" client:only />
...
于 14 世纪从法语借用，原意是“前行，继续”，现有“过程，步骤”与“处理”等含义。
