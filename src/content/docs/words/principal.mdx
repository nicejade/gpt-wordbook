---
title: Principal
description: Principal 主要有两个常见含义。一是作为形容词，表示'主要的、首要的'。二是作为名词，指'校长'或'资本，本金'。
sidebar:
  hidden: true
...
词汇"principal"源于 15 世纪中叶的法语，其根源是拉丁语"princeps"，最初的意思是"首要的"。
...
<WordRelations
  synonyms={["dean","client","proprietor","ringleader","headmaster","headmistress","headteacher","chief","main","primary"]}
  client:only
/>
