---
title: Giggle
description: Giggle 是动词，意思是轻声笑，低声窃笑，频频傻笑。
sidebar:
  hidden: true
...
<Pronunciation word="Giggle" uk="/ˈɡɪɡl/" us="/ˈɡɪɡl/" client:only />
...
"Giggle" 起源于 16 世纪的英语，最初用来描述小声嘲笑的声音。它可能来源于"gegen"一词，这是“笑”的古英语形式。
...
<WordRelations
  synonyms={["amusement", "fun", "joke", "laugh", "titter"]}
  client:only
/>
