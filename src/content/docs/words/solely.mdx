...
title: solely
description: >-
  Sure, let's delve into the word solely. 分析词义： Solely is an adverb that means
  only or not involving anything or anyone else. It can emphasize that only a
  particular thing is involved in something. 列举例句： 1. He is solely responsible
  for any damage. 他是任何损害的唯一责任人。
sidebar:
  hidden: true
