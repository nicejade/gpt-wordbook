...
title: Punishment
description: >-
  Punishment是一个英语名词，意思是'惩罚'或者'处罚'。它指的是由于某人的行为错误或犯罪行为，而被官方、学校、父母或任何有权威的个人或者机构给予的负面的后果或反馈。此外，'punishment'也可以描述一种痛苦或不愉快的体验，像是某种形式的苦难或者讨厌的任务。
sidebar:
  hidden: true
...
"Punish"源于 13 世纪的法语单词 "püinir"，其意为"惩罚，对...进行伤害法律程序"。此前，"punish"源自拉丁单词"punire"，意为"惩罚"或"修正"。
...
<WordRelations
  synonyms={["beating", "castigation", "punition"]}
  antonyms={["reward"]}
  client:only
/>
