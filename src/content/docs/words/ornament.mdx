---
title: Ornament
description: Ornament作为名词指的是装饰或者装饰品，通常用于添加美感或者突出某种样式。作为动词，'ornament'意为装饰，使某物更吸引人。
sidebar:
  hidden: true
...
"Ornament"和"装饰"都有两个 O 和一个 N，可以尝试将它们关联记忆。
...
<WordRelations
  synonyms={["adorn", "bedeck", "decorate", "embellish", "trim"]}
  client:only
/>
