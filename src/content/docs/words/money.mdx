...
description: >-
  Money
  是英语中的一个名词，指的是货币，一般用来交换商品和服务。这个词有多种用法，可以用于指代现金，也可用来泛指任何类型的货币，或者象征财富、收入、加薪等。
sidebar:
  hidden: true
...
<Pronunciation word="Money" uk="/ˈmʌni/" us="/ˈmʌni/" client:only />
...
Money 在 12 世纪就已经出现在英语中。它来自拉丁语 "moneta"(货币、铸币厂)，古罗马的货币铸币厂通常建在朱诺神庙旁边，朱诺其中一个别名就是 "Monēta"。在古罗马，"Monēta" 用于代表"警示"的意思。
...
<WordRelations
  synonyms={["bread","bucks","cake","cash","cheddar","coin","cream","currency","dinars","dosh","dough","ducats","funds","geld","gelt","greenbacks","jack"]}
  client:only
/>
