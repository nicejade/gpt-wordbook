...
title: Breadth
description: >-
  Breadth通常指的是宽度，也可以指某个领域的广泛知识。例如，'The breadth of his knowledge about horses was
  impressive.' 在这个句子中，'breadth'是指他对马的知识相当广泛。
sidebar:
  hidden: true
...
<Pronunciation word="Breadth" uk="/bɹɛdθ/" us="/bɹɛdθ/" client:only />

### 列举例句

1.  The river reaches a maximum breadth of 500 metres here. (这条河在这里的最大宽度达到了 500 米。)
...
<WordRelations
  synonyms={["width", "extent", "range", "scope", "size"]}
  client:only
/>
