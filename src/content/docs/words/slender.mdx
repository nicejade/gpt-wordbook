---
title: Slender
description: Slender 是形容词，通常用来形容某人或物体纤细，细长的或苗条的。同时，也可以形容某事物数量少，微小或无力的。
sidebar:
  hidden: true
...
<Pronunciation word="Slender" uk="/ˈslɛndə/" us="/ˈslɛndɚ/" client:only />
...
"Slender"的词根是 an Old Norse 词缀 "slenkr" ，表示靠近，相似或者一致。在词汇的发展过程中，“slenkr”来表示纤细或细长。
...
"Slender"源自 14 世纪的中古英语，一词语用于描绘某事物细长和微薄。在欧美文化背景中，"slender"一般用于形容人的身材瘦弱或者美的方面，这表示了西方文化对苗条女性的审美偏好。
...
<WordRelations
  synonyms={["insufficient", "scarce", "sparse", "lithe", "svelte", "willowy"]}
  antonyms={["broad"]}
  client:only
/>
