---
title: Nationwide
description: nationwide 是一个副词，也可以作为形容词，意为“全国范围内的”。通常用于描述某种事件、现象或者政策影响的范围覆盖整个国家。
sidebar:
  hidden: true
...
<Pronunciation word="Nationwide" uk="/ˌneɪ.ʃənˈwaɪd/" us="/ˌneɪ.ʃənˈwaɪd/" client:only />

### 列举例句

1.  The fast food chain has gone nationwide.（这个快餐连锁店已经覆盖了全国。）
2.  Nationwide, homes sales fell by 20%.（全国各地的房屋销售下滑 20%。）
...
"nationwide" 这个词汇源自 20 世纪初，主要用于描述一些活动、风俗、法律、商业等覆盖全国的事件或现象。
...
故事翻译: 在 Zxy 国，一个关于保护野生动物的新法律在全国范围内实施。禁止任何公民猎杀任何野生动物。

<WordRelations
  synonyms={["countrywide","national","nationally"]}
  antonyms={["citywide","districtwide","local","provincewide","statewide","locally"]}
  client:only
/>
