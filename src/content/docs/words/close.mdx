...
title: Close
description: >-
  Close 是一个英文词，既可做动词也可做形容词。作为动词，'close' 表示'关闭'，'结束'。作为形容词，'close'
  表示'近的'，'紧密的'，'密切的'。
sidebar:
  hidden: true
...
<Pronunciation word="Close" uk="/kləʊz/" us="/kloʊz/" client:only />
...
<WordRelations
  synonyms={["end","finale","narrow","shut","cover","finish","terminate","exit"]}
  antonyms={["beginning","start","extend","widen","open","begin","commence","initiate"]}
  client:only
/>
