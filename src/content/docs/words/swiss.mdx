...
title: Swiss
description: >-
  Swiss 这个单词通常作为形容词，表示'瑞士的'，可以用来描述任何与瑞士相关的事物，如'Swiss cheese'(瑞士奶酪)、'Swiss
  Alps'（瑞士阿尔卑斯山）等。作为名词，'Swiss'也可以表示“瑞士人”。
sidebar:
  hidden: true
...
<Pronunciation word="Swiss" uk="/swɪs/" us="/swɪs/" client:only />
