---
title: Citizenship
description: Citizenship是一个名词，它指的是一个人是属于一个特定国家，拥有其公民权利和义务的状态或事实。它代表一种国家与个人之间的法律关系。
sidebar:
  hidden: true
...
"Citizenship"一词源于英语的公民一词，首次出现在 14 世纪，表示一种隶属于一个城市或镇的法定地位。它随后发展成包括对一个国家或政府的忠诚以及从中获得的权利和义务。
...
<WordRelations synonyms={["citizenhood", "freemanship"]} client:only />
