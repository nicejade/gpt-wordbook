---
title: Buck
description: Buck 是英语中的一个多义词，通常有以下几种主要含义：
sidebar:
  hidden: true
...
<Pronunciation word="Buck" uk="/bʌk/" us="/bʌk/" client:only />
...
<WordRelations
  synonyms={["button","stag","hob","billy","billygoat","buckling","ram","tup","bill","bone","clam","cucumber","greenback","note","paper"]}
  client:only
/>
