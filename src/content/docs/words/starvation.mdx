---
title: Starvation
description: Starvation 是一个名词，用来描述极度的饥饿或缺乏营养。
sidebar:
  hidden: true
...
Starvation 是一个名词，用来描述极度的饥饿或缺乏营养。
...
Starvation 这个词源于 13 世纪的中英文，早期表达的是死亡的概念，后来发展为极度饥饿或饥荒的意思。
...
记住这个词，你可以联想到 star（星星），然后想象一个情境：如果你在星辰大海中飘荡，没有食物，可能会感到极度的饥饿，也就是 starvation。
