---
title: Laborious
description: Laborious是一个英语形容词，描述一项任务或活动需要大量的时间和精力，通常是不太愉快的工作。这个单词在中文里的意思是“费力的”、“辛苦的”。
sidebar:
  hidden: true
...
"Laborious"首次出现在 16 世纪，源自法语"laborieux"，又源自拉丁语"laboriosus"。在过去和现代的英语中，它都被用来描述需要大量努力和时间的事物。
...
<WordRelations synonyms={["painstaking", "toilsome", "worksome"]} client:only />
