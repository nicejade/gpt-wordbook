---
title: Make
description: Make是一个最常用的英语动词，意思是'制造'，'生产'，'创造'或'造成'。
sidebar:
  hidden: true
...
<Pronunciation word="Make" uk="/meɪk/" us="/meɪk/" client:only />
...
<WordRelations
  synonyms={["manufacture","production","brand","manufacturer","type","completion","construction","origin","character","disposition","makeup","way","output","ID","identification","lay"]}
  client:only
/>
