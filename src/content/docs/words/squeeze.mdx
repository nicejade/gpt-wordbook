---
title: Squeeze
description: Squeeze 是一个动词，主要有三个含义：
sidebar:
  hidden: true
...
1.  用力压，挤压，例如挤橙汁； 2.（从困境、困难处）设法获得，设法找到；
2.  （使）勉强进入，塞进。

<Pronunciation word="Squeeze" uk="/skwiːz/" us="/skwiːz/" client:only />
...
<WordRelations synonyms={["compress", "condense"]} client:only />
