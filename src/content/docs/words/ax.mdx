---
title: Ax
description: '- ''Ax''是''斧头''的意思，是一个常见的工具名词，你可以用它来形容一种用于砍、切或积木的重型刀刃工具。在不同的情境中，它的使用会有所变化。'
sidebar:
  hidden: true
...
<Pronunciation word="Ax" uk="/æks/" us="/æks/" client:only />
...
<WordRelations
  synonyms={["boot","chop","sack","downsize","fire"]}
  client:only
/>
