---
title: Edit
description: Edit通常被用作动词，意味着增删或整理文本以提高质量或使其更为适应其目的，或者也可以用于指改动或对电子文件、视频或音频进行修改。
sidebar:
  hidden: true
...
<Pronunciation word="Edit" uk="/ˈɛdɪt/" us="/ˈɛdɪt/" client:only />
...
"Edit"一词首次出现在 1791 年，起初有"出版"的意思，由拉丁词 "editus" 演变而来，意为“走出来”。在 19 世纪，随着印刷业的发展，其含义转变为“准备出版的材料进行校订”，在大约 20 世纪初，扩展到其现在的含义，即“进行更改或修订”。
...
<WordRelations synonyms={["splice", "cut", "alter", "retouch"]} client:only />
