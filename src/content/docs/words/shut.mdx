---
title: Shut
description: 英语单词 'shut' 是一个动词，表示“关闭，合上”。也可以指结束，停止。
sidebar:
  hidden: true
...
<Pronunciation word="Shut" uk="/ʃʌt/" us="/ʃʌt/" client:only />
...
<WordRelations
  synonyms={["high","near","nearby","muggy","oppressive","intimate"]}
  antonyms={["open","distant","far","faraway","remote","aloof","cool"]}
  client:only
/>
