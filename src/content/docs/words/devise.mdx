---
title: Devise
description: Devise 是一个动词，主要的意思是设计或策划。它一般用于创建、发明或精心构思一个计划、设备或者方式等等。
sidebar:
  hidden: true
...
<Pronunciation word="Devise" uk="/dɪˈvaɪz/" us="/dɪˈvaɪz/" client:only />
...
"Devise" 这个词源于中世纪的拉丁语 "divisare"，原意为“预见、布置”。16 世纪，该词未在法语中发展出了“筹划、设计”的意思，然后进入英语。
