---
title: Training
description: Training是一个名词，意为“训练、培训”，它也可以作为动词'train'的现在分词，表示'正在培训、正在训练'。
sidebar:
  hidden: true
...
<Pronunciation word="Training" uk="/ˈtɹeɪnɪŋ/" us="/ˈtɹeɪnɪŋ/" client:only />
...
"Train"这个词在 14 世纪时出现的，最初的意思是"拉、拖"，17 世纪末才发展出"教育、训练"的含义。
