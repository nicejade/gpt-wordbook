...
title: Lame
description: >-
  Lame是一个形容词，最常见的意思是“跛的，瘸的”，用于形容行走时受到身体伤害或疾病影响的人或动物。另外，'Lame'也常用来形容某种事物低劣，不满意或不充分，如
  'a lame excuse' (牵强的借口)。
sidebar:
  hidden: true
...
<Pronunciation word="Lame" uk="/leɪm/" us="/leɪm/" client:only />
...
<WordRelations
  synonyms={["imperfect","inefficient","limping","boring","irrelevant","pathetic","uncool","unfunny","uninteresting","unbelievable","weak"]}
  antonyms={[
    "efficient",
    "perfect",
    "cool",
