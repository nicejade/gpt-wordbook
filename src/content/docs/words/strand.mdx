---
title: Strand
description: Strand作为名词，有“线，绳，纤维”的意思，也可以表示“海滩”，或者“使陷入困境”。作为动词，它表示“使滞留，使搁浅”。
sidebar:
  hidden: true
...
<Pronunciation word="Strand" uk="/stɹænd/" us="/stɹænd/" client:only />
...
<WordRelations synonyms={["abandon", "desert", "beach"]} client:only />
