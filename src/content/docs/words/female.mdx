---
title: Female
description: Female是一个形容词，意为“女性的”，也可以作为名词，表示“女性”。
sidebar:
  hidden: true
...
<Pronunciation word="Female" uk="/ˈfiː.meɪl/" us="/ˈfiː.meɪl/" client:only />
...
<WordRelations synonyms={["socket", "feminine", "womanly"]} client:only />
