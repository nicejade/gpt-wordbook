---
title: Lorry
description: Lorry是英式英语中的一种货车或大卡车。美式英语中的同义词是'truck'。在澳大利亚，它被称为 'ute'。
sidebar:
  hidden: true
...
<Pronunciation word="Lorry" uk="/ˈlɒɹi/" us="/ˈlɒɹi/" client:only />
...
"Lorry"这个词最早出现在 19 世纪的英格兰，最初用于指一种被马拉的四轮运送货物的大车。随着技术的发展，这个词的意义逐渐转移到了现在我们理解的机动化货车上。
...
<WordRelations synonyms={["hauler", "rig", "truck"]} client:only />
