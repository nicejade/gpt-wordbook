---
title: Defend
description: Defend 是一个动词，用于描述保护某人或某事，防止受到伤害或袭击。比如保护一个人不被攻击，保护一个观点或理念不被攻击等。
sidebar:
  hidden: true
...
<Pronunciation word="Defend" uk="/dɪˈfɛnd/" us="/diˈfɛnd/" client:only />
...
<WordRelations antonyms={["attack"]} client:only />
