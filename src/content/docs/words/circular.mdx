---
title: Circular
description: Circular，形容词，有环形的，圆形的，循环的等意思。当用作名词时，指的是小册子或者通告。
sidebar:
  hidden: true
...
"Circular"是英语中常见的形容词，形象地描绘了环状或循环的状态。最早的用法可以追溯到 14 世纪。随着科技的发展，"circular"的含义也跟着扩展，例如在电路设计、算法设计中，"circular"经常被用来描述类似于循环或者环状的复杂模式。
...
<WordRelations
  synonyms={["circular","leaflet","aviator"]}
  client:only
/>
