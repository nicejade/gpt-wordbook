---
title: Liquor
description: Liquor 是名词，通常指的是含有酒精的饮料，尤其指强烈的烈酒。在美国，'liquor' 通常用于描述蒸馏酒，如威士忌，伏特加，朗姆酒等。
sidebar:
  hidden: true
...
<Pronunciation word="Liquor" uk="/ˈlɪk.ə(ɹ)/" us="/ˈlɪk.ə(ɹ)/" client:only />
...
"Liquor" 这个词最早可以追溯到 14 世纪的拉丁语 "liquor"，意为“液体，沥青，水”，最后在英语中特指“烈酒”。
...
<WordRelations
  synonyms={["bouillon", "broth", "stock", "spirits"]}
  client:only
/>
