...
title: Dissipate
description: >-
  Dissipate 是一个动词，意思是使逐渐消失，分散，耗尽。也可以用来形容力量、精力、金钱等逐渐消耗殆尽。在物理学中， 'dissipate'
  可以用来描述能量的散失或款项的挥霍。
sidebar:
  hidden: true
...
<Pronunciation word="Dissipate" uk="/ˈdɪsɪpeɪt/" us="/ˈdɪsɪpeɪt/" client:only />
...
"Dissipate" 这个词汇来自于 16 世纪的拉丁语"dissipatus"，意思是"分散，驱散"。在这个词汇的使用历史中，最初主要描述抽象物体如雾气、能量、情绪等的散开。然后在 18 世纪开始，它也开始被用来描述财富的挥霍和浪费。
