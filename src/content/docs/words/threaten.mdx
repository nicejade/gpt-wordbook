---
title: Threaten
description: Threaten是动词，意思是'威胁'或者'恐吓'。它表示有人或事给予别人强迫或恐惧的压力，以达到自己的目标或意图。
sidebar:
  hidden: true
...
<Pronunciation word="Threaten" uk="/ˈθɹɛt.n̩/" us="/ˈθɹɛt.n̩/" client:only />
...
- 名词形式是"Threat" (威胁)
- 动词形式的现在分词形式是 "Threatening" (威胁)，过去变形和过去分词形式是 "Threatened" (被威胁)
- 形容词形式是"Threatening" (有威胁的)
