...
title: Swim
description: >-
  Swim是一个动词，表示游泳的动作。例如：'I swim in the pool every
  morning'（我每天早上在游泳池游泳）。此外，它还可以用于比喻，例如：'My head is swimming with
  information'（我的头都要被这些信息淹没了）。
sidebar:
  hidden: true
...
<Pronunciation word="Swim" uk="/swɪm/" us="/swɪm/" client:only />
