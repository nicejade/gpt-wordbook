---
title: How
description: How 是一个英语副词，用于以多种方式查询详细信息。最常见的使用是在询问方法（如何做某事）、程度（多么）或条件（以何种方式）时。
sidebar:
  hidden: true
...
<Pronunciation word="How" uk="/haʊ/" us="/haʊ/" client:only />
...
"How" 来自古英语单词 "hū"，自 12 世纪以前已经开始使用。这个词本身没有特定的文化内涵，但它在讲英语的社会中的日常交流中起着重要的作用。
