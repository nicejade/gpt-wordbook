...
title: Wishful
description: >-
  Wishful 是一个形容词，通常用来描述人的一种渴望事情达到理想的状态（尽管可能并不现实）的心态。“Wishful thinking”
  是一个常用短语，指的是人们对事物采取乐观态度，期望最好的结果，忽视了事实和可能的结果。记忆的时候，可以将 'wishful' 与 'wish' 和
  'full' 相关联。
sidebar:
  hidden: true
...
<Pronunciation word="Wishful" uk="/ˈwɪʃfəl/" us="/ˈwɪʃfəl/" client:only />
...
关于 "wishful" 这个词，它最早出现在 14 世纪的英格兰，来自于"willful desire"，意味着“充满意愿的”。这个词在文化中，多表示人们对理想情况的渴望和愿望。
