---
title: Jar
description: Jar 这个单词在英语中有两个主要的含义：
sidebar:
  hidden: true
...
<Pronunciation word="Jar" uk="/dʒɐː/" us="/dʒɑɹ/" client:only />
...
Jar 这个单词的原意是 "水罐"，早在 14 世纪就译为英语。它源自法语 jarre，源于阿拉伯语 jarrah，意为 "大陶罐"。
...
在美国，jar（特指 mason jar, 带有标准尺寸螺纹盖的玻璃罐）有深远的历史。在 19 世纪，这种瓶子被用于食物保存，尤其是在冬季。它成为了美国文化的一个重要元素。
...
<WordRelations synonyms={["cruse", "pot", "bottle"]} client:only />
