---
title: Descriptive
description: Descriptive 是一个形容词，它的意思是包含很多描述的，或者给人详细描述的。这个词通常被用于说明某种语言，文字或者方法具有详尽的描述性。
sidebar:
  hidden: true
...
<Pronunciation word="Descriptive" uk="/dɪˈskɹɪptɪv/" us="/dɪˈskɹɪptɪv/" client:only />
...
"Descriptive" 这个单词起源于 16 世纪的拉丁词"descriptivus", 是在法国首先被使用，然后被引入到英语里。这个词在欧美文化中常常被用于文学，艺术和科学的语境中，用来形容一个细致，详实的描述。
...
Ann 阅读了一本关于埃及金字塔的描述性的书。生动的细节让她仿佛身临其境。

<WordRelations
  antonyms={["normative","prescriptive"]}
  client:only
/>
