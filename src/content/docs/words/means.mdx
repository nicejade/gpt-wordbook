...
title: Means
description: >-
  - 'Means' 是一个非常多功能的英语词汇，通常用作名词，表示 '方法' 或 '手段'。比如： 'By all means'（务必）、'Means to
  an end'（达成目的的手段）等。还可以用作动词，表示 '意味着'。
sidebar:
  hidden: true
...
<Pronunciation word="Means" uk="/miːnz/" us="/miːnz/" client:only />
...
<WordRelations
  synonyms={["cause","convey","indicate","signify","imply","intend","serious","wherewithal"]}
  client:only
/>
