---
title: Diverge
description: "Diverge这个词来自拉丁语'divergere'，意为'分开'。在英语中，这个词有两个主要的含义:"
sidebar:
  hidden: true
...
<Pronunciation word="Diverge" uk="/daɪˈvɜːdʒ/" us="/daɪˈvɜːdʒ/" client:only />
...
<WordRelations antonyms={["converge"]} client:only />
