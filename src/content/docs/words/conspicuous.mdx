---
title: Conspicuous
description: Conspicuous是一个形容词，表示清晰可见的或者显眼的。通常用于描述某物或者某人引人注意，无法忽视。例如：一个繁华的装束或者明显的行为。
sidebar:
  hidden: true
...
"Conspicuous"最初于 16 世纪从拉丁语引入英语，用于描述清晰可见的东西或易于观察的行为。
...
<WordRelations
  synonyms={["flashy", "prominent", "observable", "perceivable"]}
