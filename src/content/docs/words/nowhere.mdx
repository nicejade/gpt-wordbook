...
title: Nowhere
description: >-
  Nowhere 是一个副词，表示“任何地方都不”。经常用来回答有关地点的问题，强调所说的地方不存在。例如：“I've looked everywhere,
  but I can find it nowhere.”（我已经找遍了所有地方，但是就是找不到它。）
sidebar:
  hidden: true
...
<Pronunciation word="Nowhere" uk="/ˈnəʊ.wɛə/" us="/ˈnoʊ.(h)wɛɹ/" client:only />
...
<WordRelations antonyms={["everywhere"]} client:only />
