---
title: Affect
description: 英文单词 'affect' 是一种动词，它表示的是“影响；感动；假装”。在心理学中，它也可以作为名词使用，意为“情感”。
sidebar:
  hidden: true
...
<Pronunciation word="Affect" uk="/əˈfɛkt/" us="/əˈfɛkt/" client:only />
...
（Tom 在考虑突然的冰雹是否会影响他的行程。结果让他惊讶，因为冰雹过后出现的银白景色并没有带来问题，反而令人着迷。）

<WordRelations
  synonyms={["alter","change","influence","attack","harm","infect","move","touch"]}
  client:only
/>
