---
title: Existence
description: Existence是一个名词，主要用来表示'存在'或者'实在'的意思。不仅可以用来形容物质实体的存在，也可以表达抽象概念的存在。如：概念、理想、信念的存在。
sidebar:
  hidden: true
...
"Existence"源于 14 世纪，复数形式"existences"出现于 16 世纪晚期。"Existential"是与之相关连的形容词形式，意为“存在的”或者“存在主义的”。在西方文化和哲学中，‘existence’在 existentialism 存在主义哲学中占有重要地位。
