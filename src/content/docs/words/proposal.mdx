---
title: Proposal
description: Proposal是一个名词，通常用来指某人制定的计划或者建议，常常是函数形式的文件详细说明，用以商业、学术或者 Romantic context。
sidebar:
  hidden: true
...
"Proposal"是一个名词，通常用来指某人制定的计划或者建议，常常是函数形式的文件详细说明，用以商业、学术或者 Romantic context。
...
同样的后缀还可以在数学词汇 rational，政治词汇 liberal，文化词汇 cultural 等中看到。
...
<WordRelations synonyms={["overture", "proffer", "tender"]} client:only />
