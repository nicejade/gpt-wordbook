---
title: Bread
description: Bread 是一个英文单词，主要意思是“面包”，這是一種由面粉和其他成分组成，经过混合、发酵、烘焙等过程制成的食品。
sidebar:
  hidden: true
...
<Pronunciation word="Bread" uk="/bɹɛd/" us="/bɹɛd/" client:only />
...
<WordRelations
  synonyms={["dough", "lolly", "paper", "spondulicks", "wonga"]}
  client:only
/>
