---
title: Complicated
description: Complicated 是形容词，中文意思是“复杂的”，非常常用。用于描述事情、问题、关系等的复杂程度，或者表达事物内部的复杂性和难以理解或解决的特性。
sidebar:
  hidden: true
...
<Pronunciation word="Complicated" uk="/ˈkɒmplɪkeɪtɪd/" us="/ˈkɑmplɪkeɪtɪd/" client:only />
...
<WordRelations
  synonyms={["embroil","entangle","intricate","mire"]}
  antonyms={["simple"]}
  client:only
/>
