---
title: Condemn
description: Condemn 是一个动词，表示强烈的不赞同或者谴责。它可以用来描述对行为、态度或情况的负面评价。还可以表示判定某物或某人有罪。
sidebar:
  hidden: true
...
<Pronunciation word="Condemn" uk="/kənˈdɛm/" us="/kənˈdɛm/" client:only />
...
'Condemn'这一词汇源自 12 世纪的法语，含义为宣告...有罪，谴责。随着时间的推移，这个词逐渐在英语中被广泛接受和使用，逐渐发展了现代英语中的各种含义。
...
<WordRelations
  synonyms={["convict", "damn"]}
  antonyms={["acquit", "save"]}
  client:only
/>
