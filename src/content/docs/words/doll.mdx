---
title: Doll
description: Doll是英语中的一个名词，中文译为“玩偶”或“洋娃娃”。它通常被用来表示一种以人或动物形象制作的玩具。
sidebar:
  hidden: true
...
<Pronunciation word="Doll" uk="/dɒl/" us="/dɑl/" client:only />
...
"Doll" 这个词在 18 世纪贯穿英格兰的方言， 这个词源自荷兰语中 "deol" 或者 "doll"，都指的是小孩子, 起初用作对小孩的温馨称谓。随着时间的推移，"doll" 开始被用于指代一个小孩形象的玩具。
