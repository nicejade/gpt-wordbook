...
description: >-
  单词 'tongue'
  通常有两个主要的含义：一是指人或动物的舌头，作为身体的一部分，用于品尝食物和协助发音；二是指人类使用的语言或方言。这两种意义通常是最常用的。
sidebar:
  hidden: true
...
<Pronunciation word="Tongue" uk="/tɒŋɡ/" us="/tʌŋ/" client:only />
...
<WordRelations synonyms={["idiom", "language", "lingo"]} client:only />
