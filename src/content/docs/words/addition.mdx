---
title: Addition
description: Addition 是英语单词，它的主要含义是增加、添加或者数学中的加法。
sidebar:
  hidden: true
...
<Pronunciation word="Addition" uk="/æˈdɪʃən/" us="/æˈdɪʃən/" client:only />
...
"Addition"这个词早在 14 世纪就开始在英语中使用，原始含义是"增加"，后来才开始用于数学上的"加法"。
...
<WordRelations
  synonyms={["adding", "annexation", "inclusion", "extra", "supplement"]}
  antonyms={["exclusion", "reduction", "subtraction", "deduction"]}
  client:only
/>
