...
<WordRelations
  synonyms={["descent","drop","rap","downfall","decrease","dip","reduction","autumn","harvest","responsibility","become","get","descend","lower","prostrate","die"]}
  antonyms={["ascent","rise","increase","ascend","go","beat","defeat","overthrow"]}
  client:only
/>
