---
title: Induce
description: Induce 具有'引导、诱导、引发、导致'的含义。比如，如果一种行为或情况引发另一种行为或情况，我们可以说第一种行为或情况 induce 了第二种。
sidebar:
  hidden: true
...
Induce 具有"引导、诱导、引发、导致"的含义。比如，如果一种行为或情况引发另一种行为或情况，我们可以说第一种行为或情况 induce 了第二种。

<Pronunciation word="Induce" uk="/ɪnˈdjuːs/" us="/ɪnˈduːs/" client:only />
...
Induce 的词根是，duc/duct， 意为“引导、导致”。类似的单词有 produce (生产)，conduce(有助于)， deduce(推断)， seduce(诱惑)。

### 词缀分析

Induce 中，前缀" in-"表示“进入”，" -duce "是词根，表示引导。其他具有此前缀的单词包括 scatter (散播)，include (包括)，inject (注入)。

### 文化背景

Induce 源自中世纪拉丁语的"inducere"，原意是“引导、引诱、引发”。
...
<WordRelations
  synonyms={["entice","inveigle","instigate","prompt","provoke","stimulate","trigger"]}
  antonyms={["deduce"]}
  client:only
/>
