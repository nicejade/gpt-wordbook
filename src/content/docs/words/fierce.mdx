...
title: Fierce
description: >-
  Fierce 是一个形容词，表示 '猛烈的' 或 '剧烈的'。它可以用来形容人，如'凶猛或激烈的竞争者'；也可以用来形容物，比如
  '强烈的风声、色彩或感情'。
sidebar:
  hidden: true
...
<Pronunciation word="Fierce" uk="/fɪəs/" us="/fɪɹs/" client:only />
...
"Fierce"的使用起源于 14 世纪，由早期法语中"fiers"发展而来。
...
<WordRelations synonyms={["incessive"]} client:only />
