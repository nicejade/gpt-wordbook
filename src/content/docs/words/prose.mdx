---
title: Prose
description: Prose 是英语中的一个名词，它指的是平淡无华的，直接了当的语言或书写，与诗歌相对。它常用来描述故事或文章的形式。
sidebar:
  hidden: true
...
<Pronunciation word="Prose" uk="/ˈpɹəʊz/" us="/ˈpɹoʊz/" client:only />
...
Prose 中的词根 "prosa" 来自拉丁语，意为 "直线"，象征着文章的直接和简洁。
...
<WordRelations antonyms={["poetry", "verse"]} client:only />
