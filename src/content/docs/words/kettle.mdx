---
title: Kettle
description: "- 'Kettle' 是英语中代表一种厨房器具的词汇，一种常用来烧水或煮茶的容器。煮水时能够发出叫声因此在多数欧美家庭中都能找到。"
sidebar:
  hidden: true
...
<Pronunciation word="Kettle" uk="/ˈkɛ.təl/" us="/ˈkɛ.təl/" client:only />
...
<WordRelations synonyms={["teakettle"]} client:only />
