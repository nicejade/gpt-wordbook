...
description: >-
  Waterproof
  是一个形容词，意为“防水的”，用于形容那些能防止水分入侵的物品。此外它也可以作为名词，表示防水涂料。此外，它也可以表示防水的多双意底鞋。
sidebar:
  hidden: true
...
"Waterproof" 一词在英语中的使用追溯到 18 世纪，它最初是作为"防水的"的意思使用的。这个词在技术和工业革命的推动下，逐渐希望到更多的产品和物品中。
...
<WordRelations synonyms={["watertight"]} client:only />
