...
title: Per
description: >-
  Per是一个常用的英语介词。在数字或比例语境中，'per'经常用来表示'每'，例如每小时、每千米等。它也可以被理解为'通过'或'依据'，如按某人的指示或方案进行一系列操作。
sidebar:
  hidden: true
...
<Pronunciation word="Per" uk="/pɜː(ɹ)/" us="/pɝ/" client:only />

### 列举例句

1.  You are allowed 30 minutes per question during the exam. （你在考试中每题有 30 分钟的时间。）
2.  I get paid 20 dollars per hour.（我每小时获得 20 美元的报酬。）
...
<WordRelations synonyms={["/", "p", "p.", "⅌", "a", "an"]} client:only />
