---
title: List
description: List是一个英语单词，主要有两种含义。作为名词，它指的是一系列列出的项目或名字的排列，通常按特定顺序。而作为动词，'list' 指的是列举或编制清单。
sidebar:
  hidden: true
...
<Pronunciation word="List" uk="/lɪst/" us="/lɪst/" client:only />
...
<WordRelations synonyms={["tabulate"]} client:only />
