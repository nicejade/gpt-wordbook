...
<Pronunciation word="Comb" uk="/kəʊm/" us="/koʊm/" client:only />
...
单词变形：这个单词除常见的动词过去式和过去分词形式——combed 以及现在分词形式——combing 外，没有其他的形态变化。
...
<WordRelations synonyms={["cockscomb", "crest"]} client:only />
