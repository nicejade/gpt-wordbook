...
title: Belt
description: >-
  Belt 是一个英文单词，作名词时主要有两个含义。其一，指的是我们通常用在腰部固定裤子的皮带。其二，它还可以指代一种地带、区域或范围。例如'a belt
  of rainforest' (一片雨林地带)。作动词使用时，'belt' 大多用来形容急速行驶或者给出大力打击。
sidebar:
  hidden: true
...
<Pronunciation word="Belt" uk="/bɛlt/" us="/bɛlt/" client:only />
...
"Belt"一词源自古英语的"belt",可能从古日耳曼语*bilđiją 派生,该词的古老用法主要指代把衣物固定在身体上的东西，也即我们常说的“腰带”。
...
<WordRelations
  synonyms={["restraint","girdle","sash","strap","waistband","blow","punch","sock","wallop","dram","nip","gulp","pound","slurp","circle","surround","buckle","fasten"]}
  client:only
/>
