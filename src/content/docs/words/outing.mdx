---
title: Outing
description: Outing 是一个名词，主要有两个含义：
sidebar:
  hidden: true
...
<Pronunciation word="Outing" uk="/ˈaʊtɪŋ/" us="/ˈaʊtɪŋ/" client:only />
...
"Outing" 一词源自 Old English "ūtian"，意为"去外面"。在英美文化中，"outing" 常用于指代短暂的旅行或者户外活动。
