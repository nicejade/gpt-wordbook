...
title: Cling
description: >-
  Cling 是一个动词，当用在物理意义上时，它意味着紧紧地贴着或抓住某人或某物，类似于中文的 '紧紧抓住' 或
  '粘着'。当用在情感上时，它经常在描述对某人、记忆、或想法等的深深依恋。
sidebar:
  hidden: true
...
<Pronunciation word="Cling" uk="/ˈklɪŋ/" us="/ˈklɪŋ/" client:only />
...
<WordRelations synonyms={["cleave", "stick", "clinch", "grip"]} client:only />
