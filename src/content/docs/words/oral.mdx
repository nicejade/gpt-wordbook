---
title: Oral
description: Oral 这个英文单词主要有两个含义，一个是描述与口腔相关的，例如“口头的”或“口服的”，另一个含义是描述通过言语表达的，如“口头的”。
sidebar:
  hidden: true
...
<Pronunciation word="Oral" uk="/ˈɒɹəl/" us="/ˈɒɹəl/" client:only />
...
作为一个词，"oral" 第一次是在 15 世纪出现在文本中。早期它只用来描述与口腔（比如牙齿和舌头）有关的事物。19 世纪时，"oral" 开始被用来描述口头的交流和表达。
