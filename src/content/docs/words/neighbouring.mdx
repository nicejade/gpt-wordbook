---
title: Neighbouring
description: '"Neighbouring"是一个形容词，表示"adjacent"或者"next to", 在中文中意味着"相邻的"或者"附近的"。'
sidebar:
  hidden: true
...
你可以试图将"neighbouring"分成两部分来记忆：“neighbour”和“ing”。每当你看到“neighbour”，就想象你的邻居，而-ing 使其变成形容词。
