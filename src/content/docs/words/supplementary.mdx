---
title: Supplementary
description: Supplementary 是一个英语形容词，用于描述一物或事情对另一个物或事情的补充。中文翻译通常为“补充的”、“附加的”。
sidebar:
  hidden: true
...
"Supplementary" 是由"supplement"这个词通过 suffix（词尾）-ary 来形成，其中"supplement"本身是由 Latin "supplementum" 衍生而来，含义为“填充”。
