---
title: Absent
description: Absent 是一个形容词，意思是“不在的，缺席的”。作为动词，意思是“使缺席，使缺席”。它也可以用作前置词，意思是“没有”。
sidebar:
  hidden: true
...
<Pronunciation word="Absent" uk="/ˈæb.sn̩t/" us="/ˈæb.sn̩t/" client:only />
...
<WordRelations antonyms={["present"]} client:only />
