---
title: Magician
description: Magician是英文中的一个常见名词，它有两个主要的含义：
sidebar:
  hidden: true
...
<Pronunciation word="Magician" uk="/məˈdʒɪʃən/" us="/məˈdʒɪʃən/" client:only />
...
<WordRelations
  synonyms={["trickster","wizard","phenomenon","enchanter","sorcerer","thaumaturge","warlock","witch","mystic","spiritualist","whiz","whizz","wiz"]}
  client:only
/>
