---
title: Urban
description: Urban 这个英文单词，主要用作形容词，是“城市的”、“都市的”或者“市区的”的意思，通常用来描述与城市或市区有关的事物或设施。
sidebar:
  hidden: true
...
<Pronunciation word="Urban" uk="/ˈɜːbən/" us="/ˈɜːbən/" client:only />
...
Urban 本身是一个独立的单词，并没有显著的前缀或后缀。

### 文化背景

Urban 一词在中世纪拉丁文中用作名字，于 17 世纪末引入英语，主要用于描述与城市或都市生活有关的事物。
...
<WordRelations antonyms={["bucolic", "nonurban", "rural"]} client:only />
