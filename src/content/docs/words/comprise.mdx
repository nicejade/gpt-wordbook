---
title: Comprise
description: Comprise 是一个动词，它的意思是“包含”或“由...组成”，通常用于强调构成一个整体的部分或元素的重要性。
sidebar:
  hidden: true
...
<Pronunciation word="Comprise" uk="/kəmˈpɹaɪz/" us="/kəmˈpɹaɪz/" client:only />
...
<WordRelations synonyms={["form"]} client:only />
