...
title: Pure
description: >-
  Pure 是一个形容词，意思是'纯的，纯粹的'，程度上超过 'clean' 和
  'clear'。它可以用来描述非物质的特性，如纯粹的概念，纯粹的情感，或者纯粹的目的等。
sidebar:
  hidden: true
...
<Pronunciation word="Pure" uk="/ˈpjɔː/" us="/ˈpjɔɹ/" client:only />
...
Pure 这个词最早出现在 14 世纪，它逐渐从描述物质的纯洁，扩大到描述情感、目地、意念的纯洁与纯粹。
...
<WordRelations
  synonyms={["innocent"]}
  antonyms={["dirty","flawed","impure","corrupt","guilty","sinful"]}
  client:only
/>
