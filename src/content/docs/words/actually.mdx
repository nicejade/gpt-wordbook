---
title: Actually
description: Actually 是一个副词，通常用来矫正误解或误导，或者揭示一些可能令人意外的事实。在口语中，它可以作为对话插入语，表示强调。
sidebar:
  hidden: true
...
<Pronunciation word="Actually" uk="/-ɪ/" us="/ˈæk.(t)ʃu.ə.li/" client:only />
...
<WordRelations synonyms={["literally", "really", "truthfully"]} client:only />
