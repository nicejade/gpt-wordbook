---
title: Anxious
description: Anxious是一只形容词，主要含义有两种：一是“紧张的、焦虑的”，二是“渴望的、急切的”。也可以用于形容处在焦虑状态或感到紧张不安的人或事物。
sidebar:
  hidden: true
...
<Pronunciation word="Anxious" uk="/ˈaŋ(k)ʃəs/" us="/ˈæŋ(k).ʃəs/" client:only />
...
这个单词源于 1550 年代的拉丁词汇"anxius"，意为“困扰的、痛苦的”，又源于"angere"，意为“压迫、折磨”。
...
<WordRelations
  synonyms={["careful","concerned","disturbed","restless","solicitous","uneasy","unquiet","watchful"]}
  client:only
/>
