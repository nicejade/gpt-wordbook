---
title: Terrorist
description: Terrorist是一个名词，其主要含义是'恐怖分子'，指的是试图通过使用恐怖手段达到其政治目标的人。
sidebar:
  hidden: true
...
<Pronunciation word="Terrorist" uk="/ˈtɛɹəɹɪst/" us="/ˈtɛɹəɹɪst/" client:only />
...
"terrorist"这个单词源自 18 世纪，最初用来形容法国大革命期间恐怖统治的支持者。随着时间和历史的变化，现在这个单词主要用来形容试图通过使用恐怖手段实现其政治目标的人。
