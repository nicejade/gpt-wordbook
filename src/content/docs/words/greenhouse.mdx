---
title: Greenhouse
description: Greenhouse 是一个英文名词，通常用来表示'温室'。
sidebar:
  hidden: true
...
<Pronunciation word="Greenhouse" uk="/ˈɡɹiːnˌhaʊs/" us="/ˈɡɹiːnˌhaʊs/" client:only />
...
"Greenhouse"这个词在 17 世纪初期开始出现在英语中，有关温室科技的发展和应用始终是理解和以科学方法控制生态环境的一种重要方式。它在农业和园艺中有着很大的应用。
