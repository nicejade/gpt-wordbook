---
title: Bottle
description: Bottle 是英语中的名词，它的主要含义是'瓶子'，通常用来装液体，如水，酒等。另外，'bottle'作为动词时，意思是'装瓶'。
sidebar:
  hidden: true
...
<Pronunciation word="Bottle" uk="/ˈbɒ.təl/" us="/ˈbɑ.təl/" client:only />
...
"Bottle" 来源于古英语的 "bottel"，其由 Proto-Germanic *butlǭ (bottle) 衍生而来。
...
<WordRelations
  synonyms={["balls","courage","guts","nerve","pluck"]}
  antonyms={["cowardice"]}
  client:only
/>
