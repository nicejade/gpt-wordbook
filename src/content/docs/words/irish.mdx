---
title: Irish
description: "Irish 这个单词有两个主要的含义。首先，它可以被用作形容词，描述与爱尔兰有关的事物，例如 'Irish music'（爱尔兰音乐）或 'Irish culture'（爱尔兰文化）。其次，Irish 也可以用作名词，特指爱尔兰的语言（爱尔兰语）或人民（爱尔兰人）。"
sidebar:
  hidden: true
...
Irish 这个词在英语中的使用可以追溯到公元前 1200 年，当时它被用来指代爱尔兰岛的凯尔特人。现在，"Irish" 这个词在全球范围内都有广泛的使用，并且通常在描述爱尔兰的文化、历史、人民或语言。
