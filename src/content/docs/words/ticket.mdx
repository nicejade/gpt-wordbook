...
description: >-
  Ticket
  在英语中通常指“票”，它可以用来指交通票（如飞机票，火车票），入场券（如电影票，音乐会门票），还可以指彩票等。除此之外，'ticket'在美语中还可表示交通罚款单。例如：He
  got a parking ticket.（他拿到了一个停车罚款单。）
sidebar:
  hidden: true
...
<Pronunciation word="Ticket" uk="/ˈtɪkɪt/" us="/ˈtɪkɪt/" client:only />
