---
title: Deck
description: Deck 是一个英语名词，最常见的意思是“甲板”或“舞台”，用来描述一种户外建筑。它也可以指一副播放卡牌游戏的卡片或磁带/CD 播放器的部分。
sidebar:
  hidden: true
...
"Deck" 是一个英语名词，最常见的意思是“甲板”或“舞台”，用来描述一种户外建筑。它也可以指一副播放卡牌游戏的卡片或磁带/CD 播放器的部分。

<Pronunciation word="Deck" uk="/dɛk/" us="/dɛk/" client:only />
...
<WordRelations synonyms={["library"]} client:only />
