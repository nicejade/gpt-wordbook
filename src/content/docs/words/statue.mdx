---
title: Statue
description: Statue 是一个名词，指的是由任何种类的材料（如石头，木头，金属等）制成的三维形象。通常，雕像是人或动物的形象，但也可以是任何其他主题。
sidebar:
  hidden: true
...
<Pronunciation word="Statue" uk="/ˈstæt.juː/" us="/ˈstætʃu/" client:only />
...
"Statue"这个词源自拉丁语 statua，它是由 statuere（放置，立立）生成而来的，指那些被设计用来公开展示的人物或者动物的塑像。在欧美文化中，雕像很常用来作为公共艺术表现形式，常常用来纪念重要人物或事件。
