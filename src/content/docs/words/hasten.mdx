---
title: Hasten
description: Hasten是一个动词，主要意思是'加快'或'急促'，用于描述一个动作的速度增加或者急于完成一个事情。
sidebar:
  hidden: true
...
<Pronunciation word="Hasten" uk="/ˈheɪ.sən/" us="/ˈheɪ.sən/" client:only />
...
"Hasten"源自于中古英语 haste，意思是"急速"，在 17 世纪中期，人们开始用"hasten"这个单词，表示"加速"或"加快"的意思。
...
<WordRelations
  synonyms={["hurry", "rush", "zoom", "dart", "race", "accelerate", "quicken"]}
  client:only
/>
