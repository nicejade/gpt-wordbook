---
title: Inward
description: Inward是个形容词或副词，一般表示与内部、内心或本质有关的事物。形容词意为'向内的'或'内心的'，副词意为'向内部'或'在内部'。
sidebar:
  hidden: true
...
<Pronunciation word="Inward" uk="/ˈɪnwəd/" us="/ˈɪnwəd/" client:only />
...
Inward 由两个部分组成"in-"（内）和 "-ward"（方向），所以整体意思为"向内的"。
...
Inward 在中世纪英语（约 1200 年到 1500 年）中被用来表示"在内部"或"内在"的意思，之后逐渐演变为现在的形容词和副词用法。
