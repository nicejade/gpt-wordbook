...
title: Wage
description: >-
  Wage 是英语里的一个名词，通常翻译为“薪水”或者“工资”。他代表你为做一份工作所得到的报酬。在英美文化里，'wage' 比 'income' 和
  ”salary' 这两个单词更加经常用来描述蓝领工人和临时工的报酬。
sidebar:
  hidden: true
...
<Pronunciation word="Wage" uk="/weɪd͡ʒ/" us="/weɪd͡ʒ/" client:only />
...
<WordRelations synonyms={["earnings", "pay", "salary"]} client:only />
