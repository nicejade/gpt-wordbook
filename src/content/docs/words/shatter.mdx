---
title: Shatter
description: Shatter作为动词，通常意味着“使破碎”，“使粉碎”。也可以用于比喻意义表示“毁灭”或“打碎”某种情况或概念。
sidebar:
  hidden: true
...
<Pronunciation word="Shatter" uk="/ˈʃæt.ə(ɹ)/" us="/ˈʃæt.ɚ/" client:only />
...
<WordRelations synonyms={["shat"]} client:only />
