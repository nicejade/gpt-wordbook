---
title: Cabbage
description: cabbage是一个名词，中文翻译为“卷心菜”。它是一种食物，属于十字花科植物。
sidebar:
  hidden: true
...
<Pronunciation word="Cabbage" uk="/ˈkæbɪdʒ/" us="/ˈkæbɪdʒ/" client:only />
...
<WordRelations synonyms={["cole", "greens", "vegetable"]} client:only />
