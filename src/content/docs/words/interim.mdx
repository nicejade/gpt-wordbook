---
title: Interim
description: 英语单词 'interim' 是一个形容词和名词，主要用来描述那些临时或过渡期的情况。
sidebar:
  hidden: true
...
<Pronunciation word="Interim" uk="/ˈɪntəɹɪm/" us="/ˈɪntəɹɪm/" client:only />
...
<WordRelations synonyms={["caretaker", "provisional"]} client:only />
