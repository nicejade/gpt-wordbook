---
title: Sin
description: Sin 通常用作名词，表示'罪恶'或'过错'，例如，在宗教语境中，它被用来表示违背神圣道德法则的行为。此外，在数学中，sin 可以是一种表示正弦函数的缩写。
sidebar:
  hidden: true
...
<Pronunciation word="Sin" uk="/sɪn/" us="/sɪn/" client:only />
...
- The value of sin 60 degrees is equal to the square root of 3/2. (60 度的 sin 值等于根号 3 除以 2。)
