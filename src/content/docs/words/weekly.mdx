...
title: Weekly
description: >-
  Weekly是一个形容词和副词，通常用来描述发生或完成某事的频率。作为形容词，它描述的是将每周作为频率单位的事情，例如，周刊或者每周的会议。而作为副词，'weekly'用来描述每周完成或经常发生的活动。
sidebar:
  hidden: true
...
<Pronunciation word="Weekly" uk="/wiːk.li/" us="/wiːk.li/" client:only />
...
词缀：-ly, 通常在英文中表示“按照…方式”，或者“…地”。在 weekly 一词中，-ly 用于将“week”(一周)转化为“按周的”或者“每周的”。
...
<WordRelations synonyms={["hebdomadal", "hebdomadally"]} client:only />
