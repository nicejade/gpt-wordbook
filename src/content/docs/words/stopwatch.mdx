---
title: Stopwatch
description: Stopwatch 是一个英语词汇，它出现在很多场景中，主要的意思是'秒表'或者'计时器'。
sidebar:
  hidden: true
...
Stopwatch 没有特殊的词缀，它是由两个英文单词组合而成的。

### 文化背景

"Stopwatch"是由 stop 和 watch 两个词组成，直译为"停止手表"，实际意义为"秒表"，因为它是用来测量和计算时间的。
