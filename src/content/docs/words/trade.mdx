---
title: Trade
description: Trade 是一个英式英语单词，既可以作为名词也可以作为动词。
sidebar:
  hidden: true
...
<Pronunciation word="Trade" uk="/tɹeɪd/" us="/tɹeɪd/" client:only />
...
<WordRelations
  synonyms={["barter","deal","business","commerce","craft","patronage","exchange","swap","switch","truck"]}
  client:only
/>
