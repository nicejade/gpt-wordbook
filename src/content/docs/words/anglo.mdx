---
title: Anglo
description: Anglo 是一个英文前缀，通常代表英格兰或英国，也用于表示与英国人、英国文化或英国的有关的。
sidebar:
  hidden: true
...
<Pronunciation word="Anglo" uk="/ˈæŋ.ɡləʉ/" us="/ˈæŋ.ɡləʉ/" client:only />
...
Anglo 是由英国（England）和罗马（-Roman）分别取一个音节组成的。
