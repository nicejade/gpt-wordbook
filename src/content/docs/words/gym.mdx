---
title: Gym
description: Gym的意思是健身房，是一种专门为人们锻炼身体和健康设置的设施。
sidebar:
  hidden: true
...
<Pronunciation word="Gym" uk="/dʒɪm/" us="/dʒɪm/" client:only />
...
"Gym" 是一个来自于古希腊语词 gymnasium 的简化词，gymnasium 在古希腊文化中是裸体锻炼的场所。因此，它没有其他根词衍生词。
...
"gym"这个单词出自 19 世纪，由 gymnasium 简化而来，含义是指为进行体育锻炼而设的场所。在这样的场所，人们能进行各种各样的运动，如举重、锻炼力量或耐力运动，如跑步、游泳、登山等。
...
<WordRelations synonyms={["gym"]} client:only />
