---
title: Identical
description: 英语单词 'identical' 是形容词，意思是“完全相同的、一模一样的”。
sidebar:
  hidden: true
...
<Pronunciation word="Identical" uk="/aɪˈdɛntɪkl̩/" us="/aɪˈdɛntɪkl̩/" client:only />
...
<WordRelations
  synonyms={["same","selfsame"]}
  antonyms={["contrasting","different","distinct"]}
  client:only
/>
