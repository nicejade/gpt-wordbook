...
<Pronunciation word="Scrape" uk="/skɹeɪp/" us="/skɹeɪp/" client:only />
...
"Scrape"这个词汇可以追溯到约 1250 年的古英语，源自西日耳曼语群的*skrapojan。词义在发展过程中保持相对稳定，主要指通过硬物来清除表面的动作。
...
<WordRelations
  synonyms={["bind","fix","mess","pickle","altercation","brawl","fight","fistfight","fisticuffs","scuffle","abrasion","graze","drag","grate","scratch","abrade","chafe"]}
  client:only
/>
