---
title: Express
description: Express作为动词，具有多层含义，可以指明确表达，快速传递；作为形容词，表示明确的或者直接的；作为名词，表示特快列车或者快递。
sidebar:
  hidden: true
...
<Pronunciation word="Express" uk="/ɛk.ˈspɹɛs/" us="/ɛk.ˈspɹɛs/" client:only />
...
"Express"由 ex-(外、出)和-press(压榨，推)，表示压榨出或者露出，也就有了表达的含义。

### 文化背景

"Express"在 14 世纪由拉丁文"expressus"演变过来，原意为"清楚明白显示出来"。后来逐渐具有了"传达，标明，并明确地告诉"的意思。
...
<WordRelations
  synonyms={["explicit", "plain", "crack", "fast"]}
  antonyms={["local", "stopper", "implied"]}
  client:only
/>
