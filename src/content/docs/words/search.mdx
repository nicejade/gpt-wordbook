---
title: Search
description: Search 这个单词是一个既可当动词也可作名词使用的英文单词，因此含有两种主要的含义：
sidebar:
  hidden: true
...
<Pronunciation word="Search" uk="/sɜːt͡ʃ/" us="/sɝt͡ʃ/" client:only />
...
<WordRelations synonyms={["comb", "scour", "seek"]} client:only />
