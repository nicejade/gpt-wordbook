---
title: "search"
description: "Search 这个单词是一个既可当动词也可作名词使用的英文单词，因此含有两种主要的含义： * 作为动词使用时，search 主要表示“搜寻”或者“搜索”的意思，例如：“Search for clues.”(搜索线索）。 * 作为名词使用时，“search”则主要表示“搜查”，“搜寻”，例如： “The search was arduous.” (搜索工作艰巨)."
---
...
"Search"的词根来自于拉丁语词根"circāre"，表示“四处看”。这个词根也可在单词 circus（马戏团，环形竞技场）中找到。
