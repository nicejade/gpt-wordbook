---
title: chopsticks
description: 英语单词“chopsticks”指的是“筷子”。这是一种亚洲饮食文化中常见的餐具，特别是在中国、日本、韩国和越南等地。
sidebar:
  hidden: true
...
"Chopsticks"这个词在英文中的使用可以追溯到 17 世纪，当时作为英国间接贸易中从中国引入的一个词汇。因为筷子是东亚饮食文化的一部分，这个词也常被用来象征亚洲文化上的区别。
