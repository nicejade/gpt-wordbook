...
description: >-
  Characteristic 是一个形容词，也可作为名词使用，主要表示的是特性、特征或者代表性的特点。例如：“a characteristic
  feature（特征性的特点）”。
sidebar:
  hidden: true
...
"Characteristic" 这个词最初来自希腊语，经过拉丁语传到英语，最早在 17 世纪时被用作英语单词。
...
<WordRelations
  ...
  antonyms={["uncharacteristic", "untypical"]}
  client:only
/>
