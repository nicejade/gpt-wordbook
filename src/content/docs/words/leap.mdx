---
title: Leap
description: Leap 是一个动词，表示'跳跃'或'快速移动'，也可以作为名词，表示'跳跃'或'跳跃的距离'。
sidebar:
  hidden: true
...
<Pronunciation word="Leap" uk="/liːp/" us="/liːp/" client:only />
...
<WordRelations synonyms={["bound", "hop", "jump", "spring"]} client:only />
