...
title: Damn
description: >-
  - 'Damn'是一个常用的俚语，被用来表示 frustration，annoyance 或者
  surprise。它用来加重对一件事情或者某人的否定情绪，好比中文的“该死”。如果用于正面情况，如 'damn good', 则表示事件或问题出人意料地好。
sidebar:
  hidden: true
...
<Pronunciation word="Damn" uk="/dæm/" us="/dæm/" client:only />
...
- "Damn" 来自于拉丁语 "damnare”，意为“谴责”或“诅咒”。其他与其相关的单词有 condemn (谴责)，damnation (诅咒，政教分离) 等。
