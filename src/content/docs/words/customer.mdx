---
title: Customer
description: Customer 通常指的是购买产品或服务的人。这个词也被广泛用于形容经常光顾某地或使用某服务的人。
sidebar:
  hidden: true
...
<Pronunciation word="Customer" uk="/ˈkʌstəmə/" us="/ˈkʌstəmə/" client:only />
...
这个词的历史可以追溯到 14 世纪的英格兰，当时用来表示一种习惯或者风俗。并在 15 世纪才进一步演变成比喻常来往的买主，客户。
...
镇上有一个以甜甜圈闻名的面包店。每天早晨，一个忠实的客户名叫 Bob 会过来买一盒新鲜做好的甜甜圈给他的同事。他的一贯行为使他在其他客户和工作人员中成为了一个引人注目的人物。
