...
description: Representation 是个名词，意为“表现”，“代表”，或者“描绘”。它可以结构为下列几种形式：
sidebar:
  hidden: true
...
<Pronunciation
  word="Representation"
  uk="/ˌɹɛp.ɹə.zɛn.ˈteɪ.ʃən/"
  us="/ˌɹɛp.ɹə.zɛn.ˈteɪ.ʃən/"
  client:only
/>
...
"Representation" 这个词在中世纪晚期通过 "representation" (表现，描绘) 的法语引入英语，并在 17 世纪中期形成了 "表示，代表 " 的现代含义。
...
<WordRelations synonyms={["likeness"]} client:only />
