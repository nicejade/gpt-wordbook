...
title: Doom
description: >-
  - Doom 是一个英语单词，其主要意思是'厄运'、'毁灭'或'死亡'。它可能涵盖了能导致最后的失败或破坏的任何形势的概念。当用作动词时，Doom
  意味着指定或判定为失败、死亡或灾难。
sidebar:
  hidden: true
...
<Pronunciation word="Doom" uk="/duːm/" us="/duːm/" client:only />
...
<WordRelations antonyms={["fortune"]} client:only />
