...
description: >-
  Generalization
  是一个名词，主要有两种含义。第一种含义是“概括”，指把一组具有相同性质的具体事物或观念提炼抽象为一个总括概念。第二种含义是“泛化”，在逻辑和科学研究中指由特殊到一般的推理或结论，即通过观察个别现象得出的一般性原则或规律。
sidebar:
  hidden: true
...
"Generalization" 这个词在 18 世纪后期首次出现在英语中，用于科学研究领域以表示从具体事例提炼出的一般原理。
