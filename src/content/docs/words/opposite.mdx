---
title: Opposite
description: Opposite这个单词在英语里面表示“与...完全相反或者对立”，通常用来描述两个事物之间的差异性。在数学上，它还可以用来描述两个角度或矢量的对立面。
sidebar:
  hidden: true
...
<Pronunciation word="Opposite" uk="/ˈɒpəsɪt/" us="/ˈɑp(ə)sɪt/" client:only />
...
"Opposite"这个单词来自于 14 世纪的中古法语"opposite"，它又来自于拉丁语"oppositus"，原意为“对立的，相反的”。
