...
title: Rotten
description: >-
  Rotten 是一个形容词，主要有两个含义。首先，它可以描述物体被侵蚀、破损，老旧无法使用或食物等物质腐烂，比如 'rotten
  fruit'（腐烂的水果）。其次，它也可以用于形容非物质的事物，譬如不好、差劲、恶劣的意思，例如 'rotten behavior'（恶劣的行为）。
sidebar:
  hidden: true
...
<Pronunciation word="Rotten" uk="/ˈɹɒtn̩/" us="/ˈɹɒtn̩/" client:only />
...
"Rotten"的词根是 "rot"，这是一个从老英语 derived 出来的词汇，意为腐烂。
...
Rotten 的来源可以追溯到古尔代语，它在查尔斯·狄更斯的许多作品中被广泛使用，描绘了当时社会的疾病和腐败。例如在《荒凉山庄》中，寓言化地描绘了腐败的社会。
