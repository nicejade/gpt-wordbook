---
title: Interrupt
description: Interrupt是一个动词，主要含义是'打断另一人或事情的进程'。它也可以表示'使事情被迫暂停或终止'。
sidebar:
  hidden: true
...
'Interrupt'这个词源自拉丁语'intrruptus'，在 16 世纪初传入英语。
...
"Tom was about to propose to Lily, when their dog suddenly jumped and interrupted him." (Tom 正准备向 Lily 求婚，突然他们的狗跳了起来，打断了他。)

<WordRelations antonyms={["continue", "resume"]} client:only />
