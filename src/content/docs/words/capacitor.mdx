---
title: Capacitor
description: Capacitor 是电容器的英文表示。电容器是一种储存电能的电子元件，由内藏有两片导体和介质的薄膜组成。
sidebar:
  hidden: true
...
"Capacitor" 一词首次在 1745 年由德国科学家 Ewald Georg 使用，用于描述他的发明 "Leiden jar"，是一种早期的电容器。
...
<WordRelations synonyms={["condenser"]} client:only />
