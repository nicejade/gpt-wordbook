---
title: Thin
description: Thin是一个形容词，通常用来描述体积小或厚度小的物体、人或动物。它也可以用来表示液体的稀薄，或者事物的稀疏、不足。
sidebar:
  hidden: true
...
<Pronunciation word="Thin" uk="/ˈθɪn/" us="/ˈθɪn/" client:only />
...
"Thin"的现代意义，即"不厚或尺寸小"，可以追溯到 14 世纪。其在文化中的内涵常常与“不足或显得弱小”相联系，如瘦弱的人、稀薄的空气或稀疏的植被。
...
<WordRelations
  synonyms={["reedy","skinny","slender","slim","svelte","waifish","narrow","sparse","scant","scarce","slight","runny","watery","fine"]}
  antonyms={["thick"]}
  client:only
/>
