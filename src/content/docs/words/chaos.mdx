---
title: Chaos
description: Chaos 是一个英文名词，意思是'混乱'，指的是一种无序或混乱的状态。这个单词也经常用来描述非常混乱的场景或事件。
sidebar:
  hidden: true
...
<Pronunciation word="Chaos" uk="/ˈkeɪ.ɒs/" us="/ˈkeɪ.ɑs/" client:only />
...
<WordRelations antonyms={["cosmos", "order"]} client:only />
