...
title: Own
description: >-
  Own是一个常见的英语单词，既可以作为动词也可以作为形容词。作为动词时，主要意思是“拥有”，例如： 'I own a
  car.'（我有一辆汽车）。作为形容词时，意为'自己的'，例如：'This is my own room.'（这是我自己的房间）。
sidebar:
  hidden: true
...
<Pronunciation word="Own" uk="/ˈəʊn/" us="/ˈoʊn/" client:only />
...
想象一个场景，在一家商店，店主说，“我拥有这个店，这是我的 own 店（own sounds like 'own' in the dialogue）。”通过此双关方法，你可能会更容易记住这个单词。
