...
title: Climax
description: >-
  Climax 来源于古希腊的 klimax，意为 '梯子' 或
  '攀爬'。现在它主要有两个含义：在故事或事件中的最高、最紧张或最重要的点；或在音乐中的最高点或顶峰。
sidebar:
  hidden: true
...
<Pronunciation word="Climax" uk="/ˈklaɪmæks/" us="/ˈklaɪmæks/" client:only />
...
<WordRelations
  synonyms={["auxesis", "catacosmesis", "incrementum"]}
  antonyms={["catacosmesis"]}
  client:only
/>
