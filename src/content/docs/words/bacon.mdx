---
title: Bacon
description: Bacon 是英语中的一个名词，主要指一种制成薄片的熏或煮熟的猪肉，通常在早餐时食用。在烹饪中，它也常常用于制作三明治，或者烹调其他食物以增添风味。
sidebar:
  hidden: true
...
<Pronunciation word="Bacon" uk="/ˈbeɪ.kən/" us="/ˈbeɪ.kən/" client:only />
...
<WordRelations synonyms={["ham", "pork"]} client:only />
