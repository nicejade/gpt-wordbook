---
title: Fragrant
description: Fragrant 是一个形容词，用来形容有很好闻、清新、宜人的香味的东西。
sidebar:
  hidden: true
...
Fragrant 的词缀包括前缀 f-, 词根-fragr-, 和后缀-ant。

相同词缀的单词例如：flamboyant (浮夸的)，pregnant (怀孕的)。

### 文化背景

Fragrant 一词来源于拉丁语的 fragrare，这个词在欧洲文化中通常与美好的事物，如花朵、食物、香水等相联系。
...
<WordRelations
  antonyms={["fetid", "noisome", "pungent", "smelly"]}
  client:only
/>
