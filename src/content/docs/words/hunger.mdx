...
title: Hunger
description: >-
  Hunger 主要有两层含义，一种是生理上饥饿，需要食物的感觉；另一种是渴望，对某事的强烈求知或者追求。例如：“Knowledge can solve
  the hunger of the mind.” (知识可以解决心灵的饥饿。)
sidebar:
  hidden: true
...
<Pronunciation word="Hunger" uk="/ˈhʌŋɡə/" us="/ˈhʌŋɡɚ/" client:only />
