---
title: Daring
description: "Daring 是一个形容词, 它的基本意思是“勇敢的”，“大胆的”，它可以描述一个人或一个行为勇于尝试或接受风险和困难。"
sidebar:
  hidden: true
...
<Pronunciation word="Daring" uk="/ˈdɛəɹɪŋ/" us="/ˈdɛəɹɪŋ/" client:only />
...
"Daring" 的构造比较简单, 主体 dare 是个词根, 其后缀-ing 使其变成形容词。
...
<WordRelations
  synonyms={["boldness", "audacious", "bold", "dareful", "venturesome"]}
  client:only
/>
