...
description: >-
  - 'Clearly'
  是一个副词，主要有两个含义：一是“清楚地，明白地”，用于描述事物可以被轻易理解或观察到；二是“无疑地、明显地”，用于强调某一事实或者状况极其明显，不容置疑。
sidebar:
  hidden: true
...
<Pronunciation word="Clearly" uk="/ˈkliːɹli/" us="/ˈklɪɹli/" client:only />
...
<WordRelations synonyms={["expressly", "unambiguously"]} client:only />
