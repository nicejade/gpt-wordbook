---
title: Purify
description: Purify是一个动词，通常被用来指清洁、净化或者除去污染物。在物理、化学以及精神层面都可以使用，如净化水、净化空气、精神净化等。
sidebar:
  hidden: true
...
<Pronunciation word="Purify" uk="/ˈpjʊəɹɪfaɪ/" us="/ˈpjʊəɹɪfaɪ/" client:only />
...
<WordRelations antonyms={["defile"]} client:only />
