---
title: Weakness
description: Weakness是一个名词，意为“弱点”、“弱处”、“软点”，也可以指物理上或情感上的“虚弱”。
sidebar:
  hidden: true
...
<Pronunciation word="Weakness" uk="/ˈwiːk.nəs/" us="/ˈwiːk.nəs/" client:only />
...
Weakness 本身是名词，对应的形容词是 weak，表示“虚弱的”；副词形式为 weakly，表示“虚弱地”。
...
<WordRelations
  synonyms={["frailty","powerlessness","vulnerability","defect","fault","flaw","hole"]}
  antonyms={[
    "durability",
    "invincibility",
    "powerfulness",
