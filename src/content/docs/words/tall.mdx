---
title: Tall
description: "- 'Tall' 是一个形容词，用于描述物体的高度或人的身高比一般或平均水平要高。它也可以用来形容数量、程度或时间较长。"
sidebar:
  hidden: true
...
<Pronunciation word="Tall" uk="/tɔːl/" us="/tɑl/" client:only />
...
<WordRelations antonyms={["low", "short"]} client:only />
