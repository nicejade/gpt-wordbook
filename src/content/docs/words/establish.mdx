...
title: Establish
description: >-
  Establish 是一个动词，有多种含义，包括：“建立；设立；创办；确认；确立”。比如，我们可以‘establish a
  company’（建立一家公司）或者‘establish a connection’（建立联系）。
sidebar:
  hidden: true
...
"Establish" 在 14 世纪初从法语中引入英语中，最初的意思是"confirm legally"。在文化中，"establish" 常被用于法律、政治和社会制度的建立。
