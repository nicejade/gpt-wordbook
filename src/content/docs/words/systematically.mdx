...
description: "- 'Systematically' 是个副词，用来描述一个行为或过程是有系统的，有条理的，按一定的顺序或规矩进行的。"
sidebar:
  hidden: true
...
- 词缀："systematically"无前缀，-ic 是形容词后缀，-ally 是转换为副词的后缀。
...
<WordRelations synonyms={["methodically", "systemwise"]} client:only />
