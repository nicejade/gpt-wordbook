...
description: >-
  「Petty」
  是一种形容词，主要描述那些不重要、琐碎的事情或吝啬的人。它可以用来形容一切非重大，非严重，非主要的事物。在另一种情况下，表示一种心胸狭窄或者小气的态度。
sidebar:
  hidden: true
...
<Pronunciation word="Petty" uk="/ˈpɛti/" us="/ˈpɛti/" client:only />
...
「Petty」一词在 14 世纪从法语中派生而来，最早的含义是“小的”。
...
<WordRelations synonyms={["ABC", "grudgeful", "grudging"]} client:only />
