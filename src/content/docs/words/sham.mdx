---
title: Sham
description: Sham 主要被用于两种不同的语境。首先，作为名词，它用来描述任何假的、欺骗性的或假装的东西。其次，作为动词，'sham' 指的是伪装或假装。
sidebar:
  hidden: true
...
<Pronunciation word="Sham" uk="/ʃæm/" us="/ʃæm/" client:only />
...
"Sham"这个词可能来自 16 世纪的英格兰方言，"sham"或"shame"意思是诈骗，欺骗。
...
过去式和过去分词形式为 shammed，现在分词形式为 shamming。
