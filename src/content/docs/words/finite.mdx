---
title: Finite
description: Finite是一个英语形容词，意思是有限的，有尽头的，非永久的。这个词用来描述一个数量，空间，时间等有一个清晰可见的限制或结束的东西。
sidebar:
  hidden: true
...
<Pronunciation word="Finite" uk="/ˈfaɪnaɪt/" us="/ˈfaɪnaɪt/" client:only />
...
"Finite"是源自拉丁文的 "finitus"，这个词是“finis”(结束)的过去分词形式。此词最早记载于 14 世纪，在以数学和哲学为主的学术研究中出现。
...
<WordRelations
  synonyms={["limited"]}
  antonyms={["endless","eternal","everlasting","infinite","unlimited"]}
  client:only
/>
