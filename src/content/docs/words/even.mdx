---
title: Even
description: Even 是一个极为常用且多功能的英语单词。它可以作为形容词、副词、连词以及动词使用。以下是其主要的含义：
sidebar:
  hidden: true
...
<Pronunciation word="Even" uk="/ˈiːvən/" us="/ˈivn̩/" client:only />
...
<WordRelations
  synonyms={["match","flatten","level","settle","round","flat","uniform","quits","square","monotone","regular","definitely","precisely"]}
  antonyms={["odd","uneven"]}
  client:only
/>
