...
description: >-
  ...
  当作为形容词使用时，"even"意思是"平坦的"、"相等的"或者"偶数的"，例如 "an even surface"（平坦的表面）或者 "an even
  number"（偶数）。 - 当作为副词使用时，"even"用来增强语气，做到“甚至”、“连……都”的效果，例如 "even
  better"（更好）或者"even you"（连你都）。 - 作为连词时，"even"表达“即使”的含义，例如 "even if"（即使）。 -
