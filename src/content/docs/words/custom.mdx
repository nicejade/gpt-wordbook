...
description: >-
  Custom
  是一个非常常用的英语单词，它主要有两种含义。第一种是“习惯”，指的是某种惯常进行的，特定的行为或活动。第二种是“风俗”，指的是特定社区、地区或国家人们的生活方式和行为。在商务语境中，'custom'
  也常常指定制的或者是订制的。
sidebar:
  hidden: true
...
<Pronunciation word="Custom" uk="/ˈkʌstəm/" us="/ˈkʌstəm/" client:only />
...
"Custom"首次出现在英语中是在 14 世纪，最初是指一种习惯或者是习性。后来，这个单词逐渐演变，含义扩大到指某一特定社区或地区的生活方式或者是行为习惯。
...
<WordRelations
  synonyms={["fashion", "habit", "practice", "usage", "wone", "wont"]}
  client:only
/>
