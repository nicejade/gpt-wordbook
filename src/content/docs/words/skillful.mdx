---
title: Skillful
description: Skillful 是一个形容词，用来描述某人在某事上非常擅长，有高超的技巧。通常用来形容技艺高超的人。
sidebar:
  hidden: true
...
<Pronunciation word="Skillful" uk="/ˈskɪl.fəl/" us="/ˈskɪl.fəl/" client:only />
...
词缀"-ful"作为后缀，表示"充满...的"或"有...特性的"。像是 peaceful（和平的），grateful（感恩的）等都使用了这一词缀。
