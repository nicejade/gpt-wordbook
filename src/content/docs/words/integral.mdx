---
title: Integral
description: Integral 是一个英语形容词，作为形容词时，常常表示“必不可少的”，“完整的”。它还可以作为名词，表示数学概念中的“积分”。
sidebar:
  hidden: true
...
<Pronunciation word="Integral" uk="/ˈɪntɪɡɹəl/" us="/ˈɪntɪɡɹəl/" client:only />
...
"Integral"来自于拉丁语的整数概念“integer”，其在拉丁语的意思是"untouched, thus 'entire'"（未触碰的，因此是'完整的'）。这个词在 17 世纪的数学领域中首次出现，用作积分的概念。
...
<WordRelations
  synonyms={["antiderivative", "∫", "immanent", "inherent", "necessary"]}
  antonyms={["derivative"]}
  client:only
/>
