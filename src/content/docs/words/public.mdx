---
title: Public
description: "- 'Public' 常作形容词，意为公共的，公开的，大众的。它也可以用作名词，表示公众，群众。"
sidebar:
  hidden: true
...
<Pronunciation word="Public" uk="/ˈpʌblɪk/" us="/ˈpʌblɪk/" client:only />
...
<WordRelations antonyms={["private"]} client:only />
