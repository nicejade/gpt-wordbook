...
title: Half
description: >-
  Half 是一个英语单词，作为名词，它的意思是“一半”，'two halves make a whole'
  意思是'两半组成一个整体'。当'half'用作形容词时，意思是'一半的'或'不完整的'，例如'half an apple' 表示'半个苹果'。
sidebar:
  hidden: true
...
<Pronunciation word="Half" uk="/hɑːf/" us="/hɑːf/" client:only />
...
Amy ate half an apple at breakfast. (Amy 在早餐时吃了半个苹果。)
小故事的中文翻译：艾米在早餐时吃了半个苹果。

<WordRelations synonyms={["½", "dimidiate"]} client:only />
