---
title: Silent
description: 英文单词 'silent' 主要是形容词，中文翻译为“沉默的，寂静的”。它常用来描述一个人或者物体没有制造出声音或是噪音的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Silent" uk="/ˈsaɪlənt/" us="/ˈsaɪlənt/" client:only />
...
<WordRelations
  synonyms={["quiet","invisible","dormant","still","mute","quiescent","servile","speechless","taciturn","dumb"]}
  client:only
/>
