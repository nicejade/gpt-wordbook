...
title: Decrease
description: >-
  Decrease 是一个英文单词，通常用作名词或动词。作为动词使用时，'decrease' 的意思是减少、降低。作为名词使用时，'decrease'
  的意思是减少、减小、降低。
sidebar:
  hidden: true
...
1.  The government aims to decrease unemployment by 5% this year. (政府计划今年将失业率降低 5%。)
...
“Decrease”这一词起源于 14 世纪的中英语时期，最初是作为动词，意思为“减少、降低”，后来发展为名词，表示“减少、降低”的状态或动作。
...
<WordRelations
  synonyms={["cut","decrement","drop","fall","loss","lowering","reduction","shrinkage","plummet","plunge","reduce","shrink","sink","abate","lower"]}
  antonyms={["gain","increase","increment","raise","rise","grow","soar","up"]}
  client:only
/>
