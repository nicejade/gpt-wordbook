---
title: Smuggle
description: Smuggle 是一个动词，它的基本含义是非合法或秘密地走私（人或货物），通常为了逃避法律条款，避免检查或税收。
sidebar:
  hidden: true
...
<Pronunciation word="Smuggle" uk="/ˈsmʌɡəl/" us="/ˈsmʌɡəl/" client:only />
...
"Smuggle" 这个词在 17 世纪的英语中被首次使用，源头是荷兰语的 "smuggelen"，当时的含义是“走私”，这也解释了为什么走私行为在现代社会中被视为违法和危险。
