---
title: Mop
description: mop主要有两个含义：一是作为动词，表示'用拖把擦洗'；二是作为名词，表示'拖把'。
sidebar:
  hidden: true
...
<Pronunciation word="Mop" uk="/mɒp/" us="/mɑp/" client:only />
...
"mop"单词并没有明显的词根。它在中古英语中原为"mappe"，首次在 15 世纪被纪录为"moppe"，并逐渐简化为现在的"mop"。
...
"mop"一词来源于中古英语"mappe"，在 15 世纪被记为"moppe"，并最终简化为"mop"。拖把作为清洁工具，在英美文化中十分常见，它不仅是家务劳动中必备的工具，也是在各类公共场所保持清洁的重要道具。
...
Tommy accidentally spilled some juice on the floor. He quickly grabbed a mop and started mopping. His little puppy watched curiously. (Tommy 不小心把果汁洒在了地板上。他迅速抓起拖把开始擦洗。他的小狗疑惑地看着。)
