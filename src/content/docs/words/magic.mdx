---
title: Magic
description: Magic 是一个英文单词，具有魔法、巫术或者神奇的意义。它可以用作名词或形容词。
sidebar:
  hidden: true
...
<Pronunciation word="Magic" uk="/ˈmadʒɪk/" us="/ˈmædʒɪk/" client:only />
...
Magic 是一词根词，没有词缀。以 ic 结尾的形容词很多，如 "specific"（具体的）,"fantastic"（棒极了）等。
...
<WordRelations
  synonyms={["charmwork","conjuring","dweomercraft","dwimmer","dwimmercraft","enchantment","hexcraft","sorcery","spellcasting","spellcraft","spellwork","thaumaturgy","wandwork","warlockry","witchcraft","wizardcraft","wizardry","illusionism","legerdemain"]}
  client:only
/>
