...
title: Stripe
description: >-
  Stripe有'条纹'的意思，通常指物体上相间的线状标记或图案，可以用来形容材料、服装、动物等上的条纹。此外，'stripe'也有'类型、种类'的意思，常用短语是'of
  a different stripe'，表示'完全不同的类型'。
sidebar:
  hidden: true
...
<Pronunciation word="Stripe" uk="/st(ʃ)ɹʌɪp/" us="/st(ʃ)ɹʌɪp/" client:only />
