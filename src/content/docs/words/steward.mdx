...
description: >-
  Steward
  是一个英文名词，主要有两种含义：一是指“乘务员”，通常是指飞机、火车、船上的服务人员。二是“管理人”，尤其是对公共事务的管理者或者管理其他人财物的人。
sidebar:
  hidden: true
...
<Pronunciation word="Steward" uk="/ˈstjuː.əd/" us="/ˈstuɚd/" client:only />
...
<WordRelations
  synonyms={["bailiff","provost","caretaker","custodian","groundskeeper","keeper"]}
  client:only
/>
