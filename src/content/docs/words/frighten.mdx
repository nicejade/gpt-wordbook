...
description: >-
  Frighten
  这个单词是一个动词，意思是“使恐惧”或“使害怕”。它涵盖了任何引起恐惧或焦虑的行为，可以是源于真实的威胁，也可以是幻觉或虚构的情况。它用来描述对事物或情况产生深刻恐惧的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Frighten" uk="/ˈfɹaɪtn̩/" us="/ˈfɹaɪtn̩/" client:only />
...
Frighten 源自古英语的 fyrhtan，意味着使恐惧或被吓到。它最初被用于描绘恶魔或鬼魂引发的恐惧。
...
（有一个叫 Tom 的男孩，他喜欢用编造的鬼故事吓他的小妹妹。但是有一天，他的妹妹受够了，决定让他尝尝自食其果的滋味。）
