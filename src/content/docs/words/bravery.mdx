---
title: Bravery
description: Bravery 是一个名词，指的是在面对困难、挑战或危险时所表现出的大胆与勇气。
sidebar:
  hidden: true
...
<Pronunciation word="Bravery" uk="/ˈbɹeɪvəɹi/" us="/ˈbɹeɪvəɹi/" client:only />
...
<WordRelations
  synonyms={["braveness","courage","fearlessness","pluck","valor"]}
  client:only
/>
