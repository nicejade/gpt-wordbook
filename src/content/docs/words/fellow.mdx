---
title: Fellow
description: Fellow 是一个英文单词，主要有两个常见的含义。一是作为名词使用，表示“同伴”或者“朋友”；第二个是在学术环境中用来表示“研究员”或者“学者”。
sidebar:
  hidden: true
...
<Pronunciation word="Fellow" uk="/ˈfɛləʊ/" us="/ˈfɛloʊ/" client:only />
...
"Fellow" 这个单词在 13 世纪的中英语中首次出现，起初只表示"同伴"或"伙伴"。到了 16 世纪，这个词开始用于表示大学的研究员或学者，这也是我们今天在学术环境中常用的意思。
...
<WordRelations synonyms={["fellow", "schoolfellow"]} client:only />
