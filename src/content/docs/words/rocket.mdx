---
title: Rocket
description: Rocket 是英文里表示火箭的词汇。火箭是允许在没有空气的空间被推动前进的载具，主要应用于航天科学。
sidebar:
  hidden: true
...
<Pronunciation word="Rocket" uk="/ˈɹɒkɪt/" us="/ˈɹɑkɪt/" client:only />
...
"Rocket" 最初在 14 世纪作为 "rochet" 出现在英语中，那时候它的含义是指小线轴。后来在 17 世纪火箭作为一种武器出现后，这个词被用来表示这种新的装置。
