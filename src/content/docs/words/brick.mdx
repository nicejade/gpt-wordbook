---
title: Brick
description: Brick 是名词，表示的是一种硬化后用于建筑的矩形陶瓷材料，中文里意思是 '砖头'。同时，'brick' 也可以作为形容词，形象地描述一种红褐色。
sidebar:
  hidden: true
...
<Pronunciation word="Brick" uk="/bɹɪk/" us="/bɹɪk/" client:only />
...
（埃里克在他的院子里发现了一块老砖头。好奇心驱使他去了图书馆，那里他发现它是从 19 世纪的！）

<WordRelations antonyms={["unbrick"]} client:only />
