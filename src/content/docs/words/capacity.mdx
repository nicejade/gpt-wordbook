...
title: Capacity
description: >-
  Capacity是一个名词，主要有三个含义：一是指容量，即能够装载多少的测量；二是指能力，即具有执行或生产某些东西的能力；三是指职位或职责。
  它也可以表示人的潜力或身体、精神的承受程度。
sidebar:
  hidden: true
...
<Pronunciation word="Capacity" uk="/kəˈpæsɪti/" us="/kəˈpæsɪti/" client:only />

### 列举例句

1.  The capacity of the fuel tank in my car is 50 liters.（我的汽车的油箱容量是 50 公升。）
...
"Capacity"来自中古法语 "capacité"，在 14 世纪时开始用于英语，表示"能力"或"状态"。
...
<WordRelations synonyms={["throughput"]} client:only />
