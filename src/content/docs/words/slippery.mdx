...
title: Slippery
description: >-
  Slippery是一个形容词，最基本的含义是“滑的，溜的”，常被用来形容地面、物体的表面等在触摸或行走时具有滑动的特性。此外，'slippery'还可以用来形容一个人或行为“狡猾的，不可信赖的”。
sidebar:
  hidden: true
...
<Pronunciation word="Slippery" uk="/ˈslɪpəɹi/" us="/ˈslɪpəɹi/" client:only />
...
"Slippery" 这个词在英语中的使用可以追溯到 14 世纪，当时它的含义主要是指“光滑的，滑溜的”。而关于“狡猾的，不可信赖的”这一含义则在 18 世纪开始出现。
...
<WordRelations
  synonyms={["greasy", "slick", "slimy", "slippy", "wet"]}
  antonyms={["sticky"]}
  client:only
/>
