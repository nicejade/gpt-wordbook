---
title: Reliable
description: Reliable 是一个形容词，表示“可靠的，值得信赖的”。它通常用来描述某人或者某样事物是可信赖、稳定或者不会失效的。
sidebar:
  hidden: true
...
Reliable 由 "re-"（再，重复） + "ly"（...的）+ "-able"（能...的）组成。并没有明确的来源词根，-able 是变形的词缀，表明"有...能力"。

### 词缀分析

-able 是一个常见的后缀，用来从动词或者形容词中派生形容词，意思是"有能力做..."。例如，可移动的（moveable）、可信的（believable）等。

### 文化背景

“Reliable”这个单词源自 18 世纪的英国，起初是用来描述一个人的性格或行为的，但现在已经扩大到所有的事物。在这期间，它一直保持着它的基本含义，即可以信赖。
...
<WordRelations
  synonyms={["secure","trustworthy","trusty"]}
  antonyms={["unreliable"]}
  client:only
/>
