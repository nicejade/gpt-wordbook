---
title: "install"
description: "Install 是一个动词，通常有两种基本含义：一是指将一些设备或软件放置或安装在特定的位置或系统中以便使用。例如：install a new shower，安装新的淋浴设备；安装新的计算机程序Install a new computer program。 二是指使某人就职，正式地把某人置于某一职位上。例如：The new president will be installed next week，新总统将在下周正式就职。"
---
