...
title: Vitality
description: >-
  Vitality是一个名词，来源于拉丁词汇'vitalitas'，原意为生命，现在的含义为活力，生命力，精力充沛。这是一个积极的词语，常用来形容生活中充满热情，充满活力的人或事物。
sidebar:
  hidden: true
...
"Vitality"一词源自拉丁文的"vitalitas"，原意为"生命"，最早见于 16 世纪。在欧美文化中，这个词常用于健康，能量和活力的描述，表示积极向上的生命态度。
