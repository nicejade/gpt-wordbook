...
title: monopoly
description: >-
  Monopoly是一个英语名词，意为垄断，指的是一个企业、机构或个体在某一领域或行业中的主导地位，无任何竞争对手。 例如：A company becomes
  a monopoly when it is the only one in a particular market selling a product.
sidebar:
  hidden: true
