...
title: Bubble
description: >-
  Bubble 指的是由液体包围的空气或其他气体的小球，通常所指的是水泡。此外，'bubble'
  在经济和金融领域，也经常用来形容物价或资产价值非常过高并可能随时破裂的现象。
sidebar:
  hidden: true
...
<Pronunciation word="Bubble" uk="/ˈbʌb.əl/" us="/ˈbʌb.əl/" client:only />
...
"Bubble" 来自古英语 buduc，意思是“something inflated"，是动词和名词。
...
"Bubble" 这个词从 14 世纪开始用作物体的名称，具体指小球形的气泡。从 17 世纪起，人们开始以"bubble" 为名，分别在经济和科技领域描述过热现象，如经济泡沫和科技泡沫等。
...
<WordRelations
  synonyms={["ambience", "circumstances", "giraffe"]}
  antonyms={[]}
  client:only
/>
