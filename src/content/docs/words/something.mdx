---
title: Something
description: Something 是一个不定代词，一般用来指具体但未被明确的事物或人。
sidebar:
  hidden: true
...
<Pronunciation word="Something" uk="/ˈsamθɪŋ/" us="/ˈsʌmθɪŋ/" client:only />
...
Something 由 "some" 和 "thing" 组成。 "Some" 意为一些或一部分， "thing" 指事物，所以 "something" 的直译就是 “一些事物”或“某事物”。
...
Something 最初在 13 世纪出现在中英语中。它是 "some" 和 "thing" 的合并，用来表示不明确或不可描述的事物。自那时起，“Something”在各种各样的环境下都得到了使用。
...
<WordRelations synonyms={["sth"]} client:only />
