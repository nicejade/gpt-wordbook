---
title: Pants
description: "- 'Pants' 在美国英语中通常指的是 '长裤'，在英国英语中则是对 '内裤' 的通称。"
sidebar:
  hidden: true
...
<Pronunciation word="Pants" uk="/pænts/" us="/pænts/" client:only />
...
- "Pants" 是 19 世纪 60 年代开发的，用于描述男士的裤子。在英式英语中，"pants" 原意为男性穿的内裤或短裤，现在也用于形容事情糟糕或不好。
...
<WordRelations
  synonyms={["breeks", "britches", "hosen", "slacks", "strides", "trousers"]}
  client:only
/>
