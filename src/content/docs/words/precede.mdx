---
title: Precede
description: Precede是一个动词，主要意思是“在时间、地位或重要性上先于、在…之前发生或存在”。
sidebar:
  hidden: true
...
<Pronunciation word="Precede" uk="/pɹiːˈsiːd/" us="/pɹiːˈsiːd/" client:only />
...
在"precede"中，“pre-”是前缀，表示“之前”，“-cede”是词根，表示“走”。与此词缀相对应的其他单词包括：predecease、preamble、precondition 等单词，它们的前缀"pre-"都表示"之前"。

### 文化背景

"precede"一词来自中古法语的"preceder"，进一步追溯可以找到拉丁语的"praecedere"，意为“走在前面”，由"prae-"(在……之前)和"-cedere"(走)组成。18 世纪末，这个词在英语中开始流行。
...
<WordRelations synonyms={["forego"]} antonyms={["succeed"]} client:only />
