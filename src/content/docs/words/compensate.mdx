---
title: Compensate
description: Compensate 是一个动词，意思是“补偿，赔偿”。它可以指在金钱、时间、努力等各个层面对损失或不足进行补偿。
sidebar:
  hidden: true
...
词源可追溯到 16 世纪的拉丁语"compensatus"，在西方社会中，"compensate"常用于法律和财务上，表示出于责任或义务对某人或某事进行补偿或赔偿。
...
将"compensate"拆分为"com-"和"-pensate"，你可以想象你正在和(com-)一位名叫 Pensate 的人支付钱，以帮助你记住这个单词是关于赔偿的。
...
<WordRelations
  synonyms={["accommodate","accustom","adapt","accord","amend","appease","level","offset","reconcile","rectify"]}
  client:only
/>
