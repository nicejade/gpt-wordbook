---
title: Proverb
description: Proverb是一个名词，意思是“谚语”，“俗语”，一般指流传广泛并富含智慧或教诲的简短陈述。
sidebar:
  hidden: true
...
<Pronunciation word="Proverb" uk="/ˈpɹɒvɜːb/" us="/ˈpɹɑːvɝːb/" client:only />
...
Proverb 本身的不同形式并不多。例如，可以把它变为复数形式，作为名词，如 "proverbs"（谚语们）。
...
<WordRelations
  synonyms={["adage","byword","maxim","saw","saying"]}
  client:only
/>
