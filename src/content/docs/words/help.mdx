---
title: Help
description: Help 是一个英语单词，作为动词时，它的意思是“帮助，协助”，例如我帮助他完成作业。作为名词时，它的意思是“帮助，协助”，例如我需要你的帮助。
sidebar:
  hidden: true
...
<Pronunciation word="Help" uk="/hɛlp/" us="/hɛlp/" client:only />
...
“Help”的来源可以追溯到古英语的"helpan"，这个词在英文中有“帮助”的意思。它的词源还可以往后追溯到中古英语，Proto-Germanic，和 Proto-Indo-European，分别是"helpian"和"kelb-"。

### 单词变形

以"help"为例，其动词形式有 helps（第三人称单数形式），helping（现在分词形式）和 helped（过去式和过去分词形式）。"Helper"则是对应的名词形式，表示帮助者。
...
<WordRelations synonyms={["aid", "assistance"]} client:only />
