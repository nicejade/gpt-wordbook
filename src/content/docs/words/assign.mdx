...
title: Assign
description: >-
  Assign这个单词在英语中的意思主要是'分配'，
  '指派'或'设定'。被动形式为'被分配'，'被指派'或'被设定'。这通常关联到一个人把一项任务或者责任给予或者委托给他人。
sidebar:
  hidden: true
...
<Pronunciation word="Assign" uk="/əˈsaɪn/" us="/əˈsaɪn/" client:only />
...
"Assign"这个词源自 14 世纪的法语词汇"assigner"，意为"指定"或者"分配"。这个词进入英语是和法律文书有关的，常常用在分配任务或者责任，后来逐渐演变成现在的多种含义。
...
<WordRelations
  synonyms={["allocate", "earmark", "consign", "convey"]}
  client:only
/>
