---
title: Selective
description: Selective 是一个形容词，表示 '选择性的，有选择性的'。通常是指在众多选项中，仔细挑选、甄选出来的。
sidebar:
  hidden: true
...
<Pronunciation word="Selective" uk="/səˈlɛktɪv/" us="/səˈlɛktɪv/" client:only />

### 列举例句

1.  The university has a selective admissions process.（这所大学有选择性的招生过程。）
2.  She is selective about her friends.（她对朋友非常挑剔。）
3.  The report gives a selective view of the 问题 s at hand.（这份报告针对手头的问题进行了选择性的阐述。）
...
"Selective"一词最早出现在 1620 年，由于知识的爆炸式增长，人们需要“选择性地”获取、处理信息，因此在欧美文化中，这个词表达了理智、理性、批判性思维的精神特质。
