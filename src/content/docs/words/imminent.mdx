...
title: Imminent
description: >-
  Imminent是一个形容词，表示某件事情即将发生或迫在眉睫。例如，“imminent threat”（即将到来的威胁）、'imminent
  danger'（即将出现的危险）。
sidebar:
  hidden: true
...
<Pronunciation word="Imminent" uk="/ˈɪmɪnənt/" us="/ˈɪmɪnənt/" client:only />
...
这个词首次在 16 世纪的英语文献中出现，传达了紧迫和紧张的感觉，常用于描述即将发生的重大事件。
...
<WordRelations
  synonyms={["immediate", "impending", "inevitable"]}
  client:only
/>
