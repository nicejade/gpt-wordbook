...
description: >-
  Compatible
  是一个形容词，主要含义有两个方面。首先，它可以用来描述两个或多个事物（如设备、系统、人或想法）可以一起工作，或相互补充，而不会有冲突或差异。其次，它也可用来描述人彼此兼容，意思是他们的性格、信仰或生活方式可以和谐相处。
sidebar:
  hidden: true
...
曾经，有两个名叫 Com 和 Pati 的齿轮居住在一台大机器里。他们能够毫无冲突地顺畅运转 - 他们真正的相互兼容！

<WordRelations antonyms={["incompatible", "noncompatible"]} client:only />
