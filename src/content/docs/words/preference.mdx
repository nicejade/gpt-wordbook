...
title: Preference
description: >-
  这个英语单词 'preference'来源于拉丁词'praeferre'，意为
  '在前，优先'，在英语中，'preference'表示对某种事物的喜爱程度高于其它事物的状态，也可以理解为优先选择或偏好。
sidebar:
  hidden: true
...
“Preference”最早在 14 世纪的法语中出现，后来在 16 世纪的英语中使用。原始意思是"在法庭上把一个案子放在另一个案子前面"，这个意义包含了"优先考虑"的含义，所以现在我们使用"preference"来表达更喜欢某物的意思。
...
<WordRelations synonyms={["forechoice"]} client:only />
