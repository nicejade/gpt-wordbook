---
title: Phone
description: Phone是英语中的一个非常常用的单词，表示电话。这个单词通常用来指代固定电话或移动电话，可能是特许的设备，也可能是应用程序。
sidebar:
  hidden: true
...
<Pronunciation word="Phone" uk="/fəʊ̯n/" us="/foʊ̯n/" client:only />
...
"Phone"一词在 19 世纪 70 年代，随着电话的发明而产生。电话开创了远程通信的时代，使人们无需面对面就能进行交流，在人类社会发展中起到了重要作用。

### 单词变形

Phone 的复数形式为 phones。作为动词，phone 有三种主要形式：phone(现在式)，phoned(过去式)，phoning(进行时态)。
...
<WordRelations synonyms={["call", "ring", "telephone"]} client:only />
