---
title: Rash
description: Rash是一个英语单词，既可以作为名词，又可以作为形容词使用。作为名词时，它表示的是一种皮肤问题，形象地说就是皮疹。作为形容词时，它的意义是鲁莽的，轻率的。
sidebar:
  hidden: true
...
<Pronunciation word="Rash" uk="/ɹæʃ/" us="/ɹæʃ/" client:only />
...
<WordRelations
  synonyms={["heady","hotheaded","impulsive","inconsiderate","precipitate"]}
  client:only
/>
