---
title: Tilt
description: tilt作为动词，主要有两个含义：1. （使）倾斜；2. 攻击，冲撞。作为名词，可以表达'倾斜'或'猛冲，冲突”。
sidebar:
  hidden: true
...
<Pronunciation word="Tilt" uk="/tɪlt/" us="/tɪlt/" client:only />
...
<WordRelations synonyms={["incline", "slant", "slope"]} client:only />
