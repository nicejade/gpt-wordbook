---
title: Digital
description: digital通常被用来描述那些与计算机技术和电子设备有关的事物。例如，'digital technology' 是指用数字信号处理信息的科技。
sidebar:
  hidden: true
...
<Pronunciation word="Digital" uk="/ˈdɪd͡ʒɪtəɫ/" us="/ˈdɪd͡ʒɪtəɫ/" client:only />
...
<WordRelations
  antonyms={["analog", "analogue", "continuous", "nondigital", "undigital"]}
  client:only
/>
