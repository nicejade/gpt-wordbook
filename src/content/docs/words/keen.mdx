---
title: Keen
description: 英文单词 'keen' 通常用作形容词，有以下主要含义：
sidebar:
  hidden: true
...
<Pronunciation word="Keen" uk="/kiːn/" us="/kin/" client:only />
...
<WordRelations
  synonyms={["biting","piercing","acute","penetrating","shrewd","sharp","ardent","eager","prompt"]}
  client:only
/>
