...
title: Grunt
description: >-
  - 'Grunt' 常见的意思是用于形容人或动物发出的低吼声或嘟囔声，这是一个动词，也是一个名词。此外，在军事术语中，美国士兵有时被称为
  'grunt'，是一个包含亲切和轻微贬义的词。
sidebar:
  hidden: true
...
<Pronunciation word="Grunt" uk="/ɡɹʌnt/" us="/ɡɹʌnt/" client:only />
