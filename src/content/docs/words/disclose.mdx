...
title: Disclose
description: >-
  - 'Disclose' 是一个动词，常用来表示“公开，揭示，透露，披露”。当你有某些信息、事实或具体细节并打算与他人共享时，就可以使用
  'disclose'。例如，一家公司可能会选择'disclose'其年度财务报告。
sidebar:
  hidden: true
...
<Pronunciation word="Disclose" uk="/dɪsˈkləʊz/" us="/dɪsˈkləʊz/" client:only />
...
<WordRelations
  synonyms={["expose","reveal","impart","publish","divulge","unveil"]}
  antonyms={["withhold"]}
  client:only
/>
