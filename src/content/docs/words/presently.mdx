...
title: Presently
description: >-
  Presently' is an adverb which has two related but somewhat different meanings.
  The traditional meaning is 'soon' or 'in a short time,' suggesting something
  will happen in the near future. A more modern use, especially in American
  English, means 'now' or 'at this time.
sidebar:
  hidden: true
