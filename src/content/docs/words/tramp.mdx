...
title: Tramp
description: >-
  Tramp是一个具有多重含义的英文单词，常用的定义有两个。一是指流浪者，不稳定的生活方式，经常四处流浪。二是当做动词使用，意为'重步行走'，形象地描述步伐重重、艰难地走路。
sidebar:
  hidden: true
...
<Pronunciation word="Tramp" uk="/tɹæmp/" us="/tɹæmp/" client:only />
...
"Tramp"这个词在英美文化中多用于表达差距，流浪的状态，贫困或失去希望的人。在美国，这个词在大萧条时期的 1930 年代被广泛使用，来指那些失去工作、四处流浪的人。
...
<WordRelations
  synonyms={["bum", "hobo", "vagabond", "bushwalk", "hike", "ramble", "trek"]}
  client:only
/>
