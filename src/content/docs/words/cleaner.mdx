...
description: >-
  Cleaner
  是英语中的名词，直译为“清洁工”或“清洁剂”。在不同的上下文中，这个词可能有不同的含义。在描述人的情况下，它通常指的是那些负责打扫、清洁的人。而在描述物品的情况下，它可以指的是用于清洁的产品或设备，比如地毯清洁器。
sidebar:
  hidden: true
...
<Pronunciation word="Cleaner" uk="/ˈkliː.nə/" us="/ˈkliː.nə/" client:only />
