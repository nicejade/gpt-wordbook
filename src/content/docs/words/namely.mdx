---
title: Namely
description: Namely是一个副词，用于特别指出列表中的一项或几项，或者是为了详细说明前面所提到的事情。在中文中，我们可以翻译为“也就是”，“即”，“特指”。
sidebar:
  hidden: true
...
<Pronunciation word="Namely" uk="/ˈneɪmli/" us="/ˈneɪmli/" client:only />
...
"Namely"源自于中世纪英语“nameliche”，在中世纪英语中，它的意思是“尤其是”，“特别是”。在公元 1100 年左右开始被广泛应用。
...
彼得有两个宠物，即一只叫 Max 的狗和一只叫 Lulu 的猫。他对他们的爱是平等的。

<WordRelations
  synonyms={["sc.", "scilicet", "videlicet", "viz."]}
  client:only
/>
