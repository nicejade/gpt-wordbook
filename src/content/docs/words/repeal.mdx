---
title: Repeal
description: Repeal 是一个动词，中文意思是'废除'或者'撤销'，通常用于法律或法规。
sidebar:
  hidden: true
...
<Pronunciation word="Repeal" uk="/ɹəˈpiːl/" us="/ɹəˈpiːl/" client:only />
...
Repeal 来自拉丁语 "re-"表示"反"和"pellere"表示"推"，所以字面上的意思是"推回"，即撤销。
...
"Repeal"一词最早在 14 世纪出现在英语中，最早用于指"撤销法律"。在英美法律中，"Repeal"被广泛应用于政治和法律术语中。

### 单词变形

Repeal 的过去式和过去分词形式为 "repealed"，现在进行式和将来时态形式为"repealing"。
...
<WordRelations
  synonyms={["annul", "cancel", "invalidate", "revoke", "veto"]}
  client:only
/>
