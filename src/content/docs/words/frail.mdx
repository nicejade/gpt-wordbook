---
title: Frail
description: Frail这个词在英文中主要有两种意义：一是表示身体虚弱，健康状况不好；二是指某物或情况脆弱，易于损坏或改变。它通常用来形容人、健康状况、物品或情况。
sidebar:
  hidden: true
...
<Pronunciation word="Frail" uk="/fɹeɪl/" us="/fɹeɪl/" client:only />
...
"Frail"这个单词没有明显的词根。但是与它意义类似的单词还有 fragile，frailty 等。
...
"Frail"这个单词来自中古英语的"frele"，表示易受伤害的或者虚弱的。这个词最早在 14 世纪时使用。
