---
title: "preset"
description: "“Preset”是一个英语单词，它可以作为动词或者名词使用。 当作为动词时，preset的意思是“预先设定或者“预置”，指的是在事情发生之前就设定好，影响其结果。例如，你可以预先设定闹钟在早上7点钟响。 当作为名词使用时，preset的意思是“预设”，指的是预先设定好的参数或值。"
---
...
当作为动词时，"preset"的意思是“预先设定"或者“预置”，指的是在事情发生之前就设定好，影响其结果。例如，你可以预先设定闹钟在早上 7 点钟响。
...
"Preset"这个词在 20 世纪中叶开始流行，随着科技的发展，这个词的使用频率也在逐年增长。因为在很多科技产品和设置中，我们都需要预先设定一些参数。
...
Every morning, Tom's coffee machine automatically starts brewing coffee at 7 a.m., thanks to the preset program. (每天早晨，由于预设程序的存在，汤姆的咖啡机都会在早上 7 点钟自动开始冲泡咖啡。)
