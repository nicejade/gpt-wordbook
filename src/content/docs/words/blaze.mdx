...
title: Blaze
description: >-
  Blaze 并非一个常见的日常单词，它的意思多种多样。作为动词，'blaze' 的两个最常见的含义是 '燃烧' 或 '大显光彩，飞速发展'；作为名词，指的是
  '大火'，也有 '明亮的光' 的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Blaze" uk="/bleɪz/" us="/bleɪz/" client:only />
...
单词 "Blaze" 的使用已经可以追溯到 14 世纪，最初的含义是“燃烧得明亮”。由于其形象生动的描述刚刚燃起的火焰的场景，因此在文学作品中经常受到喜爱，尤其是诗歌。
