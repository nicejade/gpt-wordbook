---
title: Dilute
description: Dilute 是一个动词，意为'将（液体）稀释'或'减弱（质量，纯度，力度等）'。当它被用作一个形容词时，就意味着'被稀释的'或'减弱的'。
sidebar:
  hidden: true
...
<Pronunciation word="Dilute" uk="/daɪˈljuːt/" us="/daɪˈljuːt/" client:only />
...
<WordRelations antonyms={["condense"]} client:only />
