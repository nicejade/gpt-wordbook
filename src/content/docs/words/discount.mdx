...
description: >-
  Discount
  是一个英语单词，通常作为动词和名词使用。作为动词时，它有两种主要的含义。一是指在原价基础上减去一定的金额，也就是我们常说的'打折'。二是指对某事或某人轻视或忽视，就像我们说的'不把......放在眼里'。作为名词时，它指的是减价，或者是打折的金额。
sidebar:
  hidden: true
...
<Pronunciation word="Discount" uk="/dɪsˈkaʊnt/" us="/dɪsˈkaʊnt/" client:only />

### 列举例句

1.  "The store offers a 10% discount to all new customers." （这家店对所有新客户提供 10%的折扣。）
