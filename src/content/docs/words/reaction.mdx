---
title: Reaction
description: Reaction 是一个名词，主要解释为“反应、反馈”，它可以指人对某个情况或事件的感情和行动的反应，也可以指物质之间的化学反应。
sidebar:
  hidden: true
...
<Pronunciation word="Reaction" uk="/ɹiˈækʃən/" us="/ɹiˈækʃən/" client:only />
...
"Reaction" 这个词源自于 14 世纪的中法语，原意为“回归、收回”，后来发展出“反对、反抗”的意思。在 17 世纪，这个词开始用于描述化学反应。
...
<WordRelations synonyms={["reax", "rxn"]} client:only />
