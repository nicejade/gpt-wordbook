---
title: Rope
description: Rope 是一个名词，意为“绳子”，用于提起、拴起、捆绑等。也可转变为动词，例如 'rope in'表示“拉入”，'rope off' 表示'隔离。
sidebar:
  hidden: true
...
<Pronunciation word="Rope" uk="/ɹəʊp/" us="/ɹoʊp/" client:only />
...
<WordRelations
  synonyms={["cord","line","twine","lasso","bind","secure","tie"]}
  client:only
/>
