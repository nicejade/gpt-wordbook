---
title: Dairy
description: Dairy 是一个名词，通常指的是乳制品，如牛奶、奶酪、黄油等。它也可以指的是生产乳制品的场所，比如乳品店或乳制品工厂。
sidebar:
  hidden: true
...
<Pronunciation word="Dairy" uk="/ˈdɛəɹi/" us="/ˈdɛəɹi/" client:only />
...
Dairy 的词根来自于英语单词“dey”，早在 14 世纪就用来指代一个管理乳制品生产的女人。

### 词缀分析

Dairy 没有明显的词缀，但其在中世纪英语中的形式 "dayerye" 显示出 "-ery" 这一构词成分，这种后缀常在名词后边，指代地点或行为。
...
<WordRelations synonyms={["milkery", "milkhouse"]} client:only />
