...
description: >-
  Shadowy
  这个单词可以形容一种神秘、暧昧或不明朗的气氛或情境，也可以用于指代一个隐蔽或陌生的人或地点。百度翻译也将其定义为“有阴影的，阴暗的，模糊的，朦胧的”。
sidebar:
  hidden: true
...
<Pronunciation word="Shadowy" uk="/ˈʃæd.əʊ.i/" us="/ˈʃæd.oʊ.i/" client:only />
...
使用前缀 shadow- 的其他单词有：shadowed, shadowing, shadows 等。

### 文化背景

Shadowy 这个单词在 17 世纪晚期开始有“模糊”或“神秘”的意思，在这之前，它更多的是被用来指“阴影”。
