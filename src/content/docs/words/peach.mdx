---
title: Peach
description: peach作为名词时，意思是桃子，一种软皮、味甜的水果。作为形容词时，'peach'可以用来描述桃色的，或者如桃花般美丽的。
sidebar:
  hidden: true
...
<Pronunciation word="Peach" uk="/piːt͡ʃ/" us="/piːt͡ʃ/" client:only />
...
- a peach of a **\_** is used to describe something as being the best or exceptional (一颗**\_**的桃子，用来形容某物是最好的或杰出的)
