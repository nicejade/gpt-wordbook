---
title: Purity
description: 英语单词 'purity' 的意思是纯洁，纯净，无污染。这个词经常用来形容物质、情感、道德等无杂质，无污染的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Purity" uk="/ˈpjɔːɹɪti/" us="/ˈpjɔːɹɪti/" client:only />
...
<WordRelations antonyms={["impurity"]} client:only />
