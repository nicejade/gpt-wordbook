---
title: Irrespective
description: Irrespective 是一个副词，表示 "不顾，不管，无关"。它常用来表达某事物的进行或存在是不考虑其他因素或情况的。
sidebar:
  hidden: true
...
词根 "respect" 衍生出的其他单词有：respectful, disrespect, respective 等。
...
Irrespective 是由拉丁词根 respicere(留心，考虑)经过演变后得到的。首次出现在 16 世纪，杰弗里·查塞尔(Jeffrey Chaucer) 首次使用了这个词。

### 单词变形

Irrespective 是一个副词，没有其他变形。

### 记忆辅助

可以这样记忆此词：前缀“ir-”表示否定，词根“respect”代表尊重或考虑，后缀“-ive”将其变为形容词。所以，irrespective 的意思就是不考虑或不尊重的，与这个词的实际含义一致。
