---
title: Accustomed
description: 它的基本含义是"习惯的、熟悉的"。当一个人自然而然地做某件事，或者习惯了某种状态，我们就可以说他已经"accustomed"于它。
sidebar:
  hidden: true
...
Accustomed 来自于拉丁词根"custom"，意为"习惯"。它是"accustomed"的词根。

### 词缀分析

Accustomed 有一个前缀"ac-"（表示 “向，到，加强”） 和后缀“-ed”（用于形成过去分词或形容词）。
