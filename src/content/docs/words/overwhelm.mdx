---
title: Overwhelm
description: Overwhelm 是一个动词，意思是覆盖，淹没，也可以指，情绪激动到难以控制自己，或者感觉任务和问题控制不住。
sidebar:
  hidden: true
...
<Pronunciation word="Overwhelm" uk="/ˌovɚˈʍɛlm/" us="/ˌovɚˈʍɛlm/" client:only />
...
该词出现于 14 世纪，最早用于描写物质的覆盖或淹没。现在主要用来指控制或征服某人，或使其无法处理事物。
...
<WordRelations synonyms={["swamp"]} antonyms={["underwhelm"]} client:only />
