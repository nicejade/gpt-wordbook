---
title: Ouch
description: Ouch 是一种口语化的感叹词，常在英语中表示疼痛，不舒服或受伤的时候使用。
sidebar:
  hidden: true
...
<Pronunciation word="Ouch" uk="/ˈaʊtʃ/" us="/ˈaʊtʃ/" client:only />
...
<WordRelations synonyms={["ow", "owie", "youch", "yow", "yowch"]} client:only />
