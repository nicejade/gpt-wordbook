---
title: Attach
description: Attach 是一个动词，中文翻译为'附加'、'连接'或'附着'。它的常见用法有，将两个物体固定在一起，或把文件添加到电子邮件中。
sidebar:
  hidden: true
...
<Pronunciation word="Attach" uk="/əˈtætʃ/" us="/əˈtætʃ/" client:only />
...
"Attach" 这个单词最早出现在 14 世纪，源自法语 "atachier"，意为"连接"或"装配"。进入英语后，这个词逐渐丰富了其使用的场景。
...
<WordRelations
  synonyms={["annex","connect","unite","cling","stick"]}
