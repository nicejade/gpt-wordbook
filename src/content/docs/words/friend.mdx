---
title: Friend
description: Friend 是一个名词，表示'朋友'，指的是有密切关系的人，经常交往并具有共同利益或活动的人。
sidebar:
  hidden: true
...
<Pronunciation word="Friend" uk="/fɹɛnd/" us="/fɹɛnd/" client:only />
...
<WordRelations
  synonyms={["buddy","mate","pal","admirer","booster","champion","protagonist","supporter","ally","acquaintance","contact"]}
