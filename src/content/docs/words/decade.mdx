---
title: Decade
description: Decade 是一个英语单词，主要指的是十年的时间。
sidebar:
  hidden: true
...
<Pronunciation word="Decade" uk="/dəˈkeɪd/" us="/dəˈkeɪd/" client:only />
...
"Decade" 已被使用数百年，最初源自拉丁语的 "decas"，表示一组十个。在英语中，它常用于形容十年的时间段，也被广泛用于形容特定年代的文化与历史特点，如 "the 80s decade" (80 年代)。
