---
title: "programming"
description: "Programming 是一种设计和构建可执行计算机软件的过程，也可用于描述创建电视或广播的节目表。可以用来指程序设计、规划、策划等概念。"
---
...
(杰克，一名高中生，决定学习计算机编程。他花了无数个夜晚掌握 Python， 在其中一个晚上，他创建了一个小程序来规划他的学习时间表。多亏了编程，他的生活现在变得更加有条理。)
