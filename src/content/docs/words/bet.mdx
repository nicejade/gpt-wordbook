...
title: Bet
description: >-
  bet 作为动词时的意思是“打赌，赌注”，表达一种对于某种结果或可能性的信念及期望。如“I bet you can't finish the task
  within one day.”（我敢打赌你不能在一天内完成任务。）。'bet'也可以作为名词使用，意思是“赌注”，如'The bet is
  off'（这个赌注取消了）。
sidebar:
  hidden: true
...
<Pronunciation word="Bet" uk="/ˈbɛt/" us="/ˈbɛt/" client:only />
...
"Bet" 最早出现在 16 世纪，来源于俚语，一开始是用作“确信”，后来发展成为现在的意思，包含对结果的期望和猜测。
