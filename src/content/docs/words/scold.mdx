...
title: Scold
description: >-
  - 'Scold' 是一个动词，主要意思是斥责，训斥，批评，通常是因为某人做了什么不对或犯了错误。比如，一个孩子如果没有完成家庭作业，父母会 'scold'
  他。
sidebar:
  hidden: true
...
<Pronunciation word="Scold" uk="/skəʊld/" us="/skoʊld/" client:only />
...
- “Scold" 的使用可以追溯到 14 世纪中叶的英格兰，当时它是用来指责或口头攻击他人的。它的使用在社会和家庭场合都很常见。
