---
title: Probability
description: Probability 是一个英语名词，意思是“概率”。它代表了某一事件在所有可能事件中发生的可能性。
sidebar:
  hidden: true
...
"Probability"这个词在 16 世纪末进入英语中，最初主要用于法律语境中，用来描述证据的说服力。18 世纪中期，随着概率论的发展，这个词义扩展到了数学和科学领域。
...
（冰淇淋摊贩计算了在寒冷的天气里卖出 100 个冰淇淋的概率，概率非常低。）
