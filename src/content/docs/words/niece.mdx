---
title: Niece
description: Niece 是一个英文名词，指的是你的兄弟姐妹的女儿。它的男性对应词是 'nephew'，指的是你的兄弟姐妹的儿子。
sidebar:
  hidden: true
...
<Pronunciation word="Niece" uk="/niːs/" us="/nis/" client:only />
...
"Niece"一词在 14 世纪从法语借用到英语中，原意为侄女或外甥女。
...
<WordRelations antonyms={["aunt", "uncle", "nephew"]} client:only />
