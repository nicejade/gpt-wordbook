---
title: Zebra
description: Zebra 是英语中的一个名词，表示一种生活在非洲的野生哺乳动物，为马科动物，以其身上的黑白条纹著称。中文对应的词义为 '斑马'。
sidebar:
  hidden: true
...
<Pronunciation word="Zebra" uk="/ˈziːbɹə/" us="/ˈziːbɹə/" client:only />
...
<WordRelations synonyms={["fascinoma"]} client:only />
