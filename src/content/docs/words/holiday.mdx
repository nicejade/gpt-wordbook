...
title: Holiday
description: >-
  Holiday 是一个英文常用词，用来表示休假或公众假期。例如，学校的暑假期间，人们可以说'school
  holiday'；如果是法定的公共假日，如圣诞节，人们会说 'public holiday'。
sidebar:
  hidden: true
...
<Pronunciation word="Holiday" uk="/ˈhɒlɪdeɪ/" us="/ˈhɑləˌdeɪ/" client:only />
...
Holiday 的词根来自两个古英语单词 "hālig"（sacred，神圣的）和 "dæg"（day，日子），表示神圣的日子。
...
Holiday 在早期的使用中指的是宗教节日，或者由教会规定的休息日。而现在，Holiday 的意义已经扩展到了任何公众假期或者私人休假。

### 单词变形

没有特别的变形，Holiday 的复数形式是 holidays。
...
<WordRelations synonyms={["lacuna", "leave", "vacation"]} client:only />
