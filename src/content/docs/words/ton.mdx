...
title: Ton
description: >-
  Ton 是一个量度单位，主要用分为两个部分来理解： 1. 在英国英语中的含义是"gross ton", 即重量为 2240 磅(lbs)，相当于
  1016.04691 公斤(kg)。 2. 在美国英语中的含义是"net ton", 即重量为 2000 磅(lbs)，相当于 907.18474
  公斤(kg)。 此外，Ton 还有其他的含义，例如，“a ton of”是一个非正式的比喻表达，表示"大量的"或"很多"。
sidebar:
  hidden: true
