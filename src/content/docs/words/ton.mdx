...
title: ton
description: >-
  Ton 是一个量度单位，主要用分为两个部分来理解： 1. 在英国英语中的含义是gross ton,
  即重量为2240磅(lbs)，相当于1016.04691公斤(kg)。 2. 在美国英语中的含义是net ton,
  即重量为2000磅(lbs)，相当于907.18474公斤(kg)。 此外，Ton还有其他的含义，例如，“a ton
  of”是一个非正式的比喻表达，表示大量的或很多。
sidebar:
  hidden: true
