---
title: Telephone
description: '- ''Telephone'' 是名词，主要指的是电话，也可以作为动词使用，表示打电话。'
sidebar:
  hidden: true
...
<Pronunciation word="Telephone" uk="/ˈtɛləfəʊn/" us="/ˈtɛləfoʊn/" client:only />
...
- "Telephone" 是由亚历山大·贝尔于 1876 年发明的，是一种通过电线或无线电波发送和接收声音的装置。
...
<WordRelations
  synonyms={["Ameche","blower","farspeaker","horn","phone","call","ring"]}
  client:only
/>
