...
title: Spark
description: >-
  Spark在英语中有两个主要含义，一个是名词，另一个是动词。作为名词，它通常指的是由火生成的一点点光亮的点， metaphorically,
  它也可以指源起，启发或灵感的来源。作为动词，它意味着发出火花或启动。
sidebar:
  hidden: true
...
<Pronunciation word="Spark" uk="/spɑːk/" us="/spɑɹk/" client:only />
...
<WordRelations
  synonyms={["beginning","germ","glimmer"]}
  client:only
/>
