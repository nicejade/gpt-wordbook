---
title: Exclamation
description: Exclamation 是一种强烈的表达方式，通常表示惊奇、欣喜、愤怒等情感。它还可以指代那些用于表达上述情绪的词，比如'哇'、'呀'等。
sidebar:
  hidden: true
...
<Pronunciation word="Exclamation" uk="/ˌɛkskləˈmeɪʃ(ə)n/" us="/ˌɛkskləˈmeɪʃ(ə)n/" client:only />
