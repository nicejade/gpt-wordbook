---
title: Support
description: Support 是一个非常常见的英语单词。根据具体的上下文环境，它有多种含义。主要的含义有：
sidebar:
  hidden: true
...
<Pronunciation word="Support" uk="/səˈpɔːt/" us="/səˈpɔɹt/" client:only />
...
"Support"这个单词在 13 世纪中叶首次出现在英文中，来源于法语的“suporter”，意为“支持，帮助”。“suporter”来自拉丁语的“supportare”，含义和法语一样，都是“支持，帮助”。
...
<WordRelations
  synonyms={["stut", "underprop", "uphold"]}
  antonyms={["kernel", "oppose"]}
  client:only
/>
