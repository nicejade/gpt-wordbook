---
title: Bronze
description: "- 'Bronze' 是一个名词，意思是“青铜”，也可以用作形容词表达颜色，即“青铜色”。"
sidebar:
  hidden: true
...
<Pronunciation word="Bronze" uk="/bɹɒnz/" us="/bɹɑnz/" client:only />
...
- "Bronze"这个词源于 18 世纪法语的 "brunese"。在英语中,"bronze" 一词最初只用来描述一种很有特色的青铜合金。后来，它又被用来指代一种特殊的颜色——青铜色。
...
<WordRelations synonyms={["bronzen"]} client:only />
