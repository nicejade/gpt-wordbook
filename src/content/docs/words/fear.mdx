---
title: Fear
description: Fear是英语中的一个动词和名词，表示害怕、担忧、恐惧的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Fear" uk="/fɪə/" us="/fɪəɹ/" client:only />
...
Fear 在英语中没有一个明确的词根，但是在古英语中，它源于词根 _fær_ ，表示“危险，恶事”，这个词根在很多古代日尔曼语言中都有类似的含义。

### 词缀分析

Fear 本身就是一个单词的基本形式，它不包含特定的词缀。
...
<WordRelations
  synonyms={["dread","afraid","frightened","scared"]}
  antonyms={[]}
  client:only
/>
