...
description: >-
  Cruise
  是一个英文单词，主要有两个含义。它既可以作为动词，表示“航行”或“驾驶”，如在空中、海上或路上平稳的移动。此外，它也经常用作名词，表示“邮轮旅行”。
sidebar:
  hidden: true
...
<Pronunciation word="Cruise" uk="/kɹuːz/" us="/kɹuːz/" client:only />

### 列举例句

1.  I plan to cruise the Mediterranean this summer. (我计划今年夏天在地中海上游览。)
2.  The car can cruise at 80 miles an hour. (这辆车可以以每小时 80 英里的速度巡航。)
