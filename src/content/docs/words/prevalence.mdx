---
title: Prevalence
description: Prevalence 是一個英文单词，我们在中文中通常将其翻译为“普遍”，“流行”。它指的是某种行为或现象在特定区域或人群中的普遍存在或普遍发生。
sidebar:
  hidden: true
...
Prevalence 的词根来自于 Latin "prevaleo"，含有“强的”、“有影响力的”的意思，而-en 和-ance 是标准的后缀，合起来民 “强有力的存在”。
...
Prevalence 作为一个词在 17 世纪开始使用，主要用于描述疾病或其他不良现象的广泛存在或频繁发生。
