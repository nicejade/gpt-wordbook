---
title: Plug
description: Plug 可用作名词和动词。作为名词，它最常用的含义是“插头”或者“塞子”；作为动词，它表示“把...塞住”。也常用于俚语，表示推广，宣传。
sidebar:
  hidden: true
...
<Pronunciation word="Plug" uk="/plʌɡ/" us="/plʌɡ/" client:only />
...
"Plug" 这个词最初的含义是“塞子”，在 19 世纪初，随着电力的广泛使用，它也开始用来指代电源插头。到了 20 世纪，由于广告媒体的发展，"plug" 也开始用作动词，表示宣传，推广。
...
"Plug" 与 "pug" 发音类似，可以通过"pug 狗爱玩塞子(plug)"的故事来记忆。
...
<WordRelations
  synonyms={["bum","dobbin","hack","jade","nag","bung","dowel","stopper","stopple","drill","pound","pop","ventilate"]}
  client:only
/>
