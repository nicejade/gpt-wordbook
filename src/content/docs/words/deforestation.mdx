---
title: Deforestation
description: Deforestation 是一个名词，用来描述大规模砍伐森林或者其他的树木的过程。这个词语通常用来讨论环保问题。
sidebar:
  hidden: true
...
"Deforestation" 这个词在 19 世纪后期开始被广泛使用，体现了由于工业化和城市化进程，人类对自然资源的大量消耗，造成的破坏性后果。
...
<WordRelations antonyms={["afforestation", "reforestation"]} client:only />
