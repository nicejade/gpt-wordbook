...
title: Miniskirt
description: >-
  Miniskirt是一个由'mini'和'skirt'两个词组成的复合词，用以指代一种特殊的裙子款式。'mini'是'minimum'的缩写，意为“最小的”，而'skirt'指的就是裙子。所以，'miniskirt'通常意味着一种长度特别短的裙子。
sidebar:
  hidden: true
...
2.  Miniskirt was a fashion statement in the 1960s.（在 1960 年代，超短裙是一种时尚声明。）
...
"Miniskirt"这个词在 1960 年代开始流行，当时由时尚设计师玛丽·夸恩特设计出这种短裙，立即引发了一场全球性的时尚革命。在英美文化中，尤其是在青年文化中，超短裙通常被视为一种展示个性和怀旧的方式。
