---
title: Infer
description: "- 'Infer' 是一个动词，主要意思是“推断，推理，得出结论”。它通常用来在已知的信息或证据基础上推测或做出推断。"
sidebar:
  hidden: true
...
<Pronunciation word="Infer" uk="/ɪnˈfɜː/" us="/ɪnˈfɝ/" client:only />
...
- "Infer" 首次出现在英语中是在 16 世纪，最初的意思是“引导，引领”。在 17 世纪，它开始被用来表示“推断，推理”。
...
<WordRelations
  synonyms={["assume","conclude","construe","deduce"]}
  client:only
/>
