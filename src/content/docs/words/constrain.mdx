---
title: Constrain
description: Constrain 是一个动词，其基本意思是'强迫，迫使'或'限制，束缚'。这个词，通常用在角色或事物受到一种强制性的限制或控制的情况中。
sidebar:
  hidden: true
...
"Constrain"首次出现在 14 世纪的英语中，源于拉丁语的 "constringere"。“Constrain”在历史文化中经常用于描述权威对人民、自然如何强制执行规则或法规。
