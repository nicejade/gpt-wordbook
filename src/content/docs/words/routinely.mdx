---
title: Routinely
description: Routinely是一个副词，意为“通常地，习惯性地”，用来描述一个经常发生、或按常规进行的动作。
sidebar:
  hidden: true
...
Routine 在 19 世纪从法语借用到英语，最初是在戏剧和歌舞中使用，表示一种例行公事的演出。后来，其意义扩展为任何形式的例行公事或常规。
...
<WordRelations
  synonyms={["customarily", "ordinarily", "routinely"]}
  client:only
/>
