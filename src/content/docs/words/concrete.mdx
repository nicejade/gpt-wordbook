...
description: >-
  Concrete
  是一个形容词和名词。作为形容词时，其意思是“具体的”，指的是实实在在的、有形的事物，对应的中文翻译是“具体的”。作为名词时，它表示“混凝土”，这是一种建筑材料。
sidebar:
  hidden: true
...
<Pronunciation word="Concrete" uk="/kɵnˈkɹiːt/" us="/ˈkɑnkɹiːt/" client:only />
...
该单词是从拉丁文的"concretus"过来的，从 15 世纪开始使用。在拉丁语中，"con-"表示一起，还有个部分最初是"cre-"表示生长。这是因为在古罗马，他们发现将水泥、沙子和石子混合可以制得一种坚固的建筑材料，就像石头生长在一起一样。
...
<WordRelations
  synonyms={["tangible"]}
  antonyms={["abstract", "intangible", "discrete"]}
  client:only
/>
