---
title: Reserve
description: Reserve是一个角色骑马单词，可以作为名词和动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Reserve" uk="/ɹɪˈzɜːv/" us="/ɹɪˈzɝv/" client:only />
...
<WordRelations
  synonyms={["TA","TAVR","reservists","terriers","territorials","reticence","taciturnity","substitute","res","reservation","rez"]}
  client:only
/>
