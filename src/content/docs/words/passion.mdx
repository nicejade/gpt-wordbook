---
title: Passion
description: Passion是一个名词，它指的是强烈的感情、强烈的欲望或者强烈的爱好。这个词可能用来形容对一个活动、概念、追求或某人的深深喜欢或热爱。
sidebar:
  hidden: true
...
<Pronunciation word="Passion" uk="[ˈpʰæʃən]" us="[ˈpʰæʃən]" client:only />
...
<WordRelations synonyms={["ardor", "zeal"]} antonyms={["action"]} client:only />
