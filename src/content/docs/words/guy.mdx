...
title: Guy
description: >-
  - 'Guy' 是一个英语单词，通常用来指代一个男人或男孩，它主要是美国俚语，在英国则有时指特定的男人。例如，'He's a nice
  guy'（他是个好人）。
sidebar:
  hidden: true
...
<Pronunciation word="Guy" uk="/ɡaɪ/" us="/ɡaɪ/" client:only />
...
<WordRelations
  synonyms={["bloke","brother","chap","fellow","geezer","dude","fella","homey"]}
  antonyms={["bird","broad","chick","girl","woman"]}
  client:only
/>
