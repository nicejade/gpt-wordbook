...
title: Hill
description: >-
  Hill是一个名词，指的是自然环境中的一种地形特征，比较的小的地面升高，通常低于山。 如果 Hill 是姓氏，如：Hillary Hill, Hill
  在此情况下就属于人名的部分。
sidebar:
  hidden: true
...
"Hill"是一个名词，指的是自然环境中的一种地形特征，比较的小的地面升高，通常低于山。 如果 Hill 是姓氏，如：Hillary Hill, Hill 在此情况下就属于人名的部分。

<Pronunciation word="Hill" uk="/hɪl/" us="/hɪl/" client:only />
