...
description: >-
  Suffering
  是一个英语名词，意思是“痛苦，苦痛”，既可以指身体上的痛苦，也可以指精神上的痛苦。但是，这个词的使用是广泛的，而且可以用在很多不同的语境中。
sidebar:
  hidden: true
...
<Pronunciation word="Suffering" uk="/ˈsʌfəɹɪŋ/" us="/ˈsʌfəɹɪŋ/" client:only />
...
"Suffering" 的词根是"-fer-",这具有"带，带来"的意思，来自拉丁语的"ferre"。在"suffering"中,"fer"变为了双写的"ff"。衍生词有 refer(提及), confer(商量, 协商)等。
...
<WordRelations
  synonyms={["permit","deteriorate","worsen","bear","agonize","anguish","in","pain"]}
  client:only
/>
