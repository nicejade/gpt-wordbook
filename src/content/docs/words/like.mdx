...
description: >-
  ...
  1）当"like"作为动词使用时，它的意思是"喜欢"。 例如："I like apples."（我喜欢苹果。）
  2）当"like"作为形容词使用时，它的意思是"相似的"。 例如："He is like his father."（他像他的父亲。）
  3）当"like"作为介词使用时，也是表示"像…一样"。 例如："She runs like a gazelle."（她跑起来像羚羊一样。）
  4）当"like"作为连词对象的时候，它的意思是"好像，仿佛"。 例如："It looks like it's going to
  rain."（看起来像是要下雨了。）
sidebar:
  hidden: true
