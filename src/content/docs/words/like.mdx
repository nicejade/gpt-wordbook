---
title: Like
description: Like 是个非常常用的英语单词，它可以作为动词，形容词，介词，甚至连词使用，含义也相应有所不同。
sidebar:
  hidden: true
...
<Pronunciation word="Like" uk="/laɪk/" us="/laɪk/" client:only />
...
<WordRelations
  synonyms={["favorite", "preference", "enjoy", "fancy", "love"]}
  antonyms={["dislike", "hate", "mislike", "unlike"]}
  client:only
/>
