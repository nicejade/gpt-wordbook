---
title: Experiment
description: '"Experiment"是一个名词，主要意思是“实验”。它指的是为了验证、发现或说明某种科学理论或事实而进行的一系列动作或操作。'
sidebar:
  hidden: true
...
单词"experiment"在 16 世纪的时候进入了英语，一开始被使用为找出事情的真实情况。 古希腊和罗马的日常生活和科学探索都有着实验的元素，所以这个单词深受重视。

### 单词变形

- 名词: Experiment (实验)
- 动词: Experiment (进行实验)，其过去式和过去分词形式均为 Experimented (进行过实验)，现在分词形式为 Experimenting (正在进行实验)；
