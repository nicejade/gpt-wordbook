...
title: Accumulate
description: >-
  Accumulate 这个英文单词来自于拉丁语 'accumulare'，来源于 'ad-' (到) 与
  'cumulus'（堆），意为“增加”，“累积”，通常用于描述物质或抽象事物，如知识、货品、资金等不断增长或积累的过程。
sidebar:
  hidden: true
...
"Accumulate" 来自拉丁语 "accumulare"，在 16 世纪开始在英语中使用，主要表示抽象或实际的积累和增长。
...
<WordRelations
  synonyms={["aggregate","collect","gather","heap","hoard","store"]}
  client:only
/>
