---
title: Intensive
description: Intensive 是一个英文形容词，主要用来形容一些程度很高的、集中的事物或行为。常用作 '集中的'、'密集的'、或'强烈的'。
sidebar:
  hidden: true
...
<Pronunciation word="Intensive" uk="/ɪnˈtɛnsɪv/" us="/ɪnˈtɛnsɪv/" client:only />
...
"Intensive"这个词在英语中大约出现在 14 世纪，最初用于描述农业或农耕，意思是 "激增" 或 "大量的"。该词后来的发展引申出了 "集中的" 或 "强烈的" 的意思。
