---
title: Bat
description: Bat在英语中主要有两个含义。一是指棒球用的棒，或者是任何形式的敲击用的平板；二是指一种哺乳动物，我们通常称之为“蝙蝠”。
sidebar:
  hidden: true
...
<Pronunciation word="Bat" uk="/bæt/" us="/bæt/" client:only />
...
"Bat"作为“球棒”的用法可以追溯到 17 世纪，主要源于棒球运动发源地——美国。"Bat"作为“蝙蝠”的含义则在英格兰流行，这个词在那里被用来称呼这种夜行性的飞行哺乳动物。
...
<WordRelations
  synonyms={["chiropter","chiropteran","flindermouse","flittermouse","fluttermouse","rearmouse","reremouse"]}
  client:only
/>
