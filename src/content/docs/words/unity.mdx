---
title: Unity
description: "Unity这个词的基本含义是'团结'或'一致', 可以用来描述一组人共同按照一种信念、意图或目标行动。"
sidebar:
  hidden: true
...
<Pronunciation word="Unity" uk="/ˈjuːnɪtɪ/" us="/ˈjunɪti/" client:only />
...
<WordRelations
  antonyms={["multiplicity","plurality"]}
  client:only
/>
