---
title: Customary
description: Customary 是一个形容词，它的基本含义是'习惯的'或'规定的'，是描述某事、某活动或某种行为符合某个团体或者文化的长期习惯或者规定。
sidebar:
  hidden: true
...
Tom 为了工作移民到了另一个国家。对他来说，那里的一切都是崭新和陌生的。然而，他很快发现，遵循当地人的习惯性行为，让他感到自己成为了社区的一部分。

<WordRelations synonyms={["conventional", "habitual", "wont"]} client:only />
