---
title: Besides
description: Besides是一个英语副词，用来表示“除了……还有；除此之外”。以下是一些相关的解释：
sidebar:
  hidden: true
...
<Pronunciation word="Besides" uk="/biˈsaɪdz/" us="/biˈsaɪdz/" client:only />
...
<WordRelations synonyms={["beyond", "barring", "besides"]} client:only />
