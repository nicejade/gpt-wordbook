...
title: Besides
description: >-
  "Besides"是一个英语副词，用来表示“除了……还有；除此之外”。以下是一些相关的解释： 1. 额外的或更多的；例如："What do you like
  to do besides soccer?"（除了足球你还喜欢做什么？） 2. 其他的或另外的；例如："Who else will be there
  besides you?"（除你之外，还有谁会在那里？）
sidebar:
  hidden: true
