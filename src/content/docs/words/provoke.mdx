...
title: Provoke
description: >-
  Provoke 这个单词源于拉丁语，它的意思是勾起，激发或者引发一种反应或情绪。比如我们说：'His comment provoked an
  argument.' 他的评论引发了一场争论。
sidebar:
  hidden: true
...
<Pronunciation word="Provoke" uk="/pɹəˈvəʊk/" us="/pɹəˈvoʊk/" client:only />
...
<WordRelations
  synonyms={["discompose","engender","evoke","grill","incite","induce","inflame","instigate","invoke","rouse"]}
  client:only
/>
