---
title: Young
description: Young 是一个形容词，表示“年轻的”。这可以指年龄小的，年数低的或者对于某个时期，某个物种或种群而言早期的。
sidebar:
  hidden: true
...
<Pronunciation word="Young" uk="/jʌŋ/" us="/jʌŋ/" client:only />
...
"Young"源自古英语的"geong"，这个词在公元 700 年前就开始使用。在欧美文化中，"young"可以被用如"young and bright"来表示充满活力和活跃。
...
在一个阳光明媚的早晨，一个年轻的男子站在山顶上，大喊"我是 the young and the fearless!" (一个明媚的早晨，一个年轻的男子站在山顶上，大喊"我是年轻而无畏的！")

<WordRelations
  synonyms={["junior","youthful","juvenile","immature","underdeveloped","undeveloped"]}
  antonyms={["aged","elderly","old","senior","youthless","mature","experienced","veteran"]}
  client:only
/>
