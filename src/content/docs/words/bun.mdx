---
title: Bun
description: 「Bun」是一个英语单词，主要有两种常见的含义。一种是指面包，特指那种小型、圆形的软面包或者甜点。另一种是指发型，在头部后面扎成的紧凑型圆形发髻。
sidebar:
  hidden: true
...
<Pronunciation word="Bun" uk="/bʌn/" us="/bʌn/" client:only />
...
“Bun”一词在英语中自 14 世纪就有记录，原意指做成某种形状（特别是圆形）的面包或饼干。而它作为发型名词的用途，开始广泛流行是在 20 世纪。
...
<WordRelations synonyms={["cake"]} client:only />
