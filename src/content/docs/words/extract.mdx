...
title: Extract
description: >-
  Extract 是一个多义词，通常可作为名词和动词。作为动词，它的意思是“提取”或“精炼”， 比如从某物中取出或获取有用的元素。作为名词，'Extract'
  可以指一种被从特定来源提取出的物质。
sidebar:
  hidden: true
...
'Extract' 最早起源于 15 世纪，是来自拉丁语的词。这个词在许多领域都有应用，如科学，烹饪，以及药物制造等。
...
<WordRelations synonyms={["extraction", "origin", "outdraw"]} client:only />
