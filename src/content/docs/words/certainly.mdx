---
title: Certainly
description: Certainly是一个副词，含义是“当然'，'无疑'，强调某件事的确定性或肯定性。
sidebar:
  hidden: true
...
<Pronunciation word="Certainly" uk="/ˈsɜːtn̩li/" us="/ˈsɝʔn̩li/" client:only />
...
<WordRelations
  synonyms={["absolutely","indubitably","undoubtedly","wis","definitely","doubtlessly","indeed","indisputably","really"]}
  client:only
/>
