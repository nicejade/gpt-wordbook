---
title: Stroll
description: Stroll 是一个英语动词，表示“闲逛，散步”，通常用来表达一个慵懒而无特定目的的行走状态。
sidebar:
  hidden: true
...
<Pronunciation word="Stroll" uk="/stɹəʊl/" us="/stɹoʊl/" client:only />
...
<WordRelations
  synonyms={["ramble", "range", "roam", "rove", "stray"]}
  client:only
/>
