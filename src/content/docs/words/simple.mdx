---
title: Simple
description: Simple这个单词在英语中备受欢迎，主要意思是“简单的”，“容易理解或做的”。可以用来形容事物、概念、规则等不复杂、易于理解或执行的特性。
sidebar:
  hidden: true
...
<Pronunciation word="Simple" uk="/ˈsɪmpəl/" us="/ˈsɪmpəl/" client:only />
...
<WordRelations
  synonyms={["onefold", "plain"]}
  antonyms={["complex", "complicated", "compound", "subtle", "gentle"]}
  client:only
/>
