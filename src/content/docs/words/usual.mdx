...
title: Usual
description: >-
  Usual是一个形容词，意思是“通常的，平常的”，它用来描述平时会发生、看到、或者期望会发生的事情。例如：“That's the usual state
  of affairs.”（那是常态。）
sidebar:
  hidden: true
...
<Pronunciation word="Usual" uk="/ˈjuːʒʊəl/" us="/ˈjuːʒʊəl/" client:only />
...
"Usual"来源于拉丁词 roots "Usus"，意思是“被使用的”，其他有相同词根的单词有"use"（使用），“usable”（可用的）等。
