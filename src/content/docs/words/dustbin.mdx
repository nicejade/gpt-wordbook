...
title: Dustbin
description: >-
  Dustbin 是英式英语中的一个名词，主要是指存放垃圾的容器，通常情况下放置在室外或者公共场所。在美式英语中，这个词常常被表达为 'Trash can'
  或者 'Garbage can'。
sidebar:
  hidden: true
...
"Dustbin"是一种主要在英国使用的词汇，美国人更常用"Trash can"。在 19 世纪的城市化过程中，municipal governments 开始下达法令，家庭和商业需要有一个专门的地方放垃圾，于是"dustbin"应运而生。
...
<WordRelations synonyms={["ashcan", "dumpster", "wastebin"]} client:only />
