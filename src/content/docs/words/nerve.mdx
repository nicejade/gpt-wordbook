...
title: Nerve
description: >-
  Nerve 是一个很常见的词，它的意思主要是指'神经'。在医学和生物学中，这词用来描述在身体内传输信息的组织。此外，'nerve'
  也可以用作比喻，表示'勇气'或'胆量'。
sidebar:
  hidden: true
...
<Pronunciation word="Nerve" uk="/nɛɾv/" us="/nɜɪv/" client:only />
...
<WordRelations synonyms={["balls", "brashness", "brazenness"]} client:only />
