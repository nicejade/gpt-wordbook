...
title: Foggy
description: >-
  Foggy是形容词，它来自常见名词'fog'，意为雾。当我们描述天气、环境、景色中充满雾时，我们会在'weather'、'environment'或'scenery'后添加'foggy'。除此之外，'foggy'还可以形容记忆或思维模糊不清。
sidebar:
  hidden: true
...
"Foggy" 这个单词来自 Old English 的 "fog"，意思是一种生长在湿地上的稠密植物，该词可能源于斯堪的纳维亚语，因为只有在北欧语言中有相关词源。"foggy"这个形容词形式大约在 15 世纪形成。
