---
title: Continuity
description: Continuity是一个名词，意为连续性或者连贯性。它突出了事件或状态的不断性和一致性。
sidebar:
  hidden: true
...
Continuity 来自于拉丁词根"-tinu-"，意为 "持续"。"Con-" 是一个前缀，意味着"一起"。词尾"-ity"表明它是名词。
...
"Continuity"这个词来自于 14 世纪的拉丁词"continuitas"，意即"连接或无间隔"。在许多西方文化中，连贯性被视为一种原则，比如在科学的观念、故事叙述乃至电影制作中。
...
<WordRelations antonyms={["discontinuity"]} client:only />
