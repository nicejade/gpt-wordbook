---
title: Malice
description: Malice 是一个名词，表示恶意，意在伤害别人。在法律中，它是故意做出伤害或不公正行为的意图。
sidebar:
  hidden: true
...
<Pronunciation word="Malice" uk="/ˈmælɪs/" us="/ˈmælɪs/" client:only />
...
Malice 来自拉丁词"malitia"，是"malus"（恶、坏）的衍生。
...
"Malice"源自 12 世纪的法国，由"malitia"派生而来。随着时间的推移，"malice"在英语中的使用变得越来越普遍，尤其是在法律环境中。
...
<WordRelations
  synonyms={["evilness", "wickedness", "envy", "grudge", "spite"]}
  client:only
/>
