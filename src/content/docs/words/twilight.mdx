...
title: Twilight
description: >-
  Twilight这个单词的主要含义是“黄昏”或“暮色”，指的是日落之后天空里的微光，也可以指日出前的那段微亮的时间。该词也经常被用作形容词，表示模糊，朦胧或者是不明确的。
sidebar:
  hidden: true
...
<Pronunciation word="Twilight" uk="/ˈtwaɪlaɪt/" us="/ˈtwaɪlaɪt/" client:only />
...
<WordRelations synonyms={["gloaming"]} client:only />
