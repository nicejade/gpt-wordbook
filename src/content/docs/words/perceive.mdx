...
title: Perceive
description: >-
  Perceive 是一个英语动词，主要的意思是“观察”、“认识”或“理解”。当你 perceive
  something，它就意味着你注意到、感知到或者理解了那个事物。
sidebar:
  hidden: true
...
<Pronunciation word="Perceive" uk="/pəˈsiːv/" us="/pɚˈsiv/" client:only />
...
"Perceive"的使用可以追溯到 14 世纪的拉丁语，通过法语传入英语。在欧美文化中，这个词常用于形容一个人的感知、理解和观察稳步的能力。
...
<WordRelations synonyms={["ken"]} client:only />
