---
title: Strong
description: Strong 是一个形容词，主要有以下几种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Strong" uk="/stɹɒŋ/" us="/stɹɔŋ/" client:only />
...
<WordRelations
  synonyms={["forceful","powerful","durable","sturdy","tough","ardent","unyielding","zealous","irregular","hard","concentrated","potent","rank","extreme","intense","impregnable","inviolable"]}
  antonyms={["weak","fragile","regular","diluted","impotent","powerlessly","weakly"]}
  client:only
/>
