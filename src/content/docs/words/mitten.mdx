...
description: >-
  Mitten
  是一个英语名词，指的是一种手部保暖配件，略微不同于普通手套的是，它通常只有一个大拇指部分，其余四个手指共享一个空间，使得手指之间的相互温暖能够更好地抵御寒冷。
sidebar:
  hidden: true
...
<Pronunciation word="Mitten" uk="/ˈmɪtn̩/" us="/ˈmɪtn̩/" client:only />
...
<WordRelations synonyms={["sock"]} client:only />
