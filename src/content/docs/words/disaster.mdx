...
description: >-
  Disaster
  是一个名词，通常指一种毁灭性的事件，尤其是导致大量人员伤亡和/或财产损失的自然或人为造成的不幸事件。例如地震、洪水、火灾、飞机失事等都可以被称为
  disaster。在口语中，它有时也被用来形容一场失败的尝试或计划。
sidebar:
  hidden: true
...
<Pronunciation word="Disaster" uk="/dɪˈzæs.tə/" us="/dɪˈzæs.tɚ/" client:only />
