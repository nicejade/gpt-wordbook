---
title: Speech
description: Speech 是一个名词，主要用来指'对于公众所做的形式演讲'。在扩大范围的语境中，'speech' 可以指代'人类语言的能力'，或者简单的'谈话'。
sidebar:
  hidden: true
...
<Pronunciation word="Speech" uk="/ˈspiːtʃ/" us="/ˈspiːtʃ/" client:only />
...
<WordRelations synonyms={["monologue", "oration", "soliloquy"]} client:only />
