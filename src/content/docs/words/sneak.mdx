...
description: >-
  - 'Sneak'
  是一个英文单词，在中文中，“sneak”通常可翻译为“潜行”，“偷偷摸摸”，主要表示偷偷地去做某事，或在人们不知道的情况下悄悄地进行。它可以用作动词和名词。
sidebar:
  hidden: true
...
<Pronunciation word="Sneak" uk="/sniːk/" us="/sniːk/" client:only />
...
- "Sneak" 这个词的历史可以追溯到 14 世纪，它起源于古英语的 "snican"，意思是"溜走"或"潜行"。在欧美文化中，"sneak" 经常用来描述偷偷行事或者做事情的人或动作。
...
<WordRelations
  synonyms={["trickster","grass","snitch","skulk"]}
  client:only
/>
