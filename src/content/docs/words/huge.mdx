---
title: Huge
description: Huge 这个单词的意思是“巨大的，庞大的”。这是一个形容词，主要用来形容尺寸、数量或程度非常大的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Huge" uk="[hʊudʒ]" us="/hjuːd͡ʒ/" client:only />
...
<WordRelations
  ...
  antonyms={["dwarf","minuscule","small","tiny"]}
  client:only
/>
