---
title: Pickle
description: Pickle主要有两种含义：一是动词，指将食物（尤其是蔬菜）浸泡在醋或者盐水中以防腐和调味；二是名词，指这种方法处理后的食物，例如：酸黄瓜。
sidebar:
  hidden: true
...
<Pronunciation word="Pickle" uk="/ˈpɪkl̩/" us="/ˈpɪkl̩/" client:only />
...
"Pickle"在英语中有着悠久的历史。早在 14 世纪，人们就用“pickle”来指代酸黄瓜。这个词可能源自荷兰语的“pekel”,意为"东西浸入水中"，表明了 pickle 的制作方法。
