---
title: Between
description: Between 是一个英语预词，用来表示两者之间或者两者中间的关系。这个词的主要意思是 “在...之间”，也可以用于权衡或比较两者。
sidebar:
  hidden: true
...
<Pronunciation word="Between" uk="/bɪˈtwiːn/" us="/bəˈtwin/" client:only />
...
<WordRelations
  synonyms={["atween", "atwix", "atwixt", "betwixt"]}
  client:only
/>
