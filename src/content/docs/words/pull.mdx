...
<Pronunciation word="Pull" uk="/pʊl/" us="[pʰʊːɫ]" client:only />
...
<WordRelations
  synonyms={["drag","toke","tug","yank","attraction","handle","knob","lever","rope","influence","sway","tow","score","complete","do","execute","perform","recall","withdraw"]}
  antonyms={["push","shove","repulsion","button","repel"]}
  client:only
/>
