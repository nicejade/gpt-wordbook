---
title: Spaceship
description: Spaceship是一个英文单词，中文翻译为'太空船'。它是指专为太空旅行设计的航行器，具有在太空中行驶和载人或物的能力。
sidebar:
  hidden: true
...
"Spaceship"一词在 20 世纪初开始进入公众视野，随着人类对太空的探索和发展，这个词逐渐成为常见的词汇。
...
<WordRelations synonyms={["spacecraft"]} client:only />
