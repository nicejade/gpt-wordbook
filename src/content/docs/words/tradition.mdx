...
title: Tradition
description: >-
  Tradition 是一个名词，来源于拉丁语的 'tradere'，意思是 '传递'。在英语中，'tradition'
  是指一个长期以来被某一群体或社会沿袭或坚持的信仰、观念、风俗习惯或活动方式。
sidebar:
  hidden: true
...
<Pronunciation word="Tradition" uk="/tɹəˈdɪʃn̩/" us="/tɹəˈdɪʃn̩/" client:only />
...
<WordRelations synonyms={["doctrine"]} client:only />
