---
title: Beggar
description: beggar 是一个名词，其主要含义是“乞丐”，指无家可归，靠乞讨为生的人。同时，它也可以作为动词，表示“使成为乞丐”或'使贫穷'。
sidebar:
  hidden: true
...
<Pronunciation word="Beggar" uk="/ˈbɛɡə/" us="/ˈbɛɡɚ/" client:only />
...
<WordRelations
  synonyms={["pauper","vagabond","mendicant","panhandler","truant","ruin"]}
  client:only
/>
