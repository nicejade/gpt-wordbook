...
title: At
description: >-
  "At"是一个英语预词，主要用于表示位置、时间、方式等方面的含义。在表达位置时，一般特指一个具体的地点，例如：at
  home（在家）；在表示时间上，表示某一特定的时间点，如：at 2 p.m.（下午两点）；在表示方式上，表示以……方式，如：at a high
  speed（以高速）。
sidebar:
  hidden: true
...
"At"始源于古英语 æt，表示“在、处于”的意思，用来表示时间、地点或方式。
