---
title: Critical
description: 英语单词 'critical' 主要有两个含义：1) 批评的，表示有批评性或找出错误的意图；2) 至关重要的，指某件事或某个时刻对结果有决定性的影响。
sidebar:
  hidden: true
...
<Pronunciation word="Critical" uk="/ˈkɹɪtɪkəl/" us="/ˈkɹɪtɪkəl/" client:only />
...
"Critical" 源自于希腊语 "kritikos"，意为 "能够做出判断的"。其在拉丁语和法语中也有类似的变体，最终在 16 世纪进入到英语中。此外，在英美文化中，这个词常常是表达批评意见或者是强调事情的关键性的。
