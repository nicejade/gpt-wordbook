---
title: Baggage
description: Baggage一词主要有两种含义。其一，它可以引用旅行中携带的行李；其二，用于比喻来表达个人的历史、经验或感情等带来的心理负担。
sidebar:
  hidden: true
...
<Pronunciation word="Baggage" uk="/ˈbæɡɪdʒ/" us="/ˈbæɡɪdʒ/" client:only />
...
<WordRelations synonyms={["bags", "gear", "luggage", "stuff"]} client:only />
