...
title: Handle
description: >-
  Handle 是一个英语单词，有多种用法。主要的两个词义是 '处理' 和 '把手'。当作为动词时，'handle'
  通常意味着管理、应对或处理某事或某人。作为名词时，则通常表示一个用手控制或移动某物的器具把手。
sidebar:
  hidden: true
...
<Pronunciation word="Handle" uk="/ˈhæn.dl/" us="/ˈhæn.dl/" client:only />
...
Handle 没有不同的词性变形，但可以添加 "-er" 后缀变为 "handler"，意为"处理者"。
