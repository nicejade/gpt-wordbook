---
title: Allege
description: Allege 是一个动词，意思是声称或者断言，通常指没有提供证据或者证明的情况下。
sidebar:
  hidden: true
...
<Pronunciation word="Allege" uk="/əˈlɛdʒ/" us="/əˈlɛdʒ/" client:only />

### 列举例句

1.  The newspaper alleged the mayor's corrupt practices.（报纸声称市长有腐败行为。）
2.  He alleges that she was driving at 90 mph.（他断言她的驾驶速度为每小时 90 英里。）
...
“Allege”来自于法语"alléguer"，再追溯则源于拉丁语的"allegare"，意思是“引用”或“举例”。在 14 世纪晚期，这个词开始在英语中使用，用来表示“引用，提出”，而在 15 世纪，它获得了“声称，断言”的含义。
