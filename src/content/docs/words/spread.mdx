---
title: Spread
description: Spread 是一个多义词，具有多种含义，可以作为动词和名词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Spread" uk="/spɹɛd/" us="/spɹɛd/" client:only />
...
<WordRelations
  synonyms={["straddle","swole","circulate","diffuse","disseminate","propagate"]}
  client:only
/>
