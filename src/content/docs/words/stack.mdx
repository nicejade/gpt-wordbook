---
title: Stack
description: "Stack的最基本的意思是“一堆，一叠”, 通常用于描述放置整齐的物体的群组，特别是一个个地叠加在一起的物体。"
sidebar:
  hidden: true
...
<Pronunciation word="Stack" uk="/stæk/" us="/stæk/" client:only />
...
<WordRelations synonyms={["gerrymander", "smash", "wreck"]} client:only />
