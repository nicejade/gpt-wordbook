---
title: Absence
description: Absence 是一个英文名词，中文意思是'缺席，缺少'。常用在描述某人或物在某个场合或地方缺席或不存在。
sidebar:
  hidden: true
...
<Pronunciation word="Absence" uk="/ˈæb.s(ə)n̩s/" us="/æbˈsɒns/" client:only />
...
Absence 这个单词从 14 世纪开始在英语中出现，其主要释义为"缺席，离开"，这个词反映了西方文化中对出席、参与的重视。

### 单词变形

作名词，单复数变形一样，均为 absence。缺席的意思可以作为动词，动词形式为"absent"，过去式和过去分词均为"absented"。
...
<WordRelations
  synonyms={["missingness"]}
  antonyms={["existence", "possession", "sufficiency", "presence"]}
  client:only
/>
