---
title: Latter
description: Latter 是一个英语形容词，用于描述在一系列两个或更多事物中位于后面或最后的事物。在中文中，通常被翻译为“后者”。
sidebar:
  hidden: true
...
<Pronunciation word="Latter" uk="/ˈlæt̬.əɹ/" us="/ˈlæt̬.əɹ/" client:only />
...
3.  In the 18th and 19th centuries, which latter period includes the industrial revolution, changes were much more gradual.
    在 18 世纪和 19 世纪（后者包含了工业革命），变化是更加渐进的。
...
<WordRelations
  antonyms={["aforementioned", "aforesaid", "former"]}
  client:only
/>
