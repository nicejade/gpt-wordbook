...
title: Lip
description: >-
  lip 在英语中主要用作名词，意思是'嘴唇'。此外，它还有其他的含义，如'瞧不起，不敬'或者用于构成一些比喻表达，如 'bite one's
  lip'（咬着嘴唇）等。
sidebar:
  hidden: true
...
<Pronunciation word="Lip" uk="/lɪp/" us="/lɪp/" client:only />
...
<WordRelations
  synonyms={["backchat","impudence","rudeness","edge","rim","spout","labium"]}
  client:only
/>
