---
title: Sword
description: Sword 是英文中的一种武器的名称，它主要指的是一种长而锐利的刀，两边有刃，通常配有保护手掌的护手。它被广泛用于战斗和竞技场。
sidebar:
  hidden: true
...
<Pronunciation word="Sword" uk="/sɔːd/" us="/sɔɹd/" client:only />
...
"Sword" 这个单词的存在可以追溯到公元前 1200 年，那时候的“剑”更加粗糙，比一般的刀更长。剑在各种文化中都有出现, 被广泛用于战斗和象征力量和威严。
