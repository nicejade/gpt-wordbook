...
title: Microcomputer
description: >-
  Microcomputer（微型计算机）是一种计算机，它是基于微处理器（microprocessor）的处理器，通常用在个人计算机（personal
  computers）。
sidebar:
  hidden: true
...
"Microcomputer"一词出现在 20 世纪 70 年代，指的是以微处理器为基础的个人计算机。微处理器的出现使计算机的体积大大减小，从而让更多的人能够拥有和使用计算机，引发了个人计算机的革命。
...
在 20 世纪 70 年代，微型计算机的发明重塑了世界。如今，这些强大的设备小到可以放在桌子上，成为日常生活的一部分。

<WordRelations synonyms={["PC", "micro"]} client:only />
