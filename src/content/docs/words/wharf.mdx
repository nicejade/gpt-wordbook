---
title: Wharf
description: wharf 是一个英文名词，主要用来表达“码头，停泊处”的含义。通常指供船只停靠，货物装卸的地方。
sidebar:
  hidden: true
...
<Pronunciation word="Wharf" uk="/wɔːf/" us="/wɔːf/" client:only />
...
<WordRelations synonyms={["dock", "quay"]} client:only />
