...
title: Prior
description: >-
  Prior 这个单词通常被用作形容词，表示发生在时间或顺序上发生在其它事情之前的。例如，在“prior
  experience”(先前的经验)这个表达中就是这样。
sidebar:
  hidden: true
...
<Pronunciation word="Prior" uk="/ˈpɹaɪɚ/" us="/ˈpɹaɪɚ/" client:only />
...
<WordRelations
  synonyms={["provost", "anterior", "ago", "hitherto"]}
  antonyms={["posterior"]}
  client:only
/>
