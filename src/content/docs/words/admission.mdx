...
title: Admission
description: >-
  "Admission" 是一个英文名词，常被应用在几个不同的情境中，它可以有以下几种含义： 1. 允许进入，例如：“他因为没有票被拒绝入场。”（He was
  denied admission because he did not have a ticket.） 2.
  承认，例如：“他的错误承认让我们都感到惊讶。”（His admission of his mistake surprised us all.） 3.
  进入费，例如：“影院入口票的价格。”（The price of admission to the cinema.）
sidebar:
  hidden: true
