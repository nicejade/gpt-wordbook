---
title: Admission
description: Admission 是一个英文名词，常被应用在几个不同的情境中，它可以有以下几种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Admission" uk="/ædˈmɪʃ.ən/" us="/ædˈmɪʃ.ən/" client:only />
...
<WordRelations
  synonyms={["acknowledgment","admittance","allowance","concession"]}
  client:only
/>
