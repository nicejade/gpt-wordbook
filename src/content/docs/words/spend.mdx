---
title: Spend
description: spend是一个英语动词，其基本意思是'使用金钱购买物品、服务或体验'或'用时间来做某事'。
sidebar:
  hidden: true
...
<Pronunciation word="Spend" uk="/spɛnd/" us="/spɛnd/" client:only />
...
"spend"本身就是一个词根，没有前缀或后缀。但是可以加上后缀-er 构成新词"spender"（花钱的人）。

### 文化背景

"spend"一词起源于 14 世纪，最初的含义主要与金钱有关，后来扩展到花费时间、能量等。
...
spend 的第一个字母 s，可以帮助记忆它的意思。s 既可以代表“钱 s(=money)”，也可以代表"时间 s(=seconds)" ， 我们都可以"spend"他们。

### 助记故事

Tom decided to spend his entire savings to buy a car. He believed it was a spend worth making.

Tom 决定用他所有的储蓄购买一辆车，他相信这是值得的花费。
