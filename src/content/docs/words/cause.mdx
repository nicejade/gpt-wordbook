---
title: Cause
description: cause 是一个英文词汇，可以作为名词使用，也可作为动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Cause" uk="/kɔːz/" us="/kɔz/" client:only />
...
<WordRelations synonyms={["grounds", "justification"]} client:only />
