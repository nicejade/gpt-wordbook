---
title: Middle
description: Middle 是一个英语单词，用作名词和形容词。作为名词，它称为中间或中部；作为形容词，它描述的事物位于中间，质量或顺序位于两个目标之间。
sidebar:
  hidden: true
...
<Pronunciation word="Middle" uk="/ˈmɪdəl/" us="/ˈmɪdəl/" client:only />
...
<WordRelations
  synonyms={["center", "centre", "midpoint", "midst"]}
  client:only
/>
