...
title: Burst
description: >-
  Burst 是一个动词，也可以作为名词使用。当其作为动词时，主要表示“突然破裂”或“突然发生”。例如，气球爆炸，我们就会说 'The balloon
  burst.' 当其作为名词时，意思为“一阵”，通常指一段时间内的集中或连续的活动。
sidebar:
  hidden: true
...
<Pronunciation word="Burst" uk="/bɜːst/" us="/bɝst/" client:only />
...
<WordRelations synonyms={["spurt"]} client:only />
