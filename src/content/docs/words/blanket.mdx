---
title: Blanket
description: Blanket是一个英语单词，这是一种宽大的布，通常用于覆盖以保暖，尤其是在睡觉时。也可以指 metaphorically 的盖住或包含所有人或所有事物。
sidebar:
  hidden: true
...
<Pronunciation word="Blanket" uk="/ˈblæŋkɪt/" us="/ˈblæŋkɪt/" client:only />
...
<WordRelations synonyms={["exhaustive"]} client:only />
