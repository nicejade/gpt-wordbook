...
title: Council
description: >-
  "Council" 是一个名词，主要指一个由多人组成的决策或咨询机构，例如学校的校董会或政府的理事会。 ## 例句举例 1. The student
  council planned a school trip for the entire grade. (学生会为全年级的同学计划了一次学校旅行。) 2.
  She's a member of the city council. (她是市议会的一员。) 3. The council approved the
  new housing project. (理事会批准了新的住房项目。)
sidebar:
  hidden: true
...
"Council" 一词源自 12 世纪的中英语，它是由拉丁词 "concilium" （聚集，集会）发展而来，它对应于今天英语中的 "council" 并代表组织聚集在一起做出决策的团体。
