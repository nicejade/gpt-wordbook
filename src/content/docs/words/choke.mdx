...
title: Choke
description: >-
  Choke作为动词，它的基本意义是'阻塞'或'窒息'。除此之外，它还可以在转喻意义上表示'由于紧张而失败'。例如，'I was so nervous, I
  choked during my presentation.'（我太紧张了，在演讲时失败了。）
sidebar:
  hidden: true
...
<Pronunciation word="Choke" uk="/t͡ʃəʊk/" us="/t͡ʃəʊk/" client:only />
...
<WordRelations
  synonyms={["asphyxiate","strangle","suffocate","throttle","clog","congest","jam","obstruct","stifle","stick"]}
  client:only
/>
