...
title: Hawk
description: >-
  Hawk 在英语中主要有两种意思。一种是鸟类的名字，指的是猎鹰，这是一种捕食其它小型动物的鸟类。此外，'hawk'
  还可以作为动词使用，表示公开催促或宣扬，通常用于销售或推广。
sidebar:
  hidden: true
...
<Pronunciation word="Hawk" uk="/hɔːk/" us="/hɔk/" client:only />
...
<WordRelations synonyms={["warmonger"]} antonyms={["dove"]} client:only />
