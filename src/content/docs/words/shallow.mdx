...
title: Shallow
description: >-
  Shallow 是一个形容词，一般用于描述事物表面化的、缺乏深度的或不深的，如浅水(shallow water)，浅薄的人(shallow
  person)，浅色(shallow color)等。在口语中，称某人为 'shallow'，多指其思考问题肤浅，没有深度。
sidebar:
  hidden: true
...
<Pronunciation word="Shallow" uk="/ˈʃaləʊ/" us="/ˈʃæl.oʊ/" client:only />
...
<WordRelations antonyms={["deep"]} client:only />
