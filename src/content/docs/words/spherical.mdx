...
title: Spherical
description: >-
  Spherical 这个单词源自于拉丁词'
  sphaericus'，其意思是“球形的，像球体的”。当你看到有人使用这个单词时，他们大概在谈论一些东西的形状与球类相似。你可以用这个词来描述物体，特别是三维物体，比如：地球是一个大的球形物体。
sidebar:
  hidden: true
...
<Pronunciation word="Spherical" uk="/sfiːɹɪkəl/" us="/sfiːɹɪkəl/" client:only />
...
"Spherical" 这个词最初是用于描述几何形状或实体的。它首次出现在 1387 年的英文记录中，在 16 世纪时，"spherical" 这个单词开始被广泛应用于天文学。
...
<WordRelations synonyms={["globular", "orbicular", "round"]} client:only />
