...
title: Fourth
description: >-
  Fourth是一个序数词，用来描述在一系列事物中的第四个。例如：“April is the fourth month of the
  year”（四月是一年中的第四个月）。
sidebar:
  hidden: true
...
<Pronunciation word="Fourth" uk="/fɔːθ/" us="/fɔɹθ/" client:only />
...
<WordRelations synonyms={["quarter"]} client:only />
