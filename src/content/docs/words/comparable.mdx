...
title: Comparable
description: >-
  "Comparable"是一个形容词，源自于拉丁词
  comparabilis，意为"可比较的"或"相似的"。它用于描述两个或更多的事物在某一方面很相似，或者可以直接对比。
sidebar:
  hidden: true
...
"Comparable"是一个形容词，源自于拉丁词 comparabilis，意为"可比较的"或"相似的"。它用于描述两个或更多的事物在某一方面很相似，或者可以直接对比。
...
"Comparable"这个词源自中古英语的"comparabil", 源于拉丁词"comparabilis"，意为"适合比较的"。它是 14 世纪末期开始在英语中出现使用，在多个欧洲语言中都有类似的表达方式，说明这个概念在欧美文化中非常普遍。
