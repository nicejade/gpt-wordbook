...
title: Beam
description: >-
  Beam 这个单词在英语中有多种意义，最常见的有两个。一方面，它可以被解读为 '一条长而直的硬条' 或者 '横梁',
  例如在建筑学中的一个重要组成部分。另一方面，它也常常用来形容 '射出光线或热量'，例如 '阳光照射' 或 '电视信号传输'。
sidebar:
  hidden: true
...
<Pronunciation word="Beam" uk="/biːm/" us="/biːm/" client:only />
...
<WordRelations synonyms={["breadth"]} client:only />
