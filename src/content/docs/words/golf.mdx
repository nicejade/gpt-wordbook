---
title: Golf
description: Golf 是一项无接触的户外运动，由玩家使用不同类型的各种高尔夫球杆，将小球击入球场上的一个系列洞中，以尽可能少的击打次数完成。
sidebar:
  hidden: true
...
<Pronunciation word="Golf" uk="/ɡɒlf/" us="/ɡɑlf/" client:only />
...
"Golf" 的起源颇有争议，大致可追溯到中世纪的苏格兰。这项运动在欧洲久负盛名，并在 19 世纪开始逐渐在全球范围内普及，现在是世界上知名度极高的运动之一。
