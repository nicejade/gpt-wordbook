---
title: Buffet
description: Buffet是一个英语词语，它有两个主要的含义：一是自助餐，是指一种就餐方式，餐馆提供多种食品让顾客自行选择；二是打击，冲击。
sidebar:
  hidden: true
...
<Pronunciation word="Buffet" uk="/ˈbʊfeɪ/" us="/bəˈfeɪ/" client:only />
...
<WordRelations
  synonyms={["smorgasbord","cupboard","sideboard"]}
  client:only
/>
