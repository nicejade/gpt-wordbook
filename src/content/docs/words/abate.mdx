...
<WordRelations
  synonyms={["contract","decrease","diminish","lessen","lower","moderate","remove","suppress","terminate","appease","depress","humble","pacify","soften","soothe","fail"]}
  antonyms={["accelerate","aggravate","amplify","continue","develop","enhance","enlarge","extend","increase","intensify","magnify","prolong","raise","revive","rise"]}
  client:only
/>
