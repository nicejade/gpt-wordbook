---
title: Abate
description: Abate是一个动词，它通常有两个主要含义。一是指'数量、程度或强度减少/降低'，二是'结束/取消'。
sidebar:
  hidden: true
...
<Pronunciation word="Abate" uk="/əˈbeɪt/" us="/əˈbeɪt/" client:only />
...
"Abate"的历史可以追溯到 12 世纪的法语，来自拉丁语的"ad battere"，意味着"向着击打"。在中世纪法律术语中，它也有"赋予（权利）"或"宣布（权利）无效"的含义。
...
<WordRelations
  synonyms={["contract","decrease","diminish","lessen","lower","moderate","remit","remove","slacken","suppress","terminate","appease","depress","humble","pacify","soften","soothe","tranquilize","fail"]}
  antonyms={["accelerate","aggravate","amplify","augment","continue","develop","enhance","enlarge","extend","foment","increase","intensify","magnify","prolong","raise","revive","rise"]}
  client:only
/>
