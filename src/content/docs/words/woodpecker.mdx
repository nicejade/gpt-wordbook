---
title: Woodpecker
description: Woodpecker是一种生活在林地和其他树木繁多地区的鸟类的名字，在中文中我们称它为“啄木鸟”。
sidebar:
  hidden: true
...
<Pronunciation word="Woodpecker" uk="/ˈwʊdpɛkə/" us="/ˈwʊdpɛkə/" client:only />
...
<WordRelations synonyms={["speight", "spight"]} client:only />
