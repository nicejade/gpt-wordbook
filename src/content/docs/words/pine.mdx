---
title: Pine
description: Pine 在英语中有两个主要的词义。作为名词（n.），通常用来指'松树'；当作为动词（v.）时，表示'渴望' '怀念' '消瘦'。
sidebar:
  hidden: true
...
<Pronunciation word="Pine" uk="/paɪn/" us="/paɪn/" client:only />
...
<WordRelations synonyms={["pinewood"]} client:only />
