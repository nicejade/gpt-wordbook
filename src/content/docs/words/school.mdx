---
title: School
description: School通常用来指代一个教育机构，例如小学，中学或者是大学。同时，'school' 也可以作为动词来表示教导或者培训的意思。
sidebar:
  hidden: true
...
<Pronunciation word="School" uk="/skuːl/" us="/skuːl/" client:only />
...
<WordRelations synonyms={["shoal"]} client:only />
