---
title: Horror
description: Horror 是英文中的一个常用词，中文翻译常为'恐怖'。它既可以用来指具有让人感到惊恐和恐怖的事物或事件，也可以反映出一种强烈的厌恶或恐惧感。
sidebar:
  hidden: true
...
<Pronunciation word="Horror" uk="/ˈhɔɹɚ/" us="/ˈhɑɹɚ/" client:only />
...
"Horror"来自拉丁语，意为“毛骨悚然”。在西方文化中，horror 与电影、小说类别深度关联，形成了独特的恐怖文化。
...
<WordRelations synonyms={["nightmare"]} client:only />
