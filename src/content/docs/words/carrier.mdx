---
title: Carrier
description: Carrier 是一个英语单词，主要有两种意思。其一，表示承载者，即运输工具或运输公司。其二，表示携带者，如疾病的携带者等。
sidebar:
  hidden: true
...
<Pronunciation word="Carrier" uk="/ˈkæ.ɹɪ.ə/" us="/ˈkæ.ɹɪ.ə/" client:only />
...
其他含有"er"的单词，如 runner(跑步者), leader(领导者)。
...
Carrier 是个名词，没有复数形式，没有形容词和副词的变形。
