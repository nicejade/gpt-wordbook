---
title: Hen
description: Hen 是英语中的一个常用单词，意思是“母鸡”。 这个单词几乎在所有涉及到农业、家禽或食物的场合都会用到。
sidebar:
  hidden: true
...
<Pronunciation word="Hen" uk="/hɛn/" us="/hɛn/" client:only />
...
<WordRelations synonyms={["bachelorette", "henfish"]} client:only />
