---
title: Postpone
description: Postpone是一个动词，意思是“推迟”，“延期”。它经常用来指一个任何类型的计划或事件被延后进行，出于各种原因。
sidebar:
  hidden: true
...
<Pronunciation word="Postpone" uk="/poʊstˈpoʊn/" us="/poʊstˈpoʊn/" client:only />
...
"Postpone" 一词首次出现在 15 世纪，来源于拉丁词“postponere”。在很多的西方文化中，"postpone" 通常有着稍许消极的内涵，表明因某种情况，事情无法按预定时间进行，需要推迟。
...
<WordRelations
  synonyms={["defer","delay","forestay","posticipate","procrastinate","stay","suspend"]}
  antonyms={["advance","antedate","expedite","hasten"]}
  client:only
/>
