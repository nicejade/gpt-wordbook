---
title: Government
description: Government（政府）是一个名词，本指管理、管理机构，特殊时指一个国家的最高行政权力机构，或个地方的管理组织。
sidebar:
  hidden: true
...
“Government”这个词在 14 世纪以"governement"的形式从法语进入英语，最初的含义是“控制，指导”，现在的含义“管理机构”在 17 世纪开始普及。
