---
title: Skeleton
description: "- 'Skeleton' 是名词，主要指的是动物或人的骨骼。在更广泛的意义上，它可以指称任何支撑结构，例如建筑物的框架。"
sidebar:
  hidden: true
...
<Pronunciation word="Skeleton" uk="/ˈskɛlətən/" us="/ˈskɛlətən/" client:only />

### 列举例句

1.  "The human skeleton is made up of 206 bones." (人的骨骼由 206 块骨头组成。)
...
- "Skeleton" 这个词最初诞生于 16 世纪，来自于希腊语，意为 "干瘪"。在欧美文化中，骷髅经常被用来象征死亡和毁灭。
...
<WordRelations
  synonyms={["ottomy", "skellington", "backbone"]}
  antonyms={["stub"]}
  client:only
/>
