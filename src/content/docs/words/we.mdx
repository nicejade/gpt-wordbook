---
title: We
description: we 是英语的一个人称代词，被用来指代讲话人和其他一名或者多名被包含在内的人。它的用法比较简单，没什么特殊之处。
sidebar:
  hidden: true
...
<Pronunciation word="We" uk="/wiː/" us="/wi/" client:only />
...
"We" 这个词源自早期的英语和日耳曼语，“we 的形式在大部分印欧（包括日耳曼）语中有相似出现。
...
因为 we 是基础英语单词，频繁使用并理解其中的意思，会更有助于记忆。我们可以通过一些日常英语国语中找到“我们”的英文对应单词，例如：“We all like singing.” "我们都喜欢唱歌。"
