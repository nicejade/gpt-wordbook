---
title: Treatment
description: treatment 是一个英文单词，它的基本含义是“治疗”，通常用于医学或心理学的领域。此外，'treatment'也可以指待遇，表示某人接受的对待方式。
sidebar:
  hidden: true
...
"treatment"这个单词在 14 世纪由中古英语的"treatment"衍生而来，意为对待或处理，后来在医学领域被广泛使用，用以描述药物或医疗程序的应用。
