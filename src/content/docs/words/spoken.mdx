---
title: Spoken
description: Spoken 是'恶话'的过去分词和过去式，主要用于描述以口头方式表达的信息或者描述人的口头语言能力。
sidebar:
  hidden: true
...
<Pronunciation word="Spoken" uk="/ˈspoʊkən/" us="/ˈspoʊkən/" client:only />
...
<WordRelations
  synonyms={["articulate","talk","verbalize","oral","verbal"]}
  antonyms={["unspoken"]}
  client:only
/>
