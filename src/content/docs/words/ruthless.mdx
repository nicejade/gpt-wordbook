---
title: Ruthless
description: Ruthless 是一个形容词，意味着无情的、冷酷的、毫无同情心的。使用这个词的时候可以形容一个人或者行为毫不留情，不顾及他人的感受或者后果。
sidebar:
  hidden: true
...
<Pronunciation word="Ruthless" uk="/ˈɹuːθləs/" us="/ˈɹuːθləs/" client:only />
...
<WordRelations antonyms={["ruthful"]} client:only />
