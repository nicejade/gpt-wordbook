...
description: >-
  Skyrocket
  这个词在英语中通常具有两个主要含义。首先，“skyrocket”作为动词，意味着“急剧上升”，可以和价格、数量、需求等有关。其次，它也可以作为名词，指的是一种会飞到空中并爆炸的烟火，相当于汉语中的“烟花”。
sidebar:
  hidden: true
...
<WordRelations synonyms={["maroon"]} antonyms={["plummet"]} client:only />
