...
description: >-
  Vain
  是一个英文形容词，意思是“虚荣的、自负的”，表示一个人过于关注自己的外貌或者特质，忽视了他人的观点或者心情。它还有一个意思是“无用的、徒劳的”，表示尽管已经尽力，但是无法达到预期的结果。
sidebar:
  hidden: true
...
<Pronunciation word="Vain" uk="/veɪn/" us="/veɪn/" client:only />
...
<WordRelations
  synonyms={["conceited","inflated","fruitless","futile","ineffectual","pointless"]}
  client:only
/>
