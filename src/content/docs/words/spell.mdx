...
title: Spell
description: >-
  "Spell" 这个词在英语中有多种含义，最常用的两个含义是： 1.动词，意为“拼写”。表示将一个词的每个字母按顺序写出或说出。例如：“Can you
  spell your name?”（你能拼写出你的名字吗？） 2.名词，意为“魔法，咒语”。例如：“She cast a spell to make
  herself invisible.”（她施了一个咒语使自己变得隐形。）
sidebar:
  hidden: true
