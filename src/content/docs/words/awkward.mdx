---
title: Awkward
description: Awkward是一个形容词，其主要的意思是“尴尬的，笨拙的”，主要用来形容不自然或者不熟练的动作，也可以形容形势或者环境复杂难处理。
sidebar:
  hidden: true
...
<Pronunciation word="Awkward" uk="/ˈɑkwɚd/" us="/ˈɔkwɚd/" client:only />
...
<WordRelations
  synonyms={["clumsy","ungraceful","maladroit"]}
  antonyms={["amiable","cool","dexterous","graceful","handy","skillful"]}
  client:only
/>
