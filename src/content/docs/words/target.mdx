...
title: Target
description: >-
  单词 'target' 通常用作名词，主要的含义是“目标”、“靶子”或“目的地”，例如：The company set a target of
  increasing sales by 10%. （公司设定了提高销售额 10%的目标）； When shooting, aim at the
  target. （射击时，瞄准靶子）。
sidebar:
  hidden: true
...
单词 "target" 通常用作名词，主要的含义是“目标”、“靶子”或“目的地”，例如：The company set a target of increasing sales by 10%. （公司设定了提高销售额 10%的目标）； When shooting, aim at the target. （射击时，瞄准靶子）。

<Pronunciation word="Target" uk="/tɑːɡɪt/" us="/ˈtɑɹɡɪt/" client:only />
