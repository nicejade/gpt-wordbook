---
title: Invoice
description: "Invoice是名词，表示'账单'或'发票',主要用于商品或服务的买卖交易中。"
sidebar:
  hidden: true
...
<Pronunciation word="Invoice" uk="/ˈɪnˌvɔɪs/" us="/ˈɪnˌvɔɪs/" client:only />
...
"Invoice"一词最早出现在 15 世纪，并且在那时表示“送货清单”。它来自于法语单词 "envoie" 的形式"en voie"，也就是"在路上"的意思。这是因为在中世纪，商人之间的商品买卖通常会配有一份清单，随同货物一起"在路上"。现在，“Invoice”的意思已经延伸到了“发票”或“账单”。
...
<WordRelations synonyms={["shipment"]} client:only />
