---
title: Yesterday
description: Yesterday是一个时间词，指的是“昨天”，通常用于表示在今天的前一天发生的事情或时间点。
sidebar:
  hidden: true
...
<Pronunciation word="Yesterday" uk="/ˈjɛstədeɪ/" us="/ˈjɛstɚdeɪ/" client:only />
...
"Yesterday"始于 10 世纪，在旧英语中写作“geostran dæg”。它也在 The Beatles 的著名歌曲《Yesterday》中被广泛使用，这首歌的全球销量超过了 1500 万张，使“Yesterday”这个词在全球继续流传。
...
<WordRelations antonyms={["tomorrow"]} client:only />
