...
description: >-
  英语单词 'patent'
  这个词有两个主要的含义。第一个是它作为名词使用，指的是“专利”，这是一种法律文书，赋予发明人一段时间内对其发明产品或设计的专有控制权。第二个含义是它作为形容词使用，指的是“显而易见的”。
sidebar:
  hidden: true
...
<Pronunciation word="Patent" uk="/ˈpeɪtənt/" us="/ˈpeɪtənt/" client:only />
...
这个词最早来源于拉丁语“letters patent”（意思是“公开的信”），指的是一种公开声明，对某人赋予特定的权益或财产。从 14 世纪开始，在英语中，这个词被用来指代“由政府授予的特权”，其后，“patent”一词逐渐发展为现在我们所熟知的关于知识产权的含义。
