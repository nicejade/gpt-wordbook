---
title: "relative"
description: "Relative可以作为名词或形容词使用。 作为名词，它通常表示亲戚，例如我们说a close/far relative，就是指近/远亲。 作为形容词，relative有相对的，相关的的意思。例如我们说relative temperature，就是指相对温度。"
---
...
其他的衍生单词有：relate, relationship 等。

### 词缀分析

"Relative"这个单词的词缀分析如下: re- 表示反复，-late 表示载，-ive 表示形容词。

与其含有共同词缀的其他单词有：active, progressive 等。

### 发展历史和文化背景

"Relative"这个单词源自 15 世纪的拉丁语，最初用来表明某事与另一件事有关系或联系。在现代英语中，该单词成为关注事物间关系和相对性的常用术语。
