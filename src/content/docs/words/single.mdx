...
<Pronunciation word="Single" uk="/ˈsɪŋɡəl/" us="/ˈsɪŋɡəl/" client:only />
...
"Single" 这个词在 13 世纪时从法语传入英语中。起初，它主要用于描述没有任何混杂物质的物体，也用来描述纯洁或绝对的道德原则。到了 16 世纪，"single" 开始用于指望远镜、单人房等物品和情况。随着社会文化的发展，"single" 也开始用于描述未婚或者没有恋人的人。
...
David 是一个喜欢唱歌的单身爸爸。每天早晨给女儿做早餐时，他都会轻声哼唱。这是他们一天中最珍贵的时光。
...
<WordRelations
  ...
  antonyms={["album", "married", "divorced", "taken", "widowed", "LAT"]}
  client:only
/>
