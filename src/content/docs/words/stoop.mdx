---
title: Stoop
description: Stoop是一个英语动词，具有两个主要的含义：
sidebar:
  hidden: true
...
<Pronunciation word="Stoop" uk="/stuːp/" us="/stuːp/" client:only />
...
"Stoop" 最早出现在 14 世纪的英国，主要用来描述人的身体动作。后来慢慢地，"stoop "也开始被用来比喻降低自己的社会地位或品格的行为。
