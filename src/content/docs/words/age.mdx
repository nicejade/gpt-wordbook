...
description: >-
  Age
  这个单词在英语中有两个基本含义。首先，它可以指一个人、物体或事件存在或发展的时间长度。例如，可以用来表示年龄，或者一个历史时期。其次，它也可以作为动词使用，表示“变老”或“成熟”。
sidebar:
  hidden: true
...
<Pronunciation word="Age" uk="/eɪd͡ʒ/" us="/eɪd͡ʒ/" client:only />
...
<WordRelations
  synonyms={["lifespan","lifetime","dotage","eld","eternity","yonks","epoch","time","centennium","yearhundred","mature","elden"]}
  client:only
/>
