---
title: During
description: During 是一个预词，表示在某段时间或某个事件发生的同时。
sidebar:
  hidden: true
...
<Pronunciation word="During" uk="/ˈdjɔː.ɹɪŋ/" us="/ˈd(j)ʊɚ.ɪŋ/" client:only />
...
"During" 在英美文化中通常用于描述时间段，尤其是突出事件的上下文。它出现在 14 世纪，由旧英语的 "duren" 演化而来，原意是“持续”。
