---
title: Tropic
description: "Tropic一词来自希腊语单词'tropikos'，意为'转换'，开始被用来表示太阳在南至南回归线和北至北回归线之间转换的地点。在现当代英语中，'tropic'主要用于表示地球上的两个热带——'Tropic of Cancer'(北回归线)和 'Tropic of Capricorn'(南回归线)。"
sidebar:
  hidden: true
