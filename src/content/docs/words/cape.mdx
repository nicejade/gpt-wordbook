...
title: Cape
description: >-
  Cape在英语中主要有两个意思。一是作为名词，指的是斗篷或披风，一种穿在外衣上面的宽大的服饰；二是地理名词，指的是地质形态（海角），通常是进入海洋或湖泊的一块陆地。
sidebar:
  hidden: true
...
<Pronunciation word="Cape" uk="/keɪp/" us="/keɪp/" client:only />
...
"Cape"作为指披肩或斗篷的名词，成形于 14 世纪通过法语引入英语的，源自拉丁语"cappa"。作为指海角的名词，16 世纪初引入英语，源自法语"cap"，意为"头"，在地理方面解释为陆地的一部分突出海洋部分，形状似头。
...
<WordRelations synonyms={["chersonese", "peninsula", "point"]} client:only />
