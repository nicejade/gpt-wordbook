---
title: Explicitly
description: Explicitly 是一个副词，意思是 '明确地'，'毫不含糊地'。它经常用于描述一个行为或陈述是直接、清楚可见的，没有任何隐晦或模糊。
sidebar:
  hidden: true
...
1.  He explicitly told me to arrive by 8:00. (他明确地告诉我要在 8 点前到达)
...
<WordRelations
  synonyms={["expressly", "unambiguously"]}
  antonyms={["implicitly"]}
  client:only
/>
