---
title: Predominantly
description: Predominantly 是一个副词，意思是主要地、大部分地。
sidebar:
  hidden: true
...
"Predominantly"这个词在 16 世纪由拉丁语“praedominant”演变而来，一直沿用至今。
...
<WordRelations synonyms={["primarily", "principally"]} client:only />
