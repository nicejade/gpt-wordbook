...
description: >-
  ...
  列舉例句 1. Please look at the blackboard. (請看黑板。) 2. She has the look of a movie
  star. (她有電影明星的風采。) 3. It looks like it's going to rain. (看起來要下雨了。) ## 詞根分析
  「Look」來自於中古英語的詞彙「loken」，意為觀看或者眺望。 ## 詞綴分析 「Look」是一個獨立單詞，沒有前後綴。 ## 文化背景
  「Look」源於中古英語的「loken」，和現代英語中的「gaze」，都代表「盡量地看」的意思。從文化角度來看，這個詞表現了英語語言獨特的思維方式，即更加注重個體的觀察和發現。
  ## 單詞變形 名詞單數形式：look 名詞複數形式：looks 動詞一般現在時：look 動詞一般過去時：looked 動詞一般將來時：will look
  形容詞：lookable 副詞：lookingly
sidebar:
  hidden: true
