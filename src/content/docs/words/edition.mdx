---
title: Edition
description: Edition 是一个名词，表示出版物（如书，报纸，杂志等）的一次印刷或一种版本。它也可以用来形容艺术品（如雕塑或印刷品）的一个系列。
sidebar:
  hidden: true
...
<Pronunciation word="Edition" uk="/əˈdɪʃən/" us="/əˈdɪʃən/" client:only />
...
"edition" 这个词在 16 世纪末由法语引入英语，原意为 "一次印刷"或 "版本"。至今这个词在出版业以及艺术收藏中十分常用。
