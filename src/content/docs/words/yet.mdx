---
title: Yet
description: Yet 是一个副词，意思是'still' (仍然) 或者 'up to now' (到现在为止)。
sidebar:
  hidden: true
...
<Pronunciation word="Yet" uk="/jɛt/" us="/jɛt/" client:only />
...
<WordRelations
  synonyms={["even","now","still","besides","further","moreover","erenow","withal"]}
  client:only
/>
