---
title: Firewood
description: '"Firewood"是一个名词，用来描述被切割好并准备以燃烧的方式使用的木头。'
sidebar:
  hidden: true
...
没有明确的变形形式，但是与它相关的单词还有 firewood chopping (砍柴)。
...
(在一个寒冷的冬夜，Tom 坐在火堆旁，向跳动的火焰中扔一块块柴火。他的脸被温暖的火光照亮，他感到了一种只有热火才能带来的舒适和平静。)
