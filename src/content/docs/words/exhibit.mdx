---
title: Exhibit
description: Exhibit 是一个英语单词，它既可以作为动词也可以作为名词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Exhibit" uk="/ɛɡ-/" us="/ɛɡ-/" client:only />
...
相同词缀的其他单词有：extrude（挤出）和 exit（出口）等。

### 文化背景

"Exhibit" 是 14 世纪中期入主英语的，来自拉丁语，最初用法是 "展示或指出（事实等）"。到了 1530 年， 单词的名词用法以及 "展示（物品等）"的涵义开始流行。
...
<WordRelations
  synonyms={["showing","exhibition","exposition","show","demonstrate","display"]}
  client:only
/>
