---
title: Deceit
description: Deceit 在英语中是一个名词，意为'欺骗'或'不诚实'，指的是为了得到自己想要的结果而故意隐瞒真相或者伪造事实的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Deceit" uk="/dɪˈsiːt/" us="/dɪˈsiːt/" client:only />
...
"Deceit" 这个词首次出现在 14 世纪，源于拉丁词 "decipere"，这个词在罗马时代的意思是"捉弄"、"欺骗"。这个词的最初含义包含了人们在争夺战争和权力时所发挥的诸多策略。
...
<WordRelations
  synonyms={["deception","trickery","fraud","trick","deceptiveness","fraudulence"]}
  client:only
/>
