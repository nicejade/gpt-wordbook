...
<WordRelations
  synonyms={["broad","close","friendly","intimate","chunky","solid","stocky","thickset","crowded","dense","packed","dumb","stupid","opaque"]}
  antonyms={["brainy","intelligent","smart","runny","scant","scarce","slight","slender","slim","svelte","thin","sparse","transparent"]}
  client:only
/>
