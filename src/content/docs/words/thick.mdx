---
title: Thick
description: Thick 是一个形容词，基本意味是不薄的，用于形容材料、液体、物体等的厚度，同时也可以形容声音沉闷等抽象概念，还常常用于比喻人头脑笨或反应慢。
sidebar:
  hidden: true
...
<Pronunciation word="Thick" uk="/θɪk/" us="/θɪk/" client:only />
...
<WordRelations
  synonyms={["broad","chummy","close","friendly","intimate","pally","chunky","solid","stocky","thickset","crowded","dense","packed","dumb","stupid","opaque"]}
  antonyms={["brainy","intelligent","smart","runny","scant","scarce","slight","slender","slim","svelte","thin","sparse","transparent","unacquainted"]}
  client:only
/>
