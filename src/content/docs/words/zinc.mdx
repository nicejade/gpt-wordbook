...
title: Zinc
description: >-
  Zinc 是一个英语单词，它通常用来指一种化学元素（化学符号为 Zn），这也是在元素周期表上的名称。Zinc
  是一个必须的微量元素，在人体中扮演重要的功能，例如免疫功能、蛋白质合成等。
sidebar:
  hidden: true
...
<Pronunciation word="Zinc" uk="/zɪŋk/" us="/zɪŋk/" client:only />
...
Zinc 在古代被广泛应用于合金和金属制品的制造。名字“Zinc”来自德语单词“Zink”，该词首次出现在 16 世纪。其名称可能源于锌矿石的外观，对应的德语单词 "zincen" 意为 “突出”。
