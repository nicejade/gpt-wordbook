---
title: Yell
description: Yell是一个动词，原词意为'大声呼喊'或者'大叫'，通常用于描述一个人因为愤怒、惊奇、恐惧或者激动等情绪而发出的很大的声音。
sidebar:
  hidden: true
...
<Pronunciation word="Yell" uk="/jɛl/" us="/jɛl/" client:only />
...
<WordRelations synonyms={["call", "cry", "holler", "shout"]} client:only />
