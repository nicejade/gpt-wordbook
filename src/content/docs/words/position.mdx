---
title: Position
description: Position 是一个英文单词，通常被用作名词，主要有三个含义：位置、职位以及立场。
sidebar:
  hidden: true
...
"Position" 这个单词从 14 世纪开始在英语中出现，主要来源于拉丁词 "positionem"，意味着"放置"或"站立"。
...
<WordRelations synonyms={["stead", "stell"]} client:only />
