---
title: Fashion
description: Fashion 这个单词在最常被用来指时尚、流行或者风尚。除此之外，它也可以被用作动词，表达制作或者创建某样东西的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Fashion" uk="/ˈfæʃən/" us="/ˈfæʃən/" client:only />
...
"Fashion" 一词源自 14 世纪的 "façon"，意为：方式，方法，流行的风格，在 15 世纪时开始用于代表流行款式或服装。
