...
title: Headmistress
description: >-
  headmistress 是一个名词，指的是一所学校的女校长。在英国的私立学校和公立学校中，特别是只招收女性学生的学校，校长人常常被称为
  'headmistress'。如果是男校长，则用 'headmaster'。
sidebar:
  hidden: true
...
"headmistress" 这个词在英语中被用来表示女校长大约在 19 世纪末期开始，那时候女性开始在教育界占据领导职位。最初，“mistress”曾是对于所有女性的通用称呼，后来逐渐演化为现在的义项。
...
<WordRelations synonyms={["headteacher", "principal"]} client:only />
