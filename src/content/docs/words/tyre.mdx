---
title: Tyre
description: "- 'Tyre' 是一个英语单词，主要在英式英语中使用，等同于美式英语的 'tire'，主要用来指自行车、摩托车或汽车等车辆的轮胎。"
sidebar:
  hidden: true
...
<Pronunciation word="Tyre" uk="/taɪə(ɹ)/" us="/taɪə(ɹ)/" client:only />
...
- "Tyre"这个单词起源于 17 世纪，最早指的是围绕木制车轮的铁箍。随着橡胶轮胎的发明及普及，"tyre"的意义逐渐演变，成为今天我们用来指汽车、自行车等轮胎的词汇。
