---
title: Smooth
description: Smooth是一个形容词，常用来形容物体或表面光滑无疙瘩，没有凹凸不平的地方。同时也可以用来形容动作或过程流畅，没有问题或困难。
sidebar:
  hidden: true
...
<Pronunciation word="Smooth" uk="/smuːð/" us="/smuːð/" client:only />
