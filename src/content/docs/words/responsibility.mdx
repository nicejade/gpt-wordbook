...
description: Responsibility 是一个名词，意味着 '责任' 或 '义务'，用于描述一个人需要履行的义务或职责。
sidebar:
  hidden: true
...
"Responsibility" 这个词在 16 世纪的拉丁语中首次出现，用来描述 "承担答复或承诺的义务" 的情况。在英美文化中，"responsibility" 经常被用来描述道德、法律或社会对个体的要求。
...
<WordRelations synonyms={["responsibleness"]} client:only />
