---
title: Tomato
description: Tomato是英语单词，翻译成中文就是“西红柿”。
sidebar:
  hidden: true
...
<Pronunciation word="Tomato" uk="[tʰə̥ˈmɑːtʰəʊ]" us="[tʰə̥ˈmeɪɾoʊ]" client:only />
...
"Tomato"源自西班牙语单词'tomate'，其进一步源自 NAHUATL（阿兹特克语）'tomatl'。并无明显的词根相关。
...
"Tomato"一词的历史始于 16 世纪，最先在墨西哥南部和中美洲使用，然后通过西班牙的探险家传播到欧洲。在英语中，最早见于 1595 年，是英语接触和借用西班牙语的结果。
