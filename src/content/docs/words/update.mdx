...
title: Update
description: >-
  单词 'update' 是个动词，中文的意思是'更新'或
  '升级'。使用电脑或手机时经常会碰到这个单词，表示重新安装或修正软件以提供最新的数据或改善性能。此外, 'update'
  在日常对话中也可以指提供最新信息或新闻，或者通知某人对现状的变更。
sidebar:
  hidden: true
...
'Update' 这个词在 20 世纪 40 年代开始出现，在计算机和科技行业中使用广泛。随着科技的发展，该词在日常生活中的应用也变得越来越普遍。
