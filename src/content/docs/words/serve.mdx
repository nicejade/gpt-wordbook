...
title: Serve
description: >-
  Serve作为动词时，有几种主要的含义。第一它常被用来表达'服役'或者'服务'，例如在餐馆工作等。第二，它也被用来表达'担任'的意思，例如担任社区的领导者。第三，有时我们使用'serve'来表示'提供'或者'给予'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Serve" uk="/sɜːv/" us="/sɝv/" client:only />
...
<WordRelations
  synonyms={["service","serving","attend","bestand"]}
  antonyms={["receive"]}
  client:only
/>
