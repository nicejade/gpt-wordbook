---
title: Sunshine
description: Sunshine是一个英语单词，主要有两个含义：1）阳光。2）开朗快乐的人或事物，这是引申意。
sidebar:
  hidden: true
...
<Pronunciation word="Sunshine" uk="/ˈsʌnʃaɪn/" us="/ˈsʌnʃaɪn/" client:only />
...
<WordRelations synonyms={["sunlight"]} client:only />
