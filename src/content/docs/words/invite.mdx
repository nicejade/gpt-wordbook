---
title: Invite
description: 单词 'invite' 的主要词义是邀请，是动词，比如邀请某人到某处或做某事。目的可能是宴会，聚会，会议或任何类型的社交活动。
sidebar:
  hidden: true
...
<Pronunciation word="Invite" uk="/ɪnˈvaɪt/" us="/ɪnˈvaɪt/" client:only />
...
这个单词来自 14 世纪的中古英文 "inviten"，它的意思也是邀请。在古英语中，表达邀请的词是 "biddan".
...
<WordRelations
  synonyms={["encourage","provoke","ask","beseech","entreat","request"]}
  client:only
/>
