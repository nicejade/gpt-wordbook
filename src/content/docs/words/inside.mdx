...
description: >-
  - 'Inside'
  是个形容词，副词，或介词，指在某物的内部或内部的一部分。它可以用于描述物理位置，如“在房子里面”，也可以用于描述非物理概念，如“由内而外的了解”等等。
sidebar:
  hidden: true
...
<Pronunciation word="Inside" uk="/ɪnˈsaɪd/" us="/ɪnˈsaɪd/" client:only />
...
- "Inside" 的使用可以追溯到 14 世纪的中古英语，原意为“在内”的意思，后来发展为现今的多种语境和含义。
...
<WordRelations antonyms={["outside"]} client:only />
