---
title: Species
description: 英文单词'species'通常被翻译为'物种'。它最基础的含义是指生物分类学中的一个基本单位，同一物种的生物有共同的特征和系谱。
sidebar:
  hidden: true
...
<Pronunciation word="Species" uk="/ˈspiːsiːz/" us="/ˈspiːsiːz/" client:only />
...
"Species"这个词源自 16 世纪的拉丁文，那时被用来指代各种植物和动物的特定种群。
