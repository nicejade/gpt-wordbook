...
title: Prohibition
description: >-
  Prohibition 是一个英语名词，通常指的是官方或法律对某种活动或行为的禁止。例如，'Alcohol prohibition'
  指的是对酒精的禁令。在历史上，'The Prohibition' 常常特指美国在 1920 到 1933 年间强制实行的禁酒法。
sidebar:
  hidden: true
...
<WordRelations synonyms={["forbode"]} antonyms={["permission"]} client:only />
