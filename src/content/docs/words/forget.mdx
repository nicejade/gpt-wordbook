---
title: Forget
description: Forget 是一个英语动词，意思是“忘记”。它可以指的是无法回忆起某个人、事、物或者信息，或者没能把某事物放在心上，无法记清。
sidebar:
  hidden: true
...
<Pronunciation word="Forget" uk="/fəˈɡɛt/" us="/fɚˈɡɛt/" client:only />
...
<WordRelations
  synonyms={["disremember","obliviate","overlook"]}
  antonyms={["acquire","learn","mind","recall","recollect","remember","reminisce"]}
  client:only
/>
