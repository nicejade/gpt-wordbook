---
title: Medal
description: Medal一词是指一种标记特定成就，尤其是竞赛中的优胜，或显示某种荣誉或服役的牌匾。这可以是在体育赛事中或者学术等方面获得的荣誉。
sidebar:
  hidden: true
...
<Pronunciation word="Medal" uk="[ˈmɛd.ɫ̩]" us="[ˈmeɾ.ɫ̩]" client:only />
...
"Medal"一词源自 16 世纪的法语 médaille，该词源自拉丁语的 medallis，表示"金属小币"，随后经由意大利语发展为 medaglia，最终形成了现在的英文形式。
