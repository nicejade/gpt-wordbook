---
title: Likeness
description: Likeness在英语中是个名词，意思是'相似性'或'肖像'。这个单词主要用来指人或事物间的相似之处，或者是某人的肖像或画像。
sidebar:
  hidden: true
...
<Pronunciation word="Likeness" uk="/ˈlaɪknəs/" us="/ˈlaɪknəs/" client:only />
...
<WordRelations
  synonyms={["resemblance", "similarity", "similitude"]}
  client:only
/>
