---
title: Intimate
description: Intimate 是一个可以作为形容词和动词使用的英文单词。
sidebar:
  hidden: true
...
<Pronunciation word="Intimate" uk="/ˈɪn.tɪ.mət/" us="/ˈɪn.tɪ.mət/" client:only />
...
“Intimate”,作为形容词在 16 世纪时首次出现，由拉丁词源“intimatus”衍生而来，意为"使亲近"。而作为动词使用，可以追溯到 1650s。

### 单词变形

Intimate 的动词变形有 intimates, intimated, intimating；名词形式是 intimation(暗示)。
