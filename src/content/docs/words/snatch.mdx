---
title: Snatch
description: Snatch是一个动词，意味着迅速且突然地抓取或夺取。也可以用作名词，作为名词时它描述了一个迅速或急促的行动。
sidebar:
  hidden: true
...
<Pronunciation word="Snatch" uk="/snætʃ/" us="/snætʃ/" client:only />
...
"Snatch"这个单词在 13 世纪从旧英语的"snæccan"发展而来，一直沿用到现在。在英语中"snatch"往往含有急促，突然的意思，可能会给人一种负面的印象。
...
<WordRelations synonyms={["cunt", "twat", "grab"]} client:only />
