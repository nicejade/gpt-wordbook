...
<WordRelations
  synonyms={["changeable","parameter","flexible","mutable","aberrant","fickle","fluctuating","inconstant","shifting","unstable","unsteady","varying"]}
  antonyms={["constant","invariable","immutable","unalterable","unchanging"]}
  client:only
/>
