---
title: Lesson
description: Lesson 这个单词在英语中主要有两个意思：第一是 '教训'，指从经验或错误中学到的知识；第二是'课程'，指在学校、学院或私人导师那里学习的课。
sidebar:
  hidden: true
...
<Pronunciation word="Lesson" uk="/ˈlɛsn̩/" us="/ˈlɛsn̩/" client:only />
...
"Lesson" 一词源于 12 世纪的中古英语 “lesoun”，原意指的是一种宗教仪式。后来，随着时间的推移，它的意义扩大，可以指任何一种教育或经历。
...
<WordRelations synonyms={["lection", "lear"]} client:only />
