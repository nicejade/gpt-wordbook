...
title: Kill
description: >-
  Kill在英语中是一个动词，主要有两个含义。第一是结束生命，比如：“He killed the
  spider”（他杀死了那只蜘蛛）。第二是使停止或消除，例如：“The rain killed our plans for a
  picnic”（雨水破坏了我们的野餐计划）。
sidebar:
  hidden: true
...
<Pronunciation word="Kill" uk="/kɪl/" us="/kɪl/" client:only />
...
<WordRelations
  synonyms={["annihilate","assassinate","dispatch","ice","liquidate","murder","slaughter","slay","top","whack","break","deactivate","disable"]}
  client:only
/>
