---
title: Potato
description: Potato是英语中表示一种常见蔬菜的单词，将其直接翻译成中文为“土豆”或“马铃薯”。
sidebar:
  hidden: true
...
<Pronunciation word="Potato" uk="/pəˈteɪ.təʊ/" us="/pəˈteɪ.təʊ/" client:only />

### 列举例句

1.  "I like eating baked potatoes." (我喜欢吃烤土豆。)
2.  "Potatoes are rich in Vitamin C." (土豆富含维生素 C。)
...
<WordRelations
  synonyms={["p'tater","spud","tater","tatie","tator","earthapple","murphy"]}
  client:only
/>
