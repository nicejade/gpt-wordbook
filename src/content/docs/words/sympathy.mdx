...
title: Sympathy
description: >-
  Sympathy是一个名词，主要有两种意思。第一种是同情，同理心，指你理解他人的感受，并对他们的情况感到遗憾。第二种是悼念，哀悼，用来表示对他人遭遇悲剧或苦难的悲伤情绪。
sidebar:
  hidden: true
...
<Pronunciation word="Sympathy" uk="/ˈsɪmpəθi/" us="/ˈsɪmpəθi/" client:only />
...
"Sympathy"这个词在英语中的使用可以追溯到 16 世纪初，它来自于古希腊语，表示的含义是共同感受到或者受到影响。在西方文化中，"Sympathy"常常被用于表达对他人的同情和理解，是一种表达人与人之间深度联系的方式。
...
<WordRelations antonyms={["contempt"]} client:only />
