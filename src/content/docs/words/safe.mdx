---
title: Safe
description: Safe 主要有两个含义，首先是形容事物或地方无危险、无害；其次是作为名词，表示保险柜、金库等保护物品不受损失的装置。
sidebar:
  hidden: true
...
<Pronunciation word="Safe" uk="/seɪf/" us="/seɪf/" client:only />
...
<WordRelations
  synonyms={["coffer","lockbox","strongbox","cool","wicked","lenient","merciful","tolerant","harmless","riskless","secure","trustworthy"]}
  antonyms={["dangerous","harmful","harsh","intolerant","strict","unsafe"]}
  client:only
/>
