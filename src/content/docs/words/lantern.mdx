---
title: Lantern
description: Lantern 是一个英文名词，中文意为“灯笼”。“Lantern”一词通常用于描述一种可以携带的便携式照明设备，可以使用烛光、油、气体等作为光源。
sidebar:
  hidden: true
...
<Pronunciation word="Lantern" uk="/ˈlæn.tən/" us="/ˈlæn.tɚn/" client:only />
...
由于 lantern 是一个名词，它没有良好的动词或形容词形式。 但是，形容词 "lantern-like" 可以用来描述像灯笼一样的东西。
