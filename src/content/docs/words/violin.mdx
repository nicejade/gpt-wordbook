---
title: Violin
description: Violin 是一种弦乐器，音色悠扬，是交响乐团中最重要的乐器之一。
sidebar:
  hidden: true
...
<Pronunciation word="Violin" uk="/ˌvɑe.ɘˈlɘn/" us="/ˌvaɪəˈlɪn/" client:only />
...
"Violin" 来源于 16 世纪的意大利，现已发展为全球最为广泛使用的乐器之一。在西方古典音乐中，小提琴在所有的交响乐团中占有重要地位。
...
<WordRelations synonyms={["fiddle"]} client:only />
