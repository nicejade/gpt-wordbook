---
title: Rotate
description: "- 'Rotate' 这个词在英语中的意思是“旋转”或“转动”。"
sidebar:
  hidden: true
...
<Pronunciation word="Rotate" uk="/ɹəʊˈteɪt/" us="/ˈɹoʊteɪt/" client:only />
...
- "Rotate" 这个词源自拉丁语，最早出现在 16 世纪的英语中，用以描述物体沿轴线旋转的动作。
...
<WordRelations synonyms={["circumvolve", "revolve"]} client:only />
