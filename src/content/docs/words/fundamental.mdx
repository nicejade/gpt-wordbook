...
description: >-
  英文单词 'fundamental'
  是一个形容词，表示“基础的”或者“根本的”。它是用来描述一些事情最基本、最重要的部分。这个词通常与原则、信仰、规则等词语搭配使用。
sidebar:
  hidden: true
...
"Fundamental"源自拉丁文"fundamentum"，最早在 16 世纪的英语中出现，表示"地基"或"基础"的意思。在语言的演进中，"fundamental"的含义也有所延伸，现在更多的用来表示事物最基本、最重要的部分。
...
<WordRelations synonyms={["groundlaying"]} client:only />
