---
title: House
description: House 是一个英语的名词，中文意思是'房子'或'住宅'。它通常指的是一个为居住或商业目的建造的建筑物。
sidebar:
  hidden: true
...
<Pronunciation word="House" uk="/haʊs/" us="/hʌʊs/" client:only />
...
<WordRelations synonyms={["shop"]} client:only />
