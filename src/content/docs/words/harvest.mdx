---
title: Harvest
description: Harvest 是一个名词和动词，主要有两种意思：
sidebar:
  hidden: true
...
<Pronunciation word="Harvest" uk="/ˈhaːvəst/" us="/ˈhɑɹ.vəst/" client:only />
...
"Harvest" 来自古英语 "hærfest"，意为“秋天”，因为秋天是收获的季节。其历史可以追溯到公元前 4500 年，它的词根是印欧语系的 "kerp-"，意为“收割”。
...
<WordRelations synonyms={["crop", "autumn", "fall"]} client:only />
