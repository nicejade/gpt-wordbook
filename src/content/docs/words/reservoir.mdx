---
title: "reservoir"
description: "Reservoir是一个英语名词，表示一个用于储存液体(尤其是水)的大型自然或人工湖。它也可以形象地指代一个大量储备或供应的源头。例如，reservoir of knowledge 指的是知识的丰富源泉。"
---
...
"Reservoir"这个词首先在 1690 年，被引入英语中，表示"储水池"。这个词是直接从法语单词"réservoir"借用进来的，原意是"储藏处"。
