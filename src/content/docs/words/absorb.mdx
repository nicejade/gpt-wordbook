---
title: Absorb
description: 英文单词 'absorb' 是一个动词，主要有三个意思：
sidebar:
  hidden: true
...
<Pronunciation word="Absorb" uk="/əbˈsɔːb/" us="/æbˈsɔɹb/" client:only />
...
<WordRelations
  synonyms={["assume","bear","assimilate","engulf","incorporate","overwhelm","engage","engross","immerse","monopolize","occupy","draw","imbibe","steep"]}
  antonyms={["emit"]}
  client:only
/>
