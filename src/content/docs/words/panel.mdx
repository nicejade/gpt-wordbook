...
description: >-
  Panel
  在英语中，是一个名词，一般的意思是指一个平面的、经常是矩形的部分，与其周围环境区分开来，主要用于覆盖、装饰或分隔。另外，在特定的上下文中，'panel'
  还可以表示小组讨论会中的小组成员、指示板、仪表盘等。
sidebar:
  hidden: true
...
<Pronunciation word="Panel" uk="/ˈpænəl/" us="/ˈpænəl/" client:only />
...
"Panel" 这个词在 14 世纪的英语中首次出现，原本指的是小块布，后来发展为表示各种平板的意思。
