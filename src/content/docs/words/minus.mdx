...
<Pronunciation word="Minus" uk="/ˈmaɪnəs/" us="/ˈmaɪnəs/" client:only />
...
1.  I have fifteen dollars minus the five I owe you. (我有 15 美元，减去欠你的 5 美元。 )
...
"Minus"首次出现在拉丁语中，然后进入中世纪的拉丁语并最终在 16 世纪时被英语所采用。这个词在数学中经常使用，也被用于表示气温低于零或者负面情况。
...
（“看看这个，”Bob 对 Alice 说，举起一个红苹果。“拿着这个苹果，去掉茎。你得到什么？” Alice 笑了起来，“一个没有茎的苹果。”）

<WordRelations
  synonyms={["defect","deficiency","drawback","flaw","shortcoming","negative","below","zero","lacking","without"]}
  antonyms={["advantage","bonus","boon","gain","plus","positive"]}
  client:only
/>
