---
title: Three
description: Three是一个基本的英语词汇，表示数目'3'，用于数物品或事件。
sidebar:
  hidden: true
...
<Pronunciation word="Three" uk="/θɹiː/" us="/θɹiː/" client:only />
...
Three 起源于古代英语，当时的形式是"þrīe"或"þrēo"，源自古日耳曼语中的"þrīz"，意为"三"。在许多文化中，三是一个有特殊意义的数字。例如，在基督教中，有神圣的三位一体。在中国文化中，“三”还具有吉祥的含义。
...
<WordRelations synonyms={["leash", "tether"]} client:only />
