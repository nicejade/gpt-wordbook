...
title: Weigh
description: >-
  "Weigh" 是一个动词，主要有两种基本意思： 1. 量...的重量。比如 weigh an object 就是量对象的重量。 2. 考虑，权衡。例如
  weigh the pros and cons 就是权衡优劣。
sidebar:
  hidden: true
...
"Weigh" 一词没有前后缀，为原形。不过在其由此衍生的单词中会有前后缀的添加，如 un-weigh-ed 等。
