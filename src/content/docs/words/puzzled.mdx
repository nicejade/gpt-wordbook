---
title: Puzzled
description: Puzzled 是一个形容词，基础含义为“感到困惑的”，通常用来描述一个人无法理解或弄明白某件事情的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Puzzled" uk="/ˈpʌ.zl̩d/" us="/ˈpʌ.zl̩d/" client:only />
...
"puzzle" 作为一个词在 16 世纪首次出现，用来指代一种复杂且难解的问题。形容词 "puzzled" 则在 17 世纪开始流行，用以描述人们面对难题时的表现或心情。
