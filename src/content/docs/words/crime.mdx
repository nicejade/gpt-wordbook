---
title: Crime
description: Crime 是一个名词，意为“犯罪”，指违反法律，并且可能受到法律处罚的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Crime" uk="/kɹaɪm/" us="/kɹaɪm/" client:only />
...
<WordRelations synonyms={["criminality", "delinquency"]} client:only />
