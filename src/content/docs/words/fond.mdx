---
title: Fond
description: Fond是一个形容词，常用来形容对某人或某事物的深厚的喜爱或极度的喜欢。“Fond of” 这个词组对应的中文意思是“喜欢”。
sidebar:
  hidden: true
...
<Pronunciation word="Fond" uk="/fɒnd/" us="/fɑnd/" client:only />
...
"Fond"来源于古英语 fond 或 fonned，意为'愚蠢，痴呆'，后转化为正面的情感含义，表示深厚的喜爱。
...
<WordRelations synonyms={["grope", "pet"]} client:only />
