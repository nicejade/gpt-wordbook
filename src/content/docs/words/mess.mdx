...
title: Mess
description: >-
  Mess 是一个英文单词，通常作为名词使用，表示凌乱的，混乱的东西或者情况；作为动词时，意思是弄乱，搞糟。例如：'This room is a
  mess.'（这个房间很乱。）或者 'Don't mess with him.' （不要惹他。）
sidebar:
  hidden: true
...
<Pronunciation word="Mess" uk="/mɛs/" us="/mɛs/" client:only />
