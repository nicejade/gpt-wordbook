---
title: Aim
description: Aim 是一个英语单词，作为名词时，其指的是目标，目的，或瞄准的象征；作为动词时，它指的是瞄准，设定目标。
sidebar:
  hidden: true
...
<Pronunciation word="Aim" uk="/eɪm/" us="/eɪm/" client:only />
...
"Aim" 这个词源于 14 世纪的中英文，最初是指"估计，瞄准"，来自于旧法语，随着时间的发展，"aim" 的意思发展为目标，目的，或设定目标。
...
<WordRelations
  synonyms={["aspiration","design","end","intention","mint","object","purpose","scheme","scope","tendency"]}
  client:only
/>
