...
<WordRelations
  synonyms={["colossal","enormous","gargantuan","giant","gigantic","great","huge","titanic","awesome","excellent","stupendous","super","consequential","meaningful","overwhelming","significant","weighty","bulky","heavy"]}
  antonyms={["dwarf","little","microscopic","minuscule","tiny","wee","crappy","disappointing","lame","stale","inconsequential","insignificant","piddling","trifling","trivial","unimportant","insubstantial"]}
  client:only
/>
