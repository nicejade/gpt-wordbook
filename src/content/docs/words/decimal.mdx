...
description: >-
  Decimal
  是一个英文单词，它主要用于数学领域，表示十进制的数值系统或者一种表示小数的方式。例如，计算机科学在述说关于十进制数系统的时候，会使用“decimal”这个单词。
sidebar:
  hidden: true
...
<Pronunciation word="Decimal" uk="[ˈdɛsɪməɫ]" us="/ˈdɛsɪməl/" client:only />
...
曾经有一次，10 个微小的小数点在数字世界中迷路了。它们正在试图找到回到十进制王国的路。

<WordRelations
  synonyms={["base", "denary"]}
  antonyms={["fraction"]}
  client:only
/>
