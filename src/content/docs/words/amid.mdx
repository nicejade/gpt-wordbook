...
description: >-
  这个单词 'amid' 是一个介词,
  在中文里的意思通常译为“在……中间”，“在……之间”，“在……之中”，指的是处于某个环境或状况的中心或其中。用于表示物理环境，心理状态，时间环境等多种场景。
sidebar:
  hidden: true
...
<Pronunciation word="Amid" uk="/əˈmɪd/" us="/əˈmɪd/" client:only />
...
这个单词最早出现在公元前 725 年的古英语中，此后在英语中的使用逐渐增加。由于它描述的是一个基本人类经验——在某物中间或周围，因此它在历史上的许多英文文本中都有出现。
...
<WordRelations synonyms={["among", "amongst"]} client:only />
