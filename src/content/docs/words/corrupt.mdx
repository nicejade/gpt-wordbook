...
description: >-
  Corrupt
  这个单词在英文中主要具有两种含义。一个是形容词意义，表示'腐败的，贪污的'，通常用于描述道德败坏或者是易于被贿赂的人或系统。第二种则是动词意义，表示'使腐败，使堕落'，描述某种力量或情况使一个人或物失去原有的纯洁性或功能性。
sidebar:
  hidden: true
...
<Pronunciation word="Corrupt" uk="/kəˈɹʌpt/" us="/kəˈɹʌpt/" client:only />
...
<WordRelations synonyms={["corrupted"]} client:only />
