---
title: Mushroom
description: Mushroom 是一个英语名词，意思是“蘑菇”。在定义的层级上，它也有一个更广泛的用途，可以表示任何类似的真菌。
sidebar:
  hidden: true
...
<Pronunciation word="Mushroom" uk="/ˈmʌʃˌɹuːm/" us="/ˈmʌʃˌɹuːm/" client:only />
...
"Mushroom" 在英语中早在 15 世纪就已经出现。它原本是来自法语的一个词，法语中的 "mouscheron" 是从拉丁语中的 "mushrum" 衍生出来的。
...
<WordRelations synonyms={["mushrump", "shroom"]} client:only />
