...
description: >-
  Concede
  是个动词，主要有两种含义。第一种是'承认'或'认可'，通常指承认自己在争论或挑战中失败。第二种是'允许'或'让步'，表明你接受了你原先不同意或愿意的事情。
sidebar:
  hidden: true
...
<Pronunciation word="Concede" uk="/kənˈsiːd/" us="/kənˈsiːd/" client:only />
...
"Concede"来源于拉丁语“concedere”，其中“con-”表示“完全”，“-cedere”表示“走”或“退让”，整体意思就是完全放弃或让步，这就很好的解释了 concede 的含义。
...
"Concede"这个单词首次出现在 15 世纪，来源于拉丁语“concedere”。在西方文化中，它常用在政治和法律语境中，例如一个政治家在选举中落败后会"concede defeat"。
...
<WordRelations synonyms={["capitulate", "accede"]} client:only />
