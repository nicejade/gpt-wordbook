...
description: >-
  Oath
  是一个英文名词，主要指的是“誓言”、“誓约”，特指庄重且严肃的承诺或保证。这是一个法律术语，通常在法庭上使用，表示一个人在法律面前发誓，他/她说的是真实的。
sidebar:
  hidden: true
...
<Pronunciation word="Oath" uk="/ˈəʊθ/" us="/ˈoʊθ/" client:only />
...
"Oath" 这个词源自公元前 6 世纪的古英语 "āth"，表示的是庄重的、正式的发誓或者承诺。这种庄重性使得它被广泛应用于公开的场合，比如现代的就职仪式，庭审，入籍，军队入伍等。
...
<WordRelations synonyms={["avowal", "pledge", "vow"]} client:only />
