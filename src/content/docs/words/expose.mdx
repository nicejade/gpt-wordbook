---
title: Expose
description: Expose 是一个动词，它有几种不同的含义，包括“揭示”，“暴露”，“使遭受”。具体使用哪种含义取决于上下文环境。
sidebar:
  hidden: true
...
<Pronunciation word="Expose" uk="/ɪkˈspəʊz/" us="/ɛkˈspoʊz/" client:only />
...
<WordRelations synonyms={["bare", "nake"]} client:only />
