---
title: Noun
description: noun 是英语中词性的一种，指的是名词。名词可以是实物、人、地点、事情、观念或感觉。
sidebar:
  hidden: true
...
<Pronunciation word="Noun" uk="/naʊn/" us="/naʊn/" client:only />
...
在公元前 4 世纪的亚里士多德讨论中，noun 被用来描述字母或声音的名字。它随后在中世纪拉丁文中被引用，以指明语法名词的概念。
...
<WordRelations synonyms={["name", "nameword", "substantive"]} client:only />
