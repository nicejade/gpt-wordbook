...
description: >-
  Drip
  是一个英语单词，它既可以作为动词也可以作为名词使用。作为动词时，'drip'主要有两个含义：1)液体一滴一滴地落下；2)不停地流出。作为名词时，'drip'主要指液体的一滴，或用在医学场合，指的是'滴注'。
sidebar:
  hidden: true
...
<Pronunciation word="Drip" uk="/dɹɪp/" us="/dɹɪp/" client:only />
