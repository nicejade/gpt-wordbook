---
title: Thirst
description: Thirst 作为名词，代表口渴的感觉，渴望喝水或者液体。它也有更广泛的含义，比如指对知识，权力，成功等的强烈渴望。
sidebar:
  hidden: true
...
<Pronunciation word="Thirst" uk="/θɜːst/" us="/θɝst/" client:only />
...
<WordRelations synonyms={["craving", "longing"]} client:only />
