...
title: Work
description: >-
  Work通常作为名词和动词使用。作为名词，它指的是人们为了赚取生活所必需的工作，或者指一项特定的任务、任务、项目或任务。作为动词，它有多个意思，包括执行有体力或脑力的任务，或使一件事情发生或起作用。
sidebar:
  hidden: true
...
<Pronunciation word="Work" uk="/wɜːk/" us="/wəik/" client:only />
...
约翰每天早上 6 点钟起床去工作。他是一名工程师。他热爱他的工作，因为它很有挑战性，也很有趣。
