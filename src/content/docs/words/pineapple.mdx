---
title: Pineapple
description: "- 'Pineapple' 是一种水果的名称，中文名为'菠萝'或'凤梨'。此外，'pineapple'也可以指作为一种装饰物的菠萝形状。"
sidebar:
  hidden: true
...
<Pronunciation word="Pineapple" uk="/ˈpaɪnəpəl/" us="/ˈpaɪnəpəl/" client:only />
...
<WordRelations synonyms={["ananas"]} client:only />
