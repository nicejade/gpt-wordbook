---
title: Clutch
description: 1.  作为动词，clutch 的基本意义是“紧握”，意指用手紧紧地抓住或握住某物。
sidebar:
  hidden: true
...
<Pronunciation word="Clutch" uk="/klʌt͡ʃ/" us="/klʌt͡ʃ/" client:only />
...
Clutch 在英语中的使用可以追溯到 14 世纪，起初表示动作"抓取"或"握住"，到 17 世纪时，词义延伸为"保持或控制"的含义。20 世纪初，由于汽车的广泛使用，clutch 也被用来形容车辆的离合器。
...
<WordRelations synonyms={["clasp", "grasp", "grip"]} client:only />
