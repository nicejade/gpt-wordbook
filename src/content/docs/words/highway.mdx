---
title: Highway
description: Highway 是名词，它主要表示主要或重要的公路或道路，通常是宽阔且为长途旅行和交通而构建的。
sidebar:
  hidden: true
...
<Pronunciation word="Highway" uk="/ˈhaɪweɪ/" us="/ˈhaɪweɪ/" client:only />
...
<WordRelations
  synonyms={["busbar","autobus","coach","motorbus","multibus","omnibus","hwy."]}
  client:only
/>
