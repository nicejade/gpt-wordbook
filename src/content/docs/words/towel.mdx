---
title: Towel
description: Towel 是英文中的一个名词，意为'毛巾'。它可以用来表征各种各样的毛巾，包括但不限于浴巾，面巾，和手巾。
sidebar:
  hidden: true
...
<Pronunciation word="Towel" uk="/taʊl/" us="/taʊl/" client:only />
...
"Towel"这个词在 14 世纪时来自古法语的"toaille"，之后随着英语的演变而变为现在的样子。在西方文化中，毛巾一般用于擦干身体，清洁物体等。
