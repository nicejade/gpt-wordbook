---
title: Fox
description: Fox 是英语单词，常作为名词使用。中文意思为“狐狸”。同时，'fox' 也有“狡猾的人”、“诡计多端的人”的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Fox" uk="/fɒks/" us="/fɑks/" client:only />
...
<WordRelations synonyms={["tod"]} client:only />
