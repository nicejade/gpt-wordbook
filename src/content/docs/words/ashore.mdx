...
title: Ashore
description: >-
  Ashore 这个英文单词是副词，它表示某个人或事物竖直距离从水面、海上或空中向陆地移动，例如海边或河边。一般会跟 'go', 'come' 或 'be'
  等动词连用。
sidebar:
  hidden: true
...
<Pronunciation word="Ashore" uk="/əˈʃɔː/" us="/əˈʃɔɹ/" client:only />
...
<WordRelations synonyms={["aland"]} client:only />
