---
title: Deadline
description: Deadline 是英语中非常常用的一个单词，它在大多数情况下代表的是“截止日期”或者“最后期限”，主要用来描述某项工作或任务需要在规定的时间内完成。
sidebar:
  hidden: true
...
<Pronunciation word="Deadline" uk="/ˈdɛdˌlaɪn/" us="/ˈdɛdˌlaɪn/" client:only />
