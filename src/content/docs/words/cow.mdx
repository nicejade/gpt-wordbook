...
title: Cow
description: >-
  cow 这个单词在英语中最直接的词义是“牛”，特别是指未生育过的成年母牛。它还可以用于冒犯地指称女性。此外, 'cow' 还有一个动词的意思——
  'terrorize' 或 'intimidate'，意为'吓唬'，'恐吓'。
sidebar:
  hidden: true
...
<Pronunciation word="Cow" uk="/kaʊ/" us="/kaʊ/" client:only />
...
英语单词 'cow' 的历史可以追溯到公元 600 年左右的古英语，那时的古英语单词是 'cū'。'Cū' 本身又来自早期西日耳曼语的 'kūz'，最终源于原始日耳曼词汇 'kūz'。这个词的原意就是“牛”。
...
<WordRelations
  synonyms={["bitch", "bastard", "bugger"]}
  antonyms={["bull", "heifer", "ox", "steer"]}
  client:only
/>
