---
title: Fro
description: "- 'Fro' 是个副词，用于表述来来回回或者反复不定的动作。"
sidebar:
  hidden: true
...
<Pronunciation word="Fro" uk="[fɹəʊ]" us="[fɹəʊ]" client:only />
...
- "Fro" 最早使用在 14 世纪的英语中，源自古英语。在现代英语中，我们通常使用 "to and fro" 这个短语来描述来回移动的状态。
