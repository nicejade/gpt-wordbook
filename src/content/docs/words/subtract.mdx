---
title: Subtract
description: Subtract 是一个英文动词，通常意味着'从整数或者总数中取掉某个数量'，在数学中通常被理解为减法的操作。
sidebar:
  hidden: true
...
<Pronunciation word="Subtract" uk="/səbˈtɹækt/" us="/səbˈtɹækt/" client:only />
...
<WordRelations synonyms={["unadd"]} antonyms={["add"]} client:only />
