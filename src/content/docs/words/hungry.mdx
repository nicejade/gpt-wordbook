...
description: >-
  hungry
  是一个形容词，基本含义为“饿的”，描述人或动物想吃东西的状态。它也可以形容对知识、权力、胜利等的渴望或需求，比如“他对成功有强烈的渴望”可以说“He is
  hungry for success”。
sidebar:
  hidden: true
...
<Pronunciation word="Hungry" uk="/ˈhʌŋ.ɡɹi/" us="/ˈhʌŋ.ɡɹi/" client:only />
...
<WordRelations synonyms={["famished", "peckish", "starving"]} client:only />
