...
description: >-
  Inertia
  来自于拉丁文，是一个物理学上的术语，用来描述物体保持当前运动状态或静止状态的性质。在日常英语对话中，该单词也用来描述一种抵制改变现状的倾向，或者某人或某事物的不活动、缺乏活力。
sidebar:
  hidden: true
...
<Pronunciation word="Inertia" uk="/ɪnˈɝ.ʃə/" us="/ɪnˈɝ.ʃə/" client:only />
...
<WordRelations
  synonyms={["idleness", "laziness", "sloth", "slothfulness"]}
  client:only
/>
