...
description: >-
  Illusion
  是个名词，意为'错觉'或'幻想'。它指的是一个错误的观念或感觉，尤指由于对现实的误解或幻想引起的。有时它也被用来描述一种是人误以为是真实的事物的幻影或幻想。
sidebar:
  hidden: true
...
"Illusion" 这个词在 14 世纪自拉丁语中引入英语，当时用来表示"嘲笑"或"欺骗"，由 1430s 开始逐渐发展为"错误的感知或信念"。
...
<WordRelations synonyms={["misapprehension"]} client:only />
