---
title: Viscous
description: Viscous是英文的形容词，表示“具有黏稠性，粘的”。在物理学、化学中常用于描述某种物质的粘度较大，像蜂蜜或者糖浆那样流动缓慢。
sidebar:
  hidden: true
...
<Pronunciation word="Viscous" uk="/ˈvɪs.kəs/" us="/ˈvɪs.kəs/" client:only />
...
"Viscous"源自拉丁语 "viscosus"，最早在 14 世纪的医学文献中出现，用于描述黏稠的物质或体液。
...
Viscous 的前两个字母 Vi 和粘度的英文 Viscosity 前两个字母也是 Vi，可以帮助我们联想记忆。
...
<WordRelations
  synonyms={["syrupy", "thickflowing", "viscid", "viscose"]}
  antonyms={["inviscid"]}
  client:only
/>
