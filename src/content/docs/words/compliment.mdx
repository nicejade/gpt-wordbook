---
title: Compliment
description: "Compliment 是一个英语词汇,主要意思是 '赞美'或'恭维'，可以作为名词或动词使用。"
sidebar:
  hidden: true
...
"Compliment"的词根 **-pli-** 来自拉丁词 cum（表示 "一起"）和 plei（表示 "满"）,在此词中具有 "满足" 的意思.
...
"Compliment" 这个词源于法语 compliment，意思是"称赞"，首次出现在英语中约在 17 世纪，英美文化中，“Compliment”常用于表达对他人的尊重和赞美。
...
<WordRelations antonyms={["insult"]} client:only />
