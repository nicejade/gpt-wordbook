...
title: Weaver
description: >-
  Weaver 是一个英语名词，它主要有两个含义。首先，它可以指织布工，也就是那些用织布机编织布料的人。其次，在鸟类学中，'weaver'
  可以指织巢鸟，这是一种善于编织复杂鸟巢的鸟类。
sidebar:
  hidden: true
...
<Pronunciation word="Weaver" uk="/ˈwiː.və(ɹ)/" us="/ˈwiː.və(ɹ)/" client:only />
