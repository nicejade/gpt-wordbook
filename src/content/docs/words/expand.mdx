---
title: Expand
description: Expand 在中文中的意思主要是“扩大”或“扩展”，通常指在数量、体积、规模等方面的增大。也可以指在知识、视野等抽象事物的开展或扩展。
sidebar:
  hidden: true
...
<Pronunciation word="Expand" uk="/ɛkˈspænd/" us="/ɛkˈspænd/" client:only />
...
<WordRelations
  synonyms={["spread", "unfold", "elaborate", "enlarge"]}
  antonyms={["factor", "contract"]}
  client:only
/>
