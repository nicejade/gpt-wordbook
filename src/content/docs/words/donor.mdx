---
title: Donor
description: Donor 通常用来指一个提供或赠予物品、钱财或者器官的个人或组织。
sidebar:
  hidden: true
...
<Pronunciation word="Donor" uk="/ˈdəʊnə/" us="/ˈdoʊnɚ/" client:only />
...
<WordRelations synonyms={["donater", "donator"]} client:only />
