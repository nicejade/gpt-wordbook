---
title: Transverse
description: Transverse是一个形容词，意思是垮过，横过，或者是横切。它常常用来形容某样东西在另一样东西的垮过或者横过。它也可以作为测量的单位。
sidebar:
  hidden: true
...
1.  The river has a transverse width of about 500 meters.（这条河的横向宽度大约 500 米。）
2.  The transverse section of the wood reveals its age.（横切木头的切面可以展示它的年龄。）
3.  He made a transverse cut in the paper.（他在纸上切了一道横切口。）

### 词根分析

"Transverse" 的词根是："trans-"（过）+"vers"（转）。由此衍生出的单词例如：transfer, translate 等。
...
<WordRelations antonyms={["longitudinal"]} client:only />
