---
title: Percent
description: Percent是一个英文单词，表示“百分比”或“百分数”，源自拉丁文'per centum'，意思是'每一百'。
sidebar:
  hidden: true
...
<Pronunciation word="Percent" uk="/pəˈsɛnt/" us="/pɚˈsɛnt/" client:only />
...
3.  Sixty percent of the company's profits were donated to charity. (公司的利润中有 60%被捐赠给了慈善机构。)
...
"Percent"没有特别的词缀构成。但可以拆解成 per(每个)和 cent(百)。类似构成的词汇有：percantile, percentage 等。

### 文化背景

"Percent"一词最早出现在 1758 年，最早的使用者是商人和数学家，用来计算贸易和经济问题。在当今社会，该词变得非常通用，并被广泛应用在各个领域。
