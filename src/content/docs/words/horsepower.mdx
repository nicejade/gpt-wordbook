...
title: Horsepower
description: >-
  Horsepower 是一个英文单词，用来衡量动力的单位，常用在汽车、机器等含有发动机的物品上，以描述其动力大小。它的源自 18
  世纪，当时被用来描述蒸汽机的功率。中文翻译为“马力”。
sidebar:
  hidden: true
...
"Horsepower" 是一个英文单词，用来衡量动力的单位，常用在汽车、机器等含有发动机的物品上，以描述其动力大小。它的源自 18 世纪，当时被用来描述蒸汽机的功率。中文翻译为“马力”。
...
1.  The car has 150 horsepower. （这辆车有 150 马力。）
...
"Horsepower"这个词出现在 18 世纪，由发明蒸汽机的詹姆斯·瓦特首次使用，以估计蒸汽机的功率。他发现一匹马平均可以提供 550 英尺·磅/秒的动力，于是以此为标准定义了“马力”这个单位。
...
<WordRelations synonyms={["hp"]} client:only />
