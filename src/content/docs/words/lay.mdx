---
title: Lay
description: Lay在英语中被广泛使用，其最基本的含义是“放置”或“平放”。它可以指出物理的动作，例如把书放在桌子上，也可以指出抽象的概念，例如把问题摆在面前。
sidebar:
  hidden: true
...
<Pronunciation word="Lay" uk="/leɪ/" us="/leɪ/" client:only />
...
<WordRelations synonyms={["ascribe", "attribute", "becalm"]} client:only />
