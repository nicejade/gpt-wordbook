---
title: Skull
description: Skull 是指动物或人类的头骨或颅骨。它是大脑、眼睛和耳朵等器官的保护罩。
sidebar:
  hidden: true
...
<Pronunciation word="Skull" uk="/skʌl/" us="/skʌl/" client:only />
...
<WordRelations synonyms={["brainpan", "harnpan"]} client:only />
