...
description: >-
  Accusation
  是一个名词，意为'指控'或者'控告'。它通常用于法律语境中，表示一种正式的指控或者刑事案件中的指控。例如，一个人可能因为某件行为受到指控。
sidebar:
  hidden: true
...
"Accusation" 这个词源自 14 世纪中叶的法语 accusation，其中“accuser”意为“指控”。这个词进一步源自拉丁语“accusare”，意为“对...提出控告”。
...
<WordRelations
  synonyms={["allegation","assertion","charge","impeachment"]}
  client:only
/>
