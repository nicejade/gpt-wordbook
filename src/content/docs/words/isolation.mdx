...
title: Isolation
description: >-
  Isolation 是一个名词，它的基本含义是孤立、隔离。在不同的语境中，'Isolation'
  可以拥有多重含义，包括单独、被隔离、或远离与大众的情况。在医学中，它也可以指隔离病人以防止疾病传播。
sidebar:
  hidden: true
...
Isolation 来自于词根 -late ，可表示“放，置”。其中 iso 是源自拉丁语 insula 的前缀，意思是“岛”。因此 Isolation 原意是像岛一样被放置独立，因而具有“孤立、隔离”的含义。
