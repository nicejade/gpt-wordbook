---
title: Merge
description: Merge 是动词，主要意思是“合并”，“融合”，当两个或多个不同的元素（如公司，系统，文件等）合成为一个整体时，我们通常使用这个单词。
sidebar:
  hidden: true
...
<Pronunciation word="Merge" uk="/mɜːdʒ/" us="/mɝdʒ/" client:only />
...
<WordRelations antonyms={["divide", "split"]} client:only />
