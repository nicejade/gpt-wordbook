...
description: >-
  Sedan
  是英语中的一个单词，通常指一种有四个轮子，至少包括四个座位和一个固定的硬顶的乘用车。这个词通常用来区分有固定硬顶的乘客车与其他类型的车辆，例如敞篷车或者跑车。
sidebar:
  hidden: true
...
<Pronunciation word="Sedan" uk="/səˈdæn/" us="/səˈdæn/" client:only />
...
"Sedan" 这个词最早源自 17 世纪中叶的法国，当时该词指的是一种由人搬运的轿子。随着时间的发展，它的含义逐渐演变为现在我们所知的含义，即一种有四个轮子，硬顶的汽车。
...
<WordRelations synonyms={["saloon", "litter"]} client:only />
