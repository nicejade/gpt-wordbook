---
title: Problem
description: Problem 是一个名词，意指具有挑战性的或待解决的事情。它也可以指存在困扰或疑问的情况。
sidebar:
  hidden: true
...
<Pronunciation word="Problem" uk="/ˈpɹɒbləm/" us="/ˈpɹɑbləm/" client:only />
...
"Problem" 的记载最早可追溯到 14 世纪，最初是引用希腊哲学用词，指一个待议或争论的问题或主题。
...
(一天，Bob 发现他有个问题 - 他丢了他的钱包。问题不在于丢失的金钱，而在于里面那张无法找回的珍贵照片。)

<WordRelations antonyms={["solution"]} client:only />
