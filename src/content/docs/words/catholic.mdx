...
title: Catholic
description: >-
  Catholic主要有两个意思，第一个意思是'全面的，普遍的'，通常用来形容一个观点或理念被广大人群接受或理解。第二个意思是'天主教的'。因此，根据上下文，这个词可能指的是一个广大无边的观念，或者是天主教的信仰。
sidebar:
  hidden: true
...
<WordRelations synonyms={["eclectic", "universal"]} client:only />
