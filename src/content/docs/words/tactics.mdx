...
description: >-
  Tactics
  是一个英语名词，它的意思是“战术”或“策略”。它通常用于讨论在特定的情况或问题中采取的具体方法和步骤。例如在军事、商业、游戏和体育等许多领域都能见到它的应用。
sidebar:
  hidden: true
...
Tactics 是一个英语名词，它的意思是“战术”或“策略”。它通常用于讨论在特定的情况或问题中采取的具体方法和步骤。例如在军事、商业、游戏和体育等许多领域都能见到它的应用。

<Pronunciation word="Tactics" uk="/ˈtæktɪks/" us="/ˈtæktɪks/" client:only />
...
"Tactics"这个词源于希腊语的 τακτική (taktike)，意思是“排列，分配，指挥”，这词是由 τάσσω (tasso) 演变而来的，意思是“我排列”。
...
<WordRelations
  synonyms={["maneuver", "plan", "scheme", "stratagem"]}
  client:only
/>
