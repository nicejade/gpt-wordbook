---
title: Toothpaste
description: Toothpaste 是一个英文名词，意思是“牙膏”。我们往往用它来清洁和保护我们的牙齿。
sidebar:
  hidden: true
...
Toothpaste 是一个英文名词，意思是“牙膏”。我们往往用它来清洁和保护我们的牙齿。
...
Toothpaste 没有前缀或后缀。是由两个单词组合而成的，一是 tooth（牙齿），二是 paste（软糊状的物质）。意为牙齿用的糊状物，就是我们日常用的牙膏。

### 文化背景

"Toothpaste"这个词在 19 世纪晚期开始广泛使用，当时人们开始意识到口腔卫生的重要性，并开始使用各种产品来保护牙齿。此外，在这个时候出现了第一种可挤压的金属管，这也是现代牙膏的主要包装方式。

### 单词变形

Toothpaste 是不可数名词，所以没有复数形式。
