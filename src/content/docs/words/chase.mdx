...
title: Chase
description: >-
  Chase 是一个相当常用的英语单词，主要有两种语言基本含义。作为动词时，'chase' 的含义是追逐，追赶，追求，寻找。作为名词时，'chase'
  的含义是追赶，追逐，猎捕。
sidebar:
  hidden: true
...
<Pronunciation word="Chase" uk="/tʃeɪs/" us="/tʃeɪs/" client:only />
...
<WordRelations synonyms={["game", "pursue"]} client:only />
