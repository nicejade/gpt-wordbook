---
title: Question
description: Question是一个名词，意味着一个要求回答的陈述或建议，一个询问的主题或者一个疑惑或不确定的情况。
sidebar:
  hidden: true
...
<Pronunciation word="Question" uk="/ˈkwɛstjən/" us="/ˈkwɛstjən/" client:only />
...
"Question" 这个词源自 13 世纪的中古英语，来自法语词 "question"（意为询问，疑问），该词源自拉丁语 "quaestio" ("一种索求，询问")，"Question" 这个词代表了人类对知识的追求和对理解世界的好奇心。
...
"Alex had a question about the assignment, so he approached his teacher after class for clarification."（Alex 对作业有个问题，所以他在课后找到老师寻求解答。）
这个故事虽然很短，但却描绘了一个很实际的状况，我们经常会在学习或者工作中遇到问题，然后寻找答案。

<WordRelations
  synonyms={["doubt","issue","enquiry","inquiry","interrogation","query","proposal","consideration","problem","proposition","subject","topic"]}
  client:only
/>
