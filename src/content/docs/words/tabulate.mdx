---
title: Tabulate
description: Tabulate是一个动词，意思是将数据、事物等组织成表格形式，以便于查阅和理解。其主要用在专业领域，比如数据处理、科研分析等。
sidebar:
  hidden: true
...
"Tabulate"这个单词在 18 世纪后期开始出现，取自拉丁文 "tabula" 的意思，用来表示将信息以表格形式整理。在科研、数据分析、统计等领域的使用较为广泛。
...
<WordRelations synonyms={["enroll", "recite"]} client:only />
