...
title: Normally
description: >-
  Normally 是一个副词，它通常用来描述一种平常或习惯的状态。这个词的含义包括“通常，平常，正常地”。例如，'I normally wake up at
  7 a.m.' (我通常 7 点钟起床)。
sidebar:
  hidden: true
...
"Normally" 是一个副词，它通常用来描述一种平常或习惯的状态。这个词的含义包括“通常，平常，正常地”。例如，"I normally wake up at 7 a.m." (我通常 7 点钟起床)。

### 列举例句

1.  The library is normally open until 8 p.m. （这个图书馆通常开放到晚上 8 点。）
...
"Normally" 来源于中世纪拉丁词 "normalis"，意为符合规则的，与法则相符的，起初在英文中作为数学术语使用。15 世纪时扩大了使用范围，开始包含符合规则或标准的一般含义。
...
索菲通常 6 点起床，但是今天她睡过头了，错过了校车。幸运的是，她的父亲能开车送她去学校。

<WordRelations
  synonyms={["customarily","routinely","commonly","frequently","ordinarily"]}
  client:only
/>
