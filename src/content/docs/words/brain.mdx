---
title: Brain
description: Brain 是一个名词，主要用来指人体或动物体内的大脑。除此之外，它也可以形象地指一个人的智力或者头脑。
sidebar:
  hidden: true
...
<Pronunciation word="Brain" uk="/bɹeɪn/" us="/bɹeɪn/" client:only />
...
<WordRelations synonyms={["harns"]} client:only />
