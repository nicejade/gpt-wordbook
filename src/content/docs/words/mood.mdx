---
title: Mood
description: mood 的基本词义是心情或情绪的意思，常常用来描述人的感觉或状态。比如 'I'm in a good mood today'（我今天心情很好）。
sidebar:
  hidden: true
...
<Pronunciation word="Mood" uk="/muːd/" us="/muːd/" client:only />
...
<WordRelations
  synonyms={["composure","humor","spirit","temperament","huff","pet","temper"]}
  client:only
/>
