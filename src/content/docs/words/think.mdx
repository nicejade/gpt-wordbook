---
title: Think
description: Think 是一个动词，表示“思考，想”。这个单词用在很多场合，解释不同的概念。 例如，它可以表示反复考虑一个问题或概念，也可以表示有某种观点或看法。
sidebar:
  hidden: true
...
<Pronunciation word="Think" uk="/θɪŋk/" us="/θɪŋk/" client:only />
...
<WordRelations synonyms={["guess"]} client:only />
