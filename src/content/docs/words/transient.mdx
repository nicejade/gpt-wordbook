---
title: Transient
description: Transient这个单词是形容词，描述的是短暂的，转瞬即逝的，不持久的状态。
sidebar:
  hidden: true
...
该词在 14 世纪时出现，最初用于形容"生命短暂的"，后来扩大到形容所有短暂的和瞬间的事物。
...
<WordRelations
  synonyms={["homeless","migrant","traveller","brief","ephemeral","fleeting","flighty","passing","temporary","transitory"]}
  antonyms={["inveterate", "permanent", "recurrent", "immanent"]}
  client:only
/>
