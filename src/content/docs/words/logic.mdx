---
title: Logic
description: Logic缺省的意思是'逻辑'，既包含着推理的正当性和结构的严密性。而在计算机科学中，它引申为一种符合某些特定规则的操作和思考方式。
sidebar:
  hidden: true
...
<Pronunciation word="Logic" uk="/ˈlɒdʒɪk/" us="/ˈlɑdʒɪk/" client:only />
...
"Logic"一词可以追溯到公元前 4 世纪的古希腊哲学家亚里士多德，他是西方逻辑学的创始人，开创了形式逻辑。此后，这个词被广泛用于形容推理和思考的严谨性。
