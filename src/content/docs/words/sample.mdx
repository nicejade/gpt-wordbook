---
title: Sample
description: Sample 作为名词，其主要含义是“样品”或“样本”。作为动词时，意思是“尝试”，“试验”，“取样”。
sidebar:
  hidden: true
...
<Pronunciation word="Sample" uk="/sæːm.pəl/" us="/sæːm.pəl/" client:only />
...
<WordRelations synonyms={["example", "specimen"]} client:only />
