...
title: Diet
description: >-
  Diet 是一个非常常用的英语单词，原意是指'饮食'。平时我们在谈论吃什么、吃多少的时候，就可以用到它。除此之外，'diet'
  还可以作为动词，表示'节食'或是'饮食调节'。
sidebar:
  hidden: true
...
<Pronunciation word="Diet" uk="/ˈdaɪət/" us="/ˈdaɪət/" client:only />
...
早在 14 世纪，"diet" 就已经被用来形容日常饮食，同时也指某种特殊的饮食习惯或疗养生活。
...
<WordRelations synonyms={["lite"]} client:only />
