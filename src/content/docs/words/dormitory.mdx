...
description: >-
  Dormitory
  是英语单词，用中文来表达就是“宿舍”。这个词大多数情况下是用在学校的环境，描述学生们居住的地方。也可以用在其他环境中，诸如工厂的宿舍等等。
sidebar:
  hidden: true
...
Dormitory 的词根是来自拉丁语的 "dormire" ，意为 "to sleep"（睡觉）。与此相关的词有"dormant"（休眠的）和"dormouse"（睡鼠）。
...
"Dormitory"这个词始于 14 世纪左右，来自于中古拉丁语的"dormitorium"。这个词在美国用来指代大学的住宿设施，同时在英国，"dormitory"通常用来指小学或者寄宿学校的卧室。
...
<WordRelations synonyms={["dorm"]} client:only />
