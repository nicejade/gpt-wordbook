---
title: Among
description: Among 是一个英语介词，主要表示'在...之中'或'在...中间'的意思。其使用场景多于表达某事物或个体在一群事物或个体之中的位置关系。
sidebar:
  hidden: true
...
<Pronunciation word="Among" uk="/əˈmɒŋ/" us="/əˈmɒŋ/" client:only />
...
<WordRelations synonyms={["amid", "amidst", "amongst"]} client:only />
