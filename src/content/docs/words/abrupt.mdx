---
title: Abrupt
description: abrupt 是一个形容词，主要有两个含义：
sidebar:
  hidden: true
...
<Pronunciation word="Abrupt" uk="/aˈbɹʌpt/" us="/aˈbɹʌpt/" client:only />
...
"abrupt" 大概在 16 世纪从拉丁语直接借用过来，用来描绘景观的“陡峭”和“突然”的特点，之后也扩展到了对行为与言语的描述。
...
<WordRelations
  synonyms={["broken","rough","rugged","blunt","sudden","unexpected","impolite","rude","uncivil"]}
  client:only
/>
