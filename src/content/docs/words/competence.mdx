...
title: Competence
description: >-
  Competence 是一个名词，意为'能力'或'胜任力'，用来形容某人在某个特定领域或任务中表现出的技能和能力。例如，'Her competence in
  handling difficult situations was impressive.'（她处理困难情况的能力令人印象深刻。）
sidebar:
  hidden: true
...
<Pronunciation word="Competence" uk="/ˈkɒmpətəns/" us="/ˈkɒmpətəns/" client:only />
...
（由于 Tom 擅长解决问题的能力，他被提升为经理。他的团队非常尊敬他，尊重他做出艰难决定的能力。）

<WordRelations
  synonyms={["ability","aptitude","competency","knack","nous"]}
