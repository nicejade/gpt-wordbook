---
title: Dull
description: 英文单词 'dull' 通常描述一种乏味、呆滞甚至单调的情况。它也可以用来描述锐度不足的物理对象，比如钝的刀。
sidebar:
  hidden: true
...
<Pronunciation word="Dull" uk="/dəl/" us="/dʌl/" client:only />
...
词汇 "dull" 可以追溯到古英语 "dol"，早在 14 世纪就有了无趣或乏味的意思。
