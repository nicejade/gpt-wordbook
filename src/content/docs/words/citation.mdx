---
title: "citation"
description: "“Citation” 是一个英文名词，主要有以下含义： 1. 引用：该词最常用于学术论文中，用于指作者引用其他人的研究作为自己观点的支持。 2. 表扬，嘉奖：该词在军事领域中常用，指表扬或嘉奖某人的行为或功绩。 3. 罚单，传票：这是在法律领域中的用法，指法官或警察为了某种违法行为而给予的罚单或传唤证。"
---
