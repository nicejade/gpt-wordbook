...
title: Thesis
description: >-
  英文单词 'thesis' 的主要含义是“论文，论点”。在学术上，'thesis'
  主要用来指代学位论文，如：硕士论文或博士论文。此外，“thesis”也可用于描述任何一个观点或主张，例如：He is arguing his thesis
  (他在辩论他的观点）。
sidebar:
  hidden: true
...
<Pronunciation word="Thesis" uk="/ˈθisɪs/" us="/ˈθisiz/" client:only />
...
单词 "thesis" 在 14 世纪从拉丁语 thēsis 以及古希腊语 θέσις，采用而来，原意为“一项提出的命题，一种观点，一个论点”，它来自希腊动词 θε- (the-)。“布置，安置”，这里特指"生成，创造"，泛指"做任何事情”。
