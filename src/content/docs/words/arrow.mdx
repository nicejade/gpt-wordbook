---
title: Arrow
description: Arrow 是一个英文名词，表示箭头或者箭。在日常会话中，也常常用于表示方向。
sidebar:
  hidden: true
...
<Pronunciation word="Arrow" uk="/ˈæɹ.əʊ/" us="/ˈæɹ.əʊ/" client:only />
...
<WordRelations synonyms={["arc", "streal"]} client:only />
