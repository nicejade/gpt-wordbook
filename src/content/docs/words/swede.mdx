---
title: Swede
description: Swede有两种常见的含义。一种是作为名词，指的是瑞典人(Swedish person). 另一种是作为植物名词，指的是我们通常称为蓝菜头的植物。
sidebar:
  hidden: true
...
<Pronunciation word="Swede" uk="/swiːd/" us="/swiːd/" client:only />
...
<WordRelations synonyms={["rutabaga", "neep"]} client:only />
