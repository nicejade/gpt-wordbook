---
title: "meter"
description: "Meter 是一个英文单词，它主要有两种词义： 1. 衡量、测定的仪器。例如：电表(Electricity Meter)。 2. 米（基本长度单位）。例如：一米(meter)，约等于3.281英尺。"
---
...
2.  米（基本长度单位）。例如：一米(meter)，约等于 3.281 英尺。
...
"Meter" 这个词起源于 17 世纪，先是作为测量设备使用，后与公制计量单位的推广，增加了米的含义。
