---
title: Descendant
description: 词语 'descendant' 是一个名词，代表一个人的后裔或来自某个源头或起源的东西。它是描述直接或间接血统关系的常用词汇。
sidebar:
  hidden: true
...
"Descendant" 这个单词最初源自 14 世纪的法国，当时被用来描绘人类的血统关系。现在，在英语中，它已经延伸出了更广义的含义，可以用来描述任何事物从某个起源衍生而来的情况。
...
<WordRelations
  synonyms={["afterbear", "offspring", "relative", "scion"]}
  antonyms={["ancestor", "ascendant", "forebear", "ascendent", "ascending"]}
  client:only
/>
