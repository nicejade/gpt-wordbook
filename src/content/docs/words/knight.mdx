...
description: >-
  Knight
  是英语中的一个单词，主要有两种用法：作为名词，它表示一种古代社会的封建地位，就像是中世纪的勇士或者贵族。在象棋中，'knight'也是'跳马'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Knight" uk="/naɪt/" us="/naɪt/" client:only />
...
<WordRelations synonyms={["horse"]} client:only />
