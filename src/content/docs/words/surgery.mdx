---
title: Surgery
description: Surgery 是名词，通常指的是医生进行的手术。此外，它也可以指手术室或外科诊所。
sidebar:
  hidden: true
...
<Pronunciation word="Surgery" uk="/ˈsɜːdʒəɹi/" us="/ˈsɝdʒəɹi/" client:only />
...
"手术"是个非常古老的疗法。医生用各种工具和技术修复人的身体。这个词在英语中的使用史可以追溯到 14 世纪。
...
<WordRelations synonyms={["office", "operation", "theatre"]} client:only />
