---
title: Otherwise
description: Otherwise 是一个英文副词（adverb，也可以作为连词（conjunction），含义多样，常见的有'否则'，'另外'，'在其他方面'等。
sidebar:
  hidden: true
...
<Pronunciation word="Otherwise" uk="/ˈʌð.əˌwaɪz/" us="/ˈʌð.əˌwaɪz/" client:only />
...
<WordRelations
  synonyms={["contrarily","contrastingly","elsewise","else","if","not"]}
  antonyms={["likewise"]}
  client:only
/>
