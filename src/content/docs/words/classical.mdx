...
description: >-
  classical
  是一个形容词，中文意思为“古典的”。它经常用来形容那些经过时间检验，被公认为高品质、悠久传统或高雅的艺术、音乐、文学、设计、建筑等。也可以形容古希腊和罗马的文化。
sidebar:
  hidden: true
...
<Pronunciation word="Classical" uk="/ˈklæsɪkl̩/" us="/ˈklæsɪkl̩/" client:only />
...
<WordRelations synonyms={["classic"]} client:only />
