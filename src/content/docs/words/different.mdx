---
title: Different
description: 在日常用语中，“different”表示不同的、不一样的。例如：All people are different. (所有的人都是不同的。)
sidebar:
  hidden: true
...
"different"这个词源于 14 世纪中叶的法语，源自拉丁文 "differens" 或者 "differentem"。在欧美文化中，鼓励并欣赏人们的不同之处，因为这代表着多元化和开放思想。
...
<WordRelations
  synonyms={["apart","distinct","other","aberrant","deviant","sundry"]}
  antonyms={["coherent","indistinct","unified","alike","identical","same","similar","normal","usual","homogeneous"]}
  client:only
/>
