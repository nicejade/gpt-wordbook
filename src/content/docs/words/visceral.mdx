...
title: Visceral
description: >-
  Visceral 是一个形容词，字面上的意思是'内脏的'。它用于描述与内脏器官有关的事物，尤其是肠胃。然而，在比喻的语境中，'visceral'
  常常用来形容一种强烈、原始的感情反应，这种反应是出于本能而非思考。
sidebar:
  hidden: true
...
<Pronunciation word="Visceral" uk="/ˈvɪsəɹəl/" us="/ˈvɪsəɹəl/" client:only />
...
<WordRelations synonyms={["splanchnic"]} antonyms={["cerebral"]} client:only />
