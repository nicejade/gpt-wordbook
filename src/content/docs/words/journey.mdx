---
title: Journey
description: Journey 是一个名词，表示一个人从一个地方到另一个地方的行程，也可以象征性地表示走过的生活过程或经历。
sidebar:
  hidden: true
...
<Pronunciation word="Journey" uk="/ˈd͡ʒɜːni/" us="/ˈd͡ʒɝni/" client:only />
...
<WordRelations synonyms={["wayfare"]} client:only />
