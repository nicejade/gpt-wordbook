---
title: Retain
description: Retain 是动词，主要意思是持有或保留，尤其是在面临失去的情况下。
sidebar:
  hidden: true
...
<Pronunciation word="Retain" uk="/ɹɪˈteɪn/" us="/ɹɪˈteɪn/" client:only />
...
Re- 是 "retain" 的词缀，此处表示 "again 或回，再" 的意思，-tain 是词根。
...
<WordRelations synonyms={["keep"]} client:only />
