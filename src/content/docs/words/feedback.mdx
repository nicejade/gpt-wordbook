...
<Pronunciation word="Feedback" uk="/ˈfiːdˌbæk/" us="/ˈfiːdˌbæk/" client:only />
...
- Feedback 是一个由两部分组成的合成词，“feed”（供给）和“back”（回）。所以 "feedback" 的原意是提供回去的东西，即对事物的回应或回报。
...
- "Feedback" 这个词起源于 20 世纪早期，当时被用来描述电子设备中某些功能的返回。现今，在许多领域，包括教育、商业和科技，其都被使用来描述对人或系统的响应。
...
<WordRelations
  synonyms={["howlback","howlround","assessment","critique","estimation","evaluation"]}
  client:only
/>
