...
title: Inspire
description: >-
  Inspire是一个动词，它来自于拉丁语'inspirare'，意思是'吹入'，引申为'激发'，'燃起'。所以在英语中，
  'inspire'的意思是激发某人的想法或感情，更具体的说，是提供创新的思维或行为的动机。
sidebar:
  hidden: true
...
"Inspire" 最早在 14 世纪用来描述上帝将神圣的思想植入人类思想的过程。“启发”或者"激发"的含义则在 16 世纪开始使用。
...
<WordRelations synonyms={["beghast"]} antonyms={["expire"]} client:only />
