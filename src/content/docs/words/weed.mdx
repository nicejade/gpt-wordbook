...
title: Weed
description: >-
  Weed主要有两种主要含义。在园艺领域，'weed'被用来描述一种在不希望它存在的地方生长的植物，这通常是因为它们会影响其他植物的生长，或者因为它们在视觉上对园林美感产生影响。在另一个切实可感的上下文中，'weed'被用作描述大麻的俚语。
sidebar:
  hidden: true
...
<Pronunciation word="Weed" uk="/wiːd/" us="/wiːd/" client:only />
