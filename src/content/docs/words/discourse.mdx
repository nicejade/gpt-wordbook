...
description: >-
  ...
  它可以指一次完整的讲话、对话、辩论、书面文档或者一篇文章等。另外，'discourse'还可以用来指一个领域或社区中人们交流、探讨的方式。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["communication","expression","dissertation","lecture","study","treatise","conversation","debate","discussion","talk"]}
  client:only
/>
