...
title: Prospective
description: >-
  "Prospective" 是一个形容词，源自拉丁语 "prospectus”， 意思是„看得见的”或„朝前看的”。在英语中，它主要有二个含义： 1.
  预期到的，未来的，预见的。表示可能会发生的事情或未来可能会成真的情境；例如："prospective job
  opportunities"（预期的工作机会）。 2. 可能成为…的，未来的。代表有可能成为某种状态或角色的人或事物；例如："prospective
  bride"（未婚妻）。
sidebar:
  hidden: true
...
"prospective"首次出现在 1788 年，主要用于法律术语来描述未来的或潜在的角色或责任，后来演变为一般用语。
