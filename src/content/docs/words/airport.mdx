---
title: Airport
description: "Airport 是指一个有固定设施的场所,可供飞机起飞和降落使用的地方。"
sidebar:
  hidden: true
...
<Pronunciation word="Airport" uk="/ˈɛə.pɔːt/" us="/ˈɛɹ.pɔɹt/" client:only />
...
这个词出现在 19 世纪末，那时飞机刚刚开始使用，人们开始需要一个为飞机服务的场所，所以诞生了'airport'这个词。

### 单词变形

Airport 本身就是名词,其单复数形式为 airports，用法上没有动词、形容词或副词形式。典型的固定搭配有 'international airport'（国际机场），'airport terminal'（机场航站楼）等。
