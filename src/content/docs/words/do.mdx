---
title: Do
description: do 是英文中一个非常常用的动词，主要有以下几种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Do" uk="/dʉː/" us="/du/" client:only />
...
每天，Tim 都会在晚餐前做完他的作业。他认为一天的工作应该在白天完成。

<WordRelations
  synonyms={["accomplish","functionate","attend","serve","defraud","diddle","scam","murder","off","furnish","give","supply"]}
  antonyms={["don't"]}
  client:only
/>
