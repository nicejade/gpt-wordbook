...
title: Exclusively
description: >-
  Exclusively 是一个副词，其意思为“只，仅仅，专门地”，指的是
  “完全的或者主要的”。它用于强调所有的注意力、资源或者权利都只专注于一个地方或者是一件事情。
sidebar:
  hidden: true
...
Exclusively 本身是一个副词，没有具体的名词形式、动词形式或者形容词形式。但是，它是从形容词 exclusive 变化来的，而 exclusive 又是从动词 exclude 变化来的。
...
<WordRelations synonyms={["alone", "exclusively"]} client:only />
