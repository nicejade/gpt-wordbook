---
title: Emotion
description: Emotion 是一个名词，意指的是感情或者情绪，涵盖了愤怒、快乐、恐惧、惊讶、悲伤等多种人类的心理反应。
sidebar:
  hidden: true
...
<Pronunciation word="Emotion" uk="/iˈmoʊʃən/" us="/iˈmoʊʃən/" client:only />
...
<WordRelations synonyms={["affect", "feeling"]} client:only />
