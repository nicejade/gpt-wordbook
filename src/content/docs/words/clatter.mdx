...
description: >-
  Clatter
  是一个英语单词，一般被用作动词或者名词。动词形式意为'发出嘈杂声'，描述一种由于硬物相互撞击而产生的声音。而作为名词，它指的就是这种声音本身。
sidebar:
  hidden: true
...
<Pronunciation word="Clatter" uk="/ˈklætə/" us="/ˈklætə/" client:only />
...
这个单词的使用可以追溯到 14 世纪，最初是用于描绘金属或其他硬物冲撞发出的声音。现在在英语中广泛用于描述任何乱糟糟或吵闹的声音。
...
<WordRelations synonyms={["commotion", "racket"]} client:only />
