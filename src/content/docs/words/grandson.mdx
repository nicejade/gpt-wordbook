---
title: Grandson
description: Grandson是英语中的一个名词，指的是你的儿子或者女儿的儿子，中文里我们叫'孙子'。
sidebar:
  hidden: true
...
"Grandson"这个词源自古英语的 "sunu"，它的词义逐渐减少，一般只在家庭关系中使用，比如 son, grandson 等。

### 单词变形

Grandson 的对应名词是"granddaughter"，有着相同的前缀"grand-"。

### 记忆辅助

可以通过联想或者包含词缀的其他单词来记住"grandson"。比如，"grand-" use 来表示"大的"或"重要的"，"-son"表示儿子。那么把他们放在一起就是"grandson"，非常重要的儿子，也就是我们的孙子。
...
<WordRelations
  synonyms={[]}
  antonyms={["grandfather", "grandmother"]}
  client:only
/>
