---
title: Cage
description: Cage 在英语中是一个名词，主要指的是用来困住、关押动物或者人的笼子或者围栏。它的意义带有一个具有限制性或者束缚性的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Cage" uk="/keɪdʒ/" us="/keɪdʒ/" client:only />
...
"Cage" 这个词在英语中早在 14 世纪就广泛使用了，当时有很多种类的笼子用于不同目的。
