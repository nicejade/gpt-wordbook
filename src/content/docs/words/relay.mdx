---
title: Relay
description: Relay 作为名词，通常指的是接力赛或继电器。作为动词，它有传递、转播等意思。
sidebar:
  hidden: true
...
"Relay" 不含有前缀或后缀，但 "re-" 是一个常见的重复意义前缀，例如：repeat, reapply 等。

### 文化背景

"Relay" 这个词源自法语，在 14 世纪的时候就进入了英语词汇中，表示一种在长途旅行中更换马匹的方式。
...
(Tom 渴望赢得这场接力赛。每天早晨，他都会在日出之前醒来，在凉爽的早晨天空下跑步。)

<WordRelations synonyms={["convey"]} client:only />
