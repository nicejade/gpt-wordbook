...
title: Length
description: >-
  Length 是一个名词，主要的含义是“长度”，通常用来描述物体从一端到另一端的距离。也可以引申为时间的长短，如“the length of the
  movie”。
sidebar:
  hidden: true
...
<Pronunciation word="Length" uk="/lɛn(t)θ/" us="/lɛn(t)θ/" client:only />
...
"Length" 这个单词在英语中的使用可追溯至公元前 725 年。在早期，它主要是指物理长度。随着时贤人们开始使用它来形容时间的长短。
