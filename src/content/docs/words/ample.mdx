...
title: Ample
description: >-
  Ample 这个词来自英语，意思是'足够的，充足的'。它用来形容东西丰富或者有大量，超过了正常所需的量。比如，'ample time'
  (充足的时间)，'ample food' (充足的食物)。
sidebar:
  hidden: true
...
<Pronunciation word="Ample" uk="/ˈæm.pəl/" us="/ˈæm.pəl/" client:only />
...
Ample 这个词来源于拉丁语的 "amplus"，意为"大的"或"宽广的"。
...
<WordRelations
  synonyms={["abundant","capacious","copious","extensive","full","liberal","munificent","plenteous","plentiful","rich","spacious","wide"]}
  client:only
/>
