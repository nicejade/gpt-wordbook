---
title: Outward
description: Outward 在英语中是个形容词或副词。作为形容词时，它意味着'向外的'或是'表面的'，作为副词时意味着'向外面'或'离开中心'。
sidebar:
  hidden: true
...
<Pronunciation word="Outward" uk="/ˈaʊt.wəd/" us="/ˈaʊt.wɚd/" client:only />
...
<WordRelations synonyms={["outwards"]} client:only />
