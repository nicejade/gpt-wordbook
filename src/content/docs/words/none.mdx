---
title: None
description: None 可以用作代词、形容词和副词，主要有以下几个含义：
sidebar:
  hidden: true
...
<Pronunciation word="None" uk="/nɒn/" us="/nɒn/" client:only />
...
"None"源于古英语的 "nan"，最早出现在公元 950 年左右的文献中。
...
<WordRelations antonyms={["all", "some"]} client:only />
