---
title: Drummer
description: Drummer是一个名词，来源于动词 'drum'，意思是'鼓手'，指的是打鼓的人，常见于乐队中。
sidebar:
  hidden: true
...
<Pronunciation word="Drummer" uk="/ˈdɹʌmə(ɹ)/" us="/ˈdɹʌmə(ɹ)/" client:only />
...
Drum 是最古老的敲击乐器之一，有着超过 7000 年的历史。各种文化和宗教仪式都会使用鼓，从而产生了"drummer"这个词来描述演奏鼓的人。
...
<WordRelations
  synonyms={["drummist", "percussionist", "hawker", "peddler"]}
  client:only
/>
