---
title: Digest
description: 卡通图像：一个人拿着报纸杂志在阅读，脸上洋溢着理解的喜悦。
sidebar:
  hidden: true
...
<Pronunciation word="Digest" uk="/daɪˈdʒɛst/" us="/daɪˈdʒɛst/" client:only />
...
“Digest”作为一个拉丁词根，它已经被吸收进了许多其他语言，包括英语，并在许多领域都有广泛的应用。它首次在英文文献中的出现是在 14 世纪。
...
<WordRelations synonyms={["arrange", "sort"]} client:only />
