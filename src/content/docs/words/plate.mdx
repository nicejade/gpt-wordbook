...
title: Plate
description: >-
  "Plate" 是一个非常实用的英语单词，主要有以下两个意思： 1. "Plate" 最常见的意思是“盘子”或“碟子”。例如：We ate dinner
  on paper plates. 2. 另外一个意思是指车辆的“车牌”。例如：The police officer checked the license
  plate. 还可以作为动词用，在银行或珠宝行业中，"plate" 可以意为“镀（金、银等）”。
sidebar:
  hidden: true
