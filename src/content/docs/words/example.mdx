---
title: Example
description: Example 是一个名词，表示 '例子' 或 '示例'。
sidebar:
  hidden: true
...
<Pronunciation word="Example" uk="/əɡˈzæmpl̩/" us="/əɡˈzæmpl̩/" client:only />
...
"Example" 的前缀是 "ex-"，表示 "来自，出去"。词根是 "-ample"，来源于拉丁词根 emplum。

相同前缀的单词有：exhale（呼气），export（出口）。

### 文化背景

"Example" 这个单词自 14 世纪以来一直被用来表示 "模式"、"模型"、或"惩戒性示例"。
