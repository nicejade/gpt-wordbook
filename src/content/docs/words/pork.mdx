---
title: Pork
description: Pork是英语中的一个名词，它是指猪肉。这个词通常用于表示一种食物或者烹饪的原料。
sidebar:
  hidden: true
...
<Pronunciation word="Pork" uk="/pɔːk/" us="/pɔɹk/" client:only />
...
<WordRelations synonyms={["pigmeat", "swineflesh"]} client:only />
