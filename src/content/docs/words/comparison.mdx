---
title: Comparison
description: '"Comparison"是一个名词，意为“比较，对比”。这个词通常被用于描述两个或更多的事物之间的相似性和差异性的挑选过程。'
sidebar:
  hidden: true
...
Comparison 使用了拉丁语的-compare-的词根。这个词根表达了“比较”这样一个行为。
...
"Comparison"来自中古英语"comparisoun"，有比较、对比之意。它在英语中早在 14 世纪时就已经使用，基于拉丁文的"compario"，意为"相似"或"一致"。
