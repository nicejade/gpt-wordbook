...
description: >-
  Recite
  是一个动词，意思是朗诵、背诵或者逐个列举。通常用来描述重复或者把内容说出来的行为。人们常常“背诵”（recite）诗歌，或者在学习语言时“背诵”（recite）一些句子以加强记忆。
sidebar:
  hidden: true
...
<Pronunciation word="Recite" uk="/ɹɪˈsaɪt/" us="/ɹɪˈsaɪt/" client:only />
...
照着家里的传统，玛丽在她 8 岁生日那天必须在全家人面前背诵一首诗。为了这一时刻，她日夜不停地练习。

<WordRelations synonyms={["tabulate", "declaim", "spout"]} client:only />
