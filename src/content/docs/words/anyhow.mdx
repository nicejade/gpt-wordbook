---
title: Anyhow
description: Anyhow是一个副词，它有三个主要的意思：
sidebar:
  hidden: true
...
<Pronunciation word="Anyhow" uk="/ˈæn.i.haʊ/" us="/ˈæn.i.haʊ/" client:only />
...
<WordRelations synonyms={["anyhoo", "anyway", "anywho"]} client:only />
