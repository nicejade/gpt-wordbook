---
title: Herb
description: Herb 是名词，意为“香草，草本植物”。在一些情况下也可以表示“牧草”或者“薯类食物”。 在医学领域，它也指采用的植物药材。
sidebar:
  hidden: true
...
<Pronunciation word="Herb" uk="/hɜːb/" us="/hɜːb/" client:only />
...
<WordRelations synonyms={["grass", "weed"]} client:only />
