---
title: Attitude
description: Attitude 是一个名词，表示“态度”，在具体场景中也可以用来表示“看法”或“感觉”。
sidebar:
  hidden: true
...
<Pronunciation word="Attitude" uk="/ˈætɪˌtjuːd/" us="/ˈætɪtud/" client:only />
...
<WordRelations
  synonyms={["orientation", "trim", "posture", "stance"]}
  client:only
/>
