...
description: >-
  Ego 是拉丁词 '我'
  的英语翻译，在常规用法中，它指的是一个人的我意识或自我观念，反映了他们对自己身份的认知和理解。在心理学语境中，尤其是在弗洛伊德的心理分析理论中，它代表了'合理自我'，即调节冲动（由
  'id' 控制）和社会规范（由 'superego' 控制）的一部分。
sidebar:
  hidden: true
...
<Pronunciation word="Ego" uk="/ˈiːɡəʊ/" us="/ˈiːɡəʊ/" client:only />
