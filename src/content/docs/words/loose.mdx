---
title: Loose
description: Loose是一个形容词，通常有以下几种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Loose" uk="/luːs/" us="/luːs/" client:only />
...
<WordRelations
  synonyms={["fire","shoot","free","release","loosen","relax","slacken","unbind","undo","unfasten","untie","indiscreet","untethered","diffuse","baggy","unfastened","unsecured","separate"]}
  antonyms={["fast","bind","constrain","tighten","fasten","tie","discreet","bound","leashed","tethered","tied","compact","firm","snug","tight","packaged","faithful","monogamous"]}
  client:only
/>
