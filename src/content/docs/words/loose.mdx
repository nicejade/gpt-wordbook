...
<WordRelations
  synonyms={["fire","shoot","free","release","loosen","relax","undo","untie","indiscreet","diffuse","baggy","unfastened","unsecured","separate"]}
  antonyms={["fast","bind","constrain","tighten","fasten","tie","discreet","bound","tethered","compact","firm","snug","tight","packaged","faithful","monogamous"]}
  client:only
/>
