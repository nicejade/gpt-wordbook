---
title: Eighteen
description: 英文单词 'eighteen' 是一个基本的基数词，用于表示数字十八。
sidebar:
  hidden: true
...
<Pronunciation word="Eighteen" uk="/ˈeɪ.tiːn/" us="/ˈeɪ.tiːn/" client:only />
...
Eight Eight" 是一个在诸多欧美文化中有重要含义的年龄。在许多国家，18 岁标志着成年，能够享有大部分的公民权利，如投票、驾驶等。
