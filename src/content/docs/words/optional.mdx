---
title: optional
description: Optional 这个词在英文中的意思是“可选的，非强制的”。它用在我们想表示一件事物、动作、或者决策不是必需的，而是可以自由选择的场合。
sidebar:
  hidden: true
...
2.  You have an optional dinner with the CEO tonight.（今晚你有一次可选的与 CEO 共进晚餐的机会。）
...
（周末的度假计划是可选的。Harry 选择不参加，因为他有重要的事情需要处理。他承诺下次会参加。）
