---
title: Sigh
description: sigh 是个动词，可以用来描述一个人因为感到宽慰、悲伤、痛苦、厌烦，或者其他类似的情感，而发出的长而有些重的呼吸。还可以作为名词，描述这种发出的声音。
sidebar:
  hidden: true
...
<Pronunciation word="Sigh" uk="/saɪ/" us="/saɪ/" client:only />
...
<WordRelations synonyms={["sithe"]} client:only />
