---
title: "regiment"
description: "英文单词 regiment 常在军事或者非正式社交场合下使用，它含有两个主要的词意： 1. 其军事涵义，指的是一种军队的分类单位，规模通常小于师但大于营。 2. 作为动词使用时，regiment 意指“严格管理或控制”。"
---
...
"Regiment" 这个词来源于 14 世纪的法语，意为 "政权"或"管轄权"，随后的发展使其更多的引申为军事含义，形成当前的常见用法。
