---
title: Clothing
description: clothing 是一个名词，表示“衣物，服装”的意思。具有较宽泛的含义，通常指代一般的、各种类型的服装。
sidebar:
  hidden: true
...
<Pronunciation word="Clothing" uk="/ˈkləʊðɪŋ/" us="/ˈkloʊðɪŋ/" client:only />
...
"clothing"这个词自古就有，其本意为"包裹"，最初来自于古英语的 clath，意为"布"或"披件"。在中世纪英语中，"clothe"的词形 evolve 了起来，衍生出了"clothing"这个词。
...
<WordRelations
  synonyms={["dight", "don", "apparel", "attire", "clothes"]}
  client:only
/>
