---
title: Rub
description: Rub主要有两种基本含义，一种作为名词时，表示 '摩擦'，'困难'或 '问题' 的意思。另一种作为动词时，它表示 '擦，摩擦'。
sidebar:
  hidden: true
...
<Pronunciation word="Rub" uk="/ɹʌb/" us="/ɹʌb/" client:only />
...
<WordRelations
  synonyms={["catch", "glitch", "hiccup", "hitch", "kink", "snag"]}
  client:only
/>
