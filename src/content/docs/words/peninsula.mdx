---
title: Peninsula
description: Peninsula是一个名词，指的是被水域包围，只有一部分连接陆地的土地，象半岛。在中文中，我们通常把它译为“半岛”。
sidebar:
  hidden: true
...
<Pronunciation word="Peninsula" uk="/pəˈnɪn.ʃə.lə/" us="/pəˈnɪn.sə.lə/" client:only />
...
Peninsula 是一个拉丁词，没有明显的词缀结构。

### 文化背景

词汇"peninsula"来自拉丁文 paenīnsula，由 paene（几乎）和 insula（岛）构成，字面意思是"几乎是一座岛"。随着长期的使用，"peninsula"现在具有“半岛”的含义，并广泛应用于地理和地质学的领域。

### 单词变形

Peninsula 是名词，没有变形。但可以描述它的词有词组 “peninsular”, 其中 "-ar" 是形容词后缀, 表示具有...性质的意思。比如说 ‘The peninsular region has a unique climate.’ “半岛地区有独特的气候”。
...
<WordRelations
  synonyms={["byland","cape","chersonese","headland","ness"]}
  client:only
/>
