---
title: Throw
description: Throw 是一个动词，意思是投掷，抛，扔。
sidebar:
  hidden: true
...
<Pronunciation word="Throw" uk="/θɹəʊ/" us="/θɹoʊ/" client:only />
...
<WordRelations
  synonyms={["spend","pledge","promise","vow","bowl","bung","buzz","cast","catapult","chuck","dash","direct","fire","fling","flip","heave","hurl","launch"]}
  client:only
/>
