...
description: >-
  Incompatibility
  是一个名词，主要指两者之间的不兼容或不和谐。如果两件事物或者两个人不能和谐共存，就可以被称作为'incompatibility'。比如，两款软件在同一系统下运行时发生错误，或者两个人的性格大相径庭，无法和谐相处。
sidebar:
  hidden: true
...
<Pronunciation
  ...
  uk="/ˌɪnkəmˌpætɪˈbɪlɪti/"
  us="/ˌɪnkəmˌpætɪˈbɪlɪti/"
  client:only
/>
...
"Incompatibility" 这个词从 17 世纪开始使用，主要用于描述人或物无法共存或者协调的状态。在法律或心理学中，也常用来形容人的性格差异或冲突。
...
（Sandy 和 Sam 曾经是最好的朋友，直到他们之间的不和谐性使他们的关系受到了影响。Sandy 喜欢安静，而 Sam 是个派对动物。渐渐地，他们各走各的路，把这归咎于他们的性格不协调。）

<WordRelations antonyms={["compatibility"]} client:only />
