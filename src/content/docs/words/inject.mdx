...
description: >-
  Inject
  这个词是动词，意思是'注射'，一般用在医学上。这个词也可以翻译成'注入'，指把一种事物，比如钱或能量，放入另一种事物中。这个词还可以指'嵌入'或'插入'，表示加入新的元素使某事更加有趣或有效。
sidebar:
  hidden: true
...
<Pronunciation word="Inject" uk="/ɪnˈdʒɛkt/" us="/ɪnˈdʒɛkt/" client:only />
...
"Inject"这个词在 15 世纪引入英文，原是有关"施以魔法"的意思。后来在医学上变成了"注射"的意思。
