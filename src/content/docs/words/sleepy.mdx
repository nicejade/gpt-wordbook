---
title: Sleepy
description: "Sleepy 是一个形容词，用于描述一个人感到困倦和疲劳, 需要睡觉。"
sidebar:
  hidden: true
...
<Pronunciation word="Sleepy" uk="/ˈsliːpi/" us="/ˈsliːpi/" client:only />
...
<WordRelations synonyms={["sleep", "tired"]} client:only />
