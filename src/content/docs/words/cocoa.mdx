---
title: Cocoa
description: Cocoa通常用来指代可可或者可可粉，来自于可可豆制成的口味醇厚的食品，也可以用来指代可可色。
sidebar:
  hidden: true
...
<Pronunciation word="Cocoa" uk="/ˈkəʊ.kəʊ/" us="/ˈkoʊ.koʊ/" client:only />
...
"Cocoa"这个词来自于 Nahuatl（阿兹特克语）的“cacahuatl”，意即‘可可豆’。
...
<WordRelations synonyms={["chocolate"]} client:only />
