---
title: Destroy
description: Destroy 是一个动词，意思是 '彻底破坏' 或 '消灭'。它包含了意图或行动以彻底破坏或终止某事物的存在。
sidebar:
  hidden: true
...
<Pronunciation word="Destroy" uk="/dɪˈstɹɔɪ/" us="/dɪˈstɹɔɪ/" client:only />
...
<WordRelations
  synonyms={["break","kill","ruin","waste"]}
