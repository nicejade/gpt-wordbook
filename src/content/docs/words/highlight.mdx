...
description: >-
  Highlight
  这个单词在英语中有两个基本的词义。第一，作为动词，意味着“强调，突出显示”，通常用于强调重要的信息或事实；第二，作为名词，意味着“最精彩的部分、焦点”，常用于描述活动或事件中最重要、最值得关注的部分。
sidebar:
  hidden: true
...
"Highlight" 这个单词在英语中的使用开始于 20 世纪初，最初主要用在艺术和画画中表示对某部分的明亮突出。随着时间的流逝，它的含义逐渐扩大，现在在许多领域都有使用，比如在文学、新闻报道、体育赛事等。
...
<WordRelations antonyms={["lowlight"]} client:only />
