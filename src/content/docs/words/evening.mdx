---
title: Evening
description: Evening 是英语中的一个常见单词，表示'傍晚'或'晚上'。
sidebar:
  hidden: true
...
<Pronunciation word="Evening" uk="/ˈivnɪŋ/" us="/ˈivnɪŋ/" client:only />
...
<WordRelations synonyms={["eve", "eventide", "undern"]} client:only />
