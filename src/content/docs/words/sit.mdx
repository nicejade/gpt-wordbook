---
title: Sit
description: Sit 是个具有广泛应用的动词，表示“坐”的动作，通常用于表示安静的待在椅子或者地面上。
sidebar:
  hidden: true
...
<Pronunciation word="Sit" uk="/sɪt/" us="/sɪt/" client:only />
...
<WordRelations
  synonyms={["accepted","received","welcomed","well","be","found","situated","seat"]}
  client:only
/>
