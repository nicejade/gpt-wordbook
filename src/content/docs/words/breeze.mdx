---
title: Breeze
description: Breeze是一个名词，主要有两个含义：
sidebar:
  hidden: true
...
<Pronunciation word="Breeze" uk="/bɹiːz/" us="/bɹiːz/" client:only />
...
Breeze 的词根来自于老英语的"bresen"，意思是自然风。
...
"Breeze"一词最早出现于 14 世纪，初始时表示"吹得很轻的风"。后来逐渐演变成表达"轻而易举的事情"这个含义。
...
<WordRelations
  synonyms={["cakewalk", "cinch", "doddle", "walkover"]}
  client:only
/>
