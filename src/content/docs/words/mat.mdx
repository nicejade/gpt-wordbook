---
title: Mat
description: Mat 这个词最常见的意思是“垫子”，特指用于地面上以防滑或保持清洁的一种物品。在不同的语境中，'mat'还可表示毛发或线条交织成的厚实层或网状结构。
sidebar:
  hidden: true
...
<Pronunciation word="Mat" uk="/mæt/" us="/mæt/" client:only />
...
"Mat" 词在英语中的使用报道自 1300 年左右, 它原封不动的从拉丁语的 "matta" 迁移过来, 这表明这个词在人们的日常生活中有着重要的作用。
