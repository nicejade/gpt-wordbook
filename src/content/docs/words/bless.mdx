---
title: Bless
description: Bless 是一个动词，它的基本意思是 '祝福' 或 '赐福'，经常被用在正式或者宗教的场合。但是在非正式的口语中，它的意思可以变为表达欣喜或者感谢。
sidebar:
  hidden: true
...
<Pronunciation word="Bless" uk="/blɛs/" us="/blɛs/" client:only />
...
<WordRelations antonyms={["unbless", "condemn", "curse"]} client:only />
