---
title: Beg
description: Beg 是一个英语动词，意思是恳求、乞求。它的用法主要通过口头或书面语言向别人请求某事。
sidebar:
  hidden: true
...
<Pronunciation word="Beg" uk="/bɛɡ/" us="/bɛɡ/" client:only />
...
- 现在分词："begging"
- 对应名词："beggar" （乞丐）
- 相关固定搭配："beg a favour"（求个人情），"beg to differ"（有异议）。
...
<WordRelations synonyms={["supplicate"]} client:only />
