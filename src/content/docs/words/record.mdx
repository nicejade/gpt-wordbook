---
title: Record
description: Record是一个多义词，可以做名词和动词使用。作为名词，'record'的意义主要有：记录、成绩、履历。作为动词'record'意为：记录、录制。
sidebar:
  hidden: true
...
<Pronunciation word="Record" uk="/ˈɹɛkɔːd/" us="/ˈɹɛkɚd/" client:only />
...
<WordRelations synonyms={["record", "vinyl", "log"]} client:only />
