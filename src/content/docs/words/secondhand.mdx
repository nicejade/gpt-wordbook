...
title: Secondhand
description: >-
  Secondhand 是一个形容词，主要用于两个方面：1）描述物品是经过别人使用过的，二手的。如：a secondhand
  car（二手车）。2）描述信息、观点等是不是第一手得来，间接的。如：secondhand information（间接信息）。
sidebar:
  hidden: true
...
<WordRelations synonyms={["used"]} client:only />
