---
title: bureaucracy
description: Bureaucracy 是一个英语名词，指的是一个系统，特点是一种严格遵守规定的处理方式以及一个复杂的等级制度。
sidebar:
  hidden: true
...
发展历史和文化背景：Bureaucracy 这个词在 18 世纪后半期首次出现在法语中，当时法国学者用它来形容一个由非选举官员和职业公务员组成的政府。今天，它已经有了更广泛的应用，可以描述任何大型，复杂的机构或系统。
