---
title: Agree
description: Agree 这个词在英语中是一个常用动词，它的基本含义是“同意”或“赞同”。例如， 'I agree with you'（我同意你）。
sidebar:
  hidden: true
...
<Pronunciation word="Agree" uk="/əˈɡɹi/" us="/əˈɡɹi/" client:only />
...
'Agree' 这个词汇在 14 世纪从法语借入英语，在那之前的几个世纪，它在法语中意为"please, satisfy; reconcile, make agree"。
...
<WordRelations
  synonyms={["coincide","correspond","match","resemble","bargain","deal","engage","fit","suit","concur","harmonize","accede","approve","set"]}
  antonyms={["disagree"]}
  client:only
/>
