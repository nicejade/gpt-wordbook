---
title: Uncle
description: Uncle 除了我们最熟悉的意思——朋友和堂、伯、舅、姨父——外，还可以作为一种亲切的称谓来对待年纪较大的男性。
sidebar:
  hidden: true
...
<Pronunciation word="Uncle" uk="/ˈʌŋ.kəl/" us="/ˈʌŋ.kəl/" client:only />
...
<WordRelations
  synonyms={[]}
  antonyms={["boy","nephew","niece","aunt"]}
  client:only
/>
