---
title: Longing
description: Longing 是一个名词，来自动词 'long'，表示强烈的渴望或思念。例如，非常想要回到家乡，可以说 'a longing for home'。
sidebar:
  hidden: true
...
<Pronunciation word="Longing" uk="/ˈlɒŋɪŋ/" us="/ˈlɔːŋɪŋ/" client:only />
...
<WordRelations synonyms={["ache", "yearn"]} client:only />
