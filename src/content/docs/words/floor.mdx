---
title: Floor
description: Floor主要有两个核心含义，一是作为名词，指的是'地板'，'楼层'; 二是作为动词，表示 '使某人惊讶' 或者'击倒'.
sidebar:
  hidden: true
...
<Pronunciation word="Floor" uk="/flɔː/" us="/flɔɹ/" client:only />
...
<WordRelations synonyms={["possession"]} antonyms={["ceiling"]} client:only />
