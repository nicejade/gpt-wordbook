---
title: Brief
description: Brief 最常见的含义是形容词，表示'短暂的'或'简洁的'。在法律领域，'brief' 还有'案情摘要'的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Brief" uk="/bɹiːf/" us="/bɹiːf/" client:only />
...
"Brief "从中古英语 bref, breif 演变而来，原意为"短暂的"，后转化为"案情简述"的意思。
...
"Brief "最初源于拉丁词"brevis"，寓意短暂或速率。14 世纪，该词被引入英语，最初用于描述时间和语言的短暂之意。到了 16 世纪，以"简要摘要或概述"的意思使用。
