...
title: Running
description: >-
  Running 是英语中的一个单词，主要用作动词的现在分词和形容词。作为动词，它是 'run'
  的现在分词形式，表示“奔跑”、“运行”的动作；作为形容词，它表示“连续的”、“正在进行中的”。
sidebar:
  hidden: true
...
<Pronunciation word="Running" uk="/ˈɹʌnɪŋ/" us="/ˈɹʌnɪŋ/" client:only />
...
<WordRelations synonyms={["runny"]} client:only />
