---
title: Refuse
description: Refuse 是一个动词，表示 '拒绝' 或 '不接受' 。这个词强调了对某事或某人的疏远，并且这种疏远是由一个决定引起的。
sidebar:
  hidden: true
...
<Pronunciation word="Refuse" uk="/ˈɹɛfjuːs/" us="/ˈɹɛfjuːs/" client:only />
...
"Refuse"起源于 14 世纪的法国，原意为倾倒。随着时间的推移，它的意思逐渐演变为否定。
...
<WordRelations
  synonyms={["garbage","rubbish","trash"]}
  client:only
/>
