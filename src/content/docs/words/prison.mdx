---
title: Prison
description: Prison 是一个名词，指的是一个被用来关押囚犯的设施，可以译为“监狱”。
sidebar:
  hidden: true
...
<Pronunciation word="Prison" uk="/ˈpɹɪzən/" us="/ˈpɹɪzən/" client:only />
...
<WordRelations synonyms={["bridewell", "imprisonment"]} client:only />
