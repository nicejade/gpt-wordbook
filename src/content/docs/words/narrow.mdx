---
title: Narrow
description: Narrow 是一个形容词，主要意思是“狭窄的”，也可以用来表示“有限的”，“仅仅的”，还有“精细的”，“详细的”之意。当其作为动词时，意思是“变窄”。
sidebar:
  hidden: true
...
<Pronunciation word="Narrow" uk="/ˈnæɹəʊ/" us="/ˈnæɹoʊ/" client:only />
...
"Narrow" 首次记录使用是在西元前 725 年。在欧美文化中，“narrow-minded”（狭隘的）是一种贬义词，指思维狭隘，看事情角度单一的人。
...
<WordRelations antonyms={["broad", "wide"]} client:only />
