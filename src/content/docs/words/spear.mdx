---
title: Spear
description: Spear作为名词，是'矛、枪'的意思，是一种原始的远古武器，一端尖锐，用来刺或投掷。作为动词，它的意思是'用矛刺'。
sidebar:
  hidden: true
...
<Pronunciation word="Spear" uk="/spɪɹ/" us="/spɪɹ/" client:only />
...
"Spear"这个词源于古英语，早在公元前 4000 年，人们就已经开始使用矛这种武器了。在欧洲，梦幻般的骑士和士兵通常都会携带长矛。
...
<WordRelations antonyms={["distaff"]} client:only />
