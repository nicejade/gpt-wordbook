...
title: Supplement
description: >-
  Supplement 英 [ˈsʌplɪmənt] 美 [ˈsʌplɪmənt]
  是一个英语单词，作为名词时，其主要意思是'补充'，'添加'，或者'辅助物'。当它作为动词使用时，'supplement' 的主要意义是'增补'，'补充'。
sidebar:
  hidden: true
...
<Pronunciation word="Supplement" uk="/ˈsʌpləmənt/" us="/ˈsʌpləmənt/" client:only />
...
Supplement 来自拉丁词根“supple”，意思是“以……填满”或“完全”。它后面的词缀“-ment”表示“行为或结果”。

### 词缀分析

Supplement 中没有前缀，“-ment”是后缀，表示把动词变成名词，相当于中文里的"行为或结果"。其他使用这个后缀的单词有 "engagement"、"establishment"等。

### 文化背景

Supplement 词源于 14 世纪的中法语“supplement”，意为"额外的东西"。最初是拉丁语“supplementum”，其意为"完成，填满"，源于“sub”(在......之下）与“pleō”(充满）的组合。
