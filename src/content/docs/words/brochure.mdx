---
title: Brochure
description: Brochure是一个名词，用来指代一种小册子，通常包含有关产品、服务、活动或者可能感兴趣的信息。公司、学校或者非盈利机构经常用其来进行推广和宣传。
sidebar:
  hidden: true
...
<Pronunciation word="Brochure" uk="/ˈbɹəʊ.ʃə(ɹ)/" us="/bɹoʊˈʃɝ/" client:only />
...
"Brochure"来源于法语，并在 18 世纪时传入英语。这个单词源自于法语动词"brocher"，意为“钉，缝”，用以形容小册子的制作方式。
