...
title: Spice
description: >-
  Spice源自中世纪的拉丁词'species',这是借用自拉丁语的'species'，意思是'看起来或感觉好的东西'。如今，“spice”主要用于指调料或香料，它们通常用于改善或增强食物的味道,
  也可以用来表示增加乐趣和兴奋。
sidebar:
  hidden: true
...
<Pronunciation word="Spice" uk="/spaɪs/" us="/spaɪs/" client:only />
...
“Spice”是一种单词，没有前缀和后缀。但我们可以基于它创建一些派生词，例如 spiceless（没有香料的），spiceful（充满香料的）。
...
有一个叫 Nina 的女孩，她热爱烹饪。有一天，她发现了“香料”的魔力。从那时起，她做的每一道菜都被各种香料丰富了起来，变得美味而独特。小小的厨房变成了她的魔法地，充满了味道和色彩。
