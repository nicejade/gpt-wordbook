...
<WordRelations
  synonyms={["delay","hinder","retard","careful","deliberate","prudent","boring","dull","inactive","slothful","sluggish","tardy","quiet","gradual","moderate"]}
  antonyms={["hasty","precipitate","prompt","accurate","fast","brisk","lively","abrupt","sudden","keen","quick","rapid","swift"]}
  client:only
/>
