...
title: Contempt
description: >-
  Contempt 是一种辱骂性的、嘲笑性的、厌恶性的负面情绪或行为状态，主要指瞧不起或轻视别人。在法律上，'contempt of court'
  表示'藐视法庭'，是指对法庭的命令、规定或法官的行为持不尊重的态度。
sidebar:
  hidden: true
...
<Pronunciation word="Contempt" uk="/kənˈtɛmpt/" us="/kənˈtɛmpt/" client:only />
...
Contempt 这个词的使用最早可以追溯到公元 14 世纪，最初来源于拉丁语的"contemptus"，在法律环境中经常使用，特别是"藐视法庭"的情况，对个体的表达瞧不起或不尊重法律或法庭裁决。
