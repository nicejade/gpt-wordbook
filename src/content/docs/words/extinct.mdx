...
<Pronunciation word="Extinct" uk="/ɛkˈstɪŋkt/" us="/ɛkˈstɪŋkt/" client:only />
...
发展历史和文化背景：该词最早出现在中世纪拉丁文中，用来形容一个家族或血统的断绝。到了 16 世纪，在生物学文本中，它开始被用作“物种灭绝”的概念。
...
<WordRelations
  synonyms={["dead"]}
  antonyms={["extant", "burning", "active", "dormant"]}
  client:only
/>
