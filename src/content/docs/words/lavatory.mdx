---
title: Lavatory
description: Lavatory是英语中的一种比较正式的说法，它指的是厕所或卫生间，用于公共场所或正式场合。
sidebar:
  hidden: true
...
Lavatory 的源自于拉丁语"lavare"，原意为"洗涤"。在我 19 世纪开始，它开始用于表示"洗手间"或"厕所"。这是因为在那个时代，人们在厕所的地方也完成了清洁的任务。

### 单词变形

Lavatory 作为名词，没有特殊的变形。

### 记忆辅助

你可以将"lava"和"tory"这两个单词联合起来帮助记忆，想象在火山熔岩（lava）喷发后，人们需要洗涤（tory 象征清洁）以保持清洁。
...
<WordRelations synonyms={["washbasin", "sink"]} client:only />
