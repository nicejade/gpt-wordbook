---
title: Destination
description: '"Destination"是一个英文名词，用来表示“目的地，终点”等概念。可以指的是你打算旅行或要去的特定地点，同样适用于邮件或包裹所寄送的地点。'
sidebar:
  hidden: true
...
"Destination"最早出现在 14 世纪的拉丁文中，意为"目的、目标"。在英语发展过程中标志着一种目标或结束点的概念，尤其在旅行和运输中常用。
