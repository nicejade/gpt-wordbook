...
title: Autumn
description: >-
  Autumn 是一个英语名词，表示一年中的一个季节，紧跟在夏季之后，又被称为'fall'。在北半球，autumn 一般包含 9 月，10 月和 11
  月。这个季节的特点是叶子变色并落下，引入了冬季。
sidebar:
  hidden: true
...
"Autumn" 是一个英语名词，表示一年中的一个季节，紧跟在夏季之后，又被称为"fall"。在北半球，autumn 一般包含 9 月，10 月和 11 月。这个季节的特点是叶子变色并落下，引入了冬季。

<Pronunciation word="Autumn" uk="/ˈɔːtəm/" us="/ˈɔtəm/" client:only />
...
"Autumn" 可追溯到公元前 12 世纪的英语优美诗歌中。在美国，秋天常常和 Thanksgiving（感恩节，一个庆祝收获的节日）联系在一起。
...
<WordRelations synonyms={["fall", "harvest", "decline"]} client:only />
