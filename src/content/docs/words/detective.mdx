---
title: Detective
description: Detective 是一个名词，意思是“侦探”，特指那些专门从事侦查、追踪犯罪或侦破案件的人。例：private detective（私家侦探）。
sidebar:
  hidden: true
...
<Pronunciation word="Detective" uk="/dɪˈtɛktɪv/" us="/dɪˈtɛktɪv/" client:only />
...
"Detective" 这个单词与侦探类小说的发展历史紧密相关。从 19 世纪开始，侦探小说在西方文学中占据了重要地位。诸如阿尔弗雷德·希区库克和阿加莎·克里斯蒂等著名作家，通过他们的作品，使得这个词汇在文化中得到了广泛传播，并影响了我们对侦探角色的理解和想象。
...
<WordRelations synonyms={["DT", "Det", "dick", "sleuth"]} client:only />
