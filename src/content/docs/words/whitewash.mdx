...
description: >-
  Whitewash
  是一个动词，也可以作为名词使用。作为动词时，它有两个主要含义。第一个意思是给...刷一层白漆。第二个含义是在众人面前粉饰真相，掩盖真实情况。当'whitewash'作为名词时，它的意思也类似，是指一层白色涂料，或者掩盖真相的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Whitewash" uk="/ˈwaɪtwɒʃ/" us="/ˈwaɪtwɒʃ/" client:only />
...
<WordRelations antonyms={["blackwash"]} client:only />
