---
title: Worsen
description: worsen 是一个动词，意为“变得更糟；加重；恶化”。
sidebar:
  hidden: true
...
<Pronunciation word="Worsen" uk="/ˈwɜː(r)sən/" us="/ˈwɜː(r)sən/" client:only />
...
<WordRelations
  synonyms={["decline","deteriorate","better","defeat","aggravate"]}
  antonyms={["improve"]}
  client:only
/>
