---
title: Tightly
description: "- 'Tightly' 是一个副词，表示紧紧地、牢牢地，这里的'紧'可以表示空间上的紧密接合，也可以表示程度上的高度强调。"
sidebar:
  hidden: true
...
<Pronunciation word="Tightly" uk="/ˈtaɪtli/" us="/ˈtaɪtli/" client:only />
...
- "Tightly" 形成于 14 世纪，最初的使用是描述事物间紧密无间的连接，例如紧密缠绕的线团。现在的用法还增加了表达强烈的程度，如"tightly controlled"，表示严密控制。
