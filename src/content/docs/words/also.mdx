...
title: Also
description: >-
  also 是一个副词，用于列举事物时在另一项前面表示“并且，而且”。例如：“I like tea, also I like
  coffee.”（我喜欢茶，我也喜欢咖啡）。
sidebar:
  hidden: true
...
“also” 是一个副词，用于列举事物时在另一项前面表示“并且，而且”。例如：“I like tea, also I like coffee.”（我喜欢茶，我也喜欢咖啡）。

<Pronunciation word="Also" uk="/ˈɔːl.səʊ/" us="/ˈɔl.soʊ/" client:only />
...
<WordRelations synonyms={["eke", "too"]} client:only />
