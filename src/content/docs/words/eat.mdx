---
title: Eat
description: '- ''Eat'' 是一个动词，表示“吃”或“食用”的行为。'
sidebar:
  hidden: true
...
<Pronunciation word="Eat" uk="/iːt/" us="/it/" client:only />

### 列举例句

- "I usually eat breakfast at 7 a.m"（我通常在早晨 7 点吃早餐）
...
<WordRelations
  synonyms={["bother","disturb","worry","consume","swallow","breakfast","dine","dinner","lunch","supper","tea"]}
  client:only
/>
