---
title: Hooray
description: hooray 是一个英语口语中常用的欢呼词，意为 “万岁”、“好哇”或者“太好了”。常用于表示兴奋、快乐、赞赏或成功的情绪。
sidebar:
  hidden: true
...
<Pronunciation word="Hooray" uk="/həˈɹeɪ/" us="/həˈɹeɪ/" client:only />
...
<WordRelations synonyms={["hurrah"]} client:only />
