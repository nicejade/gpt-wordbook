---
title: Smash
description: Smash 在英文中主要有两个含义，一个是动词，表示“打碎”或“破坏”，另一个是名词，表示“破裂声”或“重击”。这个词常用于形象地描述强力击打或撞击的场景。
sidebar:
  hidden: true
...
<Pronunciation word="Smash" uk="/smæʃ/" us="/smæʃ/" client:only />
...
<WordRelations
  synonyms={["crash","shatter","dash","slaughter","trounce","coitize","pound","thump","wallop"]}
  client:only
/>
