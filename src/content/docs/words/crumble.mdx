...
title: Crumble
description: >-
  Crumble是一个英语动词，通常用来描述把一件事物分解、瓦解成小块或碎片。它也可以作为名词，表示瓦解后的碎片或残骸。除此之外，'Crumble'还可以用来描述事物、组织系统或者人的状态在压力下瓦解、崩溃。
sidebar:
  hidden: true
...
<Pronunciation word="Crumble" uk="/ˈkɹʌmbəl/" us="/ˈkɹʌmbəl/" client:only />
...
Crumble 作为英语词汇的历史可以追溯到中世纪时的英格兰，最初用于描述物体分解成小块的过程。随着时间的推移，这个词的含义逐渐扩大，也用来形容事物、组织或人在压力或困难面前的瓦解、崩溃。

### 单词变形

Crumble 作为动词，其第三人称单数形式为 crumbles，过去式和过去分词形式均为 crumbled。名词形式为 crumble。

### 记忆辅助

可以将 crumble 与 crumb(面包屑)和-ble(表示动作的词缀)分开记忆，crumb（面包屑）+ble ，就是把 something 弄成面包屑，也就是让它分解碎裂，易于记忆。
...
<WordRelations synonyms={["crisp", "crunch"]} client:only />
