---
title: Tease
description: Tease 是一个动词，主要含义为戏弄，取笑，挑逗或烦扰。同时在一些特定语境下，'tease' 还有'拨开，撕开'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Tease" uk="/tiːz/" us="/tiːz/" client:only />
...
你可以想象一个儿童的场景："T"是一个小男孩，"ease"则是他的意思就是“轻松”。故事是男孩 T 总是用一种轻松的方式戏弄他的妹妹，这样你就记住"tease"意味着以一个轻松、玩笑的方式去戏弄或挑逗别人了。
...
<WordRelations
  synonyms={["cocktease", "cockteaser", "prickteaser"]}
  client:only
/>
