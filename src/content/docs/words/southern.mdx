...
description: >-
  Southern
  是个形容词，用来描述南方的或者和南方相关的人、地方或事物。此外，'Southern'也可以作为专有名词，指的是美国南方。这个词通常用来强调与北方的对比特性。
sidebar:
  hidden: true
...
<Pronunciation word="Southern" uk="/ˈsʌðɚn/" us="/ˈsʌðɚn/" client:only />
...
<WordRelations
  synonyms={["Southron", "austral", "meridional", "southerly", "southron"]}
  antonyms={[
    "Northerner",
    "Yankee",
    "boreal",
