...
description: >-
  Conversion
  这个单词在英文中的意思是“转变”，“改变”或者“转化”，具体表现在事物的性质、信仰、美元汇率等因素的改变，或者在生态学中表现为能量的改变。
sidebar:
  hidden: true
...
<Pronunciation word="Conversion" uk="/-ʒ(ə)n/" us="/kənˈvɝʒən/" client:only />
...
<WordRelations antonyms={["deconversion"]} client:only />
