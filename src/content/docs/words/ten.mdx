---
title: Ten
description: Ten 是一个基本的阿拉伯数字，用于表示数量，通常写成数字 '10'。它也可以用于描述十个单元或元素的集合。
sidebar:
  hidden: true
...
<Pronunciation word="Ten" uk="/tɛn/" us="/tɛn/" client:only />
...
"Ten" 属于古英语，其原始形态出自印欧语系，后来进化成现在我们所用的 "ten"。在西方文化中，10 用于代表完美评分的上限，在诸如滑冰或舞蹈等奥运比赛中，评分为 "10" 意味着表演非常完美。
...
<WordRelations synonyms={["tenner", "X"]} client:only />
