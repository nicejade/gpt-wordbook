---
title: Self
description: Self 是一个非常常见的英文单词，它是一个名词、代词或前缀，主要表示'自己'、'自我' 或 '本身'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Self" uk="/sɛlf/" us="/sɛlf/" client:only />
...
<WordRelations antonyms={["nonself", "outcross"]} client:only />
