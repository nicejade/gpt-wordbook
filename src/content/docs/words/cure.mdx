---
title: Cure
description: Cure主要有两个含义，一是作为动词，表示'治愈'或'解决'，二是作为名词，表示'治疗方法'或'解决方案'。
sidebar:
  hidden: true
...
<Pronunciation word="Cure" uk="/kɜː(ɹ)/" us="/kjɝ/" client:only />
...
<WordRelations synonyms={["curacy"]} client:only />
