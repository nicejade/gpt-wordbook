...
title: Inspector
description: >-
  Inspector是一个名词，意为“检察官，视察员，督察员”。这个词常用在一些具体职位的称谓中，如'police
  inspector“（警察督察）或'health inspector“（卫生督察）。
sidebar:
  hidden: true
...
<Pronunciation word="Inspector" uk="/ɪnˈspɛktə/" us="/ɪnˈspɛktɚ/" client:only />
