---
title: Carbon
description: Carbon 是一个科学名词，它是英文表达化学元素“碳”的单词。碳是所有生命形式的基础元素，也被广泛应用于各种生产与制造过程中。
sidebar:
  hidden: true
...
<Pronunciation word="Carbon" uk="/ˈkɑɹbən/" us="/ˈkɑɹbən/" client:only />
...
<WordRelations synonyms={["cc"]} client:only />
