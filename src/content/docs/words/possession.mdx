...
title: Possession
description: >-
  Posession 是一个名词，它的基本含义是“占有”, '拥有'。它可以指自身的财产（如 “personal
  possession”，个人财产），也可以是概念性的占有，如占有主权 (“sovereign possession”)。
sidebar:
  hidden: true
...
<Pronunciation word="Possession" uk="/pəˈzɛʃən/" us="/pəˈzɛʃən/" client:only />
...
"possession"在 13 世纪由法语引进英语，表示“拥有”, "占有"。在英美文化中，"possession" 常被用于法律用语，如 "illegal possession"（非法占有）。
...
<WordRelations
  synonyms={["owndom", "retention", "ight"]}
  antonyms={["absence"]}
  client:only
/>
