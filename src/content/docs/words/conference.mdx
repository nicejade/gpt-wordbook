---
title: Conference
description: Conference 是一个英语名词，通常用来表示“会议”，特指一群人聚在一起讨论某个特定主题或进行业务洽谈。
sidebar:
  hidden: true
...
Conference 这个词在 14 世纪的法语中首先出现，最初只是表示“讨论”。在 16 世纪，它的用途扩展到了“正式会议”。此词常用于描述企业或组织为了讨论特定主题，解决问题而聚集在一起的正式聚会。
...
可以记住 "con-" 和"fer"的连续发音，可以帮助记忆。也可以联想到 ferry（渡船），“会议”就像是载着所有与会者的思想的船。
...
面对关于新产品的各种意见，CEO 召开了一场会议。令人惊讶的是，会议室变成了一个头脑风暴，为他们的未来进步带来了有益的想法。
