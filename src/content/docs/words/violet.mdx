---
title: Violet
description: Violet 通常有两个基本含义：一是颜色，紫罗兰色，是一种接近于紫色的颜色；二是花卉，即紫罗兰，是一种常见的花卉名称。
sidebar:
  hidden: true
...
<Pronunciation word="Violet" uk="/ˈvaɪlət/" us="/ˈvaɪlət/" client:only />
...
<WordRelations synonyms={["violet", "rooster"]} client:only />
