---
title: Photo
description: Photo 是源自希腊语的英语单词，通常被用作名词，意为照片。可能指的是来自任何来源的图像，如相机、手机等设备。
sidebar:
  hidden: true
...
<Pronunciation word="Photo" uk="/ˈfəʊ.təʊ/" us="/ˈfoʊ.toʊ/" client:only />
...
'Photo'这个词的出现可以追溯到 19 世纪，当时的摄影术的发展让人们可以通过照片来记录和分享他们的生活。它在英语中是一个非常常用的单词，无论在书面语还是口语中。
