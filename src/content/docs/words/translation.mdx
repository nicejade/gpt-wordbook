...
title: Translation
description: >-
  Translation 是一个名词，来源于拉丁语
  'translatio'，意为运输或榨汁。在英语中，它最常用来指的是一个语言的内容被转化或解释为另一种语言。
sidebar:
  hidden: true
...
"Translation" 这个词最初出现在英语中的时间大约在 14 世纪，这是在中世纪後期，拉丁语到英语的翻译开始变得常见，并产生了需要专门解释这个过程的词汇。由于英语是全球最广泛使用的语言之一，"translation"已经成为全球交流和文化交融的重要工具。
