---
title: Sauce
description: Sauce是一个英文单词，表示“酱汁”。这是一种通常用于为食物增添风味的液体，半固体或混合物。包括番茄酱、奶油酱、烧烤酱等。
sidebar:
  hidden: true
...
<Pronunciation word="Sauce" uk="/sɔːs/" us="/sɑs/" client:only />
...
"Sauce"源自 14 世纪的旧法语"sauce"，它来自拉丁语"salsa"，意思是“盐渍”，来自"salsus"，意为 "盐渍"。
...
<WordRelations synonyms={["sowl", "wellspring"]} client:only />
