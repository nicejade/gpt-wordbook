---
title: Workman
description: Workman是一个英语名词，它通常指的是从事体力劳动或手工艺制作的人，比如说一个工人或者工匠。 这个词通常用于描述那些专注熟练手艺的人。
sidebar:
  hidden: true
...
<Pronunciation word="Workman" uk="/ˈwɜːkmən/" us="/ˈwɜːkmən/" client:only />
...
"Workman"这个词在英语中的使用可以追溯到 14 世纪，它发源于中古英语的"wyrkman"。
