---
title: Urgent
description: Urgent 是一个形容词，用于描述需立即处理的事情或要求迅速采取行动的情况。具有紧迫性、急迫性。另外，它也可以用来强调某事很重要，不能延迟。
sidebar:
  hidden: true
...
<Pronunciation word="Urgent" uk="/ˈɜːdʒənt/" us="/ˈɚdʒənt/" client:only />
...
<WordRelations synonyms={["needly", "pressing"]} client:only />
