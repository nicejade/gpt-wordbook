---
title: Filter
description: Filter 这个单词在英文中主要有两个基本含义，一个是作为名词，表示'过滤器'或者'筛子'；另一个是作为动词，表示'过滤'或者'筛选'。
sidebar:
  hidden: true
...
<Pronunciation word="Filter" uk="/ˈfɪltə/" us="/ˈfɪltɚ/" client:only />
...
"Filter"这个词在 16 世纪的时候被引入英语中，并且在 18 世纪的时候开始发展出"过滤"的动词含义。
...
<WordRelations antonyms={["ideal"]} client:only />
