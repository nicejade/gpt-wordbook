---
title: Kindle
description: Kindle 作为动词，意为“点燃”，“激发”，“激起”。这个词旨在描述点亮或引发一些东西，如火焰或兴趣。
sidebar:
  hidden: true
...
<Pronunciation word="Kindle" uk="/ˈkɪndl/" us="/ˈkɪndl/" client:only />
...
<WordRelations
  synonyms={["arouse", "inspire", "ignite"]}
  antonyms={["dampen", "douse", "extinguish"]}
  client:only
/>
