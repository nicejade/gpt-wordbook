---
title: Conclude
description: '"Conclude" 是一个英语动词，有“结束”、“总结”、“推断出”等含义，常用于表示一项事务或事件的结束，或者指出一项论据或处理的结束。'
sidebar:
  hidden: true
...
"Conclude" 来源于拉丁语 "concludere" ，意为“封锁”、“关闭”、“结束”。它的使用从 14 世纪开始，主要用于法律语境中标志手续或论据的终止，后来演变成现在的常规含义——结束。
