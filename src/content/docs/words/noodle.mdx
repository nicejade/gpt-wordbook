...
title: Noodle
description: >-
  Noodle一词通常被用作名词，它的意思是“面条”，是各种亚洲菜肴的主要成分，尤其是在中国和日本。
  然而，在美语中，这个词也可以用来形容一个人的头脑，一种口语化的使用方法。
sidebar:
  hidden: true
...
<Pronunciation word="Noodle" uk="/nuːdl̩/" us="/nuːdl̩/" client:only />
...
"Noodle"一词在 18 世纪的英语中起源于德语"Nudel"。随着国际交流的增加，面条成为全球公认的食品，并进入了英语词汇中。
...
<WordRelations synonyms={["guddle"]} client:only />
