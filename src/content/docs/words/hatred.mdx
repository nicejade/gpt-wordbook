---
title: Hatred
description: Hatred是一个英语单词，意指强烈的厌恶或憎恨。
sidebar:
  hidden: true
...
<Pronunciation word="Hatred" uk="/ˈheɪtɹɪd/" us="/ˈheɪtɹɪd/" client:only />
...
"Hatred"是从古英语"hate"发展而来的，它的历史可以追溯到公元前 1200 年的日耳曼语系。
...
<WordRelations
  synonyms={["antipathy", "hate", "hostility"]}
  antonyms={["amity", "love"]}
  client:only
/>
