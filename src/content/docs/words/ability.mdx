---
title: Ability
description: Ability 是一个英语名词，主要指个体的能力、才能或技能，无论是自然天赋的，还是后天通过学习和努力获得的。
sidebar:
  hidden: true
...
"Ability" 这个单词起源于 14 世纪，借自古法语 "abeleté"，源自拉丁语"habilitatem"，原意指“适宜、方便”。
...
<WordRelations
  synonyms={["aptitude","cleverness","dexterity","talent","capability","capacity","faculty"]}
  antonyms={["disability","inability"]}
  client:only
/>
