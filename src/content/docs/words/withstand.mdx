---
title: Withstand
description: Withstand 是一种动词，意思是“抵挡”或“忍受”。当用在某人对抗困难，压力，批评等形式的攻击时，它特别有用。直接中文翻译是“承受；经受；对抗”。
sidebar:
  hidden: true
...
<Pronunciation word="Withstand" uk="/wɪðˈstænd/" us="/wɪðˈstænd/" client:only />
...
- stand 来自古英语 standan，意思是 "站立，位于，存在，持续，停留。

### 词缀分析

"Withstand"本身没有明显的词缀，但是我们可以从 stand 这个词根找到一些相关的词。例如：Understand（理解）、Standstill（静止）、Standoff(对峙或僵持).

### 文化背景

"Withstand" 起源于 10 世纪早期的古英语 "wiðstandan"，历来都有“反对；对抗”等含义。在抗争或忍受困难等语境下最为常见。
