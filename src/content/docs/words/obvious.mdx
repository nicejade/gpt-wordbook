---
title: Obvious
description: Obvious是一个英语形容词，意思是“明显的”，“易见的”，通常用来描述不需要深度思考或者额外证明就可以立即察觉、理解或者认定的事物或情况。
sidebar:
  hidden: true
...
<Pronunciation word="Obvious" uk="/ˈɒ.vɪəs/" us="/ˈɑ.vi.əs/" client:only />
...
"Obvious"出现在 14 世纪的拉丁语文献中，形容那些立刻可以见到的事物。这个词在欧美语境中经常用来形容那些不需要额外证明的事实或证据。
...
<WordRelations antonyms={["subtle", "unobvious"]} client:only />
