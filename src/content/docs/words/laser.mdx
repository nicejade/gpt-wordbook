...
title: Laser
description: >-
  Laser 是一种能发出高度集中，单色并且相干的光的设备，它的全名是“Light Amplification by Stimulated Emission
  of Radiation”，即“通过受激发射来放大光的辐射”。
sidebar:
  hidden: true
...
<Pronunciation word="Laser" uk="/ˈleɪz.ə(ɹ)/" us="/ˈleɪz.ə(ɹ)/" client:only />
...
"Laser" 一词源于上述的缩写。它是 1957 年由美国科学家 Gordon Gould 首次提出，并用于他的研究笔记，后来被公认为激光技术的基础。
...
<WordRelations synonyms={["LASER"]} client:only />
