...
title: Surf
description: >-
  Surf 是一个英语单词，主要有两个含义。首先，它可以做名词，指的是海浪；其次，'surf' 也可以做动词，表示在海浪上冲浪。除此之外，'surf'
  有时候还被用来形象地描述在网上随意浏览的动作，比如 'surf the Internet'。
sidebar:
  hidden: true
...
<Pronunciation word="Surf" uk="/sɜːf/" us="/sɜːf/" client:only />
...
该单词没有具体的词根，但 "surf" 的词源可以追溯至 17 世纪的荷兰语“surven”或者低地德语"sörven"，都是指在水面上滑动。
...
(城市男孩 Tom, 第一次看到翻滚的海浪, 觉得充满了力量和自由。他决定学习冲浪，渴望在大海上体验那种惊险刺激。)
