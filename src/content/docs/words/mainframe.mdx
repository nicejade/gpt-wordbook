---
title: "mainframe"
description: "Mainframe 是一个英文单词，通常用于描述大型、强大且可靠的计算机系统，特别是那些在重要业务环境中负责处理和管理大量数据的系统。它一般作为企业级应用的主机使用。"
---
...
Mainframe 并没有前缀或后缀，它是由两个单词“main”和“frame”组合而来。

### 发展历史和文化背景

"Mainframe"一词最早在 20 世纪 60 年代开始使用，主要在信息技术行业中用于描述那些大型而强大的计算机系统。在当时，这些系统通常占据整个房间，故得名"大型机"。
...
In the 1960s, a mainframe took up a whole room, but it was less powerful than a smartphone now. (在 20 世纪 60 年代，一台大型主机占据了整个房间，但它的性能比现在的智能手机还要弱。)
