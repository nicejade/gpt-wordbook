---
title: Courageous
description: Courageous 是一个形容词，表示有勇气的、骄勇的。Translates in Chinese as '勇敢的'。
sidebar:
  hidden: true
...
此词的发展可以追踪到 14 世纪的法语，'Courage' 源自法语 'Corage'，意为“心”，并逐渐发展为表示“勇气”的意思。
...
<WordRelations
  synonyms={["bold", "brave", "hardy", "valorous", "heroic"]}
  client:only
/>
