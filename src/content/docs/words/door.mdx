---
title: Door
description: Door 是英语中的一个常用词，主要指的是进入或离开建筑物、房间或车辆的开启或关闭的通道或其封闭的部分。这个词也可以象征性地引申为机会或权利的入口。
sidebar:
  hidden: true
...
<Pronunciation word="Door" uk="/dɔː/" us="/dɔɹ/" client:only />
...
有一天，Tom 在他的房子里发现了一扇神秘的门。他以前从未注意到过。当他打开门时，他发现了一个充满机会的新世界。
