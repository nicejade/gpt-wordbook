---
title: Pantry
description: Pantry是一个名词，它指的是一个小的贮藏室或房间用于储存食品、餐具和其他与食物相关的物品。在现代设计中，它通常位于厨房附近。
sidebar:
  hidden: true
...
<Pronunciation word="Pantry" uk="/ˈpantɹi/" us="/ˈpantɹi/" client:only />
...
<WordRelations
  synonyms={["cabinet","cupboard","kitchen","closet","larder","press"]}
  client:only
/>
