---
title: Responsive
description: 英文单词'responsive'的基本含义是'对某物有反应的'或者'能很快作出反应的'。
sidebar:
  hidden: true
...
可以将 "responsive" 联想成 "response" （反应）+"-ive"。之后，就可以用类似的 pattern 记忆其他以 "-ive" 结尾的形容词了。
...
<WordRelations antonyms={["nonresponsive", "unresponsive"]} client:only />
