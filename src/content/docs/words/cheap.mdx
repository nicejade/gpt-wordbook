---
title: Cheap
description: Cheap 是一个形容词，主要有两种含义：一是指价格低廉，不需要花费很多的钱；二是形容人节俭，不愿意花钱的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Cheap" uk="/t͡ʃiːp/" us="/t͡ʃiːp/" client:only />
...
<WordRelations
  synonyms={["bargain","frugal","inexpensive","flimsy"]}
  antonyms={["rich","dear","expensive","pricey","precious","valuable"]}
  client:only
/>
