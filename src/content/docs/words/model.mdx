---
title: Model
description: Model 作为名词时的主要意思有“模型”，“模特”，或者“典型”。作为动词时，它的含义是“模仿”，“制作模型”。
sidebar:
  hidden: true
...
<Pronunciation word="Model" uk="/ˈmɒdl̩/" us="/ˈmɑdl̩/" client:only />
...
“Model”的起源可以追溯到 16 世纪的拉丁词“modellus”，意为“度量”或“方式”。这个词最初描述的是一个小型物体，比如微型雕像，后来它的意义发展到了我们现在知道的模型的各种形式。
...
<WordRelations synonyms={["modelise", "modelize", "ideal"]} client:only />
