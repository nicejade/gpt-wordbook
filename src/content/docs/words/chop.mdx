...
title: Chop
description: >-
  Chop 是一个英文常用动词及名词，其主要含义为“砍、剁碎”。当做动词时，比如‘chop the
  wood’等，中文翻译为“砍柴”。当做名词时，常常指代肉的一块，比如‘lamb chops’可以翻译为“羊排”。
sidebar:
  hidden: true
...
<Pronunciation word="Chop" uk="/tʃɒp/" us="/tʃɒp/" client:only />
...
"Chop" 源自于 14 世纪的英语，意思为“攻击，击打”，在片刻后获得了“剁碎”的含义。它还有“咬住”的含义，这在早期的英语中用于指代兽类的咬合。18 世纪时，它开始用来指特定的肉块，如猪排等。
...
（Tim 在厨房准备晚饭。他的身体倾斜在柜台上，刀子在砧板上跳舞一样地剁，剁，剁，将胡萝卜剁成小块。）

<WordRelations synonyms={["axe", "sack"]} client:only />
