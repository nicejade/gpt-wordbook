---
title: Original
description: Original 表示的是'初始的'，'首创的' 或 '原始的'。
sidebar:
  hidden: true
...
<Pronunciation word="Original" uk="/əˈɹɪdʒnəl/" us="/əˈɹɪdʒnəl/" client:only />
...
<WordRelations
  synonyms={["autograph", "prototype", "initial"]}
  antonyms={["copy", "remake", "reproduction", "derivative", "ultimate"]}
  client:only
/>
