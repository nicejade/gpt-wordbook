---
title: Nor
description: Nor 这个词通常用来连接两个否定句，相当于中文中的 '也不' 或者 '也没'。它可以用于形式上和语义上的否定。
sidebar:
  hidden: true
...
<Pronunciation word="Nor" uk="/nɔː/" us="/nɔːɹ/" client:only />
...
"Nor" 是英语中的连词，没有根源词或词根，这是中古英语的一个词，源自 ne+or。
...
"Nor" 在威廉·莎士比亚的剧本中有大量的使用。这表明该词在英语中的使用至少可以追溯到 16 世纪初。
