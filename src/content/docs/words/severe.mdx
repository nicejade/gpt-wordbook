...
title: Severe
description: >-
  Severe是一个形容词，用来形容不良的事情十分严重，或形容某种程度或质量极为严厉或强烈。例如：“severe weather
  conditions”指的是极端恶劣的天气条件。
sidebar:
  hidden: true
...
<Pronunciation word="Severe" uk="/sɪˈvɪə/" us="/sɪˈvɪə/" client:only />
...
将 severe 联想成“严重的”，把 severe 和"serious"（严肃的）联想在一起，同为形容事情严重的词汇，可以帮助记忆。
