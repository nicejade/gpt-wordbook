...
title: Inanimate
description: >-
  Inanimate' 是一个形容词，意为'无生命的'，常用来描述那些没有生命的物体，如石头、桌子等。例如：'The inanimate objects in
  the room.
sidebar:
  hidden: true
...
<Pronunciation word="Inanimate" uk="/ɪnˈænɪmət/" us="/ɪnˈænɪmət/" client:only />
...
<WordRelations
  synonyms={["insensate","insentient","lifeless","immobile","motionless"]}
  antonyms={["animate"]}
  client:only
/>
