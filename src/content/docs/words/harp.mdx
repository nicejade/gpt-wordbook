---
title: Harp
description: Harp 是一个英文单词，主要有两个含义：作为名词表示'竖琴'，作为动词则有'喋喋不休地谈论'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Harp" uk="/hɑːp/" us="/hɑːp/" client:only />
...
<WordRelations synonyms={["perseverate"]} client:only />
