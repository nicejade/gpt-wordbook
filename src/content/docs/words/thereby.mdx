---
title: Thereby
description: thereby是一个副词，通常用于表示'因此'或'由此'，用来连接两个句子，说明前一个行动或情况导致了后一个结果。
sidebar:
  hidden: true
...
<Pronunciation word="Thereby" uk="/ðɛəˈbaɪ/" us="/ðɛɹˈbaɪ/" client:only />
...
<WordRelations synonyms={["therefore"]} client:only />
