---
title: Capability
description: Capability 是一种表示能力或者素质的名词，指的是一种完成特定任务或者达到特定目标的技能或者能力。
sidebar:
  hidden: true
...
"Capability"一词源自 Latin 词根"capabilis"，意为"能承受的"。

### 词缀分析

"Capability"一词由词根 cap, 后缀-able, -ility 组成。词根 cap 意味着"获取，抓住"，后缀-able 表示有...的能力，-ility 则是转变为名词的后缀。组合在一起就形成了表示"有...的能力"的意思。

### 文化背景

该词在 14 世纪初开始广泛使用，最初来源于法语 "capable"，意为"可以理解或接受的"。在文化背景上，"capability"通常用来描述一个人的多方面能力，它既可以表示做某事的技能，也可以表示理解或学习新事物的能力。
