---
title: Scrutiny
description: Scrutiny 是名词，意思是“仔细检查”或“详细的审查”。一般用来指对事物、事件或人进行细致入微的观察或评估。
sidebar:
  hidden: true
...
<Pronunciation word="Scrutiny" uk="/ˈskɹuː.tɪ.ni/" us="/ˈskɹuː.tɪ.ni/" client:only />
...
Scrutiny 来源于 Latin 的 "scrutari"，意为 "to examine, to search”。其中 scrut 是词根，表示“查找、搜索”，-iny 是后缀，表示名词。
...
Scrutiny 这个词最早可以追溯到 14 世纪的拉丁语，原指“用蓑衣装束自己，比喻打着某种旗号的搜索”后来扩大化为"认真检查"的概念。这个词在西方社会中，经常用於与政治、刑事犯罪、研究等场合，指对事情进行严谨的审查和研究。
...
<WordRelations
  synonyms={["examination","exploration","inquiry","inspection","investigation","perusal","probe","scan","study","survey"]}
  client:only
/>
