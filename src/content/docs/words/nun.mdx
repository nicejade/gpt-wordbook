---
title: Nun
description: Nun (名词）指的是女修道院的修女，是一位在某个宗教团体中发誓过贞洁、贫穷和顺从的女性。
sidebar:
  hidden: true
...
<Pronunciation word="Nun" uk="/nʌn/" us="/nʌn/" client:only />
...
<WordRelations
  synonyms={["moniale", "sister", "sistren"]}
  antonyms={["brother", "frater", "friar", "monk"]}
  client:only
/>
