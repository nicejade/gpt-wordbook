---
title: Use
description: 单词 'use' 作为动词时，主要意思是'使用'，也可表示“利用”。作为名词时，它表示'用途'，'使用'，'利用'。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["employment","nait","note","usage","benefit","good","point","usefulness","utility","apply","employ","engage","utilise","utilize","exploit"]}
  client:only
/>
