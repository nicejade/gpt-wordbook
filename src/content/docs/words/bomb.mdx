---
title: Bomb
description: Bomb 是一个名词，表示“炸弹”，是一种充满了爆炸性物质，可以引起大规模损毁和破坏的装置。也可以用作动词，表示 '投放炸弹' 或 '猛烈攻击'。
sidebar:
  hidden: true
...
<Pronunciation word="Bomb" uk="/bɒm/" us="/bɑm/" client:only />
...
<WordRelations synonyms={["cannonball", "fortune", "packet"]} client:only />
