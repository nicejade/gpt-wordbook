---
title: Central
description: Central是形容词，主要有两个含义：一是指“中心的、中央的”，二是指“主要的、关键的”。
sidebar:
  hidden: true
...
<Pronunciation word="Central" uk="/ˈsɛntɹəl/" us="/ˈsɛntɹəl/" client:only />
...
<WordRelations synonyms={["dominant", "main", "principal"]} client:only />
