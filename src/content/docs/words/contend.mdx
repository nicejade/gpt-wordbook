...
title: contend
description: >-
  Contend 是一个英语动词，它有两种主要的意思。一是表示竞争或争夺，通常是为了获取某种权力或者优势。例如，In the business world,
  companies contend for
  customers.（在商业世界中，公司们争夺顾客。）二是表示坚决声明或者声称，通常是表示个人或者团体坚信其观点的正确性。例如，He contends
  that the judge was wrong.（他坚持认为法官错了。）
sidebar:
  hidden: true
