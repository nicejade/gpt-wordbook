---
title: Speculate
description: Speculate 是一个英语动词，来源于拉丁语 'speculatus'，意为观察、探察。在现代英语中，'speculate' 大致有三个基本的含义：
sidebar:
  hidden: true
...
"Speculate" 最早出现在 16 世纪，用于形容透过反思或审视来获取知识。在 19 世纪，它引入了投机的含义，因为当时的投机商人就像是在进行一场金钱的赌博。
