---
title: "fortnight"
description: "英语单词 fortnight 是时间计量单位的一种，指的是 两个星期 或 十四天 这一段时间。"
---
...
为了记住 "fortnight"，你可以将其拆分为两部分 - 'fort' 和 'night'。将这两个词组合，您可以构建一个图像或故事，比如：在这个堡垒（fort）里，我将停留 14 个夜晚（night），这样你就很容易记住"fortnight"了。
