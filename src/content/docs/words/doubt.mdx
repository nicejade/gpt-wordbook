---
title: Doubt
description: Doubt是一种不确定性或不信任的感觉。它可以用作名词，表示不信任或怀疑，也可以用作动词，表示对某事存在疑虑。
sidebar:
  hidden: true
...
<Pronunciation word="Doubt" uk="/dʌʊt/" us="/daʊt/" client:only />
...
<WordRelations synonyms={["distrust", "mistrust"]} client:only />
