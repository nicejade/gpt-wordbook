...
title: Neck
description: >-
  - 'Neck' 是一个英语单词，名词，意思是 '脖子'，也可以形容狭窄的地方，例如瓶颈（bottle's
  neck）。作为动词，可用来描述人亲密地相互吻和拥抱。
sidebar:
  hidden: true
...
<Pronunciation word="Neck" uk="/nɛk/" us="/nɛk/" client:only />
...
- "Neck" 可以追溯到公元前 8 世纪的早期英语中。起初被用来指人的颈部或者动物的颈部。之后发展出更广泛的意思，包括表示狭窄或长条状的地方。
...
- Malcolm 仰头看星星，把脖子扭到了。然而，当他发现一颗流星划过天空时，他忘记了他的疼痛。

<WordRelations
  synonyms={["Neck","Näcken","nicor","nix","nixie","nixy","nokk","nokken","näck","grope","pet","smooch","smoodge","snog","snuggle","chug"]}
  client:only
/>
