...
description: >-
  Fellowship
  是一个名词，用来表达'友好交流'，'与其他人在一起而感到的愉快'或'共享特权'的概念。亦常在学术环境中用来描述一种奖学金或津贴系统，供研究者或学者进行研究或学习。
sidebar:
  hidden: true
...
<Pronunciation word="Fellowship" uk="/ˈfɛləʃɪp/" us="/ˈfɛləʃɪp/" client:only />
...
"Fellowship" 这个单词源自早期的中古英语 "fēolagscipe"，首次出现在 13 世纪，原本含义是"伙伴关系"。在文化背景中，“fellowship” 常用于描述一群有共同目标或兴趣的人之间建立的情谊和联盟。
