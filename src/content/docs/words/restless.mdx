...
title: Restless
description: >-
  Restless是形容词，常常指的是一个不能静下来的状态，时常处于活动或更变，甚至可能因此感到焦虑或不安。'Restless'也可以形容一个不满足于现状、不断寻求新事物或变革的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Restless" uk="/ˈɹɛstləs/" us="/ˈɹɛstləs/" client:only />
...
"Restless"的使用可以追溯到 14 世纪，源自古英语"restleas"，来自"rest"（休息）和"-leas"（没有）。
...
<WordRelations synonyms={["antsy"]} client:only />
