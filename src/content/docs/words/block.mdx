...
title: Block
description: >-
  Block 是一个常见的英文单词，它既可以用作名词也可以用作动词。当作名词使用时，'block' 的意思为'块，区，大厦' 等，如 'a block of
  wood'（一块木头）。当作动词使用时，'block' 的意思为'阻碍，挡住' 等，如 'block the way'（阻挡道路）。
sidebar:
  hidden: true
...
<Pronunciation word="Block" uk="/blɒk/" us="/blɑk/" client:only />
...
<WordRelations
  synonyms={["roof","stuff","wall","barrier","blockage","obstruction"]}
  client:only
/>
