---
title: Offspring
description: Offspring 是一个名词，意为“子女”，“后代”。一般用于人或动物，强调的是父母与孩子之间的生物关系。
sidebar:
  hidden: true
...
<Pronunciation word="Offspring" uk="/ˈɒfspɹɪŋ/" us="/ˈɒfspɹɪŋ/" client:only />
...
Offspring 是一个非常古老的单词，早在公元前 1000 年就已经在使用了。在很早的时候，这个词也被用来表示“水源”或“泉水”，因为水也是生命的源泉。
...
<WordRelations
  synonyms={["descendant","get","lineage","progeny","seed","baby","child","issue","kid"]}
  antonyms={["father","genitor","mother","parent","progenitor","ancestor","forbears","forebears","forefathers"]}
  client:only
/>
