...
title: Lodge
description: >-
  Lodge是个具有多重含义的英语单词。它既可以作为名词，也可以作为动词使用。作为名词的时候，'lodge'常常指“小屋”或者“旅馆”。作为动词的时候，'lodge'一般指'提交'或者'嵌入'。
sidebar:
  hidden: true
...
<Pronunciation word="Lodge" uk="/lɒdʒ/" us="/lɑdʒ/" client:only />
...
"Lodge"一词可以追溯到 10 世纪的古英语，随着时间的推移，它的含义已经发生了一些变化。现在，在美国，"lodge" 常被用来指一种提供住宿并有其他娱乐设施的设施，例如滑雪度假村。
...
<WordRelations synonyms={["stop"]} client:only />
