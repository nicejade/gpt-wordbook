---
title: Grandfather
description: Grandfather 是英文中一个常见的名词，表示'祖父'。
sidebar:
  hidden: true
...
"Grandfather"一词早在 14 世纪中叶就开始在英文中被用来表示祖父。并且在许多文化中，祖父都有着重要的地位，常常被视为家族的智者和精神支柱。
...
<WordRelations
  synonyms={["grandsire", "highfather"]}
  antonyms={["grandchild", "granddaughter", "grandmother", "grandson"]}
  client:only
/>
