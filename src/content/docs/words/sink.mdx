---
title: Sink
description: Sink 是一个英文单词，可以作为名词或者动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Sink" uk="/sɪŋk/" us="/sɪŋk/" client:only />
...
"Sink" 这个单词没有前缀和后缀，只有词根 sink。

### 文化背景

"Sink" 的起源可以追溯到公元前 450 年的老英语。在许多西方文化中，"sink" 被用作象征"沉没"，"衰败"，"消沉"的象征意义。
...
<WordRelations
  synonyms={["basin","washbasin","descend","dip","dunk","submerge"]}
