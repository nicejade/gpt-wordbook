---
title: Allow
description: Allow 是一个动词，中文意思是'允许'或'让步'。
sidebar:
  hidden: true
...
从前，有一个严厉的父亲不允许他的女儿在晚上 6 点后在外面玩耍。然而，看到她的悲伤，他最终允许她玩到日落。

<WordRelations
  synonyms={["admit","assign","bestow","concede","let","permit","suffer","tolerate"]}
  client:only
/>
