...
description: >-
  ...
  它是"mechanic"的复数形式，表示多个机械工。例： "The mechanics are working on the
  car."（机械师们正在修车。） - 作为单数形式，"mechanics" 是物理学的一个分支，专门研究力与物质运动的关系。例： Classical
  mechanics is a branch of physics.（经典力学是物理学的一个分支。）
sidebar:
  hidden: true
