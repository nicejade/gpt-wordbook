...
description: >-
  Hug
  是一个英文动词，其基本意义为“拥抱”。它可以用来形容在亲密的环境中，用手臂围绕两个或以上人体之间的互动。除此之外，'hug'还可以作为名词使用，指的是“拥抱”的动作。
sidebar:
  hidden: true
...
<Pronunciation word="Hug" uk="/hʌɡ/" us="/hʌɡ/" client:only />
...
"Hug" 一词在 13 世纪中叶开始出现在英语中，最初的含义是“护卫”或“保护”。这个词很可能来自于古挪威语的 "hugga"，意为“安慰”。拥抱在西方文化中通常表示亲密、安慰、欢迎和庆祝。
...
<WordRelations
  synonyms={["stick","hunker","squat","stoop","embrace","treasure"]}
  client:only
/>
