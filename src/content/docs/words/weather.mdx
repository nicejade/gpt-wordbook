---
title: Weather
description: Weather 是一个英语单词，它的主要含义是'天气'。如果用作动词，则它的含义可以转变为“经受”，“经受住”。
sidebar:
  hidden: true
...
<Pronunciation word="Weather" uk="/ˈwɛðə/" us="/ˈwɛðɚ/" client:only />
...
<WordRelations
  synonyms={["meteorology", "weatherboard", "windward"]}
  antonyms={["lee"]}
  client:only
/>
