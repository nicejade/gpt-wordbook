---
title: Hour
description: Hour 是一个名词，泛指一段时间的六十分钟，也可以用来泛指一段重要的或决定性的时刻。
sidebar:
  hidden: true
...
<Pronunciation word="Hour" uk="/ˈaʊə(ɹ)/" us="/ˈaʊɚ/" client:only />
...
小时实际上是古埃及人首先使用的，他们把日、夜各划分为 12 小时，后来的希腊人，罗马人采用了他们的计时法，演变为今天所使用的 24 小时制。
...
<WordRelations synonyms={["stound", "h", "hr", "hrs"]} client:only />
