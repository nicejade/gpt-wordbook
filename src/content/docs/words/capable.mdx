---
title: Capable
description: Capable 是一个形容词，用来描述有能力或者有技能去完成某项任务或者实现某种目标的个体。它强调的是个体的能力以及潜力。
sidebar:
  hidden: true
...
<Pronunciation word="Capable" uk="/ˈkeɪpəbl̩/" us="/ˈkeɪpəbl̩/" client:only />
...
"Capable" 来源于法语的"capable"，在 14 世纪初开始在英语中使用，用来形容有技能和能力去实现某事的人。
...
<WordRelations antonyms={["incapable"]} client:only />
