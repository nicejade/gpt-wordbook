---
title: Text
description: Text 在英语中是名词，意为'文本'或'正文'。它可以指任何书面或印刷的内容，可以是一封信、一篇文章、一本书的内容等。
sidebar:
  hidden: true
...
<Pronunciation word="Text" uk="/tɛkst/" us="/tɛkst/" client:only />
...
<WordRelations
  synonyms={["theme","topic","SMS","message"]}
  antonyms={["binary"]}
  client:only
/>
