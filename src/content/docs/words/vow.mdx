---
title: Vow
description: Vow 是一个名词和动词。作为名词，它的意思是“誓言”，是一个坚定的承诺或者保证。作为动词，它的意思是“发誓”，即做出坚定的承诺或保证。
sidebar:
  hidden: true
...
<Pronunciation word="Vow" uk="/vaʊ/" us="/vaʊ/" client:only />
...
没有单数复数变形，因为同时可以当名词和动词。其过去式和过去分词都是 vowed，现在分词是 vowing.
