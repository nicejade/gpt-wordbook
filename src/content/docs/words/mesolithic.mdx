---
title: Mesolithic
description: "Mesolithic是一个来自考古学的单词，描述了石器时代与新石器时代之间的一个时期。在这个时期，人类开始转向更复杂的狩猎采集方式，并开始制作更复杂的工具。"
sidebar:
  hidden: true
...
“Mesolithic”在 19 世纪末由考古学家提出，用以描述欧洲石器时代和新石器时代之间的过渡时期。在这个时期，人们开始制作和使用小型的石器，进行游牧生活。
