...
title: Eggplant
description: >-
  Eggplant（美式英语）或 aubergine（英式英语）是一种延伸词汇，其原文意是“南瓜”。在现代英语中，eggplant 是.solana
  的一种蔬菜的名称，常见做各种佳肴。
sidebar:
  hidden: true
...
Eggplant（美式英语）或 aubergine（英式英语）是一种延伸词汇，其原文意是“南瓜”。在现代英语中，eggplant 是.solana 的一种蔬菜的名称，常见做各种佳肴。
...
Eggplant 这个词从 17 世纪开始在英语中出现。刚开始的时候，南瓜的形状和颜色与鸡蛋相似，所以被叫做 "eggplant" ，随后普遍用来指代一种常见的蔬菜。
...
<WordRelations
  synonyms={["melongene", "aubergine", "baingan", "brinjal"]}
  client:only
/>
