...
description: >-
  Inclusive
  是一个形容词，表示包含所有部分的或被认为是一个整体的一部分的。这个词经常用于描述一个不排斥任何人，不论其种族、性别、年龄、身体状况、性取向、宗教信仰等的环境或系统。
sidebar:
  hidden: true
...
"Inclusive" 这个词来自于拉丁语 "inclusus"，原意是"包括的，包含的"。这个词在公元 16 世纪时被引入英语。在现代语境下，它经常被用来描述一个包容所有人的环境或系统。
