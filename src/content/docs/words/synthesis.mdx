---
title: Synthesis
description: Synthesis 是一个名词，是指将两个或更多部份结合在一起，形成一个新的整体。经常用于化学反应和制造过程，也可用于抽象概念，如观点、理论等的结合。
sidebar:
  hidden: true
...
<Pronunciation word="Synthesis" uk="/ˈsɪnθəsɪs/" us="/ˈsɪnθəsɪs/" client:only />
...
"Synthesis"这个词在 17 世纪自拉丁语借用至英语，并主要用于科学语境。这是一种在思维、艺术、科学等多个领域的常见概念。
...
<WordRelations antonyms={["analysis"]} client:only />
