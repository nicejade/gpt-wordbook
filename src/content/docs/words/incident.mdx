...
title: Incident
description: >-
  Incident是一个英语单词，作为名词使用，它的基本含义是'发生的事情'，特别是指那些突然发生，或者可能有重要影响的事情。译为中文，通常将'incident'翻译为'事件'或者'事故'。
sidebar:
  hidden: true
...
"Incident"这个词语来源于拉丁语“incidere”，其意思是“发生”，在 14 世纪末由法语引入英语，当时的意思是“发生的事情”。
