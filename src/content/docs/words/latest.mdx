---
title: Latest
description: Latest 是一个形容词，它表示“最新的，最近的”。
sidebar:
  hidden: true
...
<Pronunciation word="Latest" uk="/ˈleɪt.ɪst/" us="/ˈleɪt.ɪst/" client:only />
...
<WordRelations synonyms={["erenow", "freshly", "belatedly"]} client:only />
