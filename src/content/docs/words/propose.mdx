---
title: Propose
description: Propose 是一个英语动词，中文的意思是“提议”，“建议”，或者“求婚”。
sidebar:
  hidden: true
...
<Pronunciation word="Propose" uk="/pɹəˈpəʊz/" us="/pɹəˈpoʊz/" client:only />
...
"Propose"来自中古英语，最初用于表示"建议"或"提议"的意思，到了 16 世纪，它的意思延伸到了"求婚"。
...
<WordRelations synonyms={["forthput", "suggest"]} client:only />
