...
description: >-
  Sieve
  是一个英文名词，主要指的是一种用来筛选物体的工具，框架上网状或布满小孔，可以让较小的物体通过，而保留较大的物体。在广义上，也可以指任何过滤、筛选或评选的过程或机构。
sidebar:
  hidden: true
...
<Pronunciation word="Sieve" uk="/sɪv/" us="/sɪv/" client:only />
...
- 名词：sieve
- 动词：sieve (单数第三人称 sieves，现在分词 sieving，过去式和过去分词 sieved)
- 形容词：无
