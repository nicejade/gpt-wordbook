---
title: Music
description: Music 是一个英语单词，表示'音乐'。这是一种艺术形式，它的媒介是声音和沉默，其时间的维度是基本的。
sidebar:
  hidden: true
...
<Pronunciation word="Music" uk="/ˈmjuːzɪk/" us="/ˈmjuzɪk/" client:only />
...
<WordRelations synonyms={["melody", "vibe"]} client:only />
