---
title: Tape
description: Tape 这个单词在英语中有两个主要的含义：一个作为名词，指的是录音带或者胶带；另一个作为动词，表示录音或者粘贴。
sidebar:
  hidden: true
...
<Pronunciation word="Tape" uk="/teɪ̯p/" us="/teɪ̯p/" client:only />
...
这个词最早源于 14 世纪的中英语(tape)，原意是带子，条带，后来随着科技的发展，人们开始用这个词来表示记录声音的装置——录音带。
