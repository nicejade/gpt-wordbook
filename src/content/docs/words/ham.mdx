---
title: Ham
description: Ham是一种常见的食品，指的是经过盐腌或烟熏的猪蹄肉。在西方，传统的节庆中常常有制作和分享火腿的习俗。
sidebar:
  hidden: true
...
<Pronunciation word="Ham" uk="/ˈhæm/" us="/ˈhæm/" client:only />
...
<WordRelations antonyms={["spam"]} client:only />
