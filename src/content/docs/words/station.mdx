...
title: Station
description: >-
  Station一词在英语中通常用作名词，指的是一个地方或位置，专门用于特定的活动或任务。最常见的是指一个公共交通的起点、终点或中途停靠点，如火车站、公交站或者电台等。此外，“Station”也可以表示社会或职业地位。当作动词使用时，意为把…安置在，布置。
sidebar:
  hidden: true
...
<Pronunciation word="Station" uk="/ˈsteɪʃən/" us="/ˈsteɪʃən/" client:only />
...
“Station”这个词源自拉丁词根"stare"，意为站立。有很多词都是由这个词根衍生出来的，像 statistics(统计)、status(状态).

### 词缀分析

前缀无，“-tion”是后缀，用来构成名词，表示"行为或结果"。比如 action(行动)、question(问题)。

### 文化背景

“Station”来自拉丁语“statio”，意思是“站立”的动作。中世纪早期，这个词开始用于指代军队的驻地。到了 16 世纪，人们开始使用“station”来指代各种特殊用途的场所，例如火车站或公交站。

### 单词变形

Station 是名词，形容词可以变为 stationary 或 stationed. 另外，也常用作动词，例如"She stationed herself by the door" (她站在门边).
...
<WordRelations
  synonyms={["channel", "sta", "stn", "farm", "ranch", "base"]}
  client:only
/>
