---
title: Black
description: Black一词在英语中主要有两个基本含义。首先，它可能是一个形容词，表示颜色，是所有颜色的消失或缺乏。其次，'black'还可以用作名词，指黑色本身。
sidebar:
  hidden: true
...
<Pronunciation word="Black" uk="/blak/" us="/blak/" client:only />
...
<WordRelations
  synonyms={["blackball","blacklist","blacken","darken","swarten","dark","swart","gloomy"]}
  antonyms={["white","nonblack","unblack","bright","illuminated","lit"]}
  client:only
/>
