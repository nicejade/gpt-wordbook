...
title: Would
description: >-
  Would 是一种模态动词，用于表达过去的习惯，表示愿意、可能性，或者在某些条件下的情况。例如，'Would you like a drink?'
  （你想喝点什么吗?）， 'As a child, she would go fishing with her dad every Sunday.'
  （她小时候，每个星期天都会和她爸爸去钓鱼。）
sidebar:
  hidden: true
...
<Pronunciation word="Would" uk="/wʊd/" us="/wʊd/" client:only />
