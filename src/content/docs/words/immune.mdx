...
description: >-
  Immune
  是一个形容词，表示免疫的或者不受影响的。此词大多用于医学领域，描述身体对疾病的防护机制。它也可以用于非医学领域，表示不会受到某种情况或行为的影响。
sidebar:
  hidden: true
...
<Pronunciation word="Immune" uk="/ɪˈmjuːn/" us="/ɪˈmjuːn/" client:only />
...
"Immune" 这个词在 14 世纪进入英语，原本用来描述免除义务或税收的人。18 世纪末，这个词被用来表示抵抗某种疾病的能力。
...
<WordRelations antonyms={["susceptible", "vulnerable"]} client:only />
