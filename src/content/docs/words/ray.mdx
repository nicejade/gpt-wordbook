---
title: Ray
description: 单词 'Ray' 有两个主要含义。首先，它可以作为一个名词，指光线或射线，比如太阳光。其次，它也可以指水生动物鳐鱼。
sidebar:
  hidden: true
...
<Pronunciation word="Ray" uk="/ɹeɪ/" us="/ɹeɪ/" client:only />
...
"Ray" 的最初来源是拉丁语 "radius"，用于描述从一个点发出的光束。直到现在，这个词在英语中仍然保持了这个含义。对于鳐鱼的用法，最早出现在 17 世纪，可能是从旧法语的 "raie" 派生出来的。
