---
title: Trim
description: Trim 可作为动词和形容词。当它作为动词时，它的意思有：修剪，削减，减少。作为形容词时，它指的是整洁，修长的。
sidebar:
  hidden: true
...
<Pronunciation word="Trim" uk="/tɹɪm/" us="/tɹɪm/" client:only />

### 列举例句

1.  "Could you trim the bushes in the garden?" (你能修剪一下花园里的灌木吗？)

2.  "We need to trim the budget by 10%." (我们需要把预算削减 10%。)
