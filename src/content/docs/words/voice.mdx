---
title: Voice
description: Voice 这个单词在英语中有多个含义，最常见的是作为名词，指的是“声音”，尤其是人的说话声。它也可以形容借用某种方法或手段来表达意见或情感。
sidebar:
  hidden: true
...
<Pronunciation word="Voice" uk="/vɔɪs/" us="/vɔɪs/" client:only />
...
<WordRelations
  synonyms={["steven","vote","reard","diathesis","gender"]}
  client:only
/>
