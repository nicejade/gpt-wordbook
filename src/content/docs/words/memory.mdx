---
title: Memory
description: Memory 是英语标准词汇，指的是人脑中存储过去经验的能力，或者是个体以前的特定知识和经验。同时，Memory 也指计算机存储器。
sidebar:
  hidden: true
...
<Pronunciation word="Memory" uk="/ˈmɛm(ə)ɹi/" us="/ˈmɛm(ə)ɹi/" client:only />

### 列举例句

1.  My childhood memories are still vivid. (我对童年的记忆依然清晰。)
2.  Good memory is a great gift. (好的记忆力是一份很好的礼物。)
3.  The computer has a memory of 16 gigabytes. (该电脑有 16 千兆字节的内存。）
...
<WordRelations synonyms={["core", "recall", "recollection"]} client:only />
