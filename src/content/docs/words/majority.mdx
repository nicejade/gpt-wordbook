---
title: Majority
description: "- 'Majority' 是一个名词，其含义是“大多数”，或者“半数以上”。在政治学中，'majority' 也被用来表示议会中的半数以上的投票。"
sidebar:
  hidden: true
...
"Majority" 这个单词在 16 世纪左右由法语演变而来，最初被用来表示年满法律所规定的成年的年龄，并在此基础上扩展了其含义。
...
During the class president election, Tom managed to win the majority of votes, demonstrating his popularity and charisma. (在班级主席选举中，Tom 成功的赢得了大多数选票，显示出他的受欢迎程度和魅力。)

<WordRelations antonyms={["minority"]} client:only />
