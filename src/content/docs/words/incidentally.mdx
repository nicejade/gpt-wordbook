...
title: Incidentally
description: >-
  incidentally是一个副词，它的意思是'顺便，偶然，另外'。它通常用于口语中，作为一个插入语，用于引出与主题不完全相关但仍然重要的信息，或者用于引出次要或者附带的评论、观察或者信息。
sidebar:
  hidden: true
...
"incidentally"是 19 世纪初期开始在英语中使用的，它来源于拉丁语的 "incidentalis"，表达“作为附带事物或者巧合发生的”意思。
...
有一天，Tom 偶然找到一本关于古代历史的书籍，深深地吸引了他。从那时起，他对考古学产生了兴趣，决定成为一名考古学家。

<WordRelations antonyms={["certainly", "inevitably"]} client:only />
