---
title: Service
description: Service 在英语中作为名词使用，指的是为他人提供的帮助或是满足他人需求的行为或工作。而作为动词，'service'表示的是提供服务或保养。
sidebar:
  hidden: true
...
<Pronunciation word="Service" uk="/ˈsɜːvɪs/" us="/ˈsɜːvɪs/" client:only />
