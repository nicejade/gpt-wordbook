...
description: >-
  Steep
  是一个形容词，意思是“陡峭的”，一般用来形容坡度大或者倾斜度大的地方。除此之外，“steep”还有另外一个意思是“急剧的”，或者“过高的”，常常用来形容价格或者费用。
sidebar:
  hidden: true
...
<Pronunciation word="Steep" uk="/stiːp/" us="/stiːp/" client:only />
...
<WordRelations synonyms={["brant"]} client:only />
