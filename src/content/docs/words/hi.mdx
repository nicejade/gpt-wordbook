---
title: Hi
description: "- 'Hi'在英语中是一个非正式的问候用语，相当于中文中的“你好”或“嗨”。"
sidebar:
  hidden: true
...
<Pronunciation word="Hi" uk="/haɪ/" us="/haɪ/" client:only />
...
<WordRelations synonyms={["greeting", "hello", "greetings"]} client:only />
