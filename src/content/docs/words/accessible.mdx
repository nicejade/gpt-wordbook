---
title: Accessible
description: accessible 是一个形容词，它的基本含义是'可接近的'、'可达到的'或'易接受的'。
sidebar:
  hidden: true
...
<Pronunciation word="Accessible" uk="/əkˈsɛs.ə.bəl/" us="/əkˈsɛs.ə.bəl/" client:only />
...
<WordRelations
  synonyms={["approachable","friendly","welcoming"]}
