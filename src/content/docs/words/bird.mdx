---
title: Bird
description: Bird 是英语中的一个基本单词，表示鸟类的总称。它可以指任何的鸟类，包括乌鸦、鸽子、鹦鹉等等。
sidebar:
  hidden: true
...
<Pronunciation word="Bird" uk="/bɜd/" us="/bɝd/" client:only />
...
<WordRelations
  synonyms={["bloke","chap","guy","fowl","broad","chick","girl","lass"]}
  client:only
/>
