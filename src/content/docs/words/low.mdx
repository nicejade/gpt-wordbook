...
title: Low
description: >-
  low是一个形容词，意思是'不高的'，'低的'。它可以用于描述物理高度，比如“low ceiling”（低的天花板）；或者抽象的概念，如'low
  temperature'（低温度）。它还可以用于描述声音的响亮程度，如'low voice'（低声）。'low'还可以表达地位低、程度低或者数量少等意思。
sidebar:
  hidden: true
...
<Pronunciation word="Low" uk="/ləʊ/" us="/loʊ/" client:only />
...
"Low"是一个古英语词，最初的形式为"lah"或"læg"，自公元前 1100 年以来在英语中使用，意思为"不高的"。在德语中，与之语源相似的词是"lah"。"Low"在英国和美国的文化中，常用来描述状态或者程度的低落。
...
<WordRelations
  synonyms={["blue","depressed","down","gloomy","miserable","sad","unhappy","abject","immoral","scummy","scurvy","nether","underslung","devalued","reduced","soft","deep","flat"]}
  antonyms={["high","tall"]}
  client:only
/>
