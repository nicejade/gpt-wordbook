---
title: Circulation
description: Circulation 是一个名词，主要有两种含义：流通和循环。可以指物质、空气、水、电、热、资金等的流通或者循环。在医学领域，这个词常指血液的循环。
sidebar:
  hidden: true
...
"Circulation"这个词在 14 世纪的时候从法语借用而来。它首先被用来描述物品、货币和信息的流通，后来在医学上开始描述血液流动状态。
