...
<Pronunciation word="Flock" uk="/flɒk/" us="/flɑk/" client:only />
...
<WordRelations
  synonyms={["bunch","gaggle","horde","host","legion","litter","nest","rabble","swarm","throng","wake"]}
  client:only
/>
