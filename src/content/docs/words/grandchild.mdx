---
title: Grandchild
description: Grandchild 是英语中的一个单词，它通常用来描述人的关系。这个词的意思是 '孙子' 或 '孙女'
sidebar:
  hidden: true
...
Grandchild 这个词汇其实是两个词的组合, "grand-" 和 "child". "Grand-"在此含有“大”的意思，而 "child" 就是孩子的意思。将两者结合，形成了 “孙子” 或 “孙女” 的含义。
...
<WordRelations
  synonyms={["grandkid", "grandwean", "oe"]}
