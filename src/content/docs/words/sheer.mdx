---
title: "sheer"
description: "sheer 是一个英语单词，可以作为形容词，副词，还可以用作动词。 1. 作为形容词，其基本涵义包括： * 完全的，纯粹的，例如：sheer nonsense（纯粹的胡说）。 * 陡峭的，峻傍的，例如：sheer cliffs（陡峭的悬崖）。 * 透明的，薄的，像纱一样轻薄的，例如：sheer curtains（薄纱窗帘）。 2. 作为副词，sheer 主要表示突然转向，尤指船只突然改变方向。 3. sheer作为动词，意思是 偏离航线, 偏航。"
---
