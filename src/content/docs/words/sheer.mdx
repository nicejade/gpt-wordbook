---
title: Sheer
description: sheer 是一个英语单词，可以作为形容词，副词，还可以用作动词。
sidebar:
  hidden: true
...
<Pronunciation word="Sheer" uk="/ˈʃɪə/" us="/ʃɪɹ/" client:only />
...
<WordRelations
  synonyms={["downright","mere","pure","unmitigated","undiluted","perpendicular","steep","vertical","diaphanous","thin"]}
  client:only
/>
