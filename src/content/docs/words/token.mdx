---
title: Token
description: 英文单词'token'一般有两个主要含义：
sidebar:
  hidden: true
...
<Pronunciation word="Token" uk="/ˈtəʊkən/" us="/ˈtoʊkən/" client:only />
...
<WordRelations
  synonyms={["memento","souvenir","miracle","password","reason","sign","symbol"]}
  antonyms={["type"]}
  client:only
/>
