...
title: Will
description: >-
  Will 通常用作助动词，表示未来的意思，例如：'I will go to the
  store.'（我将去商店）。另外，它还有表示意愿、意图或决心的含义，例如：'I will finish my work before I go
  home.'（我会在回家之前完成我的工作）。
sidebar:
  hidden: true
...
<Pronunciation word="Will" uk="/wɪl/" us="/wɪl/" client:only />
