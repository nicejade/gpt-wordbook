---
title: Aural
description: Aural 这个单词是形容词，源自拉丁词 'auris'，意为 '耳' 或 '听觉的'。凡是与听觉负责接收的声音或信息的事物都可以用这个单词来形容。
sidebar:
  hidden: true
...
<Pronunciation word="Aural" uk="/ˈɔːɹəl/" us="/ˈɔːɹəl/" client:only />
...
"Aural" 是自 19 世纪始被认为是 "oral" 的听力背景的等价物，强调与听觉有关的部分。
