---
title: Embed
description: Embed 是一个英语动词，表示'嵌入'或'插入'。
sidebar:
  hidden: true
...
<Pronunciation word="Embed" uk="/əmˈbɛd/" us="/əmˈbɛd/" client:only />
...
"Embed" 源自中古英语"on beddian"，表示"在...中"，在 19 世纪的时候才开始有今天的"嵌入"的意思。在信息时代，"embed"常常用来描述将某种元素（例如视频、音频等）嵌入到网页或者其他媒体中。
