...
description: >-
  英文单词 'predecessor'
  主要用作名词，意为“前任”或“前辈”。常用来指某一个职位或地位的前一任持有者。也可以指存在的或被发明的时间在某物之前的任何事物。
sidebar:
  hidden: true
...
2.  The predecessor of the modern bicycle was the 19th-century penny-farthing.（现代自行车的前身是 19 世纪的“大头钱”自行车）
...
单词"predecessor"源自 14 世纪的中英语，进一步追溯，该词源自拉丁词"decessor"（意为“离开者”）及"pre-"（意为“在前，之前”）。由于欧美社会重视继承和传承，"predecessor"这一单词在文化、社会 等领域经常出现。
...
<WordRelations
  synonyms={["foreganger", "forerunner"]}
  antonyms={["successor"]}
  client:only
/>
