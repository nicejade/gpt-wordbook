...
title: Cube
description: >-
  Cube 是一个名词，其主要意义为立方形物体或体积单位。当我们说物体是
  'cubed'，我们的意思是这个物体有三维，宽度、高度、深度都是相等的。此外，在数学中，'to cube a number' 意味着将这个数乘以其自身两次。
sidebar:
  hidden: true
...
<Pronunciation word="Cube" uk="/kjuːb/" us="/kjub/" client:only />
...
<WordRelations
  synonyms={["power", "third", "block", "brick", "die", "dice"]}
  client:only
/>
