---
title: Solid
description: 英语单词 'solid' 主要有两个含义，其一表示'固体的'或者'实心的'，其二表示'硬朗的'或者'坚固的'
sidebar:
  hidden: true
...
<Pronunciation word="Solid" uk="/ˈsɒlɪd/" us="/ˈsɑlɪd/" client:only />
...
<WordRelations synonyms={["closed", "massive", "substantial"]} client:only />
