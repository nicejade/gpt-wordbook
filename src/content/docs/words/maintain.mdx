...
title: maintain
description: >-
  Maintain 是一个英文动词，主要有三种意思： 1. 保持某种状态或条件，比如maintain a healthy diet - 保持健康的饮食。 2.
  坚持声称或主张，比如maintain one's innocence - 坚决维护自己的清白。 3.
  修理或照料（建筑物、机器等），保持其良好状况，比如maintain a car - 维修汽车。
sidebar:
  hidden: true
