---
title: Army
description: Army 是一个英文名词，中文翻译为“军队”或者“陆军”。这是一个集体名词，代表由许多士兵，官员，及其设备构成的大型军事力量。
sidebar:
  hidden: true
...
<Pronunciation word="Army" uk="/ˈɑː.miː/" us="/ˈɑɹ.mi/" client:only />
...
<WordRelations synonyms={["ferd", "here", "host"]} client:only />
