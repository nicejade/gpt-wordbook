---
title: Bullet
description: Bullet 是英语单词，常被用来指代枪弹或子弹。它也可以用于形容小东西的速度快。像是射出去的子弹。
sidebar:
  hidden: true
...
<Pronunciation word="Bullet" uk="/ˈbʊl.ɪt/" us="/ˈbʊl.ɪt/" client:only />
...
"Bullet"从法语"boulette"（晚期拉丁语的 "bulla"），意为"小球或小块"，在 16 世纪时开始出现在英文中，指代可投射或发射的任何小硬物，特别是金属的。然而现在更常用于指代枪弹或者子弹。
...
<WordRelations synonyms={["cap", "pill", "slug"]} client:only />
