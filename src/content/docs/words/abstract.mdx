...
<WordRelations
  synonyms={["abridgment","epitome","summarize","steal","remove","separate","withdraw","abstruse","conceptual","ideal","imaginary"]}
  antonyms={["actual","concrete","empirical","practical","discrete","particular","precise","specific"]}
  client:only
/>
