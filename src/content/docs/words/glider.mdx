...
<Pronunciation word="Glider" uk="/ˈɡlaɪdə(ɹ)/" us="/ˈɡlaɪdə(ɹ)/" client:only />
...
- "Glider"一词在 16 世纪的英语中首先作为“滑行”出现，描述光滑的移动。在科技进步，尤其是航空技术发展后，“glider”开始被用来指代一种依赖气流滑翔的飞行器。
...
<WordRelations synonyms={["semiconsonant", "semivowel"]} client:only />
