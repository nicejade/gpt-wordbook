---
title: Love
description: Love 是一个既可作名词又可作动词的英文字，它在英语中有多种用法和含义。
sidebar:
  hidden: true
...
<Pronunciation word="Love" uk="/lʌv/" us="/lʌv/" client:only />
...
<WordRelations
  synonyms={["baby","darling","honey","lover","pet","sweetheart","romance","coitus","sex","aphrodisia","carnality","mate","sweetie","adore","cherish","enjoy"]}
  antonyms={["indifference","angst","hate","hatred","malice","spite","despise"]}
  client:only
/>
