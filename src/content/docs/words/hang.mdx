---
title: Hang
description: hang在英语中是一个动词，也可以用作名词。当它作为动词时，可以表示以下几种意思：
sidebar:
  hidden: true
...
<Pronunciation word="Hang" uk="[heɪŋ]" us="[heɪŋ]" client:only />
...
"hang"的历史可以追溯到公元前 7 世纪的古英语。它原来是指"悬挂"或"悬空"的意思。随着时间的推移，这个词的意思也在变化和扩展，比如，人们开始用它来形容一个人的行为和举止，也用它来描述执行绞刑的行为。
...
<WordRelations
  synonyms={["gallows","swing","dangle","suspended","suspend","freeze","bedeck","deck","decorate","lynch","exhibit","show","float","hover","drop","lower"]}
  client:only
/>
