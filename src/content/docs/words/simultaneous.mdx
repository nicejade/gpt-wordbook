---
title: Simultaneous
description: Simultaneous是一个形容词，定义为'发生在同一时间'或'同时进行的'。它描述的是两个或更多的事件，动作或过程在同一时间发生。
sidebar:
  hidden: true
...
<Pronunciation
  word="Simultaneous"
  uk="/sɪm.əlˈteɪ̯n.i.əs/"
  us="/ˌsaɪ̯m.əlˈteɪ̯n.i.əs/"
  client:only
/>
...
<WordRelations antonyms={["sequential"]} client:only />
