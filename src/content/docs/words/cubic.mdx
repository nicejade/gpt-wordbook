---
title: Cubic
description: Cubic 是一个形容词，主要有两种含义。一是表示与立方体有关的，尤其是形状像立方体的。二是与三次方程或者三次乘积有关的。
sidebar:
  hidden: true
...
<Pronunciation word="Cubic" uk="/ˈkjuː.bɪk/" us="/ˈkju.bɪk/" client:only />
...
"Cubic"的词根来自于 Latin 的 "cubus"，意思是 "立方体"。
...
"Cubic" 这个词在 17 世纪初首次出现，主要是用于描述数学直方体或者几何中的立方体。
...
<WordRelations synonyms={["isometric", "monometric"]} client:only />
