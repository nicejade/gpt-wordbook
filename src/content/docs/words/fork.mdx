...
description: >-
  Fork
  在英语中具有不同的含义，取决于它的使用情境。最常见的是作为名词，意为'叉'或者'叉子'，例如在用餐时。但它也可以指代“分支”，例如道路的分叉处。此外，'fork'也可用作动词，表示“分岔”。
sidebar:
  hidden: true
...
<Pronunciation word="Fork" uk="/fɔːk/" us="/fɔɹk/" client:only />
...
<WordRelations
  synonyms={["branch","pitchfork","pommel","swell","annihilate","obliterate","ruin","bang","eff","hump","screw","shag","ream","bugger","feck"]}
  client:only
/>
