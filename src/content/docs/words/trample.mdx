...
title: Trample
description: >-
  Trample 是一个英语动词，其基本意义是指“践踏”，就是用力踩下，通常指频繁并缺乏尊重地走过某个表面或踩在某物上。此外，'trample'
  还有一个比喻用法，就是指对别人的权利或感情的无理侵害或蔑视。
sidebar:
  hidden: true
...
<Pronunciation word="Trample" uk="/ˈtɹæmpəl/" us="/ˈtɹæmpəl/" client:only />
