---
title: Linger
description: Linger 是一个动词，意思是“逗留”，“延迟”，或者形容一个行为或状态持续不肯结束。
sidebar:
  hidden: true
...
<Pronunciation word="Linger" uk="/ˈlɪŋɡə/" us="/ˈlɪŋɡə/" client:only />
...
<WordRelations synonyms={["abide", "tarry"]} client:only />
