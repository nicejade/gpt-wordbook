...
title: Bureau
description: >-
  Bureau 是一个名词，来自法语，原意为办公室或者机构。在英语中也有同样的含义。例如： 'Federal Bureau of Investigation'
  表示 '联邦调查局'。
sidebar:
  hidden: true
...
<Pronunciation word="Bureau" uk="/ˈbjʊɹ.oʊ/" us="/ˈbjʊɹ.oʊ/" client:only />
...
由于 Bureau 直接从法语中借用，其发音和拼写都保持了原有的法语特色，你可以把它和法语联系起来记忆。同时，由于它在政府或新闻机构中的常见使用，可以把它和这些场景联想起来记忆。
