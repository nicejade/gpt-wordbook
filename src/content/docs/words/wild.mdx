...
title: Wild
description: >-
  Wild 是一个英语形容词，它的基本含义是未经开发的，自然的，未经人类的开发和干涉。同时，'wild'
  还可以形容行为荒诞，无法预测的。当它作为一个名词时，'wild' 通常指的是远离城市，人类居住区的自然环境。
sidebar:
  hidden: true
...
<Pronunciation word="Wild" uk="/waɪld/" us="/waɪld/" client:only />
...
<WordRelations antonyms={["tame"]} client:only />
