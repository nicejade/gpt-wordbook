...
description: >-
  Metropolitan
  是一个形容词，主要是用来形容和大城市或大都会有关的事物或者特性。例如，象征了城市复杂性，人口众多，多元文化等等。另外作为名词，它也可以指大都会区或主教的行政区。
sidebar:
  hidden: true
...
<Pronunciation word="Metropolitan" uk="/mɛtɹəˈpɒlɪtən/" us="/mɛtɹəˈpɒlɪtən/" client:only />
...
Metropolitan 是一个整体词，没有前缀或后缀。结尾的“-an” 是形容词后缀，表示与......有关。我们可以见到相同后缀的单词，如"American"、"European"等。

### 文化背景

"Metropolitan" 一词最初出现在 14 世纪，用来指主教的职位或者主教的行政区。后来在 18 世纪，以其在希腊语中的“母亲城市”含义，被用来指代大城市或首都。
