...
title: double
description: >-
  Double 可用作动词、形容词和名词，主要含义有： 1. 作为动词，double 主要表示“翻倍”，例如，“Our profits have
  doubled in the last year.”(我们的利润在过去一年里翻了一番。) 2. 作为形容词，double 表示“双”的意思，例如，“a
  double bed”（双人床） 3. 作为名词，double 指的是两倍的数量或数量，例如，“I’ll have a double
  espresso,please.(请给我来一杯双份浓缩咖啡。)
sidebar:
  hidden: true
