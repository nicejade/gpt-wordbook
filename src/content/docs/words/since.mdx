---
title: Since
description: Since是一个英语单词，既可以用作介词，也可以用作连词。作为介词时，它表示从某个时间点开始；作为连词时，它表示原因或原因。
sidebar:
  hidden: true
...
<Pronunciation word="Since" uk="/sɪns/" us="/sɪns/" client:only />
...
<WordRelations synonyms={["sith", "sithen"]} antonyms={["until"]} client:only />
