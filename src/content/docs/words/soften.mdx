---
title: Soften
description: Soften 是一个动词，主要意味着使变得柔软或使缓解。例如，我们可以通过加热将黄油变软，或通过和解的谈话让人的态度变得更温和。
sidebar:
  hidden: true
...
<Pronunciation word="Soften" uk="/ˈsɑfən/" us="/ˈsɔfən/" client:only />
...
"Soft" 这个词在英语中的最早使用可以追溯到公元前 700 年，最初源自古英语的 "sōfte", 后来演变为现在的 "soften"。
