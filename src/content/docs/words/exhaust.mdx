---
title: Exhaust
description: Exhaust 是一个英文动词，通常有两个主要含义：第一是 '用完，耗尽'（例如资源）；第二是 '使精疲力尽'。
sidebar:
  hidden: true
...
<Pronunciation word="Exhaust" uk="/ɪɡˈzɔːst/" us="/ɪɡˈzɔːst/" client:only />
...
<WordRelations synonyms={["consume", "spend", "weary"]} client:only />
