...
description: >-
  Tie
  是一个多义的英文单词，在不同的上下文里可能有多个含义。最常见的意思是“系，绑，打结”，用作动词和名词。另一意思是“连接，联系”，还可以表示“平局，相等”。
sidebar:
  hidden: true
...
<Pronunciation word="Tie" uk="/taɪ/" us="/taɪ/" client:only />
...
<WordRelations synonyms={["bond", "draw", "necktie", "sleeper"]} client:only />
