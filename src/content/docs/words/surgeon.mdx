---
title: Surgeon
description: Surgeon 是英语中的一个常见单词，该词是名词，指的是在医院或诊所工作，执行手术的医生，即“外科医生”。
sidebar:
  hidden: true
...
<Pronunciation word="Surgeon" uk="/ˈsɜːdʒən/" us="/ˈsɜːdʒən/" client:only />
...
"Surgeon" 这个词在历史上有着丰富的背景。其首次出现于 14 世纪，最早源自拉丁语 surgentem，意为“一个进行切开或劈开的人”。此后，经过几个世纪的语言演变，成为我们现在所熟知的 "surgeon"。
...
<WordRelations synonyms={["chirurgeon", "sawbones"]} client:only />
