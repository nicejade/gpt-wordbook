...
title: Employ
description: >-
  - `Employ`这个单词来源于法语`employer`，意思是“使用，雇佣”，在现代英语中主要具有以下两个含义： 1.
  作为动词，表示“使用”或者“利用”。如：We need to employ new strategies to deal with the
  problem.（我们需要采用新的策略来处理这个问题。） 2. 作为动词，表示“雇佣，雇用”。如：She is employed as a teacher
  at a local school.（她在一个本地学校被雇佣为教师。）
sidebar:
  hidden: true
...
许多人在学习单词“employ”的同时，会把它与 employee（雇员）和 employer（雇主）这两个词一起记忆，这样可以形成一种含义上的联系，帮助记忆。
