---
title: Hurricane
description: Hurricane 是一个名词，指的是“飓风”，这是一种出现在热带海洋上的强烈气候现象。
sidebar:
  hidden: true
...
<Pronunciation word="Hurricane" uk="/ˈhʌɹɪkən/" us="/ˈhɝɪˌkeɪn/" client:only />
...
"Hurricane" 的使用开始于 16 世纪，用于描述在加勒比地区经常出现的强烈热带风暴。这个词在英语中表示大风暴，尤其是那些在大西洋地区生成并对陆地产生威胁的风暴。
