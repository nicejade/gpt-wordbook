...
title: Cathedral
description: >-
  Cathedral是一个名词，原义是指一个由一个主教或大主教主持的基督教教堂，也是他们的官方办公地点。在更广义的讲法中，它可以指任何较大或重要的教堂，不一定由主教主持。
sidebar:
  hidden: true
...
"Cathedral"这个词最初在英语中的使用日期可以追溯到 14 世纪，源自拉丁语的"cathedra"。在欧美文化中，大教堂往往是城市的地标和象征，也是宗教活动和社区活动的重要场所。
