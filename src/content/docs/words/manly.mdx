---
title: Manly
description: Manly 是一个形容词，意为“有男子气概的，像男人的”。它和 “man”（男人）同源，设置 '-ly' 的后缀给它带来形容词的属性。
sidebar:
  hidden: true
...
<Pronunciation word="Manly" uk="/ˈmænli/" us="/ˈmænli/" client:only />
...
-Man 是主词根，意为“男人”，ly 是常见的形容词后缀，例如: happily, badly 等。
...
<WordRelations antonyms={["womanly"]} client:only />
