---
title: Playmate
description: Playmate是一个英文单词，指的是游戏伙伴或玩伴。
sidebar:
  hidden: true
...
"Playmate"这个词最早可以追溯古英语中的"plægge"（play）和"gemetta"（mate）。Playmate 在美国文化中被广泛用作称呼童年玩伴。
...
<WordRelations synonyms={["playfellow"]} client:only />
