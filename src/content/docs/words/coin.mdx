---
title: Coin
description: 英语单词 'coin' 主要有两个基本的含义：
sidebar:
  hidden: true
...
<Pronunciation word="Coin" uk="/kɔɪn/" us="/kɔɪn/" client:only />
...
"coin" 最早在 14 世纪进入英语，源于法国词 "coigne"，意思是角，内涵是硬币的角状。它反映了古代人们铸币的方法，用楔子形状的模具来铸造硬币。
...
<WordRelations
  synonyms={["chip","money","wedge","invent","originate","manufacture","mint"]}
  client:only
/>
