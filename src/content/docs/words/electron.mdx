---
title: Electron
description: Electron 是一个英文单词，中文含义是“电子”。电子是物质的基本粒子之一，在原子或者分子中围绕原子核运动，且带有负电荷。
sidebar:
  hidden: true
...
<Pronunciation word="Electron" uk="/ɪˈlɛktɹɒn/" us="/ɪˈlɛktɹɑn/" client:only />
...
<WordRelations synonyms={["negatron"]} client:only />
