---
title: Rational
description: Rational是一个形容词，根据上下文的不同可以翻译成“理性的”，“合理的”，或者“有理数的”。
sidebar:
  hidden: true
...
<Pronunciation word="Rational" uk="/ˈɹæʃ(ə)nəl/" us="/ˈɹæʃ(ə)nəl/" client:only />
...
Rational 其词根是“Ration”，一个拉丁词源，意为“计算”，“思考”。
...
"Rational" 一词源于 14 世纪的拉丁语 rationalis，意为"逻辑的，明理的"，这是欧美文化强调理性思考和逻辑推理的一种反映。

### 单词变形

Rational 的名词形式是“rationality” (理性)，反义词是"irrational" (无理的, 不合理的)。
...
<WordRelations
  antonyms={["arational","irrational","absurd","nonsensical"]}
  client:only
/>
