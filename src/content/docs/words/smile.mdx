...
title: Smile
description: >-
  Smile 在英语中是一个动词或名词，主要用来描述脸部的一个表情，通常表达欢乐、喜悦或者满足的情绪。当我们说到 'smile at
  someone'时，通常意味着向某人微笑。
sidebar:
  hidden: true
...
<Pronunciation word="Smile" uk="/ˈsmaɪ.əl/" us="/ˈsmaɪ.əl/" client:only />
...
<WordRelations synonyms={["treat"]} client:only />
