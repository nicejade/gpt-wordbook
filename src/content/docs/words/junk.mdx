...
title: Junk
description: >-
  Junk是一个英文单词，主要有两个意思。第一个意思是'废旧物品'，通常指无用或者不再需要的东西。第二个意思是'垃圾食品'，指的是营养价值低，含糖、盐、脂肪等过高的食物。
sidebar:
  hidden: true
...
<Pronunciation word="Junk" uk="/dʒʌŋk/" us="/dʒʌŋk/" client:only />
...
"Junk"在 14 世纪的时候是指用来制作船只的旧绳索，由于它们在使用中磨损严重，所以无法再进行其他用途，从而演变为现在表示“无用的东西”的含义。"Junk food"的概念则比较新，大约在 20 世纪 70 年代开始流行。
...
<WordRelations
  synonyms={["bin","chuck","discard","dispose","ditch","dump","scrap","toss","trash"]}
  client:only
/>
