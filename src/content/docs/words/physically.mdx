...
title: Physically
description: >-
  Physically 这个单词由 physic（体质，物理）+ -ally
  （表副词后缀）组成，是一个副词，用来描述任何和身体、物理或自然科学相关的行为或特性。常见的定义有：
sidebar:
  hidden: true
...
<Pronunciation word="Physically" uk="/ˈfɪzɪkli/" us="/ˈfɪzɪkli/" client:only />
...
Physically 这个词源自拉丁语，由 physic（自然科学）和 -ally（表示方式或状态的副词后缀）组成，于 16 世纪末开始广泛使用，经常用于医学和自然科学领域。
