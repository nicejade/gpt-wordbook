---
title: Corps
description: Corps 是英文单词，表示"团体"或者"军团"。
sidebar:
  hidden: true
...
Corps 是一个不规则的单词，它的词根来源于拉丁文"corpus"，意为"身体"。在英文中，corps 被用来指代由某一目标或事业合在一起的团体。
...
Corps 本身就是一个名词，没有特殊的变形。复数形式依然是 corps，并且在发音时最后的"s"是静音。

### 记忆辅助

由于 corps 的末尾"s"是静音，可以将其联想成一个团体，它的末尾有许多"沉默"的成员。
