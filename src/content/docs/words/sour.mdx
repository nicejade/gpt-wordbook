---
title: Sour
description: Sour 是一个形容词，意思是酸的，同时也有意味着糟糕，恶化的含义。也可以作为动词，意为变酸或变糖。
sidebar:
  hidden: true
...
<Pronunciation word="Sour" uk="/ˈsaʊə/" us="/ˈsaʊ(ə)ɹ/" client:only />
...
<WordRelations antonyms={["sweet"]} client:only />
