...
title: Congress
description: >-
  Congress首要的意思是“国会”，尤其是在美国，我们常常使用'Congress'来指代美国立法机构的名字。另外，它也可以用作'会议'，'集会'这样的意思。例如，'a
  congress of physicists'（物理学家的会议）。
sidebar:
  hidden: true
...
<Pronunciation word="Congress" uk="/ˈkɒŋˌɡɹɛs/" us="/ˈkɑŋɡɹɛs/" client:only />
...
Congress 是由拉丁文词根 "con-" 和 "gradi"组成。其中 "con-" 表示"together"（一起），而 "gradi" 表示“走”。

衍生出来的其他单词包括"gradient"（坡度），"egress"（出口）。

### 词缀分析

Congress 中的 "-s"是名词的常见后缀，表示复数。

### 文化背景

词语“Congress”最早出现在 15 世纪，其时也就代表着“一群人聚在一起”。然后到了 18 世纪初，它开始被广泛运用于政治领域，用于表示代表性的立法机构。
...
<WordRelations
  synonyms={["assembly", "legislature", "parliament", "federation"]}
  client:only
/>
