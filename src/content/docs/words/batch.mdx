---
title: Batch
description: Batch这个单词在英语中的常用含义是“一批”，“一组”，通常用来形容一次完成或处理的事物的数量，比如一批人、一批货物等。
sidebar:
  hidden: true
...
<Pronunciation word="Batch" uk="/bæt͡ʃ/" us="/bæt͡ʃ/" client:only />
...
“Batch”这个词源自 11 世纪的老英语，原意指烘烤的面团，可以一次烤制的所有面包。中世纪晚期，词语中的"ch"用上了现在的发音，到了 240 年后，有"一批"的意思。这个词在工业革命后使用的特别广泛。
...
<WordRelations
  synonyms={["group", "lot", "pressing", "run", "recipe"]}
  antonyms={["continuous"]}
  client:only
/>
