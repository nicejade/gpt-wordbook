...
description: >-
  Life
  是一个名词，英文中的主要含义是生命，生活，和寿命等。这是一个非常泛泛的词，可以用来描述生物体从出生到死亡的整个过程，也可以用来描述个体的日常生活或经历。
sidebar:
  hidden: true
...
<Pronunciation word="Life" uk="/laɪf/" us="/laɪf/" client:only />
