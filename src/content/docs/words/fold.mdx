...
title: Fold
description: >-
  Fold 主要有两个基本含义。首先，它是一个动词，表示“折叠”、“折翻”，比如可以用来描述将衣物整洁地折叠好。其次，'fold'
  也可以作名词，指的是折痕或者褶皱，比如在纸张或布料上的折痕。
sidebar:
  hidden: true
...
<Pronunciation word="Fold" uk="/fəʊld/" us="/foʊld/" client:only />
...
<WordRelations
  synonyms={["bend","crease","bending","creasing","concede","yield"]}
  antonyms={["unfold"]}
  client:only
/>
