---
title: Approximately
description: Approximately 是一个副词，用来表示'大约'或'近似'的意思。当我们不能或不需要提供精确的数值或描述时，我们会用到这个词。
sidebar:
  hidden: true
...
"I will arrive at the airport at approximately 6pm."（我将约在下午 6 点到达机场。）
"He spent approximately 500 dollars on shopping."（他在购物上花了大约 500 美元。）
"Approximately 20% of the students failed the exam."（大约 20%的学生没通过考试。）
