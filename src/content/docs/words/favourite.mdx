---
title: Favourite
description: Favourite是个形容词，表达最喜欢的或首选的意思。 这个单词也可以被用做名词，表示最喜欢的人，事物或活动。
sidebar:
  hidden: true
...
<Pronunciation word="Favourite" uk="/ˈfeɪv.ɹɪt/" us="/ˈfeɪv.ɹɪt/" client:only />
...
它最初源自 14 世纪的法语词"favoirit"（表“偏爱的”意思），然后进入英语中变为"favourite"。
...
<WordRelations antonyms={["unfavorite", "unfavourite"]} client:only />
