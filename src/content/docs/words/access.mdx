...
title: Access
description: >-
  Access是一个英文词汇，作为名词时，主要意思是'通道'、'接入'、'访问'或'存取'，用来表示得到某物或接触某物的机会或权利。作为动词时，意思是'接近'、'进入'、'获得'或'使用'。
sidebar:
  hidden: true
...
<Pronunciation word="Access" uk="/ˈæksɛs/" us="/ˈækˌsɛs/" client:only />
...
"Access"最早在大约 15 世纪中期由拉丁语引入英语，原为名词，代表了"到达、进入"的意思。后来进一步发展演变，增加了"访问、使用权限"的含义。到了 20 世纪，计算机技术的普及更让这个词具有了"在线获取、存取（信息或资源）"的含义，如 "access a file"。
