...
title: Intrinsic
description: >-
  Intrinsic 是一个形容词，来源于拉丁语的
  'intrinsecus'，意思是内在的，本质的，固有的。当我们说某件事物的价值、性质、特质或力量是内在的时，就会用到这个词。
sidebar:
  hidden: true
...
<Pronunciation word="Intrinsic" uk="/ɪn.ˈtɹɪn.zɪk/" us="/ɪn.ˈtɹɪn.zɪk/" client:only />
...
<WordRelations
  synonyms={["essential","inherent","innate"]}
  antonyms={["extrinsic"]}
  client:only
/>
