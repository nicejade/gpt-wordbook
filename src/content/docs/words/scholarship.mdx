---
title: Scholarship
description: Scholarship 的主要含义是'奖学金'，是用于资助学生继续他们的教育的资金。 此外，这个词也可以指'学识'或'学术成就'。
sidebar:
  hidden: true
...
<Pronunciation word="Scholarship" uk="/ˈskɒləʃɪp/" us="/ˈskɒləʃɪp/" client:only />
...
Scholarship 的词根是 scholar, 意为"学者", 来自拉丁语的"scholasticus"，意为"属于学校的"，它的后缀 '-ship' 表示 "状态或质量”。
...
<WordRelations
  synonyms={["allowance","bursary","grant","stipend","subsidy"]}
  client:only
/>
