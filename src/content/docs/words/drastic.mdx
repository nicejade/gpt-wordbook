---
title: Drastic
description: Drastic是一个形容词，表示“猛烈的”、“剧烈的”、“激烈的”、“极端的”。
sidebar:
  hidden: true
...
<Pronunciation word="Drastic" uk="/ˈdɹɑːs.tɪk/" us="/ˈdɹæs.tɪk/" client:only />
...
<WordRelations synonyms={["draconian"]} client:only />
