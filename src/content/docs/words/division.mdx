---
title: Division
description: Division（除法）在英语中主要是一个名词，它有分支或部门的意思，同时在数学中代表除法。
sidebar:
  hidden: true
...
<Pronunciation word="Division" uk="/dɪˈvɪʒən/" us="/dɪˈvɪʒən/" client:only />

### 列举例句

1.  "The company announced a division of its business."（公司宣布业务分割。）
2.  "The competition has three divisions."（比赛分为三个级别。）
3.  "In mathematics, four divided by two is an example of division." (在数学中，4 除以 2 是除法的一个例子。)
