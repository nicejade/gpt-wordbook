---
title: Kingdom
description: Kingdom 是一个英文名词，表示'王国'，一种由君主（通常是国王或女王）统治的领土或国家。
sidebar:
  hidden: true
...
<Pronunciation word="Kingdom" uk="/ˈkɪŋdəm/" us="/ˈkɪŋdəm/" client:only />
...
<WordRelations synonyms={["regnum"]} client:only />
