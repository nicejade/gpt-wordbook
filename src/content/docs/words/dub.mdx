...
title: Dub
description: >-
  dub 可以是名词也可以是动词。作为动词，它的基本意思是“授予……称号”，比如称某一首歌为“年度最佳单曲”。然而，'dub'
  最常用的意思可能还是“配音”。例如，在动画、电视剧或电影中替换演员的原声。
sidebar:
  hidden: true
...
<Pronunciation word="Dub" uk="/dʌb/" us="/dʌb/" client:only />
...
"dub" 这个词在古英语中被用来表示“封爵”，就像在剑上轻轻一点作为封爵仪式的一部分。不过，现代最常见的含义“配音”则大约于 20 世纪中期开始流行。
