...
title: Creep
description: >-
  Creep 是一个极为常用并且含义丰富的词汇。它主要表示“缓慢地、小心翼翼地移动”，仿佛是在悄悄接近某个目标；另外，“creep”
  还可以用来形容使人感到毛骨悚然或不舒服的人或事情。
sidebar:
  hidden: true
...
<Pronunciation word="Creep" uk="/kɹiːp/" us="/kɹiːp/" client:only />
...
Creep 的最早使用可以追溯到公元前 725 年的 Beowulf 史诗。在美国，互联网文化中常用"creep"形容在线上行为不当甚至是让人感到不安的人。
...
<WordRelations synonyms={["crawl"]} client:only />
