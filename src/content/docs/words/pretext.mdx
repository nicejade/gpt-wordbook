---
title: Pretext
description: Pretext是一个英文名词，它的意思是借口或托辞，用于掩饰真实的动机或行动。
sidebar:
  hidden: true
...
<Pronunciation word="Pretext" uk="/ˈpɹiːtɛkst/" us="/ˈpɹiːtɛkst/" client:only />
...
"Pretext"首次出现在 16 世纪英文中，它的本意是从一种事物去推断另一种隐藏的或不明显的事物，后演变成现在的“借口，托词”的含义。
...
<WordRelations synonyms={["blag"]} client:only />
