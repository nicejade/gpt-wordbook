---
title: Nowadays
description: Nowadays 是一个副词，用来描述在当前的时间或者周期内的情况，相当于中文里的 '现今'，'如今'，'现在'。
sidebar:
  hidden: true
...
<Pronunciation word="Nowadays" uk="/ˈnaʊ.ə.deɪz/" us="/ˈnaʊ.ə.deɪz/" client:only />
...
- "Now": 表示“现在，此刻”， offer 的词意中后缀“-fer”源自拉丁语，表示“带来，给予”，如同常见的单词 transfer (转移)， refer (参考)等。
...
"Nowadays"一词在英语历史上的使用已经有很长一段时间了，源自中世纪英语，最早记载于 14 世纪，用来描述那个时代的当时。在历史的发展中，"nowadays"的含义并未发生显著的变化，一直用来描述"当前的"或"现代的"情况。
