---
title: Peasant
description: Peasant 是一个英文名词，主要指的是从事农业的农民。一般情况下，它对应的中文翻译是“农民”或者“乡下人”。
sidebar:
  hidden: true
...
<Pronunciation word="Peasant" uk="/ˈpɛzənt/" us="/ˈpɛzənt/" client:only />
...
<WordRelations
  synonyms={["boor","peon","serf","rustic","villager"]}
  client:only
/>
