---
title: Inflate
description: Inflate 是一个动词，主要有两个含义：1）使充气；2）使膨胀或更大。例如，我们可以'inflate' 一个气球，也可以'inflate'价格或数字。
sidebar:
  hidden: true
...
<Pronunciation word="Inflate" uk="/ɪnˈfleɪt/" us="/ɪnˈfleɪt/" client:only />
...
"Inflate"的词缀是前缀 in-，它在这里并没有否定的意思，表示“进入”的概念，跟 -flate(吹)组成 inflate。其他具有这个词缀的单词还有，例如，introduce (介绍), include (包括)。

### 文化背景

“Inflate”这个词源于拉丁语，它在 17 世纪进入英语，最初的意思是“充气”，后来才演变成“扩大”或“增加”的意思。在现代英语中，"inflate" 不仅可以用于实体的 "膨胀"（如球类、气囊等），也经常用于抽象概念的 "膨胀"（如经济、价格、期望等）。
...
<WordRelations antonyms={["deflate"]} client:only />
