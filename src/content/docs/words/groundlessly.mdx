---
title: Groundlessly
description: "Groundlessly 是一个副词，源于形容词 'groundless'，意思是“无理由的，无根据的”，常用在英语的口语和书面语中。使用 'groundlessly' 的时候通常是用来描述一个行动或者陈述没有任何根据或依据。"
sidebar:
  hidden: true
...
"Groundless" 的词源可以追溯到 16 世纪的英语。该词语在这个时期被用来形容无根据或无理由的行为或陈述。
