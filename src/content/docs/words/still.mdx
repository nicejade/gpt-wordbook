---
title: Still
description: Still 是一种常用英文单词，常作副词，形容词和名词使用，有多种不同的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Still" uk="/stɪl/" us="/stɪl/" client:only />
...
<WordRelations
  synonyms={["lull","quiet","respite","rest","tranquility","hushed","tranquil","incessant","ongoing","unremitting","flat","fixed","inert","stagnant","static","stationary"]}
  client:only
/>
