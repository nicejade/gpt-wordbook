...
description: >-
  Wrong
  是一个英文单词，它可以作为名词、形容词、副词和动词使用。最常用的含义是'不正确的'或'错误的'，表示有事情与事实或期待相悖，有时也表示'不公正的'或'不道德的'，指行为违反公正准则或道德规范。
sidebar:
  hidden: true
...
<Pronunciation word="Wrong" uk="/ɹɒŋ/" us="/ɹɔŋ/" client:only />
...
Wrong 这个词的起源可以追溯到公元 1000 年前后的古英语中，当时的意思指的是"不正常的"或"弯曲的"。在这个过程中，Wrong 已经有“不道德的”或“不公正的”含义，这也是我们现在最常使用的含义。
...
<WordRelations
  synonyms={["detrimental","false","faulty","injurious","unfit","unjust","unsuitable"]}
  antonyms={["right"]}
  client:only
/>
