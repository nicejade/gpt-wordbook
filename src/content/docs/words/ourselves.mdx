...
title: Ourselves
description: >-
  Ourselves 是一个反身代词，通常用于强调主语。它指的是 'we' 或 'us' 这两个词的人。例如，我们可能会说，'We did it
  ourselves'（我们自己做的）。
sidebar:
  hidden: true
...
<Pronunciation word="Ourselves" uk="/aʊəˈsɛlvz/" us="/aʊɚˈsɛlvz/" client:only />
...
<WordRelations synonyms={["usself", "weself"]} client:only />
