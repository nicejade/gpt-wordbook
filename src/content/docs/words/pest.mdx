...
title: Pest
description: >-
  pest 是英语中的一个常见单词，它的基本含义是 '害虫' 或者
  '令人讨厌的人或事物'。当用来描述动物或植物时，通常指的是对环境造成破坏或者对人类造成伤害的种类；而当描述人时，则是指行为让人烦躁或者干扰到别人的人。
sidebar:
  hidden: true
...
<Pronunciation word="Pest" uk="/pɛst/" us="/pɛst/" client:only />
...
"pest" 这个词在英语中的使用可以追溯到 16 世纪。最早的时候它被用来描述各种令人恼怒的昆虫，后来扩展到了任何能搞破坏的动物，甚至用来形容人的行为。
...
从前，有一只名叫 Tiny 的害虫。Tiny 想要融入其他昆虫的群体，但所有的昆虫都怕他，因为他有破坏它们家园的能力。

<WordRelations synonyms={["bug"]} client:only />
