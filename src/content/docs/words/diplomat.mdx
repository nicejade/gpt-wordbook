...
description: >-
  Diplomat
  是个名词，描述一种职业，是指代表一个国家政府与别国政府或国际性组织进行谈判及处理国际事务等活动的公务员或外交官员。家庭生活，商业社会，人际关系中，'diplomat'也可描述很擅长处理敏感或困难问题的人。
sidebar:
  hidden: true
...
这个单词源于希腊的 diplo，意为“两倍”。而"diplomat"中包含了“diplo”，也许是因为外交官通常需要处理两国（或多国）之间的事务。
...
这个词车源于 18 世纪，最初引用的是一种折叠文件，即“diploma”。然后，专门处理这些文件的人被称为“diplomat”。现在，"diplomat" 已经发展成描述代表国家进行国际关系工作的人。

### 单词变形

Diplomat 本身是名词。形容词形式为"diplomatic"，意为外交的，有外交手腕的,副词形式是“diplomatically”。
...
<WordRelations synonyms={["diplomatist"]} client:only />
