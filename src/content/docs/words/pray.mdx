---
title: Pray
description: Pray 是个动词，它的中文翻译是 “祈祷”。英语中的 'pray' 通常用于表达向神或其他被视为神圣的实体进行祈求的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Pray" uk="/pɹeɪ/" us="/pɹeɪ/" client:only />
...
"Pray"这个词在历史上尤其与宗教文化的发展紧密相关。这个词最初的使用可追溯到 12 世纪，早期主要用于宗教文本中，用于描述宗教仪式中的祈祷活动。
