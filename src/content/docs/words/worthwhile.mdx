---
title: Worthwhile
description: Worthwhile这个单词的含义是“值得的，有价值的”，用来形容由于带来帮助、成功或欢乐因此值得去做的一些事情。
sidebar:
  hidden: true
...
<Pronunciation word="Worthwhile" uk="/wɜː(ɹ)θˈwaɪl/" us="/wɜː(ɹ)θˈwaɪl/" client:only />
...
"Worthwhile"这个单词是在 late 19 世纪晚期的英美文化语境中被广泛使用，常被用来激励个人完成某事，强调回报与付出相匹配。
