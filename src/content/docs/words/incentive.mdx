...
title: Incentive
description: >-
  Incentive是一个名词，其定义为刺激措施或奖励，一种鼓励取得特定成果或行为的方式。例如，公司可能会为高效的员工提供金钱作为奖励，这就属于一种“incentive”。
sidebar:
  hidden: true
...
<Pronunciation word="Incentive" uk="/ɪnˈsɛntɪv/" us="/ɪnˈsɛntɪv/" client:only />
...
“Incentive”源自 15 世纪的拉丁语“incendere”，从中我们可以看出奖励在鼓励产品性和行为上的基本作用是“点燃”或“激发”。
...
<WordRelations antonyms={["disincentive"]} client:only />
