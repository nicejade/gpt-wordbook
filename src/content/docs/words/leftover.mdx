---
title: Leftover
description: Leftover 是一个名词，表示“剩余的东西”。它通常用于指剩下的食物，但也可以用于描述其他剩余的或未使用的物品。
sidebar:
  hidden: true
...
"Leftover"这个词源于 19 世纪的英国，最初用来描述剩余的食物。英国的烹饪文化有的时候会摒弃浪费，因此，"leftover"这个词的使用频率遂逐渐增加，尤其是在二战期间，由于物资短缺，人们尽其所能的消耗所有资源，这一单词的使用更为普遍。

### 单词变形

Leftover(剩余的东西)，Leftovers（复数形式，剩余的东西），Leftover 作为形容词时意为“剩余的”，如 leftover food 表示“剩余的食物”。
