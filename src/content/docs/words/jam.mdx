...
title: jam
description: >-
  Jam 是一个英语词汇，可以作为名词或者动词使用，具有多种含义： * （名词）果酱，例如：She spread the toast with
  strawberry jam (她在吐司上抹了草莓果酱) * （名词）堵塞 或 阻塞，例如：There was a huge traffic jam on
  the highway (高速公路上发生了严重的交通堵塞) * （动词）把...塞满，使...阻塞，例如：He jammed his clothes
  into the suitcase (他把衣服塞进行李箱) 列举例句 1. The jam is made of fresh fruits.
  (这种果酱是用新鲜的水果制作的。
sidebar:
  hidden: true
