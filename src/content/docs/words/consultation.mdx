---
title: consultation
description: 当然，这是一个很有用的单词，让我们开始分析 consultation 这个单词吧。
sidebar:
  hidden: true
...
- "Consultation" 这个词源自拉丁语 "consultare"，在英语中的使用始于 16 世纪，其实一直保持着"寻求意见"或"获得咨询"的意义。

### 单词变形

- 该词作为名词，没有单复数和不同的时态，但其动词形式 "consult" 有不同的时态, 如 consulted，consulting。
