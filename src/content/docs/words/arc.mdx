---
title: Arc
description: arc是一个英语单词，作为名词，它的主要含义是'弧'或'弧形'， 作为动词，它表示'形成弧形'。
sidebar:
  hidden: true
...
<Pronunciation word="Arc" uk="/ɑːk/" us="/ɑɹk/" client:only />
...
<WordRelations synonyms={["curve", "swoop", "arrow"]} client:only />
