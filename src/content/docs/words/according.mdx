...
title: According
description: >-
  According 是一个英文介词，用于表示'根据…，按照…'。比如说，'According to the teacher, we have to
  finish the homework before tomorrow.' (根据老师的说法，我们必须在明天之前完成作业。)
sidebar:
  hidden: true
...
<Pronunciation word="According" uk="/əˈkɔːdɪŋ/" us="/ə.ˈkɔɹd.ɪŋ/" client:only />

### 列举例句

1.  "According to the schedule, the meeting starts at 10:00 AM." (根据日程安排，会议将在上午 10:00 开始。)
