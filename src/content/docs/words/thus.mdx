---
title: Thus
description: Thus 是一个副词，常用作连接词，表示结果或者原因，并通常用于正式的文体。因此，“thus”在口语中并不常用，更常用的一个同义词是'so'。
sidebar:
  hidden: true
...
<Pronunciation word="Thus" uk="/ˈðʌs/" us="/ˈðʌs/" client:only />
...
<WordRelations
  synonyms={["before","consequently","hence","so","therefore","this","thusly"]}
  client:only
/>
