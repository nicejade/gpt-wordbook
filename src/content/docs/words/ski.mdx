...
title: Ski
description: >-
  Ski 是个英语词汇，其主要含义为 “滑雪”，这里包括了动词和名词两种用法。作为动词，'Ski'
  是描述人们在雪地或冰上通过滑雪板滑行的行为。作为名词，'Ski' 是指滑雪板。
sidebar:
  hidden: true
...
<Pronunciation word="Ski" uk="/ʃiː/" us="/ʃiː/" client:only />
...
"Ski" 是个源自北欧的词汇，最早的滑雪板可能存在于挪威东部的 5,000 年前。人们以此作为雪地通行或狩猎的工具。今日，滑雪已经成为了一种广受欢迎的户外运动和冬季奥运会项目。
