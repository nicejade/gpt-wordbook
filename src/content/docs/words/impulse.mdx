---
title: Impulse
description: Impulse 是一个名词，其主要意思是 '冲动'，表示一股一时的强烈愿望或动力。它也可以用来形容一种物理现象，即力的瞬间效应，例如'动量”。
sidebar:
  hidden: true
...
<Pronunciation word="Impulse" uk="/ˈɪmpʌls/" us="/ˈɪmpʌls/" client:only />
...
在 14 世纪，"Impulse"被引入英语中，主要用于物理学中描述力的瞬时推动效果。随后，它在心理学中被广泛应用以形容一种忽然的强烈欲望或驱使。

### 单词变形

- 动词形式: Impulse 没有动词形式，但有近义词 "impel"（推动）
- 形容词形式: Impulsive （冲动的）
