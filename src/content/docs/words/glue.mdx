---
title: Glue
description: Glue 是一个英语单词，意思是“胶水”，作为名词，它常用于表示用来粘合东西的一种物质。也可以作为动词，意思是“粘合”、“粘住”。
sidebar:
  hidden: true
...
<Pronunciation word="Glue" uk="/ɡluː/" us="/ɡluː/" client:only />
...
<WordRelations
  synonyms={["adhere","cling","stick","gum","paste"]}
  client:only
/>
