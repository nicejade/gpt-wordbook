...
title: Luxury
description: >-
  Luxury 是一个名词，意思是奢侈，指过分或昂贵的物质享受。比如，豪华的汽车、珠宝，或者住在豪华酒店等。在形容词形式 'luxurious'
  ，意为豪华的，奢侈的。
sidebar:
  hidden: true
...
<Pronunciation word="Luxury" uk="/ˈlʌk.ʃə.ɹi/" us="/ˈlʌkʃəɹi/" client:only />
...
"Luxury" 这个词源自 13 世纪的法国，起初是负面的，含有放纵、过度的含义。到了后来，它的定义逐渐转变为物质和精神上的享受，尤其是指那些非必需但愉快和有趣的东西。
...
<WordRelations antonyms={["necessity"]} client:only />
