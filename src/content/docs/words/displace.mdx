...
description: >-
  Displace
  是一个动词，主要含义是“取代”、“移置”或“置换”。例如，如果一个物体被另一个物体所取代，或者如果人们被从他们的家园赶出来，那么就可以说他们被'displace'了。
sidebar:
  hidden: true
...
<Pronunciation word="Displace" uk="/dɪsˈpleɪs/" us="/dɪsˈpleɪs/" client:only />
...
"Displace"这个词首次出现在公元 14 世纪的英语中，直译就是"移动从其原来的位置"。这个词的引申意，比如"取代"，则是在公元 19 世纪开始出现的。
