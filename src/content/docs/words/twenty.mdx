---
title: Twenty
description: Twenty 是一个英文词汇，它是一个基数词，表示的数目是 20。在汉语中，我们可以把它译为'二十'。
sidebar:
  hidden: true
...
"Twenty" 是一个英文词汇，它是一个基数词，表示的数目是 20。在汉语中，我们可以把它译为"二十"。

<Pronunciation word="Twenty" uk="/ˈtwɛnti/" us="/ˈtwɛni/" client:only />
...
这个单词最初源于古英语的"twentig"，可能是两个 10 的意思。在英语文化中，二十岁被视为一个成年的重要里程碑。
