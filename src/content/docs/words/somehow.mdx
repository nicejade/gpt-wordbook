---
title: Somehow
description: somehow是一个副词，用于表示某种方式或方法，尽管你可能不清楚具体是什么。它通常用于描述你不确定如何完成的事情，或者你不确定事情是怎么发生的。
sidebar:
  hidden: true
...
<Pronunciation word="Somehow" uk="/ˈsʌmhaʊ/" us="/ˈsʌmhaʊ/" client:only />
...
"somehow" 是由'some' 和 'how'组合而来的，这两个词在中世纪早期的英语中都有出现。"somehow"自 14 世纪起开始在英语文献中出现。
...
<WordRelations synonyms={["someway", "somewise"]} client:only />
