...
description: >-
  Wander
  是一个英文动词，主要有两个基本含义：1）漫无目的地走动或者旅行，强调对未知领域的冒险和探索，没有明确的方向或者目的。2）在思考或者话题上偏离，跳跃。包括对一个问题的思考没有聚焦，或者在谈话中频繁跳转话题。
sidebar:
  hidden: true
...
<Pronunciation word="Wander" uk="/ˈwɒndə/" us="/ˈwɑndɚ/" client:only />
...
<WordRelations synonyms={["cheat", "drift", "err", "roam"]} client:only />
