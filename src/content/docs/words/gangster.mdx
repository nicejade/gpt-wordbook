---
title: Gangster
description: Gangster是一种用于描述参与有组织犯罪行为的人的术语，他们通常是一个犯罪团队或黑社会的成员。
sidebar:
  hidden: true
...
<Pronunciation word="Gangster" uk="/ˈɡæŋstə/" us="/ˈɡæŋstə/" client:only />
...
"Gangster"这个词在 20 世纪初开始广泛使用，特别是在美国禁酒期间，黑帮犯罪活动猖獗。
