---
title: Retort
description: Retort在英语中可以作为名词和动词。作为名词时，它的意思是'尖锐的反驳'，而作为动词时，它是'犀利地回应'或'反驳'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Retort" uk="/ɹɪˈtɔːt/" us="/ɹɪˈtɔːt/" client:only />
...
<WordRelations synonyms={["comeback", "rejoinder"]} client:only />
