...
title: Clumsy
description: >-
  Clumsy' 是一个形容词，它的基本含义是“笨拙的”，既可以形容人的身体动作笨拙，例如 : '他总是那么笨拙，动不动就摔跤。'，也可以形容人的行为举止，如
  '他试图向她解释，但他的话语太笨拙了。
sidebar:
  hidden: true
...
<Pronunciation word="Clumsy" uk="/ˈklʌmzi/" us="/ˈklʌmzi/" client:only />
...
在寒冷的冬季，一个叫 Clumsey 的家伙特别笨拙，每天都会在雪地里滑倒。每次，他都会笑笑，然后再次站起来。

<WordRelations synonyms={["butterfingers", "galoot", "klutz"]} client:only />
