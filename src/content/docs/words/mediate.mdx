---
title: Mediate
description: Mediate 是动词，意为“调解”或“斡旋”，常用于描述协调、调解冲突或矛盾的过程，尤其在处理纠纷或达成和解的情况下。
sidebar:
  hidden: true
...
<Pronunciation word="Mediate" uk="/ˈmidi.ət/" us="/ˈmidi.ət/" client:only />
...
"Mediate" 来自拉丁语 "mediātus"，早在 16 世纪就引入英语，起初用于形容词中表示"中间的"、"间接的"，后来发展为动词，有“斡旋”的含义。
