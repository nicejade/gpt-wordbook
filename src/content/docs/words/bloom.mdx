---
title: Bloom
description: Bloom 在英语中是一个多义词，常见的意思有：
sidebar:
  hidden: true
...
<Pronunciation word="Bloom" uk="/bluːm/" us="/bluːm/" client:only />
...
"Bloom"最初在古英语中用作名词，表示花朵。在 14 世纪，它开始作为动词使用，表示植物开花或鲜花盛开的过程。在 19 世纪，"bloom"开始被用来描述人或事物的繁荣或最佳状态。
...
<WordRelations synonyms={["flush", "glow", "blossom", "flower"]} client:only />
