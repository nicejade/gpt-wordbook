...
description: >-
  Gesture
  是一个名词，意思是'手势'或'姿态'，是通过身体部位（尤其是手和手臂）的运动来表达特定信息或情感。此外，'gesture'也可以作为动词使用，意为'做手势'或'用动作示意'。
sidebar:
  hidden: true
...
<Pronunciation word="Gesture" uk="/ˈdʒɛs.tʃɚ/" us="/ˈdʒɛs.tʃɚ/" client:only />
...
<WordRelations synonyms={["gesticulate"]} client:only />
