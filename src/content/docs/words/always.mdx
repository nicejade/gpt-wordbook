...
title: Always
description: >-
  Always是一种副词，表示'一直，总是'的意思，用于描述一种持续不断或无异常变化的状态。例如：'I always do my homework.'
  林智展赌气说道'我总是做我的作业。
sidebar:
  hidden: true
...
<Pronunciation word="Always" uk="/ˈɔː(l).weɪz/" us="/ˈɔl.weɪz/" client:only />
...
<WordRelations
  synonyms={["continually","perpetually","anyhow","anyway","regardless","invariably","uniformly"]}
  antonyms={["never","manywise","sundrily","variously"]}
  client:only
/>
