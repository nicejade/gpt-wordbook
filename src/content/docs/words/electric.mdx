---
title: Electric
description: Electric这个单词在英文中是形容词和名词，主要表示与电有关的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Electric" uk="/əˈlɛktɹɪk/" us="/əˈlɛktɹɪk/" client:only />
...
<WordRelations synonyms={["electrical"]} antonyms={["steam"]} client:only />
