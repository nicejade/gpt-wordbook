---
title: Prosperity
description: Prosperity 是一个名词，意指 '富饶'，'繁荣' 或 '成功' 的状况。
sidebar:
  hidden: true
...
<Pronunciation word="Prosperity" uk="/pɹɒˈspɛɹ.ɪ.ti/" us="/pɹɑˈspɛɹ.ɪ.ti/" client:only />
...
<WordRelations
  synonyms={["affluence","richdom","weal","welfare"]}
  client:only
/>
