---
title: Incapable
description: incapable 是一个形容词，表示'无能的'或'无法的'。常用于描述一个人或事物无法完成某项特定任务或达到特定标准。
sidebar:
  hidden: true
...
"incapable" 这个词的使用开始于 16 世纪的法国，并在 17 世纪晚期扩散到了英国。这个词常用于法律和官方文件，表示一个人不具备完成某项工作的能力或技能。
