...
title: determine
description: >-
  determine这个单词，在英语中是一个动词，主要含有两种基本含义： 1. 决定或者确定，也可以解释为对某件事或某种情况的结果做出决定或者判断。比如：“I
  will determine my own future. (我会决定我自己的未来。) 2.
  引导或者影响，即一些因素或者原因会导致某种结果发生。例如：Genetics determine our physical traits.
  (基因决定我们的物理特性。)
sidebar:
  hidden: true
