...
title: Radius
description: >-
  "Radius"是一个名词，主要具有两个常用的意义： 1.
  在数学中，"radius"用来指描述圆或者球体的一种属性，也就是从圆心到圆周或球表的距离。中文翻译为“半径”。 2. 在其他常规的语境下，“radius”
  指的是某个特定点或物体周围的区域或范围。这通常在描述距离或者范围时使用。例如，"within a radius of ten miles"
  可理解为在十英里的半径范围内。中文翻译为“范围”或“半径”。
sidebar:
  hidden: true
