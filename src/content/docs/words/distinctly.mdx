---
title: Distinctly
description: Distinctly 这个单词是个副词，它的意思是'清晰地，明显地'。我们通常用它来描绘我们的视听感受或是对某种情况的理解辨识度。
sidebar:
  hidden: true
...
"Distinctly"这个单词的起源可以追溯到 14 世纪的老法语“distinct”, 又起源于拉丁文中的"distinctus"，它的意思是"清楚的，明显的"，这在英语语境中被广泛应用。
...
<WordRelations antonyms={["indistinctly"]} client:only />
