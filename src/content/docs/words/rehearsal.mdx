---
title: Rehearsal
description: '"Rehearsal"是一个英文单词，主要用来表示“排练”或 “预演”。 它指的是为了最后的演出或活动而进行的预先训练或模拟。'
sidebar:
  hidden: true
...
"Rehearsal"是由 latin 词根 "Hearsay"衍生出来的，"Hearsay"主要表示“说”，再加上前缀“re-”"再次"，所以"rehearsal"的字面意思是“再次说”的。
