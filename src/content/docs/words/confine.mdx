---
title: Confine
description: Confine 是一个动词，意思是'限制'，'局限'，'禁锢'。
sidebar:
  hidden: true
...
<Pronunciation word="Confine" uk="/ˈkɒnfaɪn/" us="/ˈkɒnfaɪn/" client:only />
...
<WordRelations synonyms={["border", "bound", "limit"]} client:only />
