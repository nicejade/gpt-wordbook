...
<WordRelations
  synonyms={["striker","front","forecast","predicted","bold","brazen","fresh","impertinent","ahead","forth","on","onward","onwards","forwards"]}
  antonyms={["back","posterior","rear","past","restrained","backward","backwards","reverse"]}
  client:only
/>
