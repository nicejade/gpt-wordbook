---
title: Forward
description: Forward 有多种含义，具体的词义取决于它在句子中的使用方式。
sidebar:
  hidden: true
...
<Pronunciation word="Forward" uk="/ˈfoːwəd/" us="/ˈfɔɹ.wɚd/" client:only />
...
"Forward"这个单词在英语中使用非常广泛和悠久。根据"Oxford English Dictionary"，"forward"的使用可以追溯到在早期的古英语文本中，例如 Beowulf，这是一部公元 1000 年左右的史诗。
...
<WordRelations
  synonyms={["attacker","striker","anterior","front","forecast","predicted","bold","brazen","fresh","impertinent","ahead","forth","on","onward","onwards","forwards","hereon"]}
  antonyms={["back","posterior","rear","past","restrained","backward","backwards","rearwards","reverse"]}
  client:only
/>
