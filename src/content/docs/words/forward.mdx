...
title: Forward
description: >-
  "Forward" 有多种含义，具体的词义取决于它在句子中的使用方式。 作为动词，"forward" 的意思是"向前送,
  批准；转交；促进"。例如在"Please forward my mail to my new address"中，"forward" 的意思是"转发"。
  作为副词或形容词，它表示"向前地；提前地，早"，例如在"The clock is fast and it's always five minutes
  forward"中，"forward" 的意思是"提前"。 作为形容词，它还能表示"进取的；鲁莽的，急切的"，例如"The child is very
  forward for her age"中，"forward"的意思是"过于成熟的"。
sidebar:
  hidden: true
