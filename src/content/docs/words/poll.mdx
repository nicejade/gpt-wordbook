---
title: Poll
description: "- 'Poll'作为名词的时候，可以指民意调查、投票等，指求取公众意见的过程。作为动词时，意为进行民意调查，或者投票。"
sidebar:
  hidden: true
...
<Pronunciation word="Poll" uk="/pɔl/" us="/poʊl/" client:only />
...
<WordRelations synonyms={["election", "survey", "scalp"]} client:only />
