---
title: Mutually
description: 英语单词'mutually'通常作为副词，含义为“互相地”，“彼此地”，表示一种互惠、双向的关系。
sidebar:
  hidden: true
...
<Pronunciation word="Mutually" uk="/-lɪ/" us="/-lɪ/" client:only />
...
<WordRelations
  synonyms={["collectively","equally","evenly","together","equivalently","reciprocally","similarly"]}
  client:only
/>
