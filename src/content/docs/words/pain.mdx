---
title: Pain
description: Pain 是一个名词，表示身体或心理上的痛苦。例如，你可能会因为头疼或者失去了你爱的人而感到痛苦。
sidebar:
  hidden: true
...
<Pronunciation word="Pain" uk="/peɪn/" us="/peɪn/" client:only />
...
<WordRelations synonyms={["pest"]} antonyms={["pleasure"]} client:only />
