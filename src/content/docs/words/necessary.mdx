---
title: Necessary
description: Necessary 是一个形容词，是英语中常见的词汇，表示'必要的'、'必须的'。用于描述某个动作或事物是无可避免或者是必须的。
sidebar:
  hidden: true
...
<Pronunciation word="Necessary" uk="/ˈnɛsəsɹɪ/" us="/ˈnɛsəˌsɛɹi/" client:only />
...
<WordRelations
  ...
  antonyms={["evitable", "impossible", "incidental", "unnecessary"]}
  client:only
/>
