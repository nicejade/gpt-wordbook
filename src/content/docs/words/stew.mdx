...
title: Stew
description: >-
  Stew 是一个名词，也可以被用作动词。作为一个名词，'stew'
  指的是一种烹调技术，我们将食物（尤其是肉类）用慢火和几乎全部液体熬煮的方法来烹调。同时，'stew'也广泛被用来描述熬出来的食物。作为一个动词，'stew'
  是指采用 stewing 这种烹调技术来熬炖食物。
sidebar:
  hidden: true
...
<Pronunciation word="Stew" uk="/stʃʉː/" us="/stʃʉː/" client:only />
...
<WordRelations
  synonyms={["casserole","hotpot","brood","fret","sweat","worry","bake","boil"]}
  client:only
/>
