---
title: Convene
description: Convene 是一个动词，意思是召集或召开（会议或集会）。可以指正式或不正式的聚集，特别是为了讨论和决定重要问题。
sidebar:
  hidden: true
...
<Pronunciation word="Convene" uk="/kənˈvɪin/" us="/kənˈvɪin/" client:only />
...
Convene 这个词来源于拉丁文 "convenire" ，意为 "come together"，在 15 世纪时进入英语词汇，常常用于正式的和政治的语境中。
...
<WordRelations
  synonyms={["assemble","collect","meet","summon","unite"]}
  client:only
/>
