---
title: Appliance
description: Appliance 是一个英语单词，通常指的是设备或者器具，特别是那些用于特定用途的机器或设备，例如家用电器。
sidebar:
  hidden: true
...
<Pronunciation word="Appliance" uk="/əˈplaɪəns/" us="/əˈplaɪəns/" client:only />
...
"Appliance" 首次在英语中使用是在 15 世纪，意为"满足，遵守"。之后在 16 世纪和 17 世纪，"appliance" 的含义发展为"执行，应用"，最终在 19 世纪发展为我们现在理解的"一种应用或者被应用的事物，设备或者器具"的意思。
...
<WordRelations
  synonyms={["application", "compliance", "cure", "medicine", "remedy"]}
  client:only
/>
