---
title: Someone
description: Someone 是一个英语代词，用于指代某个不确定的人。它的用法类似于 'somebody'。
sidebar:
  hidden: true
...
<Pronunciation word="Someone" uk="/ˈsʌmwʌn/" us="/ˈsʌmwʌn/" client:only />
...
<WordRelations synonyms={["anybody", "anyone", "somebody"]} client:only />
