---
title: Attempt
description: "Attempt 是一个动词，意为 '尝试', '试图'。当用作名词时，意为'尝试'，'努力'。"
sidebar:
  hidden: true
...
<Pronunciation word="Attempt" uk="/əˈtɛmpt/" us="/əˈtɛmpt/" client:only />
...
"Attempt" 的历史可追溯到 14 世纪的法语，来自拉丁词 "temptare" 意味着 "to try"。在大多数欧美文化中，"attempt" 被用来描述人们为实现特定目标或完成特定任务所做出的努力。
...
<WordRelations synonyms={["effort", "try"]} client:only />
