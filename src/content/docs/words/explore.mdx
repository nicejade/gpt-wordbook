...
<Pronunciation word="Explore" uk="/ɪkˈsplɔː/" us="/ɪkˈsplɔɹ/" client:only />
...
拥有类似词缀的单词有：export, exclaim, expand 等。

### 文化背景

"explore"首次出现在英语中是在 16 世纪，用来描述对新领域或者新想法的调查和研究.
...
<WordRelations synonyms={["delve", "research"]} client:only />
