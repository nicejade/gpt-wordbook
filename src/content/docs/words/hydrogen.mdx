...
title: Hydrogen
description: >-
  Hydrogen 是一个英文词汇，指的是一种非金属元素，具有化学符号 H，是宇宙中最丰富的元素。它是水的主要成分之一，其名称来源于希腊语
  'hydor'（水） 和 'genes'（生成）。在室温和常压下，氢是一种无色无味的气体。
sidebar:
  hidden: true
...
<Pronunciation word="Hydrogen" uk="/ˈhaɪdɹədʒ(ə)n/" us="/ˈhaɪdɹədʒən/" client:only />
