...
### 分析词义单词 "Resistance" 是英语中的一个名词，它的意思包含"抵抗"、"阻力"或者"反抗"等含义。它可以被用在很多领域比如物理学（指导体对电流的阻力），生物学（指生物体对疾病或病原体的抵抗力）以及社会学（指群体或个人对不公正现象的反抗或抵制）。
...
<WordRelations synonyms={["opposition"]} client:only />
