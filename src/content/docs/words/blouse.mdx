---
title: Blouse
description: "- 'Blouse' 是名词，指的是女士或儿童的衬衫，一般比衬衣更为宽松，和裙子或裤子配合穿着。"
sidebar:
  hidden: true
...
<Pronunciation word="Blouse" uk="/blaʊs/" us="/blaʊs/" client:only />
...
- "Blouse" 是在 19 世纪后期从法语引入英语的，原来是指 peasants (农民) 的罩衫，后来发展成为现在的意义，指女士的衬衫。
...
<WordRelations synonyms={["bodice"]} antonyms={["unblouse"]} client:only />
