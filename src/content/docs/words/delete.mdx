---
title: Delete
description: Delete 是一个动词，意思是删除，移除，从某个地方或某个东西中去掉部分或全部的词、符号、信息等。
sidebar:
  hidden: true
...
<Pronunciation word="Delete" uk="/diˈliːt/" us="/diˈliːt/" client:only />
...
<WordRelations
  synonyms={["clear","remove","strike","terminate"]}
