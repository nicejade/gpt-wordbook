...
title: Roam
description: >-
  英文单词'roam'主要有'漫游'、'漫步'、'闲逛'等意思。比如，我们常说'roam the streets'（在街上闲逛）、'roam the
  world'（环游世界）。
sidebar:
  hidden: true
...
<Pronunciation word="Roam" uk="/ɹəʊm/" us="/ɹoʊm/" client:only />
...
<WordRelations synonyms={["err", "shrithe", "wander"]} client:only />
