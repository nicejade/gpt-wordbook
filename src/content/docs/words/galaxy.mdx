---
title: Galaxy
description: "- Galaxy 是英语单词，中文翻译为'星系'，它指的是由星体、恒星的尘埃以及其他形式的物质组成的巨大的星际系统，绕着一个共享的重心旋转。"
sidebar:
  hidden: true
...
- Galaxy 是英语单词，中文翻译为"星系"，它指的是由星体、恒星的尘埃以及其他形式的物质组成的巨大的星际系统，绕着一个共享的重心旋转。

<Pronunciation word="Galaxy" uk="/ˈɡaləksi/" us="/ˈɡæləksi/" client:only />
...
- Galaxy 的词源来自于希腊语词根 gala， gala 在希腊语中的意思为“牛奶”，象征着星河璀璨如牛奶般的景象。

### 词缀分析

- Galaxy 这个单词本身既没有前缀也没有后缀。
...
- 单词 Galaxy 为名词，其单复数形式为: Galaxy (单数) / Galaxies (复数)
...
<WordRelations synonyms={["G", "trichiliocosm"]} client:only />
