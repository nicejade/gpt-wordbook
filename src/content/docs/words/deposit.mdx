---
title: Deposit
description: Deposit 主要有两个含义：一是名词，意为'存款'，'押金'或者'沉淀物'；二是动词，意为'存放'，“堆积”， '存款'等。
sidebar:
  hidden: true
...
<Pronunciation word="Deposit" uk="/dɪˈpɒzɪt/" us="/dɨˈpɑzɪt/" client:only />
...
<WordRelations antonyms={["withdrawal"]} client:only />
