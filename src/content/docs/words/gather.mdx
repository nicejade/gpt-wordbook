...
title: Gather
description: >-
  Gather 是一个动词，主要意思是聚集、收集。在不同的环境或者语境下，可以有其他的引申含义，例如，gather information
  （收集信息），gather strength （积蓄力量）等。
sidebar:
  hidden: true
...
<Pronunciation word="Gather" uk="/ˈɡæðə/" us="/ˈɡæðɚ/" client:only />

### 列举例句

- "Let's gather at the park at 6 pm."（我们 6 点在公园集合。）
...
<WordRelations synonyms={["aggroup", "togetherize"]} client:only />
