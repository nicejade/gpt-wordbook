---
title: Interpreter
description: Interpreter 是一个名词，有两个主要含义：
sidebar:
  hidden: true
...
<Pronunciation word="Interpreter" uk="/ɪnˈtɜːpɹɪtə/" us="/ɪnˈtɜːpɹɪtə/" client:only />
...
3.  Python is an **interpreter** language.（Python 是一种解释型语言。）
...
在国际会议上，一个名叫 Lily 的**翻译员**由于其出色的口译技能而引人注目。

<WordRelations
  synonyms={["terp","docent"]}
  client:only
/>
