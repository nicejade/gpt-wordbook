...
title: Boxing
description: >-
  Boxing 是英语中的一个动名词，主要有两个含义。首先，作为一个动词，'boxing' 表示'把...装箱'，例如 'I am boxing up my
  old clothes'（我正在把我的旧衣服装箱）。其次，它也是'拳击'的意思，如'Boxing is a tough
  sport'（拳击是一项艰难的运动）。
sidebar:
  hidden: true
...
<Pronunciation word="Boxing" uk="/ˈbɒksɪŋ/" us="/ˈbɒksɪŋ/" client:only />
...
汤姆每天早上 5 点就起床练习拳击。他决心赢得即将到来的拳击冠军。一天，当他正在把他的拳套和装备装箱的时候，他微笑着，想象着他将取得的胜利。

<WordRelations
  synonyms={["case","embox","encase","pack","package","fisticuffs","pugilism","sparring"]}
