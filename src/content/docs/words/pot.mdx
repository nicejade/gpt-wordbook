...
title: Pot
description: >-
  Pot 主要有两个含义。作为名词，它通常指的是我们用来煮食物的炊具，例如'cooking
  pot'。另一个常见的含义是作为动词，它常常被用在池艺和台球中，表示将球打入洞内。
sidebar:
  hidden: true
...
<Pronunciation word="Pot" uk="/pɒt/" us="/pɑt/" client:only />
...
<WordRelations
  synonyms={["cookpot","kitty","pool","kettlebelly","lib"]}
  client:only
/>
