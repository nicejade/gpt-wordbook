---
title: Gramophone
description: Gramophone 是一个名词，指的是语音重现或录音设备的一种，通常用来放音乐。俗称为'留声机'或'唱片播放机'。
sidebar:
  hidden: true
...
Gramophone 这个词最初是一家英国公司在 19 世纪 80 年代发明了这种新型唱片机后的商标名称，后来人们习惯性地用这个词来指代所有唱片机。

### 单词变形

Gramophone 本身就是名词，没有对应的动词、形容词和副词等变形。
...
<WordRelations synonyms={["phonograph"]} client:only />
