...
title: Push
description: >-
  Push是一个英语单词，通常用作动词，表示'推'，“推动”或“推进”。也可以用作名词，表示力的一种类型，即推力。它还可以用来表示努力实现某事，如'做出努力'或'增加压力'。
sidebar:
  hidden: true
...
<Pronunciation word="Push" uk="[pʷʊʃ]" us="[pʷʊʃ]" client:only />
...
一些与 push 相关的固定搭配包括：“push on”（继续向前），“push away”（推开），“push through”（迅速通过）。
...
<WordRelations
  synonyms={["approach","near","press","urge","advertise","promote","shove","thring","thrutch"]}
  antonyms={["draw","pull","tug","pop"]}
  client:only
/>
