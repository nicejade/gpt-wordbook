---
title: Gust
description: Gust主要有两个含义：一是风的突然猛烈一吹，即一阵强风；二是某种情绪的突发，如一股怒火。
sidebar:
  hidden: true
...
<Pronunciation word="Gust" uk="/ɡʌst/" us="/ɡʌst/" client:only />
...
"Gust"这个词在中古英语(约 1150 年至 1470 年)中，表示感官的喜好。这个词的起源可以追溯到装有匈牙利语(Latin)的 gustus，意思是尝试，感觉或品味；因此，它最初的含义主要是关于味觉的，表示品尝或尝试。

### 单词变形

"Gust"在单复数形式上没有变化，因为它可以表示一个或多个猛烈的风或情绪突发。它作为动词使用时，表达的意思是（风）猛烈吹，例如：The wind gusted at over 50 mph (风速达到每小时 50 英里以上)。
...
<WordRelations synonyms={["windflaw"]} client:only />
