...
title: Safety
description: >-
  Safety是一种状态，即不会遭受伤害或危险的情况。健康、合规、没有风险的地方、事物，或活动，也可称为安全。'Safety'是一个名词，常用于安全性、保护和防护场景中。
sidebar:
  hidden: true
...
<Pronunciation word="Safety" uk="/ˈseɪfti/" us="/ˈseɪfti/" client:only />
...
"Safety"这个单词自 14 世纪起就在英语中使用，该单词的来源是拉丁语的 "salvus"，意思是 "unharmed" 或 "well"。在现代英语中，"safety" 在消防、道路安全和职业安全等场景中被广泛使用。
...
<WordRelations antonyms={["danger"]} client:only />
