...
title: Knit
description: >-
  Knit 是个动词，主要有三层含义。第一，它指的是用针织方法制作（毛衣、围巾等）；第二，它也可以用来形容使事物紧密结合或者连在一起，比如 ‘knit a
  community together’. 第三，它还可以用来描述伤口愈合的过程。
sidebar:
  hidden: true
...
<Pronunciation word="Knit" uk="/ˈnɪt/" us="/ˈnɪt/" client:only />
