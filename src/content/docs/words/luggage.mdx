---
title: Luggage
description: Luggage 是一个名词，主要指携带在旅行中的行李、皮箱等。
sidebar:
  hidden: true
...
<Pronunciation word="Luggage" uk="/ˈlʌɡɪd͡ʒ/" us="/ˈlʌɡɪd͡ʒ/" client:only />
...
"Luggage" 这个词源于 16 世纪，最初是指人力拖拉的重物，后来逐渐演变为现在表示各种旅行用品的含义。
...
<WordRelations synonyms={["baggage"]} client:only />
