---
title: Increase
description: Increase作为动词时，表示“增加”，“提高”；作为名词时，指的是“增长”或者“增加的量”。
sidebar:
  hidden: true
...
3.  His salary will increase by 5% next year. (他的薪资明年将增加 5%。)
...
"increase" 出现在 14 世纪，源于拉丁语 "in-" （加深）和 "crescere" (生长) 的结合。这一词汇成为英语中表达增长、提升的主要方式。
...
(David 在他的车库里开始了一项小生意。随着时间的推移，他的销售额开始增加。最终，他将生意搬到了一座大办公楼里。)

<WordRelations
  synonyms={["enlargement","expansion","gain","increment","raise","rise","grow","soar","wax","up","proliferate","propagate","teem"]}
  antonyms={["decline","decrease","diminishment","cut","decrement","drop","fall","loss","lowering","reduction","shrinkage","plummet","plunge","reduce","shrink","sink","lower","wane"]}
  client:only
/>
