...
<WordRelations
  synonyms={["enlargement","expansion","gain","increment","raise","rise","grow","soar","wax","up","propagate"]}
  antonyms={["decline","decrease","cut","drop","fall","loss","reduction","shrinkage","plummet","plunge","reduce","shrink","sink","lower","wane"]}
  client:only
/>
