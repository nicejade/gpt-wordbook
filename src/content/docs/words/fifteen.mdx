---
title: Fifteen
description: Fifteen 是一个英文数字，代表 15。它既可以用来表示具体的数目，也可以指代一个顺序。
sidebar:
  hidden: true
...
<Pronunciation word="Fifteen" uk="/fɪfˈtiːn/" us="/fɪfˈtiːn/" client:only />
...
"Fifteen" 这个单词由 'Fif-' 和 '-teen' 两部分组成。'-teen' 是表示十几的英文后缀，前者 'fif-' 就是 'five'，即 5。
...
<WordRelations synonyms={["15", "XV"]} client:only />
