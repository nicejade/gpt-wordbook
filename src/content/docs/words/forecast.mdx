---
title: Forecast
description: Forecast 是一个英语单词，既可以作为动词，也可以作为名词使用。作为动词时，意思是预测或者预报，如预报天气；作为名词时，意思是预测或者预报的内容。
sidebar:
  hidden: true
...
<Pronunciation word="Forecast" uk="/ˈfɔːkɑːst/" us="/ˈfɔɹkæst/" client:only />
...
"Forecast" 这个单词在 17 世纪时开始在英语中使用，最初的意思是"计划在前"，随着时间的推移，这个词的意思逐渐转为"预测未来"。
