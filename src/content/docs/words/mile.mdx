---
title: Mile
description: Mile 是一个表示长度的英文单位，对应于 5280 英尺或者约等于 1.609 千米。 还经常用于比喻中，表达路途的长短或事情的难易程度。
sidebar:
  hidden: true
...
"Mile" 是一个表示长度的英文单位，对应于 5280 英尺或者约等于 1.609 千米。 还经常用于比喻中，表达路途的长短或事情的难易程度。

<Pronunciation word="Mile" uk="/maɪ̯l/" us="/maɪ̯l/" client:only />
