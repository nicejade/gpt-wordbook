...
description: >-
  Clown
  是名词，用来指代一个专门在马戏团、舞台表演或者生活中调动大家欢乐气氛的人，拥有独特、夸张的妆容和服装，不时做出好笑的动作或者恶作剧。此外，'clown'也可以用来形容一个滑稽、愚蠢的人。
sidebar:
  hidden: true
...
<Pronunciation word="Clown" uk="/klaʊn/" us="/klaʊn/" client:only />
...
"Clown" 等于 "C"（看）+ "lown"（low 的音变，低），联想起在马戏团看小丑滑稽的下跌动作，有助于记忆。
...
<WordRelations synonyms={["buffoon", "fool"]} client:only />
