---
title: Procedure
description: "- 'Procedure' 是一个名词，中文翻译通常为“程序”、“步骤”或“过程”，主要用于描述完成某件事情必须的操作步骤或方式。"
sidebar:
  hidden: true
...
- "Procedure" 这个单词首先在英语中出现在 1600 年，最早用于描述诉讼过程。现在，它常常用来形容一系列完成特定任务的预设步骤。
...
<WordRelations
  synonyms={["function","method","routine","operation","algorithm","process","protocol"]}
  client:only
/>
