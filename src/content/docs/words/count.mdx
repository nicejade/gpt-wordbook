---
title: Count
description: Count原意是'计数'，既可作名词，也可作动词。当作名词时，它表示“计数，总数”。作为动词时，它表示'算，计算，把...算作，看作'。
sidebar:
  hidden: true
...
<Pronunciation word="Count" uk="/kaʊnt/" us="/kaʊnt/" client:only />
...
"Count"这个词在 14 世纪从古法语借入到英语，本意是“计数”，到了现在，意思并没有太大的变化，还是用来表示数和计算。
...
<WordRelations synonyms={["enumerate", "number"]} client:only />
