---
title: Action
description: Action 在英语中是一个名词，通常表示“行动”或者“动作”。它可以指具体的身体动作，例如：打跑、跳等，同时也可以表示抽象的行动，如采取一种策略等。
sidebar:
  hidden: true
...
<Pronunciation word="Action" uk="/ˈæk.ʃən/" us="/ˈæk.ʃən/" client:only />
...
"Action" 由 Latin 词根"-act-"派生而来，这个词根表示“行动”或“做”。
...
<WordRelations synonyms={["deed"]} client:only />
