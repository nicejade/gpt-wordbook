...
<WordRelations
  synonyms={["demonstration","illustration","proof","exhibition","exposition","front","superficiality","display","exhibit","indicate","reveal","demonstrate","prove","arrive"]}
  antonyms={["conceal","hide","refute"]}
  client:only
/>
