---
title: "outgoing"
description: "Outgoing 是一个形容词，它常用来描述一个友好、开朗、善于交往的人，对人际交流有积极的态度，爱出去与人交际。另外，它也可以用来描述一个正在离职或即将离任的人。"
---
...
"Outgoing" 的使用可以追溯到 14 世纪，最先用来描述去世或死亡。然后，它的用法扩大到了表示方向和位置的变化。
