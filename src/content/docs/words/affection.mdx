...
description: >-
  Affection
  是一个名词，意为情感、感情，特别是表达出的温暖、爱护和关心。它多用于描述对朋友、家人或者宠物的一种喜爱，更多的表达的是亲情和友情，而不是恋爱的感情。
sidebar:
  hidden: true
...
<Pronunciation word="Affection" uk="/əˈfɛkʃən/" us="/əˈfɛkʃən/" client:only />
...
"Affection" 一词源自 14 世纪的拉丁词"affectionem"，意为"倾向、偏爱",后逐渐发展为现在的意思。
