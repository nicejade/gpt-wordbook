---
title: Contrive
description: Contrive是一个动词，通常用于描述设计、计划或者巧妙地制造出某物。它也可以表示设法做到乃至谋划的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Contrive" uk="/kənˈtɹaɪv/" us="/kənˈtɹaɪv/" client:only />
...
"Contrive"在 14 世纪初自法语进入英语，初衷是形容教育良好的人所具有的"设法做到"能力，之后它的含义扩大，用于描述任何需要寻找解决方案的情况。
...
<WordRelations
  synonyms={["becast", "hatch", "plan", "plot", "scheme"]}
  client:only
/>
