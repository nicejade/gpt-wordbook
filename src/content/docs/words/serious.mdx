---
title: Serious
description: Serious是一个形容词，表示“严肃的”、“庄重的”或者“认真的”。另外，它也可以表示“严重的”或者“重大的”。
sidebar:
  hidden: true
...
<Pronunciation word="Serious" uk="/ˈsɪə.ɹi.əs/" us="/ˈsɪəɹ.i.əs/" client:only />
...
"Serious"在 16 世纪时引入英语，意思是"严重的"或"庄重的"，随着时间的推移，它的含义逐渐扩展到"严肃的"或"严格的"。
...
<WordRelations
  ...
  antonyms={["trifling", "unimportant", "jesting"]}
  client:only
/>
