...
title: Riddle
description: >-
  Riddle主要有两种含义。第一种含义是'谜语'或'难题'，通常是一种需要智力解答的问题或语句，通常语境里充满了双关语或隐喻。第二种是动词形式，意为'充满'或'遍布'。
sidebar:
  hidden: true
...
<Pronunciation word="Riddle" uk="/ˈɹɪdəl/" us="/ˈɹɪdəl/" client:only />
...
"Riddle"的词根是 Old English 的"rǣdelsē",意思是"opinion, conjecture, riddle,"，也与古德语中的"rât"有联系，意为"advice, counsel."
...
<WordRelations synonyms={["conundrum", "enigma"]} client:only />
