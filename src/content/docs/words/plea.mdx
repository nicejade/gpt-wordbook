---
title: Plea
description: Plea 是一个名词，主要用于法律语境中，指被告的答辩或抗辩。此外，'plea'也可进一步泛指请求或恳求。
sidebar:
  hidden: true
...
<Pronunciation word="Plea" uk="/pliː/" us="/pliː/" client:only />
...
"Plea" 一词源自 14 世纪中叶的法国，原意为“诉讼”，后来发展出“辩护”和“请求”等含义。
...
<WordRelations synonyms={["plaidoyer"]} client:only />
