---
title: Siren
description: Siren是一种通常由警察、救护车或消防车使用的响亮的警报器。它也可以指希腊神话中的美人鱼——妖魔，通过歌唱迷惑航海者。
sidebar:
  hidden: true
...
<Pronunciation word="Siren" uk="/ˈsaɪəɹən/" us="/ˈsaɪəɹən/" client:only />
...
<WordRelations
  synonyms={["bewitching","enchanting","enticing"]}
  client:only
/>
