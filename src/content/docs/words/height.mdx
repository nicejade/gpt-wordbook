...
title: Height
description: >-
  Height是一个名词，它主要用来表示“高度”，指的是从地面或底部到顶部的距离；也可以用来描述“最高点”或者“顶峰”。此外，'height'也可能表示一种极度或强烈的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Height" uk="/haɪt/" us="/haɪt/" client:only />

### 列举例句

1.  The height of the mountain is 5000 feet.（这座山的高度是 5000 英尺。）
2.  The bookshelf is 2 meters in height.（书架的高度是 2 米。）
...
<WordRelations antonyms={["depth"]} client:only />
