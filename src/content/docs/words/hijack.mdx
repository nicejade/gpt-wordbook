...
title: Hijack
description: >-
  Hijack这个词来自英文，一般是一个动词，意思是非法劫持，无论是飞机，还是车辆等等。它既可以用于实际的物物质劫持，也可以被延伸用于抽象事物的控制，如被黑客劫持的电脑。
sidebar:
  hidden: true
...
<Pronunciation word="Hijack" uk="/ˈhaɪ.dʒæk/" us="/ˈhaɪ.dʒæk/" client:only />
...
"Hijack" 这个词在 20 世纪早期的美国俚语中出现，原本指的是在路上抢劫。到了 20 世纪的下半叶，随着飞行产业的发展，该词语开始被用来指称飞机的劫持。
