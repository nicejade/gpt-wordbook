---
title: "counter"
description: "Counter是个多义词，可以作为名词和动词使用。 1. 作为名词，它指的是可以用来计算的东西，或者是一种像桌子一样可以放东西的平面。 2. 作为动词，它通常意味着“反驳”或“反对”。"
---
...
2.  The digital counter on the device shows that we have 500 visitors today.（设备上的数字计数器显示我们今天有 500 名访客。）
...
"Counter"一词最初来自古法语"contouer"，意为"计数器"，并发展为现在的英语形式。作为动词，其含义"反对"在 17 世纪中叶出现。
