---
title: Recruiter
description: Recruiter 这个单词非常简单地可以被理解为一名'招聘人员'或者'猎头'。这是一个名词，用来描述那些在公司或机构中负责寻找并吸引合适候选人的角色。
sidebar:
  hidden: true
...
一种记忆 recruiter 的方法是通过其词根和词缀来进行，“-er”通常表示人或者事物，给出"做某事的人”的含义,“recruit”译为 “招募”，那么可以理解为"招募者"或者是"招新员工的人"。
...
<WordRelations synonyms={["agent", "headhunter", "scout"]} client:only />
