...
title: Overlap
description: >-
  Overlap 是动词，它的基本含义是重叠，涵盖或超过。它表示两个或更多的事物部分相同或覆盖在一起。在计算机图形学中，'overlap'
  也经常出现，描述图形或窗口之间的部分重叠。
sidebar:
  hidden: true
...
<Pronunciation word="Overlap" uk="/ˈəʊvəˌlæp/" us="/ˈəʊvəˌlæp/" client:only />
...
"Overlap" 这个词源于 14 世纪的中英语，最初的含义是“覆盖”，后来发展出“超过、重叠”的含义。
...
<WordRelations synonyms={["intersect"]} client:only />
