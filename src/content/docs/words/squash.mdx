---
title: Squash
description: Squash 是一个着实有趣的单词，既有名词也有动词两种用法，且每种用法又各有几种含义。下面让我们逐一过一遍：
sidebar:
  hidden: true
...
<Pronunciation word="Squash" uk="/skwɒʃ/" us="/skwɔʃ/" client:only />
...
<WordRelations synonyms={["condense", "press"]} client:only />
