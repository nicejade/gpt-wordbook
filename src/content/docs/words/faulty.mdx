...
title: Faulty
description: >-
  Faulty 是一个形容词，意为'有错误的'，'有缺陷的'，或者'不完善的'。例如， 'faulty machinery'（有故障的机器）,'faulty
  logic'（错误的逻辑）。
sidebar:
  hidden: true
...
<Pronunciation word="Faulty" uk="/ˈfɔːlti/" us="/ˈfɔːlti/" client:only />
...
<WordRelations antonyms={["faultless"]} client:only />
