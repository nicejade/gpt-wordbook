---
title: Observe
description: Observe是一个动词，主要有两种基本含义。第一种是“看，观察”，如在科学实验中观察现象。第二种是“遵守”，如遵守规则或法律。
sidebar:
  hidden: true
...
<Pronunciation word="Observe" uk="/əbˈzɝv/" us="/əbˈzɝv/" client:only />
...
<WordRelations synonyms={["celebrate"]} client:only />
