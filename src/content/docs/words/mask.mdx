...
title: Mask
description: >-
  Mask 是一个非常常用的英文单词，它有两个主要的含义：第一个是作为名词，代表“面罩，口罩，面具”；第二个是作为动词，表示“遮盖，隐藏”。例如，'Wear
  a mask' (戴上面具/口罩) 或 'Mask the truth' (掩盖真相)。
sidebar:
  hidden: true
...
<Pronunciation word="Mask" uk="/mæsk/" us="/mæsk/" client:only />
...
<WordRelations synonyms={["mascaron", "vizard"]} client:only />
