---
title: Modify
description: Modify 是一个动词，在英语中常用的含义是“改变”、“修改”或“调整”。可以用在许多场合，比如改变计划、修改设计，等等。
sidebar:
  hidden: true
...
<Pronunciation word="Modify" uk="/ˈmɒdɪfaɪ/" us="/ˈmɑdɪfaɪ/" client:only />
...
"Modify"来源于 14 世纪的中法语，meananing "to change, alter, make different; amend, correct; to adjust, regulate, conduct," 从现代法"modifier" 而来。
...
<WordRelations
  synonyms={["adapt", "alter", "amend", "revamp", "rework"]}
  client:only
/>
