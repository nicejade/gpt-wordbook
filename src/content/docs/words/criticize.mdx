---
title: Criticize
description: Criticize 是一个动词，表示“对…提出批评或不满”，有时候也用于表示“详细评价”。这个词多用在提出批评意见，评论某人或某事的行为或表现的语境中。
sidebar:
  hidden: true
...
<Pronunciation word="Criticize" uk="/ˈkɹɪtɪsaɪz/" us="/ˈkɹɪtɪsaɪz/" client:only />
...
"Criticize" 这个词于 16 世纪末从法语中引进英语，最初主要用于对艺术和文学的评价中，到了 17 世纪时，该词语的含义扩大到对任何事物表达批评或不满的意义。
