---
title: Attendance
description: Attendance，源自拉丁语"attendere"，含义指参加，出席或到场，通常指在指定的事件，如会议或学校课程中的出席或参加。
sidebar:
  hidden: true
...
例句 1: His attendance at the conference was mandatory.（他必须参加会议。）
例句 2: She has had perfect attendance in school all year.（她全年在学校的出勤记录是完美的。）
例句 3: We have had a high attendance rate for our seminars this year.（今年我们的研讨会出席率很高。）
...
"Attendance" 这个单词中 "-ance" 是一个后缀，用于将动词转变为名词，表示一种行为或状态。像 assurance（保证）, reliance（依赖）等词都有同样的后缀.

### 文化背景

"Attendance" 这个词在 12 世纪时引进了英语。它主要在教育和职场环境中使用，用来追踪和记录一个人是否在规定的时间和地点出现。
