---
title: Drought
description: drought 是一个名词，表示长期的、严重的缺水或降雨严重不足的现象。也可以形象地用来表示缺乏其他事物的状况。
sidebar:
  hidden: true
...
<Pronunciation word="Drought" uk="/dɹaʊt/" us="[dɹʌʊt]" client:only />
...
"drought" 来自老英语（Old English）"drūgath"，意为“干燥”， 旧英文 drūg 的派生词，意为“干燥”。
