---
title: Parameter
description: "- 'Parameter' 是一个英文单词，一般用来指控制系统行为或者描述系统特性的变量。汉语中可以翻译为“参数”。"
sidebar:
  hidden: true
...
- 具有相同词缀的其他单词有：Paranormal、Parapsychology、Paramilitary 等。

### 文化背景

- “Parameter” 这个词源自 19 世纪，最初用于数学领域，用以描述由一个或多个变量控制的问题或系统。后来逐渐演化，被广泛应用于各种领域，比如物理、化学、计算机科学、经济学，等等。

### 单词变形

- Parameter（参数）是一个名词，其复数形式为 parameters（参数）。
...
<WordRelations
  synonyms={["distinguishing", "feature", "argument"]}
  client:only
/>
