...
description: >-
  Curl
  是一个英文单词，它常常作为动词或名词来使用。作为动词，它的基本含义是“卷曲”、“弯曲”，包括引申含义，如头发卷曲，烟雾蜿蜒升起等。当它作为名词使用时，它描述了事物呈曲线或螺旋形的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Curl" uk="/kəːl/" us="/kɝl/" client:only />
...
"Curl" 这个单词源自古老的英语，具体历史可以上溯到公元前 450 年。它主要描述物品朝某个方向自然弯曲的状态或过程。
...
<WordRelations
  synonyms={["curlicue","curve","flourish","loop","spiral","ringlet","coil","arch"]}
  antonyms={["extension","straighten","uncoil","unroll"]}
  client:only
/>
