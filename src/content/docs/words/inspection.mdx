...
description: >-
  Inspection
  是名词，主要有两个含义。第一是审查，检查，它通常指查看物品或设施以确认其状态或保证其质量。第二是审视，研究，这是指深思熟虑或详细分析某物。
sidebar:
  hidden: true
...
"Inspection" 源自于 14 世纪的拉丁语 "inspectio"，意思是查看或考察，后来这个词语被广泛应用在法律、建筑及其他多个领域。此外，在欧美的文化背景中，"inspection" 对保障商品和服务质量、社区环境的良好维护起到重要作用。
...
<WordRelations synonyms={["examination", "scrutiny"]} client:only />
