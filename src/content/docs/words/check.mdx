---
title: Check
description: Check 是一个非常常用的英文单词，既可以当动词，也可以当名词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Check" uk="/t͡ʃɛk/" us="/t͡ʃɛk/" client:only />
...
<WordRelations synonyms={["bill", "cheque", "checkmark", "tick"]} client:only />
