...
title: Latitude
description: >-
  Latitude是一个英文名词，直译为'纬度'，这是一个地理学术语，表示处在地球表面的某点与赤道的平行圈之间的角度。除此之外，'latitude'还有'自由，选择的余地'的意义。
sidebar:
  hidden: true
...
"Latitude"这个词最早出现于 14 世纪，由拉丁语"latitudo"演变而来，最初用于描述地理宽度，后来扩展为描述具有选择自由的含义。
