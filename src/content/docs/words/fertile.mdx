...
title: Fertile
description: >-
  Fertile是形容词，原意是‘能生育的’，中文翻译为“肥沃的”，“富饶的”，“多产的”，它通常用于描述土地或者某片区域的富饶情况。也可以引申为在思想、文化等抽象领域的丰富性。
sidebar:
  hidden: true
...
<Pronunciation word="Fertile" uk="/ˈfɝːtaɪl/" us="/ˈfɝːtaɪl/" client:only />
