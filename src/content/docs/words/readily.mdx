---
title: Readily
description: Readily 是一个副词，通常用来描述做事情的程度 —— 不费力，快速，愿意做等。相当于中文中的'容易地'、'愿意地'，或者'迅速地'。
sidebar:
  hidden: true
...
<Pronunciation word="Readily" uk="/ˈɹɛdɪli/" us="/ˈɹɛdɪli/" client:only />
...
"Readily" 中的 -ly 是英语中常见的用来形容词变副词的后缀。例如：quick（快）和 quickly （快速地）。
