...
title: Interact
description: >-
  Interact 这个单词源于拉丁文 'inter-' 表示 '之间' ， '-act' 表示 '行动”。所以，'interact' 的字面意思是
  '在...之间行动'。我们通常用它来指示两个或多个人或事物之间发生相互作用或影响。
sidebar:
  hidden: true
...
<Pronunciation word="Interact" uk="/ɪntəɹˈækt/" us="/ɪntəɹˈækt/" client:only />
...
"Interact" 一词源于早期现代英语的 "interaction"。它首次出现在英文语料库中是在 1805 年，语言学家将 "interaction" 的过程形式改变为 "interact"，以描述两个或以上实体相互作用或影响的行为。
...
<WordRelations
  synonyms={["entracte", "interlude", "intermission"]}
  client:only
/>
