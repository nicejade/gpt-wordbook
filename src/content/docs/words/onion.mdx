---
title: Onion
description: Onion 是英语中的一个名词，表示“洋葱”的意思。在烹饪中，洋葱经常被用作食物的调味品或是食材。
sidebar:
  hidden: true
...
<Pronunciation word="Onion" uk="/ˈʌnjən/" us="/ˈʌnjən/" client:only />
...
"Onion" 这个词的最早记录源自 14 世纪。在欧美文化中，洋葱被广泛用于各种食品的准备和调味。
...
<WordRelations synonyms={["violet"]} client:only />
