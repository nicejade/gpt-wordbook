---
title: Coincidence
description: Coincidence 是一个名词，表示两件或多件事件同时或近乎同时发生的情况，尤其是以意想不到或难以置信的方式发生的事件。用中文来解释，就是“巧合”。
sidebar:
  hidden: true
...
<Pronunciation word="Coincidence" uk="/kəʊˈɪnsɪdəns/" us="/koʊˈɪnsɪdəns/" client:only />
...
"Coincidence" 一词首次出现在大约 1600 年的英文文献中，用以描述两件事情的同期发生。在欧美文化中，巧合被看作是神秘或超自然的现象的标志，尤其是在电影和文学中。
...
<WordRelations
  synonyms={["concurrentness","synchronicity"]}
  client:only
/>
