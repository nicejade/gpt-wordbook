---
title: Insufficient
description: 英文单词 'insufficient' 是形容词，表示不足的、不够的。
sidebar:
  hidden: true
...
这个词取自 14 世纪的拉丁语 "insufficientem"，在老法语中也有同样的表达 "insuffisant"，最初的含义就是“不足的”。
...
<WordRelations synonyms={["unsufficient"]} client:only />
