---
title: Clone
description: Clone 是一個英文單詞，作為名詞時，它的意思是'克隆體'、'副本'或'複製品'。作為動詞時，它的意思是'複製'、'克隆'。
sidebar:
  hidden: true
...
<Pronunciation word="Clone" uk="/kləʊn/" us="/kloʊn/" client:only />
...
"Clone" 这个词在 20 世纪初的生物学界中出现，用于描述通过无性生殖产生的生物实体。在文化上，随着科学技术的进步，这个词逐渐出现在科幻文学和电影中，常常用来探讨人类社会和道德伦理的问题。

### 单词变形

Glone 本身是個不規則的詞，不會变化形態。動詞形式有：是克隆（clone），正在克隆（cloning），已克隆（cloned）。
...
在 1997 年，一只名叫多莉的羊成了第一个在全世界范围内知名的克隆体。她成了科学进步的象征。
