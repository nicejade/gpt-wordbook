---
title: Patient
description: Patient 是一个形容词和名词，作为形容词，它意味着能够接受延迟，痛苦，或困苦，而不会投诉。作为名词，它是指接受医疗照护的人。
sidebar:
  hidden: true
...
<Pronunciation word="Patient" uk="/ˈpeɪʃənt/" us="/ˈpeɪʃənt/" client:only />
...
"Patient" 来自拉丁词根 "pati"，意味着 "suffer" 或 "endure"。其他衍生词有：patience, impatient 等。
...
<WordRelations
  synonyms={["composed"]}
  antonyms={["agent", "antsy", "impatient", "macrophobic"]}
  client:only
/>
