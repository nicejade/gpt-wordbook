---
title: Goods
description: "- 'Goods' 是一种集合名词，可以翻译为“商品”或“货物”。通常用来指出售或转让的物品，尤其在商业和贸易中使用。"
sidebar:
  hidden: true
...
<Pronunciation word="Goods" uk="/ɡʊdz/" us="/ɡʊdz/" client:only />
...
- "Goods" 这个单词可以追溯到公元前 900 年的英语，然而它的现代意义，指的是"货物"或"商品"，大约始于 17 世纪。
...
<WordRelations
  ...
  antonyms={["bad", "evil", "capital", "services"]}
  client:only
/>
