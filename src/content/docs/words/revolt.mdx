...
title: Revolt
description: >-
  Revolt 是一个动词，有反抗，反叛的意思。在古法语中，“revolt”来源于“re-' (再次) 和 'volter' (滚动，翻转)。例如,
  人民对政府的不公平进行反抗就可以说 'People revolt against the injustice of the government.'。
sidebar:
  hidden: true
...
<Pronunciation word="Revolt" uk="/ɹɪˈvɒlt/" us="/ɹɪˈvoʊlt/" client:only />
...
"Revolt" 最早起源于 14 世纪的法语，原意为挣脱，变反或往回翻。在西方文化中，这个词经常用于描述对不公正和压迫的反抗和反叛。
...
<WordRelations synonyms={["insurrection", "rebellion"]} client:only />
