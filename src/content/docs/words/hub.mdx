...
title: Hub
description: >-
  "Hub"一词在英语中有几个常见的含义： 1.
  作为名词，"hub"指的是中心，轴心，枢纽等，以示其在某件事物或某个区域中的核心或重要位置。例如：“London is the hub of the
  UK's rail network.”(伦敦是英国铁路网络的枢纽。) 2.
  在计算机科学中，"hub"被用于表示网络枢纽，这种设备用来连接多个以太网设备并使其作为一个网络段运行。
sidebar:
  hidden: true
