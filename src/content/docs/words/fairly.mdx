...
description: >-
  Fairly
  是一个副词，用于强调动词或形容词，意味着'相当地'、'适度地'或'公正地'。它也可以用来强调事实或情况，意思是'令人满意地'或'在某种程度上是正确的'。
sidebar:
  hidden: true
...
<Pronunciation word="Fairly" uk="/ˈfɛə(ɹ).li/" us="/ˈfɛɹ.li/" client:only />
...
<WordRelations
  synonyms={["frankly", "justly", "pretty", "quite", "somewhat"]}
  client:only
/>
