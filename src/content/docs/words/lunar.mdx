---
title: Lunar
description: '- ''Lunar'' 是一个形容词，意为“月亮的”，“阴历的”，这个词通常被用于描述和月亮有关的事物或概念。'
sidebar:
  hidden: true
...
<Pronunciation word="Lunar" uk="/ˈl(j)uːnə/" us="/ˈlunɚ/" client:only />
...
<WordRelations
  synonyms={["intermedium","semilunar","lunarlike","lunary","moonish","moonlike","moonly","selenic"]}
  client:only
/>
