...
title: Jet
description: >-
  Jet在英语中具有多种含义：作为名词，它可以表示'喷射机，喷气式飞行器'，还可以描述'黑色的煤焦石'，或者是指'喷射，射流'。此外，'jet'作为动词时，表示'喷出，射出'，也可用来形容快速行动，如'jet
  off to someplace'。
sidebar:
  hidden: true
...
<Pronunciation word="Jet" uk="/dʒɛt/" us="/dʒɛt/" client:only />
...
"Jet"在 16 世纪时被引入英语，在此之前，它被用来形容，硬而黑的煤焦石。由于其"投掷、喷出"的含义，随着喷气式飞机的出现，该词在 20 世纪被广泛用来指代"喷气式飞行器"。然后因为喷气式飞机的速度快，"jet"也逐渐有了"迅速移动"的含义。
