---
title: Decent
description: Decent 是一个形容词，意为'合适的'、'像样的'或'体面的'。
sidebar:
  hidden: true
...
<Pronunciation word="Decent" uk="/ˈdiːsənt/" us="/ˈdiːsənt/" client:only />
...
这个单词来源于 16 世纪的拉丁语，一开始主要被用来描述社会地位或行为方式的适当。现在，它在世界各地的英语中广为使用，描述的范围也已经扩大到任何事物或情形的适当性或满意度。
...
<WordRelations
  synonyms={["adequate", "satisfactory", "good", "moral"]}
  antonyms={["bad","immoral","inadequate","poor","unsatisfactory","indecent"]}
  client:only
/>
