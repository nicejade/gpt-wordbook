...
title: Certainty
description: >-
  Certainty 是一个名词，表示确定，肯定，无疑，或者有信心的感觉。例如：There can be no certainty that the
  disease can be eradicated (没有准确的证据可以证明这种疾病可以根除。).
sidebar:
  hidden: true
...
<Pronunciation word="Certainty" uk="/ˈsɜːtn̩ti/" us="/ˈsɝtn̩ti/" client:only />
...
单词出自 14 世纪的中英语"certaintee"。"Certaintee" 则是来源于早期法语的 "certaineté" 。原始意思近似于“安全”或“保障”。
