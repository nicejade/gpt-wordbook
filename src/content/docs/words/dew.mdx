---
title: Dew
description: Dew是一个名词，它的意思是“露水”，在凉爽的地方或在早晨的时候，小水珠会从空气中凝结在冷的表面上，这就是露水。
sidebar:
  hidden: true
...
<Pronunciation word="Dew" uk="/djuː/" us="/du/" client:only />
...
<WordRelations synonyms={["rore"]} client:only />
