...
title: Visible
description: >-
  Visible是形容词，其基本含义是'能看到的'，'显而易见的'。我们可以用这个字形容任何我们能用眼睛看到的事物，也可以比喻一些不容忽视或无法忽视的情况或事实。
sidebar:
  hidden: true
...
<Pronunciation word="Visible" uk="/ˈvɪzəb(ə)l/" us="/ˈvɪzəb(ə)l/" client:only />
...
"Visible"的早期用法可以追溯到 14 世纪中叶的拉丁文"visibilis"，具有“看得见的”、“明显的”等含义。在日常沟通和学术研究中都有广泛应用，如天文学中的可见光，经济学中的可见手等。
