---
title: Entry
description: Entry是名词，意思是进入、入口或条目。
sidebar:
  hidden: true
...
<Pronunciation word="Entry" uk="/ˈɛntɹi/" us="/ˈɛntɹi/" client:only />
...
<WordRelations
  synonyms={["access","enter","entrance","article","lemma","lexeme","ingang","admission","record","element"]}
