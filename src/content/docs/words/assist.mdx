---
title: Assist
description: Assist是一个英语动词，也可以用作名词。作为动词时，意思是“帮助，协助”，用来描述对另一个人或事物提供支持或帮助。作为名词，它指的是提供的帮助或协助。
sidebar:
  hidden: true
...
<Pronunciation word="Assist" uk="/əˈsɪst/" us="/əˈsɪst/" client:only />
...
- 名词：Assistance (帮助)
- 动词：Assisted (过去式，过去分词), Assisting (现在分词)
- 形容词：Assistive (助力的)
- 副词形式：不适用
