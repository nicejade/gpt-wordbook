---
title: Formation
description: Formation是一个名词，主要意思是'形成'或'构造'，通常指通过组织或整理一些事物、人或者观念形成一个统一的结构或者体系。
sidebar:
  hidden: true
...
<Pronunciation word="Formation" uk="/fə(ɹ).ˈmeɪ.ʃən/" us="/fə(ɹ).ˈmeɪ.ʃən/" client:only />
...
3.  The football team was set out in a 4-4-2 formation. (足球队采用了 4-4-2 的阵型。)

### 词根分析

"Formation"的词根是"form-"，含义是"形状"或"形成"。
衍生单词有：Inform, Reformation 等。
...
"Formation"这个单词起源于 14 世纪的法语"formacion"，意思是教育、指导。便从法语传入早期英语，意思扩展为构造、建立。
