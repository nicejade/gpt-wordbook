...
title: Approximate
description: >-
  Approximate是一个英语单词，既可以做形容词，也可以做动词。当它做形容词时，意思是“大约的，近似的”，表示某个数字或者描述不精确，但是接近真实情况。做动词时，意思是“接近，使接近”。
sidebar:
  hidden: true
...
1.  The approximate cost of the repair is $100. (修理的大约费用是 100 美元。)
...
"Approximate"源自 16 世纪的拉丁语"approximatus"，意为“接近”，后来在英语中演变成了表示“近似、大概”的词汇。
...
In a math class, the teacher asked, "Can anyone tell the approximate value of Pi?" Kids started guessing, "Is it 3.14?" The class laughed together. (在数学课上，老师问："有谁能说出 Π 的近似值是多少?" 孩子们开始猜测："是 3.14 吗？"全班一起笑了起来。)
