...
description: Reconciliation是一个名词，主要指的是在争执、战争、纷争等状况之后，实现和平、和解的过程。英汉对照的意思是“和解”或“调解”。
sidebar:
  hidden: true
...
<Pronunciation
  word="Reconciliation"
  uk="/ˌɹɛkənˌsɪliˈeɪʃən/"
  us="/ˌɹɛkənˌsɪliˈeɪʃən/"
  client:only
/>
...
"Reconciliation"这个词，最初在 14 世纪，从拉丁语 "conciliationem" 或 "conciliatio" 演变而来。在以往和现代欧美社会，"reconciliation" 往往被用来指和解发生在两国之间，两组人之间，甚至家庭成员之间。
...
<WordRelations synonyms={["saught"]} client:only />
