...
title: Welcome
description: >-
  Welcome是一个常见的英语单词，作为形容词使用时，它指的是'受欢迎的'，或者'愉快的'；作为动词，它的意思是'欢迎'或者'接待'。此外，“welcome”也可以作为词组'you're
  welcome'的一部分，这是对'thank you'的一种常见回答。
sidebar:
  hidden: true
...
<Pronunciation word="Welcome" uk="/ˈwɛlkəm/" us="/ˈwɛlkəm/" client:only />
