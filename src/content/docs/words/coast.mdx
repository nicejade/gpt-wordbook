...
title: Coast
description: >-
  Coast 是一个名词，它在地理上主要是指海岸或者湖岸，而在日常对话中我们也经常用到比如 'the west/east coast'
  来指代美国的西海岸或者东海岸等。同时，'coast' 还有一个动词的意思，就是滑行，比如一辆车在下坡的时候会'coast' down the hill。
sidebar:
  hidden: true
...
<Pronunciation word="Coast" uk="/kəʊst/" us="/koʊst/" client:only />
...
这个词在历史上最早的文献记录可以追溯到 14 世纪，最初从拉丁语词 costa 演变出来，意为 "rib, side, wall"（肋骨、侧面、墙壁），随着时间的推移，人们将此词用于形容地理上的边缘，渐渐演变为我们现在所说的"海岸"或"湖岸"等。
