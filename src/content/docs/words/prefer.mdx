...
title: Prefer
description: >-
  Prefer' 是个动词，一般用于表达一种偏爱或更喜欢某件事物或某个选择。例如，'I prefer tea to
  coffee'，意为“我更喜欢茶而不是咖啡。
sidebar:
  hidden: true
...
<Pronunciation word="Prefer" uk="/pɹɪˈfɜː/" us="/pɹɪˈfɝ/" client:only />

### 列举例句

1.  I prefer listening to music over watching television. (我更喜欢听音乐，不喜看电视。)
2.  Sally prefers the mountains to the beach for her vacation. (Sally 在度假时更偏爱山区，不喜欢海滩。)
...
这个词在法国通过拉丁语>Evolu 成为更常用的形式，然后在 14 世纪经由法语引入了英语。
...
<WordRelations synonyms={["forechoose"]} antonyms={["disprefer"]} client:only />
