---
title: Physics
description: Physics 是一个英文名词，意为 '物理学'。它是研究物质的构造、运动和互动等自然现象的学科。
sidebar:
  hidden: true
...
<Pronunciation word="Physics" uk="/ˈfɪz.ɪks/" us="/ˈfɪz.ɪks/" client:only />
...
<WordRelations antonyms={["nonphysics"]} client:only />
