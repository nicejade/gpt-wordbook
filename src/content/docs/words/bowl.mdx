...
title: Bowl
description: >-
  Bowl 是一个名词，通常指的是用来装食物或其他物品的圆形、开口的容器。此外，“bowl'
  也可以作为动词使用，意思是抛出（球），通常用在板球或保龄球这样的运动中。
sidebar:
  hidden: true
...
<Pronunciation word="Bowl" uk="/bəʊɫ/" us="/boʊɫ/" client:only />
...
Alice went to the antique shop and bought a charming, old bowl. It was beautifully decorated and she couldn’t wait to fill it with fresh fruits. (Alice 去了个古董店，买了个有魅力的老碗。它装饰得非常漂亮，她迫不及待地想要用新鲜水果将它填满。）

<WordRelations synonyms={["bowlful", "crater", "hollow"]} client:only />
