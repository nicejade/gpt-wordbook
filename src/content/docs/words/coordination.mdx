...
description: >-
  Coordination
  是一个英语名词，中词意思为'协调'，'配合'。这个词语通常用来描述几个部分或者几个人的共同，协同的行动，使所有的部分或人都有效的工作，达成共同目标的情况。
sidebar:
  hidden: true
...
"Coordination"这个单词来自于拉丁语的"coordinare"，这个词的词源是"co"（一起）和"ordinare"（成行，成列）。该词自 19 世纪开始使用，原来主要表示数学上的"协调"，后来逐渐被引申到日常生活中，形容各种需要合作，协调的情况。
...
<WordRelations antonyms={["incoordination", "subordination"]} client:only />
