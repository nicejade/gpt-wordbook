---
title: Deny
description: Deny 是一个动词，它的基本意思是'否认'或'拒绝'。
sidebar:
  hidden: true
...
<Pronunciation word="Deny" uk="/dɪˈnaɪ/" us="/dɪˈnaɪ/" client:only />
...
"deny"来自于拉丁语"denegare"，中世纪英语接收并将其变形为 denayen，最终在现代英语中变为 deny。"deny" 用在法律语境中，代表否认犯罪或否认责任。
