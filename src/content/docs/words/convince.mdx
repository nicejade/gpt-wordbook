---
title: Convince
description: Convince作为动词，意为'说服'或'使确信'，它可以表示说服某人做某事，或者使某人相信某事。
sidebar:
  hidden: true
...
<Pronunciation word="Convince" uk="/kənˈvɪns/" us="/kənˈvɪns/" client:only />
...
Convince 在中古英语中的原义是“征服、战胜”，在 15 世纪时才进化出“使……确信”的现在意思。
...
<WordRelations
  synonyms={["assure","convert","persuade","satisfy"]}
  client:only
/>
