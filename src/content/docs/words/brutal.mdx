---
title: Brutal
description: Brutal是一个形容词，表示极端的无情或者残忍。当我们描述一个人或行为为'brutal'时，我们是在说他们非常粗暴或者不人道。
sidebar:
  hidden: true
...
<Pronunciation word="Brutal" uk="/ˈbɹuːtəl/" us="/ˈbɹuːtəl/" client:only />
...
Brutal 原本指的是像野兽一样野蛮无理的行为或特质，后来演变成了现在的意思，用于形容极端的残忍和粗暴。在西方文化中，这个词常用于描述无情的行为或不人道的环境。
...
<WordRelations
  synonyms={["barbaric", "savage", "vicious"]}
