---
title: Want
description: Want是一个动词，基本含义是“想要”或“需要”。它既可以表示一个人对物质对象的需求或渴望，也可以表示对非物质事物（如情感、情况、结果）的期望和欲望。
sidebar:
  hidden: true
...
<Pronunciation word="Want" uk="/wɒnt/" us="/wɑnt/" client:only />
...
<WordRelations synonyms={["wish", "without", "need"]} client:only />
