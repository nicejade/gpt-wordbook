...
title: Torch
description: >-
  "torch"是一个英语单词，主要有两种含义： 1. 英式英语中，"torch"通常指的是“电筒，手电筒”。例：I need a torch to see
  in the dark（我需要一只电筒在黑暗中看东西）。 2.
  美式英语中，"torch"通常指的是“火炬，火把”。它也可以指示在事件中传递权力或职责的象征。例：The torch of leadership was
  passed on to the next generation（领导权被传递给了下一代）。
sidebar:
  hidden: true
