...
title: Enable
description: >-
  例如，如果我们说，“这个课程使他有能力开始他的新事业”，我们会用“enable”这个词：“This course enabled him to start
  his new business.” 所以，你可以理解'enable'就是给某人或者某事提供了所需要的条件或者能力。
sidebar:
  hidden: true
...
<Pronunciation word="Enable" uk="/ɪˈneɪbəl/" us="/ɪˈneɪbəl/" client:only />
...
“enable”单词的前缀是“en-”，表示“使……”。-able 是后缀，表示“能……的”。所以 enable 字面上理解就是"使能的", "使可能的"。

### 文化背景

“enable”这个词源自 14 世纪，来自于中古英语的“enablen”，意思就是“使……能够”。
...
<WordRelations
  synonyms={["activate","allow","authorize","let","permit","empower","endow"]}
  antonyms={["disable"]}
  client:only
/>
