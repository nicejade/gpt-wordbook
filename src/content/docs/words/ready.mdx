---
title: Ready
description: Ready是一个形容词，用来形容一个人或事物已做好准备，处于可开始、可使用或可行动的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Ready" uk="/ˈɹɛdi/" us="/ˈɹɛdi/" client:only />
...
<WordRelations
  synonyms={["yark","dexterous","easy","expert","prompt"]}
  antonyms={["unready"]}
  client:only
/>
