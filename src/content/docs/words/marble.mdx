...
description: >-
  Marble
  是一个名词，通常意指一种由石灰岩类型的岩石经过高温和压力变质而成的材料，被广泛用于雕刻和建筑装饰。'Marble'也可以指一种大小形状多样的小玻璃球，即弹珠。
sidebar:
  hidden: true
...
<Pronunciation word="Marble" uk="/ˈmɑːbəl/" us="/ˈmɑɹbəl/" client:only />
...
<WordRelations synonyms={["marbleize"]} client:only />
