---
title: Seventy
description: Seventy是一个基数词，对应中文的“七十”。这被用来表示任何数量的对象或事物的精确数量。
sidebar:
  hidden: true
...
<Pronunciation word="Seventy" uk="/ˈsɛv.ən.di/" us="/ˈsɛv.ən.di/" client:only />
...
<WordRelations synonyms={["70", "LXX"]} client:only />
