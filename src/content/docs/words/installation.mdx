---
title: Installation
description: Installation 是名词，原文意思是安装，设置或建造。它常被用来描述装置或系统的设置过程，或者指一个已经建成或设置好的项目或设施。
sidebar:
  hidden: true
...
“Installation” 最早在 14 世纪被用于表示 "任命为神职职务"，在二战后，它开始表示 "系统或设备的安装"，从 60 年代开始，被广泛用于艺术领域，表示 "艺术装置"。
