---
title: Night
description: Night是一个名词，主要指的是从日落到日出的时间，与'day'相对。也可以指喻无知或不知情的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Night" uk="/naɪt/" us="/naɪt/" client:only />
...
Tim is a night owl. He enjoys the tranquility that the night brings. He always walks in the deserted park, enjoying the sparkling stars.（Tim 是一个夜猫子。他享受夜晚带来的宁静。他总是在空无一人的公园里散步，欣赏着闪烁的星星。）

<WordRelations
  synonyms={["darkness","gloom","obscurity","shadow","evening","dark","dusk","nightfall","sundown","sunset","sleep"]}
