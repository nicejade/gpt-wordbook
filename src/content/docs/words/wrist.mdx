---
title: Wrist
description: Wrist 是一个名词，指的是我们身体的一个部分，它连接手和手臂。在中文中，我们称其为“手腕”。
sidebar:
  hidden: true
...
<Pronunciation word="Wrist" uk="/ɹɪst/" us="/ɹɪst/" client:only />
...
你可以想象你的手腕 (wrist) 扭了一下，感到很痛，你会大喊 ”哎哟，wrist 疼！” 用这种类似的发音的方法，能帮你记住这个单词。
