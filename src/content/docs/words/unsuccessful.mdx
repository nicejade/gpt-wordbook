---
title: Unsuccessful
description: Unsuccessful 是一个英文形容词，表示“不成功，失败的”。
sidebar:
  hidden: true
...
"Unsuccessful" 这个词形成于 16 世纪，来源于拉丁语的"successus"，在这个词中， "un-" 是英语的否定前缀，"-ful" 是形容词后缀。更多的是简单地表示对期望的一种否定。
...
<WordRelations antonyms={["successful"]} client:only />
