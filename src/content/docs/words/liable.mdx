---
title: Liable
description: liable 这个单词的基本含义是 '有责任的' 或者 '有可能的'。它通常用于形容一种可能性，表示一个人有可能面临一个情况或者承担某种责任。
sidebar:
  hidden: true
...
<Pronunciation word="Liable" uk="/ˈlaɪ̯əbəl/" us="/ˈlaɪ̯əbəl/" client:only />
...
"liable" 这个单词在英语中是个相当常用的单词，并没特别的历史文化背景，它源自于法语的 "lié"，在 14 世纪的时候开始在英语中出现，主要用在法律语境中。
