---
title: ID
description: "- 英文单词 'ID' 是 'identification' 的缩写，通常用于指代识别符号或身份证明。"
sidebar:
  hidden: true
...
<Pronunciation word="ID" uk="/ɪd/" us="/ɪd/" client:only />
...
- "ID" 这个词从 20 世纪初开始使用，源自 "identification"，缩写这种方式可以更快更方便地传达信息。
