...
title: Moist
description: >-
  Moist是一个形容词，主要意思是“湿润的”，“微湿的”，常用来形容天气、土壤、蛋糕等各种物体或状态。当用于形容食物时，例如蛋糕或面包，'moist'通常表示食物质地饱满，不干燥。
sidebar:
  hidden: true
...
<Pronunciation word="Moist" uk="/mɔɪst/" us="/mɔɪst/" client:only />
...
"Moist"最初于 14 世纪出现在英文中，来源于拉丁语的词根 have "mucidus"。它的含义自出现以来一直没有改变，仍用来描述受湿润气候、雨水等影响的物质状况。
...
<WordRelations
  synonyms={["dank","damp","thoan","thone","misty","weepy","wet","liquidlike"]}
  client:only
/>
