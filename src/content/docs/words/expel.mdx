---
title: Expel
description: Expel是一个动词，表示“驱逐”或“开除”。这通常是由于某人的不良行为或者违反了某些规章制度才会被执行。
sidebar:
  hidden: true
...
<Pronunciation word="Expel" uk="/ɪkˈspɛl/" us="/ɪkˈspɛl/" client:only />
...
"Expel"这个单词来自中世纪拉丁文"expellere"，是"ex-"（外）和"pellere"（推）的结合，最早见于 14 世纪英语。
...
<WordRelations synonyms={["fordrive"]} antonyms={["impel"]} client:only />
