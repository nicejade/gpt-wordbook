---
title: Pistol
description: "- 'Pistol' 是一个名词，常常指的是一种小型、便于携带和使用的手枪。"
sidebar:
  hidden: true
...
<Pronunciation word="Pistol" uk="/ˈpɪstəl/" us="/ˈpɪstəl/" client:only />
...
- "Pistol" 这个词来自 16 世纪的法语 "pistolet"，原指一种来自捷克的短筒急射火枪。在欧美文化中，手枪常被视为自卫和保护的象征。
