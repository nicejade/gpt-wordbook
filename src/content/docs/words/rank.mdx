---
title: Rank
description: Rank 是一个非常多元化的单词，可以作为名词和动词使用。名词时，一般意思是'等级'、'排名'或者'军衔'；动词时，意思是'做出排名'或'评级'。
sidebar:
  hidden: true
...
<Pronunciation word="Rank" uk="/ɹæŋk/" us="/ɹæŋk/" client:only />
...
"Rank"这个词在 14 世纪早期进入英语，最初的含义是一行或一列，源自古法语的"renc"，意为行或列。之后在 15 世纪发展出社会阶级或军衔的含义，而在 16 世纪则发展出了将事物以上下或优劣等标准进行排序的含义。
...
<WordRelations
  synonyms={["complete", "utter", "pong", "smelly", "stinky"]}
  client:only
/>
