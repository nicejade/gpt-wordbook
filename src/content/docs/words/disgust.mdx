...
description: >-
  Disgust
  是一个英语单词，通常用作名词或动词。作为名词时，'disgust'的意思是强烈的不喜欢或厌恶；作为动词时，'disgust'的意思是使人感到反感或厌恶。
sidebar:
  hidden: true
...
<Pronunciation word="Disgust" uk="/dɪsˈɡʌst/" us="/dɪsˈɡʌst/" client:only />
...
"Disgust"这个单词在英语中已经使用了很长时间，最早可追溯到 16 世纪的法语，来自拉丁语 disgustus，表示"不喜欢"或"讨厌"的含义。
