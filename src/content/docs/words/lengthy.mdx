---
title: Lengthy
description: Lengthy 是一个形容词，它意味着'长的、极长的'，通常用来描述时间、距离，或者一段文字。
sidebar:
  hidden: true
...
此单词的使用早在 17 世纪就有了，并在近年来变得更为常见，通常用来描述或评论一个事件，项目或过程的准备时间，实施时间或者对于某件事情的描述或讲解时间过长。
...
它变长有些像"length"，所以可以通过联想记住。例如，“记住一段长时间的内容可能需要一些 lengthy 的努力”。
