...
<WordRelations
  synonyms={["wireless","far","hidden","outlying","aloof","dispassionate","distant","removed","withdrawn","faint","remote"]}
  antonyms={["connected","contiguous","direct","close","near","proximate","intimate","involved","passionate","considerable","great","reasonable","sure"]}
  client:only
/>
