---
title: "remote"
description: "Remote是一个形容词，主要有两个基本含义：1. 距离远的，偏僻的，例如：a remote island (一个偏远的岛屿); 2. 微小的，不大可能的，例如：a remote possibility (微小的可能性)。此外，“remote”也可以作为名词，指代遥控器，例如：Pass me the TV remote (把电视遥控器递给我)。"
---
