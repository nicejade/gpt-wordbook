---
title: 'On'
description: On 是一个英语介词，主要有以下几种含义：
sidebar:
  hidden: true
...
<Pronunciation word="On" uk="/ɒn/" us="/ɔn/" client:only />
...
<WordRelations
  synonyms={["base","on","leg","about","apropos"]}
  antonyms={["off","after","afterward","afterwards","later","subsequently","thence","against"]}
  client:only
/>
