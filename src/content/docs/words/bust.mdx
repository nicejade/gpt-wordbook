...
title: Bust
description: >-
  Bust这个词在英语中的使用非常广泛，常见的含义有几种。首先，作为名词，它可以指半身雕塑，或者用来表示破产或者打破。作为动词，'bust'可以意味着破裂或者打破。在俚语中，'bust'还可以用来形容警察的搜查或逮捕。
sidebar:
  hidden: true
...
<Pronunciation word="Bust" uk="/ˈbʌst/" us="/ˈbʌst/" client:only />
...
"Bust" 这个词在 19 世纪的英国被广泛使用，用来描述破产或者破产的象征。在美国，它也被用来形容经济萧条期间的困境和破产的状态。
