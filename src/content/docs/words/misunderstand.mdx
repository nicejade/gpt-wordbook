...
title: Misunderstand
description: >-
  Misunderstand是一个动词，意思是“误解，误会”。它由 'mis-'和 'understand'两个部分组成，'mis-'
  是一个前缀，用于形成具有否定意义的单词，'understand'则表示“理解”。
sidebar:
  hidden: true
...
<Pronunciation word="Misunderstand" uk="/mɪs.ʌn.də(ɹ)ˈstænd/" us="/mɪs.ʌn.də(ɹ)ˈstænd/" client:only />
...
"Misunderstand"的词根是 'stand', 表示 '站立', '了解'。在欧洲诸语言中，stationary 的词根常带有了解的意思。其他的单词包括：understand, stand, withstand, outstanding。
