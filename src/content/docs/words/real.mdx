...
description: >-
  Real
  是一个英文单词，常被用作形容词，其主要意思是“真实的，现实的”，指的是物质存在或是不含虚构、假造成分的事情。其也有“真诚的，真挚的”等含义，用以描述人的性格或情感。
sidebar:
  hidden: true
...
<Pronunciation word="Real" uk="/ɹiːl/" us="/ɹiːl/" client:only />
...
"Real"一词起源于 14 世纪的法国，最初是“王权”的意思，后来在拉丁语中发展为“事物”，在英语中的使用演变为形容真实或真挚的东西。
...
<WordRelations
  synonyms={["actual","authentic","genuine","heartfelt","true"]}
  antonyms={["artificial","counterfeit","fake","sham","feigned","staged","imaginary","fictitious","pretend","unreal"]}
  client:only
/>
