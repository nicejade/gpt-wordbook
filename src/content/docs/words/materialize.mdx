---
title: Materialize
description: '"Materialize"是一个动词，它主要有两个含义： 1. 变得具体，变得明显或可见。 2. （想法、梦想、计划等）实现，实质化。'
sidebar:
  hidden: true
...
Materialize 的词根是"material"，来自拉丁词"materia"，意思是"物质"或"原材料"。
...
\-ize 是个英语后缀，用于将名词或形容词转变为动词，表示"使变为"或"使成为"。其他例子包括：realize（实现）、visualize（想象）。

### 文化背景

"Materialize"这个词在 19 世纪出现，最早用于描述物体变得清晰可见或从无到有的出现，后来转变为讨论思想或想法变为现实。
