...
title: Lean
description: >-
  Lean这个词有很多含义，作为动词，它通常意味着“倾斜”或“依靠”，例如，一棵树可能会朝着阳光的方向倾斜。作为形容词，'lean'就有了不同的意思，比如描述一个人或动物极少的脂肪含量，或者表示食物含有很少的脂肪。
sidebar:
  hidden: true
...
<Pronunciation word="Lean" uk="/liːn/" us="/liːn/" client:only />

### 列举例句

1.  He had to lean the ladder against the wall to reach the top.（他必须要把梯子靠在墙上才能够到顶部。） 2. She's on a diet and eats only lean meat.（她正在减肥，只吃瘦肉。） 3. I leaned my bike against the wall.（我把我的自行车靠在墙上。）
...
<WordRelations synonyms={["tilt"]} client:only />
