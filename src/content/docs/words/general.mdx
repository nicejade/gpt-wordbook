...
title: General
description: >-
  General 是一个英文单词，主要的含义是“一般的，普通的”或“全面的，总的”。它往往被用于描述广泛的、非特定的或非详细的内容。例如，“It's just
  a general idea.”（这只是一个大概的思路。）
sidebar:
  hidden: true
...
<Pronunciation word="General" uk="/ˈd͡ʒɛnɹəl/" us="/ˈd͡ʒɛnəɹəl/" client:only />
...
<WordRelations
  synonyms={["broad", "generic", "typical"]}
  antonyms={["particular", "specific", "abnormal", "uncommon"]}
  client:only
/>
