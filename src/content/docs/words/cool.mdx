---
title: Cool
description: Cool是一个非常常用的形容词，有许多不同的含义。主要有两大类是指'有魅力的'、'时尚的'以及'冷的'、'温度低'等。
sidebar:
  hidden: true
...
<Pronunciation word="Cool" uk="/kuːl/" us="/kuːl/" client:only />
...
<WordRelations
  synonyms={["calmness","composure","OK","acceptable","chilly","distant","phlegmatic","standoffish","unemotional","easy","fine","fashionable","happening","hip","in","modish"]}
  antonyms={["awkward","uncool","bothered","upset","démodé","out","lukewarm","tepid","warm","unacceptable","passionate"]}
  client:only
/>
