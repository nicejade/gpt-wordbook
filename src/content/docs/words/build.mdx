---
title: Build
description: Build 是一个英文动词，其基本意思是建造、构建。此外，它也有形成、逐渐增强的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Build" uk="/bɪld/" us="/bɪld/" client:only />
...
<WordRelations
  synonyms={["create","base","found","ground","construct","erect","enlarge","increase","strengthen"]}
  antonyms={["demolish","destroy","ruin","wreck","decrease","dissipate","weaken"]}
  client:only
/>
