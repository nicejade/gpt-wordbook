---
title: Concerning
description: Concerning 是一个英语介词，用于引导一个词语或从句，表示“关于”或“涉及到”的含义。它通常用于形容具体的事情、主题或问题。
sidebar:
  hidden: true
...
<Pronunciation word="Concerning" uk="/kənˈsɜːnɪŋ/" us="/kənˈsɝnɪŋ/" client:only />
...
“Concerning”源自 14 世纪的英语，从拉丁语“concernere”转变而来，早期汉译为“触及”或“涉及”，现代常用于书面语，表达"关于"的含义。
