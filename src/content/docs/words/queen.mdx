---
title: Queen
description: 英文词 'Queen' 是一个名词，它在中文中的对应翻译是'女王'，多用来指代女性君主。
sidebar:
  hidden: true
...
<Pronunciation word="Queen" uk="/kwiːn/" us="/kwiːn/" client:only />
...
<WordRelations synonyms={["bitch", "cowgirl", "girl", "lady"]} client:only />
