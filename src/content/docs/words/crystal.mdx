...
title: Crystal
description: >-
  Crystal 这个单词在英文中可以作为名词和形容词。作为名词，它指的是水晶、晶体，特指某些物质在适当的条件下所形成的规则的、统一的结构。形容词
  'crystal' 则用来描述清晰透明，如 'crystal clear'（清晰明确）。
sidebar:
  hidden: true
...
<Pronunciation word="Crystal" uk="/ˈkɹɪstəl/" us="/ˈkɹɪstəl/" client:only />
