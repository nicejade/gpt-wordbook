...
title: Mine
description: >-
  Mine是英语中的一个常用词，有三种主要的词义。它可以作为名词，表示'矿山'或者'地雷'；作为代词，表示“我/我的”，这是它在第一人称单数中的所有格形式；另外，'mine'也可以作为动词，意为'开采'或者'设置地雷”。
sidebar:
  hidden: true
...
<Pronunciation word="Mine" uk="/maɪn/" us="/maɪn/" client:only />
