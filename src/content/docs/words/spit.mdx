...
title: Spit
description: >-
  Spit 在英语中是一个多义词，它既可以做动词也可以做名词。作为动词时，'spit' 的主要含义是“吐出”或“唾弃”，尤其是在向 alguien 或
  etwas 吐口水或其他物质时。作为一个名词时，'spit' 主要表示“口水”或“唾液”。
sidebar:
  hidden: true
...
<Pronunciation word="Spit" uk="/spɪt/" us="/spɪt/" client:only />
...
<WordRelations synonyms={["broach"]} client:only />
