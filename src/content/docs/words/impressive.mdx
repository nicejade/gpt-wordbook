---
title: Impressive
description: Impressive是一个形容词，用来形容令人感到印象深刻或者令人赞叹的人或事物。
sidebar:
  hidden: true
...
"Impressive"由前缀 im-，词根 press，后缀-ive 组成。
im-是一个表示否定或强调的前缀，press 来自拉丁词根 press，意为“压，按”，-ive 是一个形容词后缀，意为“…的”。

### 词缀分析

其他带有相同前缀 im-的单词包括：impossible(不可能的)、imperfect(不完美的)。
其他带有相同词根 press 的单词包括：pressure(压力)、compress(压缩)。

### 文化背景

"Impressive"几乎自 16 世纪以来，就一直被用来描绘那些强烈影响人或给人深刻印象的东西。
...
<WordRelations antonyms={["unimpressive"]} client:only />
