...
description: >-
  Press
  是一个非常常用的词，可以作为名词和动词使用。作为动词，它的基本意思包括'推'、'按'、'压'、'挤'等。作为名词，它主要被用来指'媒体''新闻界'或'出版社'。
sidebar:
  hidden: true
...
<Pronunciation word="Press" uk="/pɹɛs/" us="/pɹɛs/" client:only />
...
"Press" 本身就是一个词根，在此没有前缀和后缀，但它可以衍生出含有其他词缀的单词，例如"compress"（前缀 com-，表示"一起"）。
...
<WordRelations synonyms={["closet", "cupboard", "pantry"]} client:only />
