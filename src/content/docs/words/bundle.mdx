...
description: >-
  _'Bundle'_
  是个名词，也可作为动词使用。作为名词，它的主要意思是“捆，束”，用来描述一组绑在一起的物体。作为动词，它可以表示“捆绑”，或者动作迅速的意思，如
  'bundle off'。
sidebar:
  hidden: true
...
<Pronunciation word="Bundle" uk="/ˈbʌnd(ə)l/" us="/ˈbʌnd(ə)l/" client:only />
...
Bundle 的词根来自 老英语 "byndelle", 表示绑在一起的物品。
...
单词 "bundle" 在 14 世纪从中英语变成现代英语，原本指的是一捆布或者纸张。
...
<WordRelations synonyms={["bundle"]} client:only />
