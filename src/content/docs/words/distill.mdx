...
description: >-
  Distill
  这个单词是动词，用于描述提炼，精馏的过程，经常用在库存，蜜蜂蜜，石油，酒精等液态物质的精炼过程中。此外，它也可以形象地用于表示把复杂的事物提炼成其本质或者最简单的形式。
sidebar:
  hidden: true
...
<Pronunciation word="Distill" uk="[dɪˈstɪɫ]" us="[dɪˈstɪɫ]" client:only />
...
"Distill"这个词源于 14 世纪晚期的英语，来自拉丁语 "distillare" 意为 "滴落，滴漏出"。这个词汇在中世纪被广泛地用于描述用蒸馏法来提取药物，酒精等物质的过程。
