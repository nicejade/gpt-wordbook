---
title: Sorrowful
description: Sorrowful 是一个形容词，源自' sorrow'，表示 '悲伤的' 或 '愁苦的'。
sidebar:
  hidden: true
...
<Pronunciation word="Sorrowful" uk="/ˈsɔɹoʊfəl/" us="/ˈsɑɹoʊfəl/" client:only />
...
你可以将 "sorrowful" 拆解来记，sorrow 是悲伤的意思，ful 表示充满的意思，所以 sorrowful 就是充满悲伤的。
...
<WordRelations synonyms={["grievous", "lamentable", "mournful"]} client:only />
