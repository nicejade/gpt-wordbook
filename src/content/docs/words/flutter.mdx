...
title: Flutter
description: >-
  Flutter是个动词，也可以用作名词。作为动词，表示“快速而轻盈地摆动（翅膀或其他体部）”，例如鸟儿、蝴蝶沿着空气中的路径快速摆动翅膀。作为名词，它可以表示一种快速和轻盈的摆动动作或者轻的震颤的感觉。
sidebar:
  hidden: true
...
<Pronunciation word="Flutter" uk="/ˈflʌtə/" us="/ˈflʌtɚ/" client:only />
