...
title: Sector
description: >-
  Sector是一个英语词汇，用作名词指的是一个政策或社会环境下的一部分，比如'教育部门（educational sector）''私有部门（private
  sector）'. 还可以指的是扇形或者一部分地区。
sidebar:
  hidden: true
...
<Pronunciation word="Sector" uk="/ˈsɛk.təɹ/" us="/ˈsɛk.təɹ/" client:only />
...
"Sectors" 是 sector 的复数形式，中文翻译为"部门"。
