...
title: Beef
description: >-
  Beef 是一个名词，主要指的是我们的食物之一，即来自牛的肉。这个词也有 '牛肉品种' 和 '肌肉' 的含义。在俚语中，'beef' 可以表示 '不满' 或
  '争议'。
sidebar:
  hidden: true
...
<Pronunciation word="Beef" uk="/biːf/" us="/biːf/" client:only />
...
<WordRelations synonyms={["cowflesh", "oxflesh"]} client:only />
