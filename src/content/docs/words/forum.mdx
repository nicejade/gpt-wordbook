...
title: Forum
description: >-
  Forum 是一个英语名词，来源于拉丁文，最初指的是古罗马的公共广场，人们在此集会、交流或讨论公共事务。在当前的英语中，'forum'
  常常被用来指代一种讨论场所，可以是线上的网站，也可以是线下的交流圆桌。此外，“forum”也可以用来指任何开放的讨论或表达观点的场所。
sidebar:
  hidden: true
...
<Pronunciation word="Forum" uk="/ˈfɔːɹəm/" us="/ˈfɔːɹəm/" client:only />
