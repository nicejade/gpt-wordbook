---
title: Prince
description: Prince 是一个名词，通常用来指国王或者统治者的儿子。也可以用于形容一个人的行为很有君子风度，或者他的地位、行为和能力像王子一样。
sidebar:
  hidden: true
...
<Pronunciation word="Prince" uk="/pɹɪns/" us="/pɹɪns/" client:only />
...
你可以把这个单词想象成"print"与"ce"的组合，print 打印出的 ce(Chief Executive 总裁)，即很有领导气质的人，像王子一样。
