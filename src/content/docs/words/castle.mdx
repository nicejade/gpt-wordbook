---
title: Castle
description: Castle 是名词，意思是“城堡”，通常指欧洲的大型防御性建筑。
sidebar:
  hidden: true
...
<Pronunciation word="Castle" uk="/kæsl̩/" us="/kæsl̩/" client:only />
...
作为名词的"castle"没有单复数、动词、不同时态、形容词、副词等的变形。但 castle 还可以作为棋类运动中的术语，指象棋中的“王车易位”。
...
<WordRelations
  synonyms={["fortress", "castellate", "incastellate", "fortify"]}
  client:only
/>
