---
title: Immortal
description: Immortal 是一个形容词，意思是 “不朽的，永恒的”，通常指的是无法死亡或寿命无限的生物，也常用于描述人的作品或名声等不会随时间消失的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Immortal" uk="/ɪˈmɔːtəl/" us="/ɪˈmɔɹtəl/" client:only />
...
<WordRelations
  synonyms={["deathless", "everlasting", "undeadly"]}
  antonyms={["mortal"]}
  client:only
/>
