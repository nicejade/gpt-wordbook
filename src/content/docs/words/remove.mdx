...
title: Remove
description: >-
  Remove 作为一个动词，意指“移除”、“搬走”、“取出”或者“去掉”。例如：remove the trash（清理垃圾）、remove a
  stain（去掉污渍）。
sidebar:
  hidden: true
...
<Pronunciation word="Remove" uk="/ɹɪˈmuːv/" us="/ɹɪˈmuːv/" client:only />
...
"Remove" 这个词在 14 世纪中叶时从拉丁语词汇 evolvere（卷出、进展）中衍生而来。在那个时代，人们用 remove 主要表示“移动、走开”，慢慢的发展到现在，该词有了“移除、剔除”等含义。
