---
title: Constant
description: 「Constant」这个单词在英语里常常被用作形容词，意为“持续的，稳定的，不变的”。它也可以作为名词，表示“恒量，常数”。
sidebar:
  hidden: true
...
<Pronunciation word="Constant" uk="/ˈkɒnstənt/" us="/ˈkɑnstənt/" client:only />
...
3.  In Mathematics, pi is a mathematical constant.（在数学中，π 是一个数学常数。）
...
<WordRelations
  synonyms={["nonchanging", "unaltering", "unvarying"]}
  client:only
/>
