---
title: Word
description: Word 是一个英语词汇，主要指的是一个语句或者句子的基本单位，也可以指说的或者写的话。它有很多含义和用法。
sidebar:
  hidden: true
...
<Pronunciation word="Word" uk="/wɜːd/" us="/wɝd/" client:only />
...
<WordRelations
  synonyms={["Bible","God","Logos","promise","vocable","express","phrase","state"]}
  client:only
/>
