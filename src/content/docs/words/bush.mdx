---
title: Bush
description: Bush在英语中的主要含义是“灌木”，通常用来描述一些比树小，更矮，而且枝条丰满的植物。另外，“Bush”也可以作为姓氏使用，如美国前总统乔治·布什。
sidebar:
  hidden: true
...
<Pronunciation word="Bush" uk="/bʊʃ/" us="/bʊʃ/" client:only />
...
<WordRelations synonyms={["shrub"]} client:only />
