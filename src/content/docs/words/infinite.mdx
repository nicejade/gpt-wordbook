...
title: Infinite
description: >-
  Infinite 是一个英语形容词，源于拉丁语
  'infinitus'，意思是“无尽的，无限的”。它可以用来描述无尽的时间，空间，数量，或者抽象的概念，如无限的公平、仁慈等。
sidebar:
  hidden: true
...
<Pronunciation word="Infinite" uk="/ˈɪnfɪnɪt/" us="/ˈɪnfənɪt/" client:only />
...
“Infinite”的使用可以追溯到 14 世纪的英格兰，它源于中古拉丁语词'infinitus'。在英语中，该词经常用于形容词和名词，帮助形容东西无穷无尽或无限大的特性。
...
<WordRelations
  synonyms={["immeasurable","inestimable","vast","countless","endless","interminable","limitless","unbounded","unending","unlimited"]}
  antonyms={["finite", "infinitesimal", "limited"]}
  client:only
/>
