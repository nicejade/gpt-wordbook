---
title: Drink
description: Drink 是一个英语单词，既可以作为名词，意思是“饮料”或者“一份饮料”，也可以作为动词，意思是“喝”。
sidebar:
  hidden: true
...
<Pronunciation word="Drink" uk="/dɹɪŋk/" us="/dɹɪŋk/" client:only />
...
- 动词： drink (现在式)，drank (过去式)，drunk (过去分词)，drinking (现在分词)
- 形容词和副词：通常不用此形式
- 固定搭配： have a drink (喝一杯), drink to... (为...干杯)
...
<WordRelations
  synonyms={["gulp", "imbibe", "quaff", "sip", "alcohol"]}
  client:only
/>
