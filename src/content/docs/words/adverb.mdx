---
title: Adverb
description: Adverb 是英文中的一个词典术语，中文翻译为“副词”。副词是用来修饰动词、形容词或者其他副词的词类。它用于描绘行动的方式、地点、时间、程度等。
sidebar:
  hidden: true
...
<Pronunciation word="Adverb" uk="/ˈæd.vɜːb/" us="/ˈæd.vɝb/" client:only />
...
<WordRelations synonyms={["adverbialize"]} client:only />
