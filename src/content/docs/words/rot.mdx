---
title: Rot
description: 英语单词 'rot' 的意思是指“腐烂”，也可能指变坏或衰败。通常，这个单词被用来描述自然的分解过程，特别是当有机物质开始分解并释放出恶臭的气味时。
sidebar:
  hidden: true
...
<Pronunciation word="Rot" uk="/ɹɔt/" us="[ɹɑt]" client:only />
...
<WordRelations synonyms={["putrefy"]} client:only />
