...
description: >-
  Invade
  是一个动词，主要有两个含义：一是指军事上的'入侵、侵略'；二是比喻用的，表示“涌入，侵扰”。它常常用于描述在生物、疾病、人群乃至思想等各个方面的入侵和侵扰。
sidebar:
  hidden: true
...
<Pronunciation word="Invade" uk="/ɪnˈveɪd/" us="/ɪnˈveɪd/" client:only />
...
<WordRelations antonyms={["evade"]} client:only />
