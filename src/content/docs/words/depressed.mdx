...
title: Depressed
description: >-
  "Depressed"是一个形容词，主要有两种含义: 1. 悲伤的，沮丧的，表示一个人的情绪低落或者消沉。例如：He was depressed after
  his failure (他在失败后感到很沮丧)。 2. 抑制的，使降低的，表示某种程度或活动的降低或降低。比如：The market is in a
  depressed state (市场处于低迷状态).
sidebar:
  hidden: true
