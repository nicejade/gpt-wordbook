---
title: Depressed
description: "Depressed是一个形容词，主要有两种含义:"
sidebar:
  hidden: true
...
<Pronunciation word="Depressed" uk="/dɪˈpɹɛst/" us="/dɪˈpɹɛst/" client:only />
...
<WordRelations
  synonyms={["despondent","gloomy","melancholy","miserable","sad","unhappy"]}
  antonyms={["cheerful"]}
  client:only
/>
