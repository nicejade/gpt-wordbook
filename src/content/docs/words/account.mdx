---
title: "account"
description: "Account是一个既可以做名词也可以做动词的单词。 * 作为名词时，可以表示“账户，帐目”，例如：bank account (银行账户)，也可以表示“描述，说明”，例如：She gave a detailed account of the incident. (她详细描述了这个事件。) * 作为动词时，表示解释,例如：You'll need to account for the missing money. (你需要解释钱去哪了。)"
---
