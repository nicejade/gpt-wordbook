---
title: Account
description: Account是一个既可以做名词也可以做动词的单词。
sidebar:
  hidden: true
...
<Pronunciation word="Account" uk="/ə.ˈkaʊnt/" us="/ə.ˈkaʊnt/" client:only />
...
<WordRelations
  synonyms={["explanation","defense","excuse","membership","registration","username","description","narration","narrative","recital","relation"]}
  client:only
/>
