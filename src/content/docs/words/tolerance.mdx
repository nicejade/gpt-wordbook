...
description: >-
  Tolerance
  是名词，意为'忍受'、'容忍'。这个单词具有多个用途，例如在医学上，表示对药物、疾病或环境条件的抵抗力；在技术或工程上，表示一种公差、偏差或者波动的接受程度；在社会或道德问题上，表示对不同种族、宗教或观点的宽容和接纳。
sidebar:
  hidden: true
...
<Pronunciation word="Tolerance" uk="/ˈtɒləɹəns/" us="/ˈtɒləɹəns/" client:only />
...
<WordRelations antonyms={["intolerance"]} client:only />
