...
title: Visibility
description: >-
  Visibility 是一个名词，其基本含义为能见度，也可以翻译为显见性，可见度等。在不同的语境下，Visibility
  的含义略有不同。例如，天气报告中的'visibility'是指能明确看清的最远距离，而在销售或广告策略中，“visibility'是指产品或品牌的知名度。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["apparency", "visibleness"]}
  antonyms={["hiddenness", "invisibility", "latency"]}
  client:only
/>
