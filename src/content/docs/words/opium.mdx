---
title: Opium
description: Opium是一个名词，表示一种从罂粟头的乳液中提取的麻醉品。它常常被加工成各种药物，包括镇痛剂和嗜睡剂。
sidebar:
  hidden: true
...
<Pronunciation word="Opium" uk="/ˈəʊpi.əm/" us="/ˈəʊpi.əm/" client:only />
...
在 19 世纪，一个男人对鸦片上瘾，他最初用它作为镇痛剂。渐渐地，他的生活开始破裂，象征着鸦片滥用的破坏力。
