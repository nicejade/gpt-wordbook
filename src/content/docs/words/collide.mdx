...
title: Collide
description: >-
  - 'Collide' 是一个动词，来源于拉丁语
  'collidere'，原本的意思是'一起撞击'，现在主要用于描述两个或多个实体（物体、观念、意愿等）相互冲突或碰撞。它可以是物理的碰撞，也可以是象征性的，比如指观念的冲突。
sidebar:
  hidden: true
...
<Pronunciation word="Collide" uk="/kəˈlɑɪd/" us="/kəˈlɑɪd/" client:only />
...
- "Collide" 这个单词最早被使用是在 17 世纪，由 latin "collisio" 演变而来，直到今天我们使用 "collide" 这个单词来描述各种形式的冲突或碰撞。
...
<WordRelations synonyms={["clash"]} client:only />
