...
title: Hypothesis
description: >-
  Hypothesis 是一个表示'一个尚未证实的理论或供论证的前提'
  的英语单词。这样的理论，人们一般是基于有限的证据进行提出，并期待通过进一步的研究进行验证。
sidebar:
  hidden: true
...
<Pronunciation word="Hypothesis" uk="/-əsəs/" us="/haɪˈpɑː.θə.sɪs/" client:only />
...
<WordRelations
  synonyms={["guess","supposition","theory","thesis"]}
  client:only
/>
