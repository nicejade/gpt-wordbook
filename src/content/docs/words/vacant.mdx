---
title: Vacant
description: '英文单词 ''vacant'' 是一个形容词，主要用来描述一个地方没有被占用, 空的, 未被使用的，或者描述一个人的表情或眼神呆滞、茫然。'
sidebar:
  hidden: true
...
<Pronunciation word="Vacant" uk="/ˈveɪkənt/" us="/ˈveɪkənt/" client:only />
...
"vacant" 这个单词来自于拉丁语 vacāns, 是 vacāre 的现在分词形式，原意是"空的", "无人住的"。在法语中，保留了这个词，意思也基本不变。

### 单词变形

与 vacant 相关的词形变化有它的名词形式 "vacancy"，意为“空缺，空白”；动词形式是 "vacate"，意为“腾出，空出”。
...
<WordRelations
  synonyms={["available","empty","free","uninhabited","unoccupied","vacuous"]}
  client:only
/>
