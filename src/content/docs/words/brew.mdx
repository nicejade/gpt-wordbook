---
title: Brew
description: Brew在英语中是一个动词，它最常见的含义是“酿造”，尤其用来描述酿造酒或煮咖啡、茶等饮品的过程。此外，它也可用来形容即将发生或正在酝酿的一种状况。
sidebar:
  hidden: true
...
<Pronunciation word="Brew" uk="/bɹuː/" us="/bɹuː/" client:only />
...
<WordRelations synonyms={["contrive", "hatch", "plot"]} client:only />
