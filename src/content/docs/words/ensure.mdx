---
title: Ensure
description: 英语单词'ensure'的意思是'确保'，'保证'。
sidebar:
  hidden: true
...
<Pronunciation word="Ensure" uk="/ɪnˈʃɔː/" us="/ɪnˈʃɔː/" client:only />
...
"Ensure"这个单词首次在 14 世纪的英格兰出现，原意为"使安全"或者"使安心"。这个词在保险业和其他需要保障的行业里使用得很普遍。
