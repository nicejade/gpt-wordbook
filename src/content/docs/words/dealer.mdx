---
title: Dealer
description: Dealer 是一个名词，主要有两种意义，第一种是指售货人或交易商，如汽车经销商；第二种是指发牌者，如扑克中的发牌员。
sidebar:
  hidden: true
...
<Pronunciation word="Dealer" uk="/ˈdiːlə(ɹ)/" us="/ˈdiːlə(ɹ)/" client:only />
...
<WordRelations synonyms={["peddler", "salesman"]} client:only />
