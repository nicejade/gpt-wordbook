---
title: Part
description: Part 在英语中主要有两种用法。一是作为名词，表示“部分、零件、角色”。二是作为动词，表示“分开、分离”。
sidebar:
  hidden: true
...
<Pronunciation word="Part" uk="/pɐːt/" us="/pɑɹt/" client:only />
...
<WordRelations
  synonyms={["component","element","piece","portion","faction","party","parting","shed","position","role"]}
  client:only
/>
