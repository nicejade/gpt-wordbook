---
title: Link
description: Link作为名词，主要意思为'联系'或'链接'，形象地比喻，像链条一样将两者连接起来。另外，'link'也可以作为后缀，表示网络链接。
sidebar:
  hidden: true
...
<Pronunciation word="Link" uk="/lɪŋk/" us="/lɪŋk/" client:only />
...
Link 这个单词没有词根，但是来源于古英语的 "hlinc"，意味着"链"。
...
<WordRelations
  synonyms={["link", "connection", "affix", "attach", "join"]}
  client:only
/>
