---
title: Instability
description: Instability 是一个英文名词，中文意思是 '不稳定，易变动'。
sidebar:
  hidden: true
...
Instability 的前缀是 "in-"，表示否定，"stabil" 是词根，后缀 "-ity" 用以形成名词。

### 文化背景

Instability 的形成可以追溯到文艺复兴时期的欧洲，那时许多科学、政治和社会观念开始动摇，正是这种动荡不安的状态给 "instability" 这个词赋予了初步的含义。
...
<WordRelations synonyms={["volatility"]} client:only />
