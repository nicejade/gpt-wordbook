...
title: Mock
description: >-
  Mock 的主要含义是'模仿'，'嘲笑'或'模仿以取笑'。它可以作为名词、动词、形容词和副词使用。例如，你可能会仿效别人的口音以取笑他们（mocking
  their accent），或者侮辱他们（mocking them）。
sidebar:
  hidden: true
...
<Pronunciation word="Mock" uk="/mɒk/" us="/mɑk/" client:only />
...
英语单词"mock"最初出现在 15 世纪中叶，源自中古法语的“mocquer”，意为"嘲笑"或"欺诈"。
