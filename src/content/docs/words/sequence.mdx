---
title: Sequence
description: 单词'sequence'在英文中是个名词，意思是“顺序”或“序列”。它指的是事件、动作或事物的连续发生，有具体的先后顺序。
sidebar:
  hidden: true
...
<Pronunciation word="Sequence" uk="/ˈsiːkwəns/" us="/ˈsiːkwəns/" client:only />

### 列举例句

1.  I lost my place in the sequence of events. (我对事件的顺序弄混了。)
2.  The sequences in the DNA strands were analyzed. (DNA 链中的序列被分析过。)
...
"Sequence"单词源于 14 世纪中叶的法语"seqüence"，该词来源于拉丁语"sequentia"，意为"跟随的事物"，其源头是拉丁语中的"sequi"，意为"跟随"。
