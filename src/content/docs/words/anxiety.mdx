---
title: Anxiety
description: Anxiety 是一个英语名词，表示一种心理状态，体现为担心、紧张或对未来的恐惧。它可以是对具体事物、环境或者是对未知的担忧。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["care","disquiet","distress","foreboding","perplexity","restlessness","solicitude","trouble","uneasiness"]}
  client:only
/>
