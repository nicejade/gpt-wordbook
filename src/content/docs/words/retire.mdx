...
title: retire
description: >-
  Retire是一个动词，主要有两个含义： 1. 退休: 这是它最常见的意思，通常在一个人结束长时间的职业生涯后使用。例如，After working for
  the company for 30 years, he decided to retire.（在为公司工作了30年后，他决定退休。） 2. 退房或撤退:
  这个词也可以意味着离开一个地方，尤其是去一个更私人的地方。例如， After the party, she retired to her
  room.（派对结束后，她退回到她的房间。）
sidebar:
  hidden: true
