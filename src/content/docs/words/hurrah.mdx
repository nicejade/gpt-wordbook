---
title: Hurrah
description: Hurrah 是一个表达热情、喜悦或赞成的感叹词，类似于“万岁”，常常在充满热情和期待的场合中使用，用以表达激动、欢呼或赞扬。
sidebar:
  hidden: true
...
<Pronunciation word="Hurrah" uk="/həˈɹɑː/" us="/həˈɹɑː/" client:only />
...
"Hurrah" 的词根不明，可能源于 16 世纪的士兵欢呼声，也可能来自其他欧洲语言的类似表达。
