---
title: Turtle
description: Turtle 是一个英文单词，一般被翻译为'海龟'或者'乌龟'。
sidebar:
  hidden: true
...
<Pronunciation word="Turtle" uk="/ˈtɜːtəl/" us="/ˈtɝtəl/" client:only />
...
"Turtle" 这个词源自中世纪的欧洲，原意指海龟。然而，在北美，这个词被普遍用来指所有的 Chelonia 类动物，也就是我们通常所说的龟和乌龟。
...
<WordRelations synonyms={["shellpad", "testudo"]} client:only />
