...
description: >-
  Market
  是一个名词，表示'市场'。在经济学中，市场是买卖双方进行交易的场所或机构。它也可以是指一种商品交易的供需状况，或者指某地区内的购买力。例如：'The
  real estate market is booming.'（房地产市场正在繁荣。）
sidebar:
  hidden: true
...
<Pronunciation word="Market" uk="/ˈmɑːkɪt/" us="/ˈmɑɹkɪt/" client:only />
...
"Market"来自拉丁词根 mercat-，表示"交易"，也是词语"merchandise"（商品）的词根。
...
<WordRelations synonyms={["arcade", "bazaar", "fair", "mart"]} client:only />
