---
title: Fluent
description: Fluent 是一个形容词，用于描述某人在某项技能或语言上的流畅度。在语言学习领域，我们常用它来形容一个人的语言运用能力。
sidebar:
  hidden: true
...
<Pronunciation word="Fluent" uk="/ˈfluːənt/" us="/ˈfluənt/" client:only />
...
"Fluent" 一词自 16 世纪以来一直用于描述水流，直到 18 世纪才开始用来形容语言的流利度。
...
<WordRelations synonyms={["fluent"]} client:only />
