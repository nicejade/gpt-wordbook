...
title: Hair
description: >-
  "Hair" 是一个英文名词，指的是人类和其他动物体表的毛发。 **例如** 1. She has long, curly hair.
  (她有一头长而卷曲的头发) 2. The dog's hair is soft and smooth. (这只狗的毛发又软又滑) 3. The common
  hair problems include hair loss, dry hair, etc. (常见的头发问题包括脱发、干燥等)
sidebar:
  hidden: true
