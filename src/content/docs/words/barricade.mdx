---
title: barricade
description: Barricade 是一个英文单词，作名词使用时，它的意思是路障，障碍物，用于阻止或限制人员或车辆通行。作动词使用时，它的意思是设置路障，阻塞。
sidebar:
  hidden: true
...
"Barricade" 词在 16 世纪末的法国开始出现，最初是描述横在街道上的屏障，用来抵御城市中的敌人。这个词后来在英语中也被广泛使用，描述任何用来阻碍通行的障碍物。
