---
title: "directory"
description: "Directory是一个名词，主要有两种含义： 1. 指示或导向某个地方的指南，例如电话簿或商业目录。 2. 计算机术语中，指代文件系统中文件和其它目录的组织方式，俗称文件夹。"
---
...
"Directory"的词源源自 17 世纪，最初意指导向某地的路标或指南。随着时间的推移，其含义逐渐扩展为一本提供有用信息的指南或名录，如电话簿。在计算机领域，随着操作系统出现，"Directory"也被用来指代文件夹。
