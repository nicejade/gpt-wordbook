---
title: Permit
description: '"Permit"是个英文动词，也可以作为名词。作为动词时，含义是"允许"、"许可"；作为名词时，含义是"许可证"、"批准书"。'
sidebar:
  hidden: true
...
Permit 一词来自于 16 世纪的法国，原意为“允许，让过”，其后经过英国人的借用和发展，最终成为现在的“允许，许可”。
...
Permit 的词根“mit”与 mission（任务）、transmit（传输）、commit（承诺）等词相同，都涉及到“派、送”的含义，可以联想记忆。
