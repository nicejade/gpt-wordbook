---
title: Rude
description: Rude 是形容词，常用来形容人或行为粗鲁的，没有礼貌的。这不仅局限于言语，也可能是行为或者态度。
sidebar:
  hidden: true
...
<Pronunciation word="Rude" uk="/ɹʉːd/" us="/ɹud/" client:only />
...
"Rude" 起源于法语 "rude"，意为"粗鲁的，无礼的"，并最早在 14 世纪进入英语。在欧美文化中，礼貌和尊重是社交交往的重要原则，所以 "rude" 的使用通常具有贬义，表示批评或不满。
...
<WordRelations
  synonyms={["uncouth", "adult", "blue", "primitive"]}
  client:only
/>
