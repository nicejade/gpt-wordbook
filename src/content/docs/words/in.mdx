---
title: In
description: "In 是一个英文介词，通常用于表示物体的位置、状态，或者时间。例如, 'in the box （在盒子里）', 'in time（及时）'."
sidebar:
  hidden: true
...
<Pronunciation word="In" uk="/ɪn/" us="/ɪn/" client:only />
...
<WordRelations antonyms={["out"]} client:only />
