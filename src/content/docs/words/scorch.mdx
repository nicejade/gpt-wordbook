...
title: Scorch
description: >-
  Scorch 这个单词是一个英文动词，主要有两个意思：1) 强烈热得使某物发黑、焦、烧毁；2)
  晒得皮肤痛或变色。例如，太阳的强烈热度可能会'scorch'植物的叶子。
sidebar:
  hidden: true
...
<Pronunciation word="Scorch" uk="/skɔːtʃ/" us="/skɔɹtʃ/" client:only />
...
<WordRelations synonyms={["singe"]} client:only />
