...
<WordRelations
  synonyms={["discretionary","optional","volitional","intentional","willful","honorary","unpaid","unwaged","autonomous","spontaneous"]}
  antonyms={["compulsory","obligatory","involuntary","accidental"]}
  client:only
/>
