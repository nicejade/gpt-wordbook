---
title: Voluntary
description: Voluntary 是一个形容词，表示的是愿意的，自愿的，非强制的。 它指的是一种自主选择去做某事，而不是因为别人或外部的压力而做的。
sidebar:
  hidden: true
...
<Pronunciation word="Voluntary" uk="/ˈvɒ.lən.tɹi/" us="/ˈvɑ.lənˌtɛ.ɹi/" client:only />
...
“Voluntary”是一个词根来源于拉丁语的单词，首先在 14 世纪，在法国和英国开始广泛使用。它的词义一直保持在描述一种自愿、自发的行为或状态。
...
<WordRelations
  synonyms={["discretionary","optional","volitional","intentional","willful","honorary","unpaid","unsalaried","unwaged","autonomous","spontaneous"]}
  antonyms={["compulsory","obligatory","involuntary","accidental","paid","salaried"]}
  client:only
/>
