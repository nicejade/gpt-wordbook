...
title: Cordless
description: >-
  Cordless 是一个形容词，表示'无线的'，'无绳的'或者是'无电缆的'。如果一个设备被称为
  cordless，那意味着，这个设备不需要通过电线，或者其他任何方式的实体连线来进行连接或者充电，通常它是通过电池或者无线技术进行操作和充电的。
sidebar:
  hidden: true
...
<WordRelations synonyms={["wireless"]} antonyms={["corded"]} client:only />
