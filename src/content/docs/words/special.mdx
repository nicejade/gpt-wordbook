...
description: >-
  Special
  这个词在英语中作为形容词使用，通常表示“特别的，不寻常的”，用来描述一种目标或事情不同于其他的且通常是更好的或更重要的。它亦可以作为名词，用来表示一个特别的项目，特别的事物或特殊的场合。
sidebar:
  hidden: true
...
<Pronunciation word="Special" uk="/ˈspɛ.ʃəl/" us="/ˈspɛ.ʃəl/" client:only />
...
<WordRelations antonyms={["common", "ordinary", "usual"]} client:only />
