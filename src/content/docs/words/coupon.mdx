---
title: Coupon
description: coupon 是英语中的一个名词，主要有两个含义。一是指具有一定金额的优惠券、折扣券，常在购物或购票时使用；二是指在债券上可剪下来兑现利息的小票。
sidebar:
  hidden: true
...
<Pronunciation word="Coupon" uk="/ˈkuːˌpɒn/" us="/ˈkjuːˌpɑn/" client:only />
...
<WordRelations synonyms={["voucher"]} client:only />
