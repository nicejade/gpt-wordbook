...
title: Disposable
description: >-
  Disposable 这个词在英语中是个形容词，通常被用来形容在用过之后就被丢弃，而不是被重复使用或保存的物品。例如，'disposable
  cup'意为'一次性杯子'。
sidebar:
  hidden: true
...
<Pronunciation word="Disposable" uk="/dɪsˈpəʊzəbl̩/" us="/dɪsˈpəʊzəbl̩/" client:only />
...
<WordRelations
  synonyms={["throwaway"]}
  antonyms={["indisposable","nondisposable","undisposable"]}
  client:only
/>
