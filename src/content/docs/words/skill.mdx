---
title: Skill
description: Skill 是名词，中文意思是“技巧”或“技能”。主要指通过学习和实践获得的能力。
sidebar:
  hidden: true
...
<Pronunciation word="Skill" uk="/skɪl/" us="/skɪl/" client:only />
...
<WordRelations synonyms={["ability", "talent"]} client:only />
