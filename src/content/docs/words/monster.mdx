---
title: Monster
description: Monster 是一个英语名词，主要有两种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Monster" uk="/ˈmɒnstə(ɹ)/" us="/ˈmɑnstɚ/" client:only />
...
<WordRelations synonyms={["gigantic", "monstrous"]} client:only />
