...
description: >-
  Passage
  是一个英语单词，它的主要含义是“通过，通行”，例如一条走廊或者一个门。它也可以代表某个特定的时间段或者过程，例如一篇文章的一段，或者音乐的一段。
sidebar:
  hidden: true
...
<Pronunciation word="Passage" uk="/ˈpæsɪd͡ʒ/" us="/ˈpæsɪd͡ʒ/" client:only />
...
<WordRelations synonyms={["passing"]} client:only />
