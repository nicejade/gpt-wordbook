---
title: Cradle
description: Cradle 是名词，字面意思是婴儿床或摇篮，也被用作动词，意义是温柔地保护或抱着。
sidebar:
  hidden: true
...
<Pronunciation word="Cradle" uk="/ˈkɹeɪdəl/" us="/ˈkɹeɪdəl/" client:only />
...
"Cradle"是一个非常老的词汇，源自 11 世纪的古英语。它的最初意义代表了一个包容和保护性的空间，这也是为什么它被用来描述寓送和创新的温床。
...
<WordRelations synonyms={["rocker", "rest"]} client:only />
