---
title: Sufficient
description: Sufficient 是一个形容词，表示'足够的'，'充足的'，主要用于描述某物或某个数量可以满足需要或要求。
sidebar:
  hidden: true
...
"Sufficient" 这个词在 17 世纪左右引入到英语中，源于拉丁语 "sufficere"，本意为奉上、提供或足够，一直沿用至今。
...
<WordRelations
  ...
  antonyms={["insufficient", "nonsufficient", "unsufficient"]}
  client:only
/>
