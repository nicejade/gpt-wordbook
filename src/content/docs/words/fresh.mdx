...
title: Fresh
description: >-
  Fresh这个单词在英文中是一个形容词，最直接的意思是“新鲜的”，通常用来形容食物未被加工，原汁原味的状态。另一种常见的意义是'新的'或者'未使用过的'。它还可以用来形容清新的空气或者是尚无经验的新手。
sidebar:
  hidden: true
...
<Pronunciation word="Fresh" uk="/fɹɛʃ/" us="/fɹɛʃ/" client:only />
...
<WordRelations
  synonyms={["cool", "fashionable", "rested"]}
