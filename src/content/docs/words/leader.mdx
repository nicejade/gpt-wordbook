---
title: Leader
description: Leader是一个英语名词，表示领导者，主管，头目或指挥者。这是一个一般性质的词，可以被用来指称任何领导或掌握权力的个体或团体。
sidebar:
  hidden: true
...
<Pronunciation word="Leader" uk="/ˈlidɚ/" us="/ˈlidɚ/" client:only />
...
<WordRelations synonyms={["conductor", "guide"]} client:only />
