...
title: Sphere
description: >-
  Sphere是一个英语单词，用于指代一个形状，表示三维空间中所有点距离中心点距离相等的封闭表面，中文翻译为“球体”。此外，它也可以在更抽象的上下文中使用，表示一个区域或领域，比如'in
  one's private sphere'（在某人的私人领域内）。
sidebar:
  hidden: true
...
<Pronunciation word="Sphere" uk="/sfɪə/" us="/sfɪɹ/" client:only />
...
这个单词在 14 世纪的英语中首次被使用，指代地球模型或天体。在现代意义上，它可以代表任何的球体或者一个领域或范畴。
...
<WordRelations
  synonyms={["ball","globe","orb","area","domain","field","orbit","sector"]}
  client:only
/>
