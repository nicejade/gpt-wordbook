---
title: Metre
description: Metre 是一个英文单词，主要表示长度的单位，等于 100 厘米。在诗歌中也指代诗歌的韵律。
sidebar:
  hidden: true
...
"Metre" 是一个英文单词，主要表示长度的单位，等于 100 厘米。在诗歌中也指代诗歌的韵律。

<Pronunciation word="Metre" uk="/ˈmiːtə/" us="/ˈmiːtəɹ/" client:only />
...
"Metre"这个词在英语中首次被用来表示长度单位是在 1797 年，表示公制长度单位的米。此用法源于法国革命期间的制度改革。"Metre"还有在诗歌的韵律中使用。
...
<WordRelations synonyms={["m"]} client:only />
