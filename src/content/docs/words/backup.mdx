---
title: "backup"
description: "Backup是一个常见的英语单词，主要有两个基本含义： 1. 一种安全网或保护性措施，如在计算机科学领域，备份指的是专门用于恢复原始数据（在失去或损坏原始数据的情况下）的复制品。例如：I have a backup of the files on an external hard drive. 2. 指可提供帮助或支持的人或事物。例如：In case of trouble, call in the backup."
---
