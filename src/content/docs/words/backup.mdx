---
title: Backup
description: Backup是一个常见的英语单词，主要有两个基本含义：
sidebar:
  hidden: true
...
<Pronunciation word="Backup" uk="/ˈbækˌʌp/" us="/ˈbækˌʌp/" client:only />
...
<WordRelations
  synonyms={["line","tailback","reserve","spare","substitute","extra","standby","backing"]}
  client:only
/>
