---
title: Publicly
description: Publicly 是一个副词，指公开地，公然地。
sidebar:
  hidden: true
...
<Pronunciation word="Publicly" uk="/ˈpʌblɪkli/" us="/ˈpʌblɪkli/" client:only />
...
"Publicly"由公共（public）加上表示副词的后缀-ly 组成。
...
"Publicly"这个单词源自古英语"publicus"，意为"公开的，公共的"，其中由词根 public 加上后缀-ly 形成新词，表示以公开或公共方式进行的动作。
...
你可以把"publicly"联想到“公开地”，即所有公开的事情都是 public, 加上-ly 就成了副词公开地。
...
<WordRelations antonyms={["privately", "secretly"]} client:only />
