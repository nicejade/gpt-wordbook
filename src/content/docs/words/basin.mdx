---
title: Basin
description: Basin 是一个英文名词，通常指的是一个可以装液体的容器，如 '水盆' 或 '洗脸盆'，或者宽阔、浅的地方，例如 '河盆' 或 '盆地'。
sidebar:
  hidden: true
...
<Pronunciation word="Basin" uk="/ˈbeɪsɪn/" us="/ˈbeɪsɪn/" client:only />
...
<WordRelations synonyms={["sink"]} client:only />
