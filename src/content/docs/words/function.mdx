...
description: >-
  Function
  是一个英语单词，作为名词时，它通常表示“功能”，“职能”或者“函数”等意思，主要用于描述事物的用途或者职责。作为动词时，表示“起作用”，'运行'。
sidebar:
  hidden: true
...
<Pronunciation word="Function" uk="/ˈfʌŋ(k)ʃən/" us="/ˈfʌŋkʃən/" client:only />
...
"Function" 最早由拉丁词"fungi"衍生，表示执行或完成。直到 16 世纪，它被引入英语，并用于描述事物的作用或用途。在现今的欧美文化中，"function" 是一个常用的单词，广泛用于科学、数学、电脑科学、生物学、社会学等诸多领域。
...
<WordRelations
  synonyms={["affair","occasion","aim","intention","purpose","role","use","func","funct","procedure","routine","subprogram","subroutine","map","mapping","operator","transformation"]}
