---
title: Get
description: Get 是一个常见的英语动词，它的基本意思是“得到”、“获取”。然而，这个词汇也有非常多的用法和含义，可以用在不同的语境中。
sidebar:
  hidden: true
...
<Pronunciation word="Get" uk="/ɡɛt/" us="/ɡɛt/" client:only />
...
<WordRelations
  synonyms={["arrive","reach","become","begin","commence","start","cause","make","bring","fetch","retrieve","obtain","getter","go","leave","scram","catch","hear"]}
  antonyms={["lose"]}
  client:only
/>
