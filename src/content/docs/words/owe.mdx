---
title: Owe
description: Owe 是一个动词，主要用途是指'负债'，'欠款'或'应归功于'。特定地，它可以用于谈论金钱债务，或者表达道义上的债务和义务。
sidebar:
  hidden: true
...
<Pronunciation word="Owe" uk="/əʊ/" us="/oʊ/" client:only />
...
"Owe" 这个词源于 7 世纪的 Anglo-Saxon 典籍，原始含义为 "拥有" 或 "拥有的物品"，后来不断发展演变为表示 "负债" 或 "欠债" 的意思。
