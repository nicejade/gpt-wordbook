---
title: "unqualified"
description: "Unqualified 是一个形容词，通常用于形容那些不具备必要条件，技能或素质的人或事物。例如，一个没有受过任何训练或学历的人可能被描述为 unqualified（不合格）的医生。在另一个情景中，unqualified 也可以描述没有限制或绝对的事物，例如 unqualified success（绝对的成功）。"
---
