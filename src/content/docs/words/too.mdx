...
title: Too
description: >-
  too 通常有两种基本含义：1. '也'，'还'，如'I am a student, too'（我也是一个学生）；2. '过分'，'过度'，如 'The
  soup is too hot' （汤太热了）。
sidebar:
  hidden: true
...
<Pronunciation word="Too" uk="/tuː/" us="/tu/" client:only />
...
<WordRelations
  synonyms={["eke", "excessively", "extremely", "overmuch", "unnecessarily"]}
  client:only
/>
