---
title: Simulate
description: Simulate是一个动词，意思是模拟，假装或冒充。常被用来描述试图复制或重现一种特定的情况，尤其是为了实验或测试。
sidebar:
  hidden: true
...
<Pronunciation word="Simulate" uk="/-jə-/" us="/-jə-/" client:only />
...
"Simulate"这个词在 17 世纪引入英语，来源于拉丁语的 "simulare"。在科技日益发达的今天，这个词常被用来讨论计算机模拟或虚拟现实等方面。
