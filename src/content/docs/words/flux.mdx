---
title: Flux
description: Flux 在英语中主要有两种含义。一是指'流动'或'流量'，用于描述物资或能量的移动。二是指'变动'或'变化'，常用来描述情况不断变化，无定形的状况。
sidebar:
  hidden: true
...
<Pronunciation word="Flux" uk="/flʌks/" us="/flʌks/" client:only />
...
<WordRelations antonyms={["stasis"]} client:only />
