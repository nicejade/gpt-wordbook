...
description: >-
  ...
  **举例和翻译** 1. There is a constant flux of tourists in this area.（该地区有不断流动的游客。）
  2. The flux of his feelings made him unpredictable.（他的情绪变动使他难以预测。） 3.
  Scientists use flux to describe the rate of flow of a
  quantity.（科学家们用通量来描述量的流速。）
sidebar:
  hidden: true
