---
title: Hardware
description: Hardware 是英文的名词，常在计算机领域被使用，指的是计算机系统的所有物理设备，例如主机、显示器、键盘、鼠标等。
sidebar:
  hidden: true
...
<Pronunciation word="Hardware" uk="/ˈhɑːdˌwɛə/" us="/ˈhɑɹdˌwɛɹ/" client:only />
...
“Hardware”最初在英文中并不是用来指代计算机设备，而是泛指一切金属制品，例如五金、刀剑等。它在 14 世纪出现在英文中，至今已经有六个世纪的历史了。最初的“hardware”出现在和五金店相关的背景中。到了 20 世纪 60 年代，当计算机技术开始日趋成熟，人们逐渐开始用“hardware”来指代计算机的物理组件。
