...
title: Tense
description: >-
  Tense在英语中主要有两种用法,一种是名词形式，通常用在语法学中，表示'时态'，包括过去时(past tense)、现在时(present
  tense)和未来时(future tense)等；另一种是形容词形式，意为“紧张的，拉紧的”。
sidebar:
  hidden: true
...
<Pronunciation word="Tense" uk="/tɛns/" us="/tɛns/" client:only />
...
Tense 来自拉丁词根 "tendere"，意为“拉紧、伸展”。
这个词根也出现在其他单词中，比如:tend(趋向)，extend(延伸)等。

### 词缀分析

Tense 本身并没有词缀，但我们可以学习形容词后缀-ive 和-ness 变化形式，比如 tensive(拉紧的)，tenseness(紧张)。

### 文化背景

Tense 这个词汇在 14 世纪初从法语借用过来，最初的意思是“时间”，后来在语法中专门用来表示“时态”。
...
可以将 tense 联想为一个紧张的人进行体能锻炼，他的肌肉非常紧张，如同拉伸的绳子，从而更好地记住这个单词。
