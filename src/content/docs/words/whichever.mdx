...
description: >-
  Whichever是英语的一个
  连词，它有'无论哪一个、任何一个'的含义，用来选择一个范围内的对象。它被用来表达对选项的不关心，主张的是无论选择哪一个，结果都是一样。常用于陈述语句或是疑问词，引导名词性或者状语从句。
sidebar:
  hidden: true
...
<Pronunciation word="Whichever" uk="/wɪtʃˈɛvɚ/" us="/wɪtʃˈɛvɚ/" client:only />
