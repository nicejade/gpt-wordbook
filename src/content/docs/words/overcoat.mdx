---
title: Overcoat
description: Overcoat是一个英文名词，指的是一种大衣，通常是长到至少膝盖以上，用于在较冷的天气中穿在其他服装上方的外套。
sidebar:
  hidden: true
...
<Pronunciation word="Overcoat" uk="/ˈəʊvəkəʊt/" us="/ˈoʊvɚkoʊt/" client:only />
...
"Overcoat"一词源于 18 世纪的英国，最初是指“套在其他衣物上面的长大衣”。这种外套设计宽松，能够在寒冷的天气中增加保暖，同时方便穿着者在底层穿着其他服装。

**单词变形及搭配**

Overcoat 是个不可数名词，所以没有明显的单复数变形。词组上可以与颜色，材质等进行搭配，如：a black overcoat（一件黑色的大衣），a wool overcoat（一件羊毛大衣）。
