---
title: Paradise
description: Paradise 是一个英文单词，意为“天堂”，“乐园”，或是一个理想的、完美的地方。
sidebar:
  hidden: true
...
<Pronunciation word="Paradise" uk="/ˈpæ.ɹə.daɪs/" us="/ˈpæ.ɹə.daɪs/" client:only />
...
<WordRelations
  synonyms={["Heaven","heaven","bewitch","entrance","imparadise"]}
  client:only
/>
