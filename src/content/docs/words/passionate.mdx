...
title: Passionate
description: >-
  Passionate 是一个形容词，用于描述人对某件事情或某个目标有非常强烈的感情或热情。例如，一位对音乐非常热衷的人可以被描述为 'passionate
  musician'。
sidebar:
  hidden: true
...
<Pronunciation word="Passionate" uk="/ˈpæʃənət/" us="/ˈpæʃənət/" client:only />
...
<WordRelations
  synonyms={["ardent","blazing","burning","dithyrambic","fervent","fervid","fiery","flaming","glowing","heated","hotheaded","impassioned","perfervid","scorching","torrid"]}
  client:only
/>
