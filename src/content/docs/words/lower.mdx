...
title: Lower
description: >-
  "Lower" 是一个常用的英语单词，它既可以作为动词，也可以作为形容词。 作为动词，"lower"
  常常被用来表示"降低，减小"或"使降下，使下降"的意思。例如："Lower the volume, please" （请把音量调低）。
  作为形容词，"lower" 用来指"更低的，下方的"或比较级，“低于…”。例如："the lower shelf" (下面的架子)，"Lower than
  expected." (低于预期）。
sidebar:
  hidden: true
