---
title: Lower
description: Lower 是一个常用的英语单词，它既可以作为动词，也可以作为形容词。
sidebar:
  hidden: true
...
<Pronunciation word="Lower" uk="/ˈləʊə/" us="/ˈloʊɚ/" client:only />
...
"Lower" 的词根是老英语的 "lāwer", 意味着 "下面的" ，并且这个词首次在 14 世纪的中英语中出现。
