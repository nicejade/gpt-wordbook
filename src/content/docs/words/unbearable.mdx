...
title: Unbearable
description: >-
  Unbearable 这个词的字义十分清晰，'un-' 是前缀，表示否定，'bearable' 的意思是'能够承受的，能够忍受的'，所以
  'unbearable'的意思是'无法忍受的，让人无法承受的'。
sidebar:
  hidden: true
...
<WordRelations synonyms={["insufferable", "unsupportable"]} client:only />
