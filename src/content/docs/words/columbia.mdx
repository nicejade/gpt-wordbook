...
title: Columbia
description: >-
  Columbia 是一个英文名词，首字母大写时主要指哥伦比亚，南美的一个国家。此外，Columbia
  在美国常作为地名。例如，美国的哥伦比亚大学（Columbia University），哥伦比亚广播公司（Columbia Broadcasting
  System）。此外，也是刻达怡（Kid A）胡伯特（Hubert）哥伦比亚（Columbia）号太空飞船的名字。
sidebar:
  hidden: true
