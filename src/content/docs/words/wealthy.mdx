---
title: Wealthy
description: Wealthy 是一个英文形容词，用来描述一个人或者一个地方有大量的财富或者具有富裕的资产。这个词是对于经济状况或者生活水平相当高的一个描述。
sidebar:
  hidden: true
...
<Pronunciation word="Wealthy" uk="/ˈwɛl.θi/" us="/ˈwɛl.θi/" client:only />
...
<WordRelations synonyms={["affluent", "prosperous"]} client:only />
