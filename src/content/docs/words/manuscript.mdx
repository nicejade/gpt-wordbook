---
title: Manuscript
description: Manuscript 是一个名词，指的是手写或打印的未出版的工作，尤指一篇作家的初稿，您可以理解为“手稿”。
sidebar:
  hidden: true
...
Manuscript 来自拉丁词根"manu-"，表示"手"，以及词根 "-script", 表示"写"。你可以通过这个词根联想到"manicure"（美甲）和"scribe"（抄写员）。
...
Manuscript 这个词源于公元 1603 年左右的拉丁文 manuscripts，manuscriptum，意思是"手写的"，“手稿”。
...
（炎热的夏天，Bob 在阁楼上找到了一份陈旧的手稿。这份手稿引发了他对家族过去的一段探索之旅。）

<WordRelations
  synonyms={["autograph", "handwrit", "handwriting", "ms", "ms."]}
  client:only
/>
