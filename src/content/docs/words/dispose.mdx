---
title: Dispose
description: Dispose 是一个动词，主要的意思是「处置」、「处理」。此次我们将主要针对这个词的意思以及它的使用来进行分析。
sidebar:
  hidden: true
...
<Pronunciation word="Dispose" uk="/dɪˈspəʊz/" us="/dɪsˈpoʊz/" client:only />
...
"Dispose"在 14 世纪时由法语引入英语，最初的意思是"安排"，"分别摆放"，后来发展为包含"处理"，"处置"在内的概念。在现代英语中，这个词经常用于描述如何处理不再需要、无法使用或废弃的物品。
