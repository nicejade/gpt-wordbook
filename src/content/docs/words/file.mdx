---
title: File
description: File 是一个英语词汇，术语解释为'文档'或'文件'。在计算机科学中，'file'常被用于称呼一个储存在磁盘上的具体数据集。
sidebar:
  hidden: true
...
<Pronunciation word="File" uk="/faɪl/" us="/faɪl/" client:only />
...
<WordRelations synonyms={["document", "paper"]} client:only />
