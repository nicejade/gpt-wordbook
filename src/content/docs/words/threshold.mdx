...
title: Threshold
description: >-
  Threshold 在英文中是个名词，最常见的意义是“门槛”，比如用在描述房屋或房间入口的地方。此外，'threshold'
  也常用于比喻语境中，表示“界限”或“起始点”。
sidebar:
  hidden: true
...
- Threshold 的复数形态为 thresholds。
- Thresholding 是 threshold 的动词形式。
...
<WordRelations antonyms={["lintel"]} client:only />
