...
title: Amend
description: >-
  Amend是一个动词，源自拉丁语'amendare'，相当于中文的“修改”或者“修正”，通常用于指代修改法律、规定、文档或者条例。同时，'amend'还可以用来描述改正或改善个人行为或想法的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Amend" uk="/əˈmɛnd/" us="/əˈmɛnd/" client:only />
...
‘Amend'源自 14 世纪的英语，它的意思就是在改进、改良或修复方面做出些许改变，尤其是在法律、社规、行为等领域。它体现了西方社会对变革和进步的思考与追求。
...
<WordRelations synonyms={["ameliorate", "correct", "improve"]} client:only />
