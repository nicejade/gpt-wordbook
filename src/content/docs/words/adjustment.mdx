---
title: "adjustment"
description: "Adjustment 就是调整或者修改的意思。 它程度比 little tweak 重一些，但是比 'full renovation' 轻。它 表示对某事物进行的中等程度的改动以使之适应新的环境或者条件。"
---
...
"Adjustment" 的词根是 "adjust"。"Adjust" 来自于拉丁文中的 ad (到)+juxta(在…旁边，近)。
...
"Adjustment" 这个单词来自法文 “ajustement”, 这个词进一步的解释是 "a bringing to the proper level or position". 它的实际使用由来已久，至少可以回溯到 17 世纪。
