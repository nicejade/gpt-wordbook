...
title: Squad
description: >-
  Squad是英语中的一个名词，旨在指现在被认为是一个集体的人。它最初来源于军事用语，指一个最小的军事单位，通常由 8-14
  名士兵组成。但是，在平民口语中，“squad”也被用来泛指任何组织的团体或者一个团队。
sidebar:
  hidden: true
...
"Squad"是英语中的一个名词，旨在指现在被认为是一个集体的人。它最初来源于军事用语，指一个最小的军事单位，通常由 8-14 名士兵组成。但是，在平民口语中，“squad”也被用来泛指任何组织的团体或者一个团队。

<Pronunciation word="Squad" uk="/ˈskwɒd/" us="/ˈskwɒd/" client:only />
