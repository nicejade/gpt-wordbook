---
title: Ruling
description: Ruling是一个英文单词，它的基本含义是“裁决，规定”，通常指的是由权威或法庭做出的决定或判决。'Ruling'也可以用来形容统治的或占主导地位的。
sidebar:
  hidden: true
...
<Pronunciation word="Ruling" uk="/ˈɹuːlɪŋ/" us="/ˈɹuːlɪŋ/" client:only />
...
<WordRelations
  synonyms={["commandment","edict","order","rule","govern","regnant","reigning"]}
  client:only
/>
