---
title: Meet
description: Meet 是一个常用的动词，通常有以下的含义：
sidebar:
  hidden: true
...
<Pronunciation word="Meet" uk="/miːt/" us="/mit/" client:only />
...
"Meet" 来自于古英语 mētan，是原始日耳曼语的 mētana 的变形，意为“逐渐靠近”。
...
<WordRelations antonyms={["join", "pass"]} client:only />
