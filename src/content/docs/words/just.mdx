---
title: Just
description: Just是一个非常常用的英语单词，它有多个意思，大多数情况下表示“只是，仅仅”；表示强调时语气助词，“正好”，“刚刚”，或者“公正，公平”。
sidebar:
  hidden: true
...
<Pronunciation word="Just" uk="/d͡ʒʌst/" us="/d͡ʒʌst/" client:only />
...
<WordRelations
  synonyms={["adequate","proper","correct","right","equitable","righteous","barely","hardly","scarcely","merely","simply","freshly","lately","newly"]}
  antonyms={["unjust"]}
  client:only
/>
