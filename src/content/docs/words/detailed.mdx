---
title: Detailed
description: Detailed 是一个形容词，意思是'详细的，详尽的，精细的'。它用来描述给出或展示大量小而重要事项的信息、作品或计划。
sidebar:
  hidden: true
...
<Pronunciation word="Detailed" uk="/dɪˈteɪld/" us="/dɪˈteɪld/" client:only />
...
"Detail" 是 16 世纪从法语引入的，原意是"分解"，后来在艺术中用来指图片中的小部分，由此引申出“细节”之意。
...
<WordRelations synonyms={["detach", "specify"]} client:only />
