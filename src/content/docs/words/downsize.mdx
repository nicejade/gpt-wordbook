...
title: Downsize
description: >-
  Downsize这个单词一般在商业环境中使用，并且具有两种基本含义：'缩减（或裁减）规模或运营',常常用于描述公司淘汰员工来减少成本。第二个含义是'减小'，例如减小生活费用，减小孩子们长大后空出的房子的大小等。
sidebar:
  hidden: true
...
<Pronunciation word="Downsize" uk="/ˈdaʊnsaɪz/" us="/ˈdaʊnsaɪz/" client:only />
...
此词出现在 20 世纪 70 年代，当时美国的汽车行业受到了油价上涨的冲击，为了适应油价上涨带来的成本压力，汽车公司开始生产更小的车型，这个过程被称作“downsizing”（减小规模）。后来该词就扩展到了其他行业，并在 90 年代就更多地用于描述企业裁员、降低成本等行为。
...
<WordRelations synonyms={["rightsize"]} client:only />
