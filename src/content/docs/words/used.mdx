---
title: Used
description: Used 是动词 'use' 的过去式和过去分词，表示 '使用，利用'。
sidebar:
  hidden: true
...
<Pronunciation word="Used" uk="/juːzd/" us="/juːzd/" client:only />
...
你可以通过类比其他-ed 结尾的单词来记忆 "used"，把它和"过去的使用"的含义关联起来。
...
<WordRelations
  synonyms={["apply", "employ", "engage", "utilise", "utilize", "exploit"]}
  antonyms={["unused", "new"]}
  client:only
/>
