...
title: Damp
description: >-
  Damp 主要有两大词义，一是形容词，表示'湿的，潮湿的'，如 a damp cloth（一块潮湿的布）; 二是动词，表示'使湿气渗入，使...潮湿'，如
  to damp the fire（熄灭火焰）。
sidebar:
  hidden: true
...
<Pronunciation word="Damp" uk="/dæmp/" us="/dæmp/" client:only />
...
"Damp"来自中世纪英语，最初意思是"使人窒息或昏倒的蒸汽或气体"。16 世纪时变为"潮湿的"，18 世纪时发展为动词。
...
<WordRelations
  synonyms={["glum","melancholy","sorrowful","moist"]}
  client:only
/>
