---
title: Invest
description: Invest 是一个动词，原意是'投入'，即把钱、时间、努力等投入到某个项目或其它事物上，以期望将来能得到回报或利润。它还可以引申为'装备'或者'配备'。
sidebar:
  hidden: true
...
<Pronunciation word="Invest" uk="/ɪnˈvɛst/" us="/ɪnˈvɛst/" client:only />
...
<WordRelations
  synonyms={["besiege", "beclothe", "don", "dress"]}
