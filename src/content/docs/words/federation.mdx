...
description: >-
  "Federation"
  是一个名词，表示由自治权的个体、组织、或国家等组成的联合主体。最常见的用法通常是指一个联邦政府，或者说，一组地方或状态政府下属于一个中央政府体系的结构。
sidebar:
  hidden: true
...
2.  Switzerland is a federation of 26 states. (瑞士是由 26 个州组成的联邦)
3.  The Russian Federation is the largest country in the world. (俄罗斯联邦是世界上最大的国家)

### 词根分析

"Federation" 的词根是 "federat-"，来源于拉丁语的 "foedus"，表示 "treaty" 或 "agreement" 。其他由这个词根衍生出来的词汇包括 federal, confederate 等。

### 词缀分析

"Federation" 的后缀是 "-tion"，表明这是一个名词。其他具有类似词缀的单词包括 nation, creation, demonstration 等。
