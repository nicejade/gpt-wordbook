...
<Pronunciation word="Blunt" uk="/blʌnt/" us="/blʌnt/" client:only />
...
- "Blunt"最早被用于 13 世纪，形容“不锋利的”。16 世纪后，开始用于形容“直接的，直率的”。
...
<WordRelations
  synonyms={["curt","harsh","impolite","rude","short","uncivil","obtuse","stupid","coarse","dull","pointless"]}
  client:only
/>
