...
description: >-
  ...
  例如： 1. The structural design of the building is amazing. (这座建筑的结构设计令人惊叹。) 2.
  Structural changes are needed in the economy. (经济需要结构性的变化。) 3. The structural
  elements of a plan. (一个计划的结构性元素。)
sidebar:
  hidden: true
...
"Structure"这个词来自于拉丁语"Structura"，意为"一个建筑构造"，及其动词"struere"，意为"堆叠，构建"。在 17 世纪，这个词开始被使用来表示"身体构造"。在 20 世纪，又开始用于提及抽象的事物，比如说故事的结构。
