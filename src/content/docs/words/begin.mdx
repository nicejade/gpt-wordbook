---
title: Begin
description: Begin 是一个常用的英语动词，其基本意思是“开始”。不仅可以用来表示活动或事件从未发生的状态转变为发生的状态，也可以表示一个连续过程的开始。
sidebar:
  hidden: true
...
<Pronunciation word="Begin" uk="/biˈɡɪn/" us="/biˈɡɪn/" client:only />
...
<WordRelations synonyms={["commence", "initiate", "start"]} client:only />
