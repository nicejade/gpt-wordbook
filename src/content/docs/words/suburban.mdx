...
description: >-
  Suburban
  是一个形容词，形容居住或位于城市周边的住宅区，通常被用于描述舒适安静的居住环境，许多人们更倾向于在郊区寻找房子。它的中文翻译通常为'郊区的”。
sidebar:
  hidden: true
...
单词“suburban”最初出现在 15 世纪，用于形容在城市外的，直到 19 世纪，随着城市化速度的提升，这个单词更常用于描述城市周边的宁静住宅区。
...
<WordRelations antonyms={["nonsuburban"]} client:only />
