---
title: Forever
description: 'Forever是一个英文副词，代表“永远”，“永久”，“不断”，在一些口语场合下也可理解为 ''a very long time'', 即“非常长的时间”。'
sidebar:
  hidden: true
...
<Pronunciation word="Forever" uk="/fəˈɹɛvə(ɹ)/" us="/fəˈɹɛvɚ/" client:only />
...
“forever”由前缀 -for 和后缀 -ever 组成。其中 -ever 有强调的意思。

### 文化背景

“Forever”一词的使用在英语中较早，这一构词组合源自 10 世纪的英语，其意思是“无尽的时间”或“常常”。
...
<WordRelations
  synonyms={["always","continually","eternally","evermore","forevermore","incessantly","permanently"]}
  client:only
/>
