...
description: >-
  Cartridge
  是一个名词，通常指的是封装好的物品或设备，一般为供应封装或存储特定物质或零件的容器。用途广泛，比如打印机墨水盒、玩家插入游戏机的游戏盒、放入纪录玩家的子弹盒等。
sidebar:
  hidden: true
...
<Pronunciation word="Cartridge" uk="/ˈkɑːtɹɪdʒ/" us="/ˈkɑːtɹɪdʒ/" client:only />
...
"Cartridge" 是 16 世纪起源于法国的一个单词，它最初用于指挂在马车上的半圆形篮子。随着时间的发展，它的含义逐渐扩大，覆盖了所有目的为携带或存储特定物质或部分的设备或容器。
...
曾经有个叫 Tim 的男孩，他喜欢玩电子游戏。有一天，他发现了一款已经很久没有玩过的旧游戏卡带。他非常兴奋，立刻把游戏卡带插入游戏机，准备再次体验那激动人心的冒险。
