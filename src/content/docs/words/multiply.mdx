...
title: Multiply
description: >-
  multiply是一个英文动词，它有两个基本的含义：一是“乘”，即数学上的操作，即一个数以特定的次数增加。二是“增加”，或“繁殖”，通常用于指生物的繁殖或数量的增加。例如，细菌在适合的环境中可以迅速繁殖。
sidebar:
  hidden: true
...
"multiply"一词自 14 世纪以来就被用于数学概念，以表示把一个数量增加到它自身的特定倍数。而它表示“增加”或“繁殖”的含义则更早些出现，可以追溯到公元前 3 世纪。
...
<WordRelations synonyms={["manifold"]} client:only />
