...
description: >-
  Clay
  是一个英语名词，其主要含义是'黏土'或者'粘土'，指的是一种自然发生的可塑性材料，其主要成分是混合的水合硅酸盐矿物。当它被浸泡在水中时会变得柔韧，当烘干或烧结时，它会变硬。在艺术领域，人们常常使用黏土来制作雕塑或陶器。
sidebar:
  hidden: true
...
<Pronunciation word="Clay" uk="/kleɪ/" us="/kleɪ/" client:only />
...
<WordRelations antonyms={["soul", "spirit"]} client:only />
