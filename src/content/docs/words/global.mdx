...
title: Global
description: >-
  Global 这个单词来源于英语，主要的意义是“全球的，全世界的”，它也可以用来形容影响或涉及整个世界或系统的事务。此外，'global'
  还可以指“全局的”，在计算机科学中，全局变量就是可以被系统中任何函数访问的变量。
sidebar:
  hidden: true
...
<Pronunciation word="Global" uk="/ˈɡləʊbəl/" us="/ˈɡləʊbəl/" client:only />
...
"Global" 这个词最早出现在 16 世纪，用来形容对整个地球的描述或表示。直到 20 世纪末，随着全球化的出现，这个词开始频繁地被用来指代与全球相关的事务。
...
<WordRelations
  synonyms={["planetary","globular","round","spherical"]}
  antonyms={["local","domestic","national","regional"]}
  client:only
/>
