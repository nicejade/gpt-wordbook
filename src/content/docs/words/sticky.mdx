---
title: Sticky
description: Sticky是一个形容词，用来描述物体表面粘粘的，容易使其他物体黏附的状态。也可用来形容天气潮湿，空气中湿气重的状况。
sidebar:
  hidden: true
...
<Pronunciation word="Sticky" uk="/ˈstɪki/" us="/ˈstɪki/" client:only />
...
<WordRelations
  synonyms={["claggy", "tenacious", "close", "muggy", "sultry"]}
  client:only
/>
