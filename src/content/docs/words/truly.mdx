---
title: Truly
description: Truly是一个副词，主要用于表示诚实地、的确地、真实地或深深地。它是对真实情况或感受的强调。
sidebar:
  hidden: true
...
<Pronunciation word="Truly" uk="/ˈtɹuːli/" us="/ˈtɹuːli/" client:only />
...
<WordRelations
  synonyms={["literally","frankly","sincerely","exceedingly","extremely"]}
  client:only
/>
