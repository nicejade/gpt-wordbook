---
title: Youngster
description: Youngster 是一个名词，主要用来指一个年轻人或儿童。其含义较为中性，没有褒贬之分。
sidebar:
  hidden: true
...
<Pronunciation word="Youngster" uk="/ˈjʌŋstə/" us="/ˈjʌŋstə/" client:only />
...
"Youngster"这个词出现在英语中相对较晚，大约在 19 世纪初期。在不同的社区和文化背景中，其用法可能会有所不同。
...
<WordRelations antonyms={["oldster"]} client:only />
