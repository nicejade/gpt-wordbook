---
title: Preview
description: Preview 是一个英语单词，用作名词时，它的意思是'预览'或'预演'。用作动词时，它的意思是'预先查看'或'预览'。
sidebar:
  hidden: true
...
<Pronunciation word="Preview" uk="/ˈpɹiːvjʉː/" us="/ˈpɹiːvjʉː/" client:only />
...
<WordRelations synonyms={["forelook", "foretaste"]} client:only />
