...
title: Tower
description: >-
  Tower是个常见的英语名词，指的是高耸的建筑或结构，通常远高于其周围建筑。比如，电视塔（television
  tower）、瞭望塔（watchtower）、钟楼（bell tower）等等。
sidebar:
  hidden: true
...
<Pronunciation word="Tower" uk="/ˈtaʊ.ə(ɹ)/" us="/ˈtaʊɚ/" client:only />
...
"tower"一词最早可以追溯到公元前 14 世纪的中东。这个词在历史上一直用来表示一种高大、坚固和高耸入云的建筑。在欧美文化中，"tower"通常会让人联想到宏伟、雄伟和威严。
...
<WordRelations synonyms={["donjon"]} client:only />
