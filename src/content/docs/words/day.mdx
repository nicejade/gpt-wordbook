---
title: Day
description: Day 是英语中非常常见的一个单词，它主要有两个含义，第一个含义是指'一天'，即二十四小时，另一个含义是指'白天'，相对于'night(夜晚)'来说。
sidebar:
  hidden: true
...
<Pronunciation word="Day" uk="/deɪ/" us="/deɪ/" client:only />
