---
title: Sky
description: "- 'Sky' 是一个名词，指的是天空，是我们从地面向上看到的那一切：云、天色、太阳、月亮、星星等。"
sidebar:
  hidden: true
...
<Pronunciation word="Sky" uk="/skaɪ/" us="/skaɪ/" client:only />
...
<WordRelations synonyms={["firmament", "heaven", "lift"]} client:only />
