---
title: Brim
description: Brim是一个英语单词，可以作为名词或动词使用。作为名词，它通常指代帽檐或物体的边缘；作为动词，它意味着充满或满溢。
sidebar:
  hidden: true
...
<Pronunciation word="Brim" uk="/bɹɪm/" us="/bɹɪm/" client:only />
...
"Brim"这个单词在中世纪晚期开始使用，最初用来形容水或其他液体的边缘。到了 16 世纪，它开始用于描述帽子的边缘，这也是我们现在最常使用的含义。
