...
description: >-
  Back
  在英语中有多种用法和含义，它常常被用作名词、动词、形容词、副词等。作为名词，它主要指的是人或动物的身体后部，或者某物的背面或后面。作为动词，它可以指支持或赞成。此外，还可以表示返回或后退。
sidebar:
  hidden: true
...
<Pronunciation word="Back" uk="/bæk/" us="/bæk/" client:only />
...
<WordRelations
  synonyms={["dorsum", "reverse", "remote", "rear", "former", "previous"]}
  antonyms={["front", "veer", "main", "current"]}
  client:only
/>
