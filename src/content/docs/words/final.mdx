---
title: Final
description: Final 是一个形容词，意味着 '最后的'，'决定性的' 或 '不可改变的'。这个单词也可以作为名词，如 '决赛' 或 '期末考试'。
sidebar:
  hidden: true
...
<Pronunciation word="Final" uk="/ˈfaɪ.nəl/" us="/ˈfaɪ.nəl/" client:only />

### 列举例句

1.  The final decision rests with the committee. (最终决定由委员会做出。)
2.  The final score was 3 to 2. (最后的比分是 3 比 2。)
...
"Final" 源于拉丁语 "finalis"，表示 "关于末端的"。在英语中开始普遍使用是在 14 世纪。
