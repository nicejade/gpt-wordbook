---
title: Czar
description: Czar是英文中的一个单词，源自俄语“Царь”(Tsar)，原意是君主，类似于国王。在现代英语中，此词通常用于表示某一领域的最高权威或者专家。
sidebar:
  hidden: true
...
<Pronunciation word="Czar" uk="/tsɑː(ɹ)/" us="/tsɑː(ɹ)/" client:only />
...
（从前，有一个名叫 Joe 的天才厨师，他被誉为美食行业的翘楚。他出色的烹饪技能令所有人惊叹不已。）
