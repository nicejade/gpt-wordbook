---
title: Typist
description: Typist 是名词，意为'打字员'。一般指用打字机或电脑键盘进行打字工作的人。
sidebar:
  hidden: true
...
<Pronunciation word="Typist" uk="/ˈtaɪpɪst/" us="/ˈtaɪpɪst/" client:only />
...
"Typist"这个词在 19 世纪末随着打字机的发明而出现。在一段时间里，这个角色主要被女性担当，因为人们认为这是一项需要耐心和细致的工作。
