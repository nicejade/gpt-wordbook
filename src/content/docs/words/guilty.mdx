---
title: Guilty
description: Guilty是一个形容词，主要有两个含义：
sidebar:
  hidden: true
...
1.  有罪的，犯罪的。例如，如果一个法庭判定你 guilty，那就意味着你犯了罪。
2.  感到内疚的，后悔的。例如，如果你做了某事而感到后悔，那你就可能感觉自己 guilty。

<Pronunciation word="Guilty" uk="/ˈɡɪl.ti/" us="/ˈɡɪl.ti/" client:only />
