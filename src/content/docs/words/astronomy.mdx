---
title: Astronomy
description: Astronomy 是以考察和研究宇宙一切物质和发生的各类天文现象为主要目标的科学。'天文学'是对它的中文翻译。
sidebar:
  hidden: true
...
"Astronomy" 这个单词是最早在 14 世纪由古法语 "Astronomie" 引入英文的，并且源于拉丁语的 "Astronomia"。在欧美文化中，天文学是最早的科学之一，也是对宇宙奥秘的追寻和揭示的重要领域。
...
David, a child prodigy, had a deep love for astronomy since he was young. He would spend hours observing the stars with his telescope. (从小就特别爱好天文学的神童 David, 将大把时间耗在用望远镜观测星星上。)

<WordRelations synonyms={["stargazing"]} client:only />
