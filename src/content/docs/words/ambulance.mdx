---
title: Ambulance
description: Ambulance 是一个英文名词，主要用来描述一种特殊的车辆，设计用以传送受伤或病人到医疗设施里，如医院。它通常配备有生命维持设备及训练有素的医疗人士。
sidebar:
  hidden: true
...
单词 ambulance 中，“-ance”是后缀，用于由动词变成名词，表示行动或过程。

### 文化背景

字 ambulance 有着它的历史和文化背景。这个词最初来源于法国词语“hôpital ambulant”, 意为“可移动的医院”。在十九世纪，这个词开始在英语中被使用，用于指代运送伤员的车辆。
