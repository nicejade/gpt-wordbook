---
title: Epoch
description: Epoch 是一个名词，意思是 '一个特定的历史时期，尤其是一个标志性的或者决定性的时期'。它也可以用于地质学来表达描述地球历史的长时间段。
sidebar:
  hidden: true
...
<Pronunciation word="Epoch" uk="/ˈiːˌpɒk/" us="/ˈeɪˌpɑk/" client:only />
...
<WordRelations synonyms={["age", "era"]} client:only />
