---
title: Pleasant
description: Pleasant 是一个形容词，用于描述某物或某人引起人的愉快、喜欢，或者是快乐的。具有悦目、身心舒畅、令人愉快的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Pleasant" uk="/ˈplɛzənt/" us="/ˈplɛzənt/" client:only />
...
可以通过"please+ant"来记忆 pleasant。想象一个蚂蚁能帮你做许多你喜欢的事，它对你来说就是 pleasant 的。
...
<WordRelations
  ...
  antonyms={["disagreeable", "nasty", "unpleasant"]}
  client:only
/>
