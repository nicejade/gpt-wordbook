---
title: Limb
description: limb 是一个英文单词，主要用作名词，表示'四肢'或'枝干'。用作动词时，'limb'可以表示'剪去树枝'。
sidebar:
  hidden: true
...
<Pronunciation word="Limb" uk="/lɪm/" us="/lɪm/" client:only />
...
<WordRelations synonyms={["bough", "delimb"]} client:only />
