...
title: Reap
description: >-
  Reap 是一个动词，原意为收割，特指农作物的收割。在更广泛的意义上，它表示从行为、事件或决定中获取结果或利益，经常用在成语 'reap what you
  sow' （种瓜得瓜，种豆得豆）中。
sidebar:
  hidden: true
...
<Pronunciation word="Reap" uk="/ɹiːp/" us="/ɹiːp/" client:only />
...
<WordRelations synonyms={["sheaf"]} client:only />
