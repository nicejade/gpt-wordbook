---
title: Abide
description: Abide 是一个英文动词，基本含义是'遵守'、'忍耐'，表达一种等待、忍受、听从或服从的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Abide" uk="/əˈbaɪd/" us="/əˈbaɪd/" client:only />
...
"Abide" 最早出现在公元前 7 世纪的英语中，最初的含义是"等待"。其后它的含义逐渐演变，拓展到"承受"、"保持"和"遵守"的情境。
...
<WordRelations
  synonyms={["brook","resist","dwell","live","await","stay"]}
  client:only
/>
