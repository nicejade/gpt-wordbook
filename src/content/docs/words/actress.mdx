---
title: Actress
description: Actress 是英语中的一个名词，表示从事演艺工作的女性，即'女演员'。
sidebar:
  hidden: true
...
<Pronunciation word="Actress" uk="/ˈak.tɹəs/" us="/ˈak.tɹəs/" client:only />
...
"Actress" 这个词源自 16 世纪，开始用来形容女性演员。在古时候，女性是不允许演出的，在舞台上，所有角色都由男性演员扮演。直到公元 17 世纪，女性开始在舞台上演出。
...
<WordRelations synonyms={["actorine"]} client:only />
