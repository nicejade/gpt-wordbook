---
title: Possible
description: Possible是一个形容词，意为“可能的，可行的”。
sidebar:
  hidden: true
...
<Pronunciation word="Possible" uk="/ˈpɒsɪbl̩/" us="/ˈpɑsəbl̩/" client:only />
...
“Possible”的词根为 Latin 词根"posse"，意为“能够”，这个词根还可以推导出其他单词，例如，"potent" (有力量的)，"potential" (潜力)。
...
该词源于拉丁语的 "possibilis"，最早用于 14 世纪的英语，表示"可被做的"或"能发生的"。
...
<WordRelations
  synonyms={["option","possibility","achievable","doable","viable","futurable","likely","plausible"]}
  antonyms={["impossible","certain","inevitable","implausible"]}
  client:only
/>
