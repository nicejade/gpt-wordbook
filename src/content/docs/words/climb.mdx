---
title: Climb
description: Climb 是一个动词，意思是“爬，攀登”。不仅可以指人或动物的爬行，如山岳、树木、楼梯等，也可以指象征性的提升或增加，如收入，等级等。
sidebar:
  hidden: true
...
<Pronunciation word="Climb" uk="/klaɪm/" us="/klaɪm/" client:only />
...
<WordRelations synonyms={["scale"]} client:only />
