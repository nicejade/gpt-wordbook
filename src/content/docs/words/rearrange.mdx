---
title: Rearrange
description: Rearrange是一个动词，意为“重新安排”或“重新排序”。通常用于指某人改变某物的顺序或者位置。
sidebar:
  hidden: true
...
"Rearrange"一词在 18 世纪开始在英语中使用，主要用来描述改变物体的位置或者顺序。这个词在小说、电影等文化艺术形式中，以及生活中广泛使用。
...
<WordRelations synonyms={["rejigger", "reshuffle"]} client:only />
