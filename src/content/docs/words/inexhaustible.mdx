...
title: Inexhaustible
description: >-
  Inexhaustible是一个形容词，它的核心意思是“无穷无尽的”，“取之不尽的”。主要用于描述某种资源或者特性是无限的或者无法耗尽的。当你说某人有'an
  inexhaustible patience'，表示这个人的耐心无法耗尽。
sidebar:
  hidden: true
...
<WordRelations antonyms={["exhaustible"]} client:only />
