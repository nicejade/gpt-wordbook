...
title: Moan
description: >-
  Moan 是一个英语单词，主要用作动词或名词。作为动词时，'moan' 的主要含义是抱怨或悲叹，同时也可以用于描述发出呻吟声。作为名词时，'moan'
  描述的是抱怨的言语或者是呻吟声。
sidebar:
  hidden: true
...
<Pronunciation word="Moan" uk="/məʊn/" us="/moʊn/" client:only />
...
这个单词的使用可以追溯到公元前 1000 年，原始的含义是为了表达哀悼或痛苦的情绪。
