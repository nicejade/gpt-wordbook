---
title: Moment
description: moment 是一个英文名词，主要有两种含义：
sidebar:
  hidden: true
...
<Pronunciation word="Moment" uk="/ˈməʊmənt/" us="/ˈmoʊmənt/" client:only />
...
"moment" 的最早使用是在 14 世纪，最初在中世纪拉丁文的法律文献中使用，表示“影响法律决定的重要因素”。后来演变为现在的各种含义。
...
<WordRelations synonyms={["instant", "stound", "trice"]} client:only />
