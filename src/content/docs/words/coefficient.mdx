...
title: Coefficient
description: >-
  "Coefficient" 是一个数学词汇，通常用于表示方程或函数中变量的系数。比如在数学表达式 2x 中，2 就是 x
  的系数（coefficient）。此外，在物理或化学领域，"coefficient" 也常常用于表示比例因子或换算因子。
sidebar:
  hidden: true
...
2.  In the equation 3x - 2y = 7, 3 is the coefficient of x and -2 is the coefficient of y.（在等式 3x - 2y = 7 中，3 是 x 的系数，-2 是 y 的系数。）
...
"Coefficient" 是座 Derived from Latin "coefficient- ', 'coefficiens, coefficientis" ，通过法语和中世纪晚期的拉丁语转化而来，在 1704 年左右开始用作数学术语。
