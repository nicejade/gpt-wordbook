---
title: Realm
description: Realm 是一个名词，它的中文翻译是“领域”或“王国”。它用来指的是特定的地区，或是某个方面的学问等领域。
sidebar:
  hidden: true
...
<Pronunciation word="Realm" uk="/ɹɛlm/" us="/ɹɛlm/" client:only />
...
"Realm" 这个单词从 12 世纪开始在英语中被使用，主要用来形容一个统治者的领地或权力范围。
