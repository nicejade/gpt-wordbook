---
title: Predictable
description: Predictable 是形容词，用来形容可能会或者容易被预见或者预料到的事物。
sidebar:
  hidden: true
...
Predictable 分为两部分：predict 和 -able。Predict 是来自拉丁语的词根，表示“预言”，而 -able 是英语后缀，表示“能……的”。
...
<WordRelations antonyms={["unpredictable"]} client:only />
