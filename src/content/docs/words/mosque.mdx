---
title: Mosque
description: Mosque 是一个英语名词，指的是伊斯兰教的礼拜场所。
sidebar:
  hidden: true
...
<Pronunciation word="Mosque" uk="/mɒsk/" us="/mɑsk/" client:only />
...
"Mosque" 这个词源于阿拉伯语的 "masjid" ，这在阿拉伯语中意味着 “供奉的地方”。这个词在英语中开始出现是在 14 世纪，描述伊斯兰纪元的最早时期，穆斯林在行礼时候的特殊建筑。
...
<WordRelations synonyms={["masjid"]} client:only />
