...
title: Tank
description: >-
  Tank在英语中有两个主要的含义，一是'坦克'，指的是具有重型装甲和大火力的陆地战斗车辆。二是'储罐'或'水箱'，指的是用于存储液体或气体的大型容器，如水箱，油罐等。
sidebar:
  hidden: true
...
<Pronunciation word="Tank" uk="/tæŋk/" us="/tæŋk/" client:only />
...
“Tank”的动词形式包含：tanked, tanking；复数形式是 tanks。
...
<WordRelations synonyms={["armour", "tango"]} client:only />
