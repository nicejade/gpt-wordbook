---
title: Meantime
description: Meantime 是一个名词，表示“同时，其间”。用于描述两个事件或动作之间的那段时间，代表的是在主要事件或动作的发生期间的那段时间。
sidebar:
  hidden: true
...
<Pronunciation word="Meantime" uk="/ˈmiːntaɪm/" us="/ˈmiːntaɪm/" client:only />
...
Meantime 一词源自老英语的 mǣnan tíman，意为在……期间，同时。它在中古英语中的形式为 mēne tīme。此词的使用至少可以追溯到 14 世纪。
...
<WordRelations synonyms={["meanwhile"]} client:only />
