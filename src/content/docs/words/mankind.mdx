---
title: Mankind
description: Mankind 是一个英文词汇，它主要被用于指代所有的人类。它强调的是人类的总体，整个人类社会，或者是人作为一种生物的整体。
sidebar:
  hidden: true
...
<Pronunciation word="Mankind" uk="/mænˈkaɪnd/" us="/mænˈkaɪnd/" client:only />
...
"Mankind" 这个词在英语中的起源可以追溯到公元前 1000 年，当时用来表示“人类”，自那时以来就一直沿用至今。其中 "man" 的意义为人， "kind" 的含义是类型，统称，所以 "mankind" 的意思是人类。
...
<WordRelations antonyms={["womankind", "womenkind"]} client:only />
