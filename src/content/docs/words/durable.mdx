---
title: Durable
description: Durable 是一个形容词，可以用来描述耐用的，持久的物品或者事物。比如说质量好的产品，强大的友谊，或者长期的协议。
sidebar:
  hidden: true
...
"Durable"这个单词在 14 世纪从法语引进英语，来源于拉丁语中的“durare”，意为“持久”，“耐用”。
...
<WordRelations
  synonyms={["permanent"]}
  antonyms={["nondurable", "transitory", "vulnerable", "weak"]}
  client:only
/>
