...
title: Defence
description: >-
  Defence 是英式拼写，美式英语中的对应单词为 'defense'。它是个名词，主要意思是保护、防御或者防卫。例如，在足球中，'defence'
  指的就是阻止对方进球的球员或策略。在法律语境下，它指的是为自己或他人辩护的人或事。
sidebar:
  hidden: true
...
<Pronunciation word="Defence" uk="/dɪˈfɛns/" us="/dɪˈfɛns/" client:only />
...
<WordRelations antonyms={["offence", "offense"]} client:only />
