...
description: >-
  - 'Review'
  一词有两大主要含义。第一，它可以指'重新审查'或'重新评估'的过程。第二，它也可以指对书籍、电影、音乐等的批评或评估。例如，一家餐厅的食品质量可以被'review'。
sidebar:
  hidden: true
...
<Pronunciation word="Review" uk="/ɹɪˈvjuː/" us="/ɹɪˈvjuː/" client:only />
...
- "Review"一词可以追溯到 16 世纪的英格兰，原意是"重新审查"或"重新查看"。
...
<WordRelations synonyms={["revue"]} client:only />
