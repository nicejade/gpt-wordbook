...
description: >-
  Number
  是一个常用的英语单词，在语境中有多种含义。最基本的意思就是“数字”，它也可以表示'总数'或'个数'。此外，'number'也可以被用来代替'一首歌'或'一段表演'等意思。
sidebar:
  hidden: true
...
<Pronunciation word="Number" uk="/ˈnʌmbə/" us="/ˈnʌmbə/" client:only />
...
该词语的使用可以追溯到公元前 12 世纪期间的拉丁语。古希腊文化对数学的崇拜让"number"一词在西方文化中一直被高度重视。
...
<WordRelations synonyms={["numeral", "rime", "scalar"]} client:only />
