---
title: Barely
description: Barely 是一个副词，主要有两种含义：1）仅仅，刚刚，用于表达事情几乎未发生或几乎无法完成。2）基本没有，或者干脆没有，常用来表示否定。
sidebar:
  hidden: true
...
<Pronunciation word="Barely" uk="/ˈbɛə(ɹ).li/" us="/ˈbɛə(ɹ).li/" client:only />
...
<WordRelations synonyms={["hardly", "just", "scarcely"]} client:only />
