---
title: Horse
description: 单词“horse”在英语中是一个名词，它的基本词义是'马'，也常被作为比喻，例如表达力量和坚硬的特性。
sidebar:
  hidden: true
...
<Pronunciation word="Horse" uk="/hɔːs/" us="/hɔɹs/" client:only />
...
<WordRelations
  synonyms={["horsie","nag","prad","steed","knight","dobbin","pony","trot"]}
  client:only
/>
