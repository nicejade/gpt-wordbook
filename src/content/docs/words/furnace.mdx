---
title: Furnace
description: Furnace 是一个英语名词，指的是一个用于加热的设备，通常在工业制造中使用，也指家庭供暖系统中的设备。这个单词也可以象征地用来形容一个非常热的地方。
sidebar:
  hidden: true
...
<Pronunciation word="Furnace" uk="/ˈfɜːnɪs/" us="/ˈfɝnɪs/" client:only />
...
(在寒冷的冬天，Tim 依偎在炉子旁寻找温暖。炉子里的嘶嘶声在寂静的夜晚像一首温暖的旋律。)
