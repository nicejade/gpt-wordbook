...
<WordRelations
  synonyms={["bygone","dated","outdated","groundbreaking","important","landmark","momentous","notable","significant","ancient","former","old","past","historic"]}
  antonyms={["anachronistic","expected","future","contemporary","modern","present"]}
  client:only
/>
