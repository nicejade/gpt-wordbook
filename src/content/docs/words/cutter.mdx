---
title: Cutter
description: Cutter是一个英语名词，主要有以下几个意思：
sidebar:
  hidden: true
...
3.  快艇：一种可容纳 8-10 人的小船。

<Pronunciation word="Cutter" uk="/ˈkʌtə/" us="/ˈkʌtə/" client:only />
...
Cutter 源自老英语“cytere”，意为“男性切割者或某物体”。这个单词是由“cut”（切割）加上后缀“-er”形成的。
...
字词“cutter”在 13 世纪的英国文学作品中开始出现，最初用来描述负责割草的劳动者。到 19 世纪时，已经扩大到许多其他的含义。
...
<WordRelations synonyms={["slasher"]} client:only />
