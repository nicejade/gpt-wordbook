---
title: Daughter
description: 单词 'daughter' 的中文释义是“女儿”。
sidebar:
  hidden: true
...
<Pronunciation word="Daughter" uk="/ˈdɔːtə(ɹ)/" us="/ˈdɔ.tɚ/" client:only />
...
<WordRelations antonyms={["father", "mother", "parent", "son"]} client:only />
