---
title: Trot
description: 英文单词 'trot' 是一个动词，表示'小跑'或'快步走'。它还可以作为名词，表示达到这种速度的步伐或速度。
sidebar:
  hidden: true
...
<Pronunciation word="Trot" uk="/tɹɒt/" us="/tɹɒt/" client:only />
...
"trot"源于古英语的"trotian"，原意为"快跑"。16 世纪起，人们开始用它来指代马的一种速度，也就是小跑。
...
<WordRelations
  synonyms={["horsie","nag","prad","steed","knight","dobbin","pony","trot","H","smack","jog","pace"]}
  client:only
/>
