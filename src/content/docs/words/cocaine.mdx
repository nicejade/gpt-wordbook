---
title: Cocaine
description: Cocaine 是一种强力的刺激性毒品，主要源自南美洲的古柯树。它在医学上被用作局部麻醉剂，但更频繁的是被非法用于娱乐用途，产生精神兴奋和欣快感。
sidebar:
  hidden: true
...
<Pronunciation word="Cocaine" uk="/koʊˈkeɪn/" us="/koʊˈkeɪn/" client:only />
...
<WordRelations
  synonyms={["angeldust","blow","boots","charlie","coke","crystals","girl","ice","powder","rock","slim","snow","snuff"]}
  client:only
/>
