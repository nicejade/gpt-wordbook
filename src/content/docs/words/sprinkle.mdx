...
title: Sprinkle
description: >-
  Sprinkle是一个英文单词，既可以作为名词，也可以作为动词。作为动词时，它的意思是“撒、洒、喷”，一般指将小的物体或者是液体等轻轻散落到某个表面上。例如：撒糖在糕点上，或者撒盐在马路上防滑。作为名词时，
sidebar:
  hidden: true
...
<Pronunciation word="Sprinkle" uk="/ˈspɹɪŋkəl/" us="/ˈspɹɪŋkəl/" client:only />
...
Sprinkle 的词根是 sprink，没有前缀。后缀为-le,这是一个动词后缀。动词后缀 -le 用于部分动词中，添加了“某种"动作频繁发生"或者"一定程度上的”意味。

由 sprink 这个词根衍生出来的其他单词包括 sprinkler（喷水器）

### 文化背景

Sprinkle 这个词源自中古英语的"sprengen"，意为“洒水，撒播”。这个词在英语中的常用场景包括烹饪过程中的撒料，或者是其他需要均匀分散物质的时候。
...
<WordRelations synonyms={["sprinkling"]} client:only />
