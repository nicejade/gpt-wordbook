...
title: Console
description: >-
  Console这个词在英语中有两个主要的含义。第一个是作为名词，表示“控制台”，通常指的是配有显示屏、键盘和其他控制设备的操作台，比如游戏机或电脑的控制台。第二个是作为动词，意思是“安慰、抚慰”，通常用于安慰他人在情感上的困扰。
sidebar:
  hidden: true
...
<Pronunciation word="Console" uk="/ˈkɒn.səʊl/" us="/ˈkɑːn.soʊl/" client:only />
...
3.  The Xbox One is a popular gaming console.（Xbox One 是一款很受欢迎的游戏控制台。）
...
“Console”一词自 14 世纪起在法语中使用，原意是“安慰”，后来由此引申出电子设备的"控制台"一词。
