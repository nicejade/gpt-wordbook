---
title: Trunk
description: Trunk在英语中主要有两个含义：1）大象或其他某些动物的长鼻子；2）行李箱。另外在美国英语中，'trunk'还可以指汽车后部的储物箱。
sidebar:
  hidden: true
...
<Pronunciation word="Trunk" uk="/tɹʌŋk/" us="/tɹʌŋk/" client:only />
...
<WordRelations synonyms={["boot", "dicky", "proboscis"]} client:only />
