---
title: Bound
description: Bound 通常作为动词或形容词，可能有以下含义：
sidebar:
  hidden: true
...
<Pronunciation word="Bound" uk="/ˈbaʊnd/" us="/ˈbaʊnd/" client:only />

1.  bind 的过去分词，作动词时表示“束缚”，例如“被法律条款所约束”。
...
"Bound"在古英语中作为 bind 的过去分词形态出现，其意思为"束缚"。它作为形容词的“确定的，必然的”这一含义出现在 14 世纪。
...
<WordRelations
  synonyms={["bandage","dress","fasten","fetter","restrain","tie","indenture","obligate","restrict"]}
  antonyms={["free"]}
  client:only
/>
