---
title: Request
description: Request 是一个英语单词，作为动词或名词使用。作为动词，它的含义是“要求”或“请求”，即你正在寻求一些东西；作为名词，它的含义是“请求”或“需求”。
sidebar:
  hidden: true
...
<Pronunciation word="Request" uk="/ɹɪˈkwɛst/" us="/ɹɪˈkwɛst/" client:only />
...
"Request" 最早在 14 世纪进入英语，由法语 "requeste" 演变而来，此外，它又追溯到拉丁语 "requaerere"，意为“寻求”。
...
<WordRelations
  synonyms={["asking","beseech","prayer","wish","demand","petition","postulation","ask","bespeak"]}
  client:only
/>
