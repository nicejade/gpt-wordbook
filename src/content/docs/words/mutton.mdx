---
title: Mutton
description: "- 'Mutton' 是一种英语单词，通常被用来指羊肉或者已经达到一定年龄的成年羊肉。"
sidebar:
  hidden: true
...
<Pronunciation word="Mutton" uk="/ˈmʌtn̩/" us="/ˈmʌtn̩/" client:only />
...
<WordRelations synonyms={["sheepflesh", "sheepmeat"]} client:only />
