---
title: Food
description: Food 是英文的一种非常基础的单词，指的是吃的东西，也就是我们所说的食物。
sidebar:
  hidden: true
...
<Pronunciation word="Food" uk="/fuːd/" us="/fuːd/" client:only />
...
<WordRelations
  synonyms={["chow","comestible","eats","feed","fodder","foodstuffs","nosh","nourishment","provender","sustenance","victuals","foodstuff"]}
  client:only
/>
