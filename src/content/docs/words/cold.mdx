...
<WordRelations
  synonyms={["chilly","cool","freezing","frigid","glacial","icy","nippy","parky","aloof","distant","hostile","standoffish","unfriendly","unwelcoming","unprepared","unready"]}
  antonyms={["heated","hot","scorching","torrid","warm","amiable","friendly","welcoming","prepared","primed","ready"]}
  client:only
/>
