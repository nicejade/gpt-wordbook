...
title: Cold
description: >-
  Cold 是一个形容词，最常见的含义是'冷的'或'寒冷的'。它也可以用来形容一个人的态度冷淡，或者情感上的寒冷。例如 'He gave me a cold
  stare' (他冷冷地看着我)。
sidebar:
  hidden: true
...
<Pronunciation word="Cold" uk="/kɔʊld/" us="/koʊld/" client:only />
...
Cold 来自古英语的词“cald”, 再往前追溯就是原始日耳曼语的“kaldaz”。

### 词缀分析

Cold 没有前缀或者后缀，它本身就是一个词根。
...
<WordRelations
  synonyms={["chilled","chilly","cool","freezing","frigid","glacial","icy","nippy","parky","taters","aloof","distant","hostile","standoffish","unfriendly","unwelcoming","unprepared","unready"]}
  antonyms={["baking","boiling","heated","hot","scorching","searing","torrid","warm","amiable","friendly","welcoming","prepared","primed","ready"]}
  client:only
/>
