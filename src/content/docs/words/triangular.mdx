---
title: Triangular
description: Triangular 这个单词来自于拉丁语的 'triangulum'，在英语中意为“三角形的”。
sidebar:
  hidden: true
...
"Triangular" 这个词是在 14 世纪从法语引入英语的。法语单词 "triangulaire" 源自拉丁语 "triangularis"，由 "triangulum"（三角形）派生而来。
...
<WordRelations synonyms={["threeside", "trigonal"]} client:only />
