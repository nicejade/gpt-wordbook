---
title: Report
description: "- 'Report' 可以作为名词或动词。作为名词表示'报告，报表，报道'等，作为动词时表示'举报，报告，报道'等。"
sidebar:
  hidden: true
...
<Pronunciation word="Report" uk="/ɹəˈpoːt/" us="/ɹɪˈpɔɹt/" client:only />
...
<WordRelations synonyms={["subordinate"]} client:only />
