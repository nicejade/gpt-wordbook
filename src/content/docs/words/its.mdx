---
title: Its
description: its 是英语中的一个代词，表示“它的”。它用于指代某个事物或实体，并表明被指对象与后面的名词之间存在所有权关系。
sidebar:
  hidden: true
...
<Pronunciation word="Its" uk="/ɪts/" us="/ɪts/" client:only />
...
"its" 是来源于古英语 "his" 的所有格形式，并在约 1350 年时被接受为标准英语。
