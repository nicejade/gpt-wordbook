---
title: Me
description: Me 是一个英语的代词，经常被用作宾语来引用讲话者或作者自己。例如：“Give it to me” (把它给我).
sidebar:
  hidden: true
...
<Pronunciation word="Me" uk="/miː/" us="/mi/" client:only />
...
<WordRelations synonyms={["I", "us", "mine", "my"]} client:only />
