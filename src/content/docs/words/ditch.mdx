---
title: Ditch
description: Ditch 是英语中的一个常用词，意为沟渠，用作名词；也可以作为动词使用，意为丢弃、抛弃。
sidebar:
  hidden: true
...
Ditch 是英语中的一个常用词，意为沟渠，用作名词；也可以作为动词使用，意为丢弃、抛弃。

<Pronunciation word="Ditch" uk="/dɪtʃ/" us="/dɪtʃ/" client:only />
...
1.  Ditch 的词源在古英语中，Ditch 数据来源于 didd ，意味着沟渠。
...
Ditch 这个词语最早出现在中古英语中，原意是用工具挖掘。进而形成现在“沟渠”的意思，而作为动词则形成了“抛弃”的意思。
...
可以记忆 Ditch 的发音和动词含义是“抛弃”，联想到沟渠里的东西如果不用就可能被抛弃。
