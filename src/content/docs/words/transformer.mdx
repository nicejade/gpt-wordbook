---
title: "transformer"
description: "英語单词transformer有两种基本含义：一是转换者，变形者，由动词transform派生，即变革，改变；二是在电力领域，表示“变压器”，用于改变电压。"
---
...
"Transformer"一词源于 16 世纪的欧洲，原意指通过改变物质形态而实现转变的过程或方式。到了 19 世纪，随着电力学的发展，这个词开始用于指代可以改变电压的电气设备。
