...
title: Contrast
description: >-
  "Contrast" 可以作为名词或者动词使用。 作为名词，"contrast" 的主要含义是显著区别，特别是在比较中的鲜明差异。例如，"The
  contrast between light and shadow." 作为动词，则表示比较两者以突出其差别。例如，"We contrasted the
  benefits and disadvantages of the two options."
sidebar:
  hidden: true
