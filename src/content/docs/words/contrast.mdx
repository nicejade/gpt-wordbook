---
title: "contrast"
description: "Contrast 可以作为名词或者动词使用。 作为名词，contrast 的主要含义是显著区别，特别是在比较中的鲜明差异。例如，The contrast between light and shadow. 作为动词，则表示比较两者以突出其差别。例如，We contrasted the benefits and disadvantages of the two options."
---
...
"Contrast"的词缀包括前缀 "con-"（表示“共同”）和词根 "trast"。其他具有相同词缀的单词包括：construct, converse 等。

### 发展历史和文化背景

"Contrast" 这个单词在舒缮特语系中最初的使用是以动词的形式，在 17 世纪中叶才开始作为名词使用。"Contrast" 这个词在艺术和文学中经常用来表示两个不同元素的区别。
