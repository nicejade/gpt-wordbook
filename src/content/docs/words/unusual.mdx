...
title: Unusual
description: >-
  Unusual 是一個形容詞，主要用於描述一種不常見，罕見，或者非典型的狀況和事物。例如: 'It's unusual for him to be
  late.'（他很少遲到。）
sidebar:
  hidden: true
...
<Pronunciation word="Unusual" uk="/ʌnˈjuːʒuəl/" us="/ʌnˈjuːʒuəl/" client:only />
...
Unusual 的前缀是"un-"，是一个表示否定的前缀，比如 unplesant（不愉快的），unhappy（不开心的）等。后缀"-al"用来形成形容词，如：natural，rational 等。
...
<WordRelations
  synonyms={["extraordinary", "rare", "remarkable", "uncommon"]}
  antonyms={["common", "normal", "ordinary", "usual"]}
  client:only
/>
