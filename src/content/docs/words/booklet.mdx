...
title: Booklet
description: >-
  "Booklet" 是英语中的一个名词，指的是一种小型、薄型的书，通常含有少量信息，例如指导手册、产品说明书、宣传册等。 例如： 1. The
  company has published a booklet on how to prevent computer
  ...
  tour booklet for the sightseeing schedule.（请查看旅游手册了解观光行程。）
sidebar:
  hidden: true
