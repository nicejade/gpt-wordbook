...
title: Found
description: >-
  Found 是一个英语单词，它可以作为动词或者形容词使用。作为动词，'found' 的基本含义是
  '设置'，'建立'，例如建立一家公司或组织。作为形容词，'found' 主要的含义是 '被找到的'，一般指在以前丢失、或需要寻找的事物或人。
sidebar:
  hidden: true
...
<Pronunciation word="Found" uk="/faʊnd/" us="/faʊnd/" client:only />

### 列举例句

1.  他在 2001 年成立了这家公司。(He **founded** the company in 2001.)
...
<WordRelations antonyms={["lose"]} client:only />
