---
title: So
description: So是一个常用的英语单词，在许多情况下，它可以作为连词、副词、形容词或介词。
sidebar:
  hidden: true
...
<Pronunciation word="So" uk="/səʊ/" us="/soʊ/" client:only />
...
<WordRelations
  synonyms={["musical","correct","right","true","like","this","thus","much","really","truly","very","that","yea","hey","look","see"]}
  client:only
/>
