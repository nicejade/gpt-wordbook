---
title: Tell
description: Tell是一个常用的动词，意思主要包含'说'，'告诉'，'诉说'，还有'告诉(秘密)'的含义。还有一层意思是'辨别'，'看出'，'判断'。
sidebar:
  hidden: true
...
<Pronunciation word="Tell" uk="/tɛl/" us="/tɛl/" client:only />
...
Tell 来源于老英语"tellan"意思包括"计数"，"说"，"告诉"。
...
Tell 这个单词在英语中使用非常广泛，出现在很多词组和惯用语中，反映了英语文化中对于直接表达，交流和真实的重视。

### 单词变形

Tell 的过去式和过去分词都是 told.
...
<WordRelations
  synonyms={["count","number","snitch","tattle","narrate","recount","relate","disclose","advise","apprise"]}
  antonyms={["ask"]}
  client:only
/>
