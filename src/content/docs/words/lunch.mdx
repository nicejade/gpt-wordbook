---
title: Lunch
description: Lunch 是英语中的一个名词，指的是在中午时分食用的餐点，相当于中文中的“午餐”。
sidebar:
  hidden: true
...
<Pronunciation word="Lunch" uk="/lʌnt͡ʃ/" us="/lʌnt͡ʃ/" client:only />
...
"lunch"一词可以追溯至 16 世纪的英语，原指的是一小块食物，作为人们在饭食之间的小吃。到了 19 世纪和 20 世纪，随着工业化进程加速，"lunch"开始被用来指代在中午人们为了恢复体力而进食的餐点。
...
可以想象一下，"lunch"这个词像是在“铃”声响起的时候（lunch 和 bell 的发音有点像），大家都在午间休息，吃午餐。

### 助记故事

"Every day at noon, the city streets fill with people heading for lunch." 每天中午，城市的街道上都会被赶去吃午餐的人群填满。

<WordRelations synonyms={["luncheon", "nones"]} client:only />
