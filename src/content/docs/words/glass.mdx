---
title: Glass
description: Glass 在英语中主要用作名词，意为“玻璃”。此外，'Glass'也可以用作动词，意为“用玻璃覆盖”。
sidebar:
  hidden: true
...
<Pronunciation word="Glass" uk="/ɡlɑːs/" us="/ɡlæs/" client:only />
...
"Glass" 一词的使用可以追溯到公元前 16 世纪的古埃及和美索不达米亚。这个词的起源与其主要用途有关，即制造透明物体，如窗户，眼镜和饮料容器。
