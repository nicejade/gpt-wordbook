---
title: Island
description: Island是一个名词，表示“岛屿”，尤指典型的有面积，被水（例如海洋、湖泊、河流）围绕的陆地。
sidebar:
  hidden: true
...
<Pronunciation word="Island" uk="/ˈaɪ̯lənd/" us="/ˈaɪ̯lənd/" client:only />
...
Island 来源于古英语的"iegland"，其中"ieg"表示岛屿，"land"表示土地。
...
<WordRelations synonyms={["oasis", "ait", "holm", "isle"]} client:only />
