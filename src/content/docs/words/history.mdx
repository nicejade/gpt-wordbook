---
title: History
description: History 是一个英文名词，意为 '历史'。他指的是过去发生的事情，特别是与人类社会和文明相关的事件和进程。
sidebar:
  hidden: true
...
<Pronunciation word="History" uk="/ˈhɪst(ə)ɹi/" us="/ˈhɪst(ə)ɹi/" client:only />
...
<WordRelations
  synonyms={["background","past","log","account","chronicle","story","tale"]}
  client:only
/>
