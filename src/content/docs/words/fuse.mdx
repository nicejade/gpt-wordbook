---
title: Fuse
description: Fuse可以作为名词和动词。作为名词，它意为'保险丝'或'导火索'。作为动词，它主要有两个含义，一是'熔化'，二是'合并'或'混合”。
sidebar:
  hidden: true
...
<Pronunciation word="Fuse" uk="/fjuːz/" us="/fjuːz/" client:only />
...
<WordRelations synonyms={["fuze"]} client:only />
