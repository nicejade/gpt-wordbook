---
title: Map
description: Map 这个单词来自于英文，通常作为名词使用，点对点地表示了地点的关系，具有'地图'的含义。当作为动词时，意为'制作地图'或'规划，安排'。
sidebar:
  hidden: true
...
<Pronunciation word="Map" uk="/mæp/" us="/mæp/" client:only />
...
<WordRelations
  synonyms={["function", "mapping", "level", "stage", "chart", "plan"]}
  client:only
/>
