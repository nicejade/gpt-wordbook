---
title: Superb
description: Superb 是一个英语形容词，用来描述某人或某事非常出色、卓越或者优秀。
sidebar:
  hidden: true
...
<Pronunciation word="Superb" uk="/sjuːˈpɜːb/" us="/suˈpɝb/" client:only />
...
<WordRelations synonyms={["excellent", "superlative"]} client:only />
