...
title: Undo
description: >-
  英文 'undo' 是一个动词，它有两个主要的含义。第一，它被用来表示
  “撤销”或“取消”的意思，通常指撤销之前做过的事情。第二，它也可以被用来表达“松开”，“解开”，像是解开封条或是纽扣。
sidebar:
  hidden: true
...
<Pronunciation word="Undo" uk="/ʌnˈduː/" us="/ʌnˈduː/" client:only />
...
<WordRelations
  synonyms={["cancel","reverse","unbuckle","unbutton","untie","unzip"]}
  antonyms={["redo","button","zip"]}
  client:only
/>
