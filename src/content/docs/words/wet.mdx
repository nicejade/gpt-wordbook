---
title: Wet
description: Wet是一个形容词，用来描述某物品或处于湿潮或液体的状态。也可以作为动词使用，表示让某物变湿。
sidebar:
  hidden: true
...
<Pronunciation word="Wet" uk="/wɛt/" us="/wɛt/" client:only />
...
"Wet"这个词在英语中的使用可以追溯到公元前 450 年，由古英语"wæt"转变来的。
...
<WordRelations
  synonyms={["damp","raining","rainy","saturated","soaked","drip","feeble","hopeless","useless","green","horny","moist","inebriated","soused","wetting"]}
  antonyms={["dry","sunny"]}
  client:only
/>
