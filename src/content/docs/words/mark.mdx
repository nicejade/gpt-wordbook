...
title: Mark
description: >-
  Mark这个词在英语中拥有丰富的含义，主要包括以下三种：被动词，指给某物做上记号或痕迹，来区分或纪念。例如标记一个地点或者日期等；作名词，意味着标记，符号，或者标志，比如我们常说的分数、标准等；也可作为动词，表示注意、观察等。
sidebar:
  hidden: true
...
<Pronunciation word="Mark" uk="/mɑɹk/" us="/mɑɹk/" client:only />
...
Mark 是一个由 Germanic 词根 *-merk- 演化来的单词，意为记号或边界。
...
Mark 作为动词其过去式和过去分词为 "marked"，现在分词为 "marking"。
...
（看，那个小男孩在寻宝地图上做了一个大大的 X 标记。果真，我们在 X 标记的地方找到了宝藏。这真是一个值得纪念的日子。）

<WordRelations
  synonyms={["Mk","Mk.","heed","observance","blemish","scar","scratch","stain","characterize","typify","classify","commemorate","solemnize","demonstrate","indicate","manifest","reveal","show","signal"]}
  client:only
/>
