---
title: Factory
description: Factory 是一个英文名词，它是指制造或组装商品的工厂或者场所，通常涵盖了从原材料的加工到最终产品的成品线。相当于中文里的“工厂”。
sidebar:
  hidden: true
...
<Pronunciation word="Factory" uk="/ˈfæktəɹi/" us="/ˈfæktəɹi/" client:only />
...
Factory 的词根是 Latin 的 "facere"，表示 "make"。"Facere" 又衍生出了许多其他的英文单词，如 "manufacture", "benefactor" 和 "factor" 等。
...
"Factory"一词在 16 世纪时进入英语，它源自拉丁词 ‘factorium’，由'facere'('做'的意思)派生，最初用于指代商人的经营场所。
...
<WordRelations synonyms={["fondaco", "tradepost", "manufactory"]} client:only />
