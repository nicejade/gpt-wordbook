---
title: Indulge
description: Indulge 是一个英文动词，具有“纵容，沉溺，满足”等含义。在不同的语境中，它可能有稍微不同的含义，但都围绕这些主题。
sidebar:
  hidden: true
...
<Pronunciation word="Indulge" uk="/ɪnˈdʌldʒ/" us="/ɪnˈdʌldʒ/" client:only />
...
<WordRelations synonyms={["coddle", "cosset", "pamper", "spoil"]} client:only />
