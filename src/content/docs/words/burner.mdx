...
title: Burner
description: >-
  Burner在英语中主要有两大含义。第一，它可以指燃烧器、炉头或烧火的设备，这样的物品是通过燃烧燃料来产生能量的。第二，它也常用于表示一次性、临时或不长久的事物或人，比如我们常听到的'burner
  phone'，就是指的一次性手机。
sidebar:
  hidden: true
...
<Pronunciation word="Burner" uk="/ˈbɜːnə/" us="/ˈbɜːnə/" client:only />
...
"Burner"这个单词在上世纪 90 年代的英语中就已经被广泛使用来指代炉眼或加热设备。然后，在科技日益发展的 21 世纪，随着黑市交易和违法活动的日益频繁，"burner"又被赋予了新的含义，用来形容一次性的手机。
...
<WordRelations synonyms={["ring"]} client:only />
