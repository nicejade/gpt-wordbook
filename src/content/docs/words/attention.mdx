...
title: Attention
description: >-
  Attention是名词，主要有两个含义。第一个是注意，聚焦，意思是人的思维集中在特定的事物上。第二是关心，八面玲珑，指给予特别的礼物或者服务，例如'pay
  attention to'。
sidebar:
  hidden: true
...
<Pronunciation word="Attention" uk="/əˈtɛn.ʃən/" us="/əˈtɛn.ʃən/" client:only />
...
"Attention"中，"at-"是前缀，表示在、向、对，"-tention" 是词根，含义是向着某一方向拉伸或者集中精神。相同前缀的单词如：attach, attack, attempt 等。

### 文化背景

“Attention”最早源自 14 世纪的拉丁语"attentionem"，意为“谨慎、小心翼翼”，后逐渐转变为“注意”，在英语中使用。
...
<WordRelations synonyms={["heed", "notice"]} client:only />
