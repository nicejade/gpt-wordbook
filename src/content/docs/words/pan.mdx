...
title: Pan
description: >-
  Pan 是一个英文词，有很多含义，最常见的可能是作为名词，意思是“平底锅，煎锅”，例如：'a frying pan' 意为煎锅。此外，作为动词，'pan'
  可以指在娱乐或新闻报道中，摄像机水平移动的镜头处理方式，例如：'The camera pans across the scene.'
  意思是“镜头水平扫过全景”。对于金矿工人，' pan '还有个特别的意思，即用锅筛查找金粒。
sidebar:
  hidden: true
...
<Pronunciation word="Pan" uk="/pæn/" us="/pæn/" client:only />
...
"Pan" 是一个非常常见的英语单词，它的用法和含义多种多样。"Pan" 作为“平底锅”的意思，源自古英语 "panne"，可以追溯到公元前 5 世纪。而"pan" 这个单词作为一个摄影术语，始于 20 世纪电影产业的发展。
...
<WordRelations
  synonyms={["skillet", "tin", "saucepan", "pan", "bar", "virgule"]}
  client:only
/>
