---
title: Reverse
description: Reverse 是一个既可以作为动词也可以作为名词和形容词的英文单词。
sidebar:
  hidden: true
...
<Pronunciation word="Reverse" uk="/ɹɪˈvɜːs/" us="/ɹɪˈvɜːs/" client:only />
...
<WordRelations
  antonyms={["normalise", "normalize", "unreverse", "normal"]}
  client:only
/>
