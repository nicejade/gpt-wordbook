...
title: Souvenirs
description: >-
  souvenirs 是名词，英文复数形式，单数形式为 souvenir，源自法语，意为“纪念”。souvenir
  是指那些用于纪念特定事件、地点或体验的物品，通常是旅游或参加特殊活动时购买的。
sidebar:
  hidden: true
...
"souvenir" 这个词是 18 世纪后期从法语中借用过来的，最初用来指的是“一个为了提醒或作为纪念的事情”，在 19 世纪早期，这个词的意思扩展为“不同类型的纪念品或礼品”。
