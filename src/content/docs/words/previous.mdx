---
title: Previous
description: Previous 是一个形容词，意为'先前的，以前的'。这个词常常指在时间或序列上发生在某事或某人之前的东西。
sidebar:
  hidden: true
...
<Pronunciation word="Previous" uk="/ˈpɹiːvɪəs/" us="/ˈpɹivi.əs/" client:only />
...
<WordRelations
  synonyms={["form", "former", "late", "old"]}
  antonyms={["following", "future", "next", "succeeding"]}
  client:only
/>
