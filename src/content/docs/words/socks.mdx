...
description: >-
  Socks
  是一个英语名词，表达的是一种我们所熟知的日常用品，被翻译为'袜子'。更多的时候，我们指的是覆盖脚踝甚至小腿的那种纺织品。这个词语在英文中属于可数名词，因此它有复数形式
  'socks'。
sidebar:
  hidden: true
...
<Pronunciation word="Socks" uk="/sɒks/" us="/sɒks/" client:only />
...
<WordRelations synonyms={["mitten", "jack"]} client:only />
