---
title: Authentic
description: Authentic 是一个形容词，表示“真正的”或者“真实的”，通常用来描述事物原始的、未经篡改的或者真实可信的特性。
sidebar:
  hidden: true
...
<Pronunciation word="Authentic" uk="/ɒ.ˈθɛn.tɪk/" us="/ɒ.ˈθɛn.tɪk/" client:only />
...
由此词根衍生出的其他单词有：authenticate, author 等。
...
<WordRelations
  synonyms={["credible","reliable","trustworthy","unfaked","bonafide","genuine","real"]}
  antonyms={["fake","ingenuine","phony"]}
  client:only
/>
