---
title: Martyr
description: Martyr是一个英语名词和动词，主要表示愿意为信仰或信念而死的人，或者比喻贡献巨大，付出极大牺牲的人。作为动词时，'martyr'表示使成为烈士或殉道者。
sidebar:
  hidden: true
...
<Pronunciation word="Martyr" uk="/ˈmɑːtə(ɹ)/" us="/ˈmɑɹ.tɚ/" client:only />
...
<WordRelations
  synonyms={["shaheed", "shahid", "martyrize"]}
  antonyms={["confessor"]}
  client:only
/>
