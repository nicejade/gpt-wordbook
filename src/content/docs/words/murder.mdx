---
title: Murder
description: Murder在英语中是一个非常重要的词，主要表示故意非法杀人或使事物陷入毁灭性的状态。它可以作为名词或动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Murder" uk="/ˈmɜːdə(ɹ)/" us="/ˈmɝ.dɚ/" client:only />
...
<WordRelations
  synonyms={["assassination","homicide","manslaughter","flock","thrash","trounce","assassinate","kill","massacre","slaughter"]}
  client:only
/>
