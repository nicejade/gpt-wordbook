...
title: Stagger
description: >-
  "Stagger" 是一个动词，主要有三个含义: 1. 蹒跚，摇晃，类似走路时不稳定的状态，例如疲倦或醉酒时的状态； 2. 惊讶或震惊到无法反应； 3.
  （事件或活动）安排在不同的时间，以便让它们不会完全在同一时间发生。 **例句列举:** 1. "He was staggering along the
  road, obviously drunk."（他沿着路走，明显醉了。） 2. "She was staggered by the amount of
  money he had saved."（他存的钱的数量让她感到震惊。） 3. "The exams are staggered over a period
  of two weeks."（这些考试分布在两周的时间范围内。）
sidebar:
  hidden: true
...
"Stagger" 这个词第一次出现在 14 世纪，主要是用来描述人或动物行走不稳定的景象。后来发展出惊讶或震惊的含义，因为人们在惊讶或震惊的情况下常常无法反应，就像身体摇晃一样。然后进一步扩展，该词也被用于描述事件、活动等的时间分布。
