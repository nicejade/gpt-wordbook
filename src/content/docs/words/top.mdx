---
title: Top
description: Top是英语单词，它有几种含义，最主要的两种含义是“顶部，上面”和'最好，首要'。
sidebar:
  hidden: true
...
<Pronunciation word="Top" uk="/tɒp/" us="/tɑp/" client:only />
...
<WordRelations
  synonyms={["peak","summit","beat","best","better","exceed","kill","murder","slaughter","first"]}
  antonyms={["base","bottom","underside"]}
  client:only
/>
