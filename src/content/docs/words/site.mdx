---
title: Site
description: Site 是一个名词，主要意思是'位置'，'场所'。它可以指的是一个实体的地点或者一个网站。
sidebar:
  hidden: true
...
<Pronunciation word="Site" uk="/saɪt/" us="/saɪt/" client:only />
...
"Site"这个词从 14 世纪的法国中借用过来，原词为"site"，意为"位置"或"地方"，其最早来源自拉丁文的"situs"。
