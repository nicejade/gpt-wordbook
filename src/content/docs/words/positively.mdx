---
title: Positively
description: 'Positively 是一个副词，主要有两种含义:'
sidebar:
  hidden: true
...
<Pronunciation word="Positively" uk="/ˈpɒzɪtɪvli/" us="/ˈpɒzɪtɪvli/" client:only />
...
<WordRelations
  synonyms={["confidently","absolutely","greatly","categorically","decisively","definitely","unconditionally"]}
  client:only
/>
