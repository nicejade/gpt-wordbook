...
title: Positively
description: >-
  "Positively" 是一个副词，主要有两种含义: 1. 以积极、肯定的方式。例如："He spoke positively about the
  project." (他对这个项目持积极肃谨的态度。) 2. 强调语气，表示确实，确切无疑。例如："I'm positively sure that's
  the man I saw." (我完全肯定我看见的就是那个人。)
sidebar:
  hidden: true
