...
title: Elemental
description: >-
  Elemental 是形容词，有两个主要含义。第一：基本的，初级的。例如：This is an elemental concept in
  sociology.（这是社会学的一个基本概念）。第二：与自然力量或本质力量有关的。例如：The storm was an exhibition of
  elemental power. (这场风暴是原始力量的展示)。
sidebar:
  hidden: true
