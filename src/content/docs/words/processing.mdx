---
title: Processing
description: Processing 是一个英语单词，主要含义是处理，过程，流程。例如在计算机领域，它常常被用来描述数据处理的过程。
sidebar:
  hidden: true
...
"Processing" 的词根是"process"，这个词在拉丁语 procedere 中意为“前进，推进”。"ing" 是动名词的后缀，表示动作或过程。
...
该词起源于 14 世纪，最初用于描述行军或前进的过程。后来逐渐有了"进行"或"处理"的意思。
