---
title: Occasional
description: '"Occasional" 是一种形容词，表示某事只在偶尔发生、非经常性或没有固定的时间表。例如，"occasional showers"（偶尔的阵雨）。'
sidebar:
  hidden: true
...
"Occasional" 由 "occa­sion" 和后缀 "-al" 构成。在这里，后缀 "-al"用于将 noun 转化为形容词（即 "occasion" to "occasional"），表示 “有…特征的”。
