...
title: Feed
description: >-
  Feed 在英语中主要有两种意思：一是作为动词，表示'喂养'或者'供给'，二是作为名词，它在技术语境下常被用来指代'信息流'或者'资讯源'，如 social
  media feed（社交媒体信息流）。
sidebar:
  hidden: true
...
<Pronunciation word="Feed" uk="/ˈfiːd/" us="/ˈfiːd/" client:only />
...
<WordRelations synonyms={["nourish"]} client:only />
