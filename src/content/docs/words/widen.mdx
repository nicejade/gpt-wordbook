---
title: Widen
description: widen 是动词，主要有两个含义：1. 变宽，使展开；2. 扩大，加宽。这个词通常用来描述物体的宽度增大，或者范围、角度展开。
sidebar:
  hidden: true
...
<Pronunciation word="Widen" uk="/ˈwaɪdən/" us="/ˈwaɪdən/" client:only />
...
"widen" 一词源自老英语 "wid"，意思是 "宽"，表示空间的宽度。"widen" 表示“使...变宽”，自 14 世纪起开始使用。
...
<WordRelations antonyms={["narrow"]} client:only />
