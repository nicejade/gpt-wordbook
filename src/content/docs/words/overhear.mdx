---
title: Overhear
description: Overhear 是一个动词，表示“无意中听到”或“偷听”的意思。这个词是指你没有特意去听，但偶然或无意中听到了某些对话或声音。
sidebar:
  hidden: true
...
<Pronunciation word="Overhear" uk="/oʊ.vɚˈhɪɚ/" us="/oʊ.vɚˈhɪɚ/" client:only />
...
"Overhear"这个单词来源于 Old English oferhieran，由“ofer”(超过)和“hieran”(听)构成，最早用于表示"听到的超过一般的理解"或"无意中听到"的含义。到了现代英语中，"overhear"的用法多用于形容无意间或者偶然地听到别人的对话或讨论。
...
<WordRelations synonyms={["eavesdrop"]} client:only />
