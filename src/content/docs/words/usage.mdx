...
title: Usage
description: >-
  Usage 这个单词来源于拉丁语 'usus', 表示用或使用。在英语中，'usage'
  通常有两种主要的含义：一种是指“使用”或“运用”，常用于描述物品或设备的使用情况；另一种常见的解读是“惯例”或“常规”，用于指社区和群体中人们通常遵循的规定或习俗。
sidebar:
  hidden: true
...
<Pronunciation word="Usage" uk="/ˈjuːsɪd͡ʒ/" us="/ˈjuːsɪd͡ʒ/" client:only />
