---
title: Duck
description: Duck 是一个英语单词，可以作为名词和动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Duck" uk="/dʌk/" us="/dʌk/" client:only />
...
'Duck'一词具有很长的历史，可以追溯到公元前 7 世纪的古代英格兰。在英语中，"Duck"也有许多短语和习语的含义，如"water off a duck's back"（对某人无关痛痒）。
...
<WordRelations synonyms={["dip", "dunk"]} client:only />
