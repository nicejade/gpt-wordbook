...
title: Enquire
description: >-
  Enquire 是一个动词，表示'询问'或'查询'。可以用于询问有关某事物的信息或详细情况。比如，'I enquired about the train
  schedule.' (我询问了火车的时间表。)。
sidebar:
  hidden: true
...
<Pronunciation word="Enquire" uk="/ɪŋˈkwaɪə/" us="/ɪŋˈkwaɪə/" client:only />
...
Enquire 源自中世纪英语“enqueren”，又源自老法语“enquerre”，源自拉丁语“inquirere”，意为“查询”，“问”。在英美文化中，这个词通常用于正式场合寻求信息。
