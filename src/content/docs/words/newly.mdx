---
title: Newly
description: Newly 是一个副词，它的意思是'刚刚'或'最近'。它通常用于描述刚发生的事情或新的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Newly" uk="/ˈnjuːli/" us="/ˈnjuːli/" client:only />
...
<WordRelations synonyms={["freshly", "recently"]} client:only />
