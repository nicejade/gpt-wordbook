...
title: Genetic
description: >-
  Genetic 是一个形容词，源自基本词汇
  'gene'，主要与生物学的遗传科学相关。它单词在日常使用中，主要用来描述与基因有关的特点或者遗传的性状，比如“基因的”，“遗传的”。
sidebar:
  hidden: true
...
<Pronunciation word="Genetic" uk="[d͡ʒəˈnɛtɪk]" us="[d͡ʒəˈnɛtɪk]" client:only />
...
此单词"Genetic"在 19 世纪末由威廉·贝特森（William Bateson）在介绍孟德尔（Gregor Mendel）的遗传理论时首次提出。一直以来，它都是在生物学尤其是遗传学领域使用非常常见的词汇。
...
<WordRelations synonyms={["genealogical", "hereditary"]} client:only />
