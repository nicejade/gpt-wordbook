---
title: Formulate
description: 英语单词 'formulate' 是一个动词，意为“制定；明确地阐述”。
sidebar:
  hidden: true
...
"Formulate"的使用开始于 1860 年左右，最初在科学和政治领域使用，用于描述制定公式、理论或策略的过程。
...
可将 formulate 拆分为 form(形式)+ulate（…化），记为“形式化”，以帮助理解和记忆这个词。
