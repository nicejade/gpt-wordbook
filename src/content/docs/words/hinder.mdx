---
title: Hinder
description: Hinder 主要是一个动词，意思是阻碍，妨碍。例如，当你在完成事情的道路上遇到障碍时，或者被人或事物所阻挡了，你就可以使用 'hinder'。
sidebar:
  hidden: true
...
<Pronunciation word="Hinder" uk="/ˈhɪndə/" us="/ˈhɪndɚ/" client:only />
...
<WordRelations
  synonyms={["bar","block","delay","hamper","restrain","stop","frustrate","prevent"]}
  antonyms={["aid","assist","help","facilitate"]}
  client:only
/>
