---
title: Proclaim
description: Proclaim 是一个动词，意为“宣告”，“声明”，“表明”，“公布”，通常用于指代具有权威并希望所有人知道或者理解的信息或决定。
sidebar:
  hidden: true
...
<Pronunciation word="Proclaim" uk="/pɹoʊˈkleɪm/" us="/pɹoʊˈkleɪm/" client:only />
...
3.  The CEO proclaimed the new company policy at the meeting. ("CEO 在会议上公布了新的公司政策。")
...
- 名词：Proclamation ("宣告")
- 必要的固定搭配：Proclaim something to be/that...，("宣称/宣布某事是……")
