---
title: Brittle
description: Brittle 是形容词，原义是指物质脆弱，容易破碎。引申到其他方面，可以形容人容易生气，情绪多变，也可以描述关系等抽象事物脆弱容易破裂。
sidebar:
  hidden: true
...
<Pronunciation word="Brittle" uk="/ˈbɹɪtl̩/" us="/ˈbɹɪtl̩/" client:only />
...
<WordRelations synonyms={["brickle"]} client:only />
