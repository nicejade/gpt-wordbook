---
title: Withdraw
description: Withdraw 这个单词在常用英语中有几个基本含义：
sidebar:
  hidden: true
...
<Pronunciation word="Withdraw" uk="/wɪðˈdɹɔː/" us="/wɪðˈdɹɔː/" client:only />
...
"Withdraw" 这个词的发展历史追溯到公元 1000 年，最初用于描述从战场中撤退的情况，后来进一步扩展到其他领域。
...
<WordRelations synonyms={["recant", "unsay"]} client:only />
