---
title: Tolerant
description: tolerant 这个单词是一个形容词，意思是“有耐心的，宽容的，能够接受的”，通常用来形容一个能够以开放的态度接受别人的看法，信仰，行为的人。
sidebar:
  hidden: true
...
<Pronunciation word="Tolerant" uk="/ˈtɒləɹənt/" us="/ˈtɒləɹənt/" client:only />
...
"tolerant"这个单词在法语中表示“忍受痛苦”， 并在 16 世纪初引入英语。在欧美文化中，它通常用于政治或社会背景下，表达对不同观点，信仰或行为的接受。
