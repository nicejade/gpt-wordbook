...
title: Handsome
description: >-
  Handsome是一个形容词，主要指当代英语中“好看的”或“英俊的”，通常用于形容人（尤其是男性）外表吸引人，也可以用来形容女性，意为高雅，端庄。此外，还可以被用来形容物件(如建筑)美观大气。
sidebar:
  hidden: true
...
<Pronunciation word="Handsome" uk="/ˈhæn.səm/" us="/ˈhæn.səm/" client:only />
...
Handsomely 是“handsome”的副词形式，意为"以好看的方式"。
...
<WordRelations synonyms={["hefty", "substantial", "pretty"]} client:only />
