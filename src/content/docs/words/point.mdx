---
title: Point
description: Point 是一个多义词，在不同的语境和情况下，其意思可能有所不同。它可以表示“点”，“尖端”，“注意点”，“观点”，“得分”，“目的地”等。
sidebar:
  hidden: true
...
<Pronunciation word="Point" uk="/pɔɪnt/" us="/pɔɪnt/" client:only />
...
<WordRelations
  synonyms={["spot","ord","location","place","position","opinion","view","viewpoint","moment","time","end","tip","mark"]}
  client:only
/>
