...
title: Down
description: >-
  Down常见的意思是一个介词/副词，表示动作或者事物的向下方向或位置。例如：'He walked down the
  stairs'（他走下楼梯）。然而，这个词在英语中有许多不同的含义和用法，它也可以作为动词、形容词、甚至名词。
sidebar:
  hidden: true
...
<Pronunciation word="Down" uk="/daʊn/" us="/daʊn/" client:only />
...
在一个大城市里，住着一个叫 Timmy 的小男孩。每天早晨，他都会迈着轻快的步子走下楼梯，准备好去探索新的一天。

<WordRelations antonyms={["up", "across"]} client:only />
