...
title: Story
description: >-
  Story 是一个英文名词，常被用来指述说，讲述或者编写的一个事件或一系列事情的描述或者报告。例子如：a love story (爱情故事)，a
  success story (成功的故事)，tell a story (讲故事)等。
sidebar:
  hidden: true
...
<Pronunciation word="Story" uk="/ˈstɔː.ɹi/" us="/ˈstɔː.ɹi/" client:only />
...
<WordRelations synonyms={["tome", "lie", "narrative", "serial"]} client:only />
