...
title: Nature
description: >-
  Nature通常有两个基本的含义。一是指自然世界，包括所有动植物、气候、地理特征等。二是指一个人或事物的基本特质或特性。例如，一个人的性格可以被描述为他的'nature'。
sidebar:
  hidden: true
...
<Pronunciation word="Nature" uk="/ˈneɪtʃə/" us="/ˈneɪtʃɚ/" client:only />
...
<WordRelations synonyms={["quintessence", "whatness"]} client:only />
