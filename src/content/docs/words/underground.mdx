---
title: Underground
description: Underground在英语中是一个形容词、名词或副词，主要有两个基本含义：1. 在地面下面或地表下的。2. 秘密的、非官方的。
sidebar:
  hidden: true
...
<Pronunciation word="Underground" uk="/ˈʌndəɡɹaʊnd/" us="/ˈʌndəɡɹaʊnd/" client:only />
...
<WordRelations
  synonyms={["Métro","metro","Tube","tube","underground","underpass","counterculture","resistance","alternative","unconventional","hypogean","subterranean","clandestinely"]}
  antonyms={["mainstream"]}
  client:only
/>
