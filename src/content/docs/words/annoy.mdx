---
title: Annoy
description: Annoy这个单词表示使人烦恼或者使人不悦的意思，在不同的上下文中可以有不同的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Annoy" uk="/əˈnɔɪ/" us="/əˈnɔɪ/" client:only />
...
这个单词的记忆方法是可以通过"an"和"noy"两部分独立来记，"an"可以想象成一个人，"noy"可以想象成 noise(噪音)，一个人对噪音的反应就是烦躁。
...
<WordRelations
  synonyms={["annoyance","bother","bug","hassle","irk","irritate"]}
  antonyms={["please"]}
  client:only
/>
