---
title: Perfume
description: Perfume 是一个名词，它的意思是“香水”。这是一种化妆品，往往含有香精和酒精，用于让人们身上散发出愉快的香味。
sidebar:
  hidden: true
...
<Pronunciation word="Perfume" uk="/ˈpɜːfjuːm/" us="/ˈpɜːfjuːm/" client:only />
...
你可以将 perfume 与烟雾联系起来（因为词根 fume 表示烟雾），想象一下燃烧香料产生的香气充满空气，这样可以帮助记忆。
...
<WordRelations synonyms={["aroma", "fragrance", "scent"]} client:only />
