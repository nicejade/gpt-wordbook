---
title: Fool
description: Fool 是一个英语单词，作为名词它表示'一个愚蠢或做出不明智行为的人'，作为动词则意味着'欺骗'或'愚弄'。
sidebar:
  hidden: true
...
<Pronunciation word="Fool" uk="/fuːl/" us="/fuːl/" client:only />
...
<WordRelations synonyms={["jester", "joker", "gobshite"]} client:only />
