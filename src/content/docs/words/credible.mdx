...
title: Credible
description: >-
  Credible是一个形容词，表示“可信的”，另一个相关的词是'credible
  source'，表示“可信的来源”。举例来说，如果我们说某人是“credible', 那么就是称赞他/她是值得信赖的。
sidebar:
  hidden: true
...
<Pronunciation word="Credible" uk="/ˈkɹɛdəbl̩/" us="/ˈkɹɛdəbl̩/" client:only />
...
"Credible"直接源于拉丁语。在 14 世纪，它被引入到中古英语，意思是“可以或值得相信”。现今，它主要用来描述一个人或一个事物的可靠性或信誉。
...
Fred just heard a story from his friend. He said, "Your story is credible because the evidence you provided supports it." (Fred 刚刚听完他朋友的一个故事。他说，“你的故事很可信，因为你提供的证据支持了它。”)

<WordRelations antonyms={["incredible"]} client:only />
