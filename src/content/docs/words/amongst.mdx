...
title: Amongst
description: >-
  "Amongst" 是一个介词，与 "among" 同义，用来表示某事发生在三个或三个以上的对象中。在美式英语中，我们更常用 "among"，而
  "amongst" 在英式英语中使用更为广泛。 **举例和翻译** 1. She found herself amongst strangers.
  (她发现自己身处陌生人当中。) 2. Amongst the crowd, I spotted an old friend.
  (在人群中，我发现了一个老朋友。) 3. He divided his property amongst his sons. (他把财产平均分给了儿子们。)
sidebar:
  hidden: true
