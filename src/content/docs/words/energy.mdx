...
description: >-
  Energy
  是一个名词，主要有两种含义，一个是指'能量，动力'，这涵盖了自然科学领域对于能量的定义，如热能、电能、动能等。另一个是用来形容某人充满活力，富有精力。例如：He
  doesn't have the energy to go out.（他没有精力出门。）
sidebar:
  hidden: true
...
<Pronunciation word="Energy" uk="/ˈɛnəd͡ʒi/" us="/ˈɛnɚd͡ʒi/" client:only />
...
<WordRelations synonyms={["pep", "vigor", "vim", "vitality"]} client:only />
