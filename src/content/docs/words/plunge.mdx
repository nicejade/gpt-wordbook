---
title: Plunge
description: Plunge 是一个动词，表示突然或急剧地降落、下降或跌落；也可以表示扎入、投入、冲进、陷入等。
sidebar:
  hidden: true
...
<Pronunciation word="Plunge" uk="/plʌndʒ/" us="/plʌndʒ/" client:only />
...
"Plunge" 这个词在英语中的使用可以追溯到 14 世纪，它源自拉丁语 "plumbum"，意为"铅"，因为铅被用于测量深度，故形成了"扎入，投入"的含义。
