---
title: Elevation
description: elevation 的主要意思是升高，提高，它常用来表示海拔，地位的提升以及建筑设计的侧视图等。
sidebar:
  hidden: true
...
词源来自于 14 世纪的拉丁词语 "elevationem"。在建筑和地理领域中，这个词有着特别的含义。在地理上常用来指代地形的海拔高度，而在建筑上则指的是一个建筑物的侧视图。
...
可以将 "elevation" 和 "escalator"（自动扶梯）一起记忆，scala 在拉丁文中意为阶梯，因此 escalator 意味着升高的阶梯，而 "elevation" 也有升高的含义。
...
<WordRelations
  antonyms={["demotion", "depression", "diminishment", "disgust", "reduction"]}
  client:only
/>
