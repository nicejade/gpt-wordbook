---
title: Specimen
description: Specimen 是英语中的一个词，意为“样本”或“标本”，常用来指某种类群中的个别代表，用于科学研究、检验、陈列等。
sidebar:
  hidden: true
...
<Pronunciation word="Specimen" uk="/ˈspɛsɪmɪn/" us="/ˈspɛsɪmɪn/" client:only />
...
Specimen 这个词，最初源于拉丁文中的"specimen"，该词的意思是"证据，例证"，这是由"specere"(見る)衍生出来的。在 17 世纪初，这个词被引入英语中，用来指示个别代表样本或对标本的称呼。
...
<WordRelations synonyms={["individual", "sample"]} client:only />
