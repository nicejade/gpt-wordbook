...
description: >-
  Ounce
  是一个英文单词，主要用作名词，有两种基本含义，一是表示'盎司'，用于度量质量的单位，在我们日常生活和一些科学实验中常常会用到；二是用于表示一种很小的量，比如“一点儿”。
sidebar:
  hidden: true
...
<Pronunciation word="Ounce" uk="/aʊns/" us="/aʊns/" client:only />
...
这个词的起源可以追溯到古罗马时代，当时的一种度量单位 uncia 被用到现在，后经过语言演变最终形成了现在的"ounce"。
...
Tim needed just one more ounce of flour to complete his cake recipe. Without it, his cake wouldn't be perfect. (Tim 只需要再多一盎司的面粉就能完成他的蛋糕配方。没有它，他的蛋糕就不能完美了。)

<WordRelations synonyms={["℥"]} client:only />
