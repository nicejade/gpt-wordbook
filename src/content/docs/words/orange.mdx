---
title: Orange
description: Orange 在英语中主要有两层含义。一是指的是橙色，是红色和黄色结合在一起的颜色。二是指橙子，一种常见的水果，富含维生素 C。
sidebar:
  hidden: true
...
"Orange" 在英语中主要有两层含义。一是指的是橙色，是红色和黄色结合在一起的颜色。二是指橙子，一种常见的水果，富含维生素 C。

<Pronunciation word="Orange" uk="/ˈɔɹɪ̈nd͡ʒ/" us="/ˈɔɹɪ̈nd͡ʒ/" client:only />
...
"Orange" 这个词在 14 世纪从法语借来的，原意是"来自橙树的果实"。橙色是在 16 世纪被视为独立的颜色，这个词就用来表示这个颜色了。
...
<WordRelations synonyms={["yellowred"]} antonyms={["nonorange"]} client:only />
