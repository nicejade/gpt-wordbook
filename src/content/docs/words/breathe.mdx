...
title: Breathe
description: >-
  Breathe 是个动词，基本意思是呼吸，例如“The baby was breathing rapidly”（婴儿正在急促地呼吸）。此外,
  'breathe'也可以用来描述像装有生命一样的活力，“The city is always busy and full of people; it
  really seems to breathe” （这个城市总是繁忙而且人气旺,它真的像有生命一样“呼吸”）。
sidebar:
  hidden: true
...
<Pronunciation word="Breathe" uk="/bɹiːð/" us="/bɹið/" client:only />
