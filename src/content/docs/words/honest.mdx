---
title: Honest
description: Honest 是一个英文形容词，常用来描述人的品质，意为'诚实的，真实的，公正的'。而作为副词时，可以解释为“老实说，实话说”。
sidebar:
  hidden: true
...
<Pronunciation word="Honest" uk="/ˈɒnɪst/" us="/ˈɑnɪst/" client:only />
...
<WordRelations antonyms={["dishonest"]} client:only />
