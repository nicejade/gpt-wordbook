---
title: Handbag
description: Handbag指的是手提包，一种常见的个人携带物品的方式，往往用于携带随身物品，如钱包、手机、化妆品等。它通常有把手或肩带，可以手提或肩背。
sidebar:
  hidden: true
...
<Pronunciation word="Handbag" uk="/ˈhæm.bəɡ/" us="/ˈhæm.bəɡ/" client:only />
...
一开始，"handbag" 只是用来指“随身携带的小袋子”。19 世纪末，随着女性社会角色的变化，手提包开始流行，并渐渐发展成女性服装的标志性配饰。
...
<WordRelations synonyms={["purse"]} client:only />
