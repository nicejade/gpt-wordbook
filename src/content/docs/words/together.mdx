---
title: Together
description: Together 是个副词，用于描述两个或更多的人或事物相互结合、在一起或同步进行的状态。它表示集体行动或一个整体的思想。
sidebar:
  hidden: true
...
<Pronunciation word="Together" uk="/təˈɡɛð.ə(ɹ)/" us="/təˈɡɛðɚ/" client:only />
...
<WordRelations
  synonyms={["concurrently", "collectively", "jointly"]}
  antonyms={["apart"]}
  client:only
/>
