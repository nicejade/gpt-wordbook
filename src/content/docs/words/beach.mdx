---
title: Beach
description: beach的基础意思是“海滩”，指的是沿海或湖边覆盖着沙子或小石的陆地。在更广泛的意义上，也可引申为沿河岸或其他水体周围的类似地带。
sidebar:
  hidden: true
...
<Pronunciation word="Beach" uk="/biːt͡ʃ/" us="/bit͡ʃ/" client:only />
...
<WordRelations synonyms={["backshore", "sand", "strand"]} client:only />
