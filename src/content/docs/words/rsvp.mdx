...
title: RSVP
description: >-
  RSVP 通常表示邀请的接收者需要确认他们是否将参加一项活动，比如派对或婚礼。例如: The invitation says 'RSVP by
  October 19', which means you need to let the host know whether you'll be
  attending by that date. 在这个例子中，'RSVP'被用来说明邀请人需要在某一日期前知道你是否会参加他们的活动。
sidebar:
  hidden: true
