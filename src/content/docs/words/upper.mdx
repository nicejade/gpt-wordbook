---
title: Upper
description: Upper 通常是个形容词，描述的是相对更高或较上面的某物。它也可以作为名词，描述在鞋、靴等物品中的上部部分。
sidebar:
  hidden: true
...
<Pronunciation word="Upper" uk="/ˈʌpə/" us="/ˈʌpɚ/" client:only />
...
<WordRelations antonyms={["lower", "under"]} client:only />
