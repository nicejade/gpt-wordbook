...
title: Inclination
description: >-
  Inclination 是一个名词，意思是倾向、趋势或喜好。它是从动词 'incline'
  派生出来的，通常被用来描述一个人自然地或者习惯性地会做的事情，或者对什么事物有特别的兴趣或热情。
sidebar:
  hidden: true
...
"Inclination"这个词在 14 世纪从拉丁语 "inclinationem" 而来，原意是"倾斜"，后来在中世纪英语中被引申为"偏爱"或"偏向"的意思。
...
<WordRelations
  synonyms={["incline", "inclining", "steepness", "leaning", "proclivity"]}
  client:only
/>
