---
title: Soluble
description: Soluble 是一个形容词，源于拉丁词根 'solvere'，意为'溶解的，可溶的'. 它通常用来描述一个物质（如盐或糖）能否在液体（如水）中溶解。
sidebar:
  hidden: true
...
Soluble 一词源于 14 世纪的法语，来自拉丁语 solubilis，"solvere"意为解开，分解，它也和解决问题的"solve"有关。
...
<WordRelations
  synonyms={["dissoluble", "dissolvable", "solvable"]}
  antonyms={["insoluble"]}
  client:only
/>
