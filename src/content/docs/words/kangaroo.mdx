...
title: Kangaroo
description: >-
  kangaroo 是英语中的一个单词，主要指的是一种产自澳大利亚的特大型跳跃性有袋类动物，袋鼠。此外，kangaroo
  也可以用作形容词，表示与袋鼠有关的事物，如 kangaroo pouch 就是袋鼠的育儿袋。
sidebar:
  hidden: true
...
<Pronunciation word="Kangaroo" uk="/kaŋ.ɡə.ˈɹuː/" us="/kaŋ.ɡə.ˈɹuː/" client:only />
