...
<Pronunciation word="Immediately" uk="/əˈmiːdi.ətli/" us="/əˈmiːdi.ətli/" client:only />
...
"Immediately"一词源自 14 世纪的拉丁文"immediatus"，意为"无间隔的"，与“立即，马上”这个短时间内发生的概念相符合。
...
<WordRelations
  synonyms={["forthwith","now","after","directly","immediately","right"]}
  client:only
/>
