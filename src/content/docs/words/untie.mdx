---
title: Untie
description: Untie 是一个动词，对应的中文意思是解开或者解除。通常这个词用在解开结或者束缚的场景中。
sidebar:
  hidden: true
...
<Pronunciation word="Untie" uk="/ʌnˈtaɪ/" us="/ʌnˈtaɪ/" client:only />
...
<WordRelations antonyms={["tie"]} client:only />
