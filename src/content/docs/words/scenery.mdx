---
title: Scenery
description: Scenery是一个名词，指的是自然环境的外观，特别是在其美丽的方面。它可以包括自然景观，如山脉，森林和湖泊，也可以包含城市或农村的景色。
sidebar:
  hidden: true
...
<Pronunciation word="Scenery" uk="/ˈsiːnəɹi/" us="/ˈsiːnəɹi/" client:only />
...
"Scenery"源自 17 世纪，最初用于描述剧院中的舞台布景。随着时间的推移，它开始用来形容人们看到的各种自然和人造景观。
