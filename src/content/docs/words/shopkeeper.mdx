---
title: Shopkeeper
description: Shopkeeper是一个名词，是指拥有或管理一个小商店的人，类似于我们中文中的'店主'或'店铺老板'。
sidebar:
  hidden: true
...
"Shopkeeper"这个单词在英美文化中，通常指的是小店或商店的所有者，这个词汇最早在 16 世纪的英格兰开始出现。
...
<WordRelations synonyms={["storekeeper"]} client:only />
