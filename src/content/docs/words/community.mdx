---
title: Community
description: Community是一个英文名词，它一般用来描述一个共享某种共同事物（例如地域、信仰、兴趣等）的人群。
sidebar:
  hidden: true
...
“Community”一词在 14 世纪由法语引入英文，最初表示一个共有地而非独占权的群体，后来逐渐发展为现在更广泛的定义。
...
<WordRelations antonyms={["anticommunity", "noncommunity"]} client:only />
