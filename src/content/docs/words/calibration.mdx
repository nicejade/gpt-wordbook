---
title: "calibration"
description: "Calibration这个词是一个名词，它指的是校准或借助标准比较，以调整或测量仪器的精确度。例如，在科学实验或工程项目中，你可能需要对测量设备进行校准，以确保其准确性。"
---
...
词语"Calibre"最初在 1797 年左右用于表示枪弹的口径，这个词语和度量标准具有很强的关联性，对"质量"的含义有着重要影响。"Calibration"一词以后演变成含有“校准”“度量”等含义。
