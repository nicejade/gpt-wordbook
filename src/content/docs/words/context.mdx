...
title: Context
description: >-
  Context是一个英语名词，意思是“上下文”，“语境”或“背景”。这个单词常用于描述周围的环境、设置或信息，这些环境、设置或信息能帮助我们理解某个特定的事件或话题。
sidebar:
  hidden: true
...
<Pronunciation word="Context" uk="/ˈkɒntɛkst/" us="/ˈkɒntɛkst/" client:only />
...
"Context"这个单词直接从 14 世纪的拉丁语借用过来，具体来自 "contextus"这个词，原意是"weave together,"，后来延伸为“连接、联系”等含义。
...
<WordRelations antonyms={["isolation"]} client:only />
