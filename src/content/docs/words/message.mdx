---
title: Message
description: Message（消息）是名词，指的是经由某种方式发送或者传递给别人的信息，这个词也可以作为动词使用，意思是“发送信息”。
sidebar:
  hidden: true
...
<Pronunciation word="Message" uk="/ˈmɛsɪd͡ʒ/" us="/ˈmɛsɪd͡ʒ/" client:only />
...
"Message"这个词在 14 世纪从 Old French 的"mesage"演变而来，原意是"发送者"或"送信人"。
...
<WordRelations synonyms={["text"]} client:only />
