...
description: >-
  Bishop
  是一个英语名词，主要有两个含义。首先，它是一个宗教词汇，用于指代基督教中的一种重要职务，即主教，负责管理一定地区的教会事务。次要的含义是在国际象棋中，指代'象'这一棋子。
sidebar:
  hidden: true
...
<Pronunciation word="Bishop" uk="/ˈbɪʃəp/" us="/ˈbɪʃəp/" client:only />
...
<WordRelations synonyms={["consecrator", "hierarch", "ordinary"]} client:only />
