---
title: Kilowatt
description: Kilowatt是一个名词，它是测量功率的单位，符号是 'kW'。功率是用来衡量在一定时间内消耗或转化能量的速率。1 千瓦等于 1000 瓦特。
sidebar:
  hidden: true
...
"Kilowatt"是一个名词，它是测量功率的单位，符号是 "kW"。功率是用来衡量在一定时间内消耗或转化能量的速率。1 千瓦等于 1000 瓦特。
...
"Kilowatt"这个词出现在 19 世纪，当电力开始广泛使用时。这个词被用来描述电力的数量，直观地表示微小电流的实力。随着时代的发展，"千瓦"这个单位也开始用于表示各种不同类型的能量。
...
有一天，阳光明媚，莉莉正在照看她的花园。突然，广场中的通告响起来：“好消息，女士们先生们！我们建造的太阳能公园有 50 千瓦的容量，足够供给所有房屋今天的电力！”莉莉笑了，高兴地打开了她的电风扇。

<WordRelations synonyms={["KW", "kW", "㎾"]} client:only />
