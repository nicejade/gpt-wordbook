---
title: Vulgar
description: Vulgar 这个词的意思是粗俗的，庸俗的或者不雅的。它通常被用于描述语言，行为，人，或者外表。
sidebar:
  hidden: true
...
<Pronunciation word="Vulgar" uk="/ˈvʌl.ɡə/" us="/ˈvʌl.ɡɚ/" client:only />
...
<WordRelations
  synonyms={["ignoble","inappropriate","mean","obscene","offensive","profane","uncouth","common","ordinary","popular"]}
  client:only
/>
