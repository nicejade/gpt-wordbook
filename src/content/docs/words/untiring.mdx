---
title: Untiring
description: 【Untiring】这个单词是一个形容词，源于词根 tire，加上否定前缀 un-。'Untiring'的主要含义是'不知疲倦的'或'不屈不挠的'。
sidebar:
  hidden: true
...
【Untiring】这个单词是一个形容词，源于词根 tire，加上否定前缀 un-。"Untiring"的主要含义是"不知疲倦的"或"不屈不挠的"。
...
单词 Untiring 的词根是"tire"，意思是"疲倦"。

### 词缀分析

Untiring 是由词根"tire"加词缀"un-"和"-ing"构成的，"un-"是否定前缀，表示"不是"，"-ing"是现在分词后缀。

### 文化背景

单词"Untiring"在早期英语中使用不频繁，但在 20 世纪的第二次世界大战后，随着强调奋斗与坚持的价值观的普及，"Untiring"这个词的使用开始逐渐增多。
...
<WordRelations synonyms={["tireless"]} client:only />
