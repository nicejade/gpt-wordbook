...
title: Proper
description: >-
  Proper 这个单词有两种主要的含义，一是作为形容词，表示“正确的”、“合适的”。例如：A proper answer
  (正确的回答)。第二个含义是表示“符合规定或传统的”，例如：proper behavior (文明的行为)。
sidebar:
  hidden: true
...
<Pronunciation word="Proper" uk="/ˈpɹɔp.ə/" us="/ˈpɹɑ.pɚ/" client:only />
...
“Proper”这个词从 14 世纪开始在英语中使用，最初的意思是"自己的"，“特定的”，逐步演变为现在的“适当的”、“正确的”。在美国，有一个说法叫"Proper Bostonian"，形容那些遵守波士顿的传统礼仪的人。
...
<WordRelations
  synonyms={["comprehensive","intensive","royal","sweeping","appropriate","decent","good","polite","right","upright","apt","correct","fitting","prudent","sensible","honorable","just","complete","total"]}
  antonyms={["incomplete","partial","slapdash","superficial","bad","impolite","inappropriate","indecent","unseemly","wrong","improper","imprudent","incorrect","insensible","dishonorable","unjust"]}
  client:only
/>
