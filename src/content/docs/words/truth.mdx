---
title: Truth
description: Truth是一个名词，它代表事物的真实状态或事情的真实性质。它可以用来描述一种客观的事实，或者一个被广泛接受为正确的观念或观点。
sidebar:
  hidden: true
...
<Pronunciation word="Truth" uk="/tɹuːθ/" us="/tɹuːθ/" client:only />
...
<WordRelations
  antonyms={["drivel", "falsehood", "falsity", "lie", "nonsense", "untruth"]}
  client:only
/>
