...
title: Rise
description: >-
  Rise 是一个常用的动词，具有多个含义。最常见的含义是“上升，升起”，既可以指物理上的升高，比如“太阳升起”(the sun
  rises)，也可以表示抽象的提升，如“价格上涨”或“崛起”。
sidebar:
  hidden: true
...
<Pronunciation word="Rise" uk="/ɹaɪs/" us="/ɹaɪs/" client:only />
...
<WordRelations
  synonyms={["arise", "climb", "increase"]}
  antonyms={["descend", "drop", "fall", "sink", "set", "decrease", "reduced"]}
  client:only
/>
