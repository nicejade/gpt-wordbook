...
title: Darling
description: >-
  Darling 是一个英语单词，通常被用作亲昵的称呼。通常意味着'亲爱的'或'心爱的人'。它可以被用于称呼所爱的人，如情侣、孩子、家人等。例如：wife
  can call her husband 'darling' or a mother can call her child 'darling'。
sidebar:
  hidden: true
...
<Pronunciation word="Darling" uk="/ˈdɑːlɪŋ/" us="/ˈdɑɹlɪŋ/" client:only />
...
"Darling"是一个非常古老的单词，起源于古英语"deorling"，最早的使用可以追溯到公元 9 世纪。在使用上，它一直是表示亲密和爱情的象征，非常普遍在英语国家的日常对话中使用。
