...
title: Design
description: >-
  Design可以作为名词或动词。作为名词，它指的是一个计划或规划，通常涉及艺术或建筑等领域的创作。作为动词，'design'则表示制定一个计划或方案来实现目标。
sidebar:
  hidden: true
...
<Pronunciation word="Design" uk="/dɪˈzaɪn/" us="/dɪˈzaɪn/" client:only />
...
"Design"最初的使用可以追溯到 16 世纪，意为"计划或意图"。在艺术和技术领域，"设计"涵盖了审美、实用和工程元素的整体规划和设计。
