---
title: warning
description: Warning是一个英语名词，意思是警告，预告，告诫。Warning既可以是口头或书面的告诫和警告，也可以指的是先兆或预示，即事件发生之前的迹象或者信号。
sidebar:
  hidden: true
...
- "Warning"这个单词中，-ing 是后缀。"-ing"常常是表示正在进行时态，动词转化为名词，比如 warning, meaning, running 等。
...
- 可以通过形式和读音记忆这个单词。因为它的词根是 warn，"warning"是由其派生出来的名词形式。而且中英文意思均为 “警告”，这让记住这个单词更容易。
