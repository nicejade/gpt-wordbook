---
title: Out
description: Out 是个非常常见的英语单词，可以用作副词、介词、形容词、动词或者连词。基本的含义是'向外，出去'，但是在不同的语境中，可能有其他的概念和意义。
sidebar:
  hidden: true
...
<Pronunciation word="Out" uk="/æɔt/" us="/aʊt/" client:only />
...
<WordRelations
  synonyms={["démodé", "passé", "unchic", "gay", "openly", "away", "through"]}
  antonyms={["in", "safe", "closeted"]}
  client:only
/>
