...
description: >-
  Interpret
  是一个动词，意思是解释，理解，翻译，或展示出通过解释或演绎等方式以理解或解释（一种艺术）。该词也可能意味着用新颖独特的方式转化，改编和演示作品。
sidebar:
  hidden: true
...
"Interpret" 可追溯到 14 世纪的英语，源自拉丁语 "interpretari"，意为解释，理解，翻译。这个词在许多不同的艺术和科学方面都有用，包括音乐，戏剧，文学和语言学。
...
<WordRelations
  synonyms={["explain","render","solve","translate","unfold","unravel"]}
  client:only
/>
