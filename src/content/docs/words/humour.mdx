...
description: >-
  humour
  是一个英文单词，主要用作名词。它的主要意思是“幽默”，指引发笑声或愉快的事物或现象，或是这种能力。人们通常用“幽默”来描述一种使人愉快倾向的品质，或者说是表达或欣赏滑稽和有趣的事物的技巧。
sidebar:
  hidden: true
...
<Pronunciation word="Humour" uk="/ˈhjuː.mə(ɹ)/" us="/ˈhjuːmɚ/" client:only />
...
<WordRelations
  synonyms={["comedy","wit","witticism","amusingness","comicality","mood"]}
  client:only
/>
