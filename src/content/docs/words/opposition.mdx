...
title: Opposition
description: >-
  Opposition 是一个名词，标准的英语定义是 'resistance or disagreement in response to a policy
  or situation'，也就是指对一种政策或情况的抵抗或不同意。它也有指代与政府持不同政见的政党或集团的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Opposition" uk="/ɒpəˈzɪʃən/" us="/ɑpəˈzɪʃn̩/" client:only />
...
词根是 "oppose"，是一个动词，意味着反对或与...作斗争。由此词根衍生出的其他词有：opposite，opposing，opposed 等。
...
<WordRelations antonyms={["apposition"]} client:only />
