---
title: "correlation"
description: "Correlation 是一个名词，常用于数据分析和统计上，用来描述两个或多个变量之间的互相关联程度，即两者是否存在某种关系。如果一种变量的变化伴随着另一种变量的变化，那么它们之间就存在相关性。"
---
...
"Correlation"这个词在 16 世纪的拉丁语中首次出现，最初的意思是"互相匹配"。后来在科学研究和统计学中的应用，使得它的含义逐渐演进为"变量之间的关系"。
