---
title: Blueprint
description: Blueprint是一个英语单词，主要是指详细计划或设计图。它的最初的含义是建筑或机械图纸，后来的含义延伸至详细计划或指导方案。
sidebar:
  hidden: true
...
<Pronunciation word="Blueprint" uk="/ˈbluːˌpɹɪnt/" us="/ˈbluːˌpɹɪnt/" client:only />
...
<WordRelations
  synonyms={["schematic","layout","plan","cyanotype"]}
  client:only
/>
