---
title: Fuel
description: Fuel（发'尤尔）通常指燃料，为名词。也可以作为动词，表示给（引擎等）加燃料。燃料是任何可以用来释放能量来执行工作的材料或物质，如煤、木、天然气等。
sidebar:
  hidden: true
...
<Pronunciation word="Fuel" uk="/ˈfjuːl/" us="/ˈfjuːl/" client:only />
...
Fuel 一词源自古法语 feuaillage，表示为生火备用的物质，首次出现在英语中是在 13 世纪晚期，意思是“燃料”。现代的使用频率大大提高了，发展到表示任何可以用来释放能量。
