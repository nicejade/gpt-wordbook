---
title: Cleanliness
description: 英文单词“cleanliness”指的是无污染的状态或又清洁的状况。该单词常常被用在描述场所、环境或人的个人卫生。
sidebar:
  hidden: true
...
Tom always sweeps the house to maintain its cleanliness. Without a dust, it's like a new pin every day. (Tom 总是擦拭家中，保持其清洁。一尘不染，就像每天都是崭新的一天。)
