...
description: >-
  Pollution
  是一个名词，指的是污染或污染物，特别强调的是自然环境被有毒或有害物质污染。它可以用来描述不同的环境问题，包括空气污染，水污染，土壤污染等。
sidebar:
  hidden: true
...
<Pronunciation word="Pollution" uk="/pəˈl(j)uːʃn̩/" us="/pəˈl(j)uːʃn̩/" client:only />
