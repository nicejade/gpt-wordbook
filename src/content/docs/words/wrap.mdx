---
title: Wrap
description: Wrap是一个英语单词，主要有两个基本意义。作为动词，它的意思是'包装'或'包围'，例如，用纸包装礼物。作为名词，它指的是一种包裹或涵盖物，如披肩或围巾。
sidebar:
  hidden: true
...
<Pronunciation word="Wrap" uk="/ɹæp/" us="/ɹæp/" client:only />
...
<WordRelations synonyms={["enfold", "lap"]} antonyms={["unwrap"]} client:only />
