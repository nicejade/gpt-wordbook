---
title: Rock
description: Rock 这个单词有多种含义，最常见的两种是：
sidebar:
  hidden: true
...
<Pronunciation word="Rock" uk="/ɹɒk/" us="/ɹɑk/" client:only />
...
<WordRelations
  synonyms={["Afrikaner","boulder","pebble","stone","crack","ice","diamond","gem","cliff","foundation","support","bedrock","candy"]}
  client:only
/>
