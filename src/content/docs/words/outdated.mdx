---
title: Outdated
description: Outdated是一个形容词，它的意思是过时的，不再流行的，不再使用的。
sidebar:
  hidden: true
...
<Pronunciation word="Outdated" uk="/aʊtˈdeɪtɪd/" us="/aʊtˈdeɪtɪd/" client:only />
...
Once, a robot named B2 was placed in a museum, labeled "Outdated Robot". B2 felt sad and wished to be updated one day.（曾经，一个名叫 B2 的机器人被摆在博物馆里，标签上写着“过时的机器人”。B2 感到难过，希望有一天能得到更新。）

<WordRelations
  synonyms={["superseded","parachronistic"]}
  antonyms={["current","modern","trendy"]}
  client:only
/>
