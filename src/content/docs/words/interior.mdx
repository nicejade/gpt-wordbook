...
title: Interior
description: >-
  Interior这个单词起源于拉丁语，其中'inter'的意思是'之间'或'内部'。它既可以作为名词，也可以作为形容词使用。作为名词，它通常指的是一个物体、空间或地方的内部等。作为形容词，'interior'可以描述一个位置在物体的内部，或是属于物体的内部。
sidebar:
  hidden: true
...
<Pronunciation word="Interior" uk="/ɪnˈtɪəɹɪə/" us="/ɪnˈtɪɹiɚ/" client:only />
...
"Interior"这个词在 18 世纪后期，随着建筑和装潢艺术的发展，开始广泛用于描绘室内装修和设计。
...
<WordRelations antonyms={["exterior"]} client:only />
