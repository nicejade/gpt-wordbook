---
title: Fake
description: Fake 是一个形容词和动词，常用于描述伪造的、不真实的或冒充的行为或物品。
sidebar:
  hidden: true
...
<Pronunciation word="Fake" uk="/feɪk/" us="/feɪk/" client:only />
...
"Fake" 的具体来源未知，不过这个词在 18 世纪中期开始广泛使用，用来描绘借鉴或模仿他人工作的行为。
...
<WordRelations
  synonyms={["deke", "feint", "pose", "adulterate"]}
