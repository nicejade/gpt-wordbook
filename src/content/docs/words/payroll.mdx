...
title: Payroll
description: >-
  Payroll是一个劳动力管理中的术语，通常用来指代一种雇主为其员工分配薪资和其他报酬的系统。在更广义的语境下，'payroll'也可以用来指代一个公司所有员工的名单。所以它主要有两个含义：
sidebar:
  hidden: true
...
<Pronunciation word="Payroll" uk="/ˈpeɪɹəʊl/" us="/ˈpeɪɹəʊl/" client:only />

### 列举例句

1.  "The company uses an online system to handle its payroll." (公司使用在线系统来处理工资发放。)
2.  "Our payroll has been increased by 10% this year." (今年我们公司的员工名单增加了 10%。)
...
Payroll 是由两个简单的英语单词组合而成，没有前缀和后缀。
...
<WordRelations synonyms={["paysheet"]} client:only />
