---
title: Machine
description: "- 'Machine' 是一个名词，通常用来指任何有特定器件或特定部件组成的设备，这些设备能够使用力或者能源，使物体更改形状，或者进行其他有用工作。"
sidebar:
  hidden: true
...
<Pronunciation word="Machine" uk="/məˈʃin/" us="/məˈʃin/" client:only />
...
- Machine 的词根来自于拉丁词"machina"，意思也是机器。
- 由此词根衍生出的其他单词有：machinery (机械)，mechanic (机械师)，mechanical (机械的)等。

### 词缀分析

- Machine 本身并未含有明确的词缀，但我们可以看到在一些变形或派生词中，比如 machinist (操作工)，machinary (机器的)，含有许多的词缀。
