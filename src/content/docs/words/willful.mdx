---
title: Willful
description: Willful 是形容词，表示“任性的”，“固执的”或是“故意的”，“蓄意的”。它可以用来描绘人的性格和行为。
sidebar:
  hidden: true
...
(Sam 是一个任性的男孩，从来不遵守课堂规则。一次，老师叫他站起来时，他却坐下了。)

<WordRelations
  synonyms={["headstrong", "obstinate", "spiteful", "volitional", "voluntary"]}
  client:only
/>
