...
description: >-
  Elegant
  是一个形容词，它的基本意思是“优雅的”，一般用于描述一个人、物、风格或思想举止的高贵、优雅和精致。它有着高雅，美丽，并在设计，行为或者风格上显示出质朴优雅风度的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Elegant" uk="/ˈɛl.ə.ɡənt/" us="/ˈɛl.ə.ɡənt/" client:only />
...
<WordRelations
  synonyms={["classy", "graceful"]}
  antonyms={["clumsy", "haphazard", "inelegant"]}
  client:only
/>
