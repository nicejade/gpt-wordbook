---
title: Adult
description: Adult 是一个英文单词，用来形容一个人或者生物已经完全成长或发展。亦可以作为名词，表示一个成年人。
sidebar:
  hidden: true
...
<Pronunciation word="Adult" uk="/əˈdʌlt/" us="/əˈdʌlt/" client:only />
...
"Adult"一词源于 16 世纪的拉丁语"adultus"。在各类语境中，其作为形容词和名词的用法各有侧重。在现代社会，"adult"一词代表的不仅仅是生理上的成长，更包含心理、情感以及责任感的成熟。
...
<WordRelations
  synonyms={["XXX","XXXX","pornographic","big","blue","indecent","obscene","salacious"]}
  client:only
/>
