...
description: >-
  Formidable
  是一个形容词，用以形容一个人、事情或者困难程度相当地大，因此，也让人感到敬畏、恐惧或者难以克服。例如，收集这个一百万零件的模型包的工作真是个formidable的任务。当然，formidable
  也可以用来形容某人的本领、实力或者知识深度让人感到震撼。例如，你可以说，他的知识库真的是相当formidable的。
sidebar:
  hidden: true
