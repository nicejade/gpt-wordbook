---
title: Indeed
description: Indeed 是一个副词，常用来加强前面的陈述。它的基本含义是'真实的'，'的确'，'事实上'。它也可以用于表达惊讶，疑问或同意。
sidebar:
  hidden: true
...
<Pronunciation word="Indeed" uk="/ɪnˈdiːd/" us="/ɪnˈdiːd/" client:only />
...
<WordRelations
  synonyms={["certainly","definitely","indubitably","really","surely","truly","undoubtedly","absolutely","forsooth"]}
  client:only
/>
