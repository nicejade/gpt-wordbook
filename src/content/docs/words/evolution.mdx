---
title: Evolution
description: Evolution 是一个名词，中文意思是“进化”，通常用来描述生物种类随时间的变化情况，也可以泛指任何事物的发展和演变过程。
sidebar:
  hidden: true
...
<Pronunciation word="Evolution" uk="/ˈɛvəluːʃ(ə)n/" us="/ˌivə-/" client:only />
...
进化概念在西方文化中首次广泛接受的是通过查尔斯·达尔文在 19 世纪中叶提出的"物种起源"一书。进化论被看作是现代生物科学的基础。
