---
title: Erupt
description: Erupt是一个动词，主要有两个含义：
sidebar:
  hidden: true
...
<Pronunciation word="Erupt" uk="/ɪˈɹʌpt/" us="/ɪˈɹʌpt/" client:only />
...
Erupt 这个词在英文中首次出现在 16 世纪，主要用来形容地质上的火山等自然现象的爆发。然后在语言的使用中逐渐引申到非物质的东西上，比如情绪、声音、疾病等的爆发。

### 单词变形

这个词没有名词或形容词形式。该词的过去式和过去分词为 erupted，现在分词为 erupting.
...
<WordRelations synonyms={["burst"]} client:only />
