---
title: Pianist
description: Pianist 是一名名词，指的是钢琴家，也就是演奏钢琴的人。这个词可以既指专业的音乐人，也可以指业余的或在学习过程中的钢琴爱好者。
sidebar:
  hidden: true
...
<Pronunciation word="Pianist" uk="/piˈænɪst/" us="/piˈænɪst/" client:only />
...
"Pianist" 这个词汇中，piano 的部分诞生于 18 世纪的意大利。而这个单词本身来自于 "pianoforte"，意指 "轻弱"，原因就在于钢琴能够产生出多种力度的音色，这是它的前身，大键琴所不能及的。后缀 -ist 则有古希腊文的由来，这也是西方语言中常见的用以表示从事某种活动的人的后缀。
...
(从前，在一个小镇上，有名叫 Lily 的年轻钢琴家很有名。每个傍晚，她都会在镇中心的广场上弹奏钢琴，给人们的生活带来美好。)

<WordRelations synonyms={["pianoist"]} client:only />
