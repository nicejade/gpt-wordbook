---
title: Business
description: Business这个单词主要表示生意、商业交易或一份工作。在一些特殊场景下，还可用于表示一个人的事务或个人问题。
sidebar:
  hidden: true
...
<Pronunciation word="Business" uk="/ˈbɪd.nəs/" us="/ˈbɪd.nəs/" client:only />
...
可数名词复数形式为 businesses. 形容词形式为 businesslike。
