...
title: Exam
description: >-
  Exam 是英语中的一个常见名词，它的全称是 Examination，来自拉丁语 “examinare”，意思是 '检查' 或
  '测试'。这个词大多数情况下用来指学校或专业机构的 written 或 oral 的测试。
sidebar:
  hidden: true
...
<Pronunciation word="Exam" uk="/ɛɡˈzæm/" us="/ɛɡˈzæm/" client:only />
...
<WordRelations synonyms={["undersee"]} client:only />
