---
title: Ad
description: ad 在英语中通常是 'advertisement' 的缩写，表示 '广告'。
sidebar:
  hidden: true
...
<Pronunciation word="Ad" uk="/æd/" us="/æd/" client:only />
...
"Advertisement" 这个词在 18 世纪被引入英语，其根本含义就是 "让公众注意"。广告的发展历程，既是技术发展的体现，也是文化变迁的反映。
...
<WordRelations synonyms={["advert"]} client:only />
