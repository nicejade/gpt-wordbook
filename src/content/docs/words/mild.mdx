---
title: Mild
description: Mild 是一个英语形容词，主要用来描述性质、程度或影响轻微的事物。可以用来形容天气（不太冷也不太热）、食物（不太热辣）、性格（温和的）、病症（轻度的）等。
sidebar:
  hidden: true
...
<Pronunciation word="Mild" uk="/ˈmaɪld/" us="/ˈmaɪld/" client:only />
...
<WordRelations
  synonyms={["bland","calm","gentle","indulgent","kind","lenitive","meek","placid","pleasant","soft","soothing","tender","tranquil"]}
  antonyms={["harsh","irritating","severe","violent","strong"]}
  client:only
/>
