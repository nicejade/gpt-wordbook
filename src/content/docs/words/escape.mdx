---
title: Escape
description: "- 'Escape' 是一个英语单词，主要意思是“逃脱，避免”。"
sidebar:
  hidden: true
...
<Pronunciation word="Escape" uk="/əˈskeɪp/" us="/əˈskeɪp/" client:only />
...
- 'Escape'来源于 14 世纪的法语'eschepe'，意为逃跑，避免被抓。在英语中，该词用于描绘从监禁、危险、灾难等不好的情况中脱身的行为或情况。
