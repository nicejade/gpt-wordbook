...
title: Prosecute
description: >-
  - 'Prosecute' 是一个英文动词，其主要含义是 '起诉' 或 '检控'。此外，它也可以表示 '继续执行' 或 '执行到底'。所以当你看到
  'prosecute' 这个词时，具体含义需要根据上下文来理解。
sidebar:
  hidden: true
...
- "Prosecute" 在 14 世纪起源于法律语境，原意为 "以法律手段追究"。到 18 世纪时，它开始被使用来描述对目标的追求和实现。
