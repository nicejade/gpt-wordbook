...
description: >-
  Telecommunications是一个复合词，由 tele 和 communications
  组成。Tele-的来源是希腊词τῆλε，意为远，而communications则来自拉丁词communicare，意为分享。因此，telecommunications
  的意思是远距离的通信。目前，这个单词主要用于描述通过电子系统传输信息的技术和行业。
sidebar:
  hidden: true
