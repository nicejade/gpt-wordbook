...
title: Plural
description: >-
  Plural 是一个英语形容词，源自拉丁语
  'pluralis'，意为“多个的”或“多样的”。当我们说一个词是'plural'（复数）的时候，我们是指它代表的是多于一个的事物或者概念。
sidebar:
  hidden: true
...
<Pronunciation word="Plural" uk="/ˈplɔː.ɹəl/" us="/ˈpləɹəl/" client:only />
...
"Plural"这个词首先出现在 14 世纪的拉丁语文本中，最初是用来描述数学名词和代词的复数形式的。随着时间的推移，它被更广泛地用来描述任何代表多于一个的事物或概念的名词，例如对动物、植物等名词的复数形式。
...
<WordRelations
  synonyms={["manifold", "morefold", "multiple", "several"]}
  antonyms={["singular"]}
  client:only
/>
