---
title: Opaque
description: Opaque是一个形容词，用于描述不透明的物体或者难以理解、模糊的意思或者观念。
sidebar:
  hidden: true
...
<Pronunciation word="Opaque" uk="/əʊˈpeɪk/" us="/əʊˈpeɪk/" client:only />
...
Opaque 的词根来自于拉丁文"opacus"，表示"阴暗，遮掩"。

### 词缀分析

Opaque 没有前缀或后缀。 "opa-"是词根，“-que”是表示该词是形容词的后缀。

### 文化背景

"Opaque"源自拉丁文，原指“阴暗的，昏暗的”。17 世纪初，这个词的使用开始扩大，除了描述物体的“不透明”，也常用来比喻难以理解或解释的概念或者观点。
...
<WordRelations
  synonyms={["blur","cloud"]}
  antonyms={["bright","brilliant","clear","obvious","translucent","transparent"]}
  client:only
/>
