...
title: Transform
description: >-
  - Transform 意为使改变；改变；转变；[物]
  变换；'transform'是一个动词，表示改变某物的性质、功能或外观。它还可以用于数学和科学中，表示更复杂的过程，例如函数的变换或形状的变形。
sidebar:
  hidden: true
...
<Pronunciation word="Transform" uk="/tɹænzˈfɔːm/" us="/tɹænzˈfɔɹm/" client:only />
...
<WordRelations
  synonyms={["alter","change","convert","transmogrify"]}
  client:only
/>
