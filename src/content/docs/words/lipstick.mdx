...
description: >-
  Lipstick是一个英文词汇，它是由
  'lip'（唇）和'stick'（固体棒状物体）这两个单词组成的。所以，“lipstick”通常被翻译为“口红”，它是一种用于改变唇部颜色，增加口部韵味，保护唇部免受外界伤害的化妆品。
sidebar:
  hidden: true
...
<Pronunciation word="Lipstick" uk="/ˈlɪpˌstɪk/" us="/ˈlɪpˌstɪk/" client:only />
