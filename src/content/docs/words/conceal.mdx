---
title: Conceal
description: 单词 'conceal' 是一个动词，意为“隐藏”，“遮盖”。当你想要隐藏或保密某个事物、信息、或感觉时，可以用这个词。
sidebar:
  hidden: true
...
<Pronunciation word="Conceal" uk="/kənˈsiːl/" us="/kənˈsiːl/" client:only />
...
<WordRelations
  synonyms={["hide", "obfuscate", "secrete"]}
  antonyms={["admit", "reveal", "uncover"]}
  client:only
/>
