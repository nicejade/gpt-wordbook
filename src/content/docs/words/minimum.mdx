---
title: Minimum
description: Minimum 是形容词和名词，作形容词时表示“最小的，最低的”，作名词时表示“最小量，最低限度”。
sidebar:
  hidden: true
...
<Pronunciation word="Minimum" uk="/ˈmɪn.ɪ.məm/" us="/ˈmɪn.ə.məm/" client:only />

### 列举例句

1.  The minimum age for the job is 18. (应聘这份工作的最低年龄是 18 岁。)
...
"Minimum" 是 18 世纪从拉丁语中直接借用过来的，原意是“最小的”，现在已经被广泛用于各种领域，如数学、物理和生活中。
...
<WordRelations synonyms={["minimal"]} antonyms={["maximum"]} client:only />
