---
title: Ascribe
description: ascribe 是个动词，通常用来表示“归因于”，“把...归咎于”。常常被用来描述把情况或结果归因于某个原因或源头。
sidebar:
  hidden: true
...
<Pronunciation word="Ascribe" uk="/əˈskɹaɪb/" us="/əˈskɹaɪb/" client:only />
...
这个词源自 14 世纪的中古英语，最初的意思是“书写或记录”，后来的含义逐渐发展为“将某事归因于某因素”。
...
<WordRelations synonyms={["attribute", "impute"]} client:only />
