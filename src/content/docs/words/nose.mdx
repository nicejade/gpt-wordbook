---
title: Nose
description: Nose是一个英文名词，指的是我们身体的一个重要部位：鼻子。它不只用于闻气味，也是我们呼吸系统的重要组成部分。
sidebar:
  hidden: true
...
<Pronunciation word="Nose" uk="/nəʊz/" us="/noʊz/" client:only />
...
<WordRelations synonyms={["tab", "drip", "nark"]} client:only />
