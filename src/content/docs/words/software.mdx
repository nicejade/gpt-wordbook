---
title: Software
description: Software 是一个术语，用于指代计算机程序，也就是指导计算机操作的代码和指令的集合。
sidebar:
  hidden: true
...
<Pronunciation word="Software" uk="/ˈsɑftˌwɛɹ/" us="/ˈsɔftˌwɛɹ/" client:only />
...
"Software" 这个词起源于 20 世纪 50 年代，是为了与硬件（hardware）相对而言的。在电子计算机出现之前，"software" 这个词几乎不使用。
