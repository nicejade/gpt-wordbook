---
title: Fluency
description: _Fluency_ 是一个名词，表示流利、熟练。常用于描述计算机技术，语言或者一种特殊技能的掌握程度。
sidebar:
  hidden: true
...
<Pronunciation word="Fluency" uk="/ˈfluːənsi/" us="/ˈfluːənsi/" client:only />
...
这个单词来源于 17 世纪，主要用于描绘语言或者音乐等的流畅表达。现在，'fluency' 的应用已经延伸到了各个领域，你可以在计算机科学，医学，教育等领域里发现这个词的身影。
