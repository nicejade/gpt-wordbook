---
title: Whatever
description: Whatever是一个可以代表'无论什么'、“任何”的原词，有时候也可以表示强烈的不快或置之不理的态度。
sidebar:
  hidden: true
...
<Pronunciation word="Whatever" uk="/wɒtˈɛvə/" us="/wʌtˈɛvɚ/" client:only />
...
<WordRelations synonyms={["meh", "whatev"]} client:only />
