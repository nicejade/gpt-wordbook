...
title: Thinking
description: >-
  Thinking 是动词 'think' 的现在分词形式。一方面，它可作为动词，表示正在进行的思考或思索行为，如 'He is thinking about
  the problem'（他正在思考这个问题）。另一方面，它也可作为名词，表示思考、思维，或者意见、观念，如 'positive
  thinking'（积极思维）。
sidebar:
  hidden: true
...
<Pronunciation word="Thinking" uk="/ˈθɪŋkɪŋ/" us="/ˈθɪŋkɪŋ/" client:only />
