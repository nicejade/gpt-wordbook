---
title: Display
description: Display是一个动词，主要用于表达“展示，展览，显示”的意思。同时它也可以被用作名词，表示“显示屏，陈列物，展示”。
sidebar:
  hidden: true
...
<Pronunciation word="Display" uk="/dɪsˈpleɪ/" us="/dɪsˈpleɪ/" client:only />
...
<WordRelations synonyms={["splay"]} client:only />
