---
title: Country
description: Country 是一个英文名词，主要含义为'国家'，但也可用于表达诸如'乡村'或'农村'这样的概念。
sidebar:
  hidden: true
...
<Pronunciation word="Country" uk="/ˈkʌntɹi/" us="/ˈkʌntɹi/" client:only />

### 列举例句

1.  Their wine trade extends to more than 100 countries. (他们的葡萄酒贸易扩展到 100 多个国家。)
...
<WordRelations synonyms={["country"]} client:only />
