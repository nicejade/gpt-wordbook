...
<WordRelations
  synonyms={["apparatus","design","effect","function","implementation","interchange","interplay","mechanism","method","motif","nature","operation","pattern","process","regimen","workings","active"]}
  antonyms={["static"]}
  client:only
/>
