---
title: Rejection
description: Rejection一词在英文中意为“拒绝”，“驳回”或“排斥”。
sidebar:
  hidden: true
...
其他由 "ject" 衍生出来的单词：project, eject, inject, subject 等。

### 词缀分析

"Re-" 是一个常用的前缀，其意思为"回，再"，常用于许多词中，如：revise，recall 等。

"-ion"是一个后缀，用于转变动词或形容词为名词，如：inspiration、solution 等。

### 文化背景

"Rejection"这个词来自于 late Middle English（在 14-15 世纪)，最初来自拉丁语的 "reicere", 意为"throw back"，在文化中，通常表示一种不接纳或不同意的情绪。
...
Tom 充满激情地把他的新发明带给了他的老板，却遭到了快速的否决。就好像他把心扔出去，然后又被扔回来。

<WordRelations synonyms={["rejectedness"]} client:only />
