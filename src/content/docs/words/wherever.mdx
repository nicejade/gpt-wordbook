---
title: Wherever
description: Wherever是一个副词，用来表示“无论在哪里”或“在任何地方”。它还可以作为连接词，引导条件状语从句或地点状语从句。
sidebar:
  hidden: true
...
<Pronunciation word="Wherever" uk="/wɛəˈɹɛvə/" us="/(h)wɛɹˈɛvɚ/" client:only />
...
Wherever 中并没有前缀或后缀。However, 该词是由"where"和"-ever"组成的，其中"-ever" 是一个后缀，它增加了词汇的强调含义。

### 文化背景

"Wherever"这个词的起源可以追溯到 14 世纪的中英语时期。"Where"和"ever"的结合成一个词应该是伴随着英语语言的发展逐渐形成的。
