...
description: >-
  Dinosaur
  是一个英文单词，指的是生活在侏罗纪和白垩纪时期的恐龙。恐龙是一类已经灭绝的史前爬行动物，体型从小鸟大小到超过商业飞机的长度都有。如异龙、霸王龙、剑龙等都是恐龙的典型代表。
sidebar:
  hidden: true
...
<Pronunciation word="Dinosaur" uk="/ˈdaɪnəsɔː(ɹ)/" us="/ˈdaɪnəsɔː(ɹ)/" client:only />
...
"Dinosaur"一词首次出现在 1842 年，由英国古生物学家 Richard Owen 所创建，用来描述这些强大而且令人畏惧的史前动物。在西方文化中，“恐龙”这个词经常用于形容过时或落后的事物。
