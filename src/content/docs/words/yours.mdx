---
title: Yours
description: Yours 是一个物主代词，用来表示所属关系，意为“你的”，在句中通常作主语、宾语或表语。'Yours' 形式唯一，不会随性别、数目、格位的变化而变化。
sidebar:
  hidden: true
...
<Pronunciation word="Yours" uk="/jɔː(ɹ)z/" us="/jɔɹz/" client:only />
...
<WordRelations synonyms={["yourn"]} client:only />
