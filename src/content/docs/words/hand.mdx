...
description: >-
  Hand（n. /
  v.）在英语中用途广泛，主要有两个基本含义：作为名词，它主要指的是人体的一部分，即位于手腕和手指之间的部分。作为动词，它表示'递给'或'传递'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Hand" uk="/hænd/" us="/hænd/" client:only />

### 列举例句

- 名词用法："He has a scar on his hand." 他的手上有一道疤。（表示人体部位）
- 动词用法："Can you hand me the pen, please?" 你能把笔递给我吗？（表示递给/传递）
- 还有一种比喻用法，例如："The hands of the clock are pointing at 12." 时钟的指针指向 12 点。（手用作"指针”的意思）
...
Hand 是一个非常早的英语词汇，最早出现在公元前 450 年左右的古英语中，源于原始日耳曼词汇 '\*handuz'。
...
<WordRelations synonyms={["manus", "paw"]} client:only />
