---
title: Frog
description: Frog是一种长在湿地或水中的两栖动物，具有强壮的后腿，可用于跳跃和游泳。
sidebar:
  hidden: true
...
<Pronunciation word="Frog" uk="/fɹɒɡ/" us="/fɹɑɡ/" client:only />
...
Frog 这个单词没有明显的词根。但在其他语言中，可以找到相关词根，例如荷兰语“vrok”和德语“Frosch”。
...
从前，有只名叫 Ribbit 的小青蛙住在一个大池塘里。每天，他都会从一个睡莲跳到另一个睡莲，引起水面的涟漪。

<WordRelations synonyms={["frosh", "frosk", "pad", "paddock"]} client:only />
