...
title: Orbit
description: >-
  Orbit主要有两种含义。第一，当它用作名词时，它表示类似于地球围绕太阳运行的路径即为‘轨道’。第二，当它用作动词时，它表示“围绕...运行”。“Orbit”一词的常见用法有围绕某物运动、环绕等。
sidebar:
  hidden: true
...
<Pronunciation word="Orbit" uk="/ˈɔː(ɹ)bɪt/" us="/ˈɔː(ɹ)bɪt/" client:only />
...
Orbit 作为名词，其复数形式为 orbits。做为动词，其过去式和过去分词为 orbited，并且进行时为 orbiting。
...
<WordRelations
  synonyms={["circumambulate","launch"]}
  antonyms={["deorbit"]}
  client:only
/>
