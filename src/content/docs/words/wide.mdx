...
title: Wide
description: >-
  wide是一个形容词，用来描述某个物体的宽度很大或者一个区域的面积很广。例如，我们可以说“这条河很宽（This river is very
  wide）”或者“这个地区是宽广的草原（This region is a wide plain）”。
sidebar:
  hidden: true
...
<Pronunciation word="Wide" uk="/waɪd/" us="/waɪd/" client:only />
...
固定搭配有 wide open (完全开着的), wide awake (完全醒着的)，等等。
...
<WordRelations antonyms={["narrow", "skinny", "thin"]} client:only />
