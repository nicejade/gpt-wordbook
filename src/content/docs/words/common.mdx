...
title: Common
description: >-
  Common 是一个常用的英语单词，主要意思是“普通的”、“常见的”或“共享的”。用法多样，并可用作形容词、名词和动词。例如，'It's common
  knowledge that...'（这是大家都知道的事实…）。
sidebar:
  hidden: true
...
<Pronunciation word="Common" uk="/ˈkɒmən/" us="/ˈkɑmən/" client:only />
...
<WordRelations
  synonyms={["appellative","epicene","mutual","shared","widespread","everyday","normal","ordinary","standard","usual"]}
  antonyms={["individual","peculiar","personal","rare","uncommon","exceptional","extraordinary","noteworthy","special"]}
  client:only
/>
