---
title: Traditional
description: Traditional 是一个形容词，表示与长期存在的习惯，习俗，信仰或风俗有关的事物，常用于描述被历史悠久、代代相传的独特习俗，信仰或者方法。
sidebar:
  hidden: true
...
<Pronunciation word="Traditional" uk="/tɹəˈdɪʃnəl/" us="/tɹəˈdɪʃnəl/" client:only />
...
"Traditional" 这个词从 14 世纪开始在英语中出现，它源于拉丁词组 "traditio"，指的是传递，交付的行为。在欧美文化中，"traditional" 表达对历史、习俗等的尊重。
...
<WordRelations
  synonyms={["traditionary"]}
  antonyms={["nontraditional","untraditional"]}
  client:only
/>
