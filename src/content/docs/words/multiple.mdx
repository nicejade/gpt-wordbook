---
title: Multiple
description: Multiple 是英语中的一个形容词，意为“多个的，多种的”，也可以作为名词，意为“倍数”。
sidebar:
  hidden: true
...
<Pronunciation word="Multiple" uk="/ˈmʌltɪpl̩/" us="/ˈmʌltɪpl̩/" client:only />
...
<WordRelations
  synonyms={["manifold", "many", "morefold", "several", "plural"]}
  antonyms={["paucal"]}
  client:only
/>
