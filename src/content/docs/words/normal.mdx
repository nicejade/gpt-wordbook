...
<WordRelations
  synonyms={["hale","healthy","well","orthogonal","perpendicular","average","common","commonplace","conventional","customary","everyday","expected","general","natural","ordinary","regular","routine"]}
  antonyms={["ill","poorly","sick","unwell","tangential","reverse","unconventional","unusual"]}
  client:only
/>
