...
title: Persuasion
description: >-
  Persuasion是一个名词，它主要有两种基本含义。第一种是'说服'或者'劝说'的意思，常常被用来描述一个人试图影响另一个人的信仰、态度、意图或行为的过程。第二种含义是'信仰'或'派别'，这种含义中，'persuasion'是用来指桌某人所遵守的特定道德、宗教或者哲学观念。
sidebar:
  hidden: true
...
<WordRelations antonyms={["dissuasion"]} client:only />
