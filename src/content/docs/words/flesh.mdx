...
title: Flesh
description: >-
  "Flesh"这个单词在英语中具有几个不同的基本含义： 1. 动物或人体中的肌肉和软组织。例如："human flesh"（人肉）; 2.
  个体的本性或物质本质，特别是与精神或灵魂相对应的部分。例如："in the flesh"（亲自，亲眼）; 3. 某些果实的柔软部分。例如："the
  flesh of a peach"（桃子的果肉）；
sidebar:
  hidden: true
