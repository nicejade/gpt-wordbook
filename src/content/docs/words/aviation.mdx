...
title: Aviation
description: >-
  Aviation是英语中的一个名词，通常用于指涉所有与飞机、直升机及其其他的飞行器有关的事情，包括制造，使用和飞行等。它主要关注的是大气中的飞行，而非宇宙中的飞行。
sidebar:
  hidden: true
...
"Aviation"这个词在 20 世纪初，即飞机发明和菲利佩·陨石在巴黎举办的首次动力飞行的时候，被广泛采用。在那之后，随着航空技术的更进一步发展，这个词已经成为我们讨论空中旅行的一个重要词汇。
