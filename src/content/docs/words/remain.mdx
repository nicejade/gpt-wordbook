...
title: Remain
description: >-
  Remain 是一个英语动词，主要有两个基本含义：一是 '继续存在，保持原状'，就像是我们说 'keep intact'；二是 '剩下，留下'，相当于
  'to be left'。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["await","wait","rest","stay","endure","last","linger"]}
  client:only
/>
