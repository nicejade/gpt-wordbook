---
title: Greatly
description: Greatly 是一个副词，用于描述某个动作的程度或者强度，类似于中文里的'很'或'非常'。
sidebar:
  hidden: true
...
<Pronunciation word="Greatly" uk="/ˈɡɹeɪtli/" us="/ˈɡɹeɪtli/" client:only />
...
<WordRelations synonyms={["drastically", "very"]} client:only />
