...
title: Gaze
description: >-
  Gaze 是一个英语动词，表达的是 “盯着看，凝视” 的含义。通常，gaze
  意味着你的视线并没有快速转移或者四处飘散，而是集中于特定的对象或者视野。这个词通常带出某种强烈的情感，例如沉思、欣赏、好奇或者困惑。
sidebar:
  hidden: true
...
<Pronunciation word="Gaze" uk="/ɡeɪz/" us="/ɡeɪz/" client:only />
...
<WordRelations synonyms={["gape", "look", "stare"]} client:only />
