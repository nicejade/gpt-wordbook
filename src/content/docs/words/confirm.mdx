...
title: Confirm
description: >-
  Confirm 是一个英文动词，意思是“确认”、“证实”或“确定”。在许多情况下，当人们需要对某件事情或信息进行核实以确保其真实性或准确性时，便会使用
  'confirm' 。
sidebar:
  hidden: true
...
<Pronunciation word="Confirm" uk="/kənˈfɜːm/" us="/kənˈfɝm/" client:only />
...
"Confirm"这个词最早来自于 12 世纪的拉丁文，原意是“加固，使稳定”。后来，用法逐渐发展转变为现在的“确认，证实”。
...
<WordRelations
  antonyms={["contradict","deny","dispute","infirm","question"]}
  client:only
/>
