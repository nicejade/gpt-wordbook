...
title: Resemble
description: >-
  Resemble是一个动词，意为“类似”，“相似” 或者 '有......的特征或外貌'，一般用于比较两者之间的外表或特征的相同性。例如：'She
  resembles her mother.'（她长得像她的母亲。）
sidebar:
  hidden: true
...
<Pronunciation word="Resemble" uk="/ɹɪˈzɛmb(ə)l/" us="/ɹɪˈzɛmb(ə)l/" client:only />
...
"Resemble"来自于 14 世纪的中古英语"resemblen"，意为"相似"，"类似"，源自于古法语的"resembler"，在经过时间的推移和文化的交流后被英语所采用。

### 单词变形

Resemble 作为动词，一般现在时为 resemble，过去式和过去分词为 resembled，现在分词为 resembling。
