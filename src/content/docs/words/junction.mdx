...
title: Junction
description: >-
  Junction是一个名词，意思是两条或更多的路线、线条、或部分的交叉点或联接点，一般指交叉路口或接头处，也可表示交汇点，如你会在铁路交叉口看到的火车轨道交汇的地方。
sidebar:
  hidden: true
...
<Pronunciation word="Junction" uk="/ˈdʒʌŋkʃən/" us="/ˈdʒʌŋkʃən/" client:only />
...
<WordRelations synonyms={["intersection"]} client:only />
