...
title: Extend
description: >-
  Extend 是一个动词，它主要有两个意思。一是'使...延长/扩大'，比如'extend the deadline' (延长截止日期)。二是
  '给予，提供'，比如'extend an invitation' (发出邀请)。
sidebar:
  hidden: true
...
<Pronunciation word="Extend" uk="/ɛkˈstɛnd/" us="/ɛkˈstɛnd/" client:only />

### 列举例句

1.  Can we extend the meeting for another 30 minutes? (我们能将会议延长 30 分钟吗？)
...
"Extend"起源于 14 世纪的中古英语，最初主要用于表示"扩大"或"增加"某物。
...
作为一个专注于瑜伽的实践者，Alice 每天早晨都会把她的身体伸展到极限。她相信，如果你足够挑战自己，身体的能力将会得到延展。
