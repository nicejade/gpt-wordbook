...
description: >-
  Affiliate
  是一种动词，也可以做名词使用。作为动词，它的意思是将（一个人或机构）附属或连接到一个大的、或强力的个人或机构。作为名词，它指的是附属机构或者成员。
sidebar:
  hidden: true
...
单词 "Affiliate" 最初源自拉丁语"affiliare"，意为"像儿子一样对待"。这个词在 1500 年代晚期开始流行，主要用于法律语境中描述关于领养或合法归属的概念。而现在，它更多地用于商业和教育领域，描述机构、个人或实体之间的关联。
