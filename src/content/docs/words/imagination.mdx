---
title: Imagination
description: Imagination 是名词，意为'想象；想象力'，它是指我们的能力去创造或想象对于现实并不存在的情境。
sidebar:
  hidden: true
...
"Imagination" 一词在 14 世纪由法语派生，并深深植根于英语中，这个词的使用在历史上一直与艺术和创新紧密相连，因为它描述了人类的能力去超越现实，去发明和创造。
...
<WordRelations
  synonyms={["creativity","fancy","imaginativeness","invention","inventiveness","conception","notion"]}
  client:only
/>
