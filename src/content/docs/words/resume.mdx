...
title: Resume
description: >-
  Resume 在英语中理解的含义有两种，取决于你的语境： 1. 作为动词（重读最后一个音节），意为“重新开始；恢复”。 例如： Melissa plans
  to resume her studies after a short break.（梅丽莎打算在短暂休假后恢复她的学习。） 2.
  作为名词，常用在美式英语里，主要用于招聘中，意为"个人简历"。 例如： Please send your resume and cover letter
  to the following email address.（请将你的简历和求职信发送至以下电子邮件地址。）
sidebar:
  hidden: true
