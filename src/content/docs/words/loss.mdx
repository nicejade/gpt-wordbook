---
title: Loss
description: Loss 是一个名词，意思是'损失，遗失，失去，亏损'。这是一个多义词，可以根据上下文环境用在不同的场景中。
sidebar:
  hidden: true
...
<Pronunciation word="Loss" uk="/lɑs/" us="/lɔs/" client:only />
...
<WordRelations antonyms={["gain", "profit", "victory", "win"]} client:only />
