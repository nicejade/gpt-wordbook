---
title: Depart
description: Depart 是一个动词，主要意思是离开或出发。这个词代表了一个人或一件事物从一个地方或情形离开或开始一个新的旅程或任务。
sidebar:
  hidden: true
...
<Pronunciation word="Depart" uk="/dɪˈpɑːt/" us="/dɪˈpɑɹt/" client:only />
...
"Depart" 这个词最早是在 14 世纪被使用，主要用于表示人的死亡，后来沿用下来，发展为表示人或事离开一个地方的意思。
...
<WordRelations
  synonyms={["deviate","diverge","sidetrack","vary","leave"]}
  antonyms={["arrive", "come", "stay", "conform", "live"]}
  client:only
/>
