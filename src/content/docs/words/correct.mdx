---
title: Correct
description: Correct 是一个形容词和动词。作为形容词，它意味着“正确的”，与错误相对；作为动词，它意味着“纠正”，即修正错误或不准确之处。
sidebar:
  hidden: true
...
<Pronunciation word="Correct" uk="/kəˈɹɛkt/" us="/kəˈɹɛkt/" client:only />
...
"Correct" 来自 14 世纪的法语 "correct", 是从拉丁语 "correctus" 演变过来的，拉丁词源的含义是"make straight, bring into order"。在欧美文化当中，这个词是教育和学习的基础，代表了一个追求精确和真实的传统。
...
(史蒂夫在钢琴上弹错了一个音符。他的老师迅速地说，“纠正你的错误，史蒂夫。正确的音符是 G，不是 F。”)

<WordRelations
  synonyms={["right"]}
  antonyms={["uncouth", "inaccurate", "incorrect"]}
  client:only
/>
