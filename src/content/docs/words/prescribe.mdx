---
title: Prescribe
description: Prescribe是一个动词，主要有两种含义：
sidebar:
  hidden: true
...
"Prescribe"这个单词最早在 14 世纪的医学文献中出现，用以描述医生为病人制定治疗方案或者开具处方的行为。后来，其含义逐渐扩大，也用来形容其他形式的规定或命令。
...
<WordRelations antonyms={["proscribe"]} client:only />
