---
title: Lest
description: Lest 是一个连词，基本意思为“唯恐，以防”，表示担忧某种不希望发生的情况。它经常用于引导所表示的意图、目的、担心等蓄意的子句。
sidebar:
  hidden: true
...
<Pronunciation word="Lest" uk="/lɛst/" us="/lɛst/" client:only />
...
<WordRelations synonyms={["before"]} client:only />
