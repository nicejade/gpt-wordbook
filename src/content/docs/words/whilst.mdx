---
title: Whilst
description: Whilst是一个连接词，主要应用在英国英语中，它在美国英语中的等效词是'while'。'Whilst'用于表示'在...期间'或'然而'两种意思。
sidebar:
  hidden: true
...
<Pronunciation word="Whilst" uk="/hwaɪlst/" us="/hwaɪlst/" client:only />
...
"Whilst"起源于 14 世纪，一个旧英语世界的连接词，用于表示当...的时候或者尽管。从 20 世纪开始这个词在美国英语中逐渐被“while”取代，但在英式英语中它仍然被广泛使用。
...
<WordRelations synonyms={["while"]} client:only />
