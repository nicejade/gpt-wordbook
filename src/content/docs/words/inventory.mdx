---
title: Inventory
description: Inventory 是名词，用作'库存'，'存货'的意思。这是商业用语，常用于商店或公司描述存储在仓库的商品数量。
sidebar:
  hidden: true
...
<Pronunciation word="Inventory" uk="/ɪnˈvɛn.tə.ɹi/" us="/ɪnˈvɛn.tə.ɹi/" client:only />
...
“Inventory”一词最初在 14 世纪的法语中出现，其原始含义是"制作详细清单"。后来，它在英国商业中开始用作"库存"的同义词，在许多英语国家的商业环境中，使用频率甚高。
