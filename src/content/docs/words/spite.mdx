---
title: Spite
description: Spite 是一个名词，也可作为动词使用。它的主要含义是恶意、怨恨或做某事以刻意伤害或惹恼他人。
sidebar:
  hidden: true
...
<Pronunciation word="Spite" uk="/spaɪt/" us="/spaɪt/" client:only />
...
"Spite"在 14 世纪的时候从古法语的 "spite" 进入中世纪英语，并延续至今。在文化中，"spite" 通常表示为了以某种负面的情绪或态度，尤其是恨意或敌意，来预期伤害他人或做出某种行为。
...
与 "spite" 有关的词组的记忆方法：“in spite of”（尽管），你可以将其视为"心中有 spite（恨意）"，但"of（的）"那个人行事并未受到影响，即"尽管"。
...
<WordRelations synonyms={["grudge", "rancor"]} client:only />
