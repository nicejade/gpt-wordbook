---
title: Copper
description: Copper 是“铜”的意思，通常作为名词使用，但也可作为形容词，表示同铜一样的颜色。它也是元素周期表上的第 29 号元素。
sidebar:
  hidden: true
...
"Copper" 是“铜”的意思，通常作为名词使用，但也可作为形容词，表示同铜一样的颜色。它也是元素周期表上的第 29 号元素。

<Pronunciation word="Copper" uk="/ˈkɔp.ə/" us="/ˈkɑ.pɚ/" client:only />
...
<WordRelations
  synonyms={["chestnut", "russet", "coppery", "coppern"]}
  client:only
/>
