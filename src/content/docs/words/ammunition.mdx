---
title: Ammunition
description: ammunition 这个单词来源于法语 'amunition'，它的意思是军火、弹药。它也常被用来比喻争论或辩论中强有力的事实或论点。
sidebar:
  hidden: true
...
"ammunition" 一词自 16 世纪中期开始在英语中使用，主要指代为战争做准备的物资。它的使用在历史上主要关联与战斗和军事行动。
...
<WordRelations synonyms={["ammo"]} client:only />
