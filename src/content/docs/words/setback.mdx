...
title: Setback
description: >-
  Setback是一个名词，主要意思是'挫折'或者'阻碍'，指的是进一步前进的难题或问题。'Setback'也可以指建筑设计中的一种技术，即使建筑物在高度上增加时，可以有更多的公共空间。
sidebar:
  hidden: true
...
<Pronunciation word="Setback" uk="/ˈsɛtbæk/" us="/ˈsɛtbæk/" client:only />
...
相关搭配包括 suffering a setback, a setback for, a major/minor setback 等。
