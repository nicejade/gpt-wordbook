...
title: polymer
description: >-
  Polymer是一个英文单词，通常在科学和工程领域使用，特别是化学和材料科学。Polymer来自于希腊语的poly- 意为多，很多和 -mer
  意为部分。所以，polymer的直接翻译是许多部分。Polymer在现代科学用法中，通常指一个由许多相同类型的重复单元或部分组成的大型分子。在中文中，我们把polymer翻译为聚合物。
sidebar:
  hidden: true
