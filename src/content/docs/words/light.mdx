---
title: Light
description: 单词'light'既是名词，也是形容词，甚至可用作动词。其基本含义可以归纳为以下几种：
sidebar:
  hidden: true
...
<Pronunciation word="Light" uk="/laɪt/" us="[ɫɐɪ̯ʔ]" client:only />

### 列举例句

1.  他打开了灯，*照亮*了房间。 (He turned on the _light_ and illuminated the room.)
2.  这个包非常*轻*，我能一个人搬。 (This bag is very _light_, and I can carry it by myself.)
3.  他*点燃*了篝火。 (He _lit_ the bonfire.)
