---
title: Innocent
description: Innocent 是一个英文单词，一般情况下，它是形容词，用来形容一个人或行为无罪、纯洁的，或者没有经验的，不了解世故的。
sidebar:
  hidden: true
...
<Pronunciation word="Innocent" uk="/ˈɪnəsn̩t/" us="/ˈɪnəsn̩t/" client:only />
...
"Innocent"这个词在英语中的使用可以追溯到 14 世纪。早期的使用主要是在宗教领域，用来指称那些无罪或无辜的人。这个词的较新的含义是指“无害的”或者“不具有经验、天真的”。
...
<WordRelations
  synonyms={["guiltless", "sackless", "pure", "untainted"]}
  antonyms={["guilty", "nocent", "perverse"]}
  client:only
/>
