---
title: Despair
description: Despair 是个名词，表示一种失去希望、绝望的情绪或状态。当用作动词时，'despair' 表示对事物感到绝望。
sidebar:
  hidden: true
...
<Pronunciation word="Despair" uk="/dɪˈspɛə(ɹ)/" us="/dɪˈspɛəɹ/" client:only />
...
"Despair"这个词来自于 14 世纪的意大利文，原为"disperare"，意为失去所有的希望，“-sperare”是源于拉丁语的"sperare"，意为"希望"。
