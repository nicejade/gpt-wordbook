...
title: Concept
description: >-
  Concept是一个名词，意思是'概念'、'观念'，指的是抽象的、非具象的意念或者理解。它可以被用来表达一个特定的思想，抽象的想法，或者对某一件事物的理解和认识。
sidebar:
  hidden: true
...
<Pronunciation word="Concept" uk="/ˈkɒn.sɛpt/" us="/ˈkɒn.sɛpt/" client:only />
...
可以将 concept 和接近的词"conceive"联想在一起，"conceive"意为"构想"，与 concept 的意思"概念"有着内在联系。
...
<WordRelations synonyms={["abstraction", "conception", "notion"]} client:only />
