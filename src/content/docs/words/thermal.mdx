---
title: Thermal
description: Thermal源于拉丁语'therm'，意为'热的'或'热量的'，常用来描述与热量或温度有关的东西。
sidebar:
  hidden: true
...
<Pronunciation word="Thermal" uk="/ˈθɝməl/" us="/ˈθɝməl/" client:only />
...
"Thermal"这个单词源自 19 世纪中叶，专指与热有关的科学现象。例如，19 世纪角热力学在科学领域的兴起，从而产生了"thermal"等与热量相关的词汇。
