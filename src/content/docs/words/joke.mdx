---
title: Joke
description: Joke是一个英语单词，用作名词时意思是“笑话，玩笑”，用作动词时意思是'开玩笑，戏谑'。当描述某件事情是'joke'时，也可以表示它很荒谬，不值一提。
sidebar:
  hidden: true
...
<Pronunciation word="Joke" uk="/dʒəʊk/" us="/dʒoʊk/" client:only />
...
"Joke"和"poke"发音相近（皆为-o·ke 结尾），可以联系"poke fun at"这个短语来记忆"joke"，"poke fun at"意为"取笑，戏谑"，与"joke"的意思相当。
