---
title: Least
description: 英语单词'least'一般用作形容词或副词。作为形容词时，表示'最小的'或'最不重要的'。作为副词时，表示'最少地'，它是 'less' 的最高级。
sidebar:
  hidden: true
...
<Pronunciation word="Least" uk="/list/" us="/list/" client:only />
...
<WordRelations antonyms={["most"]} client:only />
