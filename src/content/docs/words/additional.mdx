---
title: Additional
description: Additional 是一个形容词，它的意思是额外的，附加的。它通常用来描述除了已经存在的、已经提供的或已经固定的事情之外，还有的或需要的事物。
sidebar:
  hidden: true
...
"Additional" 这个单词在 14 世纪的英语中首次出现，最初是用来描述数学中的加法概念。随后，它的含义扩展到日常生活中，用来描述任何形式的增加或附加。
