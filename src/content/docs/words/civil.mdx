---
title: Civil
description: Civil 是一个形容词，用来描述与公民，公共事件或者国家有关的事情。也可以用来描绘礼貌或者文明的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Civil" uk="/ˈsɪv.əl/" us="/ˈsɪv.əl/" client:only />
...
<WordRelations
  antonyms={["impolite", "inconsiderate", "noncivil", "rude"]}
  client:only
/>
