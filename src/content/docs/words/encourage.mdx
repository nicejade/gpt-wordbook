---
title: Encourage
description: Encourage 是一个动词，意思是“鼓励、促进”。你可以使用这个词来描述激发某人去做某事或持续做下去，并给与支持和勇气。
sidebar:
  hidden: true
...
<Pronunciation word="Encourage" uk="/ɪnˈkʌɹɪdʒ/" us="/ɪnˈkɝɹɪdʒ/" client:only />
...
"Encourage"一词源自于 14 世纪的法语，原意为"使有勇气"。它体现了鼓励他人、培养勇气的重要性。
...
可以联想"encourage"与带有前缀"en-"的其他单词，如：enable、enrich、ensure 等，它们都有一种"使..."的意思。
...
<WordRelations
  synonyms={["bield", "embolden"]}
  antonyms={["becourage", "discourage"]}
  client:only
/>
