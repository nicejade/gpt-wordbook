---
title: Mate
description: Mate 有多种含义，可以作为名词或者动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Mate" uk="/meɪt/" us="/meɪt/" client:only />
...
复数形式为 mates。作为动词时，过去式和过去分词均为 mated, 现在分词为 mating。
...
<WordRelations
  synonyms={["buddy","fellow","friend","partner","sir","couple","match","pair"]}
  antonyms={[]}
  client:only
/>
