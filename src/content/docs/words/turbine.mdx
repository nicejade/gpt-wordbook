---
title: Turbine
description: turbine 是一个名词，通常指的是带有叶片的旋转机械设备，能够将流体包括压缩空气、蒸汽、水等流体的能量转化为机械能。
sidebar:
  hidden: true
...
<Pronunciation word="Turbine" uk="/ˈtɜ(ɹ)baɪn/" us="/ˈtɜ(ɹ)baɪn/" client:only />
...
"turbine" 这个词源自 19 世纪，初期用于描述各种机械设备，尤其是以涡轮为驱动的蒸气机。这个词在 19 世纪末期和 20 世纪初期，随着蒸汽和电力系统的快速发展，逐渐普及并且广泛用于各种工业环境和动力系统中。
