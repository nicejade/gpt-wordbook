---
title: Shutter
description: Shutter作为名词，常用来指照相机的光圈快门，或者指建筑物的百叶窗。另外，它也可以作为动词，意思是关闭或把商店等封闭起来。
sidebar:
  hidden: true
...
<Pronunciation word="Shutter" uk="/ˈʃʌtɚ/" us="/ˈʃʌtɚ/" client:only />
...
Shutter 源自古英语的'scutan'，意为"to shut"（关闭）。

### 词缀分析

Shutter 本身不包含词缀。但可以结合后缀来构成新词，如"shutterless"，指的是没有快门的。

### 文化背景

"Shutter" 这个词从 14 世纪开始就已经出现在英语中，最初用来指“一块用来遮挡、关闭或保护某物的板子”，之后才扩展成现在多元的含义。
