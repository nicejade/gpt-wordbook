---
title: Fowl
description: fowl 是一个名词，可以指任何种类的鸟，但大部分情况下，主要指的是家禽，如鸡、鸭、火鸡和鹅等。在饮食和烹饪中，'fowl' 通常指食用的肉鸟。
sidebar:
  hidden: true
...
<Pronunciation word="Fowl" uk="/faʊl/" us="/faʊl/" client:only />
...
从前，有一只名叫 Bob 的勇敢的家禽，他的任务是保护农场里所有的家禽免受狐狸的威胁。
