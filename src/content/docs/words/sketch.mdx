---
title: Sketch
description: Sketch通常用作名词或动词。作为名词，它指的是一个粗略的、未完成的绘画或设计。作为动词，它的含义是做一个粗略的、初步的绘画或设计。
sidebar:
  hidden: true
...
<Pronunciation word="Sketch" uk="/skɛtʃ/" us="/skɛtʃ/" client:only />
...
"Sketch"最初的使用可以追溯到 17 世纪初，当时选用这个词来形容浮光掠影的草图或者计划。

### 单词变形

-"Sketch"的动词过去式和过去分词是"sketched"，现在分词是"sketching"。 -有"sketchy"(形容词)表示"不完全的，不详细的"；"sketchiness"(名词)表示"简略，概略"等意思。
