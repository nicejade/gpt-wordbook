---
title: Grumble
description: Grumble 是一个英语动词，意思是抱怨或发牢骚。当某人对某事不满意，但不会公开表示，只是低声表达他们的不满，那么就可以使用 'grumble' 这个词。
sidebar:
  hidden: true
...
<Pronunciation word="Grumble" uk="/ˈɡɹʌmbl̩/" us="/ˈɡɹʌmbl̩/" client:only />
...
"Grumble"这个单词在 16 世纪中叶开始使用，用于描述人们低声发牢骚的动作。它在英美文化中，通常用来形容人们对一些他们不满，但又不能直接改变或控制的事情表示抱怨或不满。
