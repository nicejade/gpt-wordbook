...
title: Biological
description: >-
  Biological 是一个英语形容词，在大部分情况下，它与生物学、生物或生物过程有关。例如，当我们说'biological
  research'（生物学研究）时，我们是在讨论关于生命和生物体的科学研究。
sidebar:
  hidden: true
...
单词"biological"首次出现是在 19 世纪，那时科学在社会中的地位日益重要，对生物学的研究促使了这个单词的产生。
...
<WordRelations synonyms={["biologic"]} client:only />
