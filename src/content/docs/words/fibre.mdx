---
title: Fibre
description: Fibre 是英式英语中的词，美式英语中通常写作 'fiber'。以下是 'fibre' 的释义：
sidebar:
  hidden: true
...
<Pronunciation word="Fibre" uk="/ˈfaɪ.bə(ɹ)/" us="/ˈfaɪ.bə(ɹ)/" client:only />
...
"Fibre" 自 14 世纪以来一直存在，它来自拉丁文的 "fibra"，意为 "线束，纤维，肌纤维"。
