...
title: Calculation
description: >-
  Calculation是个名词，主要有两种含义：第一种是'数学运算或计算过程'，例如我们平时需要做的加减乘除；第二种是'精心的策划或考虑'，表示事先的规划和谋划。例如，他们的决定是基于复杂的计算的。
sidebar:
  hidden: true
...
<WordRelations
  synonyms={["sum","evaluation","reckoning","estimate","guess","measurement"]}
  client:only
/>
