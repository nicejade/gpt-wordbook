---
title: Undoubtedly
description: Undoubtedly 是一个副词，意思是“无疑地，肯定地”，表示的是一种确定无疑，没有异议的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Undoubtedly" uk="/ʌnˈdaʊtɪdli/" us="/ʌnˈdaʊtɪdli/" client:only />
...
"un-", "-ed", "-ly"为词缀，其他带有这些词缀的单词如 uncertain(不确定的)，talked(谈论过的)，quietly(安静地)等。
...
把"Undoubtedly"分解成"un-"、"doubt"和"-edly"，un-代表否定，doubt 是“怀疑”，-edly 表示状态，所以组合起来就是 “没有疑虑的状态”，即“确信无疑”。
...
<WordRelations
  synonyms={["doubtlessly","indubitably","undoubtably","unquestionably"]}
  client:only
/>
