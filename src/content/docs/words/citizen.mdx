...
<WordRelations
  synonyms={["freeman","comrade","national","denizen","inhabitant","local","native","occupant","resident","townsman","townswoman"]}
  antonyms={["peasant","villager","alien","foreigner","illegal","outsider","stranger"]}
  client:only
/>
