---
title: disservice
description: 单词分析 Disservice 是一个名词，主要的含义是 损害，在很多情况下，这是讲述对某个人或物的不好的影响或者是拙劣的服务。
sidebar:
  hidden: true
...
“Disservice”一词在 16 世纪首次出现在英语中，由“dis-”（表示否定或反对）和“service”（服务）组合而成。这个词在英语中表达了一种负面的服务或对他人的不负责任。
