...
title: Center
description: >-
  Center 这个英文单词一般是指位于事物中心的，也可指中心点、中心位置等，既可以做名词也可以做动词。例如：City center
  (城市中心)，Center of gravity (重心).
sidebar:
  hidden: true
...
<Pronunciation word="Center" uk="/ˈsɛn.tə(ɹ)/" us="/ˈsɛn.tə(ɹ)/" client:only />
...
"Center"在 14 世纪从法语传入英语，并保持了法语和原始拉丁语中的意思。在美国，它通常拼写为 "center"，而在英国，它通常拼写为 "centre"。
...
<WordRelations
  synonyms={["middle", "midst", "centroid", "midpoint", "central"]}
  antonyms={["periphery"]}
  client:only
/>
