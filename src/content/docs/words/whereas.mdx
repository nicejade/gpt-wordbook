---
title: Whereas
description: Whereas 是一个连词，主要作用是为了引出表示对比或相异意义的句子。在正式写作或讲演中经常使用，表示'而，反之，尽管'等概念。
sidebar:
  hidden: true
...
<Pronunciation word="Whereas" uk="/weəɹˈæz/" us="/(h)wɛɹˈæz/" client:only />
...
"Whereas"在英语中的用法源于古英语，最早的文本记载可追溯到 14 世纪。那时，"whereas"是用来作条件从句，意为"鉴于；由于"。到了现代英语中，"whereas"的用法逐渐转变，常常用于对比句，表示"然而，反之"的含义。
