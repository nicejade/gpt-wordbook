...
title: Road
description: >-
  Road是一个名词，一般用来指任何连接两点的公共或私人路径或通道，也可以借指生活或事业的道路。它的一些同义词包括'way', 'route',
  'pathway'等。
sidebar:
  hidden: true
...
<Pronunciation word="Road" uk="/ɹəʊd/" us="/ɹoʊd/" client:only />
...
<WordRelations synonyms={["away"]} client:only />
