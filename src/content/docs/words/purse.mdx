...
description: >-
  Purse
  是一个英文名词，主要用来指女士们用来装钱和一些小物件的小包，也就是我们通常说的“钱包”。而在英式英语中，它还具有'钱袋'的意思。此外，“Purse”也可作为动词使用，意思是“撅起”，主要用来描述嘴唇撅起的动作。
sidebar:
  hidden: true
...
<Pronunciation word="Purse" uk="/pɜːs/" us="/pɝs/" client:only />
...
<WordRelations
  synonyms={["bursary", "grant", "pocketbook", "handbag", "pucker"]}
  client:only
/>
