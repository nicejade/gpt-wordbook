---
title: Remark
description: Remark 是一个英语单词，可作为名词或动词使用。作为名词，意为“评论”、“评述”或“观察”，作为动词则有“评论”或“注意到”的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Remark" uk="/ɹɪˈmɑːk/" us="/ɹɪˈmɑɹk/" client:only />
...
"Remark"的前缀是"re-"，后缀无特定含义。其他含有"re-"前缀的单词有：reconsider, refine, rebuild 等。

### 文化背景

"Remark"这个单词来自于 14 世纪的法语"remarkier"，意思是“注意到”或“观察”。它的使用在语言中已经相当常见，并没有因时间的变化而产生太大的变化。
