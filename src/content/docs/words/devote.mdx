...
title: Devote
description: >-
  Devote 是一个动词，意思是 '献身于' 或 '致力于'。当你把时间、精力或资源给出去，以专心致志于一个目标或计划时，你就在 'devote'
  yourself。
sidebar:
  hidden: true
...
<Pronunciation word="Devote" uk="/dɪˈvəʊt/" us="/dɪˈvoʊt/" client:only />
...
从这个词根衍生出来的其他单词包括：devotion, devotee, devoted 等。
...
"Devote" 是一个拉丁词，源自 "devovere"，意思是 "promise solemnly"。这个词在 14 世纪传入英语，现在我们用它来表示投入时间和精力去做某事。
