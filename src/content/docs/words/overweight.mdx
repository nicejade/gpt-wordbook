---
title: Overweight
description: Overweight是一个形容词，用于形容人或动物体重超重，比标准体重要重。此外，'overweight'也可以作为名词使用，意为'超重'。
sidebar:
  hidden: true
...
"Overweight"是由词前缀 over- 和 root word weight 组成。over-是超过或过度的意思，而 weight 是体重的意思。所以 overweight 的字面意思就是超过正常体重。
...
"Overweight"这个单词首次出现在 14 世纪末，最初是指“过重的货物”，关心人的体重则主要是近期健康观念的改变，所以这个词在描述人体重上的使用则晚了很多。
...
<WordRelations
  synonyms={["fat","obese","overnourished"]}
  antonyms={["underweight"]}
  client:only
/>
