---
title: Clean
description: Clean这个单词，其基本意思是“清洁的，干净的”。它不仅可以描述物体、地方的清洁状态，也可以用来描述行为、动作的纯洁、诚实。
sidebar:
  hidden: true
...
<Pronunciation word="Clean" uk="/kliːn/" us="/klin/" client:only />
...
- 单数：clean
- 复数：cleans（当 clean 用作动词时，它的三单形式是 cleans）
- 动词：clean（清洗）
- 形容词：clean（干净的）
- 副词：cleanly（干净地）
