---
title: Liberty
description: "Liberty是一个名词，主要意思是'自由';包括个人的,政治的或者社会的自由。它代表不受制约、控制或者压迫的状态。"
sidebar:
  hidden: true
...
<Pronunciation word="Liberty" uk="/ˈlɪbɚti/" us="/ˈlɪbɚti/" client:only />
...
<WordRelations synonyms={["freedom"]} client:only />
