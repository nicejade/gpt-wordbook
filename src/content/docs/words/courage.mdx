---
title: Courage
description: Courage 是一个名词，通常指的是面对危险或困难时所表现出的勇气或者决心。
sidebar:
  hidden: true
...
<Pronunciation word="Courage" uk="/ˈkʌɹɪdʒ/" us="/ˈkɝɹɪdʒ/" client:only />
...
“Courage” 这个单词在 12 世纪晚期最早从法文中被引进到英文中, 从法文 "corage"， 意为"心，内在质量"。在欧美文化中，勇气被视为最重要和最尊敬的一种品格，代表正直和力量。
