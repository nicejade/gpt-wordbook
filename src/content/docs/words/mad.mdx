---
title: Mad
description: Mad 是一个形容词，主要有两个意思：一是指人'疯狂的'，'失去理智的'；二是表示'生气的'，'愤怒的'。
sidebar:
  hidden: true
...
<Pronunciation word="Mad" uk="/ˈmæːd/" us="/ˈmæd/" client:only />
...
<WordRelations
  synonyms={["hella", "helluv", "kinda", "mighty", "wicked"]}
  client:only
/>
