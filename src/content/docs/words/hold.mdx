...
title: Hold
description: >-
  hold 是一个常见的单词，在英语中主要用作动词，它的基本含义是抓住或握住。此外，'hold' 还可以用来表示拥有，支撑，容纳或者维持某种状态。例如，你可以
  hold 一个笔记本(computer)，hold 一项观点(view)，或者 hold 一场会议(meeting)。
sidebar:
  hidden: true
...
"hold" 是一个常见的单词，在英语中主要用作动词，它的基本含义是抓住或握住。此外，"hold" 还可以用来表示拥有，支撑，容纳或者维持某种状态。例如，你可以 hold 一个笔记本(computer)，hold 一项观点(view)，或者 hold 一场会议(meeting)。

<Pronunciation word="Hold" uk="/həʊld/" us="/hoʊld/" client:only />
...
“hold” 不直接带有词缀。但是，在许多 derived words 中，你会看到与 “hold” 相关的词缀，例如 "-hold"在 “household”（家庭）中，表示具有、维持或控制的意思。
