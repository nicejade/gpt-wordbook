---
title: Malicious
description: Malicious是一个形容词，意思是有恶意的，恶毒的，通常用于描述人的行为或者期待给他人带来疼痛，不便或伤害的情绪。
sidebar:
  hidden: true
...
<Pronunciation word="Malicious" uk="/məˈlɪʃəs/" us="/məˈlɪʃəs/" client:only />
...
<WordRelations synonyms={["evil", "malevolent"]} client:only />
