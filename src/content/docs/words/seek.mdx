---
title: Seek
description: Seek是动词，意为寻找，探求。这个词经常用于描述寻找物质或抽象的东西，比如知识、真理、答案等。
sidebar:
  hidden: true
...
<Pronunciation word="Seek" uk="/siːk/" us="/siːk/" client:only />
...
“Seek”是一个非常古老的词，源自古代日尔曼语，可以追溯到公元前 1100 年左右。
...
<WordRelations synonyms={["scrub", "search"]} client:only />
