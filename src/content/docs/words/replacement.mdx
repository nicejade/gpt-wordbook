...
title: Replacement
description: >-
  "Replacement"是一个名词，来自动词"replace"。它主要有两个含义： 1.
  指替换，代替，或换人，换物。这个词通常用于描述把一样东西放在别的东西的原位置或取代别的人或物的行为。 2. 这个词也可以用来形容被替换或取代的人或物。
sidebar:
  hidden: true
...
这个词首次出现在 16 世纪，源自拉丁词"re-"（again，再次）和"placere"（满意）。而被作为"代替或更换某物"的意思使用则始于 17 世纪初。
