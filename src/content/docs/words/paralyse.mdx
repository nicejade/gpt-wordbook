---
title: paralyse
description: Paralyse（美语拼法：Paralyze）是一个动词，意为“使瘫痪”，常用于描述因疾病、受伤或极度恐惧而导致身体部分或全身不能动的状态。
sidebar:
  hidden: true
...
"Paralyse"这个词来自于"paralysis", 该词最早可以追溯到 16 世纪的医学文献中，描述的是由于神经损伤导致的肌肉无法运动的状态。
