---
title: Waitress
description: Waitress 是一个英文单词，代表一个女性的餐厅服务员。它指的是在饭店、酒楼、咖啡馆等场所中，负责接待顾客、点餐和送餐等工作的女性员工。
sidebar:
  hidden: true
...
"Waitress" 这个词在英语中最早出现在 1703 年，作为 "waitor" 的女性形式（"waitor" 现在已经不再使用，已经被 "waiter" 取代）。在美国，尤其是在小城镇，餐厅的男女服务员向顾客提供服务是非常普遍的现象。
