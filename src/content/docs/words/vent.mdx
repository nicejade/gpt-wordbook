...
title: Vent
description: >-
  Vent是一个英语单词，既可以做动词，也可以作名词使用。作名词时，'vent'常表示出口、通道，特别的，在动物生理学中，它也用于指代动物的雷管或呼吸孔。而当'vent'作为动词使用时，这个词最常见的意思是释放、发泄，特指情绪或能量的外放。
sidebar:
  hidden: true
...
<Pronunciation word="Vent" uk="/vɛnt/" us="/vɛnt/" client:only />
