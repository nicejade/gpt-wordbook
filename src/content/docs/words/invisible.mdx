---
title: Invisible
description: Invisible是一个形容词，意思是看不见的，无形的。通常用于形容我们用裸眼看不见的东西，或者形容某些抽象的概念。
sidebar:
  hidden: true
...
"Invisible"这个词在 14 世纪的拉丁文中首次出现，由"in-"（不是）和"visibilis" （可以看见的）组成，字面意思是"不能看见的"。
