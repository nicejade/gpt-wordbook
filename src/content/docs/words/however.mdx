---
title: However
description: However 是一个副词，通常用于表示转折，相当于中文中的“然而”或者“不过”。它还可以用作连接词，连接两个句子。
sidebar:
  hidden: true
...
<Pronunciation word="However" uk="/hɑʊˈɛvə/" us="/haʊˈɛvɚ/" client:only />
...
<WordRelations
  synonyms={["how","anyhow","howso","howsoever","anyway","nonetheless","notwithstanding"]}
  client:only
/>
