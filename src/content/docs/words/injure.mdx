---
title: Injure
description: Injure 是一个动词，表示“伤害”、“损害”，常常用于描述对身体或感情上的伤害。它可以用来形容对身体的物理伤害，也可以用于描述精神或情感上的伤害。
sidebar:
  hidden: true
...
<Pronunciation word="Injure" uk="/ˈɪndʒə/" us="/ˈɪndʒɚ/" client:only />
...
"Injure" 这个词在 14 世纪从法语进入英语，最初的意思是“对…施加不公正的待遇或者破坏法律权利”。
...
<WordRelations
  synonyms={["damage", "disfigure", "harm", "hurt", "impair", "mar", "wound"]}
