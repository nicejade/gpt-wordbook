---
title: Leopard
description: Leopard 是一种大型猫科动物，它们生活在非洲和亚洲的一些森林和草地里。'Leopard' 在中文中的意思是“豹”。
sidebar:
  hidden: true
...
<Pronunciation word="Leopard" uk="/ˈlɛpəd/" us="/ˈlɛpɚd/" client:only />
...
<WordRelations synonyms={["pard", "pardal"]} client:only />
