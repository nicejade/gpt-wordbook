---
title: Boom
description: Boom一词最常见的意思是“轰隆声”或者“繁荣、飞速发展”。它既可以表示物理上的一种声音，也可以用于描述某事物的迅速发展或者繁荣。
sidebar:
  hidden: true
...
<Pronunciation word="Boom" uk="/buːm/" us="/buːm/" client:only />
...
这个词最初作为表示棒、杆或桁的意思，在 14 世纪从荷兰语和中低德语引进英语。后来从物理上的声音扩展到象征性的意思，用于描述事物迅速增长或繁荣。
