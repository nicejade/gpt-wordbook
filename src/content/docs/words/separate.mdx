...
title: Separate
description: >-
  Separate 是一个英语单词，根据上下文，它可以作为动词或形容词。作为动词，'separate'
  意思是'使分开'或'隔开'。作为形容词，'separate' 意思是'独立的'或'单独的'。
sidebar:
  hidden: true
...
<Pronunciation word="Separate" uk="/ˈsɛpəɹət/" us="/ˈsɛpəɹət/" client:only />
...
<WordRelations
  synonyms={["partition", "split", "disintegrate", "earmark", "sepose"]}
  antonyms={["annex", "combine"]}
  client:only
/>
