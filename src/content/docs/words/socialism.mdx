...
description: >-
  Socialism
  是一个名词，它指的是一种政治和经济理论，其中生产资料（如工厂和机器）由社会全体（通常通过政府）拥有和管理。社会主义主张生产力的公共所有权和按劳分配。
sidebar:
  hidden: true
...
<Pronunciation word="Socialism" uk="/ˈsəʊʃəlɪzəm/" us="/ˈsəʊʃəlɪzəm/" client:only />
...
术语'Socialism' 最早在 19 世纪欧洲出现，起初表示社会改革的活动。20 世纪，社会主义政治理念和政权在世界范围内扩展开来。
