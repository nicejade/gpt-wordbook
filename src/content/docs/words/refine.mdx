...
title: Refine
description: >-
  Refine 表示“精炼、提炼、改善”。它常常用于描述改进过程，如提高某个技巧、改进方法或改善生产过程。 **实例** 1. We need to
  refine our strategy to succeed. 我们需要提炼我们的策略以取得成功。 2. He refined his painting
  technique over the years. 他从岁月 \[通过岁月\] 精炼了他的绘画技巧。 3. The oil is refined
  before it can be used as fuel. 石油在被用作燃料之前需要被提炼。
sidebar:
  hidden: true
...
Refine 你可以理解为 re(再)+fine(好)==> 变得再好一点==>精炼。
