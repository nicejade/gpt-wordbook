...
title: Enclose
description: >-
  Enclose 是一个动词，表达的意思是围绕住，环绕，把……装入信封内等概念。例子如'Please enclose a copy of your
  resume with your application'（请在你的申请材料中附带你的简历）。
sidebar:
  hidden: true
...
<Pronunciation word="Enclose" uk="/ənˈkloʊz/" us="/ənˈkloʊz/" client:only />
...
<WordRelations
  synonyms={["encastellate", "fortify", "incastellate"]}
  client:only
/>
