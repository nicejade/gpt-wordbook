---
title: Science
description: Science 是一个名词，主要指的是自然和社会现象的系统性研究，包括对这些现象进行观察、解释和预测的过程。
sidebar:
  hidden: true
...
<Pronunciation word="Science" uk="/ˈsaɪəns/" us="/ˈsaɪəns/" client:only />
...
<WordRelations synonyms={["sci", "sci."]} client:only />
