---
title: Cake
description: Cake是一个名词，主要用来表示'蛋糕'。它既可以指代由糖、鸡蛋、面粉、牛奶等制成后烤制而成的一种甜品，也可以借代生日、婚礼等庆祝场合的主题食品。
sidebar:
  hidden: true
...
<Pronunciation word="Cake" uk="/keɪk/" us="/keɪk/" client:only />
...
<WordRelations synonyms={["block", "gâteau", "crust", "encrust"]} client:only />
