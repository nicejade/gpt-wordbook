...
title: Tour
description: >-
  "Tour" 是一个名词，也可作为动词使用。作为名词，"tour" 常用来指导游，游览，参观，例如一次旅行或一系列活动。作为动词，"tour"
  用以描述进行旅行或访问的行为。 **例如：** 1. He's gone on a tour of Europe. (他正在进行一次欧洲之旅。) 2.
  Educational tours are being held weekly. (每周都会举行教育参观活动。) 3. I'm planning to
  tour Asia next year. (我计划明年游览亚洲。)
sidebar:
  hidden: true
...
这个词在 14 世纪进入英语，早期与韵律诗有关，在 16 世纪进入旅游词汇。
