---
title: Commission
description: "- 'Commission' 是一个名词，也可以作为动词使用。作为名词，它通常有三个主要含义："
sidebar:
  hidden: true
...
<Pronunciation word="Commission" uk="/kəˈmɪʃən/" us="/kəˈmɪʃən/" client:only />

### 列举例句

- 作为名词使用:

  1.  He earned a 20% commission on all merchandise he sold. (他销售的所有商品，他都可以获得 20%的佣金。)
...
<WordRelations synonyms={["committee"]} antonyms={["omission"]} client:only />
