...
description: >-
  Imaginary
  的中文翻译是“虚构的，想象的”。当你说某事是“imaginary”，相当于说它并不存在于现实中，而只是在想象或创作中存在。例如：Imaginary
  friend 指的是一些小孩子中，那些他们自称拥有但实际上并不真实的“朋友”。
sidebar:
  hidden: true
...
<Pronunciation word="Imaginary" uk="/ɪˈmædʒɪn(ə)ɹi/" us="/ɪˈmædʒɪˌnɛɹi/" client:only />

### 列举例句

1.  She has an imaginary friend named Bob. (她有一个叫 Bob 的想象中的朋友。)
...
“Imaginary”一词自 14 世纪末就开始在英文中使用，用以描述那些存在于想象中的事物，比如虚构的故事、地方、或者人物。
