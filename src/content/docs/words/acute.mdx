---
title: Acute
description: Acute 在英文中的含义可能因上下文而变化，但大体上有以下几种解释：
sidebar:
  hidden: true
...
<Pronunciation word="Acute" uk="/əˈkjuːt/" us="/əˈkjut/" client:only />
...
"Acute"源自中世纪拉丁语的"acutus"，其基础词根"acus"（needle 尖针）涵义为“尖锐的”。此词在中世纪拉丁语中被广泛用于音乐方面，指高音。
...
<WordRelations
  synonyms={["emergent","pressing","sudden","fast","rapid","keen","powerful","strong"]}
  antonyms={["grave","chronic","dull","obtuse","slow","witless","leisurely"]}
  client:only
/>
