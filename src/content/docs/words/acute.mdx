---
title: "acute"
description: "Acute 在英文中的含义可能因上下文而变化，但大体上有以下几种解释： 1. （病症）急性的，迅速发展并变得严重的（病症）：如 an acute appendicitis（急性阑尾炎）。 2. （感觉或技能）敏锐的，强烈的： 如 an acute sense of smell（敏锐的嗅觉）。 3. （角度）锐角的。"
---
