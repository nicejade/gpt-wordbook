...
title: Artery
description: >-
  Artery这个单词在医学上通常用于描述将含氧血从心脏输送到身体其他部位的血管。它也有一个比喻的含义，比如，交通要道或者主要路径，这样的含义是从'artery'作为“主要的传输途径”的核心概念衍生出来的。
sidebar:
  hidden: true
...
<Pronunciation word="Artery" uk="/ˈɑː.tə.ɹi/" us="/ˈɑɹ.təɹɪ/" client:only />
...
这个单词最初出现在 14 世纪的医学文献中，用于描述主要的血管系统。在现代英语中，它也形象地描述了任何主要的传输方式或通道，如 "an artery of commerce" 用于形容商业中的主要路线。
