...
description: >-
  Circumference
  是一个英语名词，它指的是圆或者其他二维形状的周长，也可指周边或者边缘。在更广泛的意义上，它也可用来形容像边界线一样围绕周边的事物。
sidebar:
  hidden: true
...
"Circumference" 在 14 世纪时就被以数学和地理的语境使用来形容某物体的尺寸或者范围。
...
Jack 家后院有一个池塘。有一天，他决定计算一下池塘的周长。于是，他取出他的卷尺，仔细地测量了池塘的周长。然后他用直径乘以圆周率得出了池塘的周长。

<WordRelations
  synonyms={["perimeter", "umstroke", "girth", "lap"]}
  client:only
/>
