---
title: Explain
description: Explain是一个动词，中文翻译是“解释”。一般用来指明确地阐述某个概念、想法、行为的含义或原因。
sidebar:
  hidden: true
...
<Pronunciation word="Explain" uk="/ɛkˈspleɪn/" us="/ɛkˈspleɪn/" client:only />
...
<WordRelations synonyms={["elaborate", "expound", "recce"]} client:only />
