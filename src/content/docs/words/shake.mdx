...
description: >-
  Shake
  是一个非常常用的英语词汇，主要有两种含义。第一种是作为动词，表示“摇动”或“挥舞”，用于描述物体的快速且短暂地来回移动。第二种是作为名词，表示“摇动”的动作，或者是一种流行的冷饮（milk
  shake）。
sidebar:
  hidden: true
...
<Pronunciation word="Shake" uk="/ˈʃeɪk/" us="/ˈʃeɪk/" client:only />
...
<WordRelations synonyms={["shiver", "tremble", "traumatize"]} client:only />
