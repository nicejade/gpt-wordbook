---
title: Correctly
description: Correctly 是一个副词，意为“正确地”或“准确地”，用于修饰动词，表示出行动的方式或意图。
sidebar:
  hidden: true
...
<Pronunciation word="Correctly" uk="/kəˈɹɛktli/" us="/kəˈɹɛktli/" client:only />
...
<WordRelations
  synonyms={["accurately", "exactly", "precisely"]}
