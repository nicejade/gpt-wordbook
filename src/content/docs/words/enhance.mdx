---
title: Enhance
description: Enhance是一个英语动词，意味着提高，增强，加强，强化，也可以翻译为'提升'、'改进'。通常用于描述对某物质量、条件或效果的提升。
sidebar:
  hidden: true
...
<Pronunciation word="Enhance" uk="/ɪnˈhɑːns/" us="/ɪnˈhæns/" client:only />
...
"Enhance"这个词最初源于法语"enhancer"，意为"提升"或"增大"。在英语中，最早的记录用法可以追溯到 14 世纪。
...
<WordRelations synonyms={["heighten"]} client:only />
