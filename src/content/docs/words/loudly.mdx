---
title: Loudly
description: Loudly 是一个副词，描述一个动作是以大声的方式进行的。即在中文中的意思是“大声地，响亮地”。
sidebar:
  hidden: true
...
<Pronunciation word="Loudly" uk="/ˈlaʊdli/" us="/ˈlaʊdli/" client:only />
...
<WordRelations synonyms={["loud"]} antonyms={["quietly"]} client:only />
