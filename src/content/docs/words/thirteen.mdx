---
title: Thirteen
description: Thirteen指的是数学计数里的 13。它用于表示十二和十四之间的数。
sidebar:
  hidden: true
...
"Thirteen"指的是数学计数里的 13。它用于表示十二和十四之间的数。

<Pronunciation word="Thirteen" uk="/ˌθɜːˈtiːn/" us="/ˈθɜɹ.tin/" client:only />

### 列举例句

1.  There are thirteen books on the shelf. (书架上有十三本书。)
2.  I will meet you at thirteen o'clock. (我会在十三点见你。)
3.  She turned thirteen last week. (她上周刚过 13 岁生日。)
...
"Thirteen"源于古英语"þreotene"，它可以追溯到公元前 6 世纪的印欧语系。在西方文化中，"Thirteen"在一些情况下被认为是不吉利的数字，如 13 号和星期五。
...
<WordRelations synonyms={["throtteen"]} client:only />
