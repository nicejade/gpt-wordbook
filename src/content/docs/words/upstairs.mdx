...
title: Upstairs
description: >-
  Upstairs是一个形容词、副词或名词，常指向上，或者大楼、房子的上面的部分。当作形容词或副词使用时，可以描述动作的方向（例如，去楼上），或者描述某事或某人在楼上。当做名词使用时，表明楼上的区域。
sidebar:
  hidden: true
...
<Pronunciation word="Upstairs" uk="/ˈʌpˌstɛəz/" us="/ˈʌpˌstɛɹz/" client:only />
...
<WordRelations antonyms={["downstairs"]} client:only />
