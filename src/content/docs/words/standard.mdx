---
title: Standard
description: Standard 是英语中的一个词汇，可以作为名词，形容词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Standard" uk="/ˈstændəd/" us="/ˈstændəɹd/" client:only />
...
"Standard"源自于古法语的"estendre"，进而发展成中古英语的 stand，原意是更高的立场或水平。
...
词汇"standard"大约在 12 世纪左右开始在英语中使用，最早的意思并不是我们现在理解的 "标准" 而是 "旗帜，国旗"。在之后的语言发展中，它的引申意义逐渐丰富，包括"理想"，最后发展为 "标准" 的含义。
...
<WordRelations antonyms={["nonstandard"]} client:only />
