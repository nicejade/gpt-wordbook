---
title: Conduct
description: Conduct 是一种十分常用的词，通常以名词的形式出现，表示行为方式、具体举止，或者以动词的形式出现，表示引导、指挥、管理等概念。
sidebar:
  hidden: true
...
<Pronunciation word="Conduct" uk="/kənˈdʌkt/" us="/ˈkɒndʌkt/" client:only />
...
"Conduct" 在 14 世纪来源于拉丁语"conductus"，原意为"引领，引导"。
...
<WordRelations
  synonyms={["control","guidance","management","bearing","behavior","behaviour","demeanor","demeanour","action","plot","storyline","direct","lead","manage","run","supervise","accompany"]}
  client:only
/>
