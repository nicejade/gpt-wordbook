---
title: Shrub
description: Shrub 是一种对于低矮且多分枝的植物的称呼，主要指其茎木质化，在英国有时也用来表示'灌木丛'。中文里我们通常会翻译为'灌木'。
sidebar:
  hidden: true
...
<Pronunciation word="Shrub" uk="/ʃɹʌb/" us="/ʃɹʌb/" client:only />
...
"Shrub"这个单词在 Middle English 时期就已经开始使用，这个词在英美文化中并没有特别的内涵。
...
<WordRelations synonyms={["bush"]} client:only />
