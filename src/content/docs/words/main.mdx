...
title: Main
description: >-
  Main 是一个英语单词，在汉语中，可以翻译为 '主要的' 或 '最重要的'。例如在句子 'Main ideas' 中，'main' 表示
  '主要的'，整句话就是 '主要的想法'。
sidebar:
  hidden: true
...
<Pronunciation word="Main" uk="/meɪn/" us="/meɪn/" client:only />
...
<WordRelations synonyms={["largest"]} client:only />
