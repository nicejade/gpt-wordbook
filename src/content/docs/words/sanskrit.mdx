---
title: Sanskrit
description: '"Sanskrit"是一种古老的印度语言，主要用于古老的印度经文和哲学著作，包括印度教和佛教的重要新文。直译为“完善的”或“精致的”语言。'
sidebar:
  hidden: true
...
3.  Many Sanskrit words have been adopted into English, like guru, mantra, and yoga. (许多梵文词汇已被英语接纳，如 guru（导师）、mantra（咒语）和 yoga（瑜伽）。)
