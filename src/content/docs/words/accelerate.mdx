...
title: Accelerate
description: >-
  Accelerate是一个英语动词，意味着“使……加快；增速”。这可以引用在许多不同的情境中，包括物理（如使车速加快），生物（如使某种过程加速），或是更抽象的概念（如加速学习或项目进度）。
sidebar:
  hidden: true
...
<Pronunciation word="Accelerate" uk="/æk.ˈsɛl.ə.ˌɹeɪt/" us="/æk.ˈsɛl.ə.ˌɹeɪt/" client:only />
...
"Accelerate"这个词在 15 世纪从拉丁语进入英语，最初只在物理学上使用，比如描述物体的速度加快。随着时间的推移，这个词的使用变得更为广泛，也被用在抽象的概念上，比如加速学习或发展。
...
<WordRelations
  synonyms={["hasten","quicken","advance","forward","expedite","further"]}
