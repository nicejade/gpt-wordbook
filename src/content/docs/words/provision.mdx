...
description: >-
  - `Provision`
  是一个名词，主要含义有两个。一是“供应，提供”，在这种情况下，它通常用于描述食物、设备或者其他供应品的提供。二是“条款，规定”，在这种情况下，它通常用于法律或协议中的特殊条款或规定。
sidebar:
  hidden: true
...
- `Provision` 一词来自于一千多年前的拉丁语，然后在法语中演变，最终在大约 16 世纪时出现在英语中。它的历史和文化背景主要反映了人们对于准备和预定的概念。
...
<WordRelations
  synonyms={["condition", "stipulation", "supply", "victual"]}
  client:only
/>
