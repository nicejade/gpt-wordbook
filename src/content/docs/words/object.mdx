...
description: >-
  Object
  是一个很常用的英语单词，它的基本含义是在空间上可观察到的事物，或抽象的目标、目的。但在不同的语境中，这个单词可能有所不同的含义。例如，作为名词时，'object'的英文含义为'物体'，'目标'等等；当我们把它放在一句话中作为动词使用时，'object'又表示'反对'的意思。
sidebar:
  hidden: true
...
<Pronunciation word="Object" uk="/ˈɒb.d͡ʒɛkt/" us="/ˈɑb.d͡ʒɛkt/" client:only />
...
"Object"来源于拉丁语"objectum"，由 ob- (向前，表示动态)和 jacere (扔，投掷)组成，总的含义是"被投掷出来的东西"。
...
"Object"一词在 14 世纪中叶最早用于法语中，原意为"提出，断言"，在后来的发展中，含义发生了变化，包括"引起反感"和"物体，事物"等。
...
<WordRelations synonyms={["target", "article", "item", "thing"]} client:only />
