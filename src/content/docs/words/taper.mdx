---
title: Taper
description: Taper 是个动词，意思是“逐渐变小或变细”。它通常用于形容物理的形状如发育、长大或者缩小都是逐渐的、连续变化的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Taper" uk="/ˈteɪpə/" us="/ˈteɪpɚ/" client:only />
...
<WordRelations synonyms={["narrow"]} client:only />
