---
title: Trait
description: Trait这个单词在英文中的含义是指个体的特性或特征。可以是人的性格特征，也可以是遗传的物理特性。
sidebar:
  hidden: true
...
<Pronunciation word="Trait" uk="/tɹeɪ/" us="/tɹeɪ/" client:only />
...
<WordRelations synonyms={["characteristic"]} client:only />
