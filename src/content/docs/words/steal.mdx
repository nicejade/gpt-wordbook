---
title: Steal
description: Steal 是一个动词，通常意味着“偷窃”或“盗取”。它可以用在实际的物品偷窃情景，也可以用在比喻意义上比如“窃取某人的想法”或“窃取时间”。
sidebar:
  hidden: true
...
<Pronunciation word="Steal" uk="/stiːl/" us="/stiːl/" client:only />
...
<WordRelations
  synonyms={["bargain", "sneak"]}
  antonyms={["bestow", "donate", "grant", "buy", "earn", "purchase", "receive"]}
  client:only
/>
