...
title: Mechanic
description: >-
  Mechanic 通常有两种含义，一种是机械的，机械性的，另一种是指修理工，尤其是汽车修理工。比如“You can learn a lot about
  how your car works by watching a skilled
  mechanic.”（你可以通过观察熟练的修理工来学习更多关于你的汽车如何运作的知识。）
sidebar:
  hidden: true
...
<Pronunciation word="Mechanic" uk="/məˈkænɪk/" us="/məˈkænɪk/" client:only />
...
"Mechanic" 最早在 14 世纪以 "mekanik" 的形式被用来描绘建造或制造物体的人。在 18 世纪时，这个词开始广泛用于汽车修理工等领域。
