...
title: Soldier
description: >-
  Soldier 一词通常被定义为一个属于一个国家的军队或军事力量的成员，这个词也经常被用来指军人或战士。在更广义的层面上，'soldier'
  还可以用来形容一个在困难和挑战中坚守阵地的人。
sidebar:
  hidden: true
...
<Pronunciation word="Soldier" uk="/ˈsɒld͡ʒə/" us="/ˈsoʊld͡ʒɚ/" client:only />

### 列举例句

1.  He enlisted as a soldier when he turned 18. (他 18 岁时参军成为了一名士兵。)
2.  The city is defended by a garrison of 5,000 soldiers. (这个城市由 5000 名士兵保卫。)
...
<WordRelations
  synonyms={["Tommy", "grunt", "sweat", "goldbrick"]}
  client:only
/>
