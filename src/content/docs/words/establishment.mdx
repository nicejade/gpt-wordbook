...
title: Establishment
description: >-
  Establishment 是一个名词，表示设立，建立；或者指被创建或已经设立的事务、机构或系统。在更广义上，它也被用来表示社会的主流或权威，例如 'the
  Establishment' 这个短语常用来指代控制社会的权威性机构或精英阶层。
sidebar:
  hidden: true
...
"Establishment" 一词在 15 世纪后期出现，来源于法语的 "establissement”，意为“设立、建立”，后逐渐有了权威机构或精英阶层的含义。
...
<WordRelations synonyms={["foundation"]} antonyms={["abolition"]} client:only />
