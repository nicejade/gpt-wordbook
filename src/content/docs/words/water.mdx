---
title: Water
description: Water 是英语单词，表达的是一个常用名词，意思是'水'。
sidebar:
  hidden: true
...
<Pronunciation word="Water" uk="/ˈwɔːtə/" us="/ˈwɔtəɹ/" client:only />
...
<WordRelations
  antonyms={["air","earth","ether","fire","metal","void","wind","wood","ice","steam"]}
  client:only
/>
