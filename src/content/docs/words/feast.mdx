---
title: Feast
description: Feast 是一个英语词汇，它的基本意思是 '大餐' 或 '盛宴'。它可以是名词，也可以用作动词。
sidebar:
  hidden: true
...
<Pronunciation word="Feast" uk="/fiːst/" us="/fiːst/" client:only />
...
<WordRelations synonyms={["banquet"]} client:only />
