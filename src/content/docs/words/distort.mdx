...
title: Distort
description: >-
  Distort是一个动词，其基本含义是扭曲或改变某事物的真实或原始形态，使其不符合事实或真理。这个词可以用在实际和抽象的情境中。例如，镜子可能会'distort'一个人的形象，或者一个人可能会'distort'事实以适应他们的观点。
sidebar:
  hidden: true
...
<Pronunciation word="Distort" uk="/dɪsˈtɔːt/" us="/dɪsˈtɔːt/" client:only />
...
<WordRelations synonyms={["deform"]} client:only />
