...
title: Power
description: >-
  Power 这个词在中文中主要有两个含义，一个是 '权力' 或 '控制能力'，另一个是 '能量' 或 '力量'。比如，'The president has
  the power to veto laws.' ('总统有权否决法律。') ，或者 'This engine has a lot of power.'
  ('这个引擎有很大的动力。')。
sidebar:
  hidden: true
...
<Pronunciation word="Power" uk="/ˈpaʊ.ə(ɹ)/" us="/ˈpaʊ.ɚ/" client:only />
...
词 "power" 在英语中是一个大约在 14 世纪从法语过来的词。它在欧美文化中通常被用来表示个人或集体的能力去控制或影响其他人或事物。
...
<WordRelations antonyms={["impotence", "weakness"]} client:only />
