---
title: "power"
description: "Power 这个词在中文中主要有两个含义，一个是 权力 或 控制能力，另一个是 能量 或 力量。比如，The president has the power to veto laws. (总统有权否决法律。) ，或者 This engine has a lot of power. (这个引擎有很大的动力。)。"
---
