---
title: Red
description: Red是一个英语形容词，也可以当名词使用，主要代表一种颜色，就是我们通常所说的“红色”。
sidebar:
  hidden: true
...
<Pronunciation word="Red" uk="/ɹɛd/" us="/ɹɛd/" client:only />
...
<WordRelations
  synonyms={["blood","brick","cardinal","cherry","coral","crimson","maroon","rose","rosy","ruby","rufous","rust","sanguine"]}
  antonyms={[]}
  client:only
/>
