---
title: Alas
description: Alas' 是一个表示遗憾或者悲伤的感叹词，通常在对一个不幸或者糟糕的事情表示同情时使用。这个词的中文翻译是'唉'或'哎呀
sidebar:
  hidden: true
...
<Pronunciation word="Alas" uk="/ɘˈlɛs/" us="/əˈlæs/" client:only />
...
<WordRelations synonyms={["alack"]} client:only />
