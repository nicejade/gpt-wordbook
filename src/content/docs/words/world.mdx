---
title: World
description: World 是一个常用的英文单词，主要有两个含义。它可以指代地球、宇宙或整个自然界，也可以引申为人类社会、生活的广大舞台。
sidebar:
  hidden: true
...
<Pronunciation word="World" uk="/wɝld/" us="/wɝld/" client:only />
...
<WordRelations synonyms={["planet", "circle", "Earth", "globe"]} client:only />
