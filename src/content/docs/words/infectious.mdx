...
title: Infectious
description: >-
  Infectious 的主要含义是 '传染性的'，指的是疾病或条件可以通过直接或间接接触传播给其他人。更广义上讲，'infectious'
  也可以形容某种情绪或行为，如 'infectious laughter' 指的是一种能够影响并使周围的人也一同开心的笑声。
sidebar:
  hidden: true
...
"Infectious"一词起源于 14 世纪，由拉丁语"infectus"演变而来，最初用于描述物质污染现象，后来逐渐扩大到疾病的传播层面。
...
<WordRelations
  synonyms={["contagious", "catchy", "catching"]}
