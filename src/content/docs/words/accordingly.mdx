---
title: Accordingly
description: Accordingly 是一个副词，其基本意思是“因此”，“所以”，或“相对应地”，常用来指出一件事是基于另一件事的结果或因果关系。
sidebar:
  hidden: true
...
来自于 14 世纪的英语，其中 "accord"来自于法语“accorder”，意为一致，和谐。
...
<WordRelations
  synonyms={["consequently", "hence", "so", "therefore", "wherefore"]}
  client:only
/>
