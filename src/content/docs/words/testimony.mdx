---
title: Testimony
description: Testimony 是一种形式的证明或者证据，一般用于指法庭中作证的陈述或抗辩。
sidebar:
  hidden: true
...
Testimony 的词缀是 "-mony"，一种表示抽象名词的后缀。类似应用的单词有 "harmony"（和谐）, "alimony"（赡养费）等。
...
<WordRelations synonyms={["deposition"]} client:only />
