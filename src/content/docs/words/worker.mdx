---
title: Worker
description: Worker 是一个名词，指的是做工的人，工人，或职员。它是一个非常常用的词，可用于描述在任何行业或职业中从事工作的人。
sidebar:
  hidden: true
...
<Pronunciation word="Worker" uk="/ˈwɜː.kə/" us="/ˈwɝ.kɚ/" client:only />
...
<WordRelations synonyms={["laborer", "labourer"]} client:only />
