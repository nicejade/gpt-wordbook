...
title: Susceptible
description: >-
  "Susceptible"是一个形容词，主要用来描述一个人或物容易受到某种影响或损害的特性。它通常具有以下两个基本含义： 1.
  容易受影响：这种定义通常用于描述生理或心理上的易受影响性。例如，一个"易感"的人可能会很容易感染某种疾病，或者他们的情绪可能很容易受到他人的影响。 2.
  容易受到伤害：这个定义描述的是某人或某物容易阳光、损坏、攻击等有害影响。例如，"易腐的"食物可能会很快变坏；"易损"的项目可能会在运输过程中很容易受到损害。
sidebar:
  hidden: true
