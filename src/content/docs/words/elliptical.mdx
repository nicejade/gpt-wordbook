...
title: Elliptical
description: >-
  "Elliptical" 是一个形容词，有两种基本含义： 1. 指形状或路径是椭圆的，例如：An elliptical orbit（椭圆形轨道）。 2.
  指语言表达方式含糊、晦涩或省略了部分内容的，例如：An elliptical comment（含蓄的评论）。
sidebar:
  hidden: true
...
"Elliptical" 的前缀是 e-, 表示“出，从”，-llipt- 是词根，表示"leave out, fall short”，-ic 是形容词后缀，-al 也是形容词后缀。

### 文化背景

"Elliptical" 最初在 17 世纪作为数学术语出现，用以形容椭圆形的东西。到了 18 世纪，人们开始将其用于形容语言，比如詹姆斯·乔伊斯在《尤利西斯》中使用了椭圆表达方式，其独特的语言风格对 20 世纪的小说有着深远影响。
