---
title: Unhealthy
description: Unhealthy是一个形容词，用来描述不健康、有害健康或不良的。
sidebar:
  hidden: true
...
<Pronunciation word="Unhealthy" uk="/ʌnˈhɛl.θi/" us="/ʌnˈhɛl.θi/" client:only />
...
<WordRelations antonyms={["healthy"]} client:only />
