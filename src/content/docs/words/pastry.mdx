---
title: Pastry
description: Pastry 是一个名词，主要指的是糕点、面点、或者甜点泛指的一种用面粉、黄油、糖等混合制成的小吃。
sidebar:
  hidden: true
...
<Pronunciation word="Pastry" uk="/ˈpeɪstɹi/" us="/ˈpeɪstɹi/" client:only />
...
"Pastry"一词源自 14 世纪的法语的"paste",意为"固体糕饼",由拉丁语“pasta”演变而来。在欧美文化中，Pastry 是一种常见的甜点，丰富多样，如派、酥皮点心等等。
