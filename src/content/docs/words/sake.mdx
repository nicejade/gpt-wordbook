...
title: Sake
description: >-
  Sake 在英文中主要有两种意思。一种是表示'为了......的目的或利益'，例如'For the sake of clarity, let's
  define our terms.'（为了清楚起见，让我们先定义一下我们使用的术语。）另一种常见在日语中，用来指代日本的清酒。
sidebar:
  hidden: true
...
<Pronunciation word="Sake" uk="/seɪk/" us="/seɪk/" client:only />
