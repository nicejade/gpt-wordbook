---
title: Witness
description: Witness的主要意思是作为'见证人'或'作证'，指一个人亲眼目击或亲耳听到的事情，并能对此情况作证。
sidebar:
  hidden: true
...
<Pronunciation word="Witness" uk="/ˈwɪtnəs/" us="/ˈwɪtnəs/" client:only />
...
"Witness"最早在公元前 1000 年的古英语中出现，最初是表示“人的知识或理解”。现在主要的意思是“见证人”或“证据”，并在法律领域广泛使用。

### 单词变形

- 名词形式: witness
- 动词形式: witness, witnessed 或 witnessing
- 形容词形式: witnessable
- 副词形式: witnessably
...
<WordRelations synonyms={["certify"]} client:only />
