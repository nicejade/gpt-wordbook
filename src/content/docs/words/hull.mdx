---
title: Hull
description: Hull 是一个名词和动词，作为名词，主要指船的船体，作为动词，主要指剥去谷物或果实的外壳。
sidebar:
  hidden: true
...
<Pronunciation word="Hull" uk="/hʌl/" us="/hʌl/" client:only />
...
<WordRelations synonyms={["husk", "peel", "shell", "shuck"]} client:only />
