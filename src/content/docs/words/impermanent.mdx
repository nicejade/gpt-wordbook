---
title: Impermanent
description: '"Impermanent"是一个形容词，用来描述某个事物不是永恒的、短暂的、或者暂时的。你可以用它来形容人生的瞬间、感情、计划，或者任何可能改变的事物。'
sidebar:
  hidden: true
...
"Impermanent"这个词首次出现是在 14 世纪。源于拉丁语"impermanens" - "im"（不）+ "permanens"（持续）。在佛教中，"impermanent"是教义的一个重要方面，意指万物都是无常的，这种观念对接受变化以及适应生活中的起落变化有着深刻的影响。
