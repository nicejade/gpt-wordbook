---
title: Harden
description: "1.  'Harden' 主要意思是'变硬', '使坚硬'。例如：The cement had hardened.（水泥已经凝固了。）"
sidebar:
  hidden: true
...
<Pronunciation word="Harden" uk="/ˈhɑːdn̩/" us="/ˈhɑːdn̩/" client:only />
...
<WordRelations synonyms={["inure"]} client:only />
