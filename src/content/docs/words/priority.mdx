---
title: Priority
description: "- 'Priority' 是名词，意为'优先权'，'首要事物'，描述某事或某人在时间、资源、关注等方面比其他事或人更重要。"
sidebar:
  hidden: true
...
- 单词 “Priority” 来源于拉丁语词根 "prior"，在 14 世纪的法语中第一次用来指称法律上的"优先权"，到 20 世纪初，这个词开始广泛用于生活中的各个方面，用以描述重要性的次序。
...
<WordRelations
  synonyms={["dignity", "eminence", "seniority", "superiority"]}
  client:only
/>
