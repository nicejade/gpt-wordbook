---
title: Except
description: Except 是一个预词和连词，主要意思为'除……之外'，强调某个或些元素被排除在外。'Except for' 表示'除……以外，都……'。
sidebar:
  hidden: true
...
<Pronunciation word="Except" uk="/ɪkˈsɛpt/" us="/ɛkˈsɛpt/" client:only />
...
<WordRelations synonyms={["outtake"]} client:only />
