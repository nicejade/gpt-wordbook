...
title: Streak
description: >-
  Streak 是一个英文单词，它的基本含义是连续的一段时间或一系列的事件。例如，“winning streak”意思是“连胜”，“losing
  streak”意思是“连败”。此外，它也能用来形容物体的线状特征，例如，彩虹的七色就可能被形容为'streaks'。
sidebar:
  hidden: true
...
<Pronunciation word="Streak" uk="/stɹiːk/" us="/stɹiːk/" client:only />
