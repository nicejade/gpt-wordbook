...
description: >-
  Segregation
  是英语中的一个名词，常被翻译为“隔离”，“分隔”或“种族隔离”等。这个词描述了一种情况，某些人被无理由地从其他人或者社区中分离出来。最常见的用法是在描述种族，宗教，性别等方面的歧视。
sidebar:
  hidden: true
...
1.  Racial segregation was abolished in the US in the 1960s.（种族隔离在 1960 年代的美国被废止了。）
