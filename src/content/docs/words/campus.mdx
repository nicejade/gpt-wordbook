...
description: >-
  Campus
  是英语中的一个名词，它的主要意思是“校园”，这是在大学或学院中学校建筑和地点的统称。此外，它也可以用于表示公司或机构的场地。例如，'Google's
  campus' 就是指谷歌公司的公司场地。
sidebar:
  hidden: true
...
<Pronunciation word="Campus" uk="/ˈkæmpəs/" us="/ˈkæmpəs/" client:only />
...
校园文化是西方大学里非常重要的一部分，也是西方社会的显著特性之一。词汇"campus"从 17 世纪开始在美国出现，用以形容学院或大学的整个场地，包括教室、图书馆、宿舍、运动场等所有设施。
