---
title: Leading
description: Leading作为形容词，主要有两个含义：
sidebar:
  hidden: true
...
<Pronunciation word="Leading" uk="/ˈliːdɪŋ/" us="/ˈlidɪŋ/" client:only />
...
<WordRelations antonyms={["following", "lagging", "trailing"]} client:only />
