...
description: >-
  Resemblance
  是一个名词，它表示相似性或相似之处，是两个或更多个事物在某些方面的相同之处。这个词通常用于描述人或物的外表或特性，表达的是“看起来像”或“有点儿像”的意思。
sidebar:
  hidden: true
...
Resemblance 来源于动词 resemble (与....相似)，-ance 是一个后缀，被添加到动词后面转换为表示状态或质量的名词。其他由相同词根衍生的词缀有：resemble (动词), resembling(形容词)。

### 文化背景

Resemblance 起源于 14 世纪的中古法语(Old French) "resembler", 其意为"be like, look like"; 后缀"-ance"是用于形成抽象名词的后缀。

### 单词变形

Resemblance 作为名词没有变形。 但词根 "resemble" 可以变为 resembling(现在分词), resembled(过去分词),resembles(第三人称单数), resembled(过去式)。
...
<WordRelations
  synonyms={["likeness", "similarity", "similitude"]}
  client:only
/>
