---
title: Resign
description: Resign 是一个动词，它的基本含义是辞职或放弃（职位，权力等）。它也可以表示接受一种情况，因为你不能改变它。
sidebar:
  hidden: true
...
<Pronunciation word="Resign" uk="/ɹɪˈzaɪn/" us="/ɹɪˈzaɪn/" client:only />
...
"Resign" 这个词从 14 世纪就开始在英语中使用，最早的含义是放弃、撤退或者离去。
...
<WordRelations synonyms={["quit"]} client:only />
