...
description: >-
  Mend
  是一个英语单词，它是一个动词，主要有两个基本的含义。其一是修理或修补，特别是指对物品或设备的修复，使其恢复正常或原始状态。例如，你可以用其来描述修补破裂的衣物，或修理损坏的机器。其二是在情感或关系方面改善或弥补，如修复心灵的创伤或弥补人际关系。
sidebar:
  hidden: true
...
<Pronunciation word="Mend" uk="/mɛnd/" us="/mɛnd/" client:only />
