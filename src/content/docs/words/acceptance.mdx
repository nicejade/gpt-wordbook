...
description: >-
  Acceptance
  这个单词是一个名词，它指的是接受，承认，或同意的行为或过程。它可以用于各种场景，包括描述对一个人、事情或观念的心理接受过程，或者描述一个关于商品、交易、文本的实质性接受。
sidebar:
  hidden: true
...
<Pronunciation word="Acceptance" uk="/ək.ˈsɛp.təns/" us="/ək.ˈsɛp.təns/" client:only />
...
<WordRelations
  synonyms={["accepting","approval","receiving","reception","assent","acceptableness","acceptance","throughput"]}
  client:only
/>
