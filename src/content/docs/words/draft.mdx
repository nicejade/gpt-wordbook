---
title: "draft"
description: "Draft在英语中是一个多义词，主要有以下含义: 1. 草案，初稿。如法律文本、论文、设计方案的初稿。 2. 草拟，起草。如起草一个计划或合同。 3. 征召，如征召入伍、征召运动员入队伍。 4. 绘图，设计。在建筑或工程领域，草图就是一个项目或建筑物的初步设计。 5. 汇票，如承兑汇票和期票。"
---
...
在美国，"draft"一词常被用于体育中的选秀。例如"NBA draft"（NBA 选秀）,指的是每年举行的一个活动，各个球队在这个活动中选择新的球员。
