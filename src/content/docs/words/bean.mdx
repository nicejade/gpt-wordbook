---
title: Bean
description: Bean 这个单词的主要含义是 “豆子”，是指植物学上的一类果实。另一种含义用法多在口语中，可以指“头部”或表示一种轻微的打击。
sidebar:
  hidden: true
...
<Pronunciation word="Bean" uk="/biːn/" us="/biːn/" client:only />
...
"Bean"是从古老的英语单词"bean"发展而来的，早在公元前 3000 年，人们就开始在欧洲大陆种植食用豆。在文化上，豆子在各种神话、传说和习俗中扮演着重要的角色。
...
<WordRelations synonyms={["bean"]} client:only />
