...
title: Drama
description: >-
  Drama这个单词在英语中主要有两个含义。第一个比较常见的含义是戏剧或表演艺术，特指表现人类冲突和情感的舞台或影视作品。第二个含义，它常用于非正式语境中，表示引起争吵或冲突的复杂情况或麻烦事件。
sidebar:
  hidden: true
...
<Pronunciation word="Drama" uk="/ˈdɹæmə/" us="/ˈdɹɑmə/" client:only />
