---
title: Paragraph
description: '''Paragraph''是英语单词，意为"段落"。 这个词用来描述一段连贯的文本，一般包含有一个主题或者一个主要的思想。'
sidebar:
  hidden: true
...
"Paragraph"这个单词首次出现在西元 1447 年，最早用于描述在手稿或印刷品中标记新的主题段落的符号或标志。后来，这个词演变成描述一段完整的、关于一个特定主题或思想的文字。
