---
title: Divorce
description: Divorce是一个名词，也可作为动词使用。作为名词，它指的是法律上终止婚姻关系的过程或状态。作为动词，它是指通过法律手段终止婚姻关系。
sidebar:
  hidden: true
...
<Pronunciation word="Divorce" uk="/dɪˈvɔːs/" us="/dɪˈvɔːs/" client:only />
...
"Divorce"一词源于 14 世纪的法国，初期意为“分离，断开”，后期发展成为法律用语，指婚姻的法律解除。
...
<WordRelations
  synonyms={["divorcement","partition","separation","severance","disassociate","disjoint","dissociate","disunite","separate"]}
  antonyms={["marriage","marry"]}
  client:only
/>
