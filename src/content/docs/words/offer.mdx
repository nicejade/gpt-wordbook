---
title: Offer
description: Offer 作为动词，是提供、提议、给予、呈现的意思；作为名词，意味着提供、提议、机会、出价。
sidebar:
  hidden: true
...
<Pronunciation word="Offer" uk="/ˈɑfɚ/" us="/ˈɔfɚ/" client:only />
...
"Offer" 无词缀。从词根 "ferre" 衍生出的其他单词有：differ、infer、refer 等。
