...
description: >-
  Fringe
  在英语中是一个多义词。首先，它可以用作名词，表示“边缘”，指的是一个事物的外围或边界部分。此外，“fringe”也可作为形容词使用，表示“边缘的”或者“非主流的”。同样，'fringe'也可以指挂在衣物或窗帘边上的流苏状装饰。
sidebar:
  hidden: true
...
<Pronunciation word="Fringe" uk="/fɹɪndʒ/" us="/fɹɪndʒ/" client:only />
...
Fringe 中的'-inge'是后缀，表示名词、动词的词尾，用来表示状态或动作。类似的单词还有"change"（改变），"range"（范围），"hinge"（铰链）。

### 文化背景

"Fringe"词义的变迁反映了社会的历史变迁。在 20 世纪 50 年代，英语中的“fringe”开始用于表示边缘群体或边缘行为，这可能反映了在这一时期人们对社会主流和非主流的分化越来越敏感。
...
<WordRelations
  synonyms={["bang","forelocks","fringe","outskirts","alternative","nonmainstream"]}
  client:only
/>
