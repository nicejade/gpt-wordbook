---
title: Challenging
description: Challenging 是一个形容词，来源于动词 'challenge'，它的意思是具有挑战性的，困难的，需要大量努力才能成功完成的。
sidebar:
  hidden: true
...
<Pronunciation word="Challenging" uk="/ˈtʃæləndʒɪŋ/" us="/ˈtʃæləndʒɪŋ/" client:only />
...
词语 "challenge" 最初在 13 世纪的法语中用于表达 "谴责，责难" 的含义。到了 14 世纪左右，经由法语引入英语，开始用于表示 "对某事提出质疑或挑战"。
