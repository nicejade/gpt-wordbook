---
title: Clever
description: Clever 是个形容词，意为“聪明的，机灵的，灵巧的”。这个词可以用来描述人或者动作，比如一个聪明的人，或者一个灵巧的动作。
sidebar:
  hidden: true
...
<Pronunciation word="Clever" uk="/ˈklɛvɚ/" us="/ˈklɛvɚ/" client:only />
...
<WordRelations
  synonyms={["adroit","talented","magical","cunning","ingenious"]}
  antonyms={["clumsy","natural","ineffectual","naive","dull","stupid"]}
  client:only
/>
