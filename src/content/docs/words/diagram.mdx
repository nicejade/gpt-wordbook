---
title: Diagram
description: Diagram 是一个名词，意思是“图表”或“示意图”，用于把复杂的信息、系统或过程用视觉的方式简单、明了地表示出来。
sidebar:
  hidden: true
...
此词源自希腊语的'diagramma'，原始意思是"我画"。首次在英语中使用是在 1610 年，从那时起，它就被用来描述各种形式的图表、图示或模型。

### 单词变形

"Diagram"是不可数名词，没有复数形式。此外，"diagram"也可以用作动词，意为“用图表表示”，例如："The process is diagrammed in Figure 2."（这个过程在图 2 中用图表表示了出来。）
...
<WordRelations synonyms={["schematic"]} client:only />
