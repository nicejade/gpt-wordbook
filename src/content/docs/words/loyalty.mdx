---
title: Loyalty
description: Loyalty是一个名词，意为'忠诚'或'忠心”，是对某个人，群体，或者观念持有坚定不渝的支持和信任。
sidebar:
  hidden: true
...
<Pronunciation word="Loyalty" uk="/ˈlɔɪəlti/" us="/ˈlɔɪəlti/" client:only />
...
<WordRelations synonyms={["trueness"]} antonyms={["disloyalty"]} client:only />
