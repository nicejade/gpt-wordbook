...
title: Alcoholic
description: >-
  Alcoholic是形容词，用于描述一个人饮酒过度，对酒精产生依赖，这是一种病态的依赖。可以直接用来形容人，例如'He is an
  alcoholic'，也可以用来形容和酒精相关的事物，例如'alcoholic beverages'。
sidebar:
  hidden: true
...
<Pronunciation word="Alcoholic" uk="/ˌælkəˈhɒlɪk/" us="/ˌælkəˈhɔlɪk/" client:only />
...
"Alcoholic" 是由 18 世纪的 "alcohol" 演变而来的，最初用来描述与酒精相关的化学反应。20 世纪初，它开始被用来形容人对酒精的过度依赖。
...
<WordRelations
  antonyms={["teetotaler","nonalcoholic"]}
  client:only
/>
