---
title: Compass
description: Compass这个单词主要有两个基本含义。第一个是我们常用的指南针，用于指示方向。第二个含义是一个取代了较早时期的分层圆规而广泛应用于设计和绘图的绘图工具。
sidebar:
  hidden: true
...
<Pronunciation word="Compass" uk="/ˈkʌm.pəs/" us="/ˈkʌm.pəs/" client:only />
...
"Compass"这个单词来源于拉丁词根"com-" 和 "passus"，含义是"步"，合起来理解就是"一起走"的意思，引申义就是通过使用 compass，人们可以知道应该往哪个方向走。

### 词缀分析

这个单词并不包含前缀或后缀。但我们可以看到它的其他变形，如 compasses (复数形式)，compassing (进行时形式)等。

### 文化背景

"Compass"这个单词的起源可以追溯到公元前 9 世纪的中国，当时的指南针是利用磁石自然吸引力来寻找方向的。而到了 14 世纪，它被广泛用作海上导航的工具，并发挥了重要作用。
