...
title: Combat
description: >-
  Combat既可以作为名词，也可以作为动词使用。作为名词时，'combat'指的是战斗，争斗；作为动词时，'combat'意指与......作斗争，采取行动对抗。
sidebar:
  hidden: true
...
<Pronunciation word="Combat" uk="/ˈkɒmˌbæt/" us="/kəmˈbæt/" client:only />
...
"Combat"的词根为 Latin 词根"com-"，意为"共同、一起", "+"bat-",意为"打击"。所以，"combat"的直译就是"共同打击"，你可以想象把它解读为"一起作战"。
...
"Combat"一词源自 14 世纪的法语"combatre"，最初的含义是"为了争斗而战斗"。它在欧美文化中常用于描述军事行动或者是社会、经济中的某种对抗情况。
