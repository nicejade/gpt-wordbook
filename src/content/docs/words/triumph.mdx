---
title: Triumph
description: Triumph 是一个名词或者动词，作为名词时，它通常指的是一次重要的成功、胜利或者成就。作为动词，'triumph'的意义通常为战胜、成功取得胜利。
sidebar:
  hidden: true
...
<Pronunciation word="Triumph" uk="/ˈtɹaɪ.ʌmf/" us="/ˈtɹaɪ.əmf/" client:only />
...
"Triumph"源自拉丁语 triumphus，意为"胜利或凯旋"
