---
title: Eleventh
description: Eleventh 是一个序数词，基于数词“eleven”，它的意思是“第十一”。
sidebar:
  hidden: true
...
Eleventh 是一个序数词，基于数词“eleven”，它的意思是“第十一”。

<Pronunciation word="Eleventh" uk="/ɪˈlɛv.ənθ/" us="/iˈlɛv.ənθ/" client:only />
...
Eleventh 的词根是“eleven”，这是一个由古英语 ælfrice 和一组相关古词形成的，意思是“one left”。

### 词缀分析

Eleventh 的后缀是“-th”，这是英语序数词常见的后缀，用来表示位置或顺序。
...
Eleventh 本身就是“eleven”的一种变形，表示这个数字在一个序列中的位置。
...
<WordRelations synonyms={["11th", "XI", "XIth"]} client:only />
