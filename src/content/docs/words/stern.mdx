...
title: Stern
description: >-
  Stern是一个英语形容词，通常被用来形容一个人严格的，严肃的，或者说表情严厉的。当用于形容规则或惩罚时，它意味着这些事物是严厉的，严格的。此外，'stern'也可以作为一个名词使用，在航海领域中，它指的是船的尾部。
sidebar:
  hidden: true
...
<Pronunciation word="Stern" uk="/stɜːn/" us="/stɝn/" client:only />
