---
title: Morse
description: Morse 一词最早出现用于表示由发明者塞缪尔·摩尔斯所发明的一种编码方式，摩尔斯电码 (Morse code)。此外，'Morse' 也可能是一个姓氏。
sidebar:
  hidden: true
...
<Pronunciation word="Morse" uk="/mɔːs/" us="/mɔːs/" client:only />
...
3.  A SOS signal in Morse code is '... --- ...'. (Morse 电码中的 SOS 信号是'... --- ...'。)
...
"Morse" 这个词是由美国人塞缪尔·摩尔斯在 1836 年发明的一种电报代码，因此以他的名字命名。该编码是一个早期的形式，用于电报通讯，现在广泛用于无线通信。
