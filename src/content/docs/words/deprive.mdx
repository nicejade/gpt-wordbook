...
title: Deprive
description: >-
  Deprive是一个动词，意思是剥夺、使失去。这个词通常与 'of' 一起使用，表示从某人或某事物中取走某个重要的东西。例如： 'Lack of
  vitamin C can deprive the body of its resistance to illness' (维生素 C
  的缺乏会剥夺身体对疾病的抵抗力)。
sidebar:
  hidden: true
...
"Deprive"是一个动词，意思是剥夺、使失去。这个词通常与 "of" 一起使用，表示从某人或某事物中取走某个重要的东西。例如： "Lack of vitamin C can deprive the body of its resistance to illness" (维生素 C 的缺乏会剥夺身体对疾病的抵抗力)。

<Pronunciation word="Deprive" uk="/dɪˈpɹaɪv/" us="/dɪˈpɹaɪv/" client:only />
...
"Deprive"首次出现在 14 世纪，起初主要用于法律上的剥夺权利，如财产、自由等。后来这个词的使用范围扩大，包括了剥夺生命必需品，或者剥夺机会、权力等。

### 单词变形

不存在单复数变化的情况，形容词形式为 "deprived"，副词形式为 "depriving"。

"Deprive"的固定搭配有："deprive A of B" （剥夺 A 的 B）、"be deprived of"（被剥夺）
