...
description: >-
  Tragedy
  是一个名词，主要指的是一种悲剧性的事件，尤其是那些涉及死亡和毁灭的事件。它也可以用来形容一种类型的剧本，其中主角经历了痛苦的境遇并在最终遭受厄运。
sidebar:
  hidden: true
...
<Pronunciation word="Tragedy" uk="/ˈtɹæd͡ʒɪdi/" us="/ˈtɹæd͡ʒɪdi/" client:only />
...
<WordRelations antonyms={["comedy"]} client:only />
