---
title: Impulsive
description: Impulsive是一个形容词，用来描述一个人的性格或行为是冲动的、未经深思熟虑的。
sidebar:
  hidden: true
...
<Pronunciation word="Impulsive" uk="/ɪmˈpʌlsɪv/" us="/ɪmˈpʌlsɪv/" client:only />
...
"Impulsive"来自于 17 世纪的拉丁语，用来形容一个人的行为是冲动的，没有深思熟虑，常在欧美文化中被用来形容冲动的购物、决定等。
