---
title: Clothe
description: Clothe 是一个动词，意思是给（某人）穿衣，也可以用来引申为提供某人以所需之物。
sidebar:
  hidden: true
...
<Pronunciation word="Clothe" uk="/ˈkləʊð/" us="/ˈkloʊð/" client:only />
...
<WordRelations synonyms={["dight", "don"]} client:only />
