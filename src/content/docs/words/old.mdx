---
title: Old
description: 英文单词 'old' 是形容词，直接翻译为中文是“旧的”或“老的”，它用来描述年纪大、时间长久或者以前、过去的事情。
sidebar:
  hidden: true
...
<Pronunciation word="Old" uk="/ˈɒʊld/" us="/ˈoʊld/" client:only />
...
<WordRelations
  synonyms={["erstwhile","former","past","ancient","aged","ageing","aging","elderly","antiquated","obsolete","outdated"]}
