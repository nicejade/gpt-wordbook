...
title: Fiction
description: >-
  Fiction 是一个名词，指的是虚构的内容，通常用于提到小说或者故事。比如，“That's a work of fiction.”
  (那是一部虚构的作品。)
sidebar:
  hidden: true
...
<Pronunciation word="Fiction" uk="/ˈfɪk.ʃən/" us="/ˈfɪk.ʃən/" client:only />
...
Fiction 是在 14 世纪从拉丁词"fictio"中引入英语的。在早期，它被用来指的是所有创造出来的东西，无论是艺术品，还是编造的谎言。随着时间的推移，它逐渐演变为主要指代文学作品中非真实或虚构的元素。
...
<WordRelations
  ...
  antonyms={["documentary", "fact", "truth"]}
  client:only
/>
