---
title: Sometimes
description: Sometimes 是一个副词，表示“有时，偶尔”。它用来描述某些行为、情况或状态不是一直发生，而是间或发生。
sidebar:
  hidden: true
...
<Pronunciation word="Sometimes" uk="/ˈsʌmtaɪmz/" us="/ˈsʌmtaɪmz/" client:only />
...
<WordRelations synonyms={["yestertide", "occasionally"]} client:only />
