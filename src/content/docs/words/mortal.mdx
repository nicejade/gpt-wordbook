...
title: Mortal
description: >-
  Mortal是一个英语单词，有两个主要的含义。第一个定义是'必定死亡的'或'凡人的'，这是描述所有生物，包括人类，的生命有限的事实。第二个定义是'致命的'或'极其严重的'，描述伤害或威胁生命的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Mortal" uk="/ˈmɔːtəl/" us="/ˈmɔːtəl/" client:only />
...
<WordRelations
  synonyms={["baneful", "fatal", "lethal"]}
  antonyms={["immortal", "vital", "natal", "everlasting"]}
  client:only
/>
