...
description: >-
  Agent
  是一个英文名词，通常有两种主要的含义。首先，它可以表示代理人或代表，是一个人或组织代表另一个个体或组织进行某项操作或任务的人。其次，它也可表示引发某种效果或反应的物质或事物，比如化学试剂。
sidebar:
  hidden: true
...
<Pronunciation word="Agent" uk="/ˈeɪ.dʒənt/" us="/ˈeɪ.dʒənt/" client:only />
...
"Agent" 这个词源于拉丁词 "agens"，意为 "doing"，并在 15 世纪通过法语传入英语，用来描述可能产生动作或结果的人或事物。在欧美文化中，它常用于商业、法律和科学等领域，表达具有代理或行动能力的概念。
