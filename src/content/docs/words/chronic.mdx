---
title: Chronic
description: Chronic是一个形容词，通常用来描述（尤其是疾病）长期存在的，反复发生的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Chronic" uk="/ˈkɹɒnɪk/" us="/ˈkɹɒnɪk/" client:only />
...
<WordRelations
  synonyms={["gnarly","splendid","prolonged","abysmal","terrible"]}
