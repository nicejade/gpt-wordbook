...
title: Weapon
description: >-
  weapon' 是指任何用于攻击或防御的工具，特别是在战争或暴力冲突中使用的工具。它可以是刀、枪支、核弹甚至是一个人的拳头。例如：'The soldier
  was carrying a heavy weapon.
sidebar:
  hidden: true
...
<Pronunciation word="Weapon" uk="/ˈwɛ.pən/" us="/ˈwɛ.pən/" client:only />
...
"Weapon" 这个词来自古英语"wæpen"，该词的使用可以追溯到公元前 1000 年。
