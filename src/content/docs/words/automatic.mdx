---
title: Automatic
description: Automatic 是一个形容词，通常用来描述一种不需要人工操作、能自我执行或自发发生的过程或设备。它的中文翻译是“自动的”。
sidebar:
  hidden: true
...
<Pronunciation word="Automatic" uk="/ˌɔːtəˈmætɪk/" us="/ˌɔtəˈmætɪk/" client:only />
...
"Automatic" 是 19 世纪由衍生出来的，最初用于描述有自我操作功能的机器。随着科技的发展，在许多上下文中，这个词被广泛地用来描绘电子设备和系统。
...
<WordRelations
  ...
  antonyms={["stick","stickshift","manual","voluntary"]}
  client:only
/>
