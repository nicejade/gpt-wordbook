...
title: Wicked
description: >-
  Wicked是一个形容词，主要用途是描述一些十分坏的或者恶意的行为。例如，'wicked
  witch'（恶魔女巫）。此外，这个词在一些方言中，特别是新英格兰地区，也可以用作副词，用来强调一个事物或行为是非常极端的，其含义相当于“
  extremely”。
sidebar:
  hidden: true
...
<Pronunciation word="Wicked" uk="/ˈwɪkɪd/" us="/ˈwɪkɪd/" client:only />
...
<WordRelations
  synonyms={["awesome","bad","cool","dope","evil","excellent","groovy","hot","rad","immoral","malevolent","malicious","nefarious","twisted","villainous","hella","helluv"]}
  client:only
/>
