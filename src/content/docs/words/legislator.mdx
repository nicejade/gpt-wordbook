...
title: Legislator
description: >-
  "Legislator" 是名词，表示立法者，有决定、建立和修改法律的人或机构。 **举例** 1. The legislator introduced a
  bill to promote renewable energy.（该立法者提出了一项促进可再生能源的法案。） 2. Legislators are
  debating changes to immigration policy.（立法者们正在就移民政策的变更进行辩论。） 3. The young
  legislator has become influential in congress.（这位年轻的立法者在国会中影响力日益增大。）
sidebar:
  hidden: true
