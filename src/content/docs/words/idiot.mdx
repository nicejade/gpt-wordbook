...
description: >-
  Idiot
  是一个英语词汇，用来形容一个人的理解能力特别低下，行为愚蠢或者缺乏常识。但需要注意的是，它常被看作是带有侮辱性的词汇，我们建议尽可能避免在正式和文明的场合使用。
sidebar:
  hidden: true
...
<Pronunciation word="Idiot" uk="/ˈɪd.i.(j)ɪt/" us="/ˈɪd.i.(j)ɪt/" client:only />
...
<WordRelations antonyms={["genius"]} client:only />
