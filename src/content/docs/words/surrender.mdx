---
title: Surrender
description: Surrender是一个动词，经常被翻译为'屈服'、'投降'或'交出'。这个词通常用于描述一方放弃抵抗，或交出空间、物件或者权力等。
sidebar:
  hidden: true
...
<Pronunciation word="Surrender" uk="/səˈɹɛndəɹ/" us="/səˈɹɛndəɹ/" client:only />
...
"Surrender"一词源于 14 世纪中叶的法语"sur-"(超过)和"rendre"(归还)的组合，直译为“归还给”。
...
<WordRelations synonyms={["capitulation", "overgive"]} client:only />
