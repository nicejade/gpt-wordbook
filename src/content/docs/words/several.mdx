---
title: Several
description: "- 'Several'是一个形容词，表示'几个'或者'若干的'。可以用来描述数量不肯定但大于两个的物体或事物。"
sidebar:
  hidden: true
...
<Pronunciation word="Several" uk="/ˈsɛv(ə)ɹəl/" us="/ˈsɛv(ə)ɹəl/" client:only />
...
- "Several" 在 14 世纪中叶从法国借来，最初的意思是"分开的，单独的"，后来引申为"多于两个但未满许多的"。
