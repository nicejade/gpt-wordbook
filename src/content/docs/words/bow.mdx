---
title: Bow
description: 英文单词“bow”有两种主要义项，既可以表示“弓箭”也可以表示“鞠躬”，还可以作为动词，表示“弯曲”、“屈服”。
sidebar:
  hidden: true
...
<Pronunciation word="Bow" uk="/bəʊ/" us="/boʊ/" client:only />
...
<WordRelations synonyms={["arc", "bend", "curve", "fiddlestick"]} client:only />
