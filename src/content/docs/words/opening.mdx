...
title: Opening
description: >-
  英文单词 'opening' 的基本含义是 '开放'或'开启'，同时也可指 '口 ，孔，空隙' 这样的开口状态。还可以指 '开幕' 如
  '新店的开幕'，也可以指 '起始'，如 '一篇文章的开头'。
sidebar:
  hidden: true
...
<Pronunciation word="Opening" uk="/ˈəʊ.pənɪŋ/" us="/ˈoʊ.pənɪŋ/" client:only />
...
<WordRelations
  synonyms={["raise","bare","start","unseal","availability","slot","crevice","gap","hole"]}
  antonyms={["bare","shut"]}
  client:only
/>
