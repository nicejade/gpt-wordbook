---
title: Shorten
description: "- 'Shorten'这个单词是一个动词，意思是使某事物变短或者减少。其常见的用法是指减少时间、距离或长度。"
sidebar:
  hidden: true
...
<Pronunciation word="Shorten" uk="/ˈʃɔːtən/" us="/ˈʃɔːtən/" client:only />
...
"Shorten"这个词起源于古老的英语，"short"本身源自古英语的词"scort"，分别在 12 世纪和 14 世纪被引入英语。"shorten"在词义上具有减少或简化的意思，反映了人们追求效率和方便的本质。
...
<WordRelations antonyms={["extend", "lengthen"]} client:only />
