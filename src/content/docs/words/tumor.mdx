---
title: Tumor
description: 1.  'Tumor' 是一个名词，指的是由于身体某部位结构细胞无规则增长、组织繁殖无序所形成的肿瘤或肿块。
sidebar:
  hidden: true
...
<Pronunciation word="Tumor" uk="/tjuː.mə/" us="/tjuː.mə/" client:only />
...
1.  “Tumor”与“tumour”意思相同，前者为美式拼写，后者为英式拼写。你可以通过单词的形状（tumor 类似肿胀，开头的 T 像一个肿大的十字架）来帮助你记住该单词。
...
<WordRelations synonyms={["neoplasm"]} client:only />
