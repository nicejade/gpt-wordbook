...
title: Mill
description: >-
  "Mill" 是一个英文词汇，可用作名词，也可用作动词。 1. 当"Mill" 作为名词时，它主要有两个含义： -
  一种制造或加工的设施或工厂，例如纺织厂或造纸厂。 - 一种磨粉的设备或机器，如咖啡磨或胡椒磨。 2. 当 "Mill" 作为动词时，它主要有两个含义： -
  制造或加工，如 米。 - （人或动物） 在没有特定目的的情况下随意移动或者集结。
sidebar:
  hidden: true
