...
title: Charge
description: >-
  1. 分析词义 Charge 是一个常用的英语单词，常见的意义有： * 费用，价钱，例如 entrance charge（入场费） * 充电，例如
  charge a phone（给手机充电） * 控告，指责，例如 charge someone with a crime（指控某人犯罪） * 冲锋，例如
  lead a charge（领导一次冲锋）、charge at the enemy（向敌人冲锋） 2. 列举例句 * That restaurant
  charges too much for their food.（那家餐厅的食物价格太贵。
sidebar:
  hidden: true
