...
description: >-
  Amaze
  是一个动词，一般用来描述让人感到极度惊讶或者被深深吸引的情况。就像你看到一件极其出色的事情，那么你就可以说这件事“amazes”你。此外，'Amaze'可以代替'Surprise'来加重语气表达非常惊讶的状态。
sidebar:
  hidden: true
...
<Pronunciation word="Amaze" uk="/əˈmeɪz/" us="/əˈmeɪz/" client:only />
