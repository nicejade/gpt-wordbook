---
title: Foul
description: Foul  是一个英语单词，在中文中的意思是“腐烂的，污秽的”，也可以表示“犯规”，在体育竞技中常常使用。
sidebar:
  hidden: true
...
<Pronunciation word="Foul" uk="/faʊl/" us="/faʊl/" client:only />
...
<WordRelations synonyms={["odious", "shameful", "wretched"]} client:only />
