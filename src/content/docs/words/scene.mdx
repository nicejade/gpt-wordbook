...
title: Scene
description: >-
  "Scene"是英文中的一个常见词。它有两个主要的含义： 1. 指的是发生某事件或活动的地方或环境。如："It's a scene of utter
  devastation." 也就是说“这是个完全被破坏的地方”。 2. 在电影、戏剧或书籍中指的是特定的事件或动作的一部分。如："The opening
  scene of the film." 意为“电影的开场”。 此外，它还有其他一些引申意义，需要结合语境具体理解。
sidebar:
  hidden: true
...
"scene"这个词是在 14 世纪时期从拉丁语直接借用过来的，最初主要用于戏剧和艺术领域，用来描述一段戏剧或一张画的鲜明画面或情境。
