...
description: >-
  Relegate
  是一个动词，它的基本意思是把（某人或事）降级，交付给他人处理。当你把一项任务或职责'relegate'（交给）另一个人时，通常表示你认为这项任务不那么重要，或者你很忙，无法亲自去处理。
sidebar:
  hidden: true
...
<Pronunciation word="Relegate" uk="/ˈɹɛlɪɡeɪt/" us="/ˈɹɛlɪɡeɪt/" client:only />
...
"Relegate" 这个词的最早记录的英语用法始于 15 世纪，其直接来源是拉丁词 "relegatus"，该词是 "relegare" 的过去分词。
