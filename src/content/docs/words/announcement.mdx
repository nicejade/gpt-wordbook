...
title: Announcement
description: >-
  Announcement来源于动词'announce'，它通常是一个名词，表示'公告'、'声明'、'通知'或'宣布'。它常用于描述一个正式的，通常是有关重要信息或改变的声明。
sidebar:
  hidden: true
...
"Announcement"一词始于 14 世纪的英格兰，最初用于描述宗教或正式场合的重要宣布。
...
<WordRelations synonyms={["proclamation", "publication"]} client:only />
