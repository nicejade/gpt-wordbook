---
title: Spot
description: Spot有多个含义。首先，它可以作为名词，表示“地点”或“斑点”。其次，它也可以作为动词，表示“发现”或“看见”。
sidebar:
  hidden: true
...
<Pronunciation word="Spot" uk="/spɒt/" us="/spɑt/" client:only />
...
“Spot”的最初来源是古英语的单词"spotti"，原意为"小片区域或地点"。到了中世纪的英语中，它也有了"小片"或"斑点"的意思。到了 16 世纪，"spot"作为动词的意思也开始出现，即"发现"或"看见"。
