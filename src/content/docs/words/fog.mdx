...
title: Fog
description: >-
  fog 是名词，主要用来描述一种天气现象，空气中水汽凝结形成的能阻挡视线的气溶胶云，这种现象通常出现在湿润和冷的气候条件下。在托马斯·哈代的诗歌中，他使用
  'fog' 来象征困难和不确定性。
sidebar:
  hidden: true
...
<Pronunciation word="Fog" uk="/fɒɡ/" us="/fɑɡ/" client:only />
...
<WordRelations
  synonyms={["daze", "haze", "mist", "steam", "blur", "cloud", "obscure"]}
  client:only
/>
