---
title: Let
description: Let是一个多功能的英语单词，主要有两个含义。一是作为动词时表示“允许”或“让”，二是在网球等体育比赛中，表示一次无效的发球。
sidebar:
  hidden: true
...
<Pronunciation word="Let" uk="/lɛt/" us="/lɛt/" client:only />
...
<WordRelations synonyms={["allow", "permit"]} client:only />
