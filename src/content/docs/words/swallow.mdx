...
title: Swallow
description: >-
  Swallow是英语单词，既可做名词(cannot swallow)也可以做动词(a swallow),有两个常见的含义：1. 做动词时,
  指“吞咽”，是指把食物等通过喉咙送入胃里。2.做名词时，是一种鸟类，我们常说的“燕子”。
sidebar:
  hidden: true
...
<Pronunciation word="Swallow" uk="/ˈswɒləʊ/" us="/ˈswɑloʊ/" client:only />
...
<WordRelations
  synonyms={["buy","credit","creed","consume","devour","eat","gulp","absorb","engage","immerse","monopolize","occupy","brook","endure","disavow","unsay","assimilate"]}
  client:only
/>
