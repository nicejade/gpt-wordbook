---
title: Grandpa
description: 英文单词 'grandpa' 在中文里的意思是“爷爷”。它通常用于孩子或年轻人对父亲的父亲的称呼，也被用于称呼老年男性或作为对老年男性的亲切称谓。
sidebar:
  hidden: true
...
<Pronunciation word="Grandpa" uk="/ˈɡɹæmpɑː/" us="/ˈɡɹæmpɑː/" client:only />
...
"Grandpa" 这个词的使用在英语中可以追溯到 17 世纪，最初是“grandfather”的缩写。然后在日常会话中演变为更为口语化的“grandpa”。
