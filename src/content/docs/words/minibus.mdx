---
title: Minibus
description: Minibus 是一个英文名词，表示一种较小的公共汽车或长途巴士，通常拥有 10 至 30 个座位。在城市公共交通和学校巴士中很常见。
sidebar:
  hidden: true
...
Minibus 是一个英文名词，表示一种较小的公共汽车或长途巴士，通常拥有 10 至 30 个座位。在城市公共交通和学校巴士中很常见。

### 列举例句

例 1: She usually takes the minibus to work. (她通常乘坐小巴去上班。)
例 2: The school uses a minibus to transport kids to field trips. (学校使用小巴将孩子们接送到实地考察点。)
例 3: More minibuses are needed during peak hours to ease the traffic. (在高峰时段，需要更多的小巴来缓解交通压力。)
