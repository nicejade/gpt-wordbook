---
title: Bruise
description: Bruise 是一个英文单词，常用作名词或动词。作为名词它指的是身体上由于受伤或冲击导致的淤血或紫斑；作为动词时，它的意思是使皮肤淤血，被撞伤害。
sidebar:
  hidden: true
...
<Pronunciation word="Bruise" uk="/bɹuːz/" us="/bɹuːz/" client:only />
...
<WordRelations synonyms={["contusion", "ecchymosis"]} client:only />
