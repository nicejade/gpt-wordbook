---
title: Rabbit
description: Rabbit是一个英文词汇，意为'兔子'。
sidebar:
  hidden: true
...
<Pronunciation word="Rabbit" uk="/ˈɹæbət/" us="/ˈɹæbɪt/" client:only />
...
单词"rabbit"起源于 14 世纪的法国中古词"rabot". 在早期的英语中，“rabbit”通常用于指小兔子，而"coney"等词被用于指大兔子。而在现代英语中, “rabbit”已经涵盖了所有年龄和大小的兔子。
...
在一个地方，住着一个名叫 Fluffy 的小兔子。他喜欢在草地上跳来跳去。一天，他发现了一根又大又多汁的胡萝卜，于是他过得非常开心。

<WordRelations
  synonyms={["bunny","colloquial","hypocoristic","coney","cony","bolt","scamper"]}
  client:only
/>
