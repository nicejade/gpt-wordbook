---
title: Chess
description: Chess 是一个名词，指的是一种两人玩的策略型棋盘游戏。“象棋”或者叫“国际象棋”。
sidebar:
  hidden: true
...
<Pronunciation word="Chess" uk="/t͡ʃɛs/" us="/t͡ʃɛs/" client:only />
...
"Chess"这个词源于 12 世纪的欧洲，尤其是法国和英格兰。它本身源自波斯语的 shāh（意为“国王”），这就导致了象棋的基本规则，即目标是要捉住（“checkmate”）对方的国王。这个词也表明了这个游戏的贵族起源，因为只有贵族才有时间和资源玩这个精心设计的游戏。
