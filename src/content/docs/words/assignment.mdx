---
title: Assignment
description: Assignment 这个英文单词通常用来指定指派的任务，作业，被指定的任务或者分配的责任。这个词也可以被用来指定的地点，例如你被分配到某个特定地点工作。
sidebar:
  hidden: true
...
"Assignment" 这个词汇的使用，能回溯至 14 世纪的法国，原词为 "assignement"。最初的含义是"分配"，在 14 世纪时，找到的最早记录表明用来指 "安排住处"，在 15 世纪中叶，该词的含义扩大化，包括所有的"分配"，"指派的责任或任务"等都能用"assignment"来表示。
