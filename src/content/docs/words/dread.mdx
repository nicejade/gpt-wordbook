...
title: Dread
description: >-
  Dread' 是个英语单词，通常用于描述对某个即将发生的事情或者可能会发生的事情感到极度恐惧和担忧。比如：'Jane dreads the day she
  has to move out.' 意思是：“简担心搬家的那一天。
sidebar:
  hidden: true
...
<Pronunciation word="Dread" uk="/dɹɛd/" us="/dɹɛd/" client:only />
