...
title: Wardrobe
description: >-
  Wardrobe 是一个名词，通常指的是储存衣物的大型储物柜，也可以指一个人的全部服装或特定时间使用的一组服装，比如'summer
  wardrobe'（夏季服装）。
sidebar:
  hidden: true
...
<Pronunciation word="Wardrobe" uk="/ ˈwɔːdɹəʊb/" us="/ˈwɔɹdɹoʊb/" client:only />
...
"Wardrobe"这个词在 13 世纪的法国词典中最早出现，原始含义是"守卫衣物的房间"。随着时间的流逝和语言的发展，它的意思逐渐转化为我们现在理解的"衣柜"或"衣物集合"。
...
<WordRelations
  synonyms={["armoir","closet","cupboard","dresser","press","shrank","bedroom"]}
  client:only
/>
