---
title: Distance
description: Distance 是一个英文单词，表示“距离”。它可以用来形容物理距离，比如两个城市之间的距离，也可以指代抽象的概念，比如两人在感情上的距离。
sidebar:
  hidden: true
...
<Pronunciation word="Distance" uk="/ˈdɪs.təns/" us="/ˈdɪs.təns/" client:only />

### 列举例句

1.  The distance between New York and Los Angeles is about 2,450 miles. (新约克和洛杉矶之间的距离大约是 2,450 英里。)
...
Distance 这个词在 13 世纪从法语借用到英语中，源于拉丁词“distantia”。在运输和通讯技术不发达的年代，距离对人们的生活影响极大，因此这个词有着重要的历史和文化意义。
...
<WordRelations synonyms={["farness"]} client:only />
