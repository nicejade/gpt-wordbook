---
title: Master
description: Master 可以用作名词和动词。作为名词，它代表一个掌握技能或知识的专家，或者是控制或统治者。作为动词，它表示成为…的主人，或者熟练或精通某事。
sidebar:
  hidden: true
...
<Pronunciation word="Master" uk="/ˈmastə/" us="/ˈmæstɚ/" client:only />
...
<WordRelations
  synonyms={["magistrate", "master's", "masters", "captain", "skipper"]}
  client:only
/>
