---
title: Unconscious
description: 英文单词 'unconscious' 当用作形容词时有两个主要含义：
sidebar:
  hidden: true
...
<Pronunciation word="Unconscious" uk="/ˌʌnˈkɒnʃəs/" us="/ˌʌnˈkɑnʃəs/" client:only />
...
"Unconscious"这个词首次出现在 1712 年，起初主要用来描述某人失去知觉的状态。后来，由于弗洛伊德的精神分析理论，这个词开始有了无意识行为的含义，并且在心理学领域广泛使用。
...
<WordRelations
  synonyms={["insentient","oblivious","unaware"]}
  client:only
/>
