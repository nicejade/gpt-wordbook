...
description: >-
  Blink
  是动词，意思是用快速的动作打开和关闭眼睛，通常是自然反应或为了休息眼睛。在不同的上下文环境中，它还可以表示被某种光线闪烁而不敢看，或者是忽略、忽视。
sidebar:
  hidden: true
...
<Pronunciation word="Blink" uk="/blɪŋk/" us="/blɪŋk/" client:only />
...
Blink 的过去式和过去分词是 blinked，现在分词是 blinking。
...
<WordRelations synonyms={["nictitate"]} client:only />
