...
title: Severity
description: >-
  Severity 主要用作名词，它通常表示某事情的严重程度或严峻性。例如，病情的严重程度就是 disease severity，天气的严峻程度就是
  weather severity。
sidebar:
  hidden: true
...
<Pronunciation word="Severity" uk="/səˈvɛɹɨti/" us="/səˈvɛɹɨti/" client:only />
...
"Severity" 这个词起源于 14 世纪的法国，原意是严肃、严厉。它是从法国单词 severite 演变而来的，意为“严密，紧密”。进一步追溯，可以发现它来自拉丁语的 severitas。
