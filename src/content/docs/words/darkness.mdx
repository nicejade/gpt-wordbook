---
title: Darkness
description: Darkness是一个名词，它表示光线的缺乏，可以理解为“黑暗”，或者“阴暗”。它也可以用来描述阴郁、悲观或恐怖的情绪或状态。
sidebar:
  hidden: true
...
<Pronunciation word="Darkness" uk="/ˈdɑːknəs/" us="/ˈdɑɹknɪs/" client:only />
...
<WordRelations antonyms={["light", "lightness"]} client:only />
