---
title: Commonly
description: Commonly 是一个副词，意为“通常，一般，经常”。通常用来描述某些事情或行为的频繁发生或普遍存在。
sidebar:
  hidden: true
...
<Pronunciation word="Commonly" uk="/ˈkɒmənli/" us="/ˈkɑmənli/" client:only />
...
<WordRelations
  synonyms={["commonly","affinitatively","friendly","homly","intimately","nearly"]}
  client:only
/>
