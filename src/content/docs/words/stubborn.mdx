---
title: Stubborn
description: Stubborn是一个形容词，用于描述一个人或动物不愿改变自己的想法或行为，即使这可能不是明智的或有益的。它也可以用来描述某物难以去除或改变。
sidebar:
  hidden: true
...
<Pronunciation word="Stubborn" uk="/ˈstʌbən/" us="/ˈstʌbɚn/" client:only />
...
"Stubborn"来自于 14 世纪的中古英语，原意是“难以移动的，僵硬的”，后来在固执的意义上发展出“不易改变”的含义。
...
<WordRelations
  synonyms={["adamant","contrary","headstrong","insubordinate","obdurate","obstinate","unyielding","wayward","willful","enduring","persistent"]}
  client:only
/>
