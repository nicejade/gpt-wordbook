---
title: State
description: State 是一个非常常见的英语词汇，根据上下文的不同，它可以有许多不同的含义。
sidebar:
  hidden: true
...
<Pronunciation word="State" uk="/steɪt/" us="/steɪt/" client:only />
...
<WordRelations antonyms={["occurrence"]} client:only />
