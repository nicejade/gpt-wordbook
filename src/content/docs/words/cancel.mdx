---
title: Cancel
description: Cancel是一个动词，它表示终止，取消，或者把一些事务算作无效，在使用时主要描述取消预定的事项或者是删除计划。
sidebar:
  hidden: true
...
<Pronunciation word="Cancel" uk="/ˈkænsl̩/" us="/ˈkænsl̩/" client:only />
...
<WordRelations synonyms={["blacklist", "belay"]} client:only />
