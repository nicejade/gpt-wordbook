---
title: Racial
description: Racial是一个英文形容词，表示'种族的'或'人种的'。它用于描述与种族或人种有关的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Racial" uk="/ˈɹeɪʃəl/" us="/ˈɹeɪʃəl/" client:only />
...
该词来自 19 世纪的拉丁文"racialis"，意思是“来自种族的”。在欧美文化中，这个词经常在讨论种族平等、种族歧视等社会问题时使用。
