---
title: Outline
description: 单词 'outline' 主要有两个含义。一是指某物的边界或轮廓；二是指列出或描述大纲，如计划或项目的主要点。
sidebar:
  hidden: true
...
<Pronunciation word="Outline" uk="/ˈaʊtlaɪn/" us="/ˈaʊtlaɪn/" client:only />
...
"Outline" 这个单词始于 17 世纪，最初是指绘画或设计的轮廓。19 世纪中期，"outline" 开始用于描述提纲或大纲。
