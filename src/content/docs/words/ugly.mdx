...
description: >-
  Ugly
  是一个形容词，用来描述令人不悦的、难看的或者不吸引人的外表或者情况。它的语义用法多样，可以用于描述人的外貌，也可以用于描述各种情况，比如丑陋的事实，恶劣的天气等。
sidebar:
  hidden: true
...
<Pronunciation word="Ugly" uk="/ˈʌɡli/" us="/ˈʌɡli/" client:only />
...
<WordRelations
  synonyms={["displeasing","repulsive","unattractive","hideous","homely","unsightly","corrupt","immoral","vile"]}
  antonyms={[
    "attractive",
    "pleasing",
    "beautiful",
