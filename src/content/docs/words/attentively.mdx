---
title: attentively
description: 'Attentively是一个副词，用来描述一种全神贯注、仔细听的状态。例如，如果你 listen attentively, 意思是你专心地听，非常注意细节。'
sidebar:
  hidden: true
...
"Attentively"的词根是"attend", 原意是转向、关注、参加。所以，我们可以从这个词根推导出如 attendee（参与者）、attendance（出席，出勤）等单词。
