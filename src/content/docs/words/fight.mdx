...
title: Fight
description: >-
  Fight 这个单词主要有两种含义：一是指进行物理冲突或战斗；二是为了某个目标而努力斗争。例如，'They fought in the war'
  (他们在战争中战斗)或者 'She is fighting for justice' (她在为正义而战斗)。
sidebar:
  hidden: true
...
<Pronunciation word="Fight" uk="/faɪt/" us="[fʌɪt]" client:only />
