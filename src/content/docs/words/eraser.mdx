---
title: Eraser
description: "Eraser是一个名词，意味着一个用来擦除铅笔或者笔迹的物体，通常是由橡皮制成。例如: a pencil eraser (铅笔橡皮)。"
sidebar:
  hidden: true
...
<Pronunciation word="Eraser" uk="/ɪˈɹeɪzə/" us="/ɪˈɹeɪzə/" client:only />
...
<WordRelations synonyms={["bungee", "rubber"]} client:only />
