...
title: Parallel
description: >-
  Parallel作为形容词，意思是“平行的”，“相同的”，“类似的”，或“并列的”。作为名词，'Parallel'意思是“平行线”或者“相似物”。作为动词，'Parallel'的意思是“与...平行”，“与...相似”。
sidebar:
  hidden: true
...
<Pronunciation word="Parallel" uk="/ˈpæɹəˌlɛl/" us="/ˈpæɹəˌlɛl/" client:only />
...
Parallel 没有前缀或后缀。但是，我们可以通过添加词缀来创造新的单词，例如：parallelogram（平行四边形）、parallelism（平行性）。

### 文化背景

Parallel 这个词源自 16 世纪的希腊词"parallēlos"，意为“并列的”，在数学、物理和其他科学领域中广泛应用。在日常生活中，我们也经常使用“Parallel”来描述相似性或相似的情况。
...
你可以用 parallel 想象两条永不相交的铁路轨道，这样可以帮助你记住它的“平行”的含义。
...
<WordRelations antonyms={["perpendicular", "skew", "serial"]} client:only />
