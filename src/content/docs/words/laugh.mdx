---
title: Laugh
description: Laugh是个动词，意思是“大笑”或者“笑”。它可以用来表达因为开心、娱乐、费解等情感的表达。
sidebar:
  hidden: true
...
<Pronunciation word="Laugh" uk="/laːf/" us="/læf/" client:only />
...
"Laugh"这个词源自古英语 word "hliehhan"，在欧美文化中，笑常常被视为表达快乐、享受生活的象征。
...
<WordRelations
  synonyms={["cachinnation","cackle","chortle","chuckle","giggle","guffaw","snicker","snigger","titter","joke"]}
  antonyms={["cry","weep"]}
  client:only
/>
