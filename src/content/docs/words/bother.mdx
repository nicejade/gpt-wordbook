...
title: Bother
description: >-
  Bother是一个非常常见的英语单词，作为动词时，最常用的意思是“打扰”或“困扰”。如果用来形容事情，那么它可能意味着这个事情令人烦扰或者麻烦。另外，它也经常用于疑问句中，表示询问是否给别人带来了困扰，例如：Does
  it bother you?
sidebar:
  hidden: true
...
<Pronunciation word="Bother" uk="[ˈbɒðə(ɹ)]" us="[ˈbɔðə(ɹ)]" client:only />
...
"Bother"源自 18 世纪的英格兰，最初的意思是“困扰”。随着时间的推移，它的含义逐渐扩大，现在不仅可以用来表示打扰，还常常用来形容事情，表示麻烦或烦扰。

### 单词变形

Bother 的现在分词和过去分词形式为"bothering"，"bothered"，传统上没有名词形式。
...
<WordRelations
  synonyms={["annoy","disturb","irritate","vex","care","mind","blast","botheration","dang","darn","drat"]}
  client:only
/>
