---
title: Designate
description: "- 'Designate'是一个动词，它的基本意思是指定、选定或命名。通常情况下，'designate'用于直接指定某人做某件事、或者选定某物作为某种用途。"
sidebar:
  hidden: true
...
- "Designate"最早出现在 15 世纪的英语中，源于拉丁语的"designātus"，直译为"mark out"，意为划出或者指定。
...
<WordRelations
  synonyms={["entitle","name","style","denote","describe","indicate","note","allocate","earmark"]}
  client:only
/>
