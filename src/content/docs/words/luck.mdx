---
title: Luck
description: luck 这个单词在中文当中对应的意思通常是 '运气' 或者 '幸运'。它可以指一个人的运气好坏，也可以指一个意外的好运。
sidebar:
  hidden: true
...
<Pronunciation word="Luck" uk="/lʌk/" us="/lʌk/" client:only />
...
<WordRelations synonyms={["chance", "fortune"]} client:only />
