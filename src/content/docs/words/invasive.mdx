...
title: Invasive
description: >-
  Invasive是一个形容词，其含义可以是“侵袭性的”或“入侵性的”，主要用来描述具有冲破或破坏其它结构或系统界限的行为或物质。它既可以用来描述具有入侵性的植物、动物或疾病，也可以用以形容过于打扰他人自由或隐私的行为。
sidebar:
  hidden: true
...
<Pronunciation word="Invasive" uk="/ɪnˈveɪsɪv/" us="/ɪnˈveɪsɪv/" client:only />
...
“Invasive”这个词源自 16 世纪的拉丁语，直接的译意是“进入”。通过时间，它的意思已经发展到包括侵略性的行为，破坏自然或社区的构成等。
