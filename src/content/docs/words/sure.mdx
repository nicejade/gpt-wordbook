---
title: Sure
description: Sure这个词在英语中是一个常用的副词和形容词，主要有“确定的，确信的，肯定的”等含义。同时，也用于引出委婉的建议或请求。
sidebar:
  hidden: true
...
<Pronunciation word="Sure" uk="/ʃoː/" us="/ʃɔɹ/" client:only />
...
<WordRelations
  synonyms={["certain","failsafe","reliable","positive","OK","yes"]}
  client:only
/>
