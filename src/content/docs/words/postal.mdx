...
title: Postal
description: >-
  Postal 是个形容词，它通常与邮政服务有关，用来描述与邮寄或邮政有关的事物，如'postal service'（邮政服务）或'postal
  code'（邮政编码）。
sidebar:
  hidden: true
...
<Pronunciation word="Postal" uk="[ˈpəʊstl̩]" us="[ˈpəʊstl̩]" client:only />
...
"Postal"这个词在 19 世纪初首次出现，那时人们开始普遍使用邮政系统发送信件。在欧美文化中，"postal"通常用于指向与邮政服务有关的事物。
