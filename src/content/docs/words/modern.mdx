---
title: Modern
description: modern 是一个形容词，表示的是“现代的，最近的，与时俱进的”这样的含义。
sidebar:
  hidden: true
...
<Pronunciation word="Modern" uk="/ˈmɒd(ə)n/" us="/ˈmɑdɚn/" client:only />
...
'modern'这个词源于拉丁词 modō，意为“最近的”。在欧美文化中，这个词通常与时尚、艺术和科技发展的概念联系起来，表达对当下的欣赏和尊重。
...
<WordRelations
  ...
  antonyms={["ancient","dated","former","historical","old","premodern"]}
  client:only
/>
