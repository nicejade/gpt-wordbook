---
title: Frequently
description: 频繁地，经常地是 'frequently'的基本含义。这个词是一个副词，主要用于描述动作的发生频率。
sidebar:
  hidden: true
...
<Pronunciation word="Frequently" uk="/ˈfɹiː.kwənt.li/" us="/ˈfɹiː.kwənt.li/" client:only />
...
"Frequently"这个词在 14 世纪开始使用，主要用于描述重复频繁的事件或行为。在历史文化中，它的使用与语境相适应，比如描述人的行为习惯或特定事物的常态。
...
<WordRelations
  synonyms={["occasionally","often","oftenly","oftentimes"]}
  client:only
/>
