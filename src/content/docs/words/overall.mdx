---
title: Overall
description: Overall是一个英文词汇，作为副词时，它的含义是总的来说，全面地。作形容词时，它表示全部的，全面的。
sidebar:
  hidden: true
...
"Overall"的最早的用法可以追溯到 14 世纪的中英语，那时候它被用来表示"everywhere"或者"from top to bottom"的意思。
...
<WordRelations
  synonyms={["overslop","slop","big","entire","total","whole","exhaustive","thorough"]}
  client:only
/>
