---
title: Vinegar
description: Vinegar是英文烹饪用语中常见的方法，指的是醋，在中文中。
sidebar:
  hidden: true
...
<Pronunciation word="Vinegar" uk="/ˈvɪnəɡə/" us="/ˈvɪnəɡɚ/" client:only />
...
Vinegar 源于中古英语的 vinegre。其背后的词根‘vin’来源于拉丁语 vinum，指的是‘葡萄酒’，而词尾‘-egar’来自古法语的酸辣或 Sharp，所以"vinegar"的字面意思其实是“酸葡萄酒”。

### 词缀分析

Vinegar 并没有前缀或后缀加入，它的构成来自词根。
...
Vinegar 作为名词，没有太多的变型，它的复数形式是 vinegars, 表示多种类型的醋。
