---
title: Subsequently
description: Subsequently是一个副词，意为'之后'，'随后'，'接着'，通常用于描述在一件事件或动作之后发生的另一件事或动作。
sidebar:
  hidden: true
...
<Pronunciation word="Subsequently" uk="/ˈsʌb.sɪ.kwənt.li/" us="/ˈsʌb.sɪ.kwənt.li/" client:only />
...
"Subsequently"是一个较为正式的词汇，经常出现在报告和论文中，它源自拉丁语，于 17 世纪后期进入英语。
...
<WordRelations
  synonyms={["whence","ensuingly","followingly","afterwards","yet"]}
  client:only
/>
