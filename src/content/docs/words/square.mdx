---
title: Square
description: Square这个词在英语中有多种用途和含义，它可以作为名词，形容词或动词使用。
sidebar:
  hidden: true
...
<Pronunciation word="Square" uk="/skwɛə(ɹ)/" us="/skwɛɚ/" client:only />
...
<WordRelations
  synonyms={["hash","sharp","piazza","plaza","tetragon","straight","bourgeois","normal","orthogonal","perpendicular"]}
  antonyms={["crooked"]}
  client:only
/>
