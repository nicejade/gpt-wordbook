...
description: >-
  Authoritative
  是一个英语形容词，意思是“有权威的，命令式的，专断的”。它最初是用于描述一些给出已被广泛接受或认定为准确的信息的来源。逐渐地，它也开始用于便于描述那些散发出强烈权威气场，或是表现出强烈权力和控制感的个体。
sidebar:
  hidden: true
...
<Pronunciation word="Authoritative" uk="/ɔːˈθɒɹɪtətɪv/" us="/ɔːˈθɒɹɪtətɪv/" client:only />
...
<WordRelations
  synonyms={["definitive","precise","proper"]}
  client:only
/>
