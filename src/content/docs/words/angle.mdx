...
description: >-
  Angle
  是一个英文词汇，主要有两种含义。第一种作为名词，它的含义是'角度'，指物体的两条线或面之间的开合程度。在数学中，常用度数来衡量大小。第二种含义是'观点'或'立场'，指人在思考问题或解决问题时所采取的角度。
sidebar:
  hidden: true
...
<Pronunciation word="Angle" uk="/ˈæŋ.ɡəl/" us="/ˈæŋ.ɡəl/" client:only />

### 列举例句

1.  The angle between these two lines is 90 degrees. (这两条线之间的角度是 90 度。)
...
<WordRelations
  synonyms={["swerve","corner","nook","hexagon","opinion","perspective","slant","view","viewpoint"]}
  client:only
/>
