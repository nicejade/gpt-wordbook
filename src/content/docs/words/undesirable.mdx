...
description: >-
  Undesirable
  是一个英语形容词，意思是'不受欢迎的'，'不良的'，或者'不理想的'。它通常用来描述一种状态、特性或者行为，这种状态、特性或者行为是不想要的，或者可能带来消极影响。
sidebar:
  hidden: true
...
"Undesirable"一词来自早期的英语，并以其现在的形式在 16 世纪中叶成为标准英语。尽管它的使用一直都很广泛，但在 20 世纪，在讨论社会道德和伦理问题时，它的使用尤为突出。
...
<WordRelations antonyms={["desirable"]} client:only />
