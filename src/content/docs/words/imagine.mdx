---
title: Imagine
description: Imagine 是一个动词，意思是“想象，设想”。当你在脑海中构造一个场景或者想象某种可能性时，你使用这个词。
sidebar:
  hidden: true
...
<Pronunciation word="Imagine" uk="/ɪˈmædʒ.ɪn/" us="/ɪˈmædʒ.ɪn/" client:only />
...
"Imagine"从 14 世纪开始使用，最初意为‘创建一个形象或形象’，由拉丁词‘imago’派生。随着时间的推移，它发展到包括‘构思，想象’的意思。
...
<WordRelations synonyms={["ween"]} client:only />
