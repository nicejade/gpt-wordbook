---
title: Gloomy
description: "- 'Gloomy'是一个形容词，通常用于形容一种暗淡或昏暗的环境，或用于形容一个人或情况的忧郁、消沉和乏味。"
sidebar:
  hidden: true
...
<Pronunciation word="Gloomy" uk="/ˈɡlumi/" us="/ˈɡlumi/" client:only />
...
- "Gloomy"的最早记录在 14 世纪，其基础含义"阴暗的"反映在很多诗歌和文学作品中，通常用来设定情绪或描绘环境。
...
<WordRelations
  synonyms={["bleak", "dreary", "miserable", "clouded", "dim", "dusky"]}
  client:only
/>
