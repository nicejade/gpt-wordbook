---
title: Content
description: Content 在英语中有两个主要的词义：
sidebar:
  hidden: true
...
<Pronunciation word="Content" uk="/kənˈtɛnt/" us="/kənˈtɛnt/" client:only />
...
<WordRelations synonyms={["contented", "pleased", "satisfied"]} client:only />
