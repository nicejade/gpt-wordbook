...
title: Premium
description: >-
  Premium这个单词在英语中主要有两个含义。第一个含义是保险业中的'保险费'，就是投保人应当按合同歧议给予保险公司的一种金钱补偿。第二个含义是'额外费用、高级的、质量上乘的'，用来形容某种产品或服务的水平超过基础标准或预期。
sidebar:
  hidden: true
...
<Pronunciation word="Premium" uk="/ˈpɹimiəm/" us="/ˈpɹimiəm/" client:only />
...
Premium 作为形容词和名词，并没有复数形式或者时态变化。但可以搭配使用，如 premium rate（高额费率）、premium brand（高档品牌）。
...
<WordRelations antonyms={["discount"]} client:only />
