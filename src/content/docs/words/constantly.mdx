---
title: Constantly
description: Constantly是一个英文副词，意思是'持续不断地，频繁地'。它表示某件事情总是在发生，没有停止或改变。
sidebar:
  hidden: true
...
由同样词根衍生出来的其他单词：constant, constitute, constancy 等。

### 词缀分析

"Constantly"的词根是 "constant"，后缀是"ly"，表示的是"常常，不断"的状态。

相同词缀的其他单词：quickly, willingly, immediately 等。

### 文化背景

"Constantly"首次在 14 世纪出现在英语中，源自法文的"constamment"，其含义一直保持相对稳定，主要用于描述一种连续或定期的状态。
...
你可以对它和"constant"进行联想记忆，另外，constant 后面加上"ly"就变成了表示频繁状态的副词。
...
<WordRelations
  synonyms={["incessantly","nonstop","invariably","uniformly"]}
  client:only
/>
