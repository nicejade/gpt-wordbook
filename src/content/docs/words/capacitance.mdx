---
title: "capacitance"
description: "Capacitance 是一个物理术语，被定义为一个设备存储电荷的能力。它的单位是法拉（Farad）。例如，一个电容器的电容（capacitance）能够衡量它在电压变化时，可以存储多少电荷。"
---
...
1.  "The capacitance of this capacitor is 100 microfarads."（这个电容器的电容是 100 微法拉。）
...
"Capacitance"这个词首次出现在 19 世纪的科技文献中，主要涉及电力和电子工业的发展。
