---
title: Announce
description: Announce 是动词，意思是宣布或声明，常常用于公开地告知一项决定或新闻。
sidebar:
  hidden: true
...
<Pronunciation word="Announce" uk="/əˈnaʊns/" us="/əˈnaʊns/" client:only />
...
该前缀 'an-' 在 announce 中，并无特别表义。

相同词缀的其他单词有：antecedent, antidote 等。
...
<WordRelations
  synonyms={["abjudicate","judge","declare","herald","proclaim","promulgate","publish"]}
  client:only
/>
