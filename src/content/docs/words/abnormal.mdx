---
title: Abnormal
description: Abnormal 是一个英文形容词，意思是“不正常的、异常的”，用来描述离开标准、规范、规则、平均、或者是一般情况的事物或者行为。
sidebar:
  hidden: true
...
<Pronunciation word="Abnormal" uk="/əbˈnɔɹ.ml̩/" us="/əbˈnɔɹ.ml̩/" client:only />
...
"Abnormal"一词在 1847 年首次出现，起初主要用于医学领域，用于描述偏离了正常或平均健康状况的人或事物。
