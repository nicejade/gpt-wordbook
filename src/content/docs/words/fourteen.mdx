---
title: Fourteen
description: "- 'Fourteen' 是一个阿拉伯数字，在英文中表示 '14'。"
sidebar:
  hidden: true
...
<Pronunciation word="Fourteen" uk="/ˈfɔː.tiːn/" us="/ˈfɔː.tiːn/" client:only />
...
- "Fourteen" 可以分解为 "four-" 和 "-teen"。 "Four-" 来自古英语 "feower"，意为 "四"；"-teen" 来自古英语 "tēne" 或 "tīene"，在 13 到 19 的数字中用以表示"十多"。
...
- "Fourteen" 这个词源自古英语 "feowertene"，在欧美文化中，14 岁被视为从孩童到青少年的转变年龄。
