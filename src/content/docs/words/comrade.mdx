---
title: Comrade
description: Comrade的意思是“同志”，常用来表示在某种活动、事业或困难中共同努力的人，表达一种团体的连带关系。
sidebar:
  hidden: true
...
<Pronunciation word="Comrade" uk="/ˈkɒmɹeɪd/" us="/ˈkɒmɹeɪd/" client:only />
...
Comrade 为名词，单复数形式为：comrade, comrades.
...
<WordRelations
  synonyms={["brother","sister","compagno","tovarish"]}
  client:only
/>
