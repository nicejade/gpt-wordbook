---
title: Knowledge
description: Knowledge 是一个名词，表示熟知的事物或情况，专门了解的信息，学问，或理解的能力。
sidebar:
  hidden: true
...
<Pronunciation word="Knowledge" uk="/ˈnɒlɪdʒ/" us="/ˈnɑlɪdʒ/" client:only />
...
其他由“know-”衍生出来的单词包括： acknowledge, unknown, known 等。

### 词缀分析

“Knowledge” 中，“-ledge”是后缀，代表表抽象名词。

其他使用了“-ledge”的单词包括：acknowledge, pledge 等。
...
Jay 站在窗户边，俯瞰着他面前的广阔城市。它看上去如此无垠，就像他对知识的追求一样无止境。

<WordRelations
  synonyms={["awareness","ken","knowingness","learning"]}
  antonyms={["ignorance"]}
  client:only
/>
