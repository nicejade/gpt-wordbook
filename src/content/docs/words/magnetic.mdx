---
title: Magnetic
description: Magnetic是一个形容词，通常用来描述具有吸引力或者引人注意的事物。在物理学中，'magnetic'用来指任何跟磁性或磁力有关的事物。
sidebar:
  hidden: true
...
<Pronunciation word="Magnetic" uk="/mæɡˈnɛtɪk/" us="/mæɡˈnɛtɪk/" client:only />
...
是由词根 "magnet" 转化而来的。"Magnet"这个词在古希腊意为 "lodestone"，一种天然磁石。其他由这个词根衍生出来的单词有:magnetize, magnetism, magnetite 等。
...
"Magnet"这个词来源于古希腊，早在公元前 600 年，人们就发现了磁石的性质。后来，这个词通过拉丁语传入英语。"Magnetic"这个词代表磁的、吸引人的，最早的用法可以追溯到 16 世纪。
...
<WordRelations
  synonyms={["appealing","attractive","charismatic","inviting","seductive","repulsive","magnetised","magnetized"]}
  antonyms={["geographic","repulsive","antimagnetic","nonmagnetic"]}
  client:only
/>
