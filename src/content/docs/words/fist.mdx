...
title: Fist
description: >-
  Fist 是一个名词，中文翻译为“拳头”。它描述的是一种手的形状，当你的五个手指紧握到一起，形成一个坚硬的手掌，那就是拳头。此外，'fist'
  还可以作为一个动词使用，意思是“握拳”，比如 'He fisted his hands'（他握紧了拳头）。
sidebar:
  hidden: true
...
<Pronunciation word="Fist" uk="/fɪst/" us="/fɪst/" client:only />
...
<WordRelations synonyms={["ductus"]} client:only />
