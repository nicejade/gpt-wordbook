...
description: >-
  Symbolize
  这个单词是一个动词，它的意思是“代表”或者“象徵”。当一个物件或者概念被用来代表或象徵另一个物件或者更大的概念或者抽象的想法时，就可以使用
  symbolize 这个词。
sidebar:
  hidden: true
...
"Symbolize" 这个词源自 15 世纪中期的拉丁文 'symbolum' ，再源自希腊词 'symbolon'，形容一个将抽象的概念或者意义用具象的事物或者标记来表达或者指代的行为。
