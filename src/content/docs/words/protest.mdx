---
title: Protest
description: Protest 是一个动词，也可以作为名词，常用来描述公开反对或例行公事的反对。它既可以是一种积极的表达感情的方式，也可以用于描述不同形式的反对行动。
sidebar:
  hidden: true
...
<Pronunciation word="Protest" uk="/ˈpɹəʊ.tɛst/" us="/ˈpɹoʊ.tɛst/" client:only />
...
"Protest" 这个单词的使用最开始是在 14 世纪，原本意思是"vow or declare solemnly"。而公开反对或抗议的含义是在 18 世纪中期开始。
...
<WordRelations
  synonyms={["dissent", "objection", "protestation"]}
  client:only
/>
