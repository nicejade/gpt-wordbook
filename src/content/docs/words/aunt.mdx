---
title: Aunt
description: Aunt 是指你的父亲或母亲的姐姐或妹妹。这也可以用于称呼任何年长的女性亲戚。
sidebar:
  hidden: true
...
<Pronunciation word="Aunt" uk="/ɑ(ː)nt/" us="/eɪnt/" client:only />
...
<WordRelations antonyms={["nephew", "niece", "uncle"]} client:only />
