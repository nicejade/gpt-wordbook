...
title: Last
description: >-
  "Last" 是一种常见的英语单词，在不同的语境下它有多种用法和含义，主要可以被用作形容词、副词和动词。 1）当 "last" 作为动词时，意为“持续” 或
  “维持”。例如，制裁可能会持续几个月。 2）当 "last" 作为形容词时，意为“最后的” 或 “刚过去的”。例如，他在最后一秒钟获得了胜利。 3）当
  "last" 作为副词时，意为“最后一次”。例如，他们最后一次见面是在一年前。
sidebar:
  hidden: true
