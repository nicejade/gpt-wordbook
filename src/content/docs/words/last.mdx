---
title: Last
description: Last 是一种常见的英语单词，在不同的语境下它有多种用法和含义，主要可以被用作形容词、副词和动词。
sidebar:
  hidden: true
...
<Pronunciation word="Last" uk="/last/" us="/læst/" client:only />
...
<WordRelations
  synonyms={["caboose","dernier","final","terminal","ultimate","latest","most","recent","finally","lastly"]}
  client:only
/>
