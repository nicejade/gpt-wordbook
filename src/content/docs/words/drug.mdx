---
title: Drug
description: Drug 是一个名词，大多数时候被用来指医学上的药物，但也可以指在非法或娱乐场合使用的禁止或危害的物质（比如毒品）。
sidebar:
  hidden: true
...
<Pronunciation word="Drug" uk="/dɹʌɡ/" us="/dɹʌɡ/" client:only />
...
"Drug" 这个词出现于中世纪的英语中，原意是“干草”。随后它的含义发展为“干燥的维素物质”，这可能是因为一些草药在使用前需要先干燥。它的意思在 14 世纪扩展为“医学或草药”后，就保持了现在的意思。
