...
title: Condition
description: >-
  "Condition"这个词在英文中有几个主要的含义： 1. 状态或者情况，例如："The house is in good
  condition."（这个房子状态非常好。） 2. 疾病或者身体状况，例如： "He has a heart condition."（他有心脏病。） 3.
  施加的限制或者规定的前提，例如："The condition of the agreement is that you must complete the
  task on time." （这个协议的条件是你所有的任务必须准时完成。）
sidebar:
  hidden: true
