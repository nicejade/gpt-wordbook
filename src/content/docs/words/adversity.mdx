...
title: Adversity
description: >-
  Adversity'是一个名词，意思是“困难，逆境”。它通常用于描述一个人面临的困难情况或者不利的环境。例如，'He faced many
...
"Adversity"来自拉丁词根 "adversus"，意思是“对立的，敌对的”。衍生词有 adversary（敌人、对手）和 adverse(不利的，有害的)。
...
<WordRelations synonyms={["nakba"]} client:only />
