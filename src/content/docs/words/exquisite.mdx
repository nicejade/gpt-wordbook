---
title: Exquisite
description: "单词“exquisite”是一个形容词，用来描述某个对象（包括人和事物）极其精致，优美，优雅或它们极其高超，精巧。"
sidebar:
  hidden: true
...
单词“exquisite”是一个形容词，用来描述某个对象（包括人和事物）极其精致，优美，优雅或它们极其高超，精巧。
...
单词“exquisite”首次出现在 15 世纪，原意是被严格测试过或仔细挑选过的。现在我们用它来形容一种精度和庄重的美。
