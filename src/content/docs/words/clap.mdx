---
title: Clap
description: "- 单词'clap'在英语中主要有两种意思，一种是当一个动词使用，表示'拍手'或'鼓掌'，另一种是作为名词使用，表示'拍子声'或'掌声”。"
sidebar:
  hidden: true
...
<Pronunciation word="Clap" uk="/klæp/" us="/klæp/" client:only />
...
- "Clap"来自于古英语"clæppan"，意为"敲击、打击"，最早出现在 14 世纪。
...
<WordRelations synonyms={["thunderclap"]} client:only />
