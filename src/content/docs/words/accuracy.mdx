---
title: Accuracy
description: Accuracy 是一個英语单词，表示精确性或准确性。這个词经常用于描述测量、预测或计算的结果是否接近实际的、真实的或期望的值。
sidebar:
  hidden: true
...
Accuracy 起源于 Latin 词根 "accuratus"，意思是 "做得正确的，精确的"，接着通过 Old French 和 Middle English 发展成现在的 "accuracy"。
...
<WordRelations
  synonyms={["correctness", "truthfulness"]}
  antonyms={["inaccuracy"]}
  client:only
/>
