---
title: Sincerely
description: Sincerely是一个副词，意思是'真诚地'或者'诚挚地'，通常用来表示说或做某事的态度是真诚的，不带有虚假或欺骗。
sidebar:
  hidden: true
...
<Pronunciation word="Sincerely" uk="/sɪnˈsɪəli/" us="/sɪnˈsɪɹli/" client:only />
...
<WordRelations
  synonyms={["regards","earnestly","genuinely","honestly","truthfully"]}
  client:only
/>
