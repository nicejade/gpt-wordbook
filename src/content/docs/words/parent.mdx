---
title: Parent
description: Parent 是英文中的一个名词，代表父母或是一名养父或养母。这个词通常用于表示有生物关系或法律关系的保护者或者抚养者。
sidebar:
  hidden: true
...
<Pronunciation word="Parent" uk="/ˈpɛəɹənt/" us="/ˈpeəɹənt/" client:only />
...
<WordRelations
  synonyms={["mother", "progenitor", "raise", "rear"]}
