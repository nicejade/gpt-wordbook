---
title: Accidentally
description: Accidentally 是一个副词，意为“无意中，偶然地，意外地”。
sidebar:
  hidden: true
...
<Pronunciation word="Accidentally" uk="/ˌæksəˈdɛnt(ə)li/" us="/ˌæksəˈdɛnt(ə)li/" client:only />
...
<WordRelations
  synonyms={["casually","fortuitously"]}
  antonyms={["advisedly","deliberately","designedly","intentionally","purposely"]}
  client:only
/>
