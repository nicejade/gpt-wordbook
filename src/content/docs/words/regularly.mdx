---
title: Regularly
description: Regularly 是一个副词，表示定期、经常、通常发生的情况或行为，一般用来描述具有固定模式或频率的活动。
sidebar:
  hidden: true
...
<Pronunciation word="Regularly" uk="/ˈɹɛɡjəli/" us="/ˈɹɛɡjəlɚli/" client:only />
...
<WordRelations synonyms={["routinely"]} client:only />
