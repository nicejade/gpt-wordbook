---
title: Contest
description: Contest 这个单词主要有两种意思：
sidebar:
  hidden: true
...
<Pronunciation word="Contest" uk="/ˈkɒn.tɛst/" us="/ˈkɑn.tɛst/" client:only />
...
"Contest" 的前缀 con- 表示"一起"，test 指“证明，测试”。另一些带有 con- 前缀的单词如 cone, contact, concentrate 等。

### 文化背景

"Contest"这个词最早出现在公元 1600 年左右，当时的意思是"争论，争执"。到了 18 世纪，它开始被用于各种形式的比赛或竞赛，如音乐会、体育赛事等。在美国文化中，"contest"常用于描述竞争的情境，无论是友好的竞赛，还是在商业环境中的竞争。
...
<WordRelations
  synonyms={["battle","combat","fight","competition","pageant","controversy","debate","discussion","oppose","compete","contend","controvert"]}
  antonyms={["support"]}
  client:only
/>
