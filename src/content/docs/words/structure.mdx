...
title: Structure
description: >-
  Structure在英文中经常用作名词，表示“结构”，“建筑物”或“构造”。它可以指的是物理的结构，如桥梁、建筑或分子，也可以指的是抽象的结构，比如一个组织的构成或者文本的布局等。
sidebar:
  hidden: true
...
"Structure"这个词在 14 世纪从拉丁文中引入英语，最初主要用于描述建筑的物理结构。但随着时间的推移，它的意义开始扩大，包括许多非物质或抽象的概念，如组织结构、逻辑结构等。
...
<WordRelations
  synonyms={["configuration", "makeup", "formation"]}
  client:only
/>
