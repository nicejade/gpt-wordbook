...
title: Claim
description: >-
  Claim可以作为名词或动词使用。作为名词，它主要指的是对某事物的要求或要求权利，或是某种主张或声明。作为动词，'claim'有多种含义，例如要求，声称，或是主张。
sidebar:
  hidden: true
...
<Pronunciation word="Claim" uk="/kleɪm/" us="/kleɪm/" client:only />
...
Claim 的过去式和过去分词是'claimed'，现在分词是'claiming'。
