...
title: Deposition
description: >-
  Deposition 是一个英语单词，常用在法律或者地球科学领域中。在法律领域中，它表示
  '在法庭审讯未开始之前，一方取证的过程，通常是由律师提问，证人回答并且记录下来'。在地球科学上，它表示“物质从一个地方沉积到另一地方的过程”。
sidebar:
  hidden: true
...
“Deposition” 在英语中出现的时间可以追溯到 14 世纪，最初在法律领域表示“作证”在地理领域表示沉积。它是从法语的 "deposition" 衍变过来的。
...
<WordRelations
  synonyms={["desublimation"]}
  antonyms={["corrosion", "erosion", "sublimation"]}
  client:only
/>
