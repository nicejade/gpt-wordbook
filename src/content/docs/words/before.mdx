---
title: Before
description: Before是一个非常常见的英语单词，它可以作为介词、副词或是连词使用。它的主要含义通常为'在...之前'，表示时间或空间上的优先或早于。
sidebar:
  hidden: true
...
<Pronunciation word="Before" uk="/bɪˈfɔː/" us="/biˈfɔɹ/" client:only />

### 列举例句

1.  "I go to bed before 11 pm every day."（我每天都会在晚上 11 点前上床睡觉。）
...
<WordRelations
  synonyms={["previously", "ahead", "by", "ere", "lest"]}
