...
title: Noble
description: >-
  "Noble" 是一个形容词，主要含义包括以下几点： 1. 高尚的，贵族的。通常用来描述一个人的道德品质高尚或者身份地位高贵，如 noble
  thoughts (高尚的想法) 或 noble birth (贵族出身)。 2. 优秀的，高效的。在化学中，noble
  用于称呼稀有且不易与其他元素反应的元素，如 noble gas (稀有气体)。
sidebar:
  hidden: true
