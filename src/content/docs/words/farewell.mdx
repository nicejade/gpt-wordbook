...
title: Farewell
description: >-
  Farewell是一个英语单词，用作名词时，它的意思是告别或欧洲之行，用作动词时，它的意思是说再见或告别。告别体现在两种情况：较常见的一种是暂时分离，另一种可能是永久的离别或死亡。
sidebar:
  hidden: true
...
<Pronunciation word="Farewell" uk="/fɛəˈwɛl/" us="/fɛəɹˈwɛl/" client:only />
...
Farewell 这个词的早期表现形式出现在 13 世纪，"fare"（进行，做）和"well"（好）的组合形式表示祝福别人去得好。它在英国文化中常用于正式或者是更友好的情况下，表达对别人即将离去的祝福和深深的愿望。
...
<WordRelations synonyms={["adieu", "goodbye"]} client:only />
