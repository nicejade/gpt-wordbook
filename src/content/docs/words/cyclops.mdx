---
title: Cyclops
description: Cyclops 是一个英语词汇，来源于古希腊神话。原意为'圆眼'或'单眼'，用来形容只有一个眼睛的巨人。
sidebar:
  hidden: true
...
Cyclops 一词在英语中为不可数名词，没有复数形式。作为固定词汇，自身就代表一种特定的生物形象，没有其他单词形式。

### 文化背景

在古希腊神话中，Cyclops 是住在西西里岛的三个只有一个眼睛的巨人之一，他们是乌拉诺斯和盖亚的儿子。在现代文化中，Cyclops 也经常出现在各种奇幻文化作品中，如 J.R.R. Tolkien 的《霍比特人》和《指环王》。
