---
title: Messenger
description: '"Messenger" 是英语单词，作为名词，主要指 "信使"，具有传递信息或消息的职责或功能的人或物。'
sidebar:
  hidden: true
...
2.  Messenger RNA plays a key role in the process of protein synthesis. ("信使 RNA 在蛋白质合成过程中起着关键作用。")
