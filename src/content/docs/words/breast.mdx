---
title: Breast
description: Breast 是一个英文字，通常指的是人或动物的胸部，尤其是女性的乳房。它同时也可以引申用于指代心脏或心灵。
sidebar:
  hidden: true
...
<Pronunciation word="Breast" uk="/bɹɛst/" us="/bɹɛst/" client:only />
...
<WordRelations
  synonyms={["chest","brisket","heart","soul"]}
  antonyms={["thigh","wing"]}
  client:only
/>
