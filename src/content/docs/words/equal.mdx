...
title: Equal
description: >-
  Equal 是一种形容词也可以作为动词。作为形容词时，'equal'
  表示'等于'或'相等'，表示两个或更多的事物在数量、重量、质量、地位等方面完全一样或相同。作为动词时，意为'等于', '相当于'。
sidebar:
  hidden: true
...
<Pronunciation word="Equal" uk="/ˈiːkwəl/" us="/ˈiːkwəl/" client:only />
...
<WordRelations
  synonyms={["peer","entail","imply","lead","mean","spell","be","is","equivalent","identical","even","fair","uniform","unvarying"]}
  client:only
/>
