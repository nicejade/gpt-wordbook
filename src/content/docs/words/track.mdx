...
title: Track
description: >-
  Track 一词在英语中有多种含义，可以作为名词和动词使用。作为名词，'track'
  这个词最常见的含义是跑道或轨道，也可能指追踪的路径。作为动词，“track' 的常见含义是追踪、跟踪。
sidebar:
  hidden: true
...
<Pronunciation word="Track" uk="/tɹæk/" us="/tɹæk/" client:only />
...
"Track" 最初的应用可以追溯到 16 世纪，最初用来描述从田野到村庄的小径。在现代英语中，它被用来指代许多不同的物理路径或遥远的概念路径。
...
<WordRelations
  synonyms={["area","parcel","region","tract","athletics","course","path","trajectory","way","racetrack","footprint","impression","groove","ground","pitch","road","rails","railway","tracks"]}
  client:only
/>
