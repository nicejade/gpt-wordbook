---
title: Primarily
description: Primarily是一个副词，意为“主要地，首要地，大部分”。这个单词经常用于强调某一行动或状况的主要目的或重要性。
sidebar:
  hidden: true
...
<Pronunciation word="Primarily" uk="/pɹaɪˈmɛɹəli/" us="/pɹaɪˈmɛɹəli/" client:only />
...
Primarily 中的"prim-"来源于拉丁词根“primus”，意为“第一，最早”。与此词根相关的单词有 primitive(原始的)，prime(最重要的)，primordial(原始的)，primeval(原始的)。
