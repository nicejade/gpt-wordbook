---
title: Avail
description: 英文单词 'avail' 作为动词，主要含义是“有用，有助于”，表示某事或某行动对于达成目标或解决问题具有用途或帮助。
sidebar:
  hidden: true
...
<Pronunciation word="Avail" uk="/əˈveɪl/" us="/əˈveɪl/" client:only />
...
- 不规则动词变形：avail 的过去式和过去分词同样是"availed", 第三人称单数是 "avails"
...
<WordRelations antonyms={["disavail"]} client:only />
