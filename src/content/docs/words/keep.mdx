---
title: Keep
description: Keep这个词的基本含义是'保持，维持'。它是一个非常常用的动词，也可用作名词。另外，'keep'也含有'留住，保存，继续做某事'等多重含义。
sidebar:
  hidden: true
...
<Pronunciation word="Keep" uk="/kiːp/" us="/kiːp/" client:only />
...
<WordRelations
  synonyms={["donjon", "retain", "preserve", "protect"]}
  client:only
/>
