---
title: Vacation
description: Vacation是一个名词，指的是一段时间的假期，常常是从工作或学习中休息并进行旅行、放松的时间。
sidebar:
  hidden: true
...
<Pronunciation word="Vacation" uk="/veɪˈkeɪʃ(ə)n/" us="/veɪˈkeɪʃən/" client:only />
...
"Vacation"一词在 14 世纪来自拉丁文的"vacatio"，原意是"休息，空闲"。在美国，"vacation"表示休假或度假，而在英国，"holiday"是对应的词汇。
...
<WordRelations
  synonyms={["holiday","departure","moveout","annulment","revocation"]}
  client:only
/>
