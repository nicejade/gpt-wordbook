...
title: Again
description: >-
  "Again" 是一个英语副词，意思是"一次更"或"另一次"，用于描述一件事情重复发生。 例如： 1. I've told you time and
  again not to do that.（我已经一次又一次地告诉你不要那样做。） 2. Let's start again from the
  beginning.（让我们从头开始。） 3. I don't think we will meet again.（我认为我们再也不会见面了。）
sidebar:
  hidden: true
