---
title: Retail
description: Retail 是一个名词和动词，作为名词，它通常指的是以小批量出售给消费者以及最终消费品，如书店，杂货店或电子商务。作为动词，它意味着以零售出售。
sidebar:
  hidden: true
...
<Pronunciation word="Retail" uk="/ˈɹiˌteɪl/" us="/ˈɹiˌteɪl/" client:only />
...
<WordRelations antonyms={["wholesale"]} client:only />
