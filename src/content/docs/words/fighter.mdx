...
description: >-
  Fighter
  这个词主要有两个含义。首先，它可以用来描述一个参与格斗、争斗或斗争的人，尤其是职业拳击手。其次，在军事语境中，它指的是战斗机，这是一种用于空战的飞机。
sidebar:
  hidden: true
...
<Pronunciation word="Fighter" uk="/ˈfaɪ.tə(ɹ)/" us="/ˈfaɪ.tə(ɹ)/" client:only />
...
有一个名叫 Tom 的斗士。面对困难，他持续战斗，永不放弃。他深受他的城镇的爱戴和尊敬。

<WordRelations synonyms={["combatant", "soldier", "warrior"]} client:only />
