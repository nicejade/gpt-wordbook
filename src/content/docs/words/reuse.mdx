---
title: Reuse
description: Reuse，这个单词通常以动词形式出现，直译为“再度使用”。它旨在强调循环利用一些事物，而不是在使用一次后就抛弃。
sidebar:
  hidden: true
...
<Pronunciation word="Reuse" uk="/ɹiːˈjuːs/" us="/ɹiːˈjuːs/" client:only />
...
Reuse 由两部分组成，"re-" 和 "use"。"Re-"是一个常见的英语前缀，表示“再次”， "use"意为“使用”。

### 词缀分析

Reuse 这个词没有后缀，只有前缀 "re-" 和词根 "use"。
...
Tom 是一个热爱地球的孩子，他一直秉持着再利用的原则。每次他喝完一瓶水，他都会将它作为花盆使用，而不是丢弃掉。他的这个小行为看似对环保只是很小的一步，但实际上，却是巨大的一跃。
